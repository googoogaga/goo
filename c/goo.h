...
/*
PFUN FUNCODE (P fun) {
  return (PFUN)YPslot_elt(fun, (P)FUNCODEOFFSET);
}
*/
...
/*
INLINE PINT FUNARITY (P fun) {
  return (PINT)(IU(YPslot_elt(fun, (P)FUNARITYOFFSET)));
}
*/
...
/*
PLOG FUNNARYP (P fun) {
  return (PLOG)(YPslot_elt(fun, (P)FUNNARYPOFFSET) != YPfalse);
}
*/
...
char* type (P adr) {
  if (adr == PNUL)
	...
	return sym(YPtraits_owner(traits));
    case int_tag:
      return "<int>";
    case chr_tag:
      return "<chr>";
