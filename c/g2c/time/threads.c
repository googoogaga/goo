...
LINK_STACK();
  ...
  next_metsF5359 = T13;
  T11 = CALL1(1,VARREF(Yhead),next_metsF5359);
  T12 = CALL1(1,VARREF(Ytail),next_metsF5359);
  T10 = CALL4(1,VARREF(YgooSmacrosYnapp),T11,T12,x_,args_);
  tF5360 = T10;
  T2 = CALL1(1,VARREF(YtimeSthreadsYthread_function),tF5360);
  T1 = CALL2(1,VARREF(YgooSmacrosYEE),T2,VARREF(YtimeSthreadsYmain_thread_key));
  T0 = CALL1(1,VARREF(Ynot),T1);
  if (T0 != YPfalse) {
    T9 = FUNFAB(fun_14,1,tF5360);
    fF5361 = T9;
    T8 = CALL2(1,VARREF(Ytup),fF5361,tF5360);
    T7 = (P)YtimeSthreadsYPthread_create(T8);
    xF5362 = T7;
    T6 = (P)YPtag_into(xF5362,(P)3);
    hF5363 = T6;
    CALL2(1,VARREF(YtimeSthreadsYthread_handle_setter),hF5363,tF5360);
    T5 = CALL1(1,VARREF(YtimeSthreadsYthread_priority),tF5360);
    xF5364 = T5;
    xF5365 = xF5364;
    T4 = (P)YPiGG(xF5365,(P)2);
    T3 = (P)YtimeSthreadsYPthread_priority_setter(T4,hF5363);
  } else {
  }
UNLINK_STACK();
  RET(tF5360);
...
LINK_STACK();
  ARG(return_, 0);
  T17 = FUNSHELL(0,fun_x_1866_16,2);
  x_1866F5366 = T17;
  FUNINIT(x_1866F5366, 2,FREEREF(0),return_);
  x_1865F5367 = FREEREF(0);
  bodyF5368 = YPfalse;
  T1 = CALL2(1,VARREF(YisaQ),x_1865F5367,VARREF(YLlstG));
  if (T1 != YPfalse) {
    T6 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1865F5367,LITREF(lit_26),x_1866F5366);
    x_1865F5369 = T6;
    bodyF5368 = x_1865F5369;
    x_1865F5370 = Ynil;
    T4 = CALL2(1,VARREF(YgooSmacrosYmatch_sublist),x_1865F5370,x_1866F5366);
    x_1865F5371 = T4;
    T3 = CALL2(1,VARREF(YgooSmacrosYmatch_nul_list),x_1865F5371,x_1866F5366);
    T5 = CALL1(1,VARREF(Ytail),x_1865F5370);
    x_1865F5372 = T5;
    T2 = CALL2(1,VARREF(YgooSmacrosYmatch_nul_list),x_1865F5372,x_1866F5366);
  } else {
    T7 = CALL2(1,x_1866F5366,LITREF(lit_27),x_1865F5367);
  }
  T9 = CALL1(1,VARREF(Ylst),LITREF(lit_17));
  T10 = CALL1(1,VARREF(Ylst),LITREF(lit_0));
  T11 = CALL1(1,VARREF(Ylst),LITREF(lit_7));
  T14 = CALL1(1,VARREF(Ylst),LITREF(lit_28));
  T15 = CALL1(1,VARREF(Ylst),Ynil);
  T16 = bodyF5368;
  T13 = CALL4(1,VARREF(YgooSmacrosYcat),T14,T15,T16,LITREF(lit_29));
  T12 = CALL1(1,VARREF(Ylst),T13);
  T8 = CALL5(1,VARREF(YgooSmacrosYcat),T9,T10,T11,T12,LITREF(lit_29));
UNLINK_STACK();
  QRET(T8);
}
...
LINK_STACK();
  ...
  LOOP_254: {
    P a254_0;
    T2 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_1867F5375);
    T1 = CALL1(1,VARREF(Ynot),T2);
    if (T1 != YPfalse) {
      T5 = CALL1(1,VARREF(YgooScolsScolYnow),x_1867F5375);
      iF5376 = T5;
      CALL2(1,VARREF(YgooSioSwriteYpost),LITREF(lit_36),iF5376);
      T4 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1867F5375);
      a254_0 = T4;
      x_1867F5375 = a254_0;
      goto LOOP_254;
      T0 = T3;
...
LINK_STACK();
  ...
  LOOP_255: {
    P a255_0;
    T2 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_1869F5377);
    T1 = CALL1(1,VARREF(Ynot),T2);
    if (T1 != YPfalse) {
      T5 = CALL1(1,VARREF(YgooScolsScolYnow),x_1869F5377);
      iF5378 = T5;
      CALL2(1,VARREF(YgooSioSwriteYpost),LITREF(lit_38),iF5378);
      CALL1(1,VARREF(YtimeSthreadsYsleep),LITREF(lit_39));
      T4 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1869F5377);
      a255_0 = T4;
      x_1869F5377 = a255_0;
      goto LOOP_255;
      T0 = T3;
...
DEFCREGS();
  ...
  fun_x_1866_16 = YPfab_met(FUNCODEREF(fun_x_1866_16),T50,LITREF(lit_24),LITREF(lit_25),YPfalse,YPfalse);
