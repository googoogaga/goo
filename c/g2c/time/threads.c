...
LOCFOR(fun_x_1737_21);
LOCFOR(fun_22);
FUNFOR(YtimeSthreadsYtest_thread_1);
LOCFOR(fun_x_1739_24);
LOCFOR(fun_25);
...
loop:
  T2 = (P)YPnext_methods();
  next_metsF2602 = T2;
  if (next_metsF2602 != YPfalse) {
    T5 = CALL1(1,VARREF(Yhead),next_metsF2602);
    T6 = CALL1(1,VARREF(Ytail),next_metsF2602);
  ...
  T1 = T3;
  tF2603 = T1;
  T10 = CALL1(1,VARREF(YtimeSthreadsYthread_function),tF2603);
  T9 = CALL2(1,VARREF(YgooSmacrosYEE),T10,VARREF(YtimeSthreadsYmain_thread_key));
  T8 = CALL1(1,VARREF(Ynot),T9);
  if (T8 != YPfalse) {
    T15 = CALL1(1,VARREF(YtimeSthreadsYthread_function),tF2603);
    T14 = CALL2(1,VARREF(Ytup),T15,tF2603);
    T13 = (P)YtimeSthreadsYPthread_create(T14);
    T12 = (P)YPlb(T13);
    hF2604 = T12;
    CALL2(1,VARREF(YtimeSthreadsYthread_handle_setter),hF2604,tF2603);
    T18 = CALL1(1,VARREF(YtimeSthreadsYthread_priority),tF2603);
    T17 = (P)YPiu(T18);
    T16 = (P)YtimeSthreadsYPthread_priority_setter(T17,hF2604);
    T11 = T16;
  } else {
  }
  T0 = tF2603;
...
loop:
  ...
  x_1735F2605 = T1;
  FUNINIT(x_1735F2605, 1,return_);
  x_1734F2606 = FREEREF(0);
  bodyF2607 = YPfalse;
  bodyF2607 = BOXFAB(bodyF2607);
  T5 = CALL2(1,VARREF(YisaQ),x_1734F2606,VARREF(YLlstG));
  if (T5 != YPfalse) {
    T7 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1734F2606,LITREF(lit_22),x_1735F2605);
    x_1734F2608 = T7;
    BOXVAL(bodyF2607) = x_1734F2608;
    x_1734F2609 = Ynil;
    T9 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1734F2609,x_1735F2605);
    T8 = T9;
    T6 = T8;
  } else {
    T10 = CALL2(1,x_1735F2605,LITREF(lit_23),x_1734F2606);
  }
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    iF2610 = T4;
    CALL2(1,VARREF(YgooSioSwriteYpost),LITREF(lit_33),iF2610);
    T6 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1736_);
    a1 = T6;
    x_1736_ = a1;
    goto loop;
    T3 = T5;
...
loop:
  ...
  T1 = CALL1(1,VARREF(Ynot),T2);
  if (T1 != YPfalse) {
    T4 = CALL1(1,VARREF(YgooScolsScolYnow),x_1738_);
    iF2612 = T4;
    CALL2(1,VARREF(YgooSioSwriteYpost),LITREF(lit_37),iF2612);
    CALL1(1,VARREF(YtimeSthreadsYsleep),LITREF(lit_38));
    T6 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1738_);
    a1 = T6;
    x_1738_ = a1;
    goto loop;
    T3 = T5;
...
LINK_STACK();
loop:
  T1 = FUNSHELL(1,fun_x_1739_24,1);
  x_1739F2613 = T1;
  FUNINIT(x_1739F2613, 1,x_1739F2613);
  T4 = CALL1(1,VARREF(YgooScolsSseqYbelow),YPint((P)100));
  T3 = CALL1(1,VARREF(YgooScolsScolYenum),T4);
  T2 = CALL1(0,x_1739F2613,T3);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  fun_x_1735_15 = YPmet(FUNCODEREF(fun_x_1735_15),LITREF(lit_20),T68,ENVNUL,PNUL,YPfalse);
  ...
  lit_31 = YPPsym((P)"x-1737");
  lit_32 = YPPsym((P)"x-1736");
  lit_33 = YPsb((P)"%d\n");
  T87 = YPsig(YPPlist(1,LITREF(lit_32)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_x_1737_21 = YPmet(FUNCODEREF(fun_x_1737_21),LITREF(lit_31),T87,ENVNUL,PNUL,YPfalse);
  ...
  lit_35 = YPPsym((P)"x-1739");
  lit_36 = YPPsym((P)"x-1738");
  lit_37 = YPsb((P)"%d\n");
  lit_38 = YPflo(FLOINT(1.0));
  T91 = YPsig(YPPlist(1,LITREF(lit_36)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_x_1739_24 = YPmet(FUNCODEREF(fun_x_1739_24),LITREF(lit_35),T91,ENVNUL,PNUL,YPfalse);
