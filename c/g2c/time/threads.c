...
loop:
  ...
  next_metsF3695 = T2;
  T6 = CALL1(1,VARREF(Yhead),next_metsF3695);
  T7 = CALL1(1,VARREF(Ytail),next_metsF3695);
  T5 = CALL4(1,VARREF(YgooSmacrosYnapp),T6,T7,x_,args_);
  T1 = T5;
  tF3696 = T1;
  T10 = CALL1(1,VARREF(YtimeSthreadsYthread_function),tF3696);
  T9 = CALL2(1,VARREF(YgooSmacrosYEE),T10,VARREF(YtimeSthreadsYmain_thread_key));
  T8 = CALL1(1,VARREF(Ynot),T9);
  if (T8 != YPfalse) {
    T12 = FUNFAB(fun_17,1,tF3696);
    fF3697 = T12;
    T16 = CALL2(1,VARREF(Ytup),fF3697,tF3696);
    T15 = (P)YtimeSthreadsYPthread_create(T16);
    xF3698 = T15;
    T17 = (P)YPtag_into(xF3698,(P)3);
    T14 = T17;
    hF3699 = T14;
    CALL2(1,VARREF(YtimeSthreadsYthread_handle_setter),hF3699,tF3696);
    T20 = CALL1(1,VARREF(YtimeSthreadsYthread_priority),tF3696);
    xF3700 = T20;
    xF3701 = xF3700;
    T22 = (P)YPiGG(xF3701,(P)2);
    T21 = T22;
    T19 = T21;
    T18 = (P)YtimeSthreadsYPthread_priority_setter(T19,hF3699);
    T13 = T18;
    T11 = T13;
  } else {
  }
...
LINK_STACK();
  ARG(return_, 0);
loop:
  T1 = FUNSHELL(0,fun_x_1765_19,2);
  x_1765F3702 = T1;
  FUNINIT(x_1765F3702, 2,FREEREF(0),return_);
  x_1764F3703 = FREEREF(0);
  bodyF3704 = YPfalse;
  bodyF3704 = BOXFAB(bodyF3704);
  T5 = CALL2(1,VARREF(YisaQ),x_1764F3703,VARREF(YLlstG));
  if (T5 != YPfalse) {
    T7 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1764F3703,LITREF(lit_32),x_1765F3702);
    x_1764F3705 = T7;
    BOXVAL(bodyF3704) = x_1764F3705;
    x_1764F3706 = Ynil;
    T10 = CALL2(1,VARREF(YgooSmacrosYmatch_sublist),x_1764F3706,x_1765F3702);
    x_1764F3707 = T10;
    T11 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1764F3707,x_1765F3702);
    T12 = CALL1(1,VARREF(Ytail),x_1764F3706);
    x_1764F3708 = T12;
    T13 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1764F3708,x_1765F3702);
    T9 = T13;
    T8 = T9;
    T6 = T8;
  } else {
    T14 = CALL2(1,x_1765F3702,LITREF(lit_33),x_1764F3703);
  }
...
LINK_STACK();
  ARG(x_1766_, 0);
loop:
  T2 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_1766_);
  T1 = CALL1(1,VARREF(Ynot),T2);
  if (T1 != YPfalse) {
    T4 = CALL1(1,VARREF(YgooScolsScolYnow),x_1766_);
    iF3711 = T4;
    CALL2(1,VARREF(YgooSioSwriteYpost),LITREF(lit_44),iF3711);
    T6 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1766_);
    a1 = T6;
    x_1766_ = a1;
    goto loop;
    T3 = T5;
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    iF3713 = T4;
    CALL2(1,VARREF(YgooSioSwriteYpost),LITREF(lit_48),iF3713);
...
LINK_STACK();
loop:
  T1 = FUNSHELL(1,fun_x_1769_28,1);
  x_1769F3714 = T1;
  FUNINIT(x_1769F3714, 1,x_1769F3714);
  T4 = CALL1(1,VARREF(YgooScolsSseqYbelow),YPint((P)100));
  T3 = CALL1(1,VARREF(YgooScolsScolYenum),T4);
  T2 = CALL1(0,x_1769F3714,T3);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  fun_x_1765_19 = YPmet(FUNCODEREF(fun_x_1765_19),LITREF(lit_30),T64,ENVNUL,PNUL,YPfalse);
  ...
  lit_42 = YPPsym((P)"x-1767");
  lit_43 = YPPlist(1,YPPsym((P)"x-1766"));
  lit_44 = YPsb((P)"%d\n");
  T80 = YPsig(LITREF(lit_43),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_x_1767_25 = YPmet(FUNCODEREF(fun_x_1767_25),LITREF(lit_42),T80,ENVNUL,PNUL,sloc(62));
  T79 = YPsig(LITREF(lit_16),Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  fun_26 = YPmet(FUNCODEREF(fun_26),YPfalse,T79,ENVNUL,PNUL,sloc(62));
  ...
  T81 = YtimeSthreadsYtest_thread_1;
  VARSET(YtimeSthreadsYtest_thread_1,T81);
  lit_45 = YPPsym((P)"test-thread-2");
  lit_46 = YPPsym((P)"x-1769");
  lit_47 = YPPlist(1,YPPsym((P)"x-1768"));
  lit_48 = YPsb((P)"%d\n");
  lit_49 = YPflo(FLOINT(1.0));
  T84 = YPsig(LITREF(lit_47),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_x_1769_28 = YPmet(FUNCODEREF(fun_x_1769_28),LITREF(lit_46),T84,ENVNUL,PNUL,sloc(65));
  T83 = YPsig(LITREF(lit_16),Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  fun_29 = YPmet(FUNCODEREF(fun_29),YPfalse,T83,ENVNUL,PNUL,sloc(65));
  T82 = YPsig(LITREF(lit_16),Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  YtimeSthreadsYtest_thread_2 = YPmet(FUNCODEREF(YtimeSthreadsYtest_thread_2),LITREF(lit_45),T82,ENVNUL,PNUL,sloc(64));
  T85 = YtimeSthreadsYtest_thread_2;
  VARSET(YtimeSthreadsYtest_thread_2,T85);
  T86 = YPfalse;
  return T86;
}
