...
loop:
  T2 = (P)YPnext_methods();
  next_metsF3718 = T2;
  tmpF3719 = next_metsF3718;
  if (tmpF3719 != YPfalse) {
    xF3720 = next_metsF3718;
    yF3721 = Ynil;
    T9 = (P)YPeqQ(xF3720,yF3721);
    T8 = (P)YPbb(T9);
    T7 = T8;
    xF3722 = T7;
    T11 = (P)YPeqQ(xF3722,YPfalse);
    T10 = (P)YPbb(T11);
    T6 = T10;
    T5 = T6;
  } else {
  ...
  T4 = T5;
  if (T4 != YPfalse) {
    T13 = CALL1(1,VARREF(Yhead),next_metsF3718);
    T14 = CALL1(1,VARREF(Ytail),next_metsF3718);
  ...
  T1 = T3;
  tF3723 = T1;
  T20 = CALL1(1,VARREF(YtimeSthreadsYthread_function),tF3723);
  T19 = CALL2(1,VARREF(YgooSmacrosYEE),T20,VARREF(YtimeSthreadsYmain_thread_key));
  T18 = CALL1(1,VARREF(Ynot),T19);
  if (T18 != YPfalse) {
    T22 = FUNFAB(fun_17,1,tF3723);
    fF3724 = T22;
    T26 = CALL2(1,VARREF(Ytup),fF3724,tF3723);
    T25 = (P)YtimeSthreadsYPthread_create(T26);
    xF3725 = T25;
    T27 = (P)YPtag_into(xF3725,(P)3);
    T24 = T27;
    hF3726 = T24;
    CALL2(1,VARREF(YtimeSthreadsYthread_handle_setter),hF3726,tF3723);
    T30 = CALL1(1,VARREF(YtimeSthreadsYthread_priority),tF3723);
    xF3727 = T30;
    xF3728 = xF3727;
    T32 = (P)YPiGG(xF3728,(P)2);
    T31 = T32;
    T29 = T31;
    T28 = (P)YtimeSthreadsYPthread_priority_setter(T29,hF3726);
    T23 = T28;
    T21 = T23;
  } else {
  }
...
loop:
  ...
  x_1767F3729 = T1;
  FUNINIT(x_1767F3729, 2,FREEREF(0),return_);
  x_1766F3730 = FREEREF(0);
  bodyF3731 = YPfalse;
  bodyF3731 = BOXFAB(bodyF3731);
  T5 = CALL2(1,VARREF(YisaQ),x_1766F3730,VARREF(YLlstG));
  if (T5 != YPfalse) {
    T7 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1766F3730,LITREF(lit_32),x_1767F3729);
    x_1766F3732 = T7;
    BOXVAL(bodyF3731) = x_1766F3732;
    x_1766F3733 = Ynil;
    T10 = CALL2(1,VARREF(YgooSmacrosYmatch_sublist),x_1766F3733,x_1767F3729);
    x_1766F3734 = T10;
    T11 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1766F3734,x_1767F3729);
    T12 = CALL1(1,VARREF(Ytail),x_1766F3733);
    x_1766F3735 = T12;
    T13 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1766F3735,x_1767F3729);
    T9 = T13;
    T8 = T9;
    T6 = T8;
  } else {
    T14 = CALL2(1,x_1767F3729,LITREF(lit_33),x_1766F3730);
  }
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    iF3738 = T4;
    CALL2(1,VARREF(YgooSioSwriteYpost),LITREF(lit_44),iF3738);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    iF3740 = T4;
    CALL2(1,VARREF(YgooSioSwriteYpost),LITREF(lit_48),iF3740);
...
loop:
  ...
  x_1771F3741 = T1;
  FUNINIT(x_1771F3741, 1,x_1771F3741);
  T4 = CALL1(1,VARREF(YgooScolsSseqYbelow),YPint((P)100));
  T3 = CALL1(1,VARREF(YgooScolsScolYenum),T4);
  T2 = CALL1(0,x_1771F3741,T3);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
