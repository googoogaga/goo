...
LINK_STACK();
  ...
  next_metsF4108 = T9;
  T7 = CALL1(1,VARREF(Yhead),next_metsF4108);
  T8 = CALL1(1,VARREF(Ytail),next_metsF4108);
  T6 = CALL4(1,VARREF(YgooSmacrosYnapp),T7,T8,x_,args_);
  lF4109 = T6;
  T5 = CALL1(1,VARREF(YtimeSlockYlock_name),lF4109);
  nF4110 = T5;
  if (nF4110 != YPfalse) {
    T3 = LITREF(lit_24);
  } else {
    T4 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLstrG),nF4110);
    T3 = T4;
  }
  T2 = (P)YPsu(T3);
  T1 = (P)YtimeSlockYPlock_create(T2);
  xF4111 = T1;
  T0 = (P)YPtag_into(xF4111,(P)3);
  CALL2(1,VARREF(YtimeSlockYlock_handle_setter),T0,lF4109);
UNLINK_STACK();
  RET(lF4109);
}

FUNCODEDEF(fun_x_1833_11) {
  P msg_,args_;
  P T0,T1;
LINK_STACK();
  ARG(msg_, 0);
...
LINK_STACK();
  ARG(return_, 0);
  T36 = FUNSHELL(0,fun_x_1833_11,2);
  x_1833F4112 = T36;
  FUNINIT(x_1833F4112, 2,FREEREF(0),return_);
  x_1832F4113 = FREEREF(0);
  lockF4114 = YPfalse;
  lockF4114 = BOXFAB(lockF4114);
  bodyF4115 = YPfalse;
  bodyF4115 = BOXFAB(bodyF4115);
  T2 = CALL2(1,VARREF(YisaQ),x_1832F4113,VARREF(YLlstG));
  if (T2 != YPfalse) {
    T9 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1832F4113,LITREF(lit_29),x_1833F4112);
    x_1832F4116 = T9;
    T7 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1832F4116,x_1833F4112);
    BOXVAL(lockF4114) = T7;
    T8 = CALL1(1,VARREF(Ytail),x_1832F4116);
    x_1832F4117 = T8;
    BOXVAL(bodyF4115) = x_1832F4117;
    x_1832F4118 = Ynil;
    T5 = CALL2(1,VARREF(YgooSmacrosYmatch_sublist),x_1832F4118,x_1833F4112);
    x_1832F4119 = T5;
    T4 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1832F4119,x_1833F4112);
    T6 = CALL1(1,VARREF(Ytail),x_1832F4118);
    x_1832F4120 = T6;
    T3 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1832F4120,x_1833F4112);
  } else {
    T10 = CALL2(1,x_1833F4112,LITREF(lit_30),x_1832F4113);
  }
  T35 = CALL0(1,VARREF(YgooSmacrosYgensym));
  lock_nameF4121 = T35;
  T12 = CALL1(1,VARREF(Ylst),LITREF(lit_31));
  T17 = CALL1(1,VARREF(Ylst),lock_nameF4121);
  T19 = BOXVAL(lockF4114);
...
DEFCREGS();
  ...
  fun_x_1833_11 = YPmet(FUNCODEREF(fun_x_1833_11),LITREF(lit_27),T51,ENVNUL,PNUL,YPfalse);
