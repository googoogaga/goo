...
loop:
  T2 = (P)YPnext_methods();
  next_metsF2646 = T2;
  if (next_metsF2646 != YPfalse) {
    T5 = CALL1(1,VARREF(Yhead),next_metsF2646);
    T6 = CALL1(1,VARREF(Ytail),next_metsF2646);
  ...
  T8 = (P)YPlb(T9);
  CALL2(1,VARREF(YtimeSlockYlock_handle_setter),T8,lF2647);
  T0 = lF2647;
UNLINK_STACK();
  RET(T0);
}

FUNCODEDEF(fun_x_1749_11) {
  P msg_,args_;
  P T0;
  P a1,a2;
LINK_STACK();
...
LINK_STACK();
  ARG(return_, 0);
loop:
  T1 = FUNSHELL(0,fun_x_1749_11,1);
  x_1749F2648 = T1;
  FUNINIT(x_1749F2648, 1,return_);
  x_1748F2649 = FREEREF(0);
  lockF2650 = YPfalse;
  lockF2650 = BOXFAB(lockF2650);
  bodyF2651 = YPfalse;
  bodyF2651 = BOXFAB(bodyF2651);
  T7 = CALL2(1,VARREF(YisaQ),x_1748F2649,VARREF(YLlstG));
  if (T7 != YPfalse) {
    T9 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1748F2649,LITREF(lit_23),x_1749F2648);
    x_1748F2652 = T9;
    T11 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1748F2652,x_1749F2648);
    BOXVAL(lockF2650) = T11;
    T12 = CALL1(1,VARREF(Ytail),x_1748F2652);
    x_1748F2653 = T12;
    BOXVAL(bodyF2651) = x_1748F2653;
    x_1748F2654 = Ynil;
    T14 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1748F2654,x_1749F2648);
    T13 = T14;
    T10 = T13;
    T8 = T10;
  } else {
    T15 = CALL2(1,x_1749F2648,LITREF(lit_24),x_1748F2649);
  }
  T17 = CALL0(1,VARREF(YgooSmacrosYgensym));
  lock_nameF2655 = T17;
  T19 = CALL1(1,VARREF(Ylst),LITREF(lit_25));
  T24 = CALL1(1,VARREF(Ylst),lock_nameF2655);
  T26 = BOXVAL(lockF2650);
...
loop:
  ...
  fun_x_1749_11 = YPmet(FUNCODEREF(fun_x_1749_11),LITREF(lit_21),T61,ENVNUL,PNUL,YPfalse);
