...
loop:
  T2 = (P)YPnext_methods();
  next_metsF2614 = T2;
  if (next_metsF2614 != YPfalse) {
    T5 = CALL1(1,VARREF(Yhead),next_metsF2614);
    T6 = CALL1(1,VARREF(Ytail),next_metsF2614);
  ...
  T8 = (P)YPlb(T9);
  CALL2(1,VARREF(YtimeSlockYlock_handle_setter),T8,lF2615);
  T0 = lF2615;
UNLINK_STACK();
  RET(T0);
}

FUNCODEDEF(fun_x_1743_11) {
  P msg_,args_;
  P T0;
  P a1,a2;
LINK_STACK();
...
LINK_STACK();
  ARG(return_, 0);
loop:
  T1 = FUNSHELL(0,fun_x_1743_11,1);
  x_1743F2616 = T1;
  FUNINIT(x_1743F2616, 1,return_);
  x_1742F2617 = FREEREF(0);
  lockF2618 = YPfalse;
  lockF2618 = BOXFAB(lockF2618);
  bodyF2619 = YPfalse;
  bodyF2619 = BOXFAB(bodyF2619);
  T7 = CALL2(1,VARREF(YisaQ),x_1742F2617,VARREF(YLlstG));
  if (T7 != YPfalse) {
    T9 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1742F2617,LITREF(lit_23),x_1743F2616);
    x_1742F2620 = T9;
    T11 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1742F2620,x_1743F2616);
    BOXVAL(lockF2618) = T11;
    T12 = CALL1(1,VARREF(Ytail),x_1742F2620);
    x_1742F2621 = T12;
    BOXVAL(bodyF2619) = x_1742F2621;
    x_1742F2622 = Ynil;
    T14 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1742F2622,x_1743F2616);
    T13 = T14;
    T10 = T13;
    T8 = T10;
  } else {
    T15 = CALL2(1,x_1743F2616,LITREF(lit_24),x_1742F2617);
  }
  T17 = CALL0(1,VARREF(YgooSmacrosYgensym));
  lock_nameF2623 = T17;
  T19 = CALL1(1,VARREF(Ylst),LITREF(lit_25));
  T24 = CALL1(1,VARREF(Ylst),lock_nameF2623);
  T26 = BOXVAL(lockF2618);
...
loop:
  ...
  fun_x_1743_11 = YPmet(FUNCODEREF(fun_x_1743_11),LITREF(lit_21),T61,ENVNUL,PNUL,YPfalse);
