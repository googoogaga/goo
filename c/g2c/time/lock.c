...
LINK_STACK();
  ...
  next_metsF3951 = T2;
  T6 = CALL1(1,VARREF(Yhead),next_metsF3951);
  T7 = CALL1(1,VARREF(Ytail),next_metsF3951);
  T5 = CALL4(1,VARREF(YgooSmacrosYnapp),T6,T7,x_,args_);
  T1 = T5;
  lF3952 = T1;
  T9 = CALL1(1,VARREF(YtimeSlockYlock_name),lF3952);
  nF3953 = T9;
  if (nF3953 != YPfalse) {
    T13 = LITREF(lit_24);
  } else {
    T14 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLstrG),nF3953);
    T13 = T14;
  }
  T12 = (P)YPsu(T13);
  T11 = (P)YtimeSlockYPlock_create(T12);
  xF3954 = T11;
  T15 = (P)YPtag_into(xF3954,(P)3);
  T10 = T15;
  CALL2(1,VARREF(YtimeSlockYlock_handle_setter),T10,lF3952);
  T8 = lF3952;
  T0 = T8;
UNLINK_STACK();
  RET(T0);
...
LINK_STACK();
  ARG(return_, 0);
  T1 = FUNSHELL(0,fun_x_1796_11,2);
  x_1796F3955 = T1;
  FUNINIT(x_1796F3955, 2,FREEREF(0),return_);
  x_1795F3956 = FREEREF(0);
  lockF3957 = YPfalse;
  lockF3957 = BOXFAB(lockF3957);
  bodyF3958 = YPfalse;
  bodyF3958 = BOXFAB(bodyF3958);
  T7 = CALL2(1,VARREF(YisaQ),x_1795F3956,VARREF(YLlstG));
  if (T7 != YPfalse) {
    T9 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1795F3956,LITREF(lit_29),x_1796F3955);
    x_1795F3959 = T9;
    T11 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1795F3959,x_1796F3955);
    BOXVAL(lockF3957) = T11;
    T12 = CALL1(1,VARREF(Ytail),x_1795F3959);
    x_1795F3960 = T12;
    BOXVAL(bodyF3958) = x_1795F3960;
    x_1795F3961 = Ynil;
    T15 = CALL2(1,VARREF(YgooSmacrosYmatch_sublist),x_1795F3961,x_1796F3955);
    x_1795F3962 = T15;
    T16 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1795F3962,x_1796F3955);
    T17 = CALL1(1,VARREF(Ytail),x_1795F3961);
    x_1795F3963 = T17;
    T18 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1795F3963,x_1796F3955);
    T14 = T18;
    T13 = T14;
    T10 = T13;
    T8 = T10;
  } else {
    T19 = CALL2(1,x_1796F3955,LITREF(lit_30),x_1795F3956);
  }
  T21 = CALL0(1,VARREF(YgooSmacrosYgensym));
  lock_nameF3964 = T21;
  T23 = CALL1(1,VARREF(Ylst),LITREF(lit_31));
  T28 = CALL1(1,VARREF(Ylst),lock_nameF3964);
  T30 = BOXVAL(lockF3957);
...
DEFCREGS();
  ...
  fun_x_1796_11 = YPmet(FUNCODEREF(fun_x_1796_11),LITREF(lit_27),T51,ENVNUL,PNUL,YPfalse);
