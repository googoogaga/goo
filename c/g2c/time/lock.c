...
LINK_STACK();
  ...
  next_metsF5195 = T9;
  T7 = CALL1(1,VARREF(Yhead),next_metsF5195);
  T8 = CALL1(1,VARREF(Ytail),next_metsF5195);
  T6 = CALL4(1,VARREF(YgooSmacrosYnapp),T7,T8,x_,args_);
  lF5196 = T6;
  T5 = CALL1(1,VARREF(YtimeSlockYlock_name),lF5196);
  nF5197 = T5;
  if (nF5197 != YPfalse) {
    T3 = LITREF(lit_22);
  } else {
    T4 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLstrG),nF5197);
    T3 = T4;
  }
  T2 = (P)YPsu(T3);
  T1 = (P)YtimeSlockYPlock_create(T2);
  xF5198 = T1;
  T0 = (P)YPtag_into(xF5198,(P)3);
  CALL2(1,VARREF(YtimeSlockYlock_handle_setter),T0,lF5196);
UNLINK_STACK();
  RET(lF5196);
}

LOCCODEDEF(fun_x_1862_10) {
  P msg_,args_;
  P T0,T1;
LINK_STACK();
  ARG(msg_, 0);
...
LINK_STACK();
  ARG(return_, 0);
  T33 = FUNSHELL(0,fun_x_1862_10,2);
  x_1862F5199 = T33;
  FUNINIT(x_1862F5199, 2,FREEREF(0),return_);
  x_1861F5200 = FREEREF(0);
  lockF5201 = YPfalse;
  bodyF5202 = YPfalse;
  T2 = CALL2(1,VARREF(YisaQ),x_1861F5200,VARREF(YLlstG));
  if (T2 != YPfalse) {
    T6 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1861F5200,LITREF(lit_27),x_1862F5199);
    x_1861F5203 = T6;
    T4 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1861F5203,x_1862F5199);
    lockF5201 = T4;
    T5 = CALL1(1,VARREF(Ytail),x_1861F5203);
    x_1861F5204 = T5;
    bodyF5202 = x_1861F5204;
    x_1861F5205 = Ynil;
    T3 = CALL2(1,VARREF(YgooSmacrosYmatch_nul_list),x_1861F5205,x_1862F5199);
  } else {
    T7 = CALL2(1,x_1862F5199,LITREF(lit_28),x_1861F5200);
  }
  T32 = CALL0(1,VARREF(YgooSmacrosYgensym));
  lock_nameF5206 = T32;
  T9 = CALL1(1,VARREF(Ylst),LITREF(lit_29));
  T14 = CALL1(1,VARREF(Ylst),lock_nameF5206);
  T16 = lockF5201;
  ...
  T26 = CALL1(1,VARREF(Ylst),lock_nameF5206);
  ...
  T31 = CALL1(1,VARREF(Ylst),lock_nameF5206);
...
DEFCREGS();
  ...
  fun_x_1862_10 = YPfab_met(FUNCODEREF(fun_x_1862_10),T46,LITREF(lit_25),LITREF(lit_26),YPfalse,YPfalse);
