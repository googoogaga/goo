...
loop:
  ...
  next_metsF3733 = T2;
  T6 = CALL1(1,VARREF(Yhead),next_metsF3733);
  T7 = CALL1(1,VARREF(Ytail),next_metsF3733);
  T5 = CALL4(1,VARREF(YgooSmacrosYnapp),T6,T7,c_,args_);
  T1 = T5;
  eventF3734 = T1;
  T13 = CALL1(1,VARREF(YtimeSeventYevent_name),eventF3734);
  tmpF3735 = T13;
  if (tmpF3735 != YPfalse) {
    T14 = tmpF3735;
  } else {
  ...
  xF3736 = T9;
  T15 = (P)YPtag_into(xF3736,(P)3);
  T8 = T15;
  CALL2(1,VARREF(YtimeSeventYevent_handle_setter),T8,eventF3734);
  T0 = eventF3734;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  xF3740 = T3;
  T4 = (P)YPuntag_into(xF3740);
  T2 = T4;
  T6 = CALL1(1,VARREF(YtimeSlockYlock_handle),l_);
  xF3741 = T6;
  T7 = (P)YPuntag_into(xF3741);
  T5 = T7;
...
loop:
  T3 = CALL1(1,VARREF(YtimeSeventYevent_handle),e_);
  xF3742 = T3;
  T4 = (P)YPuntag_into(xF3742);
  T2 = T4;
  T6 = CALL1(1,VARREF(YtimeSlockYlock_handle),l_);
  xF3743 = T6;
  T7 = (P)YPuntag_into(xF3743);
  T5 = T7;
  T8 = (P)YPfu(secs_);
