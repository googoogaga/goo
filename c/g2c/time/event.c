...
loop:
  T2 = (P)YPnext_methods();
  next_metsF2628 = T2;
  if (next_metsF2628 != YPfalse) {
    T5 = CALL1(1,VARREF(Yhead),next_metsF2628);
    T6 = CALL1(1,VARREF(Ytail),next_metsF2628);
  ...
  T1 = T3;
  eventF2629 = T1;
  T13 = CALL1(1,VARREF(YtimeSeventYevent_name),eventF2629);
  tmpF2630 = T13;
  if (tmpF2630 != YPfalse) {
    T14 = tmpF2630;
  } else {
  ...
  T8 = (P)YPlb(T9);
  CALL2(1,VARREF(YtimeSeventYevent_handle_setter),T8,eventF2629);
  T0 = eventF2629;
UNLINK_STACK();
  RET(T0);
}
