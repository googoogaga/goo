...
loop:
  T2 = (P)YPnext_methods();
  next_metsF2656 = T2;
  if (next_metsF2656 != YPfalse) {
    T5 = CALL1(1,VARREF(Yhead),next_metsF2656);
    T6 = CALL1(1,VARREF(Ytail),next_metsF2656);
  ...
  T1 = T3;
  eventF2657 = T1;
  T13 = CALL1(1,VARREF(YtimeSeventYevent_name),eventF2657);
  tmpF2658 = T13;
  if (tmpF2658 != YPfalse) {
    T14 = tmpF2658;
  } else {
  ...
  T8 = (P)YPlb(T9);
  CALL2(1,VARREF(YtimeSeventYevent_handle_setter),T8,eventF2657);
  T0 = eventF2657;
UNLINK_STACK();
  RET(T0);
}
