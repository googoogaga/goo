...
loop:
  T2 = (P)YPnext_methods();
  next_metsF3456 = T2;
  if (next_metsF3456 != YPfalse) {
    T5 = CALL1(1,VARREF(Yhead),next_metsF3456);
    T6 = CALL1(1,VARREF(Ytail),next_metsF3456);
  ...
  T1 = T3;
  eventF3457 = T1;
  T13 = CALL1(1,VARREF(YtimeSeventYevent_name),eventF3457);
  tmpF3458 = T13;
  if (tmpF3458 != YPfalse) {
    T14 = tmpF3458;
  } else {
  ...
  xF3459 = T9;
  T15 = (P)YPtag_into(xF3459,(P)3);
  T8 = T15;
  CALL2(1,VARREF(YtimeSeventYevent_handle_setter),T8,eventF3457);
  T0 = eventF3457;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  xF3463 = T3;
  T4 = (P)YPuntag_into(xF3463);
  T2 = T4;
  T6 = CALL1(1,VARREF(YtimeSlockYlock_handle),l_);
  xF3464 = T6;
  T7 = (P)YPuntag_into(xF3464);
  T5 = T7;
...
loop:
  T3 = CALL1(1,VARREF(YtimeSeventYevent_handle),e_);
  xF3465 = T3;
  T4 = (P)YPuntag_into(xF3465);
  T2 = T4;
  T6 = CALL1(1,VARREF(YtimeSlockYlock_handle),l_);
  xF3466 = T6;
  T7 = (P)YPuntag_into(xF3466);
  T5 = T7;
  T8 = (P)YPfu(secs_);
...
loop:
  ...
  lit_13 = YPPsym((P)"e");
  T32 = YPsig(YPPlist(1,LITREF(lit_13)),YPPlist(1,VARREF(YtimeSeventYLeventG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  ...
  lit_14 = YPPsym((P)"event-broadcast");
  T37 = YPsig(YPPlist(1,LITREF(lit_13)),YPPlist(1,VARREF(YtimeSeventYLeventG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_event_broadcast_7 = YPmet(FUNCODEREF(fun_event_broadcast_7),LITREF(lit_14),T37,ENVNUL,PNUL,YPfalse);
  ...
  fun_event_reset_8 = YPmet(FUNCODEREF(fun_event_reset_8),LITREF(lit_15),T42,ENVNUL,PNUL,YPfalse);
  ...
  lit_16 = YPPsym((P)"event-wait");
  lit_17 = YPPsym((P)"l");
  T47 = YPsig(YPPlist(2,LITREF(lit_13),LITREF(lit_17)),YPPlist(2,VARREF(YtimeSeventYLeventG),VARREF(YtimeSlockYLlockG)),YPfalse,YPint((P)2),VARREF(YLlogG),Ynil);
  fun_event_wait_9 = YPmet(FUNCODEREF(fun_event_wait_9),LITREF(lit_16),T47,ENVNUL,PNUL,YPfalse);
  ...
  T52 = YPsig(YPPlist(3,LITREF(lit_13),LITREF(lit_17),LITREF(lit_19)),YPPlist(3,VARREF(YtimeSeventYLeventG),VARREF(YtimeSlockYLlockG),VARREF(YLfloG)),YPfalse,YPint((P)3),VARREF(YLlogG),Ynil);
