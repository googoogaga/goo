...
LINK_STACK();
  ...
  next_metsF5207 = T9;
  T7 = CALL1(1,VARREF(Yhead),next_metsF5207);
  T8 = CALL1(1,VARREF(Ytail),next_metsF5207);
  T6 = CALL4(1,VARREF(YgooSmacrosYnapp),T7,T8,c_,args_);
  eventF5208 = T6;
  T5 = CALL1(1,VARREF(YtimeSeventYevent_name),eventF5208);
  tmpF5209 = T5;
  if (tmpF5209 != YPfalse) {
    T4 = tmpF5209;
  } else {
  ...
  xF5210 = T1;
  T0 = (P)YPtag_into(xF5210,(P)3);
  CALL2(1,VARREF(YtimeSeventYevent_handle_setter),T0,eventF5208);
UNLINK_STACK();
  RET(eventF5208);
}
...
LINK_STACK();
  ...
  xF5214 = T3;
  T2 = (P)YPuntag_into(xF5214);
  T5 = CALL1(1,VARREF(YtimeSlockYlock_handle),l_);
  xF5215 = T5;
  T4 = (P)YPuntag_into(xF5215);
...
LINK_STACK();
  ...
  T3 = CALL1(1,VARREF(YtimeSeventYevent_handle),e_);
  xF5216 = T3;
  T2 = (P)YPuntag_into(xF5216);
  T5 = CALL1(1,VARREF(YtimeSlockYlock_handle),l_);
  xF5217 = T5;
  T4 = (P)YPuntag_into(xF5217);
  T6 = (P)YPfu(secs_);
