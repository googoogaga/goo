...
loop:
  T2 = (P)YPnext_methods();
  next_metsF3764 = T2;
  tmpF3765 = next_metsF3764;
  if (tmpF3765 != YPfalse) {
    xF3766 = next_metsF3764;
    yF3767 = Ynil;
    T9 = (P)YPeqQ(xF3766,yF3767);
    T8 = (P)YPbb(T9);
    T7 = T8;
    xF3768 = T7;
    T11 = (P)YPeqQ(xF3768,YPfalse);
    T10 = (P)YPbb(T11);
    T6 = T10;
    T5 = T6;
  } else {
  ...
  T4 = T5;
  if (T4 != YPfalse) {
    T13 = CALL1(1,VARREF(Yhead),next_metsF3764);
    T14 = CALL1(1,VARREF(Ytail),next_metsF3764);
  ...
  T1 = T3;
  eventF3769 = T1;
  T23 = CALL1(1,VARREF(YtimeSeventYevent_name),eventF3769);
  tmpF3770 = T23;
  if (tmpF3770 != YPfalse) {
    T24 = tmpF3770;
  } else {
  ...
  xF3771 = T19;
  T25 = (P)YPtag_into(xF3771,(P)3);
  T18 = T25;
  CALL2(1,VARREF(YtimeSeventYevent_handle_setter),T18,eventF3769);
  T0 = eventF3769;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  xF3775 = T3;
  T4 = (P)YPuntag_into(xF3775);
  T2 = T4;
  T6 = CALL1(1,VARREF(YtimeSlockYlock_handle),l_);
  xF3776 = T6;
  T7 = (P)YPuntag_into(xF3776);
  T5 = T7;
...
loop:
  T3 = CALL1(1,VARREF(YtimeSeventYevent_handle),e_);
  xF3777 = T3;
  T4 = (P)YPuntag_into(xF3777);
  T2 = T4;
  T6 = CALL1(1,VARREF(YtimeSlockYlock_handle),l_);
  xF3778 = T6;
  T7 = (P)YPuntag_into(xF3778);
  T5 = T7;
  T8 = (P)YPfu(secs_);
