...
LINK_STACK();
  ...
  next_metsF5397 = T9;
  T7 = CALL1(1,VARREF(Yhead),next_metsF5397);
  T8 = CALL1(1,VARREF(Ytail),next_metsF5397);
  T6 = CALL4(1,VARREF(YgooSmacrosYnapp),T7,T8,c_,args_);
  eventF5398 = T6;
  T5 = CALL1(1,VARREF(YtimeSeventYevent_name),eventF5398);
  tmpF5399 = T5;
  if (tmpF5399 != YPfalse) {
    T4 = tmpF5399;
  } else {
  ...
  xF5400 = T1;
  T0 = (P)YPtag_into(xF5400,(P)3);
  CALL2(1,VARREF(YtimeSeventYevent_handle_setter),T0,eventF5398);
UNLINK_STACK();
  RET(eventF5398);
}
...
LINK_STACK();
  ...
  xF5404 = T3;
  T2 = (P)YPuntag_into(xF5404);
  T5 = CALL1(1,VARREF(YtimeSlockYlock_handle),l_);
  xF5405 = T5;
  T4 = (P)YPuntag_into(xF5405);
...
LINK_STACK();
  ...
  T3 = CALL1(1,VARREF(YtimeSeventYevent_handle),e_);
  xF5406 = T3;
  T2 = (P)YPuntag_into(xF5406);
  T5 = CALL1(1,VARREF(YtimeSlockYlock_handle),l_);
  xF5407 = T5;
  T4 = (P)YPuntag_into(xF5407);
  T6 = (P)YPfu(secs_);
