...
DEFCREGS();
  ...
  fileF4165 = T2;
  if (fileF4165 != YPfalse) {
    T1 = XCALL2(1,VARREF(YevalStopYload_file),fileF4165,LITREF(lit_10));
    T0 = T1;
  } else {
    T0 = YPfalse;
  }
  ...
  fileF4166 = T5;
  if (fileF4166 != YPfalse) {
    T4 = XCALL2(1,VARREF(YevalStopYload_file),fileF4166,LITREF(lit_10));
    T3 = T4;
  } else {
    T3 = YPfalse;
  }
