...
LOCFOR(fun_x_1433_110);
LOCFOR(fun_111);
LOCFOR(fun_112);
LOCFOR(fun_x_1437_113);
LOCFOR(fun_114);
LOCFOR(fun_115);
...
LOCFOR(fun_x_1439_211);
LOCFOR(fun_ast_walkX_212);
LOCFOR(fun_x_1441_213);
...
LINK_STACK();
  ARG(return_, 0);
loop:
  T1 = FUNSHELL(0,fun_x_1427_0,2);
  x_1427F2433 = T1;
  FUNINIT(x_1427F2433, 2,FREEREF(0),return_);
  x_1426F2434 = FREEREF(0);
  dependentF2435 = YPfalse;
  dependentF2435 = BOXFAB(dependentF2435);
  bodyF2436 = YPfalse;
  bodyF2436 = BOXFAB(bodyF2436);
  T7 = CALL2(1,VARREF(YisaQ),x_1426F2434,VARREF(YLlstG));
  if (T7 != YPfalse) {
    T9 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1426F2434,LITREF(lit_5),x_1427F2433);
    x_1426F2437 = T9;
    T11 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1426F2437,x_1427F2433);
    BOXVAL(dependentF2435) = T11;
    T12 = CALL1(1,VARREF(Ytail),x_1426F2437);
    x_1426F2438 = T12;
    BOXVAL(bodyF2436) = x_1426F2438;
    x_1426F2439 = Ynil;
    T14 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1426F2439,x_1427F2433);
    T13 = T14;
    T10 = T13;
    T8 = T10;
  } else {
    T15 = CALL2(1,x_1427F2433,LITREF(lit_6),x_1426F2434);
  }
  T17 = CALL0(1,VARREF(YgooSmacrosYgensym));
  saved_dependentF2440 = T17;
  T19 = CALL1(1,VARREF(Ylst),LITREF(lit_7));
  T24 = CALL1(1,VARREF(Ylst),saved_dependentF2440);
  ...
  T43 = CALL1(1,VARREF(Ylst),saved_dependentF2440);
...
loop:
  ...
  modF2441 = T1;
  if (modF2441 != YPfalse) {
    T3 = CALL1(1,VARREF(YevalSastYmodule_name),modF2441);
    T2 = T3;
  } else {
...
loop:
  ...
  bF2442 = T1;
  x_1428F2443 = bF2442;
  x_1429F2444 = VARREF(YisaQ);
  T5 = CALL2(1,x_1429F2444,x_1428F2443,VARREF(YLsymG));
  if (T5 != YPfalse) {
    T6 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLstrG),bF2442);
    T4 = T6;
  } else {
    T8 = CALL2(1,x_1429F2444,x_1428F2443,VARREF(YevalSastYLmodule_bindingG));
    if (T8 != YPfalse) {
      T10 = CALL1(1,VARREF(YevalSastYbinding_module_name),bF2442);
      T11 = CALL1(1,VARREF(YevalSastYbinding_name),bF2442);
...
loop:
  ...
  if (T3 != YPfalse) {
    T4 = CALL3(1,VARREF(YgooSconditionsYmsg),VARREF(YgooSioSportYout),LITREF(lit_242),nameF2445);
    T2 = T4;
  } else {
    T6 = CALL2(1,VARREF(YevalSdependencyYdependency_includes_anyQ),dtype_,VARREF(YevalSdependencyYDoptimizaton_dependencies));
    if (T6 != YPfalse) {
      T7 = CALL3(1,VARREF(YgooSconditionsYmsg),VARREF(YgooSioSportYout),LITREF(lit_243),nameF2445);
      T5 = T7;
    } else {
      if (YPtrue != YPfalse) {
        T9 = CALL3(1,VARREF(YgooSconditionsYmsg),VARREF(YgooSioSportYout),LITREF(lit_244),nameF2445);
        T8 = T9;
      } else {
        T8 = YPfalse;
      }
...
loop:
  ...
  loopF2446 = T1;
  FUNINIT(loopF2446, 1,loopF2446);
  T2 = CALL2(0,loopF2446,Ynil,e_);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}

FUNCODEDEF(fun_x_1433_110) {
  P msg_,args_;
  P T0,T1;
  P a1,a2;
LINK_STACK();
...
LINK_STACK();
  ARG(return_, 0);
loop:
  T1 = FUNSHELL(0,fun_x_1433_110,2);
  x_1433F2447 = T1;
  FUNINIT(x_1433F2447, 2,FREEREF(0),return_);
  x_1432F2448 = FREEREF(0);
  nameF2449 = YPfalse;
  nameF2449 = BOXFAB(nameF2449);
  supersF2450 = YPfalse;
  supersF2450 = BOXFAB(supersF2450);
  T7 = CALL2(1,VARREF(YisaQ),x_1432F2448,VARREF(YLlstG));
  if (T7 != YPfalse) {
    T9 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1432F2448,LITREF(lit_254),x_1433F2447);
    x_1432F2451 = T9;
    T11 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1432F2451,x_1433F2447);
    BOXVAL(nameF2449) = T11;
    T12 = CALL1(1,VARREF(Ytail),x_1432F2451);
    x_1432F2452 = T12;
    T14 = CALL2(1,VARREF(YgooSmacrosYmatch_sublist),x_1432F2452,x_1433F2447);
    x_1432F2453 = T14;
    BOXVAL(supersF2450) = x_1432F2453;
    x_1432F2454 = Ynil;
    T16 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1432F2454,x_1433F2447);
    T15 = T16;
    T17 = CALL1(1,VARREF(Ytail),x_1432F2452);
    x_1432F2455 = T17;
    T18 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1432F2455,x_1433F2447);
    T13 = T18;
    T10 = T13;
    T8 = T10;
  } else {
    T19 = CALL2(1,x_1433F2447,LITREF(lit_6),x_1432F2448);
  }
  T22 = BOXVAL(nameF2449);
  T21 = CALL3(1,VARREF(YgooSmacrosYcat_sym),LITREF(lit_255),T22,LITREF(lit_256));
  classF2456 = T21;
  T25 = BOXVAL(nameF2449);
  ...
  T31 = CALL1(1,VARREF(Ylst),classF2456);
  T34 = CALL1(1,VARREF(Ylst),LITREF(lit_260));
  T35 = BOXVAL(supersF2450);
  ...
  T39 = CALL1(1,VARREF(Ylst),DemptyF2457);
  T42 = CALL1(1,VARREF(Ylst),LITREF(lit_262));
  T43 = CALL1(1,VARREF(Ylst),classF2456);
  ...
  T56 = CALL1(1,VARREF(Ylst),classF2456);
  ...
  T73 = CALL1(1,VARREF(Ylst),classF2456);
...
LINK_STACK();
  ARG(return_, 0);
loop:
  T1 = FUNSHELL(0,fun_x_1437_113,2);
  x_1437F2458 = T1;
  FUNINIT(x_1437F2458, 2,FREEREF(0),return_);
  x_1436F2459 = FREEREF(0);
  nameF2460 = YPfalse;
  nameF2460 = BOXFAB(nameF2460);
  T5 = CALL2(1,VARREF(YisaQ),x_1436F2459,VARREF(YLlstG));
  if (T5 != YPfalse) {
    T7 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1436F2459,LITREF(lit_277),x_1437F2458);
    x_1436F2461 = T7;
    T9 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1436F2461,x_1437F2458);
    BOXVAL(nameF2460) = T9;
    T10 = CALL1(1,VARREF(Ytail),x_1436F2461);
    x_1436F2462 = T10;
    T11 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1436F2462,x_1437F2458);
    T8 = T11;
    T6 = T8;
  } else {
    T12 = CALL2(1,x_1437F2458,LITREF(lit_6),x_1436F2459);
  }
  T14 = CALL1(1,VARREF(Ylst),LITREF(lit_254));
  T16 = BOXVAL(nameF2460);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    propF2463 = T4;
    T6 = CALL1(1,VARREF(Yprop_getter),propF2463);
    getterF2464 = T6;
    T8 = CALL1(1,VARREF(Yprop_setter),propF2463);
    setterF2465 = T8;
    T10 = CALL2(1,VARREF(YgooSmacrosYEE),getterF2464,VARREF(YevalSastYbinding_value));
    T9 = CALL1(1,VARREF(Ynot),T10);
    if (T9 != YPfalse) {
      T12 = CALL2(1,VARREF(Yprop_boundQ),FREEREF(0),getterF2464);
      if (T12 != YPfalse) {
        T14 = CALL1(1,getterF2464,FREEREF(0));
        xF2466 = T14;
        T16 = CALL2(1,VARREF(YisaQ),xF2466,VARREF(YevalSastYLprogramG));
        if (T16 != YPfalse) {
          T18 = CALL4(1,VARREF(YgooSmacrosYnapp),FREEREF(1),YPfalse,xF2466,FREEREF(2));
          T17 = CALL2(1,setterF2465,T18,FREEREF(0));
          T15 = T17;
        } else {
          T15 = YPfalse;
        }
...
LINK_STACK();
  ...
  NARGS(args_, 2);
loop:
  T0 = FUNSHELL(1,fun_x_1439_211,4);
  x_1439F2467 = T0;
  FUNINIT(x_1439F2467, 4,o_,g_,args_,x_1439F2467);
  T3 = CALL1(1,VARREF(Yobject_props),o_);
  T2 = CALL1(1,VARREF(YgooScolsScolYenum),T3);
  T1 = CALL1(0,x_1439F2467,T2);
UNLINK_STACK();
  QRET(o_);
}

FUNCODEDEF(fun_x_1441_213) {
  P x_1440_;
  P xF2470;
  P getterF2469;
  P propF2468;
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    propF2468 = T4;
    T6 = CALL1(1,VARREF(Yprop_getter),propF2468);
    getterF2469 = T6;
    T8 = CALL2(1,VARREF(YgooSmacrosYEE),getterF2469,VARREF(YevalSastYbinding_value));
    T7 = CALL1(1,VARREF(Ynot),T8);
    if (T7 != YPfalse) {
      T10 = CALL2(1,VARREF(Yprop_boundQ),FREEREF(0),getterF2469);
      if (T10 != YPfalse) {
        T12 = CALL1(1,getterF2469,FREEREF(0));
        xF2470 = T12;
        T14 = CALL2(1,VARREF(YisaQ),xF2470,VARREF(YevalSastYLprogramG));
        if (T14 != YPfalse) {
          T15 = CALL4(1,VARREF(YgooSmacrosYnapp),FREEREF(1),YPfalse,xF2470,FREEREF(2));
          T13 = T15;
        } else {
          T13 = YPfalse;
        }
...
LINK_STACK();
  ...
  NARGS(args_, 2);
loop:
  T0 = FUNSHELL(1,fun_x_1441_213,4);
  x_1441F2471 = T0;
  FUNINIT(x_1441F2471, 4,o_,g_,args_,x_1441F2471);
  T3 = CALL1(1,VARREF(Yobject_props),o_);
  T2 = CALL1(1,VARREF(YgooScolsScolYenum),T3);
  T1 = CALL1(0,x_1441F2471,T2);
UNLINK_STACK();
  QRET(o_);
}
...
loop:
  ...
  copyF2472 = T1;
  CALL2(1,VARREF(YevalSastYprogram_register_setter),YPfalse,copyF2472);
  T2 = CALL2(1,VARREF(YevalSastYast_walkX),VARREF(YevalSastYast_copy),copyF2472);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    T3 = (P)YPnext_methods();
    next_metsF2473 = T3;
    tmpF2474 = next_metsF2473;
    if (tmpF2474 != YPfalse) {
      xF2475 = next_metsF2473;
      yF2476 = Ynil;
      T10 = (P)YPeqQ(xF2475,yF2476);
      T9 = (P)YPbb(T10);
      T8 = T9;
      xF2477 = T8;
      T12 = (P)YPeqQ(xF2477,YPfalse);
      T11 = (P)YPbb(T12);
      T7 = T11;
      T6 = T7;
    } else {
    ...
    T5 = T6;
    if (T5 != YPfalse) {
      T14 = CALL1(1,VARREF(Yhead),next_metsF2473);
      T15 = CALL1(1,VARREF(Ytail),next_metsF2473);
...
loop:
  ...
  refF2480 = T1;
  T2 = CALL3(1,VARREF(Ynew),VARREF(YevalSastYLboundQG),VARREF(YevalSastYboundQ_reference),refF2480);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  modF2481 = T1;
  T3 = CALL1(1,VARREF(YevalSastYmodule_syntax_environment),modF2481);
  syntax_envF2482 = T3;
  T5 = CALL1(1,VARREF(YevalSastYmodule_target_environment),modF2481);
  target_envF2483 = T5;
  T7 = CALL3(1,VARREF(YevalSastYobjectify),program_,syntax_envF2482,tailQ_);
  astF2484 = T7;
  CALL1(1,VARREF(YevalSastYast_evaluate),astF2484);
  tmpF2485 = rtQ_;
  if (tmpF2485 != YPfalse) {
    T11 = CALL2(1,VARREF(YgooSmathYNEE),syntax_envF2482,target_envF2483);
    T10 = T11;
  } else {
    T10 = YPfalse;
  }
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    if (T4 != YPfalse) {
      ...
      loopF2486 = T8;
      FUNINIT(loopF2486, 1,loopF2486);
      T9 = CALL1(0,loopF2486,eT_);
      T7 = T9;
      T3 = T7;
    }
    T0 = T3;
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    eF2487 = T3;
    T5 = CALL1(1,VARREF(YevalSsyntaxYsexpr_defQ),eF2487);
    if (T5 != YPfalse) {
      T9 = CALL1(1,VARREF(Ylst),LITREF(lit_7));
      T15 = CALL1(1,VARREF(YevalSsyntaxYsexpr_def_variable),eF2487);
      T14 = CALL1(1,VARREF(Ylst),T15);
      T17 = CALL1(1,VARREF(YevalSsyntaxYsexpr_def_value),eF2487);
      ...
      T21 = CALL1(1,VARREF(Ylst),eF2487);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    T8 = CALL3(1,VARREF(YevalSastYobjectify),T9,FREEREF(1),tailQF2488);
    headF2489 = T8;
    T11 = CALL2(1,VARREF(YgooSmacrosYpair),headF2489,res_);
...
loop:
  ...
  loopF2490 = T2;
  FUNINIT(loopF2490, 3,tailQ_,r_,loopF2490);
  T4 = CALL1(1,VARREF(YevalSastYtransform_defs),eT_);
  T3 = CALL2(0,loopF2490,Ynil,T4);
  T1 = T3;
  astsF2491 = T1;
  T5 = CALL1(1,VARREF(YevalSastYsequentialize),astsF2491);
  T0 = T5;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  eeTF2492 = T1;
  T4 = CALL4(1,VARREF(YevalSastYprocess_closed_application),ff_,eeTF2492,r_,tailQ_);
  T0 = T4;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  fvfF2494 = T5;
  T7 = CALL1(1,VARREF(YevalSastYbinding_prop),fvfF2494);
  primF2495 = T7;
  if (primF2495 != YPfalse) {
    T10 = CALL1(1,VARREF(YevalSastYast_copy),primF2495);
    T9 = CALL4(1,VARREF(YevalSastYprocess_closed_application),T10,eeTF2493,r_,tailQ_);
    T8 = T9;
  } else {
    T11 = CALLN(1,VARREF(Ynew),7,VARREF(YevalSastYLpredefined_applicationG),VARREF(YevalSastYapplication_binding),fvfF2494,VARREF(YevalSastYapplication_arguments),eeTF2493,VARREF(YevalSastYapplication_tailQ),tailQ_);
    T8 = T11;
  }
  T6 = T8;
  T4 = T6;
...
loop:
  ...
  T6 = CALLN(1,VARREF(Ynew),7,VARREF(YevalSastYLregular_applicationG),VARREF(YevalSastYapplication_function),ff_,VARREF(YevalSastYapplication_arguments),eeTF2496,VARREF(YevalSastYapplication_tailQ),tailQ_);
  T0 = T6;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  varF2499 = T1;
  T3 = CALL1(1,VARREF(YevalSastYbinding_dottedQ),varF2499);
  if (T3 != YPfalse) {
    T5 = CALL3(1,VARREF(YevalSastYobjectify),LITREF(lit_260),FREEREF(0),YPfalse);
    lst_typeF2500 = T5;
    CALL2(1,VARREF(YevalSastYbinding_dottedQ_setter),YPfalse,varF2499);
    CALL2(1,VARREF(YevalSastYbinding_type_setter),lst_typeF2500,varF2499);
    CALL2(1,VARREF(Yhead_setter),lst_typeF2500,tT_);
...
loop:
  ...
  pack_nary_argsF2501 = T1;
  T2 = FUNSHELL(1,fun_pack_args_264,4);
  pack_argsF2502 = T2;
  FUNINIT(pack_nary_argsF2501, 1,pack_nary_argsF2501);
  FUNINIT(pack_argsF2502, 4,r_,pack_nary_argsF2501,f_,pack_argsF2502);
  ...
  T8 = CALL3(0,pack_argsF2502,eT_,vTF2503,T9);
  T10 = CALL1(1,VARREF(YevalSastYfunction_body),f_);
  T6 = CALLN(1,VARREF(Ynew),9,VARREF(YevalSastYLfix_letG),VARREF(YevalSastYfix_let_bindings),vTF2503,VARREF(YevalSastYfix_let_types),T7,VARREF(YevalSastYfix_let_arguments),T8,VARREF(YevalSastYfix_let_body),T10);
  oF2504 = T6;
  T5 = oF2504;
  T3 = T5;
  T0 = T3;
...
loop:
  ...
  opF2505 = T1;
  T3 = CALL1(1,VARREF(YevalSsyntaxYsexpr_variableQ),opF2505);
  if (T3 != YPfalse) {
    T7 = CALL1(1,VARREF(YevalSsyntaxYsexpr_fab_setter_name),opF2505);
...
loop:
  ...
  valF2507 = T3;
  T4 = CALL2(1,VARREF(YevalSastYobjectify_assignment_using),refF2506,valF2507);
  T2 = T4;
  T0 = T2;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  existing_bindingF2509 = T1;
  T3 = CALL1(1,VARREF(YevalSastYfind_static_global_environment),r_);
  grF2510 = T3;
  T5 = CALL1(1,VARREF(YevalSastYenvironment_module),grF2510);
  modF2511 = T5;
  if (existing_bindingF2509 != YPfalse) {
    T11 = CALL2(1,VARREF(YevalSastYbinding_native_toQ),existing_bindingF2509,modF2511);
    tmpF2512 = T11;
    if (tmpF2512 != YPfalse) {
      T12 = tmpF2512;
    } else {
    ...
    T9 = CALL1(1,VARREF(Ynot),T10);
    foreignQF2513 = T9;
    T13 = CALL1(1,VARREF(YevalSastYbinding_freeQ),existing_bindingF2509);
    if (T13 != YPfalse) {
      CALL2(1,VARREF(YevalSastYbinding_freeQ_setter),YPfalse,existing_bindingF2509);
      if (foreignQF2513 != YPfalse) {
        T15 = CALL1(1,VARREF(YevalSastYtransaction_register_implemented_binding),existing_bindingF2509);
        T14 = T15;
      } else {
        T14 = YPfalse;
      }
      ...
      if (foreignQF2513 != YPfalse) {
        T18 = CALL1(1,VARREF(YevalSastYmodule_name),modF2511);
        T19 = CALL1(1,VARREF(YevalSastYbinding_module_name),existing_bindingF2509);
    ...
    CALL2(1,VARREF(YevalSdependencyYinvalidate_dependents),existing_bindingF2509,VARREF(YevalSdependencyYDall_dependency_types));
    CALL2(1,VARREF(YevalSastYupdate_binding_kind),existing_bindingF2509,kind_);
    T8 = existing_bindingF2509;
    T7 = T8;
  } else {
    T21 = CALL1(1,VARREF(YevalSastYfind_environment_module),r_);
    modF2514 = T21;
    T23 = CALLN(1,VARREF(Ynew),9,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),kind_,VARREF(YevalSastYbinding_name),name_,VARREF(YevalSastYbinding_freeQ),YPfalse,VARREF(YevalSastYbinding_module),modF2514);
    bindingF2515 = T23;
    CALL2(1,VARREF(YevalSastYinsert_globalX),bindingF2515,grF2510);
    T22 = bindingF2515;
    T20 = T22;
    T7 = T20;
  }
...
loop:
  ...
  nameF2517 = T1;
  T3 = CALL4(1,VARREF(YevalSastYast_define_binding),r_,nameF2517,YPfalse,kind_);
  bindingF2518 = T3;
  T6 = CALL3(1,VARREF(YevalSastYobjectify),e_,r_,YPfalse);
  T5 = CALL5(1,VARREF(Ynew),type_,VARREF(YevalSastYassignment_binding),bindingF2518,VARREF(YevalSastYassignment_form),T6);
  defnF2519 = T5;
  T4 = defnF2519;
  T2 = T4;
  T0 = T2;
...
loop:
  ...
  if (VARREF(YevalSastYTmacro_tracingQT) != YPfalse) {
    ...
    CALL2(1,VARREF(YgooSioSwriteYwrite),VARREF(YgooSioSportYout),expF2520);
...
loop:
  ...
  expandF2521 = T1;
  FUNINIT(expandF2521, 1,expander_);
  tmpF2522 = env_or_false_;
  if (tmpF2522 != YPfalse) {
    T4 = tmpF2522;
  } else {
  ...
  T3 = T4;
  envF2523 = T3;
  T7 = CALL4(1,VARREF(YevalSastYast_define_binding),envF2523,name_,YPfalse,LITREF(lit_606));
  bindingF2524 = T7;
  CALL2(1,VARREF(YevalSastYbinding_handler_setter),expandF2521,bindingF2524);
  T6 = bindingF2524;
  T2 = T6;
  T0 = T2;
UNLINK_STACK();
...
loop:
  ...
  sep_expanderF2525 = T1;
  T3 = CALL1(1,VARREF(YevalSastYfind_syntax_environment),r_);
  syntax_envF2526 = T3;
  T5 = CALL3(1,VARREF(YevalSastYobjectify),sep_expanderF2525,syntax_envF2526,YPfalse);
  ast_expanderF2527 = T5;
  T7 = CALL1(1,VARREF(YevalSastYast_evaluate),ast_expanderF2527);
  expanderF2528 = T7;
  ...
  T12 = CALL4(1,VARREF(YPPmacro),modnameF2529,name_,expanderF2528,T13);
  bindingF2530 = T12;
  T15 = CALL1(1,VARREF(YevalSastYfind_static_global_environment),r_);
  T14 = CALL2(1,VARREF(YgooSmathYNEE),syntax_envF2526,T15);
  if (T14 != YPfalse) {
    T16 = CALL2(1,VARREF(YevalSastYinsert_globalX),bindingF2530,syntax_envF2526);
  } else {
  }
  if (rtQ_ != YPfalse) {
    T19 = CALL3(1,VARREF(YevalSastYobjectify),sep_expanderF2525,r_,YPfalse);
    T18 = CALL5(1,VARREF(Ynew),VARREF(YevalSastYLast_macro_definitionG),VARREF(YevalSastYassignment_binding),bindingF2530,VARREF(YevalSastYassignment_form),T19);
    T17 = T18;
  } else {
...
loop:
  ...
  T3 = CALL3(1,VARREF(YevalSastYobjectify),e_,r_,YPfalse);
  fF2532 = T3;
  CALL2(1,VARREF(YevalSastYfunction_binding_setter),bindingF2531,fF2532);
  T4 = CALL2(1,VARREF(YevalSastYobjectify_quotation),name_,r_);
  CALL2(1,VARREF(YevalSastYfunction_debug_name_setter),T4,fF2532);
  T6 = CALL5(1,VARREF(Ynew),VARREF(YevalSastYLast_function_definitionG),VARREF(YevalSastYassignment_binding),bindingF2531,VARREF(YevalSastYassignment_form),fF2532);
  defnF2533 = T6;
  T5 = defnF2533;
  T2 = T5;
  T0 = T2;
...
loop:
  ...
  signatureF2535 = T3;
  T6 = CALL1(1,VARREF(YevalSastYsignature_bindings),signatureF2535);
  T5 = CALL2(1,VARREF(YevalSastYr_extendT),r_,T6);
  new_rF2536 = T5;
  T8 = CALL3(1,VARREF(YevalSastYobjectify_sequential),body_,new_rF2536,YPtrue);
  bodyF2537 = T8;
  T11 = CALL2(1,VARREF(YevalSastYobjectify_quotation),name_,r_);
  T10 = CALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLast_primitiveG),VARREF(YevalSastYfunction_binding),bindingF2534,VARREF(YevalSastYfunction_adjectives),mods_,VARREF(YevalSastYfunction_debug_name),T11,VARREF(YevalSastYfunction_signature),signatureF2535,VARREF(YevalSastYfunction_body),bodyF2537);
  formF2538 = T10;
  T12 = CALL2(1,VARREF(YgooScolsScolYmemQ),mods_,LITREF(lit_616));
  if (T12 != YPfalse) {
    T13 = CALL2(1,VARREF(YevalSastYbinding_prop_setter),formF2538,bindingF2534);
  } else {
  }
  T15 = CALL5(1,VARREF(Ynew),VARREF(YevalSastYLast_primitive_definitionG),VARREF(YevalSastYassignment_binding),bindingF2534,VARREF(YevalSastYassignment_form),formF2538);
  defnF2539 = T15;
  T14 = defnF2539;
  T9 = T14;
  T7 = T9;
...
loop:
  ...
  T5 = CALLN(1,VARREF(Ynew),7,VARREF(YevalSastYLast_genericG),VARREF(YevalSastYfunction_binding),bindingF2540,VARREF(YevalSastYfunction_debug_name),T6,VARREF(YevalSastYfunction_signature),signatureF2541);
  formF2542 = T5;
  T8 = CALL5(1,VARREF(Ynew),VARREF(YevalSastYLast_generic_definitionG),VARREF(YevalSastYassignment_binding),bindingF2540,VARREF(YevalSastYassignment_form),formF2542);
  defnF2543 = T8;
  T7 = defnF2543;
  T4 = T7;
  T2 = T4;
...
loop:
  ...
  T6 = CALL3(1,VARREF(YevalSastYobjectify),e_,r_,YPfalse);
  metF2546 = T6;
  T8 = CALL3(1,VARREF(Ylst),LITREF(lit_623),genF2545,metF2546);
  callF2547 = T8;
  T10 = CALL3(1,VARREF(YevalSastYobjectify),callF2547,r_,YPfalse);
  formF2548 = T10;
  T12 = CALL5(1,VARREF(Ynew),VARREF(YevalSastYLast_method_definitionG),VARREF(YevalSastYassignment_binding),bindingF2544,VARREF(YevalSastYassignment_form),formF2548);
  defnF2549 = T12;
  CALL2(1,VARREF(YevalSastYfunction_binding_setter),name_,metF2546);
  T13 = CALL2(1,VARREF(YevalSastYobjectify_quotation),name_,r_);
  CALL2(1,VARREF(YevalSastYfunction_debug_name_setter),T13,metF2546);
  T11 = defnF2549;
  T9 = T11;
  T7 = T9;
  T5 = T7;
...
loop:
  ...
  tmpF2550 = DYNREF(YevalSastYTrecord_sourceQT);
  if (tmpF2550 != YPfalse) {
...
loop:
  ...
  x_1443F2551 = DYNREF(YgooSioSwriteYTmax_print_lengthT);
  T2 = FUNFAB(fun_287,3,FREEREF(0),FREEREF(1),FREEREF(2));
  T3 = FUNFAB(fun_288,1,x_1443F2551);
...
LINK_STACK();
  ...
  ARG(r_, 2);
loop:
  x_1442F2552 = DYNREF(YgooSioSwriteYTmax_print_depthT);
  T2 = FUNFAB(fun_289,3,sig_,body_,r_);
  T3 = FUNFAB(fun_290,1,x_1442F2552);
  T1 = with_cleanup(T2,T3);
  T0 = T1;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  signatureF2553 = T1;
  T4 = CALL1(1,VARREF(YevalSastYsignature_bindings),signatureF2553);
  T3 = CALL2(1,VARREF(YevalSastYr_extendT),FREEREF(1),T4);
  new_rF2554 = T3;
  T6 = CALL3(1,VARREF(YevalSastYobjectify_sequential),FREEREF(2),new_rF2554,YPtrue);
  bF2555 = T6;
  ...
  CALL2(1,VARREF(YevalSastYfunction_signature_setter),signatureF2553,FREEREF(3));
  CALL2(1,VARREF(YevalSastYfunction_body_setter),bF2555,FREEREF(3));
...
loop:
  ...
  methodF2556 = T1;
  x_1444F2557 = DYNREF(YevalSastYTcurrent_dependentT);
  DYNSET(YevalSastYTcurrent_dependentT,methodF2556);
  T4 = FUNFAB(fun_292,4,sig_,r_,body_,methodF2556);
  T5 = FUNFAB(fun_293,1,x_1444F2557);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    T19 = CALL3(1,VARREF(YevalSastYobjectify),arityF2561,FREEREF(1),YPfalse);
    T13 = CALLN(1,VARREF(Ynew),13,VARREF(YevalSastYLast_signatureG),VARREF(YevalSastYsignature_bindings),T14,VARREF(YevalSastYsignature_names),T15,VARREF(YevalSastYsignature_specs),T17,VARREF(YevalSastYsignature_naryQ),T18,VARREF(YevalSastYsignature_arity),T19,VARREF(YevalSastYsignature_value),valueF2560);
    T9 = T13;
    T4 = T9;
    T2 = T4;
    T0 = T2;
    ...
    paramF2562 = T21;
    T23 = CALL1(1,VARREF(YevalSsyntaxYsexpr_variable_name),paramF2562);
    snameF2563 = T23;
    T25 = CALL1(1,VARREF(YevalSsyntaxYsexpr_variable_type),paramF2562);
    stypeF2564 = T25;
    T27 = CALL2(1,VARREF(YgooSmacrosYEE),stypeF2564,VARREF(YevalSastYDsexpr_optionals_tag));
    dottedQF2565 = T27;
    if (dottedQF2565 != YPfalse) {
      T29 = VARREF(YevalSastYDsexpr_optionals_type_name);
    } else {
      T29 = stypeF2564;
    }
    stypeF2566 = T29;
    T31 = CALL3(1,VARREF(YevalSastYobjectify),stypeF2566,FREEREF(1),YPfalse);
    typeF2567 = T31;
    T33 = CALLN(1,VARREF(Ynew),7,VARREF(YevalSastYLlocal_bindingG),VARREF(YevalSastYbinding_name),snameF2563,VARREF(YevalSastYbinding_type),typeF2567,VARREF(YevalSastYbinding_dottedQ),dottedQF2565);
    bindingF2568 = T33;
    T35 = CALL1(1,VARREF(Ytail),params_);
    T36 = CALL2(1,VARREF(YgooSmacrosYpair),bindingF2568,bindings_);
    T37 = CALL5(1,VARREF(Ynew),VARREF(YevalSastYLfab_listG),VARREF(Yhead),snameF2563,VARREF(Ytail),names_);
    T38 = CALL5(1,VARREF(Ynew),VARREF(YevalSastYLfab_listG),VARREF(Yhead),typeF2567,VARREF(Ytail),types_);
    a1 = T35;
    a2 = dottedQF2565;
    a3 = T36;
    a4 = T37;
...
loop:
  ...
  sexpr_paramsF2569 = T1;
  T3 = FUNSHELL(1,fun_col_295,3);
  colF2570 = T3;
  FUNINIT(colF2570, 3,sig_,r_,colF2570);
  ...
  T4 = CALL5(0,colF2570,sexpr_paramsF2569,YPfalse,Ynil,T5,T6);
  T2 = T4;
  T0 = T2;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    findF2571 = T3;
    FUNINIT(findF2571, 5,i_,r_,FREEREF(0),FREEREF(1),findF2571);
    T5 = CALL1(1,VARREF(YevalSastYenvironment_bindings),r_);
    T4 = CALL2(0,findF2571,YPint((P)0),T5);
    T2 = T4;
    T0 = T2;
  } else {
...
loop:
  ...
  loopF2572 = T1;
  FUNINIT(loopF2572, 2,loopF2572,binding_);
  T2 = CALL2(0,loopF2572,YPint((P)0),r_);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  tup29F2573 = T1;
  T3 = CALL2(1,VARREF(YgooSmacrosYelt),tup29F2573,YPint((P)0));
  iF2574 = T3;
  T5 = CALL2(1,VARREF(YgooSmacrosYelt),tup29F2573,YPint((P)1));
  jF2575 = T5;
  T6 = CALLN(1,VARREF(Ynew),7,VARREF(YevalSastYLlocal_referenceG),VARREF(YevalSastYreference_binding),b_,VARREF(YevalSastYreference_frame_number),iF2574,VARREF(YevalSastYreference_frame_offset),jF2575);
  T4 = T6;
  T2 = T4;
  T0 = T2;
UNLINK_STACK();
...
loop:
  ...
  x_1445F2576 = T1;
  x_1446F2577 = VARREF(YgooSmacrosYEE);
  T4 = CALL2(1,x_1446F2577,x_1445F2576,LITREF(lit_63));
  if (T4 != YPfalse) {
    T3 = VARREF(YevalSastYLglobal_referenceG);
  } else {
    T6 = CALL2(1,x_1446F2577,x_1445F2576,LITREF(lit_615));
    if (T6 != YPfalse) {
      T5 = VARREF(YevalSastYLpredefined_referenceG);
    } else {
      T8 = CALL2(1,x_1446F2577,x_1445F2576,LITREF(lit_585));
      if (T8 != YPfalse) {
        T7 = VARREF(YevalSastYLruntime_referenceG);
      } else {
        T10 = CALL2(1,x_1446F2577,x_1445F2576,LITREF(lit_597));
        if (T10 != YPfalse) {
          T9 = VARREF(YevalSastYLdynamic_referenceG);
        } else {
          T12 = CALL2(1,x_1446F2577,x_1445F2576,LITREF(lit_606));
          if (T12 != YPfalse) {
            T11 = VARREF(YevalSastYLmacro_referenceG);
          } else {
            T14 = CALL2(1,x_1446F2577,x_1445F2576,LITREF(lit_586));
            if (T14 != YPfalse) {
...
loop:
  ...
  LrefGF2578 = T1;
  T2 = CALL3(1,VARREF(Ynew),LrefGF2578,VARREF(YevalSastYreference_binding),b_);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  grF2579 = T1;
  T4 = CALL1(1,VARREF(YevalSastYenvironment_allows_foreign_namesQ),grF2579);
  tmpF2580 = T4;
  if (tmpF2580 != YPfalse) {
  ...
  if (T3 != YPfalse) {
    ...
    bF2581 = T9;
    CALL2(1,VARREF(YevalSastYinsert_globalX),bF2581,grF2579);
    T11 = CALL3(1,VARREF(Ynew),VARREF(YevalSastYLglobal_referenceG),VARREF(YevalSastYreference_binding),bF2581);
    T8 = T11;
    T2 = T8;
  }
  T0 = T2;
...
loop:
  ...
  namestrF2582 = T1;
  T3 = CALL2(1,VARREF(YgooScolsSseqYpos),namestrF2582,YPchr((P)58));
  breakF2583 = T3;
  T5 = CALL3(1,VARREF(YgooScolsSseqYsub),namestrF2582,YPint((P)0),breakF2583);
  modnameF2584 = T5;
  T8 = CALL2(1,VARREF(YgooSmathYA),YPint((P)1),breakF2583);
  T9 = CALL1(1,VARREF(YgooStypesYlen),namestrF2582);
  T7 = CALL3(1,VARREF(YgooScolsSseqYsub),namestrF2582,T8,T9);
  varnameF2585 = T7;
  T13 = CALL1(1,VARREF(YgooStypesYlen),modnameF2584);
  T12 = CALL2(1,VARREF(YgooSmagYG),T13,YPint((P)0));
  tmpF2586 = T12;
  if (tmpF2586 != YPfalse) {
    T16 = CALL1(1,VARREF(YgooStypesYlen),varnameF2585);
  ...
  grF2587 = T19;
  T21 = CALL1(1,VARREF(YevalSastYenvironment_module_loader),grF2587);
  loaderF2588 = T21;
  T24 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLsymG),modnameF2584);
  T23 = CALL2(1,VARREF(YevalSastYprobe_module),loaderF2588,T24);
  modF2589 = T23;
  T27 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLsymG),varnameF2585);
  T28 = CALL1(1,VARREF(YevalSastYmodule_target_environment),modF2589);
  T26 = CALL2(1,VARREF(YevalSastYfind_binding),T27,T28);
  bindingF2590 = T26;
  CALL2(1,VARREF(YevalSastYinsert_globalX),bindingF2590,grF2587);
  T29 = CALL1(1,VARREF(Ynot),bindingF2590);
  if (T29 != YPfalse) {
    T30 = CALL3(1,VARREF(YevalSastYnamespace_error),LITREF(lit_659),varnameF2585,modnameF2584);
  } else {
  }
  T31 = CALL3(1,VARREF(YevalSastYobjectify_binding),name_,bindingF2590,r_);
  T25 = T31;
  T22 = T25;
  T20 = T22;
  T18 = T20;
...
loop:
  ...
  bindingsF2591 = T1;
  T4 = CALL2(1,VARREF(YevalSastYr_extendT),r_,bindingsF2591);
  new_rF2592 = T4;
  T6 = CALL3(1,VARREF(YgooSmacrosYmap2),VARREF(YevalSsyntaxYsexpr_make_anonymous_method),sigs_,bodies_);
  function_formsF2593 = T6;
  T9 = CALL3(1,VARREF(YgooSruntimeYrcurry),VARREF(YevalSastYobjectify),new_rF2592,YPfalse);
  T8 = CALL2(1,VARREF(YgooSmacrosYmap),T9,function_formsF2593);
  functionsF2594 = T8;
  T10 = FUNFAB(fun_313,1,r_);
  CALL3(1,VARREF(YgooScolsSseqYdo2),T10,functionsF2594,bindingsF2591);
  T12 = CALL4(1,VARREF(YgooSmacrosYnapp),VARREF(YgooSmathYfabs),YPfalse,VARREF(YevalSastYLfunctionsG),functionsF2594);
  T13 = CALL3(1,VARREF(YevalSastYobjectify_sequential),body_,new_rF2592,YPtrue);
  T11 = CALLN(1,VARREF(Ynew),7,VARREF(YevalSastYLlocalsG),VARREF(YevalSastYlocals_bindings),bindingsF2591,VARREF(YevalSastYlocals_functions),T12,VARREF(YevalSastYlocals_body),T13);
  T7 = T11;
  T5 = T7;
  T3 = T5;
  T0 = T3;
...
loop:
  ...
  bindingF2595 = T1;
  T3 = CALL2(1,VARREF(YgooSmacrosYEE),bindingF2595,YPfalse);
  if (T3 != YPfalse) {
    T5 = FUNFAB(fun_321,1,name_);
    T4 = with_exit(T5);
    T2 = T4;
  } else {
    T6 = CALL3(1,VARREF(YevalSastYexport_bindingX),FREEREF(1),name_,bindingF2595);
    T2 = T6;
  }
  T0 = T2;
UNLINK_STACK();
...
loop:
  ...
  moduleF2597 = T3;
  T6 = CALL1(1,VARREF(YevalSastYmodule_target_environment),moduleF2597);
  T5 = CALL2(1,VARREF(YgooSmacrosYEE),envF2596,T6);
  T4 = CALL1(1,VARREF(Ynot),T5);
  if (T4 != YPfalse) {
    T7 = CALL1(1,VARREF(YevalSastYnamespace_error),LITREF(lit_681));
  } else {
  }
  T8 = FUNFAB(fun_322,2,envF2596,moduleF2597);
...
loop:
  ...
  existingF2598 = T1;
  T5 = CALL2(1,VARREF(YgooSmacrosYEE),existingF2598,YPfalse);
  tmpF2599 = T5;
  if (tmpF2599 != YPfalse) {
    T6 = tmpF2599;
  } else {
    T7 = CALL2(1,VARREF(YgooSmacrosYEE),existingF2598,b_);
    T6 = T7;
  }
  T4 = T6;
...
loop:
  ...
  T3 = CALL1(1,VARREF(YevalSastYfind_environment_module),r_);
  moduleF2601 = T3;
  T5 = CALL1(1,VARREF(YevalSastYenvironment_module_loader),envF2600);
  loaderF2602 = T5;
  T7 = CALL2(1,VARREF(YevalSastYprobe_module),loaderF2602,name_);
  used_moduleF2603 = T7;
  T8 = CALL1(1,VARREF(YevalSastYenvironment_uses_modules),envF2600);
  CALL2(1,VARREF(YgooScolsSseqxYpushX),T8,used_moduleF2603);
  T9 = FUNFAB(fun_325,2,envF2600,moduleF2601);
  T10 = CALL1(1,VARREF(YevalSastYmodule_exports),used_moduleF2603);
...
loop:
  T1 = CALL1(1,VARREF(YevalSastYfind_static_global_environment),r_);
  envF2604 = T1;
  T3 = CALL1(1,VARREF(YevalSastYenvironment_module),envF2604);
  modF2605 = T3;
  T6 = FUNFAB(fun_327,1,name_);
  T7 = CALL1(1,VARREF(YevalSastYmodule_uses_c_includes),modF2605);
  T5 = CALL2(1,VARREF(YgooStypesYanyQ),T6,T7);
  T4 = CALL1(1,VARREF(Ynot),T5);
  if (T4 != YPfalse) {
    T9 = CALL1(1,VARREF(YevalSastYmodule_uses_c_includes),modF2605);
...
loop:
  T1 = CALL1(1,VARREF(YevalSastYfind_static_global_environment),r_);
  envF2606 = T1;
  T3 = CALL1(1,VARREF(YevalSastYenvironment_module),envF2606);
  modF2607 = T3;
  T6 = FUNFAB(fun_329,1,name_);
  T7 = CALL1(1,VARREF(YevalSastYmodule_uses_c_libraries),modF2607);
  T5 = CALL2(1,VARREF(YgooStypesYanyQ),T6,T7);
  T4 = CALL1(1,VARREF(Ynot),T5);
  if (T4 != YPfalse) {
    T9 = CALL1(1,VARREF(YevalSastYmodule_uses_c_libraries),modF2607);
    T8 = CALL2(1,VARREF(YgooScolsSseqxYpushX),T9,name_);
  } else {
  }
  T10 = CALL3(1,VARREF(Ynew),VARREF(YevalSastYLconstantG),VARREF(YevalSastYconstant_value),YPfalse);
...
loop:
  ...
  loaderF2608 = T1;
  T3 = CALL2(1,VARREF(YevalSastYprobe_module),loaderF2608,name_);
  used_moduleF2609 = T3;
  T4 = CALL1(1,VARREF(YevalSastYenvironment_uses_modules),FREEREF(0));
  CALL2(1,VARREF(YgooScolsSseqxYpushX),T4,used_moduleF2609);
  T5 = FUNFAB(fun_331,1,FREEREF(0));
  T6 = CALL1(1,VARREF(YevalSastYmodule_exports),used_moduleF2609);
...
loop:
  T1 = CALL1(1,VARREF(YevalSastYfind_static_global_environment),r_);
  envF2610 = T1;
  T3 = CALL1(1,VARREF(YevalSastYenvironment_module),envF2610);
  modF2611 = T3;
  T4 = FUNSHELL(1,fun_use_mod_332,1);
  use_modF2612 = T4;
  T5 = fun_use_c_mod_333;
  use_c_modF2613 = T5;
  FUNINIT(use_modF2612, 1,envF2610);
  T7 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLstrG),name_);
  x_1447F2614 = T7;
  x_1448F2615 = VARREF(YgooScolsSseqYsuffixQ);
  T10 = CALL2(1,x_1448F2615,x_1447F2614,LITREF(lit_706));
  if (T10 != YPfalse) {
    T12 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLsymG),name_);
    T11 = CALL2(0,use_c_modF2613,modF2611,T12);
    T9 = T11;
  } else {
    T14 = CALL2(1,x_1448F2615,x_1447F2614,LITREF(lit_707));
    if (T14 != YPfalse) {
      ...
      T16 = CALL1(0,use_modF2612,T17);
      swig_modF2616 = T16;
      T22 = CALL2(1,VARREF(YgooSmacrosYcat_sym),name_,LITREF(lit_708));
      T21 = CALL2(0,use_c_modF2613,swig_modF2616,T22);
      T15 = T21;
      T13 = T15;
    } else {
      T23 = CALL1(0,use_modF2612,name_);
      T13 = T23;
    }
    T9 = T13;
  }
...
loop:
  ...
  rF2617 = T1;
  T3 = CALL1(1,VARREF(YevalSastYenvironment_bindings),rF2617);
...
loop:
  ...
  T1 = CALL2(1,VARREF(YevalSastYfind_binding),T2,env_);
  existingF2618 = T1;
  T6 = CALL2(1,VARREF(YgooSmacrosYEE),existingF2618,YPfalse);
  tmpF2619 = T6;
  if (tmpF2619 != YPfalse) {
    T7 = tmpF2619;
  } else {
    T8 = CALL2(1,VARREF(YgooSmacrosYEE),existingF2618,b_);
    T7 = T8;
  }
  T5 = T7;
  T4 = CALL1(1,VARREF(Ynot),T5);
  if (T4 != YPfalse) {
    ...
    T9 = CALL4(1,VARREF(YgooSconditionsYmsg),VARREF(YgooSioSportYout),LITREF(lit_713),T10,T12);
  } else {
  }
...
loop:
  ...
  T3 = CALL1(1,VARREF(YevalSastYfind_environment_module),r_);
  moduleF2621 = T3;
  T5 = CALL1(1,VARREF(YevalSastYenvironment_module_loader),envF2620);
  loaderF2622 = T5;
  T7 = CALL2(1,VARREF(YevalSastYprobe_module),loaderF2622,name_);
  used_moduleF2623 = T7;
  T9 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLstrG),mangler_);
  str_manglerF2624 = T9;
  T10 = CALL1(1,VARREF(YevalSastYenvironment_uses_modules),envF2620);
  CALL2(1,VARREF(YgooScolsSseqxYpushX),T10,used_moduleF2623);
  T11 = FUNFAB(fun_337,2,str_manglerF2624,envF2620);
  T12 = CALL1(1,VARREF(YevalSastYmodule_exports),used_moduleF2623);
...
LINK_STACK();
  ...
  ARG(fail_, 2);
loop:
  T0 = CALL2(1,VARREF(Ysyntax_error),LITREF(lit_719),pat_);
UNLINK_STACK();
  QRET(T0);
}
...
LINK_STACK();
  ...
  ARG(fail_, 2);
loop:
  T1 = CALL1(1,VARREF(Ylst),LITREF(lit_721));
...
loop:
  ...
  if (T1 != YPfalse) {
    T2 = CALL2(1,VARREF(Ysyntax_error),LITREF(lit_723),pat_);
    T0 = T2;
  } else {
    T4 = CALL1(1,VARREF(YevalSsyntaxYsexpr_unquote_splicingQ),pat_);
    if (T4 != YPfalse) {
      T5 = CALL2(1,VARREF(Ysyntax_error),LITREF(lit_724),pat_);
      T3 = T5;
    } else {
      if (YPtrue != YPfalse) {
...
LINK_STACK();
  ...
  ARG(fail_, 2);
loop:
  T1 = CALL1(1,VARREF(Ylst),LITREF(lit_730));
  T2 = CALL1(1,VARREF(Ylst),var_);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    T7 = CALL1(1,VARREF(Ylst),T8);
    T11 = CALL1(1,VARREF(Ylst),LITREF(lit_732));
    ...
    if (T19 != YPfalse) {
      ...
      if (YPtrue != YPfalse) {
        ...
        T45 = CALL1(1,VARREF(Ylst),LITREF(lit_733));
...
loop:
  ...
  T4 = CALL1(1,VARREF(Ylst),LITREF(lit_736));
  ...
  T12 = CALL1(1,VARREF(Ylst),LITREF(lit_737));
...
loop:
  ...
  patF2625 = T1;
  T3 = CALL1(1,VARREF(YevalSsyntaxYsexpr_bind_pattern_variables),patF2625);
  varsF2626 = T3;
  ...
  failF2631 = T13;
  T15 = CALL3(1,VARREF(YevalSastYexpand_pattern),patF2625,varF2630,failF2631);
  epatF2632 = T15;
  T17 = CALL1(1,VARREF(Ylst),LITREF(lit_740));
  T18 = CALL1(1,VARREF(Ylst),LITREF(lit_741));
  T21 = CALL1(1,VARREF(Ylst),LITREF(lit_742));
  T26 = CALL1(1,VARREF(Ylst),failF2631);
  T31 = CALL1(1,VARREF(Ylst),LITREF(lit_743));
  T32 = CALL1(1,VARREF(Ylst),LITREF(lit_744));
  T30 = CALL3(1,VARREF(YgooSmacrosYcat),T31,T32,Ynil);
  T29 = CALL1(1,VARREF(Ylst),T30);
  T35 = CALL1(1,VARREF(Ylst),LITREF(lit_745));
  ...
  T39 = CALL1(1,VARREF(Ylst),LITREF(lit_741));
  T40 = CALL1(1,VARREF(Ylst),elseF2629);
  ...
  T48 = CALL1(1,VARREF(Ylst),varF2630);
  T49 = CALL1(1,VARREF(Ylst),valueF2627);
  ...
  T55 = fun_347;
  T54 = CALL2(1,VARREF(YgooSmacrosYmap),T55,varsF2626);
  T53 = CALL1(1,VARREF(Ylst),T54);
  T56 = CALL1(1,VARREF(Ylst),epatF2632);
  T57 = CALL1(1,VARREF(Ylst),thenF2628);
...
loop:
  ...
  check_type(T1,VARREF(YevalSastYLstatic_global_environmentG));
  rF2633 = T1;
  T3 = CALL1(1,VARREF(YevalSastYenvironment_bindings),rF2633);
...
loop:
  ...
  loopF2634 = T1;
  FUNINIT(loopF2634, 3,name_,r_,loopF2634);
  T3 = CALL1(1,VARREF(YevalSastYenvironment_bindings),r_);
  T2 = CALL1(0,loopF2634,T3);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
LINK_STACK();
  ...
  NARGS(args_, 1);
loop:
  T1 = CALL2(1,VARREF(YgooSmacrosYmacro_error),LITREF(lit_775),FREEREF(0));
  T0 = CALL1(1,FREEREF(1),T1);
UNLINK_STACK();
  QRET(T0);
}
...
LINK_STACK();
  ARG(return_, 0);
loop:
  T1 = FUNSHELL(0,fun_x_1452_364,2);
  x_1452F2636 = T1;
  FUNINIT(x_1452F2636, 2,FREEREF(0),return_);
  x_1451F2637 = FREEREF(0);
  nameF2638 = YPfalse;
  nameF2638 = BOXFAB(nameF2638);
  paramsF2639 = YPfalse;
  paramsF2639 = BOXFAB(paramsF2639);
  bodyF2640 = YPfalse;
  bodyF2640 = BOXFAB(bodyF2640);
  T9 = CALL2(1,VARREF(YisaQ),x_1451F2637,VARREF(YLlstG));
  if (T9 != YPfalse) {
    T11 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1451F2637,LITREF(lit_775),x_1452F2636);
    x_1451F2641 = T11;
    T13 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1451F2641,x_1452F2636);
    BOXVAL(nameF2638) = T13;
    T14 = CALL1(1,VARREF(Ytail),x_1451F2641);
    x_1451F2642 = T14;
    T16 = CALL2(1,VARREF(YgooSmacrosYmatch_sublist),x_1451F2642,x_1452F2636);
    x_1451F2643 = T16;
    BOXVAL(paramsF2639) = x_1451F2643;
    x_1451F2644 = Ynil;
    T18 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1451F2644,x_1452F2636);
    T17 = T18;
    T19 = CALL1(1,VARREF(Ytail),x_1451F2642);
    x_1451F2645 = T19;
    BOXVAL(bodyF2640) = x_1451F2645;
    x_1451F2646 = Ynil;
    T21 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1451F2646,x_1452F2636);
    T20 = T21;
    T15 = T20;
    T12 = T15;
    T10 = T12;
  } else {
    T22 = CALL2(1,x_1452F2636,LITREF(lit_6),x_1451F2637);
  }
  T25 = BOXVAL(nameF2638);
  T24 = CALL2(1,VARREF(YgooSmacrosYcat_sym),LITREF(lit_776),T25);
  special_nameF2647 = T24;
  T28 = BOXVAL(nameF2638);
  T27 = CALL3(1,VARREF(YgooSmacrosYcat_sym),LITREF(lit_777),T28,LITREF(lit_778));
  sexpr_nameF2648 = T27;
  T30 = CALL1(1,VARREF(Ylst),LITREF(lit_11));
  T33 = CALL1(1,VARREF(Ylst),LITREF(lit_261));
  T34 = CALL1(1,VARREF(Ylst),special_nameF2647);
  ...
  T45 = CALL1(1,VARREF(Ylst),sexpr_nameF2648);
  T46 = CALL1(1,VARREF(Ylst),LITREF(lit_64));
  T47 = CALL1(1,VARREF(Ylst),YPfalse);
  T48 = CALL1(1,VARREF(Ylst),LITREF(lit_779));
  T51 = CALL1(1,VARREF(Ylst),LITREF(lit_780));
  T54 = BOXVAL(paramsF2639);
  T53 = CALL2(1,VARREF(YgooSmacrosYcat),T54,Ynil);
  T52 = CALL1(1,VARREF(Ylst),T53);
  T55 = BOXVAL(bodyF2640);
...
loop:
  ...
  tup30F2649 = T1;
  T3 = CALL2(1,VARREF(YgooSmacrosYelt),tup30F2649,YPint((P)0));
  typeF2650 = T3;
  T5 = CALL2(1,VARREF(YgooSmacrosYelt),tup30F2649,YPint((P)1));
  infoF2651 = T5;
  T7 = CALL2(1,VARREF(YgooSmacrosYelt),tup30F2649,YPint((P)2));
  testF2652 = T7;
  T9 = CALL2(1,VARREF(YgooSmacrosYelt),tup30F2649,YPint((P)3));
  handlerF2653 = T9;
  T11 = CALL2(1,VARREF(YgooSmacrosYelt),tup30F2649,YPint((P)4));
  bodyF2654 = T11;
  T12 = CALLN(1,VARREF(YevalSastYobjectify_monitor),7,typeF2650,infoF2651,testF2652,handlerF2653,bodyF2654,r_,tailQ_);
  T10 = T12;
  T8 = T10;
  T6 = T8;
  T4 = T6;
...
loop:
  T1 = CALL1(1,VARREF(YevalSsyntaxYsexpr_definition_variable),x_);
  nameF2655 = T1;
  T4 = CALL1(1,VARREF(Ylst),LITREF(lit_823));
  T7 = CALL1(1,VARREF(Ylst),LITREF(lit_565));
  T8 = CALL1(1,VARREF(Ylst),nameF2655);
  ...
  T2 = CALL5(1,VARREF(YevalSastYobjectify_definition),VARREF(YevalSastYLvariable_definitionG),LITREF(lit_63),nameF2655,T3,r_);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  ownerF2658 = T5;
  T7 = CALL1(1,VARREF(YevalSsyntaxYsexpr_fab_setter_name),nameF2656);
  setter_nameF2659 = T7;
  T9 = CALL1(1,VARREF(YevalSsyntaxYsexpr_prop_type),x_);
  typeF2660 = T9;
  T13 = CALL2(1,VARREF(YevalSsyntaxYsexpr_fab_getter),nameF2656,ownerF2658);
  T14 = CALL3(1,VARREF(YevalSsyntaxYsexpr_fab_setter),nameF2656,ownerF2658,typeF2660);
  T18 = CALL1(1,VARREF(YevalSsyntaxYsexpr_prop_initQ),x_);
  if (T18 != YPfalse) {
    T23 = CALL1(1,VARREF(Ylst),varF2657);
  ...
  T16 = CALL5(1,VARREF(Ylst),ownerF2658,nameF2656,setter_nameF2659,typeF2660,T17);
  T15 = CALL2(1,VARREF(YevalSsyntaxYsexpr_make_application),LITREF(lit_826),T16);
...
loop:
  ...
  astF2661 = T1;
  T4 = CALL2(1,VARREF(YisaQ),astF2661,VARREF(YevalSastYLmacro_referenceG));
  if (T4 != YPfalse) {
    T6 = CALL1(1,VARREF(YevalSastYreference_binding),astF2661);
    macF2662 = T6;
    T9 = CALL1(1,VARREF(YevalSastYbinding_handler),macF2662);
...
loop:
  ...
  if (T0 != YPfalse) {
    T1 = CALL1(1,VARREF(YevalSdependencyYast_error),LITREF(lit_876));
  } else {
  }
...
loop:
  T0 = CALL1(1,VARREF(Ynot),VARREF(YevalSastYTcurrent_subtransactionT));
  if (T0 != YPfalse) {
    T1 = CALL1(1,VARREF(YevalSdependencyYast_error),LITREF(lit_879));
  } else {
  }
...
FUNCODEDEF(YevalSastYmerge_transactionsX) {
  P t1_,t2_;
  P t2_dependentsF2668;
  P t1_dependentsF2667;
  P t2_bindingsF2666;
  P t1_bindingsF2665;
  ...
  if (T1 != YPfalse) {
    ...
    if (T3 != YPfalse) {
      ...
      if (YPtrue != YPfalse) {
        ...
        t1_dependentsF2667 = T10;
        T12 = CALL1(1,VARREF(YevalSastYtransaction_dependents),t2_);
        t2_dependentsF2668 = T12;
        T13 = FUNFAB(fun_413,1,t1_bindingsF2665);
        CALL2(1,VARREF(YgooScolsScolYdo_keyed),T13,t2_bindingsF2666);
        T14 = FUNFAB(fun_414,1,t1_dependentsF2667);
        CALL2(1,VARREF(YgooScolsScolYdo_keyed),T14,t2_dependentsF2668);
        T11 = t1_;
        T9 = T11;
        T7 = T9;
        T5 = T7;
...
LINK_STACK();
  ...
  ARG(thunk_, 1);
loop:
  successF2670 = YPfalse;
  successF2670 = BOXFAB(successF2670);
  savedF2671 = VARREF(YevalSastYTcurrent_subtransactionT);
  T4 = FUNFAB(fun_419,2,thunk_,successF2670);
  T5 = FUNFAB(fun_420,3,successF2670,module_,savedF2671);
  T3 = with_cleanup(T4,T5);
  T2 = T3;
  T0 = T2;
UNLINK_STACK();
...
LINK_STACK();
  ...
  NARGS(args_, 1);
loop:
  T1 = CALL2(1,VARREF(YgooSmacrosYmacro_error),LITREF(lit_896),FREEREF(0));
  T0 = CALL1(1,FREEREF(1),T1);
UNLINK_STACK();
  QRET(T0);
}
...
LINK_STACK();
  ARG(return_, 0);
loop:
  T1 = FUNSHELL(0,fun_x_1456_422,2);
  x_1456F2672 = T1;
  FUNINIT(x_1456F2672, 2,FREEREF(0),return_);
  x_1455F2673 = FREEREF(0);
  moduleF2674 = YPfalse;
  moduleF2674 = BOXFAB(moduleF2674);
  bodyF2675 = YPfalse;
  bodyF2675 = BOXFAB(bodyF2675);
  T7 = CALL2(1,VARREF(YisaQ),x_1455F2673,VARREF(YLlstG));
  if (T7 != YPfalse) {
    T9 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1455F2673,LITREF(lit_896),x_1456F2672);
    x_1455F2676 = T9;
    T11 = CALL2(1,VARREF(YgooSmacrosYmatch_sublist),x_1455F2676,x_1456F2672);
    x_1455F2677 = T11;
    T13 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1455F2677,x_1456F2672);
    BOXVAL(moduleF2674) = T13;
    T14 = CALL1(1,VARREF(Ytail),x_1455F2677);
    x_1455F2678 = T14;
    T15 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1455F2678,x_1456F2672);
    T12 = T15;
    T16 = CALL1(1,VARREF(Ytail),x_1455F2676);
    x_1455F2679 = T16;
    BOXVAL(bodyF2675) = x_1455F2679;
    x_1455F2680 = Ynil;
    T18 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1455F2680,x_1456F2672);
    T17 = T18;
    T10 = T17;
    T8 = T10;
  } else {
    T19 = CALL2(1,x_1456F2672,LITREF(lit_6),x_1455F2673);
  }
  T21 = CALL1(1,VARREF(Ylst),LITREF(lit_890));
  T23 = BOXVAL(moduleF2674);
  T22 = CALL1(1,VARREF(Ylst),T23);
  T26 = CALL1(1,VARREF(Ylst),LITREF(lit_780));
  T27 = CALL1(1,VARREF(Ylst),Ynil);
  T28 = BOXVAL(bodyF2675);
...
LINK_STACK();
loop:
  x_1458F2682 = FREEREF(0);
  T3 = CALL1(1,VARREF(YevalSastYmodule_loader_stack),x_1458F2682);
  T2 = CALL1(1,VARREF(YgooScolsSseqxYpopX),T3);
  tup31F2683 = T2;
  T5 = CALL2(1,VARREF(YgooSmacrosYelt),tup31F2683,YPint((P)0));
  x_1459F2684 = T5;
  T7 = CALL2(1,VARREF(YgooSmacrosYelt),tup31F2683,YPint((P)1));
  x_1460F2685 = T7;
  CALL2(1,VARREF(YevalSastYmodule_loader_stack_setter),x_1459F2684,x_1458F2682);
  T6 = x_1460F2685;
  T4 = T6;
  T1 = T4;
  T0 = T1;
...
loop:
  ...
  stackF2686 = T1;
  T3 = CALL1(1,VARREF(YgooStypesYlen),stackF2686);
  depthF2687 = T3;
  T5 = CALL2(1,VARREF(YgooScolsSseqYrepeat),LITREF(lit_983),depthF2687);
  indentF2688 = T5;
  T6 = CALL2(1,VARREF(YgooScolsScolYmemQ),stackF2686,name_);
  if (T6 != YPfalse) {
    T8 = CALL1(1,VARREF(Yhead),stackF2686);
    T7 = CALL3(1,VARREF(YevalSastYnamespace_error),LITREF(lit_984),T8,name_);
  } else {
  }
  CALL4(1,VARREF(YgooSconditionsYmsg),VARREF(YgooSioSportYout),LITREF(lit_985),indentF2688,name_);
  x_1457F2689 = loader_;
  T12 = CALL1(1,VARREF(YevalSastYmodule_loader_stack),x_1457F2689);
  T11 = CALL2(1,VARREF(YgooScolsSseqxYpushX),T12,name_);
  T10 = CALL2(1,VARREF(YevalSastYmodule_loader_stack_setter),T11,x_1457F2689);
  T14 = FUNFAB(fun_473,2,loader_,name_);
  T15 = FUNFAB(fun_474,1,loader_);
  T13 = with_cleanup(T14,T15);
  modF2690 = T13;
  CALL2(1,VARREF(YevalSastYregister_moduleX),loader_,modF2690);
  CALL3(1,VARREF(YgooSconditionsYmsg),VARREF(YgooSioSportYout),LITREF(lit_986),indentF2688);
  T9 = modF2690;
  T4 = T9;
  T2 = T4;
  T0 = T2;
...
loop:
  ...
  exportsF2691 = T1;
  T3 = CALL3(1,VARREF(YgooScolsScolYelt_or),exportsF2691,name_,YPfalse);
  existingF2692 = T3;
  T6 = CALL2(1,VARREF(YgooSmacrosYEE),existingF2692,YPfalse);
  tmpF2693 = T6;
  if (tmpF2693 != YPfalse) {
    T7 = tmpF2693;
  } else {
    T8 = CALL2(1,VARREF(YgooSmacrosYEE),existingF2692,binding_);
    T7 = T8;
  }
  T5 = T7;
  T4 = CALL1(1,VARREF(Ynot),T5);
  if (T4 != YPfalse) {
    T9 = CALL5(1,VARREF(YevalSastYnamespace_error),LITREF(lit_991),existingF2692,binding_,module_,name_);
  } else {
  }
  CALL3(1,VARREF(YgooScolsScolxYelt_setter),binding_,exportsF2691,name_);
  T2 = YPfalse;
  T0 = T2;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    T5 = CALL4(1,VARREF(YgooSconditionsYmsg),VARREF(YgooSioSportYout),LITREF(lit_997),T6,T7);
    T0 = T5;
  } else {
    T0 = YPfalse;
  }
...
loop:
  T1 = BOXVAL(FREEREF(0));
  UF2695 = T1;
  T3 = CALL2(1,VARREF(YgooSpackerYpacker_add),UF2695,v_);
...
loop:
  ...
  add_userF2697 = T3;
  FUNINIT(add_userF2697, 3,usersF2696,add_userF2697,loader_);
  CALL2(1,VARREF(YgooSmacrosYdo),add_userF2697,modnames_);
  T5 = CALL1(1,VARREF(YgooSpackerYpacker_fab),VARREF(YLlstG));
  packer_F2698 = T5;
  packer_F2698 = BOXFAB(packer_F2698);
  T7 = FUNFAB(fun_483,1,packer_F2698);
  CALL2(1,VARREF(YgooSmacrosYdo),T7,usersF2696);
  T9 = BOXVAL(packer_F2698);
...
loop:
  ...
  modF2699 = T1;
  T3 = CALL2(1,VARREF(YevalSastYremove_module_internalX),FREEREF(0),modF2699);
  T0 = T3;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  remove_namesF2700 = T1;
  T2 = FUNFAB(fun_486,1,loader_);
  CALL2(1,VARREF(YgooSmacrosYdo),T2,remove_namesF2700);
  T0 = YPfalse;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  namestrF2701 = T1;
  T4 = CALL2(1,VARREF(YgooScolsSseqYsplit),namestrF2701,YPchr((P)47));
...
loop:
  ...
  bootmodF2702 = T1;
  T3 = CALL1(1,VARREF(YevalSastYmodule_target_environment),bootmodF2702);
  bootenvF2703 = T3;
  T5 = FUNFAB(fun_489,2,bootenvF2703,env_);
  T4 = CALL2(1,VARREF(YgooSmacrosYdo),T5,LITREF(lit_1015));
  T2 = T4;
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
...
loop:
  ...
  loaderF2705 = T1;
  T4 = CALL3(1,VARREF(YevalSastYfab_static_global_environment),module_,loaderF2705,YPfalse);
  new_envF2706 = T4;
  T5 = FUNFAB(fun_492,2,excluded_,new_envF2706);
...
loop:
  ...
  x_1461F2707 = DYNREF(YevalSastYTnow_rt_envT);
  T1 = FUNFAB(fun_494,2,FREEREF(0),FREEREF(2));
  T2 = FUNFAB(fun_495,1,x_1461F2707);
...
loop:
  ...
  typeF2708 = T1;
  T3 = CALL3(1,VARREF(Ynew),typeF2708,VARREF(YevalSastYmodule_name),name_);
  moduleF2709 = T3;
  T5 = CALL3(1,VARREF(YevalSastYfab_static_global_environment),moduleF2709,loader_,YPfalse);
  envF2710 = T5;
  keepmodQF2711 = YPfalse;
  keepmodQF2711 = BOXFAB(keepmodQF2711);
  T9 = CALL1(1,VARREF(YevalSastYmodule_name_to_relpath),name_);
  modpathF2712 = T9;
  T11 = CALL2(1,VARREF(YgooSsystemYfind_goo_file_in_path),modpathF2712,VARREF(YgooSsystemYTmodule_search_pathT));
  fileF2713 = T11;
  CALL3(1,VARREF(YevalSastYset_module_environments),moduleF2709,envF2710,envF2710);
  T12 = CALL1(1,VARREF(Ynot),fileF2713);
  if (T12 != YPfalse) {
    T13 = CALL2(1,VARREF(YevalSastYnamespace_error),LITREF(lit_1023),modpathF2712);
  } else {
  }
  T15 = FUNFAB(fun_496,5,envF2710,loader_,fileF2713,keepmodQF2711,moduleF2709);
  T16 = FUNFAB(fun_497,2,keepmodQF2711,moduleF2709);
...
loop:
  ...
  moduleF2714 = T1;
  CALL1(1,VARREF(YevalSastYensure_module_data),moduleF2714);
  T2 = CALL1(1,VARREF(YevalSastYmodule_target_environment),moduleF2714);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  T1 = CALL0(1,VARREF(YevalSastYruntime_module_loader));
  loaderF2715 = T1;
  T5 = CALL1(1,VARREF(YevalSastYmodule_loader_stack),loaderF2715);
...
loop:
  T1 = CALL0(1,VARREF(YevalSastYruntime_module_loader));
  loaderF2716 = T1;
  T3 = CALL1(1,VARREF(YevalSastYmodule_loader_module_type),loaderF2716);
  typeF2717 = T3;
  T6 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLsymG),modname_);
  T5 = CALL3(1,VARREF(Ynew),typeF2717,VARREF(YevalSastYmodule_name),T6);
  modF2718 = T5;
  T8 = CALL3(1,VARREF(YevalSastYfab_static_global_environment),modF2718,loaderF2716,YPtrue);
  envF2719 = T8;
  CALL2(1,VARREF(YevalSastYmodule_data_processedQ_setter),YPfalse,modF2718);
  CALL3(1,VARREF(YevalSastYset_module_environments),modF2718,envF2719,envF2719);
  CALL2(1,VARREF(YevalSastYmodule_runtime_data_setter),data_,modF2718);
  CALL2(1,VARREF(YevalSastYregister_moduleX),loaderF2716,modF2718);
  T7 = modF2718;
  T4 = T7;
  T2 = T4;
  T0 = T2;
...
loop:
  ...
  T3 = CALL2(1,VARREF(YevalSastYfind_binding),T4,home_envF2720);
  bindingF2721 = T3;
  T5 = CALL1(1,VARREF(Ynot),bindingF2721);
  if (T5 != YPfalse) {
    T7 = CALL1(1,VARREF(YevalSastYmodule_name),from_mod_);
    T8 = CALL1(1,VARREF(YevalSastYmodule_name),mod_);
    T6 = CALL4(1,VARREF(YevalSastYnamespace_error),LITREF(lit_1039),original_name_,T7,T8);
  } else {
  }
  T10 = CALL1(1,VARREF(YevalSastYmodule_target_environment),mod_);
  T9 = CALL2(1,VARREF(YevalSastYinsert_globalX),bindingF2721,T10);
  T2 = T9;
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
...
loop:
  ...
  T3 = CALL2(1,VARREF(YevalSastYinsert_globalX),bindingF2722,T4);
  T0 = T3;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  bindingF2723 = T1;
  T4 = CALL1(1,VARREF(YevalSastYmodule_target_environment),mod_);
  T3 = CALL2(1,VARREF(YevalSastYinsert_globalX),bindingF2723,T4);
  T0 = T3;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  bindingF2724 = T1;
  T4 = CALL1(1,VARREF(YevalSastYmodule_target_environment),mod_);
  T3 = CALL2(1,VARREF(YevalSastYinsert_globalX),bindingF2724,T4);
  T0 = T3;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  bindingF2725 = T1;
  if (bindingF2725 != YPfalse) {
    T6 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLsymG),as_name_);
    T5 = CALL3(1,VARREF(YevalSastYexport_bindingX),mod_,T6,bindingF2725);
    T4 = T5;
  } else {
    T8 = CALL1(1,VARREF(YevalSastYmodule_name),mod_);
    T7 = CALL3(1,VARREF(YevalSastYnamespace_error),LITREF(lit_1052),name_,T8);
    T4 = T7;
  }
  T0 = T4;
UNLINK_STACK();
...
loop:
  ...
  T3 = CALL2(1,VARREF(YevalSastYbinding_handler_setter),T4,cloneF2726);
  T0 = T3;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  bootmodF2727 = T1;
  T4 = CALL1(1,VARREF(YevalSastYmodule_target_environment),bootmodF2727);
  bootenvF2728 = T4;
  CALL1(1,VARREF(YevalSastYinstall_magic_bindings),bootenvF2728);
  CALL0(1,VARREF(YevalSastYreload_macros));
  CALL1(1,VARREF(YevalSastYinstall_interpreter_hacks),bootenvF2728);
  T3 = YPfalse;
  T0 = T3;
UNLINK_STACK();
  QRET(T0);
...
LINK_STACK();
  ARG(module_, 0);
loop:
  T1 = CALL1(1,VARREF(YevalSastYruntime_module),LITREF(lit_1064));
...
loop:
  T1 = CALL1(1,VARREF(YevalSastYmodule_loader_module_type),loader_);
  typeF2729 = T1;
  T3 = CALL3(1,VARREF(Ynew),typeF2729,VARREF(YevalSastYmodule_name),name_);
  moduleF2730 = T3;
  T5 = CALL1(1,VARREF(YevalSastYfab_syntax_environment),moduleF2730);
  syntax_envF2731 = T5;
  T7 = CALL3(1,VARREF(YevalSastYfab_static_global_environment),moduleF2730,loader_,YPfalse);
  target_envF2732 = T7;
  CALL3(1,VARREF(YevalSastYset_module_environments),moduleF2730,syntax_envF2731,target_envF2732);
  T8 = CALL2(1,VARREF(YgooSmacrosYEE),name_,VARREF(YevalSastYDgoo_boot_module_name));
  if (T8 != YPfalse) {
    T9 = CALL1(1,VARREF(YevalSastYinit_g2c_boot_environment),target_envF2732);
  } else {
    T10 = CALL2(1,VARREF(YevalSastYinit_g2c_regular_environment),target_envF2732,loader_);
  }
  T6 = moduleF2730;
  T4 = T6;
  T2 = T4;
...
loop:
  ...
  loopF2733 = T1;
  FUNINIT(loopF2733, 2,f_,loopF2733);
  T2 = CALL1(0,loopF2733,env_);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  loopF2734 = T1;
  FUNINIT(loopF2734, 2,f_,loopF2734);
  T2 = CALL1(0,loopF2734,env_);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  fun_x_1427_0 = YPmet(FUNCODEREF(fun_x_1427_0),LITREF(lit_3),T2,ENVNUL,PNUL,YPfalse);
...
loop:
  ...
  fun_x_1433_110 = YPmet(FUNCODEREF(fun_x_1433_110),LITREF(lit_252),T155,ENVNUL,PNUL,YPfalse);
  ...
  fun_x_1437_113 = YPmet(FUNCODEREF(fun_x_1437_113),LITREF(lit_275),T159,ENVNUL,PNUL,YPfalse);
...
loop:
  ...
  lit_476 = YPPsym((P)"x-1439");
  lit_477 = YPPlist(1,YPPsym((P)"x-1438"));
  T1 = YPsig(LITREF(lit_477),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_x_1439_211 = YPmet(FUNCODEREF(fun_x_1439_211),LITREF(lit_476),T1,ENVNUL,PNUL,YPfalse);
  ...
  lit_480 = YPPsym((P)"x-1441");
  lit_481 = YPPlist(1,YPPsym((P)"x-1440"));
  T7 = YPsig(LITREF(lit_481),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_x_1441_213 = YPmet(FUNCODEREF(fun_x_1441_213),LITREF(lit_480),T7,ENVNUL,PNUL,YPfalse);
...
loop:
  ...
  lit_709 = YPPsym((P)"insert-and-mangle-global!");
  lit_710 = YPPlist(3,YPPsym((P)"binding"),YPPsym((P)"mangle-prefix"),YPPsym((P)"r"));
  T189 = YPsig(LITREF(lit_710),YPPlist(3,VARREF(YLanyG),VARREF(YLstrG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_insert_and_mangle_globalX_335 = YPmet(FUNCODEREF(fun_insert_and_mangle_globalX_335),LITREF(lit_709),T189,ENVNUL,PNUL,YPfalse);
  ...
  lit_711 = YPPsym((P)"import-and-mangle-global!");
  lit_712 = YPPlist(3,YPPsym((P)"b"),YPPsym((P)"mangle-prefix"),YPPsym((P)"env"));
  lit_713 = YPsb((P)"warning: '%s' from %s clobbers local binding.\n");
  T194 = YPsig(LITREF(lit_712),YPPlist(3,VARREF(YevalSastYLmodule_bindingG),VARREF(YLstrG),VARREF(YevalSastYLstatic_global_environmentG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  YevalSastYimport_and_mangle_globalX = YPmet(FUNCODEREF(YevalSastYimport_and_mangle_globalX),LITREF(lit_711),T194,ENVNUL,PNUL,YPfalse);
  T195 = YevalSastYimport_and_mangle_globalX;
  VARSET(YevalSastYimport_and_mangle_globalX,T195);
  lit_714 = YPPsym((P)"objectify-use-mangle-module");
  lit_715 = YPPlist(4,YPPsym((P)"name"),YPPsym((P)"mangler"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  lit_716 = YPPlist(1,YPPsym((P)"b"));
  T197 = YPsig(LITREF(lit_716),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_337 = YPmet(FUNCODEREF(fun_337),YPfalse,T197,ENVNUL,PNUL,YPfalse);
  T196 = YPsig(LITREF(lit_715),YPPlist(4,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)4),VARREF(YevalSastYLprogramG),Ynil);
  fun_objectify_use_mangle_module_338 = YPmet(FUNCODEREF(fun_objectify_use_mangle_module_338),LITREF(lit_714),T196,ENVNUL,PNUL,YPfalse);
  ...
  lit_719 = YPsb((P)"Expected Pattern List %=\n");
  T202 = YPsig(LITREF(lit_718),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_expand_bind_list_339 = YPmet(FUNCODEREF(fun_expand_bind_list_339),LITREF(lit_717),T202,ENVNUL,PNUL,YPfalse);
  ...
  lit_720 = YPPlist(3,YPPsym((P)"pat"),YPPsym((P)"var"),YPPsym((P)"fail"));
  lit_721 = YPPsym((P)"match-empty-list");
  T208 = XCALL1(1,VARREF(YgooStypesYtE),Ynil);
  T207 = YPsig(LITREF(lit_720),YPPlist(3,T208,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLlstG),Ynil);
  fun_expand_bind_list_340 = YPmet(FUNCODEREF(fun_expand_bind_list_340),LITREF(lit_717),T207,ENVNUL,PNUL,YPfalse);
  ...
  lit_722 = YPPlist(3,YPPsym((P)"pat"),YPPsym((P)"var"),YPPsym((P)"fail"));
  lit_723 = YPsb((P)"Unquote Unexpected Here %=\n");
  lit_724 = YPsb((P)"Unquote Splicing Unexpected Here %=\n");
  T213 = YPsig(LITREF(lit_722),YPPlist(3,VARREF(YLlstG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLlstG),Ynil);
  fun_expand_bind_list_341 = YPmet(FUNCODEREF(fun_expand_bind_list_341),LITREF(lit_717),T213,ENVNUL,PNUL,YPfalse);
  ...
  lit_725 = YPPsym((P)"expand-bind-list*");
  lit_726 = YPPlist(3,YPPsym((P)"pat"),YPPsym((P)"var"),YPPsym((P)"fail"));
  T219 = XCALL1(1,VARREF(YgooStypesYtE),Ynil);
  T218 = YPsig(LITREF(lit_726),YPPlist(3,T219,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_expand_bind_listT_342 = YPmet(FUNCODEREF(fun_expand_bind_listT_342),LITREF(lit_725),T218,ENVNUL,PNUL,YPfalse);
  ...
  T224 = YPsig(LITREF(lit_727),YPPlist(3,VARREF(YLlstG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_expand_bind_listT_343 = YPmet(FUNCODEREF(fun_expand_bind_listT_343),LITREF(lit_725),T224,ENVNUL,PNUL,YPfalse);
  ...
  lit_728 = YPPsym((P)"expand-bind-element");
  lit_729 = YPPlist(3,YPPsym((P)"pat"),YPPsym((P)"var"),YPPsym((P)"fail"));
  lit_730 = YPPsym((P)"match-atom");
  T229 = YPsig(LITREF(lit_729),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_expand_bind_element_344 = YPmet(FUNCODEREF(fun_expand_bind_element_344),LITREF(lit_728),T229,ENVNUL,PNUL,YPfalse);
  ...
  lit_731 = YPPlist(3,YPPsym((P)"pat"),YPPsym((P)"var"),YPPsym((P)"fail"));
  lit_732 = YPPsym((P)"match-unquote");
  lit_733 = YPPsym((P)"match-sublist");
  T234 = YPsig(LITREF(lit_731),YPPlist(3,VARREF(YLlstG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_expand_bind_element_345 = YPmet(FUNCODEREF(fun_expand_bind_element_345),LITREF(lit_728),T234,ENVNUL,PNUL,YPfalse);
  ...
  lit_734 = YPPsym((P)"expand-pattern");
  lit_735 = YPPlist(3,YPPsym((P)"pat"),YPPsym((P)"var"),YPPsym((P)"fail"));
  lit_736 = YPPsym((P)"isa?");
  lit_737 = YPsb((P)"Match Pattern Failure");
  T239 = YPsig(LITREF(lit_735),YPPlist(3,VARREF(YLlstG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_expand_pattern_346 = YPmet(FUNCODEREF(fun_expand_pattern_346),LITREF(lit_734),T239,ENVNUL,PNUL,YPfalse);
  ...
  lit_738 = YPPsym((P)"expand-syntax-if");
  lit_739 = YPPlist(1,YPPsym((P)"x"));
  lit_740 = YPPsym((P)"esc");
  lit_741 = YPPsym((P)"return");
  lit_742 = YPPsym((P)"loc");
  lit_743 = YPPsym((P)"msg");
  lit_744 = YPPsym((P)"<str>");
  lit_745 = YPPsym((P)"args");
  lit_746 = YPPlist(1,YPPsym((P)"x"));
  T245 = YPsig(LITREF(lit_746),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_347 = YPmet(FUNCODEREF(fun_347),YPfalse,T245,ENVNUL,PNUL,YPfalse);
  T244 = YPsig(LITREF(lit_739),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_expand_syntax_if_348 = YPmet(FUNCODEREF(fun_expand_syntax_if_348),LITREF(lit_738),T244,ENVNUL,PNUL,YPfalse);
  ...
  lit_747 = YPPsym((P)"r-extend*");
  lit_748 = YPPlist(2,YPPsym((P)"r"),YPPsym((P)"bindings"));
  T250 = YPsig(LITREF(lit_748),YPPlist(2,VARREF(YLanyG),VARREF(YLlstG)),YPfalse,YPint((P)2),VARREF(YevalSastYLstatic_environmentG),Ynil);
  fun_r_extendT_349 = YPmet(FUNCODEREF(fun_r_extendT_349),LITREF(lit_747),T250,ENVNUL,PNUL,YPfalse);
  ...
  lit_749 = YPPsym((P)"insert-global!");
  lit_750 = YPPlist(2,YPPsym((P)"binding"),YPPsym((P)"r"));
  T255 = YPsig(LITREF(lit_750),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_insert_globalX_350 = YPmet(FUNCODEREF(fun_insert_globalX_350),LITREF(lit_749),T255,ENVNUL,PNUL,YPfalse);
  ...
  lit_751 = YPPsym((P)"insert-globals!");
  lit_752 = YPPlist(2,YPPsym((P)"bindings"),YPPsym((P)"r"));
  lit_753 = YPPlist(1,YPPsym((P)"b"));
  T261 = YPsig(LITREF(lit_753),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_351 = YPmet(FUNCODEREF(fun_351),YPfalse,T261,ENVNUL,PNUL,YPfalse);
  T260 = YPsig(LITREF(lit_752),YPPlist(2,VARREF(YLlstG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_insert_globalsX_352 = YPmet(FUNCODEREF(fun_insert_globalsX_352),LITREF(lit_751),T260,ENVNUL,PNUL,YPfalse);
  ...
  lit_754 = YPPsym((P)"find-static-global-environment");
  lit_755 = YPPlist(1,YPPsym((P)"r"));
  T266 = YPsig(LITREF(lit_755),YPPlist(1,VARREF(YevalSastYLstatic_local_environmentG)),YPfalse,YPint((P)1),VARREF(YevalSastYLstatic_global_environmentG),Ynil);
  fun_find_static_global_environment_353 = YPmet(FUNCODEREF(fun_find_static_global_environment_353),LITREF(lit_754),T266,ENVNUL,PNUL,YPfalse);
  ...
  T271 = YPsig(LITREF(lit_756),YPPlist(1,VARREF(YevalSastYLstatic_global_environmentG)),YPfalse,YPint((P)1),VARREF(YevalSastYLstatic_global_environmentG),Ynil);
  fun_find_static_global_environment_354 = YPmet(FUNCODEREF(fun_find_static_global_environment_354),LITREF(lit_754),T271,ENVNUL,PNUL,YPfalse);
  ...
  lit_757 = YPPsym((P)"find-syntax-environment");
  lit_758 = YPPlist(1,YPPsym((P)"r"));
  T276 = YPsig(LITREF(lit_758),YPPlist(1,VARREF(YevalSastYLstatic_environmentG)),YPfalse,YPint((P)1),VARREF(YevalSastYLstatic_global_environmentG),Ynil);
  fun_find_syntax_environment_355 = YPmet(FUNCODEREF(fun_find_syntax_environment_355),LITREF(lit_757),T276,ENVNUL,PNUL,YPfalse);
  ...
  lit_759 = YPPsym((P)"find-environment-module");
  lit_760 = YPPlist(1,YPPsym((P)"r"));
  T281 = YPsig(LITREF(lit_760),YPPlist(1,VARREF(YevalSastYLstatic_environmentG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_find_environment_module_356 = YPmet(FUNCODEREF(fun_find_environment_module_356),LITREF(lit_759),T281,ENVNUL,PNUL,YPfalse);
  ...
  lit_761 = YPPsym((P)"find-binding");
  lit_762 = YPPlist(2,YPPsym((P)"name"),YPPsym((P)"r"));
  lit_763 = YPPlist(1,YPPsym((P)"bindings"));
  T287 = YPsig(LITREF(lit_763),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_loop_357 = YPmet(FUNCODEREF(fun_loop_357),LITREF(lit_248),T287,ENVNUL,PNUL,YPfalse);
  T286 = YPsig(LITREF(lit_762),YPPlist(2,VARREF(YLanyG),VARREF(YevalSastYLstatic_local_environmentG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_find_binding_358 = YPmet(FUNCODEREF(fun_find_binding_358),LITREF(lit_761),T286,ENVNUL,PNUL,YPfalse);
  ...
  lit_764 = YPPlist(2,YPPsym((P)"name"),YPPsym((P)"r"));
  T292 = YPsig(LITREF(lit_764),YPPlist(2,VARREF(YLanyG),VARREF(YevalSastYLstatic_empty_environmentG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_find_binding_359 = YPmet(FUNCODEREF(fun_find_binding_359),LITREF(lit_761),T292,ENVNUL,PNUL,YPfalse);
  ...
  T297 = YPsig(LITREF(lit_765),YPPlist(2,VARREF(YLanyG),VARREF(YevalSastYLstatic_global_environmentG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_find_binding_360 = YPmet(FUNCODEREF(fun_find_binding_360),LITREF(lit_761),T297,ENVNUL,PNUL,YPfalse);
  ...
  lit_766 = YPPsym((P)"frame-bindings");
  lit_767 = YPPlist(1,YPPsym((P)"env"));
  T302 = YPsig(LITREF(lit_767),YPPlist(1,VARREF(YevalSastYLstatic_environmentG)),YPfalse,YPint((P)1),VARREF(YLcolG),Ynil);
  fun_frame_bindings_361 = YPmet(FUNCODEREF(fun_frame_bindings_361),LITREF(lit_766),T302,ENVNUL,PNUL,YPfalse);
...
DEFCREGS();
loop:
  lit_768 = YPPsym((P)"register-magic-binding");
  lit_769 = YPPlist(2,YPPsym((P)"name"),YPPsym((P)"value"));
  T0 = YPsig(LITREF(lit_769),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_register_magic_binding_362 = YPmet(FUNCODEREF(fun_register_magic_binding_362),LITREF(lit_768),T0,ENVNUL,PNUL,YPfalse);
  ...
  lit_770 = YPPsym((P)"magic-bindings");
  T5 = YPsig(LITREF(lit_626),Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  fun_magic_bindings_363 = YPmet(FUNCODEREF(fun_magic_bindings_363),LITREF(lit_770),T5,ENVNUL,PNUL,YPfalse);
  ...
  lit_771 = YPPlist(1,YPPsym((P)"exp"));
  lit_772 = YPPlist(1,YPPsym((P)"return"));
  lit_773 = YPPsym((P)"x-1452");
  lit_774 = YPPlist(2,YPPsym((P)"msg"),YPPsym((P)"args"));
  lit_775 = YPPsym((P)"define-magic-binding");
  lit_776 = YPsb((P)"special-");
  lit_777 = YPsb((P)"$sexpr-");
  lit_778 = YPsb((P)"-tag");
  lit_779 = YPPsym((P)"binding-handler");
  lit_780 = YPPsym((P)"fun");
  T12 = YPsig(LITREF(lit_774),YPPlist(1,VARREF(YLstrG)),YPtrue,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_x_1452_364 = YPmet(FUNCODEREF(fun_x_1452_364),LITREF(lit_773),T12,ENVNUL,PNUL,YPfalse);
  T11 = YPsig(LITREF(lit_772),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_365 = YPmet(FUNCODEREF(fun_365),YPfalse,T11,ENVNUL,PNUL,YPfalse);
  T10 = YPsig(LITREF(lit_771),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  ...
  T14 = YPsig(LITREF(lit_781),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  T17 = YPsig(LITREF(lit_782),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_783 = YPPsym((P)"begin");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_783),VARREF(YevalSastYspecial_begin));
  lit_784 = YPPsym((P)"%raw");
  VARSET(YevalSastYDsexpr_Praw_tag,LITREF(lit_784));
  lit_785 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T20 = YPsig(LITREF(lit_785),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_784),VARREF(YevalSastYspecial_Praw));
  lit_786 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T23 = YPsig(LITREF(lit_786),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  T26 = YPsig(LITREF(lit_787),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  T29 = YPsig(LITREF(lit_788),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_789 = YPPsym((P)"define");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_789),VARREF(YevalSastYspecial_define));
  lit_790 = YPPsym((P)"ddv");
  VARSET(YevalSastYDsexpr_define_dynamic_tag,LITREF(lit_790));
  lit_791 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T32 = YPsig(LITREF(lit_791),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_792 = YPPsym((P)"define-dynamic");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_792),VARREF(YevalSastYspecial_define_dynamic));
  lit_793 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T35 = YPsig(LITREF(lit_793),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_794 = YPPsym((P)"define-syntax");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_794),VARREF(YevalSastYspecial_define_syntax));
  lit_795 = YPPsym((P)"dss");
  VARSET(YevalSastYDsexpr_define_static_syntax_tag,LITREF(lit_795));
  lit_796 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T38 = YPsig(LITREF(lit_796),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_797 = YPPsym((P)"define-static-syntax");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_797),VARREF(YevalSastYspecial_define_static_syntax));
  lit_798 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T41 = YPsig(LITREF(lit_798),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_799 = YPPsym((P)"define-method");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_799),VARREF(YevalSastYspecial_define_method));
  lit_800 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T44 = YPsig(LITREF(lit_800),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_801 = YPPsym((P)"define-generic");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_801),VARREF(YevalSastYspecial_define_generic));
  lit_802 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T47 = YPsig(LITREF(lit_802),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_803 = YPPsym((P)"define-function");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_803),VARREF(YevalSastYspecial_define_function));
  lit_804 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T50 = YPsig(LITREF(lit_804),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_805 = YPPsym((P)"method");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_805),VARREF(YevalSastYspecial_method));
  VARSET(YevalSastYDsexpr_boundQ_tag,LITREF(lit_622));
  lit_806 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T53 = YPsig(LITREF(lit_806),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  T56 = YPsig(LITREF(lit_807),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  T59 = YPsig(LITREF(lit_808),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_809 = YPPsym((P)"def");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_809),VARREF(YevalSastYspecial_def));
  lit_810 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T62 = YPsig(LITREF(lit_810),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_811 = YPPsym((P)"locals");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_811),VARREF(YevalSastYspecial_locals));
  lit_812 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T65 = YPsig(LITREF(lit_812),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_813 = YPPsym((P)"iterate");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_813),VARREF(YevalSastYspecial_iterate));
  lit_814 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T68 = YPsig(LITREF(lit_814),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_815 = YPPsym((P)"bind-exit");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_815),VARREF(YevalSastYspecial_bind_exit));
  lit_816 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T71 = YPsig(LITREF(lit_816),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_817 = YPPsym((P)"unwind-protect");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_817),VARREF(YevalSastYspecial_unwind_protect));
  lit_818 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T74 = YPsig(LITREF(lit_818),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_819 = YPPsym((P)"monitor");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_819),VARREF(YevalSastYspecial_monitor));
  lit_820 = YPPsym((P)"pairize");
  lit_821 = YPPlist(1,YPPsym((P)"args"));
  T77 = YPsig(LITREF(lit_821),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_pairize_388 = YPmet(FUNCODEREF(fun_pairize_388),LITREF(lit_820),T77,ENVNUL,PNUL,YPfalse);
  ...
  lit_823 = YPPsym((P)"fab-class");
  T82 = YPsig(LITREF(lit_822),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_824 = YPPsym((P)"define-class");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_824),VARREF(YevalSastYspecial_define_class));
  lit_825 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  lit_826 = YPPsym((P)"%prop");
  lit_827 = YPPsym((P)"%prop-unbound-error");
  T85 = YPsig(LITREF(lit_825),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_828 = YPPsym((P)"prop");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_828),VARREF(YevalSastYspecial_prop));
  lit_829 = YPPsym((P)"ct");
  VARSET(YevalSastYDsexpr_compile_time_tag,LITREF(lit_829));
  lit_830 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T88 = YPsig(LITREF(lit_830),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_831 = YPPsym((P)"compile-time");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_831),VARREF(YevalSastYspecial_compile_time));
  lit_832 = YPPsym((P)"ct-also");
  VARSET(YevalSastYDsexpr_compile_time_also_tag,LITREF(lit_832));
  lit_833 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T91 = YPsig(LITREF(lit_833),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_834 = YPPsym((P)"compile-time-also");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_834),VARREF(YevalSastYspecial_compile_time_also));
  lit_835 = YPPsym((P)"dl");
  VARSET(YevalSastYDsexpr_define_primitive_tag,LITREF(lit_835));
  lit_836 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T94 = YPsig(LITREF(lit_836),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_837 = YPPsym((P)"define-primitive");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_837),VARREF(YevalSastYspecial_define_primitive));
  lit_838 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T99 = YPsig(LITREF(lit_838),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
...
DEFCREGS();
loop:
  lit_839 = YPPsym((P)"quasiquote");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_839),VARREF(YevalSastYspecial_quasiquote));
  lit_840 = YPPsym((P)"ast-macro-expand");
  lit_841 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T0 = YPsig(LITREF(lit_841),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_ast_macro_expand_395 = YPmet(FUNCODEREF(fun_ast_macro_expand_395),LITREF(lit_840),T0,ENVNUL,PNUL,YPfalse);
  ...
  T5 = YPsig(LITREF(lit_842),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_843 = YPPsym((P)"macro-expand");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_843),VARREF(YevalSastYspecial_macro_expand));
  lit_844 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T8 = YPsig(LITREF(lit_844),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_845 = YPPsym((P)"syntax-if");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_845),VARREF(YevalSastYspecial_syntax_if));
  lit_846 = YPPsym((P)"export");
  VARSET(YevalSastYDsexpr_export_tag,LITREF(lit_846));
  lit_847 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T11 = YPsig(LITREF(lit_847),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_846),VARREF(YevalSastYspecial_export));
  lit_848 = YPPsym((P)"use");
  VARSET(YevalSastYDsexpr_use_module_tag,LITREF(lit_848));
  lit_849 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T14 = YPsig(LITREF(lit_849),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_850 = YPPsym((P)"use-module");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_850),VARREF(YevalSastYspecial_use_module));
  lit_851 = YPPsym((P)"use/mangle");
  VARSET(YevalSastYDsexpr_use_mangle_module_tag,LITREF(lit_851));
  lit_852 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T17 = YPsig(LITREF(lit_852),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_853 = YPPsym((P)"use-mangle-module");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_853),VARREF(YevalSastYspecial_use_mangle_module));
  lit_854 = YPPsym((P)"use/include");
  VARSET(YevalSastYDsexpr_use_include_tag,LITREF(lit_854));
  lit_855 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T20 = YPsig(LITREF(lit_855),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_856 = YPPsym((P)"use-include");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_856),VARREF(YevalSastYspecial_use_include));
  lit_857 = YPPsym((P)"use/library");
  VARSET(YevalSastYDsexpr_use_library_tag,LITREF(lit_857));
  lit_858 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T23 = YPsig(LITREF(lit_858),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_859 = YPPsym((P)"use-library");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_859),VARREF(YevalSastYspecial_use_library));
  lit_860 = YPPsym((P)"use/export");
  VARSET(YevalSastYDsexpr_useSexport_module_tag,LITREF(lit_860));
  lit_861 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  T26 = YPsig(LITREF(lit_861),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_862 = YPPsym((P)"use/export-module");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_862),VARREF(YevalSastYspecial_useSexport_module));
  lit_863 = YPPsym((P)"<transaction>");
  T30 = (P)YPpair(VARREF(YLanyG),Ynil);
  T29 = XCALL2(1,VARREF(Yfab_class),LITREF(lit_863),T30);
  VARSET(YevalSastYLtransactionG,T29);
  lit_864 = YPPsym((P)"transaction-implemented-bindings");
  lit_865 = YPPlist(1,YPPsym((P)"_x"));
  T31 = YPsig(LITREF(lit_865),YPPlist(1,VARREF(YevalSastYLtransactionG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_transaction_implemented_bindings_404 = YPmet(FUNCODEREF(fun_transaction_implemented_bindings_404),LITREF(lit_864),T31,ENVNUL,PNUL,YPfalse);
  ...
  lit_866 = YPPsym((P)"transaction-implemented-bindings-setter");
  lit_867 = YPPlist(2,YPPsym((P)"_z"),YPPsym((P)"_x"));
  T36 = YPsig(LITREF(lit_867),YPPlist(2,VARREF(YgooScolsScolYLtabG),VARREF(YevalSastYLtransactionG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_transaction_implemented_bindings_setter_405 = YPmet(FUNCODEREF(fun_transaction_implemented_bindings_setter_405),LITREF(lit_866),T36,ENVNUL,PNUL,YPfalse);
  ...
  lit_868 = YPPlist(1,YPPsym((P)"_x"));
  T41 = YPsig(LITREF(lit_868),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  ...
  lit_869 = YPPsym((P)"transaction-dependents");
  lit_870 = YPPlist(1,YPPsym((P)"_x"));
  T43 = YPsig(LITREF(lit_870),YPPlist(1,VARREF(YevalSastYLtransactionG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_transaction_dependents_407 = YPmet(FUNCODEREF(fun_transaction_dependents_407),LITREF(lit_869),T43,ENVNUL,PNUL,YPfalse);
  ...
  lit_871 = YPPsym((P)"transaction-dependents-setter");
  lit_872 = YPPlist(2,YPPsym((P)"_z"),YPPsym((P)"_x"));
  T48 = YPsig(LITREF(lit_872),YPPlist(2,VARREF(YgooScolsScolYLtabG),VARREF(YevalSastYLtransactionG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_transaction_dependents_setter_408 = YPmet(FUNCODEREF(fun_transaction_dependents_setter_408),LITREF(lit_871),T48,ENVNUL,PNUL,YPfalse);
  ...
  lit_873 = YPPlist(1,YPPsym((P)"_x"));
  T53 = YPsig(LITREF(lit_873),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  ...
  lit_874 = YPPsym((P)"transaction-register-implemented-binding");
  lit_875 = YPPlist(1,YPPsym((P)"b"));
  lit_876 = YPsb((P)"Can't register implemented foreign binding (no subtransaction)");
  T55 = YPsig(LITREF(lit_875),YPPlist(1,VARREF(YevalSastYLbindingG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYtransaction_register_implemented_binding = YPmet(FUNCODEREF(YevalSastYtransaction_register_implemented_binding),LITREF(lit_874),T55,ENVNUL,PNUL,YPfalse);
  T56 = YevalSastYtransaction_register_implemented_binding;
  VARSET(YevalSastYtransaction_register_implemented_binding,T56);
  lit_877 = YPPsym((P)"transaction-register-dependent");
  lit_878 = YPPlist(1,YPPsym((P)"d"));
  lit_879 = YPsb((P)"Can't register dependent (no subtransaction)");
  T57 = YPsig(LITREF(lit_878),YPPlist(1,VARREF(YevalSdependencyYLdependentG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYtransaction_register_dependent = YPmet(FUNCODEREF(YevalSastYtransaction_register_dependent),LITREF(lit_877),T57,ENVNUL,PNUL,YPfalse);
  T58 = YevalSastYtransaction_register_dependent;
  VARSET(YevalSastYtransaction_register_dependent,T58);
  lit_880 = YPPsym((P)"transaction-empty?");
  lit_881 = YPPlist(1,YPPsym((P)"t"));
  T59 = YPsig(LITREF(lit_881),YPPlist(1,VARREF(YevalSastYLtransactionG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  YevalSastYtransaction_emptyQ = YPmet(FUNCODEREF(YevalSastYtransaction_emptyQ),LITREF(lit_880),T59,ENVNUL,PNUL,YPfalse);
  T60 = YevalSastYtransaction_emptyQ;
  VARSET(YevalSastYtransaction_emptyQ,T60);
  lit_882 = YPPsym((P)"merge-transactions!");
  lit_883 = YPPlist(2,YPPsym((P)"t1"),YPPsym((P)"t2"));
  lit_884 = YPPlist(2,YPPsym((P)"k"),YPPsym((P)"v"));
  lit_885 = YPPlist(2,YPPsym((P)"k"),YPPsym((P)"v"));
  T63 = YPsig(LITREF(lit_884),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_413 = YPmet(FUNCODEREF(fun_413),YPfalse,T63,ENVNUL,PNUL,YPfalse);
  T62 = YPsig(LITREF(lit_885),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_414 = YPmet(FUNCODEREF(fun_414),YPfalse,T62,ENVNUL,PNUL,YPfalse);
  T61 = YPsig(LITREF(lit_883),YPPlist(2,VARREF(YevalSastYLtransactionG),VARREF(YevalSastYLtransactionG)),YPfalse,YPint((P)2),VARREF(YevalSastYLtransactionG),Ynil);
  YevalSastYmerge_transactionsX = YPmet(FUNCODEREF(YevalSastYmerge_transactionsX),LITREF(lit_882),T61,ENVNUL,PNUL,YPfalse);
  T64 = YevalSastYmerge_transactionsX;
  VARSET(YevalSastYmerge_transactionsX,T64);
  lit_886 = YPPsym((P)"roll-back-transaction");
  lit_887 = YPPlist(1,YPPsym((P)"t"));
  lit_888 = YPPlist(2,YPPsym((P)"binding"),YPPsym((P)"junk"));
  lit_889 = YPPlist(2,YPPsym((P)"dependent"),YPPsym((P)"junk"));
  T67 = YPsig(LITREF(lit_888),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_416 = YPmet(FUNCODEREF(fun_416),YPfalse,T67,ENVNUL,PNUL,YPfalse);
  T66 = YPsig(LITREF(lit_889),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_417 = YPmet(FUNCODEREF(fun_417),YPfalse,T66,ENVNUL,PNUL,YPfalse);
  T65 = YPsig(LITREF(lit_887),YPPlist(1,VARREF(YevalSastYLtransactionG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYroll_back_transaction = YPmet(FUNCODEREF(YevalSastYroll_back_transaction),LITREF(lit_886),T65,ENVNUL,PNUL,YPfalse);
  T68 = YevalSastYroll_back_transaction;
  VARSET(YevalSastYroll_back_transaction,T68);
  lit_890 = YPPsym((P)"call-with-subtransaction");
  lit_891 = YPPlist(2,YPPsym((P)"module"),YPPsym((P)"thunk"));
  ...
  T69 = YPsig(LITREF(lit_891),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  YevalSastYcall_with_subtransaction = YPmet(FUNCODEREF(YevalSastYcall_with_subtransaction),LITREF(lit_890),T69,ENVNUL,PNUL,YPfalse);
  T72 = YevalSastYcall_with_subtransaction;
  VARSET(YevalSastYcall_with_subtransaction,T72);
  lit_892 = YPPlist(1,YPPsym((P)"exp"));
  lit_893 = YPPlist(1,YPPsym((P)"return"));
  lit_894 = YPPsym((P)"x-1456");
  lit_895 = YPPlist(2,YPPsym((P)"msg"),YPPsym((P)"args"));
  lit_896 = YPPsym((P)"with-subtransaction");
  T75 = YPsig(LITREF(lit_895),YPPlist(1,VARREF(YLstrG)),YPtrue,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_x_1456_422 = YPmet(FUNCODEREF(fun_x_1456_422),LITREF(lit_894),T75,ENVNUL,PNUL,YPfalse);
  T74 = YPsig(LITREF(lit_893),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_423 = YPmet(FUNCODEREF(fun_423),YPfalse,T74,ENVNUL,PNUL,YPfalse);
  T73 = YPsig(LITREF(lit_892),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  ...
  lit_897 = YPPsym((P)"objectify-with-subtransaction");
  lit_898 = YPPlist(3,YPPsym((P)"e"),YPPsym((P)"r"),YPPsym((P)"tail?"));
  ...
  T77 = YPsig(LITREF(lit_898),YPPlist(3,VARREF(YLanyG),VARREF(YevalSastYLstatic_environmentG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  YevalSastYobjectify_with_subtransaction = YPmet(FUNCODEREF(YevalSastYobjectify_with_subtransaction),LITREF(lit_897),T77,ENVNUL,PNUL,YPfalse);
  T79 = YevalSastYobjectify_with_subtransaction;
  VARSET(YevalSastYobjectify_with_subtransaction,T79);
  lit_899 = YPPsym((P)"<module-loader>");
  T81 = (P)YPpair(VARREF(YLanyG),Ynil);
  T80 = XCALL2(1,VARREF(Yfab_class),LITREF(lit_899),T81);
  VARSET(YevalSastYLmodule_loaderG,T80);
  lit_900 = YPPsym((P)"module-loader-modules");
  lit_901 = YPPlist(1,YPPsym((P)"_x"));
  T82 = YPsig(LITREF(lit_901),YPPlist(1,VARREF(YevalSastYLmodule_loaderG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_loader_modules_427 = YPmet(FUNCODEREF(fun_module_loader_modules_427),LITREF(lit_900),T82,ENVNUL,PNUL,YPfalse);
  ...
  lit_902 = YPPsym((P)"module-loader-modules-setter");
  lit_903 = YPPlist(2,YPPsym((P)"_z"),YPPsym((P)"_x"));
  T87 = YPsig(LITREF(lit_903),YPPlist(2,VARREF(YgooScolsScolYLtabG),VARREF(YevalSastYLmodule_loaderG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_loader_modules_setter_428 = YPmet(FUNCODEREF(fun_module_loader_modules_setter_428),LITREF(lit_902),T87,ENVNUL,PNUL,YPfalse);
  ...
  lit_904 = YPPlist(1,YPPsym((P)"_x"));
  T92 = YPsig(LITREF(lit_904),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  ...
  lit_905 = YPPsym((P)"module-loader-stack");
  lit_906 = YPPlist(1,YPPsym((P)"_x"));
  T94 = YPsig(LITREF(lit_906),YPPlist(1,VARREF(YevalSastYLmodule_loaderG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_loader_stack_430 = YPmet(FUNCODEREF(fun_module_loader_stack_430),LITREF(lit_905),T94,ENVNUL,PNUL,YPfalse);
  ...
  lit_907 = YPPsym((P)"module-loader-stack-setter");
  lit_908 = YPPlist(2,YPPsym((P)"_z"),YPPsym((P)"_x"));
  T99 = YPsig(LITREF(lit_908),YPPlist(2,VARREF(YLlstG),VARREF(YevalSastYLmodule_loaderG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_loader_stack_setter_431 = YPmet(FUNCODEREF(fun_module_loader_stack_setter_431),LITREF(lit_907),T99,ENVNUL,PNUL,YPfalse);
  ...
  T104 = YPsig(LITREF(lit_909),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  ...
  lit_910 = YPPsym((P)"<module>");
  T107 = (P)YPpair(VARREF(YLanyG),Ynil);
  T106 = XCALL2(1,VARREF(Yfab_class),LITREF(lit_910),T107);
  VARSET(YevalSastYLmoduleG,T106);
  lit_911 = YPPsym((P)"module-name");
  lit_912 = YPPlist(1,YPPsym((P)"_x"));
  T108 = YPsig(LITREF(lit_912),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_name_433 = YPmet(FUNCODEREF(fun_module_name_433),LITREF(lit_911),T108,ENVNUL,PNUL,YPfalse);
  ...
  lit_913 = YPPsym((P)"module-name-setter");
  lit_914 = YPPlist(2,YPPsym((P)"_z"),YPPsym((P)"_x"));
  T113 = YPsig(LITREF(lit_914),YPPlist(2,VARREF(YLsymG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_name_setter_434 = YPmet(FUNCODEREF(fun_module_name_setter_434),LITREF(lit_913),T113,ENVNUL,PNUL,YPfalse);
  ...
  lit_915 = YPPsym((P)"module-mangled-name");
  lit_916 = YPPlist(1,YPPsym((P)"_x"));
  T118 = YPsig(LITREF(lit_916),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_mangled_name_435 = YPmet(FUNCODEREF(fun_module_mangled_name_435),LITREF(lit_915),T118,ENVNUL,PNUL,YPfalse);
  ...
  lit_917 = YPPsym((P)"module-mangled-name-setter");
  lit_918 = YPPlist(2,YPPsym((P)"_z"),YPPsym((P)"_x"));
  T124 = XCALL1(1,VARREF(YgooStypesYtQ),VARREF(YLstrG));
  T123 = YPsig(LITREF(lit_918),YPPlist(2,T124,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_mangled_name_setter_436 = YPmet(FUNCODEREF(fun_module_mangled_name_setter_436),LITREF(lit_917),T123,ENVNUL,PNUL,YPfalse);
  ...
  lit_919 = YPPlist(1,YPPsym((P)"_x"));
  T129 = YPsig(LITREF(lit_919),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  ...
  lit_920 = YPPsym((P)"module-mangled-string-name");
  lit_921 = YPPlist(1,YPPsym((P)"_x"));
  T132 = YPsig(LITREF(lit_921),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_mangled_string_name_438 = YPmet(FUNCODEREF(fun_module_mangled_string_name_438),LITREF(lit_920),T132,ENVNUL,PNUL,YPfalse);
  ...
  lit_922 = YPPsym((P)"module-mangled-string-name-setter");
  lit_923 = YPPlist(2,YPPsym((P)"_z"),YPPsym((P)"_x"));
  T138 = XCALL1(1,VARREF(YgooStypesYtQ),VARREF(YLstrG));
  T137 = YPsig(LITREF(lit_923),YPPlist(2,T138,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_mangled_string_name_setter_439 = YPmet(FUNCODEREF(fun_module_mangled_string_name_setter_439),LITREF(lit_922),T137,ENVNUL,PNUL,YPfalse);
  ...
  T143 = YPsig(LITREF(lit_924),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  ...
  lit_925 = YPPsym((P)"module-target-environment");
  lit_926 = YPPlist(1,YPPsym((P)"_x"));
  T146 = YPsig(LITREF(lit_926),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_target_environment_441 = YPmet(FUNCODEREF(fun_module_target_environment_441),LITREF(lit_925),T146,ENVNUL,PNUL,YPfalse);
  ...
  lit_927 = YPPsym((P)"module-target-environment-setter");
  lit_928 = YPPlist(2,YPPsym((P)"_z"),YPPsym((P)"_x"));
  T151 = YPsig(LITREF(lit_928),YPPlist(2,VARREF(YevalSastYLstatic_global_environmentG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_target_environment_setter_442 = YPmet(FUNCODEREF(fun_module_target_environment_setter_442),LITREF(lit_927),T151,ENVNUL,PNUL,YPfalse);
  ...
  lit_929 = YPPsym((P)"module-syntax-environment");
  lit_930 = YPPlist(1,YPPsym((P)"_x"));
  T156 = YPsig(LITREF(lit_930),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_syntax_environment_443 = YPmet(FUNCODEREF(fun_module_syntax_environment_443),LITREF(lit_929),T156,ENVNUL,PNUL,YPfalse);
  ...
  lit_931 = YPPsym((P)"module-syntax-environment-setter");
  lit_932 = YPPlist(2,YPPsym((P)"_z"),YPPsym((P)"_x"));
  T161 = YPsig(LITREF(lit_932),YPPlist(2,VARREF(YevalSastYLstatic_global_environmentG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_syntax_environment_setter_444 = YPmet(FUNCODEREF(fun_module_syntax_environment_setter_444),LITREF(lit_931),T161,ENVNUL,PNUL,YPfalse);
...
DEFCREGS();
loop:
  lit_933 = YPPsym((P)"%module-exports");
  lit_934 = YPPlist(1,YPPsym((P)"_x"));
  T0 = YPsig(LITREF(lit_934),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_Pmodule_exports_445 = YPmet(FUNCODEREF(fun_Pmodule_exports_445),LITREF(lit_933),T0,ENVNUL,PNUL,YPfalse);
  ...
  lit_935 = YPPsym((P)"%module-exports-setter");
  lit_936 = YPPlist(2,YPPsym((P)"_z"),YPPsym((P)"_x"));
  T5 = YPsig(LITREF(lit_936),YPPlist(2,VARREF(YgooScolsScolYLtabG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_Pmodule_exports_setter_446 = YPmet(FUNCODEREF(fun_Pmodule_exports_setter_446),LITREF(lit_935),T5,ENVNUL,PNUL,YPfalse);
  ...
  T10 = YPsig(LITREF(lit_937),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  ...
  lit_938 = YPPsym((P)"module-data-processed?");
  lit_939 = YPPlist(1,YPPsym((P)"_x"));
  T12 = YPsig(LITREF(lit_939),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_data_processedQ_448 = YPmet(FUNCODEREF(fun_module_data_processedQ_448),LITREF(lit_938),T12,ENVNUL,PNUL,YPfalse);
  ...
  lit_940 = YPPsym((P)"module-data-processed?-setter");
  lit_941 = YPPlist(2,YPPsym((P)"_z"),YPPsym((P)"_x"));
  T17 = YPsig(LITREF(lit_941),YPPlist(2,VARREF(YLlogG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_data_processedQ_setter_449 = YPmet(FUNCODEREF(fun_module_data_processedQ_setter_449),LITREF(lit_940),T17,ENVNUL,PNUL,YPfalse);
  ...
  T22 = YPsig(LITREF(lit_942),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  ...
  lit_943 = YPPsym((P)"module-runtime-data");
  lit_944 = YPPlist(1,YPPsym((P)"_x"));
  T24 = YPsig(LITREF(lit_944),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_runtime_data_451 = YPmet(FUNCODEREF(fun_module_runtime_data_451),LITREF(lit_943),T24,ENVNUL,PNUL,YPfalse);
  ...
  lit_945 = YPPsym((P)"module-runtime-data-setter");
  lit_946 = YPPlist(2,YPPsym((P)"_z"),YPPsym((P)"_x"));
  T29 = YPsig(LITREF(lit_946),YPPlist(2,VARREF(YLanyG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_runtime_data_setter_452 = YPmet(FUNCODEREF(fun_module_runtime_data_setter_452),LITREF(lit_945),T29,ENVNUL,PNUL,YPfalse);
  ...
  T34 = YPsig(LITREF(lit_947),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  ...
  lit_948 = YPPsym((P)"module-transaction");
  lit_949 = YPPlist(1,YPPsym((P)"_x"));
  T36 = YPsig(LITREF(lit_949),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_transaction_454 = YPmet(FUNCODEREF(fun_module_transaction_454),LITREF(lit_948),T36,ENVNUL,PNUL,YPfalse);
  ...
  lit_950 = YPPsym((P)"module-transaction-setter");
  lit_951 = YPPlist(2,YPPsym((P)"_z"),YPPsym((P)"_x"));
  T41 = YPsig(LITREF(lit_951),YPPlist(2,VARREF(YevalSastYLtransactionG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_transaction_setter_455 = YPmet(FUNCODEREF(fun_module_transaction_setter_455),LITREF(lit_950),T41,ENVNUL,PNUL,YPfalse);
  ...
  T46 = YPsig(LITREF(lit_952),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  ...
  lit_953 = YPPsym((P)"module-uses-c-files");
  lit_954 = YPPlist(1,YPPsym((P)"_x"));
  T48 = YPsig(LITREF(lit_954),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_uses_c_files_457 = YPmet(FUNCODEREF(fun_module_uses_c_files_457),LITREF(lit_953),T48,ENVNUL,PNUL,YPfalse);
  ...
  lit_955 = YPPsym((P)"module-uses-c-files-setter");
  lit_956 = YPPlist(2,YPPsym((P)"_z"),YPPsym((P)"_x"));
  T53 = YPsig(LITREF(lit_956),YPPlist(2,VARREF(YgooScolsSvecYLvecG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_uses_c_files_setter_458 = YPmet(FUNCODEREF(fun_module_uses_c_files_setter_458),LITREF(lit_955),T53,ENVNUL,PNUL,YPfalse);
  ...
  T58 = YPsig(LITREF(lit_957),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  ...
  lit_958 = YPPsym((P)"module-uses-c-includes");
  lit_959 = YPPlist(1,YPPsym((P)"_x"));
  T60 = YPsig(LITREF(lit_959),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_uses_c_includes_460 = YPmet(FUNCODEREF(fun_module_uses_c_includes_460),LITREF(lit_958),T60,ENVNUL,PNUL,YPfalse);
  ...
  lit_960 = YPPsym((P)"module-uses-c-includes-setter");
  lit_961 = YPPlist(2,YPPsym((P)"_z"),YPPsym((P)"_x"));
  T65 = YPsig(LITREF(lit_961),YPPlist(2,VARREF(YgooScolsSvecYLvecG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_uses_c_includes_setter_461 = YPmet(FUNCODEREF(fun_module_uses_c_includes_setter_461),LITREF(lit_960),T65,ENVNUL,PNUL,YPfalse);
  ...
  lit_962 = YPPlist(1,YPPsym((P)"_x"));
  T70 = YPsig(LITREF(lit_962),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  ...
  lit_963 = YPPsym((P)"module-uses-c-libraries");
  lit_964 = YPPlist(1,YPPsym((P)"_x"));
  T72 = YPsig(LITREF(lit_964),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_uses_c_libraries_463 = YPmet(FUNCODEREF(fun_module_uses_c_libraries_463),LITREF(lit_963),T72,ENVNUL,PNUL,YPfalse);
  ...
  lit_965 = YPPsym((P)"module-uses-c-libraries-setter");
  lit_966 = YPPlist(2,YPPsym((P)"_z"),YPPsym((P)"_x"));
  T77 = YPsig(LITREF(lit_966),YPPlist(2,VARREF(YgooScolsSvecYLvecG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_uses_c_libraries_setter_464 = YPmet(FUNCODEREF(fun_module_uses_c_libraries_setter_464),LITREF(lit_965),T77,ENVNUL,PNUL,YPfalse);
  ...
  lit_967 = YPPlist(1,YPPsym((P)"_x"));
  T82 = YPsig(LITREF(lit_967),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  ...
  lit_968 = YPPsym((P)"module-exports");
  lit_969 = YPPlist(1,YPPsym((P)"x"));
  T84 = YPsig(LITREF(lit_969),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YgooScolsScolYLtabG),Ynil);
  fun_module_exports_466 = YPmet(FUNCODEREF(fun_module_exports_466),LITREF(lit_968),T84,ENVNUL,PNUL,YPfalse);
  ...
  lit_970 = YPPsym((P)"set-module-environments");
  lit_971 = YPPlist(3,YPPsym((P)"mod"),YPPsym((P)"syntax-env"),YPPsym((P)"target-env"));
  T89 = YPsig(LITREF(lit_971),YPPlist(3,VARREF(YevalSastYLmoduleG),VARREF(YevalSastYLstatic_global_environmentG),VARREF(YevalSastYLstatic_global_environmentG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  YevalSastYset_module_environments = YPmet(FUNCODEREF(YevalSastYset_module_environments),LITREF(lit_970),T89,ENVNUL,PNUL,YPfalse);
  T90 = YevalSastYset_module_environments;
  VARSET(YevalSastYset_module_environments,T90);
  lit_972 = YPPsym((P)"do-module-loader-modules");
  lit_973 = YPPlist(2,YPPsym((P)"f"),YPPsym((P)"loader"));
  lit_974 = YPPlist(1,YPPsym((P)"mod"));
  T92 = YPsig(LITREF(lit_974),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_468 = YPmet(FUNCODEREF(fun_468),YPfalse,T92,ENVNUL,PNUL,YPfalse);
  T91 = YPsig(LITREF(lit_973),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  YevalSastYdo_module_loader_modules = YPmet(FUNCODEREF(YevalSastYdo_module_loader_modules),LITREF(lit_972),T91,ENVNUL,PNUL,YPfalse);
  T93 = YevalSastYdo_module_loader_modules;
  VARSET(YevalSastYdo_module_loader_modules,T93);
  lit_975 = YPPsym((P)"module-loader-module-type");
  lit_976 = YPPlist(1,YPPsym((P)"loader"));
  T94 = YPsig(LITREF(lit_976),YPPlist(1,VARREF(YevalSastYLmodule_loaderG)),YPfalse,YPint((P)1),VARREF(YLtypeG),Ynil);
  fun_module_loader_module_type_470 = YPmet(FUNCODEREF(fun_module_loader_module_type_470),LITREF(lit_975),T94,ENVNUL,PNUL,YPfalse);
  ...
  lit_977 = YPPsym((P)"register-module!");
  lit_978 = YPPlist(2,YPPsym((P)"module-loader"),YPPsym((P)"mod"));
  T99 = YPsig(LITREF(lit_978),YPPlist(2,VARREF(YevalSastYLmodule_loaderG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YevalSastYLmodule_loaderG),Ynil);
  YevalSastYregister_moduleX = YPmet(FUNCODEREF(YevalSastYregister_moduleX),LITREF(lit_977),T99,ENVNUL,PNUL,YPfalse);
  T100 = YevalSastYregister_moduleX;
  VARSET(YevalSastYregister_moduleX,T100);
  lit_979 = YPPsym((P)"probe-module");
  lit_980 = YPPlist(2,YPPsym((P)"loader"),YPPsym((P)"name"));
  T101 = YPsig(LITREF(lit_980),YPPlist(2,VARREF(YevalSastYLmodule_loaderG),VARREF(YLsymG)),YPfalse,YPint((P)2),VARREF(YevalSastYLmoduleG),Ynil);
  YevalSastYprobe_module = YPmet(FUNCODEREF(YevalSastYprobe_module),LITREF(lit_979),T101,ENVNUL,PNUL,YPfalse);
  T102 = YevalSastYprobe_module;
  VARSET(YevalSastYprobe_module,T102);
  lit_981 = YPPsym((P)"load-and-register-module");
  lit_982 = YPPlist(2,YPPsym((P)"loader"),YPPsym((P)"name"));
  lit_983 = YPsb((P)"  ");
  lit_984 = YPsb((P)"%s: error: Circular use of %s not allowed");
  lit_985 = YPsb((P)"%s[Loading module %s...\n");
  lit_986 = YPsb((P)"%s]\n");
  ...
  T103 = YPsig(LITREF(lit_982),YPPlist(2,VARREF(YevalSastYLmodule_loaderG),VARREF(YLsymG)),YPfalse,YPint((P)2),VARREF(YevalSastYLmoduleG),Ynil);
  YevalSastYload_and_register_module = YPmet(FUNCODEREF(YevalSastYload_and_register_module),LITREF(lit_981),T103,ENVNUL,PNUL,YPfalse);
  T106 = YevalSastYload_and_register_module;
  VARSET(YevalSastYload_and_register_module,T106);
  lit_987 = YPPsym((P)"load-module");
  lit_988 = YPPlist(2,YPPsym((P)"loader"),YPPsym((P)"name"));
  T108 = YPsig(LITREF(lit_988),YPPlist(2,VARREF(YevalSastYLmodule_loaderG),VARREF(YLsymG)),YPfalse,YPint((P)2),VARREF(YevalSastYLmoduleG),Ynil);
  T107 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_987),T108,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YevalSastYload_module,T107);
  lit_989 = YPPsym((P)"export-binding!");
  lit_990 = YPPlist(3,YPPsym((P)"module"),YPPsym((P)"name"),YPPsym((P)"binding"));
  lit_991 = YPsb((P)"Tried to export %= and %= from %= as %=");
  T110 = XCALL1(1,VARREF(YgooStypesYtE),YPfalse);
  T109 = YPsig(LITREF(lit_990),YPPlist(3,VARREF(YevalSastYLmoduleG),VARREF(YevalSastYLbinding_nameG),VARREF(YevalSastYLmodule_bindingG)),YPfalse,YPint((P)3),T110,Ynil);
  YevalSastYexport_bindingX = YPmet(FUNCODEREF(YevalSastYexport_bindingX),LITREF(lit_989),T109,ENVNUL,PNUL,YPfalse);
  T111 = YevalSastYexport_bindingX;
  VARSET(YevalSastYexport_bindingX,T111);
  lit_992 = YPPsym((P)"binding-native-to?");
  lit_993 = YPPlist(2,YPPsym((P)"binding"),YPPsym((P)"module"));
  T112 = YPsig(LITREF(lit_993),YPPlist(2,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLlogG),Ynil);
  YevalSastYbinding_native_toQ = YPmet(FUNCODEREF(YevalSastYbinding_native_toQ),LITREF(lit_992),T112,ENVNUL,PNUL,YPfalse);
  T113 = YevalSastYbinding_native_toQ;
  VARSET(YevalSastYbinding_native_toQ,T113);
  lit_994 = YPPsym((P)"report-undefined-global-bindings");
  lit_995 = YPPlist(1,YPPsym((P)"mod"));
  lit_996 = YPPlist(1,YPPsym((P)"binding"));
  lit_997 = YPsb((P)"%s: warning: undefined binding '%s'.\n");
  T115 = YPsig(LITREF(lit_996),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_478 = YPmet(FUNCODEREF(fun_478),YPfalse,T115,ENVNUL,PNUL,YPfalse);
  T114 = YPsig(LITREF(lit_995),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYreport_undefined_global_bindings = YPmet(FUNCODEREF(YevalSastYreport_undefined_global_bindings),LITREF(lit_994),T114,ENVNUL,PNUL,YPfalse);
  T116 = YevalSastYreport_undefined_global_bindings;
  VARSET(YevalSastYreport_undefined_global_bindings,T116);
  lit_998 = YPPsym((P)"compute-transitive-users");
  lit_999 = YPPlist(2,YPPsym((P)"loader"),YPPsym((P)"modnames"));
  lit_1000 = YPPsym((P)"add-user");
  lit_1001 = YPPlist(1,YPPsym((P)"modname"));
  lit_1002 = YPPlist(1,YPPsym((P)"mod"));
  lit_1003 = YPPlist(1,YPPsym((P)"uses-mod"));
  lit_1004 = YPPlist(1,YPPsym((P)"v"));
  T121 = YPsig(LITREF(lit_1003),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_480 = YPmet(FUNCODEREF(fun_480),YPfalse,T121,ENVNUL,PNUL,YPfalse);
  T120 = YPsig(LITREF(lit_1002),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_481 = YPmet(FUNCODEREF(fun_481),YPfalse,T120,ENVNUL,PNUL,YPfalse);
  T119 = YPsig(LITREF(lit_1001),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_add_user_482 = YPmet(FUNCODEREF(fun_add_user_482),LITREF(lit_1000),T119,ENVNUL,PNUL,YPfalse);
  T118 = YPsig(LITREF(lit_1004),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_483 = YPmet(FUNCODEREF(fun_483),YPfalse,T118,ENVNUL,PNUL,YPfalse);
  T117 = YPsig(LITREF(lit_999),YPPlist(2,VARREF(YevalSastYLmodule_loaderG),VARREF(YLlstG)),YPfalse,YPint((P)2),VARREF(YLlstG),Ynil);
  YevalSastYcompute_transitive_users = YPmet(FUNCODEREF(YevalSastYcompute_transitive_users),LITREF(lit_998),T117,ENVNUL,PNUL,YPfalse);
  T122 = YevalSastYcompute_transitive_users;
  VARSET(YevalSastYcompute_transitive_users,T122);
  lit_1005 = YPPsym((P)"remove-module-internal!");
  lit_1006 = YPPlist(2,YPPsym((P)"loader"),YPPsym((P)"mod"));
  T123 = YPsig(LITREF(lit_1006),YPPlist(2,VARREF(YevalSastYLmodule_loaderG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  YevalSastYremove_module_internalX = YPmet(FUNCODEREF(YevalSastYremove_module_internalX),LITREF(lit_1005),T123,ENVNUL,PNUL,YPfalse);
  T124 = YevalSastYremove_module_internalX;
  VARSET(YevalSastYremove_module_internalX,T124);
  lit_1007 = YPPsym((P)"remove-modules-by-name!");
  lit_1008 = YPPlist(2,YPPsym((P)"loader"),YPPsym((P)"modnames"));
  lit_1009 = YPPlist(1,YPPsym((P)"modname"));
  T127 = YPsig(LITREF(lit_1009),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_486 = YPmet(FUNCODEREF(fun_486),YPfalse,T127,ENVNUL,PNUL,YPfalse);
  T126 = XCALL1(1,VARREF(YgooStypesYtE),YPfalse);
  T125 = YPsig(LITREF(lit_1008),YPPlist(2,VARREF(YevalSastYLmodule_loaderG),VARREF(YLlstG)),YPfalse,YPint((P)2),T126,Ynil);
  YevalSastYremove_modules_by_nameX = YPmet(FUNCODEREF(YevalSastYremove_modules_by_nameX),LITREF(lit_1007),T125,ENVNUL,PNUL,YPfalse);
  T128 = YevalSastYremove_modules_by_nameX;
  VARSET(YevalSastYremove_modules_by_nameX,T128);
  lit_1010 = YPPsym((P)"module-name-to-relpath");
  lit_1011 = YPPlist(1,YPPsym((P)"name"));
  T129 = YPsig(LITREF(lit_1011),YPPlist(1,VARREF(YLsymG)),YPfalse,YPint((P)1),VARREF(YLstrG),Ynil);
  YevalSastYmodule_name_to_relpath = YPmet(FUNCODEREF(YevalSastYmodule_name_to_relpath),LITREF(lit_1010),T129,ENVNUL,PNUL,YPfalse);
  T130 = YevalSastYmodule_name_to_relpath;
  VARSET(YevalSastYmodule_name_to_relpath,T130);
  lit_1012 = YPPsym((P)"install-initial-bindings");
  lit_1013 = YPPlist(2,YPPsym((P)"env"),YPPsym((P)"loader"));
  lit_1014 = YPPlist(1,YPPsym((P)"name"));
  lit_1015 = YPPlist(2,YPPsym((P)"seq"),YPPsym((P)"use"));
  T132 = YPsig(LITREF(lit_1014),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_489 = YPmet(FUNCODEREF(fun_489),YPfalse,T132,ENVNUL,PNUL,YPfalse);
  T131 = YPsig(LITREF(lit_1013),YPPlist(2,VARREF(YevalSastYLstatic_global_environmentG),VARREF(YevalSastYLmodule_loaderG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  YevalSastYinstall_initial_bindings = YPmet(FUNCODEREF(YevalSastYinstall_initial_bindings),LITREF(lit_1012),T131,ENVNUL,PNUL,YPfalse);
  T133 = YevalSastYinstall_initial_bindings;
  VARSET(YevalSastYinstall_initial_bindings,T133);
  lit_1016 = YPPsym((P)"fab-static-global-environment");
  lit_1017 = YPPlist(3,YPPsym((P)"module"),YPPsym((P)"module-loader"),YPPsym((P)"allow-foreign-names?"));
  T134 = YPsig(LITREF(lit_1017),YPPlist(3,VARREF(YevalSastYLmoduleG),VARREF(YevalSastYLmodule_loaderG),VARREF(YLlogG)),YPfalse,YPint((P)3),VARREF(YevalSastYLstatic_global_environmentG),Ynil);
  YevalSastYfab_static_global_environment = YPmet(FUNCODEREF(YevalSastYfab_static_global_environment),LITREF(lit_1016),T134,ENVNUL,PNUL,YPfalse);
  T135 = YevalSastYfab_static_global_environment;
  VARSET(YevalSastYfab_static_global_environment,T135);
  lit_1018 = YPPsym((P)"fab-subset-environment");
  lit_1019 = YPPlist(3,YPPsym((P)"module"),YPPsym((P)"src-module"),YPPsym((P)"excluded"));
  lit_1020 = YPPlist(2,YPPsym((P)"name"),YPPsym((P)"binding"));
  T137 = YPsig(LITREF(lit_1020),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_492 = YPmet(FUNCODEREF(fun_492),YPfalse,T137,ENVNUL,PNUL,YPfalse);
  T136 = YPsig(LITREF(lit_1019),YPPlist(3,VARREF(YevalSastYLmoduleG),VARREF(YevalSastYLmoduleG),VARREF(YLcolG)),YPfalse,YPint((P)3),VARREF(YevalSastYLstatic_global_environmentG),Ynil);
  YevalSastYfab_subset_environment = YPmet(FUNCODEREF(YevalSastYfab_subset_environment),LITREF(lit_1018),T136,ENVNUL,PNUL,YPfalse);
  T138 = YevalSastYfab_subset_environment;
  VARSET(YevalSastYfab_subset_environment,T138);
  lit_1021 = YPPsym((P)"<runtime-module-loader>");
  T140 = (P)YPpair(VARREF(YevalSastYLmodule_loaderG),Ynil);
  T139 = XCALL2(1,VARREF(Yfab_class),LITREF(lit_1021),T140);
  VARSET(YevalSastYLruntime_module_loaderG,T139);
  DYNDEFSET(YevalSastYTnow_rt_envT,YPfalse);
  lit_1022 = YPPlist(2,YPPsym((P)"loader"),YPPsym((P)"name"));
  lit_1023 = YPsb((P)"Unable to find module %s");
  ...
  T141 = YPsig(LITREF(lit_1022),YPPlist(2,VARREF(YevalSastYLruntime_module_loaderG),VARREF(YLsymG)),YPfalse,YPint((P)2),VARREF(YevalSastYLmoduleG),Ynil);
  fun_load_module_498 = YPmet(FUNCODEREF(fun_load_module_498),LITREF(lit_987),T141,ENVNUL,PNUL,YPfalse);
  ...
  lit_1024 = YPPsym((P)"runtime-module-loader");
  T151 = YPsig(LITREF(lit_626),Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  YevalSastYruntime_module_loader = YPmet(FUNCODEREF(YevalSastYruntime_module_loader),LITREF(lit_1024),T151,ENVNUL,PNUL,YPfalse);
  T152 = YevalSastYruntime_module_loader;
  VARSET(YevalSastYruntime_module_loader,T152);
  lit_1025 = YPPsym((P)"runtime-module");
  lit_1026 = YPPlist(1,YPPsym((P)"modname"));
  T153 = YPsig(LITREF(lit_1026),YPPlist(1,VARREF(YLsymG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYruntime_module = YPmet(FUNCODEREF(YevalSastYruntime_module),LITREF(lit_1025),T153,ENVNUL,PNUL,YPfalse);
  T154 = YevalSastYruntime_module;
  VARSET(YevalSastYruntime_module,T154);
  lit_1027 = YPPsym((P)"runtime-environment");
  lit_1028 = YPPlist(1,YPPsym((P)"modname"));
  T155 = YPsig(LITREF(lit_1028),YPPlist(1,VARREF(YLsymG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYruntime_environment = YPmet(FUNCODEREF(YevalSastYruntime_environment),LITREF(lit_1027),T155,ENVNUL,PNUL,YPfalse);
  T156 = YevalSastYruntime_environment;
  VARSET(YevalSastYruntime_environment,T156);
  lit_1029 = YPPsym((P)"runtime-core-environment");
  lit_1030 = YPPlist(1,YPPsym((P)"modname"));
  T157 = YPsig(LITREF(lit_1030),YPPlist(1,VARREF(YLsymG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYruntime_core_environment = YPmet(FUNCODEREF(YevalSastYruntime_core_environment),LITREF(lit_1029),T157,ENVNUL,PNUL,YPfalse);
  T158 = YevalSastYruntime_core_environment;
  VARSET(YevalSastYruntime_core_environment,T158);
  lit_1031 = YPPsym((P)"unchecked-runtime-environment");
  lit_1032 = YPPlist(1,YPPsym((P)"modname"));
  T159 = YPsig(LITREF(lit_1032),YPPlist(1,VARREF(YLsymG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYunchecked_runtime_environment = YPmet(FUNCODEREF(YevalSastYunchecked_runtime_environment),LITREF(lit_1031),T159,ENVNUL,PNUL,YPfalse);
  T160 = YevalSastYunchecked_runtime_environment;
  VARSET(YevalSastYunchecked_runtime_environment,T160);
  lit_1033 = YPPsym((P)"reloader-do-create-module");
  lit_1034 = YPPlist(2,YPPsym((P)"modname"),YPPsym((P)"data"));
  T161 = YPsig(LITREF(lit_1034),YPPlist(2,VARREF(YLstrG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YevalSastYLmoduleG),Ynil);
  YevalSastYreloader_do_create_module = YPmet(FUNCODEREF(YevalSastYreloader_do_create_module),LITREF(lit_1033),T161,ENVNUL,PNUL,YPfalse);
  T162 = YevalSastYreloader_do_create_module;
  VARSET(YevalSastYreloader_do_create_module,T162);
  lit_1035 = YPPsym((P)"reloader-do-use-module");
  lit_1036 = YPPlist(2,YPPsym((P)"mod"),YPPsym((P)"uses"));
  T163 = YPsig(LITREF(lit_1036),YPPlist(2,VARREF(YevalSastYLmoduleG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  YevalSastYreloader_do_use_module = YPmet(FUNCODEREF(YevalSastYreloader_do_use_module),LITREF(lit_1035),T163,ENVNUL,PNUL,YPfalse);
  T164 = YevalSastYreloader_do_use_module;
  VARSET(YevalSastYreloader_do_use_module,T164);
  lit_1037 = YPPsym((P)"reloader-do-import");
  lit_1038 = YPPlist(4,YPPsym((P)"mod"),YPPsym((P)"name"),YPPsym((P)"from-mod"),YPPsym((P)"original-name"));
  lit_1039 = YPsb((P)"Can't find %s from %s for %s\n");
  T165 = YPsig(LITREF(lit_1038),YPPlist(4,VARREF(YevalSastYLmoduleG),VARREF(YLstrG),VARREF(YevalSastYLmoduleG),VARREF(YLstrG)),YPfalse,YPint((P)4),VARREF(YLanyG),Ynil);
  YevalSastYreloader_do_import = YPmet(FUNCODEREF(YevalSastYreloader_do_import),LITREF(lit_1037),T165,ENVNUL,PNUL,YPfalse);
  T166 = YevalSastYreloader_do_import;
  VARSET(YevalSastYreloader_do_import,T166);
  lit_1040 = YPPsym((P)"process-module-data");
  lit_1041 = YPPlist(1,YPPsym((P)"module"));
  T167 = YPsig(LITREF(lit_1041),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYprocess_module_data = YPmet(FUNCODEREF(YevalSastYprocess_module_data),LITREF(lit_1040),T167,ENVNUL,PNUL,YPfalse);
  T168 = YevalSastYprocess_module_data;
  VARSET(YevalSastYprocess_module_data,T168);
  lit_1042 = YPPsym((P)"ensure-module-data");
  lit_1043 = YPPlist(1,YPPsym((P)"module"));
  T169 = YPsig(LITREF(lit_1043),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYensure_module_data = YPmet(FUNCODEREF(YevalSastYensure_module_data),LITREF(lit_1042),T169,ENVNUL,PNUL,YPfalse);
  T170 = YevalSastYensure_module_data;
  VARSET(YevalSastYensure_module_data,T170);
  lit_1044 = YPPsym((P)"reloader-do-runtime-binding");
  lit_1045 = YPPlist(3,YPPsym((P)"mod"),YPPsym((P)"name"),YPPsym((P)"loc"));
  T171 = YPsig(LITREF(lit_1045),YPPlist(3,VARREF(YevalSastYLmoduleG),VARREF(YLstrG),VARREF(YLlocG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  YevalSastYreloader_do_runtime_binding = YPmet(FUNCODEREF(YevalSastYreloader_do_runtime_binding),LITREF(lit_1044),T171,ENVNUL,PNUL,YPfalse);
  T172 = YevalSastYreloader_do_runtime_binding;
  VARSET(YevalSastYreloader_do_runtime_binding,T172);
  lit_1046 = YPPsym((P)"reloader-do-dynamic-binding");
  lit_1047 = YPPlist(3,YPPsym((P)"mod"),YPPsym((P)"name"),YPPsym((P)"loc"));
  T173 = YPsig(LITREF(lit_1047),YPPlist(3,VARREF(YevalSastYLmoduleG),VARREF(YLstrG),VARREF(YLlocG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  YevalSastYreloader_do_dynamic_binding = YPmet(FUNCODEREF(YevalSastYreloader_do_dynamic_binding),LITREF(lit_1046),T173,ENVNUL,PNUL,YPfalse);
  T174 = YevalSastYreloader_do_dynamic_binding;
  VARSET(YevalSastYreloader_do_dynamic_binding,T174);
  lit_1048 = YPPsym((P)"reloader-do-other-binding");
  lit_1049 = YPPlist(2,YPPsym((P)"mod"),YPPsym((P)"name"));
  T175 = YPsig(LITREF(lit_1049),YPPlist(2,VARREF(YevalSastYLmoduleG),VARREF(YLstrG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  YevalSastYreloader_do_other_binding = YPmet(FUNCODEREF(YevalSastYreloader_do_other_binding),LITREF(lit_1048),T175,ENVNUL,PNUL,YPfalse);
  T176 = YevalSastYreloader_do_other_binding;
  VARSET(YevalSastYreloader_do_other_binding,T176);
  lit_1050 = YPPsym((P)"reloader-do-export");
  lit_1051 = YPPlist(3,YPPsym((P)"mod"),YPPsym((P)"name"),YPPsym((P)"as-name"));
  lit_1052 = YPsb((P)"Can't find %s in %s\n");
  T177 = YPsig(LITREF(lit_1051),YPPlist(3,VARREF(YevalSastYLmoduleG),VARREF(YLstrG),VARREF(YLstrG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  YevalSastYreloader_do_export = YPmet(FUNCODEREF(YevalSastYreloader_do_export),LITREF(lit_1050),T177,ENVNUL,PNUL,YPfalse);
  T178 = YevalSastYreloader_do_export;
  VARSET(YevalSastYreloader_do_export,T178);
  lit_1053 = YPPsym((P)"reload-modules");
  T179 = YPsig(LITREF(lit_626),Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  YevalSastYreload_modules = YPmet(FUNCODEREF(YevalSastYreload_modules),LITREF(lit_1053),T179,ENVNUL,PNUL,YPfalse);
  T180 = YevalSastYreload_modules;
  VARSET(YevalSastYreload_modules,T180);
  lit_1054 = YPPsym((P)"install-magic-bindings");
  lit_1055 = YPPlist(1,YPPsym((P)"env"));
  lit_1056 = YPPlist(1,YPPsym((P)"binding"));
  T182 = YPsig(LITREF(lit_1056),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_514 = YPmet(FUNCODEREF(fun_514),YPfalse,T182,ENVNUL,PNUL,YPfalse);
  T181 = YPsig(LITREF(lit_1055),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYinstall_magic_bindings = YPmet(FUNCODEREF(YevalSastYinstall_magic_bindings),LITREF(lit_1054),T181,ENVNUL,PNUL,YPfalse);
  T183 = YevalSastYinstall_magic_bindings;
  VARSET(YevalSastYinstall_magic_bindings,T183);
  lit_1057 = YPPsym((P)"reload-macros");
  T184 = YPsig(LITREF(lit_626),Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  YevalSastYreload_macros = YPmet(FUNCODEREF(YevalSastYreload_macros),LITREF(lit_1057),T184,ENVNUL,PNUL,YPfalse);
  T185 = YevalSastYreload_macros;
  VARSET(YevalSastYreload_macros,T185);
  lit_1058 = YPPsym((P)"install-interpreter-hacks");
  lit_1059 = YPPlist(1,YPPsym((P)"env"));
  T188 = YPsig(LITREF(lit_1059),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  T187 = YevalSastYinstall_interpreter_hacks = YPmet(FUNCODEREF(YevalSastYinstall_interpreter_hacks),LITREF(lit_1058),T188,ENVNUL,PNUL,YPfalse);
...
DEFCREGS();
loop:
  lit_1060 = YPPsym((P)"init-runtime");
  T0 = YPsig(LITREF(lit_626),Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  YevalSastYinit_runtime = YPmet(FUNCODEREF(YevalSastYinit_runtime),LITREF(lit_1060),T0,ENVNUL,PNUL,YPfalse);
  T1 = YevalSastYinit_runtime;
  VARSET(YevalSastYinit_runtime,T1);
  lit_1061 = YPPlist(5,YPPsym((P)"ct"),YPPsym((P)"ct-also"),YPPsym((P)"ds"),YPPsym((P)"use"),YPPsym((P)"export"));
  VARSET(YevalSastYsyntax_environment_excluded_bindings,LITREF(lit_1061));
  lit_1062 = YPPsym((P)"fab-syntax-environment");
  lit_1063 = YPPlist(1,YPPsym((P)"module"));
  lit_1064 = YPPsym((P)"goo");
  T2 = YPsig(LITREF(lit_1063),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YevalSastYLstatic_global_environmentG),Ynil);
  YevalSastYfab_syntax_environment = YPmet(FUNCODEREF(YevalSastYfab_syntax_environment),LITREF(lit_1062),T2,ENVNUL,PNUL,YPfalse);
  T3 = YevalSastYfab_syntax_environment;
  VARSET(YevalSastYfab_syntax_environment,T3);
  lit_1065 = YPPsym((P)"fab-g2c-module");
  lit_1066 = YPPlist(2,YPPsym((P)"loader"),YPPsym((P)"name"));
  T4 = YPsig(LITREF(lit_1066),YPPlist(2,VARREF(YevalSastYLmodule_loaderG),VARREF(YLsymG)),YPfalse,YPint((P)2),VARREF(YevalSastYLmoduleG),Ynil);
  YevalSastYfab_g2c_module = YPmet(FUNCODEREF(YevalSastYfab_g2c_module),LITREF(lit_1065),T4,ENVNUL,PNUL,YPfalse);
  T5 = YevalSastYfab_g2c_module;
  VARSET(YevalSastYfab_g2c_module,T5);
  lit_1067 = YPPsym((P)"init-g2c-boot-environment");
  lit_1068 = YPPlist(1,YPPsym((P)"env"));
  T6 = YPsig(LITREF(lit_1068),YPPlist(1,VARREF(YevalSastYLstatic_global_environmentG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYinit_g2c_boot_environment = YPmet(FUNCODEREF(YevalSastYinit_g2c_boot_environment),LITREF(lit_1067),T6,ENVNUL,PNUL,YPfalse);
  T7 = YevalSastYinit_g2c_boot_environment;
  VARSET(YevalSastYinit_g2c_boot_environment,T7);
  lit_1069 = YPPsym((P)"init-g2c-regular-environment");
  lit_1070 = YPPlist(2,YPPsym((P)"env"),YPPsym((P)"loader"));
  T8 = YPsig(LITREF(lit_1070),YPPlist(2,VARREF(YevalSastYLstatic_global_environmentG),VARREF(YevalSastYLmodule_loaderG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  YevalSastYinit_g2c_regular_environment = YPmet(FUNCODEREF(YevalSastYinit_g2c_regular_environment),LITREF(lit_1069),T8,ENVNUL,PNUL,YPfalse);
  T9 = YevalSastYinit_g2c_regular_environment;
  VARSET(YevalSastYinit_g2c_regular_environment,T9);
  lit_1071 = YPPsym((P)"init-ast");
  T10 = YPsig(LITREF(lit_626),Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  YevalSastYinit_ast = YPmet(FUNCODEREF(YevalSastYinit_ast),LITREF(lit_1071),T10,ENVNUL,PNUL,YPfalse);
  T11 = YevalSastYinit_ast;
  VARSET(YevalSastYinit_ast,T11);
  lit_1072 = YPPsym((P)"do-static-global-bindings");
  lit_1073 = YPPlist(2,YPPsym((P)"f"),YPPsym((P)"env"));
  lit_1074 = YPPlist(1,YPPsym((P)"env"));
  T13 = YPsig(LITREF(lit_1074),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_loop_524 = YPmet(FUNCODEREF(fun_loop_524),LITREF(lit_248),T13,ENVNUL,PNUL,YPfalse);
  T12 = YPsig(LITREF(lit_1073),YPPlist(2,VARREF(YLfunG),VARREF(YevalSastYLstatic_global_environmentG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  YevalSastYdo_static_global_bindings = YPmet(FUNCODEREF(YevalSastYdo_static_global_bindings),LITREF(lit_1072),T12,ENVNUL,PNUL,YPfalse);
  T14 = YevalSastYdo_static_global_bindings;
  VARSET(YevalSastYdo_static_global_bindings,T14);
  lit_1075 = YPPsym((P)"do-named-static-global-bindings");
  lit_1076 = YPPlist(2,YPPsym((P)"f"),YPPsym((P)"env"));
  lit_1077 = YPPlist(1,YPPsym((P)"env"));
  T16 = YPsig(LITREF(lit_1077),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_loop_526 = YPmet(FUNCODEREF(fun_loop_526),LITREF(lit_248),T16,ENVNUL,PNUL,YPfalse);
  T15 = YPsig(LITREF(lit_1076),YPPlist(2,VARREF(YLfunG),VARREF(YevalSastYLstatic_global_environmentG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  YevalSastYdo_named_static_global_bindings = YPmet(FUNCODEREF(YevalSastYdo_named_static_global_bindings),LITREF(lit_1075),T15,ENVNUL,PNUL,YPfalse);
