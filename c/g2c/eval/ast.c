...
LOCFOR(fun_x_1429_109);
LOCFOR(fun_110);
LOCFOR(fun_111);
LOCFOR(fun_x_1433_112);
LOCFOR(fun_113);
LOCFOR(fun_114);
...
LOCFOR(fun_insert_and_mangle_globalX_317);
FUNFOR(YevalSastYimport_and_mangle_globalX);
LOCFOR(fun_319);
LOCFOR(fun_objectify_use_mangle_module_320);
...
LOCFOR(fun_382);
LOCFOR(fun_383);
LOCFOR(fun_transaction_implemented_bindings_384);
LOCFOR(fun_transaction_implemented_bindings_setter_385);
LOCFOR(fun_386);
LOCFOR(fun_transaction_dependents_387);
LOCFOR(fun_transaction_dependents_setter_388);
LOCFOR(fun_389);
...
LOCFOR(fun_x_1448_402);
LOCFOR(fun_403);
LOCFOR(fun_404);
LOCFOR(fun_405);
FUNFOR(YevalSastYobjectify_with_subtransaction);
LOCFOR(fun_module_loader_modules_407);
LOCFOR(fun_module_loader_modules_setter_408);
LOCFOR(fun_409);
LOCFOR(fun_module_loader_stack_410);
LOCFOR(fun_module_loader_stack_setter_411);
LOCFOR(fun_412);
LOCFOR(fun_module_name_413);
LOCFOR(fun_module_name_setter_414);
LOCFOR(fun_module_mangled_name_415);
LOCFOR(fun_module_mangled_name_setter_416);
LOCFOR(fun_417);
LOCFOR(fun_module_mangled_string_name_418);
LOCFOR(fun_module_mangled_string_name_setter_419);
LOCFOR(fun_420);
LOCFOR(fun_module_target_environment_421);
LOCFOR(fun_module_target_environment_setter_422);
LOCFOR(fun_module_syntax_environment_423);
LOCFOR(fun_module_syntax_environment_setter_424);
LOCFOR(fun_Pmodule_exports_425);
LOCFOR(fun_Pmodule_exports_setter_426);
LOCFOR(fun_427);
LOCFOR(fun_module_data_processedQ_428);
LOCFOR(fun_module_data_processedQ_setter_429);
LOCFOR(fun_430);
LOCFOR(fun_module_runtime_data_431);
LOCFOR(fun_module_runtime_data_setter_432);
LOCFOR(fun_433);
LOCFOR(fun_module_transaction_434);
LOCFOR(fun_module_transaction_setter_435);
LOCFOR(fun_436);
LOCFOR(fun_module_uses_c_files_437);
LOCFOR(fun_module_uses_c_files_setter_438);
LOCFOR(fun_439);
LOCFOR(fun_module_exports_440);
FUNFOR(YevalSastYset_module_environments);
LOCFOR(fun_442);
FUNFOR(YevalSastYdo_module_loader_modules);
LOCFOR(fun_module_loader_module_type_444);
...
LINK_STACK();
  ARG(return_, 0);
loop:
  T1 = FUNSHELL(0,fun_x_1423_0,1);
  x_1423F1658 = T1;
  FUNINIT(x_1423F1658, 1,return_);
  x_1422F1659 = FREEREF(0);
  dependentF1660 = YPfalse;
  dependentF1660 = BOXFAB(dependentF1660);
  bodyF1661 = YPfalse;
  bodyF1661 = BOXFAB(bodyF1661);
  T7 = CALL2(1,VARREF(YisaQ),x_1422F1659,VARREF(YLlstG));
  if (T7 != YPfalse) {
    T9 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1422F1659,LITREF(lit_6),x_1423F1658);
    x_1422F1662 = T9;
    T11 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1422F1662,x_1423F1658);
    BOXVAL(dependentF1660) = T11;
    T12 = CALL1(1,VARREF(Ytail),x_1422F1662);
    x_1422F1663 = T12;
    BOXVAL(bodyF1661) = x_1422F1663;
    x_1422F1664 = Ynil;
    T14 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1422F1664,x_1423F1658);
    T13 = T14;
    T10 = T13;
    T8 = T10;
  } else {
    T15 = CALL2(1,x_1423F1658,LITREF(lit_7),x_1422F1659);
  }
  T17 = CALL0(1,VARREF(YgooSmacrosYgensym));
  saved_dependentF1665 = T17;
  T19 = CALL1(1,VARREF(Ylst),LITREF(lit_8));
  T24 = CALL1(1,VARREF(Ylst),saved_dependentF1665);
  ...
  T43 = CALL1(1,VARREF(Ylst),saved_dependentF1665);
...
loop:
  ...
  modF1666 = T1;
  if (modF1666 != YPfalse) {
    T3 = CALL1(1,VARREF(YevalSastYmodule_name),modF1666);
    T2 = T3;
  } else {
...
loop:
  ...
  bF1667 = T1;
  x_1424F1668 = bF1667;
  x_1425F1669 = VARREF(YisaQ);
  T5 = CALL2(1,x_1425F1669,x_1424F1668,VARREF(YLsymG));
  if (T5 != YPfalse) {
    T6 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLstrG),bF1667);
    T4 = T6;
  } else {
    T8 = CALL2(1,x_1425F1669,x_1424F1668,VARREF(YevalSastYLmodule_bindingG));
    if (T8 != YPfalse) {
      T10 = CALL1(1,VARREF(YevalSastYbinding_module_name),bF1667);
      T11 = CALL1(1,VARREF(YevalSastYbinding_name),bF1667);
...
loop:
  ...
  if (T3 != YPfalse) {
    T4 = CALL3(1,VARREF(YgooSruntimeYmsg),VARREF(YgooSioSportYout),LITREF(lit_143),nameF1670);
    T2 = T4;
  } else {
    T6 = CALL2(1,VARREF(YevalSdependencyYdependency_includes_anyQ),dtype_,VARREF(YevalSdependencyYDoptimizaton_dependencies));
    if (T6 != YPfalse) {
      T7 = CALL3(1,VARREF(YgooSruntimeYmsg),VARREF(YgooSioSportYout),LITREF(lit_144),nameF1670);
      T5 = T7;
    } else {
      if (YPtrue != YPfalse) {
        T9 = CALL3(1,VARREF(YgooSruntimeYmsg),VARREF(YgooSioSportYout),LITREF(lit_145),nameF1670);
        T8 = T9;
      } else {
        T8 = YPfalse;
      }
...
loop:
  ...
  loopF1671 = T1;
  FUNINIT(loopF1671, 1,loopF1671);
  T2 = CALL2(0,loopF1671,Ynil,e_);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}

FUNCODEDEF(fun_x_1429_109) {
  P msg_,args_;
  P T0;
  P a1,a2;
LINK_STACK();
...
LINK_STACK();
  ARG(return_, 0);
loop:
  T1 = FUNSHELL(0,fun_x_1429_109,1);
  x_1429F1672 = T1;
  FUNINIT(x_1429F1672, 1,return_);
  x_1428F1673 = FREEREF(0);
  nameF1674 = YPfalse;
  nameF1674 = BOXFAB(nameF1674);
  supersF1675 = YPfalse;
  supersF1675 = BOXFAB(supersF1675);
  T7 = CALL2(1,VARREF(YisaQ),x_1428F1673,VARREF(YLlstG));
  if (T7 != YPfalse) {
    T9 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1428F1673,LITREF(lit_152),x_1429F1672);
    x_1428F1676 = T9;
    T11 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1428F1676,x_1429F1672);
    BOXVAL(nameF1674) = T11;
    T12 = CALL1(1,VARREF(Ytail),x_1428F1676);
    x_1428F1677 = T12;
    T14 = CALL2(1,VARREF(YgooSmacrosYmatch_sublist),x_1428F1677,x_1429F1672);
    x_1428F1678 = T14;
    BOXVAL(supersF1675) = x_1428F1678;
    x_1428F1679 = Ynil;
    T16 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1428F1679,x_1429F1672);
    T15 = T16;
    T17 = CALL1(1,VARREF(Ytail),x_1428F1677);
    x_1428F1680 = T17;
    T18 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1428F1680,x_1429F1672);
    T13 = T18;
    T10 = T13;
    T8 = T10;
  } else {
    T19 = CALL2(1,x_1429F1672,LITREF(lit_7),x_1428F1673);
  }
  T22 = BOXVAL(nameF1674);
  T21 = CALL3(1,VARREF(YgooSmacrosYcat_sym),LITREF(lit_153),T22,LITREF(lit_154));
  classF1681 = T21;
  T25 = BOXVAL(nameF1674);
  ...
  T31 = CALL1(1,VARREF(Ylst),classF1681);
  T34 = CALL1(1,VARREF(Ylst),LITREF(lit_158));
  T35 = BOXVAL(supersF1675);
  ...
  T39 = CALL1(1,VARREF(Ylst),DemptyF1682);
  T42 = CALL1(1,VARREF(Ylst),LITREF(lit_160));
  T43 = CALL1(1,VARREF(Ylst),classF1681);
  ...
  T56 = CALL1(1,VARREF(Ylst),classF1681);
  ...
  T73 = CALL1(1,VARREF(Ylst),classF1681);
...
LINK_STACK();
  ARG(return_, 0);
loop:
  T1 = FUNSHELL(0,fun_x_1433_112,1);
  x_1433F1683 = T1;
  FUNINIT(x_1433F1683, 1,return_);
  x_1432F1684 = FREEREF(0);
  nameF1685 = YPfalse;
  nameF1685 = BOXFAB(nameF1685);
  T5 = CALL2(1,VARREF(YisaQ),x_1432F1684,VARREF(YLlstG));
  if (T5 != YPfalse) {
    T7 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1432F1684,LITREF(lit_171),x_1433F1683);
    x_1432F1686 = T7;
    T9 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1432F1686,x_1433F1683);
    BOXVAL(nameF1685) = T9;
    T10 = CALL1(1,VARREF(Ytail),x_1432F1686);
    x_1432F1687 = T10;
    T11 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1432F1687,x_1433F1683);
    T8 = T11;
    T6 = T8;
  } else {
    T12 = CALL2(1,x_1433F1683,LITREF(lit_7),x_1432F1684);
  }
  T14 = CALL1(1,VARREF(Ylst),LITREF(lit_152));
  T16 = BOXVAL(nameF1685);
...
loop:
  ...
  refF1690 = T1;
  T2 = CALL3(1,VARREF(Ynew),VARREF(YevalSastYLboundQG),VARREF(YevalSastYboundQ_reference),refF1690);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  modF1691 = T1;
  T3 = CALL1(1,VARREF(YevalSastYmodule_syntax_environment),modF1691);
  syntax_envF1692 = T3;
  T5 = CALL1(1,VARREF(YevalSastYmodule_target_environment),modF1691);
  target_envF1693 = T5;
  T7 = CALL3(1,VARREF(YevalSastYobjectify),program_,syntax_envF1692,tailQ_);
  astF1694 = T7;
  CALL1(1,VARREF(YevalSastYast_evaluate),astF1694);
  tmpF1695 = rtQ_;
  if (tmpF1695 != YPfalse) {
    T11 = CALL2(1,VARREF(YgooSmathYNEE),syntax_envF1692,target_envF1693);
    T10 = T11;
  } else {
    T10 = YPfalse;
  }
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    if (T4 != YPfalse) {
      ...
      loopF1696 = T8;
      FUNINIT(loopF1696, 1,loopF1696);
      T9 = CALL1(0,loopF1696,eT_);
      T7 = T9;
      T3 = T7;
    }
    T0 = T3;
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    eF1697 = T3;
    T5 = CALL1(1,VARREF(YevalSsyntaxYsexpr_defQ),eF1697);
    if (T5 != YPfalse) {
      T9 = CALL1(1,VARREF(Ylst),LITREF(lit_8));
      T15 = CALL1(1,VARREF(YevalSsyntaxYsexpr_def_variable),eF1697);
      T14 = CALL1(1,VARREF(Ylst),T15);
      T17 = CALL1(1,VARREF(YevalSsyntaxYsexpr_def_value),eF1697);
      ...
      T21 = CALL1(1,VARREF(Ylst),eF1697);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    T8 = CALL3(1,VARREF(YevalSastYobjectify),T9,FREEREF(1),tailQF1698);
    headF1699 = T8;
    T11 = CALL2(1,VARREF(YgooSmacrosYpair),headF1699,res_);
...
loop:
  ...
  loopF1700 = T2;
  FUNINIT(loopF1700, 3,tailQ_,r_,loopF1700);
  T4 = CALL1(1,VARREF(YevalSastYtransform_defs),eT_);
  T3 = CALL2(0,loopF1700,Ynil,T4);
  T1 = T3;
  astsF1701 = T1;
  T5 = CALL1(1,VARREF(YevalSastYsequentialize),astsF1701);
  T0 = T5;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  eeTF1702 = T1;
  T4 = CALL4(1,VARREF(YevalSastYprocess_closed_application),ff_,eeTF1702,r_,tailQ_);
  T0 = T4;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  fvfF1704 = T5;
  T6 = CALLN(1,VARREF(Ynew),7,VARREF(YevalSastYLpredefined_applicationG),VARREF(YevalSastYapplication_binding),fvfF1704,VARREF(YevalSastYapplication_arguments),eeTF1703,VARREF(YevalSastYapplication_tailQ),tailQ_);
  T4 = T6;
  T0 = T4;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  T6 = CALLN(1,VARREF(Ynew),7,VARREF(YevalSastYLregular_applicationG),VARREF(YevalSastYapplication_function),ff_,VARREF(YevalSastYapplication_arguments),eeTF1705,VARREF(YevalSastYapplication_tailQ),tailQ_);
  T0 = T6;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  varF1708 = T1;
  T3 = CALL1(1,VARREF(YevalSastYbinding_dottedQ),varF1708);
  if (T3 != YPfalse) {
    T5 = CALL3(1,VARREF(YevalSastYobjectify),LITREF(lit_158),FREEREF(0),YPfalse);
    lst_typeF1709 = T5;
    CALL2(1,VARREF(YevalSastYbinding_dottedQ_setter),YPfalse,varF1708);
    CALL2(1,VARREF(YevalSastYbinding_type_setter),lst_typeF1709,varF1708);
    CALL2(1,VARREF(Yhead_setter),lst_typeF1709,tT_);
...
loop:
  ...
  pack_nary_argsF1710 = T1;
  T2 = FUNSHELL(1,fun_pack_args_251,4);
  pack_argsF1711 = T2;
  FUNINIT(pack_nary_argsF1710, 1,pack_nary_argsF1710);
  FUNINIT(pack_argsF1711, 4,r_,pack_nary_argsF1710,f_,pack_argsF1711);
  ...
  T8 = CALL3(0,pack_argsF1711,eT_,vTF1712,T9);
  T10 = CALL1(1,VARREF(YevalSastYfunction_body),f_);
  T6 = CALLN(1,VARREF(Ynew),9,VARREF(YevalSastYLfix_letG),VARREF(YevalSastYfix_let_bindings),vTF1712,VARREF(YevalSastYfix_let_types),T7,VARREF(YevalSastYfix_let_arguments),T8,VARREF(YevalSastYfix_let_body),T10);
  oF1713 = T6;
  T5 = oF1713;
  T3 = T5;
  T0 = T3;
...
loop:
  ...
  opF1714 = T1;
  T3 = CALL1(1,VARREF(YevalSsyntaxYsexpr_variableQ),opF1714);
  if (T3 != YPfalse) {
    T7 = CALL1(1,VARREF(YevalSsyntaxYsexpr_fab_setter_name),opF1714);
...
loop:
  ...
  valF1716 = T3;
  T4 = CALL2(1,VARREF(YevalSastYobjectify_assignment_using),refF1715,valF1716);
  T2 = T4;
  T0 = T2;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  existing_bindingF1718 = T1;
  T3 = CALL1(1,VARREF(YevalSastYfind_static_global_environment),r_);
  grF1719 = T3;
  T5 = CALL1(1,VARREF(YevalSastYenvironment_module),grF1719);
  modF1720 = T5;
  if (existing_bindingF1718 != YPfalse) {
    T11 = CALL2(1,VARREF(YevalSastYbinding_native_toQ),existing_bindingF1718,modF1720);
    tmpF1721 = T11;
    if (tmpF1721 != YPfalse) {
      T12 = tmpF1721;
    } else {
    ...
    foreignQF1722 = T9;
    T13 = CALL1(1,VARREF(YevalSastYbinding_freeQ),existing_bindingF1718);
    if (T13 != YPfalse) {
      CALL2(1,VARREF(YevalSastYbinding_freeQ_setter),YPfalse,existing_bindingF1718);
      if (foreignQF1722 != YPfalse) {
        T15 = CALL1(1,VARREF(YevalSastYtransaction_register_implemented_binding),existing_bindingF1718);
        T14 = T15;
      } else {
        T14 = YPfalse;
      }
      ...
      if (foreignQF1722 != YPfalse) {
        T18 = CALL1(1,VARREF(YevalSastYmodule_name),modF1720);
        T19 = CALL1(1,VARREF(YevalSastYbinding_module_name),existing_bindingF1718);
    ...
    CALL2(1,VARREF(YevalSdependencyYinvalidate_dependents),existing_bindingF1718,VARREF(YevalSdependencyYDall_dependency_types));
    CALL2(1,VARREF(YevalSastYupdate_binding_kind),existing_bindingF1718,kind_);
    T8 = existing_bindingF1718;
    T7 = T8;
  } else {
    T21 = CALL1(1,VARREF(YevalSastYfind_environment_module),r_);
    modF1723 = T21;
    T23 = CALLN(1,VARREF(Ynew),9,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),kind_,VARREF(YevalSastYbinding_name),name_,VARREF(YevalSastYbinding_freeQ),YPfalse,VARREF(YevalSastYbinding_module),modF1723);
    bindingF1724 = T23;
    CALL2(1,VARREF(YevalSastYinsert_globalX),bindingF1724,grF1719);
    T22 = bindingF1724;
    T20 = T22;
    T7 = T20;
  }
...
loop:
  ...
  nameF1726 = T1;
  T3 = CALL4(1,VARREF(YevalSastYast_define_binding),r_,nameF1726,YPfalse,kind_);
  bindingF1727 = T3;
  T6 = CALL3(1,VARREF(YevalSastYobjectify),e_,r_,YPfalse);
  T5 = CALL5(1,VARREF(Ynew),type_,VARREF(YevalSastYassignment_binding),bindingF1727,VARREF(YevalSastYassignment_form),T6);
  defnF1728 = T5;
  T4 = defnF1728;
  T2 = T4;
  T0 = T2;
...
loop:
  ...
  if (VARREF(YevalSastYTmacro_tracingQT) != YPfalse) {
    ...
    CALL2(1,VARREF(YgooSioSwriteYwrite),VARREF(YgooSioSportYout),expF1729);
...
loop:
  ...
  expandF1730 = T1;
  FUNINIT(expandF1730, 1,expander_);
  tmpF1731 = env_or_false_;
  if (tmpF1731 != YPfalse) {
    T4 = tmpF1731;
  } else {
  ...
  T3 = T4;
  envF1732 = T3;
  T7 = CALL4(1,VARREF(YevalSastYast_define_binding),envF1732,name_,YPfalse,LITREF(lit_347));
  bindingF1733 = T7;
  CALL2(1,VARREF(YevalSastYbinding_handler_setter),expandF1730,bindingF1733);
  T6 = bindingF1733;
  T2 = T6;
  T0 = T2;
UNLINK_STACK();
...
loop:
  ...
  sep_expanderF1734 = T1;
  T3 = CALL1(1,VARREF(YevalSastYfind_syntax_environment),r_);
  syntax_envF1735 = T3;
  T5 = CALL3(1,VARREF(YevalSastYobjectify),sep_expanderF1734,syntax_envF1735,YPfalse);
  ast_expanderF1736 = T5;
  T7 = CALL1(1,VARREF(YevalSastYast_evaluate),ast_expanderF1736);
  expanderF1737 = T7;
  ...
  T12 = CALL4(1,VARREF(YPPmacro),modnameF1738,name_,expanderF1737,T13);
  bindingF1739 = T12;
  T15 = CALL1(1,VARREF(YevalSastYfind_static_global_environment),r_);
  T14 = CALL2(1,VARREF(YgooSmathYNEE),syntax_envF1735,T15);
  if (T14 != YPfalse) {
    T16 = CALL2(1,VARREF(YevalSastYinsert_globalX),bindingF1739,syntax_envF1735);
  } else {
  }
  if (rtQ_ != YPfalse) {
    T19 = CALL3(1,VARREF(YevalSastYobjectify),sep_expanderF1734,r_,YPfalse);
    T18 = CALL5(1,VARREF(Ynew),VARREF(YevalSastYLast_macro_definitionG),VARREF(YevalSastYassignment_binding),bindingF1739,VARREF(YevalSastYassignment_form),T19);
    T17 = T18;
  } else {
...
loop:
  ...
  T3 = CALL3(1,VARREF(YevalSastYobjectify),e_,r_,YPfalse);
  fF1741 = T3;
  CALL2(1,VARREF(YevalSastYfunction_binding_setter),bindingF1740,fF1741);
  T4 = CALL2(1,VARREF(YevalSastYobjectify_quotation),name_,r_);
  CALL2(1,VARREF(YevalSastYfunction_debug_name_setter),T4,fF1741);
  T6 = CALL5(1,VARREF(Ynew),VARREF(YevalSastYLast_function_definitionG),VARREF(YevalSastYassignment_binding),bindingF1740,VARREF(YevalSastYassignment_form),fF1741);
  defnF1742 = T6;
  T5 = defnF1742;
  T2 = T5;
  T0 = T2;
...
loop:
  ...
  signatureF1744 = T3;
  T6 = CALL1(1,VARREF(YevalSastYsignature_bindings),signatureF1744);
  T5 = CALL2(1,VARREF(YevalSastYr_extendT),r_,T6);
  new_rF1745 = T5;
  T8 = CALL3(1,VARREF(YevalSastYobjectify_sequential),body_,new_rF1745,YPtrue);
  bodyF1746 = T8;
  T11 = CALL2(1,VARREF(YevalSastYobjectify_quotation),name_,r_);
  T10 = CALLN(1,VARREF(Ynew),9,VARREF(YevalSastYLast_primitiveG),VARREF(YevalSastYfunction_binding),bindingF1743,VARREF(YevalSastYfunction_debug_name),T11,VARREF(YevalSastYfunction_signature),signatureF1744,VARREF(YevalSastYfunction_body),bodyF1746);
  formF1747 = T10;
  T13 = CALL5(1,VARREF(Ynew),VARREF(YevalSastYLast_primitive_definitionG),VARREF(YevalSastYassignment_binding),bindingF1743,VARREF(YevalSastYassignment_form),formF1747);
  defnF1748 = T13;
  T12 = defnF1748;
  T9 = T12;
  T7 = T9;
...
loop:
  ...
  T5 = CALLN(1,VARREF(Ynew),7,VARREF(YevalSastYLast_genericG),VARREF(YevalSastYfunction_binding),bindingF1749,VARREF(YevalSastYfunction_debug_name),T6,VARREF(YevalSastYfunction_signature),signatureF1750);
  formF1751 = T5;
  T8 = CALL5(1,VARREF(Ynew),VARREF(YevalSastYLast_generic_definitionG),VARREF(YevalSastYassignment_binding),bindingF1749,VARREF(YevalSastYassignment_form),formF1751);
  defnF1752 = T8;
  T7 = defnF1752;
  T4 = T7;
  T2 = T4;
...
loop:
  ...
  T6 = CALL3(1,VARREF(YevalSastYobjectify),e_,r_,YPfalse);
  metF1755 = T6;
  T8 = CALL3(1,VARREF(Ylst),LITREF(lit_359),genF1754,metF1755);
  callF1756 = T8;
  T10 = CALL3(1,VARREF(YevalSastYobjectify),callF1756,r_,YPfalse);
  formF1757 = T10;
  T12 = CALL5(1,VARREF(Ynew),VARREF(YevalSastYLast_method_definitionG),VARREF(YevalSastYassignment_binding),bindingF1753,VARREF(YevalSastYassignment_form),formF1757);
  defnF1758 = T12;
  CALL2(1,VARREF(YevalSastYfunction_binding_setter),name_,metF1755);
  T13 = CALL2(1,VARREF(YevalSastYobjectify_quotation),name_,r_);
  CALL2(1,VARREF(YevalSastYfunction_debug_name_setter),T13,metF1755);
  T11 = defnF1758;
  T9 = T11;
  T7 = T9;
  T5 = T7;
...
loop:
  ...
  tmpF1759 = DYNREF(YevalSastYTrecord_sourceQT);
  if (tmpF1759 != YPfalse) {
...
loop:
  ...
  x_1435F1760 = DYNREF(YgooSioSwriteYTmax_print_lengthT);
  T2 = FUNFAB(fun_274,3,FREEREF(0),FREEREF(1),FREEREF(2));
  T3 = FUNFAB(fun_275,1,x_1435F1760);
...
LINK_STACK();
  ...
  ARG(r_, 2);
loop:
  x_1434F1761 = DYNREF(YgooSioSwriteYTmax_print_depthT);
  T2 = FUNFAB(fun_276,3,sig_,body_,r_);
  T3 = FUNFAB(fun_277,1,x_1434F1761);
  T1 = with_cleanup(T2,T3);
  T0 = T1;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  signatureF1762 = T1;
  T4 = CALL1(1,VARREF(YevalSastYsignature_bindings),signatureF1762);
  T3 = CALL2(1,VARREF(YevalSastYr_extendT),FREEREF(1),T4);
  new_rF1763 = T3;
  T6 = CALL3(1,VARREF(YevalSastYobjectify_sequential),FREEREF(2),new_rF1763,YPtrue);
  bF1764 = T6;
  ...
  CALL2(1,VARREF(YevalSastYfunction_signature_setter),signatureF1762,FREEREF(3));
  CALL2(1,VARREF(YevalSastYfunction_body_setter),bF1764,FREEREF(3));
...
loop:
  ...
  methodF1765 = T1;
  x_1436F1766 = VARREF(YevalSastYTcurrent_dependentT);
  VARSET(YevalSastYTcurrent_dependentT,methodF1765);
  T4 = FUNFAB(fun_279,4,sig_,r_,body_,methodF1765);
  T5 = FUNFAB(fun_280,1,x_1436F1766);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    T18 = CALL3(1,VARREF(YevalSastYobjectify),arityF1770,FREEREF(1),YPfalse);
    T13 = CALLN(1,VARREF(Ynew),13,VARREF(YevalSastYLast_signatureG),VARREF(YevalSastYsignature_bindings),T14,VARREF(YevalSastYsignature_names),T15,VARREF(YevalSastYsignature_specs),T16,VARREF(YevalSastYsignature_naryQ),T17,VARREF(YevalSastYsignature_arity),T18,VARREF(YevalSastYsignature_value),valueF1769);
    T9 = T13;
    T4 = T9;
    T2 = T4;
    T0 = T2;
    ...
    paramF1771 = T20;
    T22 = CALL1(1,VARREF(YevalSsyntaxYsexpr_variable_name),paramF1771);
    snameF1772 = T22;
    T24 = CALL1(1,VARREF(YevalSsyntaxYsexpr_variable_type),paramF1771);
    stypeF1773 = T24;
    T26 = CALL2(1,VARREF(YgooSmacrosYEE),stypeF1773,VARREF(YevalSastYDsexpr_optionals_tag));
    dottedQF1774 = T26;
    if (dottedQF1774 != YPfalse) {
      T28 = VARREF(YevalSastYDsexpr_optionals_type_name);
    } else {
      T28 = stypeF1773;
    }
    stypeF1775 = T28;
    T30 = CALL3(1,VARREF(YevalSastYobjectify),stypeF1775,FREEREF(1),YPfalse);
    typeF1776 = T30;
    T32 = CALL2(1,VARREF(YevalSastYobjectify_quotation),snameF1772,FREEREF(1));
    nameF1777 = T32;
    T34 = CALLN(1,VARREF(Ynew),7,VARREF(YevalSastYLlocal_bindingG),VARREF(YevalSastYbinding_name),snameF1772,VARREF(YevalSastYbinding_type),typeF1776,VARREF(YevalSastYbinding_dottedQ),dottedQF1774);
    bindingF1778 = T34;
    T36 = CALL1(1,VARREF(Ytail),params_);
    T37 = CALL2(1,VARREF(YgooSmacrosYpair),bindingF1778,bindings_);
    T38 = CALL5(1,VARREF(Ynew),VARREF(YevalSastYLfab_listG),VARREF(Yhead),nameF1777,VARREF(Ytail),names_);
    T39 = CALL5(1,VARREF(Ynew),VARREF(YevalSastYLfab_listG),VARREF(Yhead),typeF1776,VARREF(Ytail),types_);
    a1 = T36;
    a2 = dottedQF1774;
    a3 = T37;
    a4 = T38;
...
loop:
  ...
  sexpr_paramsF1779 = T1;
  T3 = FUNSHELL(1,fun_col_282,3);
  colF1780 = T3;
  FUNINIT(colF1780, 3,sig_,r_,colF1780);
  ...
  T4 = CALL5(0,colF1780,sexpr_paramsF1779,YPfalse,Ynil,T5,T6);
  T2 = T4;
  T0 = T2;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    findF1781 = T3;
    FUNINIT(findF1781, 5,i_,r_,FREEREF(0),FREEREF(1),findF1781);
    T5 = CALL1(1,VARREF(YevalSastYenvironment_bindings),r_);
    T4 = CALL2(0,findF1781,YPint((P)0),T5);
    T2 = T4;
    T0 = T2;
  } else {
...
loop:
  ...
  loopF1782 = T1;
  FUNINIT(loopF1782, 2,loopF1782,binding_);
  T2 = CALL2(0,loopF1782,YPint((P)0),r_);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  tup29F1783 = T1;
  T3 = CALL2(1,VARREF(YgooSmacrosYelt),tup29F1783,YPint((P)0));
  iF1784 = T3;
  T5 = CALL2(1,VARREF(YgooSmacrosYelt),tup29F1783,YPint((P)1));
  jF1785 = T5;
  T6 = CALLN(1,VARREF(Ynew),7,VARREF(YevalSastYLlocal_referenceG),VARREF(YevalSastYreference_binding),b_,VARREF(YevalSastYreference_frame_number),iF1784,VARREF(YevalSastYreference_frame_offset),jF1785);
  T4 = T6;
  T2 = T4;
  T0 = T2;
UNLINK_STACK();
...
loop:
  ...
  x_1437F1786 = T1;
  x_1438F1787 = VARREF(YgooSmacrosYEE);
  T4 = CALL2(1,x_1438F1787,x_1437F1786,LITREF(lit_41));
  if (T4 != YPfalse) {
    T3 = VARREF(YevalSastYLglobal_referenceG);
  } else {
    T6 = CALL2(1,x_1438F1787,x_1437F1786,LITREF(lit_354));
    if (T6 != YPfalse) {
      T5 = VARREF(YevalSastYLpredefined_referenceG);
    } else {
      T8 = CALL2(1,x_1438F1787,x_1437F1786,LITREF(lit_324));
      if (T8 != YPfalse) {
        T7 = VARREF(YevalSastYLruntime_referenceG);
      } else {
        T10 = CALL2(1,x_1438F1787,x_1437F1786,LITREF(lit_337));
        if (T10 != YPfalse) {
          T9 = VARREF(YevalSastYLdynamic_referenceG);
        } else {
          T12 = CALL2(1,x_1438F1787,x_1437F1786,LITREF(lit_347));
          if (T12 != YPfalse) {
            T11 = VARREF(YevalSastYLmacro_referenceG);
          } else {
            T14 = CALL2(1,x_1438F1787,x_1437F1786,LITREF(lit_325));
            if (T14 != YPfalse) {
...
loop:
  ...
  LrefGF1788 = T1;
  T2 = CALL3(1,VARREF(Ynew),LrefGF1788,VARREF(YevalSastYreference_binding),b_);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  grF1789 = T1;
  T4 = CALL1(1,VARREF(YevalSastYenvironment_allows_foreign_namesQ),grF1789);
  tmpF1790 = T4;
  if (tmpF1790 != YPfalse) {
  ...
  if (T3 != YPfalse) {
    ...
    bF1791 = T9;
    CALL2(1,VARREF(YevalSastYinsert_globalX),bF1791,grF1789);
    T11 = CALL3(1,VARREF(Ynew),VARREF(YevalSastYLglobal_referenceG),VARREF(YevalSastYreference_binding),bF1791);
    T8 = T11;
    T2 = T8;
  }
  T0 = T2;
...
loop:
  ...
  namestrF1792 = T1;
  T3 = CALL2(1,VARREF(YgooScolsSseqYpos),namestrF1792,YPchr((P)58));
  breakF1793 = T3;
  T5 = CALL3(1,VARREF(YgooScolsSseqYsub),namestrF1792,YPint((P)0),breakF1793);
  modnameF1794 = T5;
  T8 = CALL2(1,VARREF(YgooSmathYA),YPint((P)1),breakF1793);
  T9 = CALL1(1,VARREF(YgooStypesYlen),namestrF1792);
  T7 = CALL3(1,VARREF(YgooScolsSseqYsub),namestrF1792,T8,T9);
  varnameF1795 = T7;
  T13 = CALL1(1,VARREF(YgooStypesYlen),modnameF1794);
  T12 = CALL2(1,VARREF(YgooSmagYG),T13,YPint((P)0));
  tmpF1796 = T12;
  if (tmpF1796 != YPfalse) {
    T16 = CALL1(1,VARREF(YgooStypesYlen),varnameF1795);
  ...
  grF1797 = T19;
  T21 = CALL1(1,VARREF(YevalSastYenvironment_module_loader),grF1797);
  loaderF1798 = T21;
  T24 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLsymG),modnameF1794);
  T23 = CALL2(1,VARREF(YevalSastYprobe_module),loaderF1798,T24);
  modF1799 = T23;
  T27 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLsymG),varnameF1795);
  T28 = CALL1(1,VARREF(YevalSastYmodule_target_environment),modF1799);
  T26 = CALL2(1,VARREF(YevalSastYfind_binding),T27,T28);
  bindingF1800 = T26;
  CALL2(1,VARREF(YevalSastYinsert_globalX),bindingF1800,grF1797);
  T29 = CALL1(1,VARREF(Ynot),bindingF1800);
  if (T29 != YPfalse) {
    T30 = CALL3(1,VARREF(Yerror),LITREF(lit_387),varnameF1795,modnameF1794);
  } else {
  }
  T31 = CALL3(1,VARREF(YevalSastYobjectify_binding),name_,bindingF1800,r_);
  T25 = T31;
  T22 = T25;
  T20 = T22;
  T18 = T20;
...
loop:
  ...
  bindingsF1801 = T1;
  T4 = CALL2(1,VARREF(YevalSastYr_extendT),r_,bindingsF1801);
  new_rF1802 = T4;
  T6 = CALL3(1,VARREF(YgooScolsSseqYmap2),VARREF(YevalSsyntaxYsexpr_make_anonymous_method),sigs_,bodies_);
  function_formsF1803 = T6;
  T9 = CALL3(1,VARREF(YgooSruntimeYrcurry),VARREF(YevalSastYobjectify),new_rF1802,YPfalse);
  T8 = CALL2(1,VARREF(YgooSmacrosYmap),T9,function_formsF1803);
  functionsF1804 = T8;
  T10 = FUNFAB(fun_300,1,r_);
  CALL3(1,VARREF(YgooScolsSseqYdo2),T10,functionsF1804,bindingsF1801);
  T12 = CALL4(1,VARREF(YgooSmacrosYnapp),VARREF(YgooSmathYfabs),YPfalse,VARREF(YevalSastYLfunctionsG),functionsF1804);
  T13 = CALL3(1,VARREF(YevalSastYobjectify_sequential),body_,new_rF1802,YPtrue);
  T11 = CALLN(1,VARREF(Ynew),7,VARREF(YevalSastYLlocalsG),VARREF(YevalSastYlocals_bindings),bindingsF1801,VARREF(YevalSastYlocals_functions),T12,VARREF(YevalSastYlocals_body),T13);
  T7 = T11;
  T5 = T7;
  T3 = T5;
  T0 = T3;
...
loop:
  ...
  bindingF1805 = T1;
  T3 = CALL2(1,VARREF(YgooSmacrosYEE),bindingF1805,YPfalse);
  if (T3 != YPfalse) {
    T5 = FUNFAB(fun_308,1,name_);
    T4 = with_exit(T5);
    T2 = T4;
  } else {
    T6 = CALL3(1,VARREF(YevalSastYexport_bindingX),FREEREF(1),name_,bindingF1805);
    T2 = T6;
  }
  T0 = T2;
UNLINK_STACK();
...
loop:
  ...
  moduleF1807 = T3;
  T6 = CALL1(1,VARREF(YevalSastYmodule_target_environment),moduleF1807);
  T5 = CALL2(1,VARREF(YgooSmacrosYEE),envF1806,T6);
  T4 = CALL1(1,VARREF(Ynot),T5);
  if (T4 != YPfalse) {
    T7 = CALL1(1,VARREF(Yerror),LITREF(lit_405));
  } else {
  }
  T8 = FUNFAB(fun_309,2,envF1806,moduleF1807);
...
loop:
  ...
  existingF1808 = T1;
  T5 = CALL2(1,VARREF(YgooSmacrosYEE),existingF1808,YPfalse);
  tmpF1809 = T5;
  if (tmpF1809 != YPfalse) {
    T6 = tmpF1809;
  } else {
    T7 = CALL2(1,VARREF(YgooSmacrosYEE),existingF1808,b_);
    T6 = T7;
  }
  T4 = T6;
...
loop:
  ...
  T3 = CALL1(1,VARREF(YevalSastYfind_environment_module),r_);
  moduleF1811 = T3;
  T5 = CALL1(1,VARREF(YevalSastYenvironment_module_loader),envF1810);
  loaderF1812 = T5;
  T7 = CALL2(1,VARREF(YevalSastYprobe_module),loaderF1812,name_);
  used_moduleF1813 = T7;
  T8 = CALL1(1,VARREF(YevalSastYenvironment_uses_modules),envF1810);
  CALL2(1,VARREF(YgooScolsSseqxYpushX),T8,used_moduleF1813);
  T9 = FUNFAB(fun_312,2,envF1810,moduleF1811);
  T10 = CALL1(1,VARREF(YevalSastYmodule_exports),used_moduleF1813);
...
loop:
  ...
  loaderF1814 = T1;
  T3 = CALL2(1,VARREF(YevalSastYprobe_module),loaderF1814,name_);
  used_moduleF1815 = T3;
  T4 = CALL1(1,VARREF(YevalSastYenvironment_uses_modules),FREEREF(0));
  CALL2(1,VARREF(YgooScolsSseqxYpushX),T4,used_moduleF1815);
  T6 = FUNFAB(fun_314,1,FREEREF(0));
  T7 = CALL1(1,VARREF(YevalSastYmodule_exports),used_moduleF1815);
...
loop:
  T1 = CALL1(1,VARREF(YevalSastYfind_static_global_environment),r_);
  envF1816 = T1;
  T3 = CALL1(1,VARREF(YevalSastYenvironment_module),envF1816);
  modF1817 = T3;
  T4 = FUNSHELL(1,fun_use_mod_315,1);
  use_modF1818 = T4;
  FUNINIT(use_modF1818, 1,envF1816);
  T6 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLstrG),name_);
  x_1439F1819 = T6;
  x_1440F1820 = VARREF(YgooScolsSseqYsuffixQ);
  T9 = CALL2(1,x_1440F1820,x_1439F1819,LITREF(lit_415));
  if (T9 != YPfalse) {
    T13 = CALL1(1,VARREF(YevalSastYmodule_uses_c_files),modF1817);
    ...
    if (T11 != YPfalse) {
      T16 = CALL1(1,VARREF(YevalSastYmodule_uses_c_files),modF1817);
    ...
    T19 = CALL2(1,x_1440F1820,x_1439F1819,LITREF(lit_416));
    if (T19 != YPfalse) {
      ...
      c_modF1821 = T25;
      T31 = CALL1(1,VARREF(YevalSastYmodule_uses_c_files),modF1817);
      T30 = CALL2(1,VARREF(YgooScolsScolYmemQ),T31,c_modF1821);
      T29 = CALL1(1,VARREF(Ynot),T30);
      if (T29 != YPfalse) {
        T33 = CALL1(1,VARREF(YevalSastYmodule_uses_c_files),modF1817);
        T32 = CALL2(1,VARREF(YgooScolsSseqxYpushX),T33,c_modF1821);
        T28 = T32;
      } else {
        T28 = YPfalse;
      }
      ...
      T34 = CALL1(0,use_modF1818,name_);
      T18 = T34;
    }
    T8 = T18;
  }
...
FUNCODEDEF(fun_insert_and_mangle_globalX_317) {
...
loop:
  ...
  rF1822 = T1;
  T3 = CALL1(1,VARREF(YevalSastYenvironment_bindings),rF1822);
  T7 = CALL1(1,VARREF(YevalSastYbinding_name),binding_);
  T6 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLstrG),T7);
  T5 = CALL2(1,VARREF(YgooSmacrosYcat),mangle_prefix_,T6);
  T4 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLsymG),T5);
...
loop:
  ...
  T3 = CALL2(1,VARREF(YgooSmacrosYcat),mangle_prefix_,T4);
  T2 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLsymG),T3);
  T1 = CALL2(1,VARREF(YevalSastYfind_binding),T2,env_);
  existingF1823 = T1;
  T8 = CALL2(1,VARREF(YgooSmacrosYEE),existingF1823,YPfalse);
  tmpF1824 = T8;
  if (tmpF1824 != YPfalse) {
    T9 = tmpF1824;
  } else {
    T10 = CALL2(1,VARREF(YgooSmacrosYEE),existingF1823,b_);
    T9 = T10;
  }
  T7 = T9;
  T6 = CALL1(1,VARREF(Ynot),T7);
  if (T6 != YPfalse) {
    T14 = CALL1(1,VARREF(YevalSastYbinding_name),b_);
    T13 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLstrG),T14);
    T12 = CALL2(1,VARREF(YgooSmacrosYcat),mangle_prefix_,T13);
    T15 = CALL1(1,VARREF(YevalSastYbinding_module_name),b_);
    T11 = CALL4(1,VARREF(YgooSruntimeYmsg),VARREF(YgooSioSportYout),LITREF(lit_421),T12,T15);
  } else {
  }
...
FUNCODEDEF(fun_objectify_use_mangle_module_320) {
...
loop:
  ...
  T3 = CALL1(1,VARREF(YevalSastYfind_environment_module),r_);
  moduleF1826 = T3;
  T5 = CALL1(1,VARREF(YevalSastYenvironment_module_loader),envF1825);
  loaderF1827 = T5;
  T7 = CALL2(1,VARREF(YevalSastYprobe_module),loaderF1827,name_);
  used_moduleF1828 = T7;
  T9 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLstrG),mangler_);
  str_manglerF1829 = T9;
  T10 = CALL1(1,VARREF(YevalSastYenvironment_uses_modules),envF1825);
  CALL2(1,VARREF(YgooScolsSseqxYpushX),T10,used_moduleF1828);
  T11 = FUNFAB(fun_319,2,str_manglerF1829,envF1825);
  T12 = CALL1(1,VARREF(YevalSastYmodule_exports),used_moduleF1828);
...
LINK_STACK();
  ...
  ARG(fail_, 2);
loop:
  T0 = CALL2(1,VARREF(Yerror),LITREF(lit_427),pat_);
UNLINK_STACK();
  QRET(T0);
}
...
LINK_STACK();
  ...
  ARG(fail_, 2);
loop:
  T1 = CALL1(1,VARREF(Ylst),LITREF(lit_428));
...
loop:
  ...
  if (T1 != YPfalse) {
    T2 = CALL2(1,VARREF(Yerror),LITREF(lit_429),pat_);
    T0 = T2;
  } else {
    T4 = CALL1(1,VARREF(YevalSsyntaxYsexpr_unquote_splicingQ),pat_);
    if (T4 != YPfalse) {
      T5 = CALL2(1,VARREF(Yerror),LITREF(lit_430),pat_);
      T3 = T5;
    } else {
      if (YPtrue != YPfalse) {
...
LINK_STACK();
  ...
  ARG(fail_, 2);
loop:
  T1 = CALL1(1,VARREF(Ylst),LITREF(lit_433));
  T2 = CALL1(1,VARREF(Ylst),var_);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    T7 = CALL1(1,VARREF(Ylst),T8);
    T11 = CALL1(1,VARREF(Ylst),LITREF(lit_434));
    ...
    if (T19 != YPfalse) {
      ...
      if (YPtrue != YPfalse) {
        ...
        T45 = CALL1(1,VARREF(Ylst),LITREF(lit_435));
...
loop:
  ...
  T4 = CALL1(1,VARREF(Ylst),LITREF(lit_437));
  ...
  T12 = CALL1(1,VARREF(Ylst),LITREF(lit_438));
...
loop:
  ...
  patF1830 = T1;
  T3 = CALL1(1,VARREF(YevalSsyntaxYsexpr_bind_pattern_variables),patF1830);
  varsF1831 = T3;
  ...
  failF1836 = T13;
  T15 = CALL3(1,VARREF(YevalSastYexpand_pattern),patF1830,varF1835,failF1836);
  epatF1837 = T15;
  T17 = CALL1(1,VARREF(Ylst),LITREF(lit_440));
  T18 = CALL1(1,VARREF(Ylst),LITREF(lit_2));
  T21 = CALL1(1,VARREF(Ylst),LITREF(lit_441));
  T26 = CALL1(1,VARREF(Ylst),failF1836);
  T31 = CALL1(1,VARREF(Ylst),LITREF(lit_4));
  T32 = CALL1(1,VARREF(Ylst),LITREF(lit_442));
  ...
  T40 = CALL1(1,VARREF(Ylst),elseF1834);
  ...
  T48 = CALL1(1,VARREF(Ylst),varF1835);
  T49 = CALL1(1,VARREF(Ylst),valueF1832);
  ...
  T55 = fun_329;
  T54 = CALL2(1,VARREF(YgooSmacrosYmap),T55,varsF1831);
  T53 = CALL1(1,VARREF(Ylst),T54);
  T56 = CALL1(1,VARREF(Ylst),epatF1837);
  T57 = CALL1(1,VARREF(Ylst),thenF1833);
...
loop:
  ...
  check_type(T1,VARREF(YevalSastYLstatic_global_environmentG));
  rF1838 = T1;
  T3 = CALL1(1,VARREF(YevalSastYenvironment_bindings),rF1838);
...
loop:
  ...
  loopF1839 = T1;
  FUNINIT(loopF1839, 3,name_,r_,loopF1839);
  T3 = CALL1(1,VARREF(YevalSastYenvironment_bindings),r_);
  T2 = CALL1(0,loopF1839,T3);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
LINK_STACK();
  ARG(return_, 0);
loop:
  T1 = FUNSHELL(0,fun_x_1444_346,1);
  x_1444F1841 = T1;
  FUNINIT(x_1444F1841, 1,return_);
  x_1443F1842 = FREEREF(0);
  nameF1843 = YPfalse;
  nameF1843 = BOXFAB(nameF1843);
  paramsF1844 = YPfalse;
  paramsF1844 = BOXFAB(paramsF1844);
  bodyF1845 = YPfalse;
  bodyF1845 = BOXFAB(bodyF1845);
  T9 = CALL2(1,VARREF(YisaQ),x_1443F1842,VARREF(YLlstG));
  if (T9 != YPfalse) {
    T11 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1443F1842,LITREF(lit_454),x_1444F1841);
    x_1443F1846 = T11;
    T13 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1443F1846,x_1444F1841);
    BOXVAL(nameF1843) = T13;
    T14 = CALL1(1,VARREF(Ytail),x_1443F1846);
    x_1443F1847 = T14;
    T16 = CALL2(1,VARREF(YgooSmacrosYmatch_sublist),x_1443F1847,x_1444F1841);
    x_1443F1848 = T16;
    BOXVAL(paramsF1844) = x_1443F1848;
    x_1443F1849 = Ynil;
    T18 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1443F1849,x_1444F1841);
    T17 = T18;
    T19 = CALL1(1,VARREF(Ytail),x_1443F1847);
    x_1443F1850 = T19;
    BOXVAL(bodyF1845) = x_1443F1850;
    x_1443F1851 = Ynil;
    T21 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1443F1851,x_1444F1841);
    T20 = T21;
    T15 = T20;
    T12 = T15;
    T10 = T12;
  } else {
    T22 = CALL2(1,x_1444F1841,LITREF(lit_7),x_1443F1842);
  }
  T25 = BOXVAL(nameF1843);
  T24 = CALL2(1,VARREF(YgooSmacrosYcat_sym),LITREF(lit_455),T25);
  special_nameF1852 = T24;
  T28 = BOXVAL(nameF1843);
  T27 = CALL3(1,VARREF(YgooSmacrosYcat_sym),LITREF(lit_456),T28,LITREF(lit_457));
  sexpr_nameF1853 = T27;
  T30 = CALL1(1,VARREF(Ylst),LITREF(lit_12));
  T33 = CALL1(1,VARREF(Ylst),LITREF(lit_159));
  T34 = CALL1(1,VARREF(Ylst),special_nameF1852);
  ...
  T45 = CALL1(1,VARREF(Ylst),sexpr_nameF1853);
  T46 = CALL1(1,VARREF(Ylst),LITREF(lit_42));
  T47 = CALL1(1,VARREF(Ylst),YPfalse);
  T48 = CALL1(1,VARREF(Ylst),LITREF(lit_458));
  T51 = CALL1(1,VARREF(Ylst),LITREF(lit_459));
  T54 = BOXVAL(paramsF1844);
  T53 = CALL2(1,VARREF(YgooSmacrosYcat),T54,Ynil);
  T52 = CALL1(1,VARREF(Ylst),T53);
  T55 = BOXVAL(bodyF1845);
...
loop:
  ...
  tup30F1854 = T1;
  T3 = CALL2(1,VARREF(YgooSmacrosYelt),tup30F1854,YPint((P)0));
  typeF1855 = T3;
  T5 = CALL2(1,VARREF(YgooSmacrosYelt),tup30F1854,YPint((P)1));
  infoF1856 = T5;
  T7 = CALL2(1,VARREF(YgooSmacrosYelt),tup30F1854,YPint((P)2));
  testF1857 = T7;
  T9 = CALL2(1,VARREF(YgooSmacrosYelt),tup30F1854,YPint((P)3));
  handlerF1858 = T9;
  T11 = CALL2(1,VARREF(YgooSmacrosYelt),tup30F1854,YPint((P)4));
  bodyF1859 = T11;
  T12 = CALLN(1,VARREF(YevalSastYobjectify_monitor),7,typeF1855,infoF1856,testF1857,handlerF1858,bodyF1859,r_,tailQ_);
  T10 = T12;
  T8 = T10;
  T6 = T8;
  T4 = T6;
...
loop:
  T1 = CALL1(1,VARREF(YevalSsyntaxYsexpr_definition_variable),x_);
  nameF1860 = T1;
  T4 = CALL1(1,VARREF(Ylst),LITREF(lit_479));
  T7 = CALL1(1,VARREF(Ylst),LITREF(lit_309));
  T8 = CALL1(1,VARREF(Ylst),nameF1860);
  ...
  T2 = CALL5(1,VARREF(YevalSastYobjectify_definition),VARREF(YevalSastYLvariable_definitionG),LITREF(lit_41),nameF1860,T3,r_);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  ownerF1863 = T5;
  T7 = CALL1(1,VARREF(YevalSsyntaxYsexpr_fab_setter_name),nameF1861);
  setter_nameF1864 = T7;
  T9 = CALL1(1,VARREF(YevalSsyntaxYsexpr_prop_type),x_);
  typeF1865 = T9;
  T13 = CALL2(1,VARREF(YevalSsyntaxYsexpr_fab_getter),nameF1861,ownerF1863);
  T14 = CALL3(1,VARREF(YevalSsyntaxYsexpr_fab_setter),nameF1861,ownerF1863,typeF1865);
  T18 = CALL1(1,VARREF(YevalSsyntaxYsexpr_prop_initQ),x_);
  if (T18 != YPfalse) {
    T23 = CALL1(1,VARREF(Ylst),varF1862);
  ...
  T16 = CALL5(1,VARREF(Ylst),ownerF1863,nameF1861,setter_nameF1864,typeF1865,T17);
  T15 = CALL2(1,VARREF(YevalSsyntaxYsexpr_make_application),LITREF(lit_481),T16);
...
loop:
  ...
  astF1866 = T1;
  T4 = CALL2(1,VARREF(YisaQ),astF1866,VARREF(YevalSastYLmacro_referenceG));
  if (T4 != YPfalse) {
    T6 = CALL1(1,VARREF(YevalSastYreference_binding),astF1866);
    macF1867 = T6;
    T9 = CALL1(1,VARREF(YevalSastYbinding_handler),macF1867);
...
loop:
  ...
  T0 = CALL4(1,VARREF(YevalSastYobjectify_use_mangle_module),T1,T2,r_,tailQ_);
UNLINK_STACK();
  QRET(T0);
}
...
FUNCODEDEF(fun_transaction_implemented_bindings_384) {
  P Ux_;
  P T0;
  P a1;
LINK_STACK();
...
FUNCODEDEF(fun_transaction_implemented_bindings_setter_385) {
  P Uz_,Ux_;
  P T0;
  P a1,a2;
LINK_STACK();
...
FUNCODEDEF(fun_transaction_dependents_387) {
  P Ux_;
  P T0;
  P a1;
LINK_STACK();
...
FUNCODEDEF(fun_transaction_dependents_setter_388) {
  P Uz_,Ux_;
  P T0;
  P a1,a2;
LINK_STACK();
...
loop:
  ...
  if (T0 != YPfalse) {
    T1 = CALL1(1,VARREF(Yerror),LITREF(lit_507));
  } else {
  }
...
loop:
  T0 = CALL1(1,VARREF(Ynot),VARREF(YevalSastYTcurrent_subtransactionT));
  if (T0 != YPfalse) {
    T1 = CALL1(1,VARREF(Yerror),LITREF(lit_510));
  } else {
  }
...
FUNCODEDEF(YevalSastYmerge_transactionsX) {
  P t1_,t2_;
  P t2_dependentsF1873;
  P t1_dependentsF1872;
  P t2_bindingsF1871;
  P t1_bindingsF1870;
  ...
  if (T1 != YPfalse) {
    ...
    if (T3 != YPfalse) {
      ...
      if (YPtrue != YPfalse) {
        ...
        t1_dependentsF1872 = T10;
        T12 = CALL1(1,VARREF(YevalSastYtransaction_dependents),t2_);
        t2_dependentsF1873 = T12;
        T13 = FUNFAB(fun_393,1,t1_bindingsF1870);
        CALL2(1,VARREF(YgooScolsScolYdo_keyed),T13,t2_bindingsF1871);
        T14 = FUNFAB(fun_394,1,t1_dependentsF1872);
        CALL2(1,VARREF(YgooScolsScolYdo_keyed),T14,t2_dependentsF1873);
        T11 = t1_;
        T9 = T11;
        T7 = T9;
        T5 = T7;
...
LINK_STACK();
  ...
  ARG(thunk_, 1);
loop:
  successF1875 = YPfalse;
  successF1875 = BOXFAB(successF1875);
  savedF1876 = VARREF(YevalSastYTcurrent_subtransactionT);
  T4 = FUNFAB(fun_399,2,thunk_,successF1875);
  T5 = FUNFAB(fun_400,3,successF1875,module_,savedF1876);
  T3 = with_cleanup(T4,T5);
  T2 = T3;
  T0 = T2;
UNLINK_STACK();
...
LINK_STACK();
  ARG(return_, 0);
loop:
  T1 = FUNSHELL(0,fun_x_1448_402,1);
  x_1448F1877 = T1;
  FUNINIT(x_1448F1877, 1,return_);
  x_1447F1878 = FREEREF(0);
  moduleF1879 = YPfalse;
  moduleF1879 = BOXFAB(moduleF1879);
  bodyF1880 = YPfalse;
  bodyF1880 = BOXFAB(bodyF1880);
  T7 = CALL2(1,VARREF(YisaQ),x_1447F1878,VARREF(YLlstG));
  if (T7 != YPfalse) {
    T9 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1447F1878,LITREF(lit_523),x_1448F1877);
    x_1447F1881 = T9;
    T11 = CALL2(1,VARREF(YgooSmacrosYmatch_sublist),x_1447F1881,x_1448F1877);
    x_1447F1882 = T11;
    T13 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1447F1882,x_1448F1877);
    BOXVAL(moduleF1879) = T13;
    T14 = CALL1(1,VARREF(Ytail),x_1447F1882);
    x_1447F1883 = T14;
    T15 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1447F1883,x_1448F1877);
    T12 = T15;
    T16 = CALL1(1,VARREF(Ytail),x_1447F1881);
    x_1447F1884 = T16;
    BOXVAL(bodyF1880) = x_1447F1884;
    x_1447F1885 = Ynil;
    T18 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1447F1885,x_1448F1877);
    T17 = T18;
    T10 = T17;
    T8 = T10;
  } else {
    T19 = CALL2(1,x_1448F1877,LITREF(lit_7),x_1447F1878);
  }
  T21 = CALL1(1,VARREF(Ylst),LITREF(lit_519));
  T23 = BOXVAL(moduleF1879);
  T22 = CALL1(1,VARREF(Ylst),T23);
  T26 = CALL1(1,VARREF(Ylst),LITREF(lit_459));
  T27 = CALL1(1,VARREF(Ylst),Ynil);
  T28 = BOXVAL(bodyF1880);
...
loop:
  ...
  T2 = FUNFAB(fun_405,3,e_,r_,tailQ_);
  T0 = CALL2(1,VARREF(YevalSastYcall_with_subtransaction),T1,T2);
UNLINK_STACK();
  QRET(T0);
}

FUNCODEDEF(fun_module_loader_modules_407) {
  P Ux_;
  P T0;
  P a1;
LINK_STACK();
...
FUNCODEDEF(fun_module_loader_modules_setter_408) {
  P Uz_,Ux_;
  P T0;
  P a1,a2;
LINK_STACK();
...
FUNCODEDEF(fun_module_loader_stack_410) {
  P Ux_;
  P T0;
  P a1;
LINK_STACK();
...
FUNCODEDEF(fun_module_loader_stack_setter_411) {
  P Uz_,Ux_;
  P T0;
  P a1,a2;
LINK_STACK();
...
FUNCODEDEF(fun_module_name_413) {
  P Ux_;
  P T0;
  P a1;
LINK_STACK();
...
FUNCODEDEF(fun_module_name_setter_414) {
  P Uz_,Ux_;
  P T0;
  P a1,a2;
LINK_STACK();
...
FUNCODEDEF(fun_module_mangled_name_415) {
  P Ux_;
  P T0;
  P a1;
LINK_STACK();
...
FUNCODEDEF(fun_module_mangled_name_setter_416) {
  P Uz_,Ux_;
  P T0;
  P a1,a2;
LINK_STACK();
...
FUNCODEDEF(fun_module_mangled_string_name_418) {
  P Ux_;
  P T0;
  P a1;
LINK_STACK();
...
FUNCODEDEF(fun_module_mangled_string_name_setter_419) {
  P Uz_,Ux_;
  P T0;
  P a1,a2;
LINK_STACK();
...
FUNCODEDEF(fun_module_target_environment_421) {
  P Ux_;
  P T0;
  P a1;
LINK_STACK();
...
FUNCODEDEF(fun_module_target_environment_setter_422) {
  P Uz_,Ux_;
  P T0;
  P a1,a2;
LINK_STACK();
...
FUNCODEDEF(fun_module_syntax_environment_423) {
  P Ux_;
  P T0;
  P a1;
LINK_STACK();
...
FUNCODEDEF(fun_module_syntax_environment_setter_424) {
  P Uz_,Ux_;
  P T0;
  P a1,a2;
LINK_STACK();
...
FUNCODEDEF(fun_Pmodule_exports_425) {
  P Ux_;
  P T0;
  P a1;
LINK_STACK();
...
FUNCODEDEF(fun_Pmodule_exports_setter_426) {
  P Uz_,Ux_;
  P T0;
  P a1,a2;
LINK_STACK();
...
FUNCODEDEF(fun_module_data_processedQ_428) {
  P Ux_;
  P T0;
  P a1;
LINK_STACK();
...
FUNCODEDEF(fun_module_data_processedQ_setter_429) {
  P Uz_,Ux_;
  P T0;
  P a1,a2;
LINK_STACK();
...
FUNCODEDEF(fun_module_runtime_data_431) {
  P Ux_;
  P T0;
  P a1;
LINK_STACK();
...
FUNCODEDEF(fun_module_runtime_data_setter_432) {
  P Uz_,Ux_;
  P T0;
  P a1,a2;
LINK_STACK();
...
FUNCODEDEF(fun_module_transaction_434) {
  P Ux_;
  P T0;
  P a1;
LINK_STACK();
...
FUNCODEDEF(fun_module_transaction_setter_435) {
  P Uz_,Ux_;
  P T0;
  P a1,a2;
LINK_STACK();
...
FUNCODEDEF(fun_module_uses_c_files_437) {
  P Ux_;
  P T0;
  P a1;
LINK_STACK();
...
FUNCODEDEF(fun_module_uses_c_files_setter_438) {
  P Uz_,Ux_;
  P T0;
  P a1,a2;
LINK_STACK();
...
FUNCODEDEF(fun_module_exports_440) {
  P x_;
  P T0;
  P a1;
LINK_STACK();
...
FUNCODEDEF(fun_module_loader_module_type_444) {
  P loader_;
  P a1;
LINK_STACK();
  ARG(loader_, 0);
...
LINK_STACK();
loop:
  x_1450F1887 = FREEREF(0);
  T3 = CALL1(1,VARREF(YevalSastYmodule_loader_stack),x_1450F1887);
  T2 = CALL1(1,VARREF(YgooScolsSseqxYpopX),T3);
  tup31F1888 = T2;
  T5 = CALL2(1,VARREF(YgooSmacrosYelt),tup31F1888,YPint((P)0));
  x_1451F1889 = T5;
  T7 = CALL2(1,VARREF(YgooSmacrosYelt),tup31F1888,YPint((P)1));
  x_1452F1890 = T7;
  CALL2(1,VARREF(YevalSastYmodule_loader_stack_setter),x_1451F1889,x_1450F1887);
  T6 = x_1452F1890;
  T4 = T6;
  T1 = T4;
  T0 = T1;
...
loop:
  ...
  stackF1891 = T1;
  T3 = CALL1(1,VARREF(YgooStypesYlen),stackF1891);
  depthF1892 = T3;
  T5 = CALL2(1,VARREF(YgooScolsSseqYrepeat),LITREF(lit_563),depthF1892);
  indentF1893 = T5;
  T6 = CALL2(1,VARREF(YgooScolsScolYmemQ),stackF1891,name_);
  if (T6 != YPfalse) {
    T8 = CALL1(1,VARREF(Yhead),stackF1891);
    T7 = CALL3(1,VARREF(Yerror),LITREF(lit_564),T8,name_);
  } else {
  }
  CALL4(1,VARREF(YgooSruntimeYmsg),VARREF(YgooSioSportYout),LITREF(lit_565),indentF1893,name_);
  x_1449F1894 = loader_;
  T12 = CALL1(1,VARREF(YevalSastYmodule_loader_stack),x_1449F1894);
  T11 = CALL2(1,VARREF(YgooScolsSseqxYpushX),T12,name_);
  T10 = CALL2(1,VARREF(YevalSastYmodule_loader_stack_setter),T11,x_1449F1894);
  T14 = FUNFAB(fun_447,2,loader_,name_);
  T15 = FUNFAB(fun_448,1,loader_);
  T13 = with_cleanup(T14,T15);
  modF1895 = T13;
  CALL2(1,VARREF(YevalSastYregister_moduleX),loader_,modF1895);
  CALL3(1,VARREF(YgooSruntimeYmsg),VARREF(YgooSioSportYout),LITREF(lit_566),indentF1893);
  T9 = modF1895;
  T4 = T9;
  T2 = T4;
  T0 = T2;
...
loop:
  ...
  exportsF1896 = T1;
  T3 = CALL3(1,VARREF(YgooScolsScolYelt_or),exportsF1896,name_,YPfalse);
  existingF1897 = T3;
  T6 = CALL2(1,VARREF(YgooSmacrosYEE),existingF1897,YPfalse);
  tmpF1898 = T6;
  if (tmpF1898 != YPfalse) {
    T7 = tmpF1898;
  } else {
    T8 = CALL2(1,VARREF(YgooSmacrosYEE),existingF1897,binding_);
    T7 = T8;
  }
  T5 = T7;
  T4 = CALL1(1,VARREF(Ynot),T5);
  if (T4 != YPfalse) {
    T9 = CALL5(1,VARREF(Yerror),LITREF(lit_569),existingF1897,binding_,module_,name_);
  } else {
  }
  CALL3(1,VARREF(YgooScolsScolxYelt_setter),binding_,exportsF1896,name_);
  T2 = YPfalse;
  T0 = T2;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    T7 = CALL1(1,VARREF(YevalSastYbinding_name),binding_);
    T5 = CALL4(1,VARREF(YgooSruntimeYmsg),VARREF(YgooSioSportYout),LITREF(lit_572),T6,T7);
    T0 = T5;
  } else {
    T0 = YPfalse;
  }
...
LINK_STACK();
  ARG(mod_, 0);
loop:
  T1 = FUNFAB(fun_454,3,FREEREF(0),mod_,FREEREF(1));
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    T4 = FUNFAB(fun_455,2,modname_,FREEREF(1));
...
loop:
  T1 = BOXVAL(FREEREF(0));
  UF1900 = T1;
  T3 = CALL2(1,VARREF(YgooSpackerYpacker_add),UF1900,v_);
...
loop:
  ...
  usersF1901 = T1;
  T3 = FUNSHELL(0,fun_add_user_456,3);
  add_userF1902 = T3;
  FUNINIT(add_userF1902, 3,usersF1901,add_userF1902,loader_);
  CALL2(1,VARREF(YgooSmacrosYdo),add_userF1902,modnames_);
  T5 = CALL1(1,VARREF(YgooSpackerYpacker_fab),VARREF(YLlstG));
  packer_F1903 = T5;
  packer_F1903 = BOXFAB(packer_F1903);
  T7 = FUNFAB(fun_457,1,packer_F1903);
  CALL2(1,VARREF(YgooSmacrosYdo),T7,usersF1901);
  T9 = BOXVAL(packer_F1903);
...
loop:
  ...
  modF1904 = T1;
  T3 = CALL2(1,VARREF(YevalSastYremove_module_internalX),FREEREF(0),modF1904);
  T0 = T3;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  remove_namesF1905 = T1;
  T2 = FUNFAB(fun_460,1,loader_);
  CALL2(1,VARREF(YgooSmacrosYdo),T2,remove_namesF1905);
  T0 = YPfalse;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  namestrF1906 = T1;
  T4 = CALL2(1,VARREF(YgooScolsSseqYsplit),namestrF1906,YPchr((P)47));
...
loop:
  ...
  bootmodF1907 = T1;
  T3 = CALL1(1,VARREF(YevalSastYmodule_target_environment),bootmodF1907);
  bootenvF1908 = T3;
  T5 = FUNFAB(fun_463,2,bootenvF1908,env_);
  T4 = CALL2(1,VARREF(YgooSmacrosYdo),T5,LITREF(lit_581));
  T2 = T4;
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
...
loop:
  ...
  loaderF1910 = T1;
  T4 = CALL3(1,VARREF(YevalSastYfab_static_global_environment),module_,loaderF1910,YPfalse);
  new_envF1911 = T4;
  T5 = FUNFAB(fun_466,2,excluded_,new_envF1911);
...
loop:
  ...
  x_1453F1912 = DYNREF(YevalSastYTnow_rt_envT);
  T1 = FUNFAB(fun_468,2,FREEREF(0),FREEREF(2));
  T2 = FUNFAB(fun_469,1,x_1453F1912);
...
FUNCODEDEF(fun_load_module_472) {
  P loader_,name_;
  P fileF1918;
  P modpathF1917;
  P keepmodQF1916;
...
loop:
  ...
  typeF1913 = T1;
  T3 = CALL3(1,VARREF(Ynew),typeF1913,VARREF(YevalSastYmodule_name),name_);
  moduleF1914 = T3;
  T5 = CALL3(1,VARREF(YevalSastYfab_static_global_environment),moduleF1914,loader_,YPfalse);
  envF1915 = T5;
  keepmodQF1916 = YPfalse;
  keepmodQF1916 = BOXFAB(keepmodQF1916);
  T9 = CALL1(1,VARREF(YevalSastYmodule_name_to_relpath),name_);
  modpathF1917 = T9;
  T11 = CALL2(1,VARREF(YgooSsystemYfind_goo_file_in_path),modpathF1917,VARREF(YgooSsystemYTmodule_search_pathT));
  fileF1918 = T11;
  CALL3(1,VARREF(YevalSastYset_module_environments),moduleF1914,envF1915,envF1915);
  T12 = CALL1(1,VARREF(Ynot),fileF1918);
  if (T12 != YPfalse) {
    T13 = CALL2(1,VARREF(Yerror),LITREF(lit_588),modpathF1917);
  } else {
  }
  T15 = FUNFAB(fun_470,5,envF1915,loader_,fileF1918,keepmodQF1916,moduleF1914);
  T16 = FUNFAB(fun_471,2,keepmodQF1916,moduleF1914);
...
loop:
  ...
  moduleF1919 = T1;
  CALL1(1,VARREF(YevalSastYensure_module_data),moduleF1919);
  T2 = CALL1(1,VARREF(YevalSastYmodule_target_environment),moduleF1919);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  T1 = CALL0(1,VARREF(YevalSastYruntime_module_loader));
  loaderF1920 = T1;
  T5 = CALL1(1,VARREF(YevalSastYmodule_loader_stack),loaderF1920);
...
loop:
  T1 = CALL0(1,VARREF(YevalSastYruntime_module_loader));
  loaderF1921 = T1;
  T3 = CALL1(1,VARREF(YevalSastYmodule_loader_module_type),loaderF1921);
  typeF1922 = T3;
  T6 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLsymG),modname_);
  T5 = CALL3(1,VARREF(Ynew),typeF1922,VARREF(YevalSastYmodule_name),T6);
  modF1923 = T5;
  T8 = CALL3(1,VARREF(YevalSastYfab_static_global_environment),modF1923,loaderF1921,YPtrue);
  envF1924 = T8;
  CALL2(1,VARREF(YevalSastYmodule_data_processedQ_setter),YPfalse,modF1923);
  CALL3(1,VARREF(YevalSastYset_module_environments),modF1923,envF1924,envF1924);
  CALL2(1,VARREF(YevalSastYmodule_runtime_data_setter),data_,modF1923);
  CALL2(1,VARREF(YevalSastYregister_moduleX),loaderF1921,modF1923);
  T7 = modF1923;
  T4 = T7;
  T2 = T4;
  T0 = T2;
...
loop:
  ...
  T3 = CALL2(1,VARREF(YevalSastYfind_binding),T4,home_envF1925);
  bindingF1926 = T3;
  T5 = CALL1(1,VARREF(Ynot),bindingF1926);
  if (T5 != YPfalse) {
    T7 = CALL1(1,VARREF(YevalSastYmodule_name),from_mod_);
    T8 = CALL1(1,VARREF(YevalSastYmodule_name),mod_);
    T6 = CALL4(1,VARREF(Yerror),LITREF(lit_601),original_name_,T7,T8);
  } else {
  }
  T10 = CALL1(1,VARREF(YevalSastYmodule_target_environment),mod_);
  T9 = CALL2(1,VARREF(YevalSastYinsert_globalX),bindingF1926,T10);
  T2 = T9;
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
...
loop:
  ...
  T3 = CALL2(1,VARREF(YevalSastYinsert_globalX),bindingF1927,T4);
  T0 = T3;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  bindingF1928 = T1;
  T4 = CALL1(1,VARREF(YevalSastYmodule_target_environment),mod_);
  T3 = CALL2(1,VARREF(YevalSastYinsert_globalX),bindingF1928,T4);
  T0 = T3;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  bindingF1929 = T1;
  T4 = CALL1(1,VARREF(YevalSastYmodule_target_environment),mod_);
  T3 = CALL2(1,VARREF(YevalSastYinsert_globalX),bindingF1929,T4);
  T0 = T3;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  bindingF1930 = T1;
  if (bindingF1930 != YPfalse) {
    T6 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLsymG),as_name_);
    T5 = CALL3(1,VARREF(YevalSastYexport_bindingX),mod_,T6,bindingF1930);
    T4 = T5;
  } else {
    T8 = CALL1(1,VARREF(YevalSastYmodule_name),mod_);
    T7 = CALL3(1,VARREF(Yerror),LITREF(lit_609),name_,T8);
    T4 = T7;
  }
  T0 = T4;
UNLINK_STACK();
...
loop:
  ...
  T3 = CALL2(1,VARREF(YevalSastYbinding_handler_setter),T4,cloneF1931);
  T0 = T3;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  bootmodF1932 = T1;
  T4 = CALL1(1,VARREF(YevalSastYmodule_target_environment),bootmodF1932);
  bootenvF1933 = T4;
  CALL1(1,VARREF(YevalSastYinstall_magic_bindings),bootenvF1933);
  CALL0(1,VARREF(YevalSastYreload_macros));
  CALL1(1,VARREF(YevalSastYinstall_interpreter_hacks),bootenvF1933);
  T3 = YPfalse;
  T0 = T3;
UNLINK_STACK();
  QRET(T0);
...
LINK_STACK();
  ARG(module_, 0);
loop:
  T1 = CALL1(1,VARREF(YevalSastYruntime_module),LITREF(lit_617));
...
loop:
  T1 = CALL1(1,VARREF(YevalSastYmodule_loader_module_type),loader_);
  typeF1934 = T1;
  T3 = CALL3(1,VARREF(Ynew),typeF1934,VARREF(YevalSastYmodule_name),name_);
  moduleF1935 = T3;
  T5 = CALL1(1,VARREF(YevalSastYfab_syntax_environment),moduleF1935);
  syntax_envF1936 = T5;
  T7 = CALL3(1,VARREF(YevalSastYfab_static_global_environment),moduleF1935,loader_,YPfalse);
  target_envF1937 = T7;
  CALL3(1,VARREF(YevalSastYset_module_environments),moduleF1935,syntax_envF1936,target_envF1937);
  T8 = CALL2(1,VARREF(YgooSmacrosYEE),name_,VARREF(YevalSastYDgoo_boot_module_name));
  if (T8 != YPfalse) {
    T9 = CALL1(1,VARREF(YevalSastYinit_g2c_boot_environment),target_envF1937);
  } else {
    T10 = CALL2(1,VARREF(YevalSastYinit_g2c_regular_environment),target_envF1937,loader_);
  }
  T6 = moduleF1935;
  T4 = T6;
  T2 = T4;
...
loop:
  ...
  loopF1938 = T1;
  FUNINIT(loopF1938, 2,f_,loopF1938);
  T2 = CALL1(0,loopF1938,env_);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
LINK_STACK();
  ...
  ARG(env_, 1);
loop:
  T1 = FUNSHELL(1,fun_loop_500,2);
  loopF1939 = T1;
  FUNINIT(loopF1939, 2,f_,loopF1939);
  T2 = CALL1(0,loopF1939,env_);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  fun_x_1423_0 = YPmet(FUNCODEREF(fun_x_1423_0),LITREF(lit_3),T2,ENVNUL,PNUL,YPfalse);
...
loop:
  ...
  fun_x_1429_109 = YPmet(FUNCODEREF(fun_x_1429_109),LITREF(lit_151),T166,ENVNUL,PNUL,YPfalse);
  ...
  fun_x_1433_112 = YPmet(FUNCODEREF(fun_x_1433_112),LITREF(lit_170),T170,ENVNUL,PNUL,YPfalse);
...
loop:
  ...
  lit_418 = YPPsym((P)"insert-and-mangle-global!");
  lit_419 = YPPsym((P)"mangle-prefix");
  T151 = YPsig(YPPlist(3,LITREF(lit_284),LITREF(lit_419),LITREF(lit_286)),YPPlist(3,VARREF(YLanyG),VARREF(YLstrG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_insert_and_mangle_globalX_317 = YPmet(FUNCODEREF(fun_insert_and_mangle_globalX_317),LITREF(lit_418),T151,ENVNUL,PNUL,YPfalse);
  T154 = BOUNDP(YevalSastYinsert_and_mangle_globalX);
  if (T154 != YPfalse) {
    T153 = VARREF(YevalSastYinsert_and_mangle_globalX);
  } else {
    T153 = YPfalse;
  }
  T155 = fun_insert_and_mangle_globalX_317;
  T152 = XCALL2(1,VARREF(YPdefine_method),T153,T155);
  VARSET(YevalSastYinsert_and_mangle_globalX,T152);
  lit_420 = YPPsym((P)"import-and-mangle-global!");
  lit_421 = YPsb((P)"warning: '%s' from %s clobbers local binding.\n");
  T156 = YPsig(YPPlist(3,LITREF(lit_49),LITREF(lit_419),LITREF(lit_410)),YPPlist(3,VARREF(YevalSastYLmodule_bindingG),VARREF(YLstrG),VARREF(YevalSastYLstatic_global_environmentG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  YevalSastYimport_and_mangle_globalX = YPmet(FUNCODEREF(YevalSastYimport_and_mangle_globalX),LITREF(lit_420),T156,ENVNUL,PNUL,YPfalse);
  T157 = YevalSastYimport_and_mangle_globalX;
  VARSET(YevalSastYimport_and_mangle_globalX,T157);
  lit_422 = YPPsym((P)"objectify-use-mangle-module");
  lit_423 = YPPsym((P)"mangler");
  T159 = YPsig(YPPlist(1,LITREF(lit_49)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_319 = YPmet(FUNCODEREF(fun_319),YPfalse,T159,ENVNUL,PNUL,YPfalse);
  T158 = YPsig(YPPlist(4,LITREF(lit_328),LITREF(lit_423),LITREF(lit_286),LITREF(lit_287)),YPPlist(4,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)4),VARREF(YevalSastYLprogramG),Ynil);
  fun_objectify_use_mangle_module_320 = YPmet(FUNCODEREF(fun_objectify_use_mangle_module_320),LITREF(lit_422),T158,ENVNUL,PNUL,YPfalse);
  T162 = BOUNDP(YevalSastYobjectify_use_mangle_module);
  if (T162 != YPfalse) {
    T161 = VARREF(YevalSastYobjectify_use_mangle_module);
  } else {
    T161 = YPfalse;
  }
  T163 = fun_objectify_use_mangle_module_320;
  T160 = XCALL2(1,VARREF(YPdefine_method),T161,T163);
  VARSET(YevalSastYobjectify_use_mangle_module,T160);
  lit_424 = YPPsym((P)"expand-bind-list");
  lit_425 = YPPsym((P)"pat");
  lit_426 = YPPsym((P)"fail");
  lit_427 = YPsb((P)"Expected Pattern List %=\n");
  T164 = YPsig(YPPlist(3,LITREF(lit_425),LITREF(lit_334),LITREF(lit_426)),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_expand_bind_list_321 = YPmet(FUNCODEREF(fun_expand_bind_list_321),LITREF(lit_424),T164,ENVNUL,PNUL,YPfalse);
  T167 = BOUNDP(YevalSastYexpand_bind_list);
  if (T167 != YPfalse) {
    T166 = VARREF(YevalSastYexpand_bind_list);
  } else {
    T166 = YPfalse;
  }
  T168 = fun_expand_bind_list_321;
  T165 = XCALL2(1,VARREF(YPdefine_method),T166,T168);
  VARSET(YevalSastYexpand_bind_list,T165);
  lit_428 = YPPsym((P)"match-empty-list");
  T170 = XCALL1(1,VARREF(YgooStypesYtE),Ynil);
  T169 = YPsig(YPPlist(3,LITREF(lit_425),LITREF(lit_334),LITREF(lit_426)),YPPlist(3,T170,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLlstG),Ynil);
  fun_expand_bind_list_322 = YPmet(FUNCODEREF(fun_expand_bind_list_322),LITREF(lit_424),T169,ENVNUL,PNUL,YPfalse);
  T173 = BOUNDP(YevalSastYexpand_bind_list);
  if (T173 != YPfalse) {
    T172 = VARREF(YevalSastYexpand_bind_list);
  } else {
    T172 = YPfalse;
  }
  T174 = fun_expand_bind_list_322;
  T171 = XCALL2(1,VARREF(YPdefine_method),T172,T174);
  VARSET(YevalSastYexpand_bind_list,T171);
  lit_429 = YPsb((P)"Unquote Unexpected Here %=\n");
  lit_430 = YPsb((P)"Unquote Splicing Unexpected Here %=\n");
  T175 = YPsig(YPPlist(3,LITREF(lit_425),LITREF(lit_334),LITREF(lit_426)),YPPlist(3,VARREF(YLlstG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLlstG),Ynil);
  fun_expand_bind_list_323 = YPmet(FUNCODEREF(fun_expand_bind_list_323),LITREF(lit_424),T175,ENVNUL,PNUL,YPfalse);
  T178 = BOUNDP(YevalSastYexpand_bind_list);
  if (T178 != YPfalse) {
    T177 = VARREF(YevalSastYexpand_bind_list);
  } else {
    T177 = YPfalse;
  }
  T179 = fun_expand_bind_list_323;
  T176 = XCALL2(1,VARREF(YPdefine_method),T177,T179);
  VARSET(YevalSastYexpand_bind_list,T176);
  lit_431 = YPPsym((P)"expand-bind-list*");
  T181 = XCALL1(1,VARREF(YgooStypesYtE),Ynil);
  T180 = YPsig(YPPlist(3,LITREF(lit_425),LITREF(lit_334),LITREF(lit_426)),YPPlist(3,T181,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_expand_bind_listT_324 = YPmet(FUNCODEREF(fun_expand_bind_listT_324),LITREF(lit_431),T180,ENVNUL,PNUL,YPfalse);
  T184 = BOUNDP(YevalSastYexpand_bind_listT);
  if (T184 != YPfalse) {
    T183 = VARREF(YevalSastYexpand_bind_listT);
  } else {
    T183 = YPfalse;
  }
  T185 = fun_expand_bind_listT_324;
  T182 = XCALL2(1,VARREF(YPdefine_method),T183,T185);
  VARSET(YevalSastYexpand_bind_listT,T182);
  T186 = YPsig(YPPlist(3,LITREF(lit_425),LITREF(lit_334),LITREF(lit_426)),YPPlist(3,VARREF(YLlstG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_expand_bind_listT_325 = YPmet(FUNCODEREF(fun_expand_bind_listT_325),LITREF(lit_431),T186,ENVNUL,PNUL,YPfalse);
  T189 = BOUNDP(YevalSastYexpand_bind_listT);
  if (T189 != YPfalse) {
    T188 = VARREF(YevalSastYexpand_bind_listT);
  } else {
    T188 = YPfalse;
  }
  T190 = fun_expand_bind_listT_325;
  T187 = XCALL2(1,VARREF(YPdefine_method),T188,T190);
  VARSET(YevalSastYexpand_bind_listT,T187);
  lit_432 = YPPsym((P)"expand-bind-element");
  lit_433 = YPPsym((P)"match-atom");
  T191 = YPsig(YPPlist(3,LITREF(lit_425),LITREF(lit_334),LITREF(lit_426)),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_expand_bind_element_326 = YPmet(FUNCODEREF(fun_expand_bind_element_326),LITREF(lit_432),T191,ENVNUL,PNUL,YPfalse);
  T194 = BOUNDP(YevalSastYexpand_bind_element);
  if (T194 != YPfalse) {
    T193 = VARREF(YevalSastYexpand_bind_element);
  } else {
    T193 = YPfalse;
  }
  T195 = fun_expand_bind_element_326;
  T192 = XCALL2(1,VARREF(YPdefine_method),T193,T195);
  VARSET(YevalSastYexpand_bind_element,T192);
  lit_434 = YPPsym((P)"match-unquote");
  lit_435 = YPPsym((P)"match-sublist");
  T196 = YPsig(YPPlist(3,LITREF(lit_425),LITREF(lit_334),LITREF(lit_426)),YPPlist(3,VARREF(YLlstG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_expand_bind_element_327 = YPmet(FUNCODEREF(fun_expand_bind_element_327),LITREF(lit_432),T196,ENVNUL,PNUL,YPfalse);
  T199 = BOUNDP(YevalSastYexpand_bind_element);
  if (T199 != YPfalse) {
    T198 = VARREF(YevalSastYexpand_bind_element);
  } else {
    T198 = YPfalse;
  }
  T200 = fun_expand_bind_element_327;
  T197 = XCALL2(1,VARREF(YPdefine_method),T198,T200);
  VARSET(YevalSastYexpand_bind_element,T197);
  lit_436 = YPPsym((P)"expand-pattern");
  lit_437 = YPPsym((P)"isa?");
  lit_438 = YPsb((P)"Match Pattern Failure");
  T201 = YPsig(YPPlist(3,LITREF(lit_425),LITREF(lit_334),LITREF(lit_426)),YPPlist(3,VARREF(YLlstG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_expand_pattern_328 = YPmet(FUNCODEREF(fun_expand_pattern_328),LITREF(lit_436),T201,ENVNUL,PNUL,YPfalse);
  T204 = BOUNDP(YevalSastYexpand_pattern);
  if (T204 != YPfalse) {
    T203 = VARREF(YevalSastYexpand_pattern);
  } else {
    T203 = YPfalse;
  }
  T205 = fun_expand_pattern_328;
  T202 = XCALL2(1,VARREF(YPdefine_method),T203,T205);
  VARSET(YevalSastYexpand_pattern,T202);
  lit_439 = YPPsym((P)"expand-syntax-if");
  lit_440 = YPPsym((P)"esc");
  lit_441 = YPPsym((P)"loc");
  lit_442 = YPPsym((P)"<str>");
  T207 = YPsig(YPPlist(1,LITREF(lit_131)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_329 = YPmet(FUNCODEREF(fun_329),YPfalse,T207,ENVNUL,PNUL,YPfalse);
  T206 = YPsig(YPPlist(1,LITREF(lit_131)),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_expand_syntax_if_330 = YPmet(FUNCODEREF(fun_expand_syntax_if_330),LITREF(lit_439),T206,ENVNUL,PNUL,YPfalse);
  T210 = BOUNDP(YevalSastYexpand_syntax_if);
  if (T210 != YPfalse) {
    T209 = VARREF(YevalSastYexpand_syntax_if);
  } else {
    T209 = YPfalse;
  }
  T211 = fun_expand_syntax_if_330;
  T208 = XCALL2(1,VARREF(YPdefine_method),T209,T211);
  VARSET(YevalSastYexpand_syntax_if,T208);
  lit_443 = YPPsym((P)"r-extend*");
  T212 = YPsig(YPPlist(2,LITREF(lit_286),LITREF(lit_369)),YPPlist(2,VARREF(YLanyG),VARREF(YLlstG)),YPfalse,YPint((P)2),VARREF(YevalSastYLstatic_environmentG),Ynil);
  fun_r_extendT_331 = YPmet(FUNCODEREF(fun_r_extendT_331),LITREF(lit_443),T212,ENVNUL,PNUL,YPfalse);
  T215 = BOUNDP(YevalSastYr_extendT);
  if (T215 != YPfalse) {
    T214 = VARREF(YevalSastYr_extendT);
  } else {
    T214 = YPfalse;
  }
  T216 = fun_r_extendT_331;
  T213 = XCALL2(1,VARREF(YPdefine_method),T214,T216);
  VARSET(YevalSastYr_extendT,T213);
  lit_444 = YPPsym((P)"insert-global!");
  T217 = YPsig(YPPlist(2,LITREF(lit_284),LITREF(lit_286)),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_insert_globalX_332 = YPmet(FUNCODEREF(fun_insert_globalX_332),LITREF(lit_444),T217,ENVNUL,PNUL,YPfalse);
  T220 = BOUNDP(YevalSastYinsert_globalX);
  if (T220 != YPfalse) {
    T219 = VARREF(YevalSastYinsert_globalX);
  } else {
    T219 = YPfalse;
  }
  T221 = fun_insert_globalX_332;
  T218 = XCALL2(1,VARREF(YPdefine_method),T219,T221);
  VARSET(YevalSastYinsert_globalX,T218);
  lit_445 = YPPsym((P)"insert-globals!");
  T223 = YPsig(YPPlist(1,LITREF(lit_49)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_333 = YPmet(FUNCODEREF(fun_333),YPfalse,T223,ENVNUL,PNUL,YPfalse);
  T222 = YPsig(YPPlist(2,LITREF(lit_369),LITREF(lit_286)),YPPlist(2,VARREF(YLlstG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_insert_globalsX_334 = YPmet(FUNCODEREF(fun_insert_globalsX_334),LITREF(lit_445),T222,ENVNUL,PNUL,YPfalse);
  T226 = BOUNDP(YevalSastYinsert_globalsX);
  if (T226 != YPfalse) {
    T225 = VARREF(YevalSastYinsert_globalsX);
  } else {
    T225 = YPfalse;
  }
  T227 = fun_insert_globalsX_334;
  T224 = XCALL2(1,VARREF(YPdefine_method),T225,T227);
  VARSET(YevalSastYinsert_globalsX,T224);
  lit_446 = YPPsym((P)"find-static-global-environment");
  T228 = YPsig(YPPlist(1,LITREF(lit_286)),YPPlist(1,VARREF(YevalSastYLstatic_local_environmentG)),YPfalse,YPint((P)1),VARREF(YevalSastYLstatic_global_environmentG),Ynil);
  fun_find_static_global_environment_335 = YPmet(FUNCODEREF(fun_find_static_global_environment_335),LITREF(lit_446),T228,ENVNUL,PNUL,YPfalse);
  T231 = BOUNDP(YevalSastYfind_static_global_environment);
  if (T231 != YPfalse) {
    T230 = VARREF(YevalSastYfind_static_global_environment);
  } else {
    T230 = YPfalse;
  }
  T232 = fun_find_static_global_environment_335;
  T229 = XCALL2(1,VARREF(YPdefine_method),T230,T232);
  VARSET(YevalSastYfind_static_global_environment,T229);
  T233 = YPsig(YPPlist(1,LITREF(lit_286)),YPPlist(1,VARREF(YevalSastYLstatic_global_environmentG)),YPfalse,YPint((P)1),VARREF(YevalSastYLstatic_global_environmentG),Ynil);
  fun_find_static_global_environment_336 = YPmet(FUNCODEREF(fun_find_static_global_environment_336),LITREF(lit_446),T233,ENVNUL,PNUL,YPfalse);
  T236 = BOUNDP(YevalSastYfind_static_global_environment);
  if (T236 != YPfalse) {
    T235 = VARREF(YevalSastYfind_static_global_environment);
  } else {
    T235 = YPfalse;
  }
  T237 = fun_find_static_global_environment_336;
  T234 = XCALL2(1,VARREF(YPdefine_method),T235,T237);
  VARSET(YevalSastYfind_static_global_environment,T234);
  lit_447 = YPPsym((P)"find-syntax-environment");
  T238 = YPsig(YPPlist(1,LITREF(lit_286)),YPPlist(1,VARREF(YevalSastYLstatic_environmentG)),YPfalse,YPint((P)1),VARREF(YevalSastYLstatic_global_environmentG),Ynil);
  fun_find_syntax_environment_337 = YPmet(FUNCODEREF(fun_find_syntax_environment_337),LITREF(lit_447),T238,ENVNUL,PNUL,YPfalse);
  T241 = BOUNDP(YevalSastYfind_syntax_environment);
  if (T241 != YPfalse) {
    T240 = VARREF(YevalSastYfind_syntax_environment);
  } else {
    T240 = YPfalse;
  }
  T242 = fun_find_syntax_environment_337;
  T239 = XCALL2(1,VARREF(YPdefine_method),T240,T242);
  VARSET(YevalSastYfind_syntax_environment,T239);
  lit_448 = YPPsym((P)"find-environment-module");
  T243 = YPsig(YPPlist(1,LITREF(lit_286)),YPPlist(1,VARREF(YevalSastYLstatic_environmentG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_find_environment_module_338 = YPmet(FUNCODEREF(fun_find_environment_module_338),LITREF(lit_448),T243,ENVNUL,PNUL,YPfalse);
  T246 = BOUNDP(YevalSastYfind_environment_module);
  if (T246 != YPfalse) {
    T245 = VARREF(YevalSastYfind_environment_module);
  } else {
    T245 = YPfalse;
  }
  T247 = fun_find_environment_module_338;
  T244 = XCALL2(1,VARREF(YPdefine_method),T245,T247);
  VARSET(YevalSastYfind_environment_module,T244);
  lit_449 = YPPsym((P)"find-binding");
  T249 = YPsig(YPPlist(1,LITREF(lit_369)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_loop_339 = YPmet(FUNCODEREF(fun_loop_339),LITREF(lit_149),T249,ENVNUL,PNUL,YPfalse);
  T248 = YPsig(YPPlist(2,LITREF(lit_328),LITREF(lit_286)),YPPlist(2,VARREF(YLanyG),VARREF(YevalSastYLstatic_local_environmentG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_find_binding_340 = YPmet(FUNCODEREF(fun_find_binding_340),LITREF(lit_449),T248,ENVNUL,PNUL,YPfalse);
  T252 = BOUNDP(YevalSastYfind_binding);
  if (T252 != YPfalse) {
    T251 = VARREF(YevalSastYfind_binding);
  } else {
    T251 = YPfalse;
  }
  T253 = fun_find_binding_340;
  T250 = XCALL2(1,VARREF(YPdefine_method),T251,T253);
  VARSET(YevalSastYfind_binding,T250);
  T254 = YPsig(YPPlist(2,LITREF(lit_328),LITREF(lit_286)),YPPlist(2,VARREF(YLanyG),VARREF(YevalSastYLstatic_empty_environmentG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_find_binding_341 = YPmet(FUNCODEREF(fun_find_binding_341),LITREF(lit_449),T254,ENVNUL,PNUL,YPfalse);
  T257 = BOUNDP(YevalSastYfind_binding);
  if (T257 != YPfalse) {
    T256 = VARREF(YevalSastYfind_binding);
  } else {
    T256 = YPfalse;
  }
  T258 = fun_find_binding_341;
  T255 = XCALL2(1,VARREF(YPdefine_method),T256,T258);
  VARSET(YevalSastYfind_binding,T255);
  T259 = YPsig(YPPlist(2,LITREF(lit_328),LITREF(lit_286)),YPPlist(2,VARREF(YLanyG),VARREF(YevalSastYLstatic_global_environmentG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_find_binding_342 = YPmet(FUNCODEREF(fun_find_binding_342),LITREF(lit_449),T259,ENVNUL,PNUL,YPfalse);
  T262 = BOUNDP(YevalSastYfind_binding);
  if (T262 != YPfalse) {
    T261 = VARREF(YevalSastYfind_binding);
  } else {
    T261 = YPfalse;
  }
  T263 = fun_find_binding_342;
  T260 = XCALL2(1,VARREF(YPdefine_method),T261,T263);
  VARSET(YevalSastYfind_binding,T260);
  lit_450 = YPPsym((P)"frame-bindings");
  T264 = YPsig(YPPlist(1,LITREF(lit_410)),YPPlist(1,VARREF(YevalSastYLstatic_environmentG)),YPfalse,YPint((P)1),VARREF(YLcolG),Ynil);
  fun_frame_bindings_343 = YPmet(FUNCODEREF(fun_frame_bindings_343),LITREF(lit_450),T264,ENVNUL,PNUL,YPfalse);
  T267 = BOUNDP(YevalSastYframe_bindings);
  if (T267 != YPfalse) {
    T266 = VARREF(YevalSastYframe_bindings);
  } else {
    T266 = YPfalse;
  }
  T268 = fun_frame_bindings_343;
  T265 = XCALL2(1,VARREF(YPdefine_method),T266,T268);
  VARSET(YevalSastYframe_bindings,T265);
  VARSET(YevalSastYTmagic_bindingsT,Ynil);
  lit_451 = YPPsym((P)"register-magic-binding");
  T269 = YPsig(YPPlist(2,LITREF(lit_328),LITREF(lit_290)),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_register_magic_binding_344 = YPmet(FUNCODEREF(fun_register_magic_binding_344),LITREF(lit_451),T269,ENVNUL,PNUL,YPfalse);
  T272 = BOUNDP(YevalSastYregister_magic_binding);
  if (T272 != YPfalse) {
    T271 = VARREF(YevalSastYregister_magic_binding);
  } else {
    T271 = YPfalse;
  }
  T273 = fun_register_magic_binding_344;
  T270 = XCALL2(1,VARREF(YPdefine_method),T271,T273);
  VARSET(YevalSastYregister_magic_binding,T270);
  lit_452 = YPPsym((P)"magic-bindings");
  T274 = YPsig(Ynil,Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  fun_magic_bindings_345 = YPmet(FUNCODEREF(fun_magic_bindings_345),LITREF(lit_452),T274,ENVNUL,PNUL,YPfalse);
  T277 = BOUNDP(YevalSastYmagic_bindings);
  if (T277 != YPfalse) {
    T276 = VARREF(YevalSastYmagic_bindings);
  } else {
    T276 = YPfalse;
  }
  T278 = fun_magic_bindings_345;
  T275 = XCALL2(1,VARREF(YPdefine_method),T276,T278);
  VARSET(YevalSastYmagic_bindings,T275);
  lit_453 = YPPsym((P)"x-1444");
  lit_454 = YPPsym((P)"define-magic-binding");
  lit_455 = YPsb((P)"special-");
  lit_456 = YPsb((P)"$sexpr-");
  lit_457 = YPsb((P)"-tag");
  lit_458 = YPPsym((P)"binding-handler");
  lit_459 = YPPsym((P)"fun");
  T281 = YPsig(YPPlist(2,LITREF(lit_4),LITREF(lit_5)),YPPlist(1,VARREF(YLstrG)),YPtrue,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_x_1444_346 = YPmet(FUNCODEREF(fun_x_1444_346),LITREF(lit_453),T281,ENVNUL,PNUL,YPfalse);
  T280 = YPsig(YPPlist(1,LITREF(lit_2)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_347 = YPmet(FUNCODEREF(fun_347),YPfalse,T280,ENVNUL,PNUL,YPfalse);
  T279 = YPsig(YPPlist(1,LITREF(lit_1)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_348 = YPmet(FUNCODEREF(fun_348),YPfalse,T279,ENVNUL,PNUL,YPfalse);
  T282 = fun_348;
  YPmacro(YPPsym((P)"eval/ast"),YPPsym((P)"define-magic-binding"),T282);
  T283 = YPsig(YPPlist(3,LITREF(lit_131),LITREF(lit_286),LITREF(lit_287)),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_349 = YPmet(FUNCODEREF(fun_349),YPfalse,T283,ENVNUL,PNUL,YPfalse);
  T285 = fun_349;
  T284 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSsyntaxYDsexpr_if_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T285,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_if,T284);
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_357),VARREF(YevalSastYspecial_if));
  T286 = YPsig(YPPlist(3,LITREF(lit_131),LITREF(lit_286),LITREF(lit_287)),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_350 = YPmet(FUNCODEREF(fun_350),YPfalse,T286,ENVNUL,PNUL,YPfalse);
  T288 = fun_350;
  T287 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSsyntaxYDsexpr_begin_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T288,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_begin,T287);
  lit_460 = YPPsym((P)"begin");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_460),VARREF(YevalSastYspecial_begin));
  lit_461 = YPPsym((P)"%raw");
  T290 = VARSET(YevalSastYDsexpr_Praw_tag,LITREF(lit_461));
  T289 = T290;
  return T289;
}
...
loop:
  ...
  fun_351 = YPmet(FUNCODEREF(fun_351),YPfalse,T0,ENVNUL,PNUL,YPfalse);
  T2 = fun_351;
  T1 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSastYDsexpr_Praw_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T2,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_Praw,T1);
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_461),VARREF(YevalSastYspecial_Praw));
  ...
  fun_352 = YPmet(FUNCODEREF(fun_352),YPfalse,T3,ENVNUL,PNUL,YPfalse);
  T5 = fun_352;
  T4 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSsyntaxYDsexpr_quote_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T5,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_quote,T4);
  ...
  fun_353 = YPmet(FUNCODEREF(fun_353),YPfalse,T6,ENVNUL,PNUL,YPfalse);
  T8 = fun_353;
  T7 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSsyntaxYDsexpr_set_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T8,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_set,T7);
  ...
  fun_354 = YPmet(FUNCODEREF(fun_354),YPfalse,T9,ENVNUL,PNUL,YPfalse);
  T11 = fun_354;
  T10 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSsyntaxYDsexpr_define_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T11,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_define,T10);
  lit_462 = YPPsym((P)"define");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_462),VARREF(YevalSastYspecial_define));
  lit_463 = YPPsym((P)"ddv");
  VARSET(YevalSastYDsexpr_define_dynamic_tag,LITREF(lit_463));
  ...
  fun_355 = YPmet(FUNCODEREF(fun_355),YPfalse,T12,ENVNUL,PNUL,YPfalse);
  T14 = fun_355;
  T13 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSastYDsexpr_define_dynamic_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T14,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_define_dynamic,T13);
  lit_464 = YPPsym((P)"define-dynamic");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_464),VARREF(YevalSastYspecial_define_dynamic));
  ...
  fun_356 = YPmet(FUNCODEREF(fun_356),YPfalse,T15,ENVNUL,PNUL,YPfalse);
  T17 = fun_356;
  T16 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSsyntaxYDsexpr_define_syntax_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T17,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_define_syntax,T16);
  lit_465 = YPPsym((P)"define-syntax");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_465),VARREF(YevalSastYspecial_define_syntax));
  lit_466 = YPPsym((P)"dss");
  VARSET(YevalSastYDsexpr_define_static_syntax_tag,LITREF(lit_466));
  ...
  fun_357 = YPmet(FUNCODEREF(fun_357),YPfalse,T18,ENVNUL,PNUL,YPfalse);
  T20 = fun_357;
  T19 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSastYDsexpr_define_static_syntax_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T20,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_define_static_syntax,T19);
  lit_467 = YPPsym((P)"define-static-syntax");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_467),VARREF(YevalSastYspecial_define_static_syntax));
  ...
  fun_358 = YPmet(FUNCODEREF(fun_358),YPfalse,T21,ENVNUL,PNUL,YPfalse);
  T23 = fun_358;
  T22 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSsyntaxYDsexpr_define_method_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T23,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_define_method,T22);
  lit_468 = YPPsym((P)"define-method");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_468),VARREF(YevalSastYspecial_define_method));
  ...
  fun_359 = YPmet(FUNCODEREF(fun_359),YPfalse,T24,ENVNUL,PNUL,YPfalse);
  T26 = fun_359;
  T25 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSsyntaxYDsexpr_define_generic_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T26,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_define_generic,T25);
  lit_469 = YPPsym((P)"define-generic");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_469),VARREF(YevalSastYspecial_define_generic));
  ...
  fun_360 = YPmet(FUNCODEREF(fun_360),YPfalse,T27,ENVNUL,PNUL,YPfalse);
  T29 = fun_360;
  T28 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSsyntaxYDsexpr_define_function_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T29,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_define_function,T28);
  lit_470 = YPPsym((P)"define-function");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_470),VARREF(YevalSastYspecial_define_function));
  ...
  fun_361 = YPmet(FUNCODEREF(fun_361),YPfalse,T30,ENVNUL,PNUL,YPfalse);
  T32 = fun_361;
  T31 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSsyntaxYDsexpr_method_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T32,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_method,T31);
  lit_471 = YPPsym((P)"method");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_471),VARREF(YevalSastYspecial_method));
  ...
  fun_362 = YPmet(FUNCODEREF(fun_362),YPfalse,T33,ENVNUL,PNUL,YPfalse);
  T35 = fun_362;
  T34 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSastYDsexpr_boundQ_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T35,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_boundQ,T34);
  ...
  fun_363 = YPmet(FUNCODEREF(fun_363),YPfalse,T36,ENVNUL,PNUL,YPfalse);
  T38 = fun_363;
  T37 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSsyntaxYDsexpr_let_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T38,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_let,T37);
  ...
  fun_364 = YPmet(FUNCODEREF(fun_364),YPfalse,T39,ENVNUL,PNUL,YPfalse);
  T41 = fun_364;
  T40 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSsyntaxYDsexpr_def_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T41,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_def,T40);
  lit_472 = YPPsym((P)"def");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_472),VARREF(YevalSastYspecial_def));
  ...
  fun_365 = YPmet(FUNCODEREF(fun_365),YPfalse,T42,ENVNUL,PNUL,YPfalse);
  T44 = fun_365;
  T43 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSsyntaxYDsexpr_locals_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T44,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_locals,T43);
  lit_473 = YPPsym((P)"locals");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_473),VARREF(YevalSastYspecial_locals));
  ...
  fun_366 = YPmet(FUNCODEREF(fun_366),YPfalse,T45,ENVNUL,PNUL,YPfalse);
  T47 = fun_366;
  T46 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSsyntaxYDsexpr_iterate_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T47,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_iterate,T46);
  lit_474 = YPPsym((P)"iterate");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_474),VARREF(YevalSastYspecial_iterate));
  ...
  fun_367 = YPmet(FUNCODEREF(fun_367),YPfalse,T48,ENVNUL,PNUL,YPfalse);
  T50 = fun_367;
  T49 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSsyntaxYDsexpr_bind_exit_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T50,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_bind_exit,T49);
  lit_475 = YPPsym((P)"bind-exit");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_475),VARREF(YevalSastYspecial_bind_exit));
  T51 = YPsig(YPPlist(3,LITREF(lit_131),LITREF(lit_286),LITREF(lit_287)),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_368 = YPmet(FUNCODEREF(fun_368),YPfalse,T51,ENVNUL,PNUL,YPfalse);
  T53 = fun_368;
  T52 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSsyntaxYDsexpr_unwind_protect_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T53,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_unwind_protect,T52);
  lit_476 = YPPsym((P)"unwind-protect");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_476),VARREF(YevalSastYspecial_unwind_protect));
  T54 = YPsig(YPPlist(3,LITREF(lit_131),LITREF(lit_286),LITREF(lit_287)),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_369 = YPmet(FUNCODEREF(fun_369),YPfalse,T54,ENVNUL,PNUL,YPfalse);
  T56 = fun_369;
  T55 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSsyntaxYDsexpr_monitor_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T56,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_monitor,T55);
  lit_477 = YPPsym((P)"monitor");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_477),VARREF(YevalSastYspecial_monitor));
  lit_478 = YPPsym((P)"pairize");
  T57 = YPsig(YPPlist(1,LITREF(lit_5)),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_pairize_370 = YPmet(FUNCODEREF(fun_pairize_370),LITREF(lit_478),T57,ENVNUL,PNUL,YPfalse);
  T60 = BOUNDP(YevalSastYpairize);
  if (T60 != YPfalse) {
    T59 = VARREF(YevalSastYpairize);
  } else {
    T59 = YPfalse;
  }
  T61 = fun_pairize_370;
  T58 = XCALL2(1,VARREF(YPdefine_method),T59,T61);
  VARSET(YevalSastYpairize,T58);
  lit_479 = YPPsym((P)"fab-class");
  ...
  fun_371 = YPmet(FUNCODEREF(fun_371),YPfalse,T62,ENVNUL,PNUL,YPfalse);
  T64 = fun_371;
  T63 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSsyntaxYDsexpr_define_class_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T64,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_define_class,T63);
  lit_480 = YPPsym((P)"define-class");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_480),VARREF(YevalSastYspecial_define_class));
  lit_481 = YPPsym((P)"%prop");
  lit_482 = YPPsym((P)"%prop-unbound-error");
  ...
  fun_372 = YPmet(FUNCODEREF(fun_372),YPfalse,T65,ENVNUL,PNUL,YPfalse);
  T67 = fun_372;
  T66 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSsyntaxYDsexpr_prop_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T67,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_prop,T66);
  lit_483 = YPPsym((P)"prop");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_483),VARREF(YevalSastYspecial_prop));
  lit_484 = YPPsym((P)"ct");
  VARSET(YevalSastYDsexpr_compile_time_tag,LITREF(lit_484));
  ...
  fun_373 = YPmet(FUNCODEREF(fun_373),YPfalse,T68,ENVNUL,PNUL,YPfalse);
  T70 = fun_373;
  T69 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSastYDsexpr_compile_time_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T70,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_compile_time,T69);
  lit_485 = YPPsym((P)"compile-time");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_485),VARREF(YevalSastYspecial_compile_time));
  lit_486 = YPPsym((P)"ct-also");
  VARSET(YevalSastYDsexpr_compile_time_also_tag,LITREF(lit_486));
  ...
  fun_374 = YPmet(FUNCODEREF(fun_374),YPfalse,T71,ENVNUL,PNUL,YPfalse);
  T73 = fun_374;
  T72 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSastYDsexpr_compile_time_also_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T73,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_compile_time_also,T72);
  lit_487 = YPPsym((P)"compile-time-also");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_487),VARREF(YevalSastYspecial_compile_time_also));
  lit_488 = YPPsym((P)"dl");
  VARSET(YevalSastYDsexpr_define_primitive_tag,LITREF(lit_488));
  ...
  fun_375 = YPmet(FUNCODEREF(fun_375),YPfalse,T74,ENVNUL,PNUL,YPfalse);
  T76 = fun_375;
  T75 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSastYDsexpr_define_primitive_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T76,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_define_primitive,T75);
  lit_489 = YPPsym((P)"define-primitive");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_489),VARREF(YevalSastYspecial_define_primitive));
  T77 = YPsig(YPPlist(3,LITREF(lit_131),LITREF(lit_286),LITREF(lit_287)),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_376 = YPmet(FUNCODEREF(fun_376),YPfalse,T77,ENVNUL,PNUL,YPfalse);
  T79 = fun_376;
  T78 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSsyntaxYDsexpr_quasiquote_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T79,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_quasiquote,T78);
  lit_490 = YPPsym((P)"quasiquote");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_490),VARREF(YevalSastYspecial_quasiquote));
  lit_491 = YPPsym((P)"ast-macro-expand");
  T80 = YPsig(YPPlist(3,LITREF(lit_131),LITREF(lit_286),LITREF(lit_287)),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_ast_macro_expand_377 = YPmet(FUNCODEREF(fun_ast_macro_expand_377),LITREF(lit_491),T80,ENVNUL,PNUL,YPfalse);
  T83 = BOUNDP(YevalSastYast_macro_expand);
  if (T83 != YPfalse) {
    T82 = VARREF(YevalSastYast_macro_expand);
  } else {
    T82 = YPfalse;
  }
  T84 = fun_ast_macro_expand_377;
  T81 = XCALL2(1,VARREF(YPdefine_method),T82,T84);
  VARSET(YevalSastYast_macro_expand,T81);
  ...
  fun_378 = YPmet(FUNCODEREF(fun_378),YPfalse,T85,ENVNUL,PNUL,YPfalse);
  T87 = fun_378;
  T86 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSsyntaxYDsexpr_macro_expand_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T87,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_macro_expand,T86);
  lit_492 = YPPsym((P)"macro-expand");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_492),VARREF(YevalSastYspecial_macro_expand));
  T88 = YPsig(YPPlist(3,LITREF(lit_131),LITREF(lit_286),LITREF(lit_287)),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_379 = YPmet(FUNCODEREF(fun_379),YPfalse,T88,ENVNUL,PNUL,YPfalse);
  T90 = fun_379;
  T89 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSsyntaxYDsexpr_syntax_if_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T90,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_syntax_if,T89);
  lit_493 = YPPsym((P)"syntax-if");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_493),VARREF(YevalSastYspecial_syntax_if));
  lit_494 = YPPsym((P)"export");
  VARSET(YevalSastYDsexpr_export_tag,LITREF(lit_494));
  T93 = YPsig(YPPlist(3,LITREF(lit_131),LITREF(lit_286),LITREF(lit_287)),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  T92 = fun_380 = YPmet(FUNCODEREF(fun_380),YPfalse,T93,ENVNUL,PNUL,YPfalse);
  T96 = fun_380;
  T95 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSastYDsexpr_export_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T96,VARREF(YevalSastYbinding_freeQ),YPfalse);
  T94 = VARSET(YevalSastYspecial_export,T95);
  T91 = T94;
  return T91;
}
...
DEFCREGS();
loop:
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_494),VARREF(YevalSastYspecial_export));
  lit_495 = YPPsym((P)"use");
  VARSET(YevalSastYDsexpr_use_module_tag,LITREF(lit_495));
  T0 = YPsig(YPPlist(3,LITREF(lit_131),LITREF(lit_286),LITREF(lit_287)),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_381 = YPmet(FUNCODEREF(fun_381),YPfalse,T0,ENVNUL,PNUL,YPfalse);
  T2 = fun_381;
  T1 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSastYDsexpr_use_module_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T2,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_use_module,T1);
  lit_496 = YPPsym((P)"use-module");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_496),VARREF(YevalSastYspecial_use_module));
  lit_497 = YPPsym((P)"use/mangle");
  VARSET(YevalSastYDsexpr_use_mangle_module_tag,LITREF(lit_497));
  T3 = YPsig(YPPlist(3,LITREF(lit_131),LITREF(lit_286),LITREF(lit_287)),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_382 = YPmet(FUNCODEREF(fun_382),YPfalse,T3,ENVNUL,PNUL,YPfalse);
  T5 = fun_382;
  T4 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSastYDsexpr_use_mangle_module_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T5,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_use_mangle_module,T4);
  lit_498 = YPPsym((P)"use-mangle-module");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_498),VARREF(YevalSastYspecial_use_mangle_module));
  lit_499 = YPPsym((P)"use/export");
  VARSET(YevalSastYDsexpr_useSexport_module_tag,LITREF(lit_499));
  T6 = YPsig(YPPlist(3,LITREF(lit_131),LITREF(lit_286),LITREF(lit_287)),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_383 = YPmet(FUNCODEREF(fun_383),YPfalse,T6,ENVNUL,PNUL,YPfalse);
  T8 = fun_383;
  T7 = XCALLN(1,VARREF(Ynew),11,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYbinding_kind),LITREF(lit_325),VARREF(YevalSastYbinding_name),VARREF(YevalSastYDsexpr_useSexport_module_tag),VARREF(YevalSastYbinding_module),YPfalse,VARREF(YevalSastYbinding_handler),T8,VARREF(YevalSastYbinding_freeQ),YPfalse);
  VARSET(YevalSastYspecial_useSexport_module,T7);
  lit_500 = YPPsym((P)"use/export-module");
  XCALL2(1,VARREF(YevalSastYregister_magic_binding),LITREF(lit_500),VARREF(YevalSastYspecial_useSexport_module));
  lit_501 = YPPsym((P)"<transaction>");
  T10 = (P)YPpair(VARREF(YLanyG),Ynil);
  T9 = XCALL2(1,VARREF(Yfab_class),LITREF(lit_501),T10);
  VARSET(YevalSastYLtransactionG,T9);
  lit_502 = YPPsym((P)"transaction-implemented-bindings");
  T11 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YevalSastYLtransactionG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_transaction_implemented_bindings_384 = YPmet(FUNCODEREF(fun_transaction_implemented_bindings_384),LITREF(lit_502),T11,ENVNUL,PNUL,YPfalse);
  T14 = BOUNDP(YevalSastYtransaction_implemented_bindings);
  if (T14 != YPfalse) {
    T13 = VARREF(YevalSastYtransaction_implemented_bindings);
  } else {
    T13 = YPfalse;
  }
  T15 = fun_transaction_implemented_bindings_384;
  T12 = XCALL2(1,VARREF(YPdefine_method),T13,T15);
  VARSET(YevalSastYtransaction_implemented_bindings,T12);
  lit_503 = YPPsym((P)"transaction-implemented-bindings-setter");
  T16 = YPsig(YPPlist(2,LITREF(lit_21),LITREF(lit_19)),YPPlist(2,VARREF(YgooScolsScolYLtabG),VARREF(YevalSastYLtransactionG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_transaction_implemented_bindings_setter_385 = YPmet(FUNCODEREF(fun_transaction_implemented_bindings_setter_385),LITREF(lit_503),T16,ENVNUL,PNUL,YPfalse);
  T19 = BOUNDP(YevalSastYtransaction_implemented_bindings_setter);
  if (T19 != YPfalse) {
    T18 = VARREF(YevalSastYtransaction_implemented_bindings_setter);
  } else {
    T18 = YPfalse;
  }
  T20 = fun_transaction_implemented_bindings_setter_385;
  T17 = XCALL2(1,VARREF(YPdefine_method),T18,T20);
  VARSET(YevalSastYtransaction_implemented_bindings_setter,T17);
  T21 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_386 = YPmet(FUNCODEREF(fun_386),YPfalse,T21,ENVNUL,PNUL,YPfalse);
  T22 = fun_386;
  XCALL5(1,VARREF(YPprop),VARREF(YevalSastYLtransactionG),VARREF(YevalSastYtransaction_implemented_bindings),VARREF(YevalSastYtransaction_implemented_bindings_setter),VARREF(YgooScolsScolYLtabG),T22);
  lit_504 = YPPsym((P)"transaction-dependents");
  T23 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YevalSastYLtransactionG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_transaction_dependents_387 = YPmet(FUNCODEREF(fun_transaction_dependents_387),LITREF(lit_504),T23,ENVNUL,PNUL,YPfalse);
  T26 = BOUNDP(YevalSastYtransaction_dependents);
  if (T26 != YPfalse) {
    T25 = VARREF(YevalSastYtransaction_dependents);
  } else {
    T25 = YPfalse;
  }
  T27 = fun_transaction_dependents_387;
  T24 = XCALL2(1,VARREF(YPdefine_method),T25,T27);
  VARSET(YevalSastYtransaction_dependents,T24);
  lit_505 = YPPsym((P)"transaction-dependents-setter");
  T28 = YPsig(YPPlist(2,LITREF(lit_21),LITREF(lit_19)),YPPlist(2,VARREF(YgooScolsScolYLtabG),VARREF(YevalSastYLtransactionG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_transaction_dependents_setter_388 = YPmet(FUNCODEREF(fun_transaction_dependents_setter_388),LITREF(lit_505),T28,ENVNUL,PNUL,YPfalse);
  T31 = BOUNDP(YevalSastYtransaction_dependents_setter);
  if (T31 != YPfalse) {
    T30 = VARREF(YevalSastYtransaction_dependents_setter);
  } else {
    T30 = YPfalse;
  }
  T32 = fun_transaction_dependents_setter_388;
  T29 = XCALL2(1,VARREF(YPdefine_method),T30,T32);
  VARSET(YevalSastYtransaction_dependents_setter,T29);
  T33 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_389 = YPmet(FUNCODEREF(fun_389),YPfalse,T33,ENVNUL,PNUL,YPfalse);
  T34 = fun_389;
  XCALL5(1,VARREF(YPprop),VARREF(YevalSastYLtransactionG),VARREF(YevalSastYtransaction_dependents),VARREF(YevalSastYtransaction_dependents_setter),VARREF(YgooScolsScolYLtabG),T34);
  VARSET(YevalSastYTcurrent_subtransactionT,YPfalse);
  lit_506 = YPPsym((P)"transaction-register-implemented-binding");
  lit_507 = YPsb((P)"Can't register implemented foreign binding (no subtransaction)");
  T35 = YPsig(YPPlist(1,LITREF(lit_49)),YPPlist(1,VARREF(YevalSastYLbindingG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYtransaction_register_implemented_binding = YPmet(FUNCODEREF(YevalSastYtransaction_register_implemented_binding),LITREF(lit_506),T35,ENVNUL,PNUL,YPfalse);
  T36 = YevalSastYtransaction_register_implemented_binding;
  VARSET(YevalSastYtransaction_register_implemented_binding,T36);
  lit_508 = YPPsym((P)"transaction-register-dependent");
  lit_509 = YPPsym((P)"d");
  lit_510 = YPsb((P)"Can't register dependent (no subtransaction)");
  T37 = YPsig(YPPlist(1,LITREF(lit_509)),YPPlist(1,VARREF(YevalSdependencyYLdependentG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYtransaction_register_dependent = YPmet(FUNCODEREF(YevalSastYtransaction_register_dependent),LITREF(lit_508),T37,ENVNUL,PNUL,YPfalse);
  T38 = YevalSastYtransaction_register_dependent;
  VARSET(YevalSastYtransaction_register_dependent,T38);
  lit_511 = YPPsym((P)"transaction-empty?");
  T39 = YPsig(YPPlist(1,LITREF(lit_163)),YPPlist(1,VARREF(YevalSastYLtransactionG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  YevalSastYtransaction_emptyQ = YPmet(FUNCODEREF(YevalSastYtransaction_emptyQ),LITREF(lit_511),T39,ENVNUL,PNUL,YPfalse);
  T40 = YevalSastYtransaction_emptyQ;
  VARSET(YevalSastYtransaction_emptyQ,T40);
  lit_512 = YPPsym((P)"merge-transactions!");
  lit_513 = YPPsym((P)"t1");
  lit_514 = YPPsym((P)"t2");
  lit_515 = YPPsym((P)"k");
  lit_516 = YPPsym((P)"v");
  T43 = YPsig(YPPlist(2,LITREF(lit_515),LITREF(lit_516)),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_393 = YPmet(FUNCODEREF(fun_393),YPfalse,T43,ENVNUL,PNUL,YPfalse);
  T42 = YPsig(YPPlist(2,LITREF(lit_515),LITREF(lit_516)),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_394 = YPmet(FUNCODEREF(fun_394),YPfalse,T42,ENVNUL,PNUL,YPfalse);
  T41 = YPsig(YPPlist(2,LITREF(lit_513),LITREF(lit_514)),YPPlist(2,VARREF(YevalSastYLtransactionG),VARREF(YevalSastYLtransactionG)),YPfalse,YPint((P)2),VARREF(YevalSastYLtransactionG),Ynil);
  YevalSastYmerge_transactionsX = YPmet(FUNCODEREF(YevalSastYmerge_transactionsX),LITREF(lit_512),T41,ENVNUL,PNUL,YPfalse);
  T44 = YevalSastYmerge_transactionsX;
  VARSET(YevalSastYmerge_transactionsX,T44);
  lit_517 = YPPsym((P)"roll-back-transaction");
  lit_518 = YPPsym((P)"junk");
  T47 = YPsig(YPPlist(2,LITREF(lit_284),LITREF(lit_518)),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_396 = YPmet(FUNCODEREF(fun_396),YPfalse,T47,ENVNUL,PNUL,YPfalse);
  T46 = YPsig(YPPlist(2,LITREF(lit_142),LITREF(lit_518)),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_397 = YPmet(FUNCODEREF(fun_397),YPfalse,T46,ENVNUL,PNUL,YPfalse);
  T45 = YPsig(YPPlist(1,LITREF(lit_163)),YPPlist(1,VARREF(YevalSastYLtransactionG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYroll_back_transaction = YPmet(FUNCODEREF(YevalSastYroll_back_transaction),LITREF(lit_517),T45,ENVNUL,PNUL,YPfalse);
  T48 = YevalSastYroll_back_transaction;
  VARSET(YevalSastYroll_back_transaction,T48);
  lit_519 = YPPsym((P)"call-with-subtransaction");
  lit_520 = YPPsym((P)"module");
  lit_521 = YPPsym((P)"thunk");
  T51 = YPsig(Ynil,Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  fun_399 = YPmet(FUNCODEREF(fun_399),YPfalse,T51,ENVNUL,PNUL,YPfalse);
  T50 = YPsig(Ynil,Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  fun_400 = YPmet(FUNCODEREF(fun_400),YPfalse,T50,ENVNUL,PNUL,YPfalse);
  T49 = YPsig(YPPlist(2,LITREF(lit_520),LITREF(lit_521)),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  YevalSastYcall_with_subtransaction = YPmet(FUNCODEREF(YevalSastYcall_with_subtransaction),LITREF(lit_519),T49,ENVNUL,PNUL,YPfalse);
  T52 = YevalSastYcall_with_subtransaction;
  VARSET(YevalSastYcall_with_subtransaction,T52);
  lit_522 = YPPsym((P)"x-1448");
  lit_523 = YPPsym((P)"with-subtransaction");
  T55 = YPsig(YPPlist(2,LITREF(lit_4),LITREF(lit_5)),YPPlist(1,VARREF(YLstrG)),YPtrue,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_x_1448_402 = YPmet(FUNCODEREF(fun_x_1448_402),LITREF(lit_522),T55,ENVNUL,PNUL,YPfalse);
  T54 = YPsig(YPPlist(1,LITREF(lit_2)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_403 = YPmet(FUNCODEREF(fun_403),YPfalse,T54,ENVNUL,PNUL,YPfalse);
  T53 = YPsig(YPPlist(1,LITREF(lit_1)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_404 = YPmet(FUNCODEREF(fun_404),YPfalse,T53,ENVNUL,PNUL,YPfalse);
  T56 = fun_404;
  YPmacro(YPPsym((P)"eval/ast"),YPPsym((P)"with-subtransaction"),T56);
  lit_524 = YPPsym((P)"objectify-with-subtransaction");
  T58 = YPsig(Ynil,Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  fun_405 = YPmet(FUNCODEREF(fun_405),YPfalse,T58,ENVNUL,PNUL,YPfalse);
  T57 = YPsig(YPPlist(3,LITREF(lit_148),LITREF(lit_286),LITREF(lit_287)),YPPlist(3,VARREF(YLanyG),VARREF(YevalSastYLstatic_environmentG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  YevalSastYobjectify_with_subtransaction = YPmet(FUNCODEREF(YevalSastYobjectify_with_subtransaction),LITREF(lit_524),T57,ENVNUL,PNUL,YPfalse);
  T59 = YevalSastYobjectify_with_subtransaction;
  VARSET(YevalSastYobjectify_with_subtransaction,T59);
  lit_525 = YPPsym((P)"<module-loader>");
  T61 = (P)YPpair(VARREF(YLanyG),Ynil);
  T60 = XCALL2(1,VARREF(Yfab_class),LITREF(lit_525),T61);
  VARSET(YevalSastYLmodule_loaderG,T60);
  lit_526 = YPPsym((P)"module-loader-modules");
  T62 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YevalSastYLmodule_loaderG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_loader_modules_407 = YPmet(FUNCODEREF(fun_module_loader_modules_407),LITREF(lit_526),T62,ENVNUL,PNUL,YPfalse);
  T65 = BOUNDP(YevalSastYmodule_loader_modules);
  if (T65 != YPfalse) {
    T64 = VARREF(YevalSastYmodule_loader_modules);
  } else {
    T64 = YPfalse;
  }
  T66 = fun_module_loader_modules_407;
  T63 = XCALL2(1,VARREF(YPdefine_method),T64,T66);
  VARSET(YevalSastYmodule_loader_modules,T63);
  lit_527 = YPPsym((P)"module-loader-modules-setter");
  T67 = YPsig(YPPlist(2,LITREF(lit_21),LITREF(lit_19)),YPPlist(2,VARREF(YgooScolsScolYLtabG),VARREF(YevalSastYLmodule_loaderG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_loader_modules_setter_408 = YPmet(FUNCODEREF(fun_module_loader_modules_setter_408),LITREF(lit_527),T67,ENVNUL,PNUL,YPfalse);
  T70 = BOUNDP(YevalSastYmodule_loader_modules_setter);
  if (T70 != YPfalse) {
    T69 = VARREF(YevalSastYmodule_loader_modules_setter);
  } else {
    T69 = YPfalse;
  }
  T71 = fun_module_loader_modules_setter_408;
  T68 = XCALL2(1,VARREF(YPdefine_method),T69,T71);
  VARSET(YevalSastYmodule_loader_modules_setter,T68);
  T72 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_409 = YPmet(FUNCODEREF(fun_409),YPfalse,T72,ENVNUL,PNUL,YPfalse);
  T73 = fun_409;
  XCALL5(1,VARREF(YPprop),VARREF(YevalSastYLmodule_loaderG),VARREF(YevalSastYmodule_loader_modules),VARREF(YevalSastYmodule_loader_modules_setter),VARREF(YgooScolsScolYLtabG),T73);
  lit_528 = YPPsym((P)"module-loader-stack");
  T74 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YevalSastYLmodule_loaderG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_loader_stack_410 = YPmet(FUNCODEREF(fun_module_loader_stack_410),LITREF(lit_528),T74,ENVNUL,PNUL,YPfalse);
  T77 = BOUNDP(YevalSastYmodule_loader_stack);
  if (T77 != YPfalse) {
    T76 = VARREF(YevalSastYmodule_loader_stack);
  } else {
    T76 = YPfalse;
  }
  T78 = fun_module_loader_stack_410;
  T75 = XCALL2(1,VARREF(YPdefine_method),T76,T78);
  VARSET(YevalSastYmodule_loader_stack,T75);
  lit_529 = YPPsym((P)"module-loader-stack-setter");
  T79 = YPsig(YPPlist(2,LITREF(lit_21),LITREF(lit_19)),YPPlist(2,VARREF(YLlstG),VARREF(YevalSastYLmodule_loaderG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_loader_stack_setter_411 = YPmet(FUNCODEREF(fun_module_loader_stack_setter_411),LITREF(lit_529),T79,ENVNUL,PNUL,YPfalse);
  T82 = BOUNDP(YevalSastYmodule_loader_stack_setter);
  if (T82 != YPfalse) {
    T81 = VARREF(YevalSastYmodule_loader_stack_setter);
  } else {
    T81 = YPfalse;
  }
  T83 = fun_module_loader_stack_setter_411;
  T80 = XCALL2(1,VARREF(YPdefine_method),T81,T83);
  VARSET(YevalSastYmodule_loader_stack_setter,T80);
  T84 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_412 = YPmet(FUNCODEREF(fun_412),YPfalse,T84,ENVNUL,PNUL,YPfalse);
  T85 = fun_412;
  XCALL5(1,VARREF(YPprop),VARREF(YevalSastYLmodule_loaderG),VARREF(YevalSastYmodule_loader_stack),VARREF(YevalSastYmodule_loader_stack_setter),VARREF(YLlstG),T85);
  lit_530 = YPPsym((P)"<module>");
  T87 = (P)YPpair(VARREF(YLanyG),Ynil);
  T86 = XCALL2(1,VARREF(Yfab_class),LITREF(lit_530),T87);
  VARSET(YevalSastYLmoduleG,T86);
  lit_531 = YPPsym((P)"module-name");
  T88 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_name_413 = YPmet(FUNCODEREF(fun_module_name_413),LITREF(lit_531),T88,ENVNUL,PNUL,YPfalse);
  T91 = BOUNDP(YevalSastYmodule_name);
  if (T91 != YPfalse) {
    T90 = VARREF(YevalSastYmodule_name);
  } else {
    T90 = YPfalse;
  }
  T92 = fun_module_name_413;
  T89 = XCALL2(1,VARREF(YPdefine_method),T90,T92);
  VARSET(YevalSastYmodule_name,T89);
  lit_532 = YPPsym((P)"module-name-setter");
  T93 = YPsig(YPPlist(2,LITREF(lit_21),LITREF(lit_19)),YPPlist(2,VARREF(YLsymG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_name_setter_414 = YPmet(FUNCODEREF(fun_module_name_setter_414),LITREF(lit_532),T93,ENVNUL,PNUL,YPfalse);
  T96 = BOUNDP(YevalSastYmodule_name_setter);
  if (T96 != YPfalse) {
    T95 = VARREF(YevalSastYmodule_name_setter);
  } else {
    T95 = YPfalse;
  }
  T97 = fun_module_name_setter_414;
  T94 = XCALL2(1,VARREF(YPdefine_method),T95,T97);
  VARSET(YevalSastYmodule_name_setter,T94);
  ...
  lit_533 = YPPsym((P)"module-mangled-name");
  T98 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_mangled_name_415 = YPmet(FUNCODEREF(fun_module_mangled_name_415),LITREF(lit_533),T98,ENVNUL,PNUL,YPfalse);
  T101 = BOUNDP(YevalSastYmodule_mangled_name);
  if (T101 != YPfalse) {
    T100 = VARREF(YevalSastYmodule_mangled_name);
  } else {
    T100 = YPfalse;
  }
  T102 = fun_module_mangled_name_415;
  T99 = XCALL2(1,VARREF(YPdefine_method),T100,T102);
  VARSET(YevalSastYmodule_mangled_name,T99);
  lit_534 = YPPsym((P)"module-mangled-name-setter");
  T104 = XCALL1(1,VARREF(YgooStypesYtQ),VARREF(YLstrG));
  T103 = YPsig(YPPlist(2,LITREF(lit_21),LITREF(lit_19)),YPPlist(2,T104,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_mangled_name_setter_416 = YPmet(FUNCODEREF(fun_module_mangled_name_setter_416),LITREF(lit_534),T103,ENVNUL,PNUL,YPfalse);
  T107 = BOUNDP(YevalSastYmodule_mangled_name_setter);
  if (T107 != YPfalse) {
    T106 = VARREF(YevalSastYmodule_mangled_name_setter);
  } else {
    T106 = YPfalse;
  }
  T108 = fun_module_mangled_name_setter_416;
  T105 = XCALL2(1,VARREF(YPdefine_method),T106,T108);
  VARSET(YevalSastYmodule_mangled_name_setter,T105);
  T109 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_417 = YPmet(FUNCODEREF(fun_417),YPfalse,T109,ENVNUL,PNUL,YPfalse);
  T110 = XCALL1(1,VARREF(YgooStypesYtQ),VARREF(YLstrG));
  T111 = fun_417;
  XCALL5(1,VARREF(YPprop),VARREF(YevalSastYLmoduleG),VARREF(YevalSastYmodule_mangled_name),VARREF(YevalSastYmodule_mangled_name_setter),T110,T111);
  lit_535 = YPPsym((P)"module-mangled-string-name");
  T112 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_mangled_string_name_418 = YPmet(FUNCODEREF(fun_module_mangled_string_name_418),LITREF(lit_535),T112,ENVNUL,PNUL,YPfalse);
  T115 = BOUNDP(YevalSastYmodule_mangled_string_name);
  if (T115 != YPfalse) {
    T114 = VARREF(YevalSastYmodule_mangled_string_name);
  } else {
    T114 = YPfalse;
  }
  T116 = fun_module_mangled_string_name_418;
  T113 = XCALL2(1,VARREF(YPdefine_method),T114,T116);
  VARSET(YevalSastYmodule_mangled_string_name,T113);
  lit_536 = YPPsym((P)"module-mangled-string-name-setter");
  T118 = XCALL1(1,VARREF(YgooStypesYtQ),VARREF(YLstrG));
  T117 = YPsig(YPPlist(2,LITREF(lit_21),LITREF(lit_19)),YPPlist(2,T118,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_mangled_string_name_setter_419 = YPmet(FUNCODEREF(fun_module_mangled_string_name_setter_419),LITREF(lit_536),T117,ENVNUL,PNUL,YPfalse);
  T121 = BOUNDP(YevalSastYmodule_mangled_string_name_setter);
  if (T121 != YPfalse) {
    T120 = VARREF(YevalSastYmodule_mangled_string_name_setter);
  } else {
    T120 = YPfalse;
  }
  T122 = fun_module_mangled_string_name_setter_419;
  T119 = XCALL2(1,VARREF(YPdefine_method),T120,T122);
  VARSET(YevalSastYmodule_mangled_string_name_setter,T119);
  T123 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_420 = YPmet(FUNCODEREF(fun_420),YPfalse,T123,ENVNUL,PNUL,YPfalse);
  T124 = XCALL1(1,VARREF(YgooStypesYtQ),VARREF(YLstrG));
  T125 = fun_420;
  XCALL5(1,VARREF(YPprop),VARREF(YevalSastYLmoduleG),VARREF(YevalSastYmodule_mangled_string_name),VARREF(YevalSastYmodule_mangled_string_name_setter),T124,T125);
  lit_537 = YPPsym((P)"module-target-environment");
  T126 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_target_environment_421 = YPmet(FUNCODEREF(fun_module_target_environment_421),LITREF(lit_537),T126,ENVNUL,PNUL,YPfalse);
  T129 = BOUNDP(YevalSastYmodule_target_environment);
  if (T129 != YPfalse) {
    T128 = VARREF(YevalSastYmodule_target_environment);
  } else {
    T128 = YPfalse;
  }
  T130 = fun_module_target_environment_421;
  T127 = XCALL2(1,VARREF(YPdefine_method),T128,T130);
  VARSET(YevalSastYmodule_target_environment,T127);
  lit_538 = YPPsym((P)"module-target-environment-setter");
  T131 = YPsig(YPPlist(2,LITREF(lit_21),LITREF(lit_19)),YPPlist(2,VARREF(YevalSastYLstatic_global_environmentG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_target_environment_setter_422 = YPmet(FUNCODEREF(fun_module_target_environment_setter_422),LITREF(lit_538),T131,ENVNUL,PNUL,YPfalse);
  T134 = BOUNDP(YevalSastYmodule_target_environment_setter);
  if (T134 != YPfalse) {
    T133 = VARREF(YevalSastYmodule_target_environment_setter);
  } else {
    T133 = YPfalse;
  }
  T135 = fun_module_target_environment_setter_422;
  T132 = XCALL2(1,VARREF(YPdefine_method),T133,T135);
  VARSET(YevalSastYmodule_target_environment_setter,T132);
  ...
  lit_539 = YPPsym((P)"module-syntax-environment");
  T136 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_syntax_environment_423 = YPmet(FUNCODEREF(fun_module_syntax_environment_423),LITREF(lit_539),T136,ENVNUL,PNUL,YPfalse);
  T139 = BOUNDP(YevalSastYmodule_syntax_environment);
  if (T139 != YPfalse) {
    T138 = VARREF(YevalSastYmodule_syntax_environment);
  } else {
    T138 = YPfalse;
  }
  T140 = fun_module_syntax_environment_423;
  T137 = XCALL2(1,VARREF(YPdefine_method),T138,T140);
  VARSET(YevalSastYmodule_syntax_environment,T137);
  lit_540 = YPPsym((P)"module-syntax-environment-setter");
  T141 = YPsig(YPPlist(2,LITREF(lit_21),LITREF(lit_19)),YPPlist(2,VARREF(YevalSastYLstatic_global_environmentG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_syntax_environment_setter_424 = YPmet(FUNCODEREF(fun_module_syntax_environment_setter_424),LITREF(lit_540),T141,ENVNUL,PNUL,YPfalse);
  T144 = BOUNDP(YevalSastYmodule_syntax_environment_setter);
  if (T144 != YPfalse) {
    T143 = VARREF(YevalSastYmodule_syntax_environment_setter);
  } else {
    T143 = YPfalse;
  }
  T145 = fun_module_syntax_environment_setter_424;
  T142 = XCALL2(1,VARREF(YPdefine_method),T143,T145);
  VARSET(YevalSastYmodule_syntax_environment_setter,T142);
  ...
  lit_541 = YPPsym((P)"%module-exports");
  T146 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_Pmodule_exports_425 = YPmet(FUNCODEREF(fun_Pmodule_exports_425),LITREF(lit_541),T146,ENVNUL,PNUL,YPfalse);
  T149 = BOUNDP(YevalSastYPmodule_exports);
  if (T149 != YPfalse) {
    T148 = VARREF(YevalSastYPmodule_exports);
  } else {
    T148 = YPfalse;
  }
  T150 = fun_Pmodule_exports_425;
  T147 = XCALL2(1,VARREF(YPdefine_method),T148,T150);
  VARSET(YevalSastYPmodule_exports,T147);
  lit_542 = YPPsym((P)"%module-exports-setter");
  T151 = YPsig(YPPlist(2,LITREF(lit_21),LITREF(lit_19)),YPPlist(2,VARREF(YgooScolsScolYLtabG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_Pmodule_exports_setter_426 = YPmet(FUNCODEREF(fun_Pmodule_exports_setter_426),LITREF(lit_542),T151,ENVNUL,PNUL,YPfalse);
  T154 = BOUNDP(YevalSastYPmodule_exports_setter);
  if (T154 != YPfalse) {
    T153 = VARREF(YevalSastYPmodule_exports_setter);
  } else {
    T153 = YPfalse;
  }
  T155 = fun_Pmodule_exports_setter_426;
  T152 = XCALL2(1,VARREF(YPdefine_method),T153,T155);
  VARSET(YevalSastYPmodule_exports_setter,T152);
  T156 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_427 = YPmet(FUNCODEREF(fun_427),YPfalse,T156,ENVNUL,PNUL,YPfalse);
  T157 = fun_427;
  XCALL5(1,VARREF(YPprop),VARREF(YevalSastYLmoduleG),VARREF(YevalSastYPmodule_exports),VARREF(YevalSastYPmodule_exports_setter),VARREF(YgooScolsScolYLtabG),T157);
  lit_543 = YPPsym((P)"module-data-processed?");
  T158 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_data_processedQ_428 = YPmet(FUNCODEREF(fun_module_data_processedQ_428),LITREF(lit_543),T158,ENVNUL,PNUL,YPfalse);
  T161 = BOUNDP(YevalSastYmodule_data_processedQ);
  if (T161 != YPfalse) {
    T160 = VARREF(YevalSastYmodule_data_processedQ);
  } else {
    T160 = YPfalse;
  }
  T162 = fun_module_data_processedQ_428;
  T159 = XCALL2(1,VARREF(YPdefine_method),T160,T162);
  VARSET(YevalSastYmodule_data_processedQ,T159);
  lit_544 = YPPsym((P)"module-data-processed?-setter");
  T163 = YPsig(YPPlist(2,LITREF(lit_21),LITREF(lit_19)),YPPlist(2,VARREF(YLlogG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_data_processedQ_setter_429 = YPmet(FUNCODEREF(fun_module_data_processedQ_setter_429),LITREF(lit_544),T163,ENVNUL,PNUL,YPfalse);
  T166 = BOUNDP(YevalSastYmodule_data_processedQ_setter);
  if (T166 != YPfalse) {
    T165 = VARREF(YevalSastYmodule_data_processedQ_setter);
  } else {
    T165 = YPfalse;
  }
  T167 = fun_module_data_processedQ_setter_429;
  T164 = XCALL2(1,VARREF(YPdefine_method),T165,T167);
  VARSET(YevalSastYmodule_data_processedQ_setter,T164);
  T168 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_430 = YPmet(FUNCODEREF(fun_430),YPfalse,T168,ENVNUL,PNUL,YPfalse);
  T169 = fun_430;
  XCALL5(1,VARREF(YPprop),VARREF(YevalSastYLmoduleG),VARREF(YevalSastYmodule_data_processedQ),VARREF(YevalSastYmodule_data_processedQ_setter),VARREF(YLlogG),T169);
  lit_545 = YPPsym((P)"module-runtime-data");
  T170 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_runtime_data_431 = YPmet(FUNCODEREF(fun_module_runtime_data_431),LITREF(lit_545),T170,ENVNUL,PNUL,YPfalse);
  T173 = BOUNDP(YevalSastYmodule_runtime_data);
  if (T173 != YPfalse) {
    T172 = VARREF(YevalSastYmodule_runtime_data);
  } else {
    T172 = YPfalse;
  }
  T174 = fun_module_runtime_data_431;
  T171 = XCALL2(1,VARREF(YPdefine_method),T172,T174);
  VARSET(YevalSastYmodule_runtime_data,T171);
  lit_546 = YPPsym((P)"module-runtime-data-setter");
  T175 = YPsig(YPPlist(2,LITREF(lit_21),LITREF(lit_19)),YPPlist(2,VARREF(YLanyG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_runtime_data_setter_432 = YPmet(FUNCODEREF(fun_module_runtime_data_setter_432),LITREF(lit_546),T175,ENVNUL,PNUL,YPfalse);
  T178 = BOUNDP(YevalSastYmodule_runtime_data_setter);
  if (T178 != YPfalse) {
    T177 = VARREF(YevalSastYmodule_runtime_data_setter);
  } else {
    T177 = YPfalse;
  }
  T179 = fun_module_runtime_data_setter_432;
  T176 = XCALL2(1,VARREF(YPdefine_method),T177,T179);
  VARSET(YevalSastYmodule_runtime_data_setter,T176);
  T180 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_433 = YPmet(FUNCODEREF(fun_433),YPfalse,T180,ENVNUL,PNUL,YPfalse);
  T181 = fun_433;
  XCALL5(1,VARREF(YPprop),VARREF(YevalSastYLmoduleG),VARREF(YevalSastYmodule_runtime_data),VARREF(YevalSastYmodule_runtime_data_setter),VARREF(YLanyG),T181);
  lit_547 = YPPsym((P)"module-transaction");
  T182 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_transaction_434 = YPmet(FUNCODEREF(fun_module_transaction_434),LITREF(lit_547),T182,ENVNUL,PNUL,YPfalse);
  T185 = BOUNDP(YevalSastYmodule_transaction);
  if (T185 != YPfalse) {
    T184 = VARREF(YevalSastYmodule_transaction);
  } else {
    T184 = YPfalse;
  }
  T186 = fun_module_transaction_434;
  T183 = XCALL2(1,VARREF(YPdefine_method),T184,T186);
  VARSET(YevalSastYmodule_transaction,T183);
  lit_548 = YPPsym((P)"module-transaction-setter");
  T187 = YPsig(YPPlist(2,LITREF(lit_21),LITREF(lit_19)),YPPlist(2,VARREF(YevalSastYLtransactionG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_transaction_setter_435 = YPmet(FUNCODEREF(fun_module_transaction_setter_435),LITREF(lit_548),T187,ENVNUL,PNUL,YPfalse);
  T190 = BOUNDP(YevalSastYmodule_transaction_setter);
  if (T190 != YPfalse) {
    T189 = VARREF(YevalSastYmodule_transaction_setter);
  } else {
    T189 = YPfalse;
  }
  T191 = fun_module_transaction_setter_435;
  T188 = XCALL2(1,VARREF(YPdefine_method),T189,T191);
  VARSET(YevalSastYmodule_transaction_setter,T188);
  T192 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_436 = YPmet(FUNCODEREF(fun_436),YPfalse,T192,ENVNUL,PNUL,YPfalse);
  T193 = fun_436;
  XCALL5(1,VARREF(YPprop),VARREF(YevalSastYLmoduleG),VARREF(YevalSastYmodule_transaction),VARREF(YevalSastYmodule_transaction_setter),VARREF(YevalSastYLtransactionG),T193);
  lit_549 = YPPsym((P)"module-uses-c-files");
  T194 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_uses_c_files_437 = YPmet(FUNCODEREF(fun_module_uses_c_files_437),LITREF(lit_549),T194,ENVNUL,PNUL,YPfalse);
  T197 = BOUNDP(YevalSastYmodule_uses_c_files);
  if (T197 != YPfalse) {
    T196 = VARREF(YevalSastYmodule_uses_c_files);
  } else {
    T196 = YPfalse;
  }
  T198 = fun_module_uses_c_files_437;
  T195 = XCALL2(1,VARREF(YPdefine_method),T196,T198);
  VARSET(YevalSastYmodule_uses_c_files,T195);
  lit_550 = YPPsym((P)"module-uses-c-files-setter");
  T201 = YPsig(YPPlist(2,LITREF(lit_21),LITREF(lit_19)),YPPlist(2,VARREF(YgooScolsSvecYLvecG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  T200 = fun_module_uses_c_files_setter_438 = YPmet(FUNCODEREF(fun_module_uses_c_files_setter_438),LITREF(lit_550),T201,ENVNUL,PNUL,YPfalse);
  T205 = BOUNDP(YevalSastYmodule_uses_c_files_setter);
  if (T205 != YPfalse) {
    T204 = VARREF(YevalSastYmodule_uses_c_files_setter);
  } else {
    T204 = YPfalse;
  }
  T206 = fun_module_uses_c_files_setter_438;
  T203 = XCALL2(1,VARREF(YPdefine_method),T204,T206);
  T202 = VARSET(YevalSastYmodule_uses_c_files_setter,T203);
  T199 = T202;
  return T199;
}
...
loop:
  T0 = YPsig(YPPlist(1,LITREF(lit_19)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_439 = YPmet(FUNCODEREF(fun_439),YPfalse,T0,ENVNUL,PNUL,YPfalse);
  T1 = fun_439;
  XCALL5(1,VARREF(YPprop),VARREF(YevalSastYLmoduleG),VARREF(YevalSastYmodule_uses_c_files),VARREF(YevalSastYmodule_uses_c_files_setter),VARREF(YgooScolsSvecYLvecG),T1);
  VARSET(YevalSastYmodule_exports_setter,VARREF(YevalSastYPmodule_exports_setter));
  lit_551 = YPPsym((P)"module-exports");
  T2 = YPsig(YPPlist(1,LITREF(lit_131)),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YgooScolsScolYLtabG),Ynil);
  fun_module_exports_440 = YPmet(FUNCODEREF(fun_module_exports_440),LITREF(lit_551),T2,ENVNUL,PNUL,YPfalse);
  T5 = BOUNDP(YevalSastYmodule_exports);
  if (T5 != YPfalse) {
    T4 = VARREF(YevalSastYmodule_exports);
  } else {
    T4 = YPfalse;
  }
  T6 = fun_module_exports_440;
  T3 = XCALL2(1,VARREF(YPdefine_method),T4,T6);
  VARSET(YevalSastYmodule_exports,T3);
  lit_552 = YPPsym((P)"set-module-environments");
  lit_553 = YPPsym((P)"mod");
  lit_554 = YPPsym((P)"syntax-env");
  lit_555 = YPPsym((P)"target-env");
  T7 = YPsig(YPPlist(3,LITREF(lit_553),LITREF(lit_554),LITREF(lit_555)),YPPlist(3,VARREF(YevalSastYLmoduleG),VARREF(YevalSastYLstatic_global_environmentG),VARREF(YevalSastYLstatic_global_environmentG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  YevalSastYset_module_environments = YPmet(FUNCODEREF(YevalSastYset_module_environments),LITREF(lit_552),T7,ENVNUL,PNUL,YPfalse);
  T8 = YevalSastYset_module_environments;
  VARSET(YevalSastYset_module_environments,T8);
  lit_556 = YPPsym((P)"do-module-loader-modules");
  lit_557 = YPPsym((P)"loader");
  T10 = YPsig(YPPlist(1,LITREF(lit_553)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_442 = YPmet(FUNCODEREF(fun_442),YPfalse,T10,ENVNUL,PNUL,YPfalse);
  T9 = YPsig(YPPlist(2,LITREF(lit_138),LITREF(lit_557)),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  YevalSastYdo_module_loader_modules = YPmet(FUNCODEREF(YevalSastYdo_module_loader_modules),LITREF(lit_556),T9,ENVNUL,PNUL,YPfalse);
  T11 = YevalSastYdo_module_loader_modules;
  VARSET(YevalSastYdo_module_loader_modules,T11);
  lit_558 = YPPsym((P)"module-loader-module-type");
  T12 = YPsig(YPPlist(1,LITREF(lit_557)),YPPlist(1,VARREF(YevalSastYLmodule_loaderG)),YPfalse,YPint((P)1),VARREF(YLtypeG),Ynil);
  fun_module_loader_module_type_444 = YPmet(FUNCODEREF(fun_module_loader_module_type_444),LITREF(lit_558),T12,ENVNUL,PNUL,YPfalse);
  T15 = BOUNDP(YevalSastYmodule_loader_module_type);
  if (T15 != YPfalse) {
    T14 = VARREF(YevalSastYmodule_loader_module_type);
  } else {
    T14 = YPfalse;
  }
  T16 = fun_module_loader_module_type_444;
  T13 = XCALL2(1,VARREF(YPdefine_method),T14,T16);
  VARSET(YevalSastYmodule_loader_module_type,T13);
  lit_559 = YPPsym((P)"register-module!");
  lit_560 = YPPsym((P)"module-loader");
  T17 = YPsig(YPPlist(2,LITREF(lit_560),LITREF(lit_553)),YPPlist(2,VARREF(YevalSastYLmodule_loaderG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YevalSastYLmodule_loaderG),Ynil);
  YevalSastYregister_moduleX = YPmet(FUNCODEREF(YevalSastYregister_moduleX),LITREF(lit_559),T17,ENVNUL,PNUL,YPfalse);
  T18 = YevalSastYregister_moduleX;
  VARSET(YevalSastYregister_moduleX,T18);
  lit_561 = YPPsym((P)"probe-module");
  T19 = YPsig(YPPlist(2,LITREF(lit_557),LITREF(lit_328)),YPPlist(2,VARREF(YevalSastYLmodule_loaderG),VARREF(YLsymG)),YPfalse,YPint((P)2),VARREF(YevalSastYLmoduleG),Ynil);
  YevalSastYprobe_module = YPmet(FUNCODEREF(YevalSastYprobe_module),LITREF(lit_561),T19,ENVNUL,PNUL,YPfalse);
  T20 = YevalSastYprobe_module;
  VARSET(YevalSastYprobe_module,T20);
  lit_562 = YPPsym((P)"load-and-register-module");
  lit_563 = YPsb((P)"  ");
  lit_564 = YPsb((P)"%s: error: Circular use of %s not allowed");
  lit_565 = YPsb((P)"%s[Loading module %s...\n");
  lit_566 = YPsb((P)"%s]\n");
  T23 = YPsig(Ynil,Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  fun_447 = YPmet(FUNCODEREF(fun_447),YPfalse,T23,ENVNUL,PNUL,YPfalse);
  T22 = YPsig(Ynil,Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  fun_448 = YPmet(FUNCODEREF(fun_448),YPfalse,T22,ENVNUL,PNUL,YPfalse);
  T21 = YPsig(YPPlist(2,LITREF(lit_557),LITREF(lit_328)),YPPlist(2,VARREF(YevalSastYLmodule_loaderG),VARREF(YLsymG)),YPfalse,YPint((P)2),VARREF(YevalSastYLmoduleG),Ynil);
  YevalSastYload_and_register_module = YPmet(FUNCODEREF(YevalSastYload_and_register_module),LITREF(lit_562),T21,ENVNUL,PNUL,YPfalse);
  T24 = YevalSastYload_and_register_module;
  VARSET(YevalSastYload_and_register_module,T24);
  lit_567 = YPPsym((P)"load-module");
  T26 = YPsig(YPPlist(2,LITREF(lit_557),LITREF(lit_328)),YPPlist(2,VARREF(YevalSastYLmodule_loaderG),VARREF(YLsymG)),YPfalse,YPint((P)2),VARREF(YevalSastYLmoduleG),Ynil);
  T25 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_567),T26,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YevalSastYload_module,T25);
  lit_568 = YPPsym((P)"export-binding!");
  lit_569 = YPsb((P)"Tried to export %= and %= from %= as %=");
  T28 = XCALL1(1,VARREF(YgooStypesYtE),YPfalse);
  T27 = YPsig(YPPlist(3,LITREF(lit_520),LITREF(lit_328),LITREF(lit_284)),YPPlist(3,VARREF(YevalSastYLmoduleG),VARREF(YevalSastYLbinding_nameG),VARREF(YevalSastYLmodule_bindingG)),YPfalse,YPint((P)3),T28,Ynil);
  YevalSastYexport_bindingX = YPmet(FUNCODEREF(YevalSastYexport_bindingX),LITREF(lit_568),T27,ENVNUL,PNUL,YPfalse);
  T29 = YevalSastYexport_bindingX;
  VARSET(YevalSastYexport_bindingX,T29);
  lit_570 = YPPsym((P)"binding-native-to?");
  T30 = YPsig(YPPlist(2,LITREF(lit_284),LITREF(lit_520)),YPPlist(2,VARREF(YevalSastYLmodule_bindingG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLlogG),Ynil);
  YevalSastYbinding_native_toQ = YPmet(FUNCODEREF(YevalSastYbinding_native_toQ),LITREF(lit_570),T30,ENVNUL,PNUL,YPfalse);
  T31 = YevalSastYbinding_native_toQ;
  VARSET(YevalSastYbinding_native_toQ,T31);
  lit_571 = YPPsym((P)"report-undefined-global-bindings");
  lit_572 = YPsb((P)"%s: warning: undefined binding '%s'.\n");
  T33 = YPsig(YPPlist(1,LITREF(lit_284)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_452 = YPmet(FUNCODEREF(fun_452),YPfalse,T33,ENVNUL,PNUL,YPfalse);
  T32 = YPsig(YPPlist(1,LITREF(lit_553)),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYreport_undefined_global_bindings = YPmet(FUNCODEREF(YevalSastYreport_undefined_global_bindings),LITREF(lit_571),T32,ENVNUL,PNUL,YPfalse);
  T34 = YevalSastYreport_undefined_global_bindings;
  VARSET(YevalSastYreport_undefined_global_bindings,T34);
  lit_573 = YPPsym((P)"compute-transitive-users");
  lit_574 = YPPsym((P)"modnames");
  lit_575 = YPPsym((P)"add-user");
  lit_576 = YPPsym((P)"uses-mod");
  T39 = YPsig(YPPlist(1,LITREF(lit_576)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_454 = YPmet(FUNCODEREF(fun_454),YPfalse,T39,ENVNUL,PNUL,YPfalse);
  T38 = YPsig(YPPlist(1,LITREF(lit_553)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_455 = YPmet(FUNCODEREF(fun_455),YPfalse,T38,ENVNUL,PNUL,YPfalse);
  T37 = YPsig(YPPlist(1,LITREF(lit_339)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_add_user_456 = YPmet(FUNCODEREF(fun_add_user_456),LITREF(lit_575),T37,ENVNUL,PNUL,YPfalse);
  T36 = YPsig(YPPlist(1,LITREF(lit_516)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_457 = YPmet(FUNCODEREF(fun_457),YPfalse,T36,ENVNUL,PNUL,YPfalse);
  T35 = YPsig(YPPlist(2,LITREF(lit_557),LITREF(lit_574)),YPPlist(2,VARREF(YevalSastYLmodule_loaderG),VARREF(YLlstG)),YPfalse,YPint((P)2),VARREF(YLlstG),Ynil);
  YevalSastYcompute_transitive_users = YPmet(FUNCODEREF(YevalSastYcompute_transitive_users),LITREF(lit_573),T35,ENVNUL,PNUL,YPfalse);
  T40 = YevalSastYcompute_transitive_users;
  VARSET(YevalSastYcompute_transitive_users,T40);
  lit_577 = YPPsym((P)"remove-module-internal!");
  T41 = YPsig(YPPlist(2,LITREF(lit_557),LITREF(lit_553)),YPPlist(2,VARREF(YevalSastYLmodule_loaderG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  YevalSastYremove_module_internalX = YPmet(FUNCODEREF(YevalSastYremove_module_internalX),LITREF(lit_577),T41,ENVNUL,PNUL,YPfalse);
  T42 = YevalSastYremove_module_internalX;
  VARSET(YevalSastYremove_module_internalX,T42);
  lit_578 = YPPsym((P)"remove-modules-by-name!");
  T45 = YPsig(YPPlist(1,LITREF(lit_339)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_460 = YPmet(FUNCODEREF(fun_460),YPfalse,T45,ENVNUL,PNUL,YPfalse);
  T44 = XCALL1(1,VARREF(YgooStypesYtE),YPfalse);
  T43 = YPsig(YPPlist(2,LITREF(lit_557),LITREF(lit_574)),YPPlist(2,VARREF(YevalSastYLmodule_loaderG),VARREF(YLlstG)),YPfalse,YPint((P)2),T44,Ynil);
  YevalSastYremove_modules_by_nameX = YPmet(FUNCODEREF(YevalSastYremove_modules_by_nameX),LITREF(lit_578),T43,ENVNUL,PNUL,YPfalse);
  T46 = YevalSastYremove_modules_by_nameX;
  VARSET(YevalSastYremove_modules_by_nameX,T46);
  lit_579 = YPPsym((P)"module-name-to-relpath");
  T47 = YPsig(YPPlist(1,LITREF(lit_328)),YPPlist(1,VARREF(YLsymG)),YPfalse,YPint((P)1),VARREF(YLstrG),Ynil);
  YevalSastYmodule_name_to_relpath = YPmet(FUNCODEREF(YevalSastYmodule_name_to_relpath),LITREF(lit_579),T47,ENVNUL,PNUL,YPfalse);
  T48 = YevalSastYmodule_name_to_relpath;
  VARSET(YevalSastYmodule_name_to_relpath,T48);
  lit_580 = YPPsym((P)"install-initial-bindings");
  lit_581 = YPPlist(2,YPPsym((P)"seq"),YPPsym((P)"use"));
  T50 = YPsig(YPPlist(1,LITREF(lit_328)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_463 = YPmet(FUNCODEREF(fun_463),YPfalse,T50,ENVNUL,PNUL,YPfalse);
  T49 = YPsig(YPPlist(2,LITREF(lit_410),LITREF(lit_557)),YPPlist(2,VARREF(YevalSastYLstatic_global_environmentG),VARREF(YevalSastYLmodule_loaderG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  YevalSastYinstall_initial_bindings = YPmet(FUNCODEREF(YevalSastYinstall_initial_bindings),LITREF(lit_580),T49,ENVNUL,PNUL,YPfalse);
  T51 = YevalSastYinstall_initial_bindings;
  VARSET(YevalSastYinstall_initial_bindings,T51);
  lit_582 = YPPsym((P)"fab-static-global-environment");
  lit_583 = YPPsym((P)"allow-foreign-names?");
  T52 = YPsig(YPPlist(3,LITREF(lit_520),LITREF(lit_560),LITREF(lit_583)),YPPlist(3,VARREF(YevalSastYLmoduleG),VARREF(YevalSastYLmodule_loaderG),VARREF(YLlogG)),YPfalse,YPint((P)3),VARREF(YevalSastYLstatic_global_environmentG),Ynil);
  YevalSastYfab_static_global_environment = YPmet(FUNCODEREF(YevalSastYfab_static_global_environment),LITREF(lit_582),T52,ENVNUL,PNUL,YPfalse);
  T53 = YevalSastYfab_static_global_environment;
  VARSET(YevalSastYfab_static_global_environment,T53);
  lit_584 = YPPsym((P)"fab-subset-environment");
  lit_585 = YPPsym((P)"src-module");
  lit_586 = YPPsym((P)"excluded");
  T55 = YPsig(YPPlist(2,LITREF(lit_328),LITREF(lit_284)),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_466 = YPmet(FUNCODEREF(fun_466),YPfalse,T55,ENVNUL,PNUL,YPfalse);
  T54 = YPsig(YPPlist(3,LITREF(lit_520),LITREF(lit_585),LITREF(lit_586)),YPPlist(3,VARREF(YevalSastYLmoduleG),VARREF(YevalSastYLmoduleG),VARREF(YLcolG)),YPfalse,YPint((P)3),VARREF(YevalSastYLstatic_global_environmentG),Ynil);
  YevalSastYfab_subset_environment = YPmet(FUNCODEREF(YevalSastYfab_subset_environment),LITREF(lit_584),T54,ENVNUL,PNUL,YPfalse);
  T56 = YevalSastYfab_subset_environment;
  VARSET(YevalSastYfab_subset_environment,T56);
  lit_587 = YPPsym((P)"<runtime-module-loader>");
  T58 = (P)YPpair(VARREF(YevalSastYLmodule_loaderG),Ynil);
  T57 = XCALL2(1,VARREF(Yfab_class),LITREF(lit_587),T58);
  VARSET(YevalSastYLruntime_module_loaderG,T57);
  DYNDEFSET(YevalSastYTnow_rt_envT,YPfalse);
  lit_588 = YPsb((P)"Unable to find module %s");
  T63 = YPsig(Ynil,Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  fun_468 = YPmet(FUNCODEREF(fun_468),YPfalse,T63,ENVNUL,PNUL,YPfalse);
  T62 = YPsig(Ynil,Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  fun_469 = YPmet(FUNCODEREF(fun_469),YPfalse,T62,ENVNUL,PNUL,YPfalse);
  T61 = YPsig(Ynil,Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  fun_470 = YPmet(FUNCODEREF(fun_470),YPfalse,T61,ENVNUL,PNUL,YPfalse);
  T60 = YPsig(Ynil,Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  fun_471 = YPmet(FUNCODEREF(fun_471),YPfalse,T60,ENVNUL,PNUL,YPfalse);
  T59 = YPsig(YPPlist(2,LITREF(lit_557),LITREF(lit_328)),YPPlist(2,VARREF(YevalSastYLruntime_module_loaderG),VARREF(YLsymG)),YPfalse,YPint((P)2),VARREF(YevalSastYLmoduleG),Ynil);
  fun_load_module_472 = YPmet(FUNCODEREF(fun_load_module_472),LITREF(lit_567),T59,ENVNUL,PNUL,YPfalse);
  T66 = BOUNDP(YevalSastYload_module);
  if (T66 != YPfalse) {
    T65 = VARREF(YevalSastYload_module);
  } else {
    T65 = YPfalse;
  }
  T67 = fun_load_module_472;
  T64 = XCALL2(1,VARREF(YPdefine_method),T65,T67);
  VARSET(YevalSastYload_module,T64);
  T68 = XCALL1(1,VARREF(Ynew),VARREF(YevalSastYLruntime_module_loaderG));
  VARSET(YevalSastYTruntime_module_loaderT,T68);
  lit_589 = YPPsym((P)"runtime-module-loader");
  T69 = YPsig(Ynil,Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  YevalSastYruntime_module_loader = YPmet(FUNCODEREF(YevalSastYruntime_module_loader),LITREF(lit_589),T69,ENVNUL,PNUL,YPfalse);
  T70 = YevalSastYruntime_module_loader;
  VARSET(YevalSastYruntime_module_loader,T70);
  lit_590 = YPPsym((P)"runtime-module");
  T71 = YPsig(YPPlist(1,LITREF(lit_339)),YPPlist(1,VARREF(YLsymG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYruntime_module = YPmet(FUNCODEREF(YevalSastYruntime_module),LITREF(lit_590),T71,ENVNUL,PNUL,YPfalse);
  T72 = YevalSastYruntime_module;
  VARSET(YevalSastYruntime_module,T72);
  lit_591 = YPPsym((P)"runtime-environment");
  T73 = YPsig(YPPlist(1,LITREF(lit_339)),YPPlist(1,VARREF(YLsymG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYruntime_environment = YPmet(FUNCODEREF(YevalSastYruntime_environment),LITREF(lit_591),T73,ENVNUL,PNUL,YPfalse);
  T74 = YevalSastYruntime_environment;
  VARSET(YevalSastYruntime_environment,T74);
  lit_592 = YPPsym((P)"runtime-core-environment");
  T75 = YPsig(YPPlist(1,LITREF(lit_339)),YPPlist(1,VARREF(YLsymG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYruntime_core_environment = YPmet(FUNCODEREF(YevalSastYruntime_core_environment),LITREF(lit_592),T75,ENVNUL,PNUL,YPfalse);
  T76 = YevalSastYruntime_core_environment;
  VARSET(YevalSastYruntime_core_environment,T76);
  lit_593 = YPPsym((P)"unchecked-runtime-environment");
  T77 = YPsig(YPPlist(1,LITREF(lit_339)),YPPlist(1,VARREF(YLsymG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYunchecked_runtime_environment = YPmet(FUNCODEREF(YevalSastYunchecked_runtime_environment),LITREF(lit_593),T77,ENVNUL,PNUL,YPfalse);
  T78 = YevalSastYunchecked_runtime_environment;
  VARSET(YevalSastYunchecked_runtime_environment,T78);
  lit_594 = YPPsym((P)"reloader-do-create-module");
  lit_595 = YPPsym((P)"data");
  T79 = YPsig(YPPlist(2,LITREF(lit_339),LITREF(lit_595)),YPPlist(2,VARREF(YLstrG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YevalSastYLmoduleG),Ynil);
  YevalSastYreloader_do_create_module = YPmet(FUNCODEREF(YevalSastYreloader_do_create_module),LITREF(lit_594),T79,ENVNUL,PNUL,YPfalse);
  T80 = YevalSastYreloader_do_create_module;
  VARSET(YevalSastYreloader_do_create_module,T80);
  lit_596 = YPPsym((P)"reloader-do-use-module");
  lit_597 = YPPsym((P)"uses");
  T81 = YPsig(YPPlist(2,LITREF(lit_553),LITREF(lit_597)),YPPlist(2,VARREF(YevalSastYLmoduleG),VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  YevalSastYreloader_do_use_module = YPmet(FUNCODEREF(YevalSastYreloader_do_use_module),LITREF(lit_596),T81,ENVNUL,PNUL,YPfalse);
  T82 = YevalSastYreloader_do_use_module;
  VARSET(YevalSastYreloader_do_use_module,T82);
  lit_598 = YPPsym((P)"reloader-do-import");
  lit_599 = YPPsym((P)"from-mod");
  lit_600 = YPPsym((P)"original-name");
  lit_601 = YPsb((P)"Can't find %s from %s for %s\n");
  T83 = YPsig(YPPlist(4,LITREF(lit_553),LITREF(lit_328),LITREF(lit_599),LITREF(lit_600)),YPPlist(4,VARREF(YevalSastYLmoduleG),VARREF(YLstrG),VARREF(YevalSastYLmoduleG),VARREF(YLstrG)),YPfalse,YPint((P)4),VARREF(YLanyG),Ynil);
  YevalSastYreloader_do_import = YPmet(FUNCODEREF(YevalSastYreloader_do_import),LITREF(lit_598),T83,ENVNUL,PNUL,YPfalse);
  T84 = YevalSastYreloader_do_import;
  VARSET(YevalSastYreloader_do_import,T84);
  lit_602 = YPPsym((P)"process-module-data");
  T85 = YPsig(YPPlist(1,LITREF(lit_520)),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYprocess_module_data = YPmet(FUNCODEREF(YevalSastYprocess_module_data),LITREF(lit_602),T85,ENVNUL,PNUL,YPfalse);
  T86 = YevalSastYprocess_module_data;
  VARSET(YevalSastYprocess_module_data,T86);
  lit_603 = YPPsym((P)"ensure-module-data");
  T87 = YPsig(YPPlist(1,LITREF(lit_520)),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYensure_module_data = YPmet(FUNCODEREF(YevalSastYensure_module_data),LITREF(lit_603),T87,ENVNUL,PNUL,YPfalse);
  T88 = YevalSastYensure_module_data;
  VARSET(YevalSastYensure_module_data,T88);
  lit_604 = YPPsym((P)"reloader-do-runtime-binding");
  T89 = YPsig(YPPlist(3,LITREF(lit_553),LITREF(lit_328),LITREF(lit_441)),YPPlist(3,VARREF(YevalSastYLmoduleG),VARREF(YLstrG),VARREF(YLlocG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  YevalSastYreloader_do_runtime_binding = YPmet(FUNCODEREF(YevalSastYreloader_do_runtime_binding),LITREF(lit_604),T89,ENVNUL,PNUL,YPfalse);
  T90 = YevalSastYreloader_do_runtime_binding;
  VARSET(YevalSastYreloader_do_runtime_binding,T90);
  lit_605 = YPPsym((P)"reloader-do-dynamic-binding");
  T91 = YPsig(YPPlist(3,LITREF(lit_553),LITREF(lit_328),LITREF(lit_441)),YPPlist(3,VARREF(YevalSastYLmoduleG),VARREF(YLstrG),VARREF(YLlocG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  YevalSastYreloader_do_dynamic_binding = YPmet(FUNCODEREF(YevalSastYreloader_do_dynamic_binding),LITREF(lit_605),T91,ENVNUL,PNUL,YPfalse);
  T92 = YevalSastYreloader_do_dynamic_binding;
  VARSET(YevalSastYreloader_do_dynamic_binding,T92);
  lit_606 = YPPsym((P)"reloader-do-other-binding");
  T93 = YPsig(YPPlist(2,LITREF(lit_553),LITREF(lit_328)),YPPlist(2,VARREF(YevalSastYLmoduleG),VARREF(YLstrG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  YevalSastYreloader_do_other_binding = YPmet(FUNCODEREF(YevalSastYreloader_do_other_binding),LITREF(lit_606),T93,ENVNUL,PNUL,YPfalse);
  T94 = YevalSastYreloader_do_other_binding;
  VARSET(YevalSastYreloader_do_other_binding,T94);
  lit_607 = YPPsym((P)"reloader-do-export");
  lit_608 = YPPsym((P)"as-name");
  lit_609 = YPsb((P)"Can't find %s in %s\n");
  T95 = YPsig(YPPlist(3,LITREF(lit_553),LITREF(lit_328),LITREF(lit_608)),YPPlist(3,VARREF(YevalSastYLmoduleG),VARREF(YLstrG),VARREF(YLstrG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  YevalSastYreloader_do_export = YPmet(FUNCODEREF(YevalSastYreloader_do_export),LITREF(lit_607),T95,ENVNUL,PNUL,YPfalse);
  T96 = YevalSastYreloader_do_export;
  VARSET(YevalSastYreloader_do_export,T96);
  lit_610 = YPPsym((P)"reload-modules");
  T97 = YPsig(Ynil,Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  YevalSastYreload_modules = YPmet(FUNCODEREF(YevalSastYreload_modules),LITREF(lit_610),T97,ENVNUL,PNUL,YPfalse);
  T98 = YevalSastYreload_modules;
  VARSET(YevalSastYreload_modules,T98);
  lit_611 = YPPsym((P)"install-magic-bindings");
  T100 = YPsig(YPPlist(1,LITREF(lit_284)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_488 = YPmet(FUNCODEREF(fun_488),YPfalse,T100,ENVNUL,PNUL,YPfalse);
  T99 = YPsig(YPPlist(1,LITREF(lit_410)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYinstall_magic_bindings = YPmet(FUNCODEREF(YevalSastYinstall_magic_bindings),LITREF(lit_611),T99,ENVNUL,PNUL,YPfalse);
  T101 = YevalSastYinstall_magic_bindings;
  VARSET(YevalSastYinstall_magic_bindings,T101);
  lit_612 = YPPsym((P)"reload-macros");
  T102 = YPsig(Ynil,Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  YevalSastYreload_macros = YPmet(FUNCODEREF(YevalSastYreload_macros),LITREF(lit_612),T102,ENVNUL,PNUL,YPfalse);
  T103 = YevalSastYreload_macros;
  VARSET(YevalSastYreload_macros,T103);
  lit_613 = YPPsym((P)"install-interpreter-hacks");
  T104 = YPsig(YPPlist(1,LITREF(lit_410)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYinstall_interpreter_hacks = YPmet(FUNCODEREF(YevalSastYinstall_interpreter_hacks),LITREF(lit_613),T104,ENVNUL,PNUL,YPfalse);
  T105 = YevalSastYinstall_interpreter_hacks;
  VARSET(YevalSastYinstall_interpreter_hacks,T105);
  lit_614 = YPPsym((P)"init-runtime");
  T106 = YPsig(Ynil,Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  YevalSastYinit_runtime = YPmet(FUNCODEREF(YevalSastYinit_runtime),LITREF(lit_614),T106,ENVNUL,PNUL,YPfalse);
  T107 = YevalSastYinit_runtime;
  VARSET(YevalSastYinit_runtime,T107);
  lit_615 = YPPlist(5,YPPsym((P)"ct"),YPPsym((P)"ct-also"),YPPsym((P)"ds"),YPPsym((P)"use"),YPPsym((P)"export"));
  VARSET(YevalSastYsyntax_environment_excluded_bindings,LITREF(lit_615));
  lit_616 = YPPsym((P)"fab-syntax-environment");
  lit_617 = YPPsym((P)"goo");
  T108 = YPsig(YPPlist(1,LITREF(lit_520)),YPPlist(1,VARREF(YevalSastYLmoduleG)),YPfalse,YPint((P)1),VARREF(YevalSastYLstatic_global_environmentG),Ynil);
  YevalSastYfab_syntax_environment = YPmet(FUNCODEREF(YevalSastYfab_syntax_environment),LITREF(lit_616),T108,ENVNUL,PNUL,YPfalse);
  T109 = YevalSastYfab_syntax_environment;
  VARSET(YevalSastYfab_syntax_environment,T109);
  lit_618 = YPPsym((P)"fab-g2c-module");
  T110 = YPsig(YPPlist(2,LITREF(lit_557),LITREF(lit_328)),YPPlist(2,VARREF(YevalSastYLmodule_loaderG),VARREF(YLsymG)),YPfalse,YPint((P)2),VARREF(YevalSastYLmoduleG),Ynil);
  YevalSastYfab_g2c_module = YPmet(FUNCODEREF(YevalSastYfab_g2c_module),LITREF(lit_618),T110,ENVNUL,PNUL,YPfalse);
  T111 = YevalSastYfab_g2c_module;
  VARSET(YevalSastYfab_g2c_module,T111);
  lit_619 = YPPsym((P)"init-g2c-boot-environment");
  T112 = YPsig(YPPlist(1,LITREF(lit_410)),YPPlist(1,VARREF(YevalSastYLstatic_global_environmentG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YevalSastYinit_g2c_boot_environment = YPmet(FUNCODEREF(YevalSastYinit_g2c_boot_environment),LITREF(lit_619),T112,ENVNUL,PNUL,YPfalse);
  T113 = YevalSastYinit_g2c_boot_environment;
  VARSET(YevalSastYinit_g2c_boot_environment,T113);
  lit_620 = YPPsym((P)"init-g2c-regular-environment");
  T114 = YPsig(YPPlist(2,LITREF(lit_410),LITREF(lit_557)),YPPlist(2,VARREF(YevalSastYLstatic_global_environmentG),VARREF(YevalSastYLmodule_loaderG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  YevalSastYinit_g2c_regular_environment = YPmet(FUNCODEREF(YevalSastYinit_g2c_regular_environment),LITREF(lit_620),T114,ENVNUL,PNUL,YPfalse);
  T115 = YevalSastYinit_g2c_regular_environment;
  VARSET(YevalSastYinit_g2c_regular_environment,T115);
  lit_621 = YPPsym((P)"init-ast");
  T116 = YPsig(Ynil,Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  YevalSastYinit_ast = YPmet(FUNCODEREF(YevalSastYinit_ast),LITREF(lit_621),T116,ENVNUL,PNUL,YPfalse);
  T117 = YevalSastYinit_ast;
  VARSET(YevalSastYinit_ast,T117);
  lit_622 = YPPsym((P)"do-static-global-bindings");
  T119 = YPsig(YPPlist(1,LITREF(lit_410)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_loop_498 = YPmet(FUNCODEREF(fun_loop_498),LITREF(lit_149),T119,ENVNUL,PNUL,YPfalse);
  T118 = YPsig(YPPlist(2,LITREF(lit_138),LITREF(lit_410)),YPPlist(2,VARREF(YLfunG),VARREF(YevalSastYLstatic_global_environmentG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  YevalSastYdo_static_global_bindings = YPmet(FUNCODEREF(YevalSastYdo_static_global_bindings),LITREF(lit_622),T118,ENVNUL,PNUL,YPfalse);
  T120 = YevalSastYdo_static_global_bindings;
  VARSET(YevalSastYdo_static_global_bindings,T120);
  lit_623 = YPPsym((P)"do-named-static-global-bindings");
  T122 = YPsig(YPPlist(1,LITREF(lit_410)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_loop_500 = YPmet(FUNCODEREF(fun_loop_500),LITREF(lit_149),T122,ENVNUL,PNUL,YPfalse);
  T121 = YPsig(YPPlist(2,LITREF(lit_138),LITREF(lit_410)),YPPlist(2,VARREF(YLfunG),VARREF(YevalSastYLstatic_global_environmentG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  YevalSastYdo_named_static_global_bindings = YPmet(FUNCODEREF(YevalSastYdo_named_static_global_bindings),LITREF(lit_623),T121,ENVNUL,PNUL,YPfalse);
  T123 = YevalSastYdo_named_static_global_bindings;
  VARSET(YevalSastYdo_named_static_global_bindings,T123);
  tmpF1940 = YPfalse;
  if (tmpF1940 != YPfalse) {
    T124 = VARREF(YevalSastYast_evaluate);
  } else {
    T124 = YPfalse;
  }
  tmpF1941 = YPfalse;
  if (tmpF1941 != YPfalse) {
    T125 = VARREF(YevalSastYinit_environment_for_eval);
  } else {
    T125 = YPfalse;
  }
  tmpF1942 = YPfalse;
  if (tmpF1942 != YPfalse) {
    T126 = VARREF(YevalSastYload_in);
  } else {
    T126 = YPfalse;
  }
  T127 = YPfalse;
