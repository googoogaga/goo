...
loop:
  ...
  x_1422F1581 = T1;
  FUNINIT(x_1422F1581, 1,return_);
  x_1421F1582 = FREEREF(0);
  dependentF1583 = YPfalse;
  dependentF1583 = BOXFAB(dependentF1583);
  bodyF1584 = YPfalse;
  bodyF1584 = BOXFAB(bodyF1584);
  T7 = CALL2(1,VARREF(YisaQ),x_1421F1582,VARREF(YLlstG));
  if (T7 != YPfalse) {
    T9 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1421F1582,LITREF(lit_6),x_1422F1581);
    x_1421F1585 = T9;
    T11 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1421F1585,x_1422F1581);
    BOXVAL(dependentF1583) = T11;
    T12 = CALL1(1,VARREF(Ytail),x_1421F1585);
    x_1421F1586 = T12;
    BOXVAL(bodyF1584) = x_1421F1586;
    x_1421F1587 = Ynil;
    T14 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1421F1587,x_1422F1581);
    T13 = T14;
    T10 = T13;
    T8 = T10;
  } else {
    T15 = CALL2(1,x_1422F1581,LITREF(lit_7),x_1421F1582);
  }
  T17 = CALL0(1,VARREF(YgooSmacrosYgensym));
  saved_dependentF1588 = T17;
  T19 = CALL1(1,VARREF(Ylst),LITREF(lit_8));
  T24 = CALL1(1,VARREF(Ylst),saved_dependentF1588);
  ...
  T43 = CALL1(1,VARREF(Ylst),saved_dependentF1588);
...
loop:
  ...
  bF1589 = T1;
  if (bF1589 != YPfalse) {
    T4 = CALL1(1,VARREF(Yx8rSastYbinding_module_name),bF1589);
    T5 = CALL1(1,VARREF(Yx8rSastYbinding_name),bF1589);
    T3 = CALL3(1,VARREF(YgooSruntimeYmsg_to_str),LITREF(lit_129),T4,T5);
    T2 = T3;
  } else {
    T2 = LITREF(lit_130);
  }
...
loop:
  ...
  if (T3 != YPfalse) {
    T4 = CALL3(1,VARREF(YgooSruntimeYmsg),VARREF(YgooSioSportYout),LITREF(lit_133),nameF1590);
    T2 = T4;
  } else {
    T6 = CALL2(1,VARREF(Yx8rSdependencyYdependency_includes_anyQ),dtype_,VARREF(Yx8rSdependencyYDoptimizaton_dependencies));
    if (T6 != YPfalse) {
      T7 = CALL3(1,VARREF(YgooSruntimeYmsg),VARREF(YgooSioSportYout),LITREF(lit_134),nameF1590);
      T5 = T7;
    } else {
      if (YPtrue != YPfalse) {
        T9 = CALL3(1,VARREF(YgooSruntimeYmsg),VARREF(YgooSioSportYout),LITREF(lit_135),nameF1590);
        T8 = T9;
      } else {
        T8 = YPfalse;
      }
...
loop:
  ...
  loopF1591 = T1;
  FUNINIT(loopF1591, 1,loopF1591);
  T2 = CALL2(0,loopF1591,Ynil,e_);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  x_1426F1592 = T1;
  FUNINIT(x_1426F1592, 1,return_);
  x_1425F1593 = FREEREF(0);
  nameF1594 = YPfalse;
  nameF1594 = BOXFAB(nameF1594);
  supersF1595 = YPfalse;
  supersF1595 = BOXFAB(supersF1595);
  T7 = CALL2(1,VARREF(YisaQ),x_1425F1593,VARREF(YLlstG));
  if (T7 != YPfalse) {
    T9 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1425F1593,LITREF(lit_142),x_1426F1592);
    x_1425F1596 = T9;
    T11 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1425F1596,x_1426F1592);
    BOXVAL(nameF1594) = T11;
    T12 = CALL1(1,VARREF(Ytail),x_1425F1596);
    x_1425F1597 = T12;
    T14 = CALL2(1,VARREF(YgooSmacrosYmatch_sublist),x_1425F1597,x_1426F1592);
    x_1425F1598 = T14;
    BOXVAL(supersF1595) = x_1425F1598;
    x_1425F1599 = Ynil;
    T16 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1425F1599,x_1426F1592);
    T15 = T16;
    T17 = CALL1(1,VARREF(Ytail),x_1425F1597);
    x_1425F1600 = T17;
    T18 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1425F1600,x_1426F1592);
    T13 = T18;
    T10 = T13;
    T8 = T10;
  } else {
    T19 = CALL2(1,x_1426F1592,LITREF(lit_7),x_1425F1593);
  }
  T22 = BOXVAL(nameF1594);
  T21 = CALL3(1,VARREF(YgooSmacrosYcat_sym),LITREF(lit_143),T22,LITREF(lit_144));
  classF1601 = T21;
  T25 = BOXVAL(nameF1594);
  ...
  T31 = CALL1(1,VARREF(Ylst),classF1601);
  T34 = CALL1(1,VARREF(Ylst),LITREF(lit_148));
  T35 = BOXVAL(supersF1595);
  ...
  T39 = CALL1(1,VARREF(Ylst),DemptyF1602);
  T42 = CALL1(1,VARREF(Ylst),LITREF(lit_150));
  T43 = CALL1(1,VARREF(Ylst),classF1601);
  ...
  T56 = CALL1(1,VARREF(Ylst),classF1601);
  ...
  T60 = CALL1(1,VARREF(Ylst),classF1601);
  ...
  T80 = CALL1(1,VARREF(Ylst),classF1601);
  ...
  T99 = CALL1(1,VARREF(Ylst),classF1601);
  ...
  T110 = CALL1(1,VARREF(Ylst),classF1601);
  ...
  T124 = CALL1(1,VARREF(Ylst),classF1601);
  ...
  T141 = CALL1(1,VARREF(Ylst),classF1601);
...
loop:
  ...
  x_1430F1603 = T1;
  FUNINIT(x_1430F1603, 1,return_);
  x_1429F1604 = FREEREF(0);
  nameF1605 = YPfalse;
  nameF1605 = BOXFAB(nameF1605);
  T5 = CALL2(1,VARREF(YisaQ),x_1429F1604,VARREF(YLlstG));
  if (T5 != YPfalse) {
    T7 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1429F1604,LITREF(lit_165),x_1430F1603);
    x_1429F1606 = T7;
    T9 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1429F1606,x_1430F1603);
    BOXVAL(nameF1605) = T9;
    T10 = CALL1(1,VARREF(Ytail),x_1429F1606);
    x_1429F1607 = T10;
    T11 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1429F1607,x_1430F1603);
    T8 = T11;
    T6 = T8;
  } else {
    T12 = CALL2(1,x_1430F1603,LITREF(lit_7),x_1429F1604);
  }
  T14 = CALL1(1,VARREF(Ylst),LITREF(lit_142));
  T16 = BOXVAL(nameF1605);
...
loop:
  ...
  x_1431F1610 = T1;
  x_1432F1611 = VARREF(YgooSmacrosYEE);
  T4 = CALL2(1,x_1432F1611,x_1431F1610,LITREF(lit_283));
  if (T4 != YPfalse) {
    T6 = CALL1(1,VARREF(Yx8rSastYbinding_handler),f_);
    T5 = CALL3(1,T6,e_,r_,tailQ_);
    T3 = T5;
  } else {
    T8 = CALL2(1,x_1432F1611,x_1431F1610,LITREF(lit_284));
    if (T8 != YPfalse) {
...
loop:
  ...
  refF1612 = T1;
  T2 = CALL3(1,VARREF(Ynew),VARREF(Yx8rSastYLboundQG),VARREF(Yx8rSastYboundQ_reference),refF1612);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  modF1613 = T1;
  T3 = CALL1(1,VARREF(Yx8rSastYmodule_syntax_environment),modF1613);
  syntax_envF1614 = T3;
  T5 = CALL1(1,VARREF(Yx8rSastYmodule_target_environment),modF1613);
  target_envF1615 = T5;
  T7 = CALL3(1,VARREF(Yx8rSastYobjectify),program_,syntax_envF1614,tailQ_);
  astF1616 = T7;
  CALL1(1,VARREF(Yx8rSastYast_evaluate),astF1616);
  tmpF1617 = rtQ_;
  if (tmpF1617 != YPfalse) {
    T11 = CALL2(1,VARREF(YgooSmathYNEE),syntax_envF1614,target_envF1615);
    T10 = T11;
  } else {
    T10 = YPfalse;
  }
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    if (T4 != YPfalse) {
      ...
      loopF1618 = T8;
      FUNINIT(loopF1618, 1,loopF1618);
      T9 = CALL1(0,loopF1618,eT_);
      T7 = T9;
      T3 = T7;
    }
    T0 = T3;
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    eF1619 = T3;
    T5 = CALL1(1,VARREF(Yx8rSsyntaxYsexpr_defQ),eF1619);
    if (T5 != YPfalse) {
      T9 = CALL1(1,VARREF(Ylst),LITREF(lit_8));
      T15 = CALL1(1,VARREF(Yx8rSsyntaxYsexpr_def_variable),eF1619);
      T14 = CALL1(1,VARREF(Ylst),T15);
      T17 = CALL1(1,VARREF(Yx8rSsyntaxYsexpr_def_value),eF1619);
      ...
      T21 = CALL1(1,VARREF(Ylst),eF1619);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    T8 = CALL3(1,VARREF(Yx8rSastYobjectify),T9,FREEREF(1),tailQF1620);
    headF1621 = T8;
    T11 = CALL2(1,VARREF(YgooSmacrosYpair),headF1621,res_);
...
loop:
  ...
  loopF1622 = T2;
  FUNINIT(loopF1622, 3,tailQ_,r_,loopF1622);
  T4 = CALL1(1,VARREF(Yx8rSastYtransform_defs),eT_);
  T3 = CALL2(0,loopF1622,Ynil,T4);
  T1 = T3;
  astsF1623 = T1;
  T5 = CALL1(1,VARREF(Yx8rSastYsequentialize),astsF1623);
  T0 = T5;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  eeTF1624 = T1;
  T4 = CALL4(1,VARREF(Yx8rSastYprocess_closed_application),ff_,eeTF1624,r_,tailQ_);
  T0 = T4;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  fvfF1626 = T5;
  T6 = CALLN(1,VARREF(Ynew),7,VARREF(Yx8rSastYLpredefined_applicationG),VARREF(Yx8rSastYapplication_binding),fvfF1626,VARREF(Yx8rSastYapplication_arguments),eeTF1625,VARREF(Yx8rSastYapplication_tailQ),tailQ_);
  T4 = T6;
  T0 = T4;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  T1 = CALL1(1,VARREF(Yx8rSastYconvert2arguments),T2);
  eeTF1627 = T1;
  T4 = CALLN(1,VARREF(Ynew),7,VARREF(Yx8rSastYLregular_applicationG),VARREF(Yx8rSastYapplication_function),ff_,VARREF(Yx8rSastYapplication_arguments),eeTF1627,VARREF(Yx8rSastYapplication_tailQ),tailQ_);
  T0 = T4;
UNLINK_STACK();
  RET(T0);
}
...
FUNCODEDEF(fun_process_nary_closed_application_258) {
  ...
  P oF1633;
  P vTF1632;
  P gather_argumentsF1631;
  P pack_nary_argsF1630;
...
loop:
  ...
  pack_nary_argsF1630 = T1;
  T2 = FUNSHELL(1,fun_gather_arguments_257,4);
  gather_argumentsF1631 = T2;
  FUNINIT(pack_nary_argsF1630, 1,pack_nary_argsF1630);
  FUNINIT(gather_argumentsF1631, 4,pack_nary_argsF1630,r_,f_,gather_argumentsF1631);
  T4 = CALL1(1,VARREF(Yx8rSastYfunction_bindings),f_);
  vTF1632 = T4;
  T7 = CALL1(1,VARREF(Yx8rSastYfunction_specs),f_);
  T8 = CALL2(0,gather_argumentsF1631,eT_,vTF1632);
  T9 = CALL1(1,VARREF(Yx8rSastYfunction_body),f_);
  T6 = CALLN(1,VARREF(Ynew),9,VARREF(Yx8rSastYLfix_letG),VARREF(Yx8rSastYfix_let_bindings),vTF1632,VARREF(Yx8rSastYfix_let_types),T7,VARREF(Yx8rSastYfix_let_arguments),T8,VARREF(Yx8rSastYfix_let_body),T9);
  oF1633 = T6;
  T10 = CALL1(1,VARREF(YgooScolsSseqYlast),vTF1632);
...
loop:
  ...
  opF1634 = T1;
  T3 = CALL1(1,VARREF(Yx8rSsyntaxYsexpr_variableQ),opF1634);
  if (T3 != YPfalse) {
    T7 = CALL1(1,VARREF(Yx8rSsyntaxYsexpr_fab_setter_name),opF1634);
...
loop:
  ...
  valF1636 = T3;
  T4 = CALL2(1,VARREF(Yx8rSastYobjectify_assignment_using),refF1635,valF1636);
  T2 = T4;
  T0 = T2;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  existing_bindingF1638 = T1;
  T3 = CALL1(1,VARREF(Yx8rSastYfind_static_global_environment),r_);
  grF1639 = T3;
  T5 = CALL1(1,VARREF(Yx8rSastYenvironment_module),grF1639);
  modF1640 = T5;
  if (existing_bindingF1638 != YPfalse) {
    T11 = CALL2(1,VARREF(Yx8rSastYbinding_native_toQ),existing_bindingF1638,modF1640);
    tmpF1641 = T11;
    if (tmpF1641 != YPfalse) {
      T12 = tmpF1641;
    } else {
    ...
    foreignQF1642 = T9;
    T13 = CALL1(1,VARREF(Yx8rSastYbinding_freeQ),existing_bindingF1638);
    if (T13 != YPfalse) {
      CALL2(1,VARREF(Yx8rSastYbinding_freeQ_setter),YPfalse,existing_bindingF1638);
      if (foreignQF1642 != YPfalse) {
        T15 = CALL1(1,VARREF(Yx8rSastYtransaction_register_implemented_binding),existing_bindingF1638);
        T14 = T15;
      } else {
        T14 = YPfalse;
      }
      ...
      if (foreignQF1642 != YPfalse) {
        T18 = CALL1(1,VARREF(Yx8rSastYmodule_name),modF1640);
        T19 = CALL1(1,VARREF(Yx8rSastYbinding_module_name),existing_bindingF1638);
        T17 = CALLN(1,VARREF(YgooSruntimeYmsg),5,VARREF(YgooSioSportYout),LITREF(lit_325),T18,name_,T19);
        T16 = T17;
      } else {
        T16 = YPfalse;
      }
    }
    CALL2(1,VARREF(Yx8rSdependencyYinvalidate_dependents),existing_bindingF1638,VARREF(Yx8rSdependencyYDall_dependency_types));
    CALL2(1,VARREF(Yx8rSastYupdate_binding_kind),existing_bindingF1638,kind_);
    T8 = existing_bindingF1638;
    T7 = T8;
  } else {
    T22 = CALL1(1,VARREF(Yx8rSastYfind_environment_module),r_);
    T21 = CALL1(1,VARREF(Yx8rSastYmodule_name),T22);
    mod_nameF1643 = T21;
    T24 = CALLN(1,VARREF(Ynew),9,VARREF(Yx8rSastYLmodule_bindingG),VARREF(Yx8rSastYbinding_kind),kind_,VARREF(Yx8rSastYbinding_name),name_,VARREF(Yx8rSastYbinding_freeQ),YPfalse,VARREF(Yx8rSastYbinding_module_name),mod_nameF1643);
    bindingF1644 = T24;
    CALL2(1,VARREF(Yx8rSastYinsert_globalX),bindingF1644,grF1639);
    T23 = bindingF1644;
    T20 = T23;
    T7 = T20;
  }
...
loop:
  ...
  nameF1646 = T1;
  T3 = CALL4(1,VARREF(Yx8rSastYast_define_binding),r_,nameF1646,YPfalse,LITREF(lit_40));
  bindingF1647 = T3;
  T6 = CALL3(1,VARREF(Yx8rSastYobjectify),e_,r_,YPfalse);
  T5 = CALLN(1,VARREF(Ynew),5,VARREF(Yx8rSastYLdefinitionG),VARREF(Yx8rSastYassignment_binding),bindingF1647,VARREF(Yx8rSastYassignment_form),T6);
  defnF1648 = T5;
  T4 = defnF1648;
  T2 = T4;
  T0 = T2;
...
loop:
  if (VARREF(Yx8rSastYTmacro_tracingQT) != YPfalse) {
    CALL2(1,VARREF(YgooSruntimeYmsg),VARREF(YgooSioSportYout),LITREF(lit_333));
    CALL2(1,VARREF(YgooSioSwriteYwrite),VARREF(YgooSioSportYout),x_);
    T0 = CALL2(1,VARREF(YgooSruntimeYmsg),VARREF(YgooSioSportYout),LITREF(lit_334));
  } else {
  }
  ...
  expF1649 = T2;
  if (VARREF(Yx8rSastYTmacro_tracingQT) != YPfalse) {
    CALL2(1,VARREF(YgooSruntimeYmsg),VARREF(YgooSioSportYout),LITREF(lit_335));
    CALL2(1,VARREF(YgooSioSwriteYwrite),VARREF(YgooSioSportYout),expF1649);
    T4 = CALL2(1,VARREF(YgooSruntimeYmsg),VARREF(YgooSioSportYout),LITREF(lit_336));
  } else {
  }
  T1 = expF1649;
UNLINK_STACK();
...
loop:
  ...
  expandF1650 = T1;
  FUNINIT(expandF1650, 1,expander_);
  tmpF1651 = env_or_false_;
  if (tmpF1651 != YPfalse) {
    T4 = tmpF1651;
  } else {
  ...
  T3 = T4;
  envF1652 = T3;
  T7 = CALL4(1,VARREF(Yx8rSastYast_define_binding),envF1652,name_,YPfalse,LITREF(lit_284));
  bindingF1653 = T7;
  CALL2(1,VARREF(Yx8rSastYbinding_handler_setter),expandF1650,bindingF1653);
  T6 = bindingF1653;
  T2 = T6;
  T0 = T2;
UNLINK_STACK();
...
loop:
  ...
  sep_expanderF1654 = T1;
  T3 = CALL1(1,VARREF(Yx8rSastYfind_syntax_environment),r_);
  syntax_envF1655 = T3;
  T5 = CALL3(1,VARREF(Yx8rSastYobjectify),sep_expanderF1654,syntax_envF1655,YPfalse);
  ast_expanderF1656 = T5;
  T7 = CALL1(1,VARREF(Yx8rSastYast_evaluate),ast_expanderF1656);
  expanderF1657 = T7;
  ...
  T12 = CALL4(1,VARREF(YPPmacro),modnameF1658,name_,expanderF1657,T13);
  bindingF1659 = T12;
  T15 = CALL1(1,VARREF(Yx8rSastYfind_static_global_environment),r_);
  T14 = CALL2(1,VARREF(YgooSmathYNEE),syntax_envF1655,T15);
  if (T14 != YPfalse) {
    T16 = CALL2(1,VARREF(Yx8rSastYinsert_globalX),bindingF1659,syntax_envF1655);
  } else {
  }
  if (rtQ_ != YPfalse) {
    T19 = CALL3(1,VARREF(Yx8rSastYobjectify),sep_expanderF1654,r_,YPfalse);
    T18 = CALLN(1,VARREF(Ynew),5,VARREF(Yx8rSastYLast_macro_definitionG),VARREF(Yx8rSastYassignment_binding),bindingF1659,VARREF(Yx8rSastYassignment_form),T19);
    T17 = T18;
  } else {
...
loop:
  ...
  T3 = CALL3(1,VARREF(Yx8rSastYobjectify),e_,r_,YPfalse);
  fF1661 = T3;
  CALL2(1,VARREF(Yx8rSastYfunction_binding_setter),bindingF1660,fF1661);
  T4 = CALL2(1,VARREF(Yx8rSastYobjectify_quotation),name_,r_);
  CALL2(1,VARREF(Yx8rSastYfunction_debug_name_setter),T4,fF1661);
  T6 = CALLN(1,VARREF(Ynew),5,VARREF(Yx8rSastYLast_function_definitionG),VARREF(Yx8rSastYassignment_binding),bindingF1660,VARREF(Yx8rSastYassignment_form),fF1661);
  defnF1662 = T6;
  T5 = defnF1662;
  T2 = T5;
  T0 = T2;
...
loop:
  ...
  signatureF1664 = T3;
  T6 = CALL1(1,VARREF(Yx8rSastYsignature_bindings),signatureF1664);
  T5 = CALL2(1,VARREF(Yx8rSastYr_extendT),r_,T6);
  new_rF1665 = T5;
  T8 = CALL3(1,VARREF(Yx8rSastYobjectify_sequential),body_,new_rF1665,YPtrue);
  bodyF1666 = T8;
  T11 = CALL2(1,VARREF(Yx8rSastYobjectify_quotation),name_,r_);
  T10 = CALLN(1,VARREF(Ynew),9,VARREF(Yx8rSastYLast_primitiveG),VARREF(Yx8rSastYfunction_binding),bindingF1663,VARREF(Yx8rSastYfunction_debug_name),T11,VARREF(Yx8rSastYfunction_signature),signatureF1664,VARREF(Yx8rSastYfunction_body),bodyF1666);
  formF1667 = T10;
  T13 = CALLN(1,VARREF(Ynew),5,VARREF(Yx8rSastYLast_primitive_definitionG),VARREF(Yx8rSastYassignment_binding),bindingF1663,VARREF(Yx8rSastYassignment_form),formF1667);
  defnF1668 = T13;
  T12 = defnF1668;
  T9 = T12;
  T7 = T9;
...
loop:
  ...
  T5 = CALLN(1,VARREF(Ynew),7,VARREF(Yx8rSastYLast_genericG),VARREF(Yx8rSastYfunction_binding),bindingF1669,VARREF(Yx8rSastYfunction_debug_name),T6,VARREF(Yx8rSastYfunction_signature),signatureF1670);
  formF1671 = T5;
  T8 = CALLN(1,VARREF(Ynew),5,VARREF(Yx8rSastYLast_generic_definitionG),VARREF(Yx8rSastYassignment_binding),bindingF1669,VARREF(Yx8rSastYassignment_form),formF1671);
  defnF1672 = T8;
  T7 = defnF1672;
  T4 = T7;
  T2 = T4;
...
loop:
  ...
  T6 = CALL3(1,VARREF(Yx8rSastYobjectify),e_,r_,YPfalse);
  metF1675 = T6;
  T8 = CALL3(1,VARREF(Ylst),LITREF(lit_348),genF1674,metF1675);
  callF1676 = T8;
  T10 = CALL3(1,VARREF(Yx8rSastYobjectify),callF1676,r_,YPfalse);
  formF1677 = T10;
  T12 = CALLN(1,VARREF(Ynew),5,VARREF(Yx8rSastYLast_method_definitionG),VARREF(Yx8rSastYassignment_binding),bindingF1673,VARREF(Yx8rSastYassignment_form),formF1677);
  defnF1678 = T12;
  CALL2(1,VARREF(Yx8rSastYfunction_binding_setter),name_,metF1675);
  T13 = CALL2(1,VARREF(Yx8rSastYobjectify_quotation),name_,r_);
  CALL2(1,VARREF(Yx8rSastYfunction_debug_name_setter),T13,metF1675);
  T11 = defnF1678;
  T9 = T11;
  T7 = T9;
  T5 = T7;
...
loop:
  ...
  tmpF1679 = VARREF(Yx8rSastYTrecord_sourceQT);
  if (tmpF1679 != YPfalse) {
    ...
    T3 = CALL3(1,VARREF(YgooSruntimeYmsg_to_str),LITREF(lit_350),FREEREF(0),T4);
    T2 = T3;
  } else {
    T2 = YPfalse;
  }
...
loop:
  ...
  x_1434F1680 = VARREF(YgooSioSwriteYTmax_print_lengthT);
  T2 = FUNFAB(fun_276,3,FREEREF(0),FREEREF(1),FREEREF(2));
  T3 = FUNFAB(fun_277,1,x_1434F1680);
...
LINK_STACK();
  ...
  ARG(r_, 2);
loop:
  x_1433F1681 = VARREF(YgooSioSwriteYTmax_print_depthT);
  T2 = FUNFAB(fun_278,3,sig_,body_,r_);
  T3 = FUNFAB(fun_279,1,x_1433F1681);
  T1 = with_cleanup(T2,T3);
  T0 = T1;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  signatureF1682 = T1;
  T4 = CALL1(1,VARREF(Yx8rSastYsignature_bindings),signatureF1682);
  T3 = CALL2(1,VARREF(Yx8rSastYr_extendT),FREEREF(1),T4);
  new_rF1683 = T3;
  T6 = CALL3(1,VARREF(Yx8rSastYobjectify_sequential),FREEREF(2),new_rF1683,YPtrue);
  bF1684 = T6;
  ...
  CALL2(1,VARREF(Yx8rSastYfunction_signature_setter),signatureF1682,FREEREF(3));
  CALL2(1,VARREF(Yx8rSastYfunction_body_setter),bF1684,FREEREF(3));
...
loop:
  ...
  methodF1685 = T1;
  x_1435F1686 = VARREF(Yx8rSastYTcurrent_dependentT);
  VARSET(Yx8rSastYTcurrent_dependentT,methodF1685);
  T4 = FUNFAB(fun_281,4,sig_,r_,body_,methodF1685);
  T5 = FUNFAB(fun_282,1,x_1435F1686);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    T18 = CALL3(1,VARREF(Yx8rSastYobjectify),arityF1690,FREEREF(1),YPfalse);
    T13 = CALLN(1,VARREF(Ynew),13,VARREF(Yx8rSastYLast_signatureG),VARREF(Yx8rSastYsignature_bindings),T14,VARREF(Yx8rSastYsignature_names),T15,VARREF(Yx8rSastYsignature_specs),T16,VARREF(Yx8rSastYsignature_naryQ),T17,VARREF(Yx8rSastYsignature_arity),T18,VARREF(Yx8rSastYsignature_value),valueF1689);
    T9 = T13;
    T4 = T9;
    T2 = T4;
    T0 = T2;
    ...
    paramF1691 = T20;
    T22 = CALL1(1,VARREF(Yx8rSsyntaxYsexpr_variable_name),paramF1691);
    snameF1692 = T22;
    T24 = CALL1(1,VARREF(Yx8rSsyntaxYsexpr_variable_type),paramF1691);
    stypeF1693 = T24;
    T26 = CALL2(1,VARREF(YgooSmacrosYEE),stypeF1693,VARREF(Yx8rSastYDsexpr_optionals_tag));
    dottedQF1694 = T26;
    if (dottedQF1694 != YPfalse) {
      T28 = VARREF(Yx8rSastYDsexpr_optionals_type_name);
    } else {
      T28 = stypeF1693;
    }
    stypeF1695 = T28;
    T30 = CALL3(1,VARREF(Yx8rSastYobjectify),stypeF1695,FREEREF(1),YPfalse);
    typeF1696 = T30;
    T32 = CALL2(1,VARREF(Yx8rSastYobjectify_quotation),snameF1692,FREEREF(1));
    nameF1697 = T32;
    T34 = CALLN(1,VARREF(Ynew),7,VARREF(Yx8rSastYLlocal_bindingG),VARREF(Yx8rSastYbinding_name),snameF1692,VARREF(Yx8rSastYbinding_type),typeF1696,VARREF(Yx8rSastYbinding_dottedQ),dottedQF1694);
    bindingF1698 = T34;
    T36 = CALL1(1,VARREF(Ytail),params_);
    T37 = CALL2(1,VARREF(YgooSmacrosYpair),bindingF1698,bindings_);
    T38 = CALLN(1,VARREF(Ynew),5,VARREF(Yx8rSastYLfab_listG),VARREF(Yhead),nameF1697,VARREF(Ytail),names_);
    T39 = CALLN(1,VARREF(Ynew),5,VARREF(Yx8rSastYLfab_listG),VARREF(Yhead),typeF1696,VARREF(Ytail),types_);
    a1 = T36;
    a2 = dottedQF1694;
    a3 = T37;
    a4 = T38;
...
loop:
  ...
  sexpr_paramsF1699 = T1;
  T3 = FUNSHELL(1,fun_col_284,3);
  colF1700 = T3;
  FUNINIT(colF1700, 3,sig_,r_,colF1700);
  ...
  T4 = CALLN(0,colF1700,5,sexpr_paramsF1699,YPfalse,Ynil,T5,T6);
  T2 = T4;
  T0 = T2;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    findF1701 = T3;
    FUNINIT(findF1701, 5,FREEREF(0),i_,r_,FREEREF(1),findF1701);
    T5 = CALL1(1,VARREF(Yx8rSastYenvironment_bindings),r_);
    T4 = CALL2(0,findF1701,YPint((P)0),T5);
    T2 = T4;
    T0 = T2;
  } else {
...
loop:
  ...
  loopF1702 = T1;
  FUNINIT(loopF1702, 2,loopF1702,binding_);
  T2 = CALL2(0,loopF1702,YPint((P)0),r_);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  tup29F1703 = T1;
  T3 = CALL2(1,VARREF(YgooSmacrosYelt),tup29F1703,YPint((P)0));
  iF1704 = T3;
  T5 = CALL2(1,VARREF(YgooSmacrosYelt),tup29F1703,YPint((P)1));
  jF1705 = T5;
  T6 = CALLN(1,VARREF(Ynew),7,VARREF(Yx8rSastYLlocal_referenceG),VARREF(Yx8rSastYreference_binding),b_,VARREF(Yx8rSastYreference_frame_number),iF1704,VARREF(Yx8rSastYreference_frame_offset),jF1705);
  T4 = T6;
  T2 = T4;
  T0 = T2;
UNLINK_STACK();
...
loop:
  ...
  x_1436F1706 = T1;
  x_1437F1707 = VARREF(YgooSmacrosYEE);
  T4 = CALL2(1,x_1437F1707,x_1436F1706,LITREF(lit_40));
  if (T4 != YPfalse) {
    T3 = VARREF(Yx8rSastYLglobal_referenceG);
  } else {
    T6 = CALL2(1,x_1437F1707,x_1436F1706,LITREF(lit_343));
    if (T6 != YPfalse) {
      T5 = VARREF(Yx8rSastYLpredefined_referenceG);
    } else {
      T8 = CALL2(1,x_1437F1707,x_1436F1706,LITREF(lit_319));
      if (T8 != YPfalse) {
...
loop:
  T1 = CALL1(1,VARREF(Yx8rSastYbinding_kind),b_);
  x_1438F1708 = T1;
  x_1439F1709 = VARREF(YgooSmacrosYEE);
  T5 = CALL2(1,x_1439F1709,x_1438F1708,LITREF(lit_283));
  tmpF1710 = T5;
  if (tmpF1710 != YPfalse) {
    T6 = tmpF1710;
  } else {
    T7 = CALL2(1,x_1439F1709,x_1438F1708,LITREF(lit_284));
    T6 = T7;
  }
  T4 = T6;
  if (T4 != YPfalse) {
    ...
    LrefGF1711 = T9;
    T10 = CALL3(1,VARREF(Ynew),LrefGF1711,VARREF(Yx8rSastYreference_binding),b_);
    T8 = T10;
    T3 = T8;
  }
  T2 = T3;
...
loop:
  ...
  grF1712 = T1;
  T4 = CALL1(1,VARREF(Yx8rSastYenvironment_allows_foreign_namesQ),grF1712);
  tmpF1713 = T4;
  if (tmpF1713 != YPfalse) {
  ...
  if (T3 != YPfalse) {
    ...
    bF1714 = T9;
    CALL2(1,VARREF(Yx8rSastYinsert_globalX),bF1714,grF1712);
    T12 = CALL3(1,VARREF(Ynew),VARREF(Yx8rSastYLglobal_referenceG),VARREF(Yx8rSastYreference_binding),bF1714);
    T8 = T12;
    T2 = T8;
  }
  T0 = T2;
...
loop:
  ...
  namestrF1715 = T1;
  T3 = CALL2(1,VARREF(YgooScolsSseqYpos),namestrF1715,YPchr((P)58));
  breakF1716 = T3;
  T5 = CALL3(1,VARREF(YgooScolsSseqYsub),namestrF1715,YPint((P)0),breakF1716);
  modnameF1717 = T5;
  T8 = CALL2(1,VARREF(YgooSmathYA),YPint((P)1),breakF1716);
  T9 = CALL1(1,VARREF(YgooStypesYlen),namestrF1715);
  T7 = CALL3(1,VARREF(YgooScolsSseqYsub),namestrF1715,T8,T9);
  varnameF1718 = T7;
  T13 = CALL1(1,VARREF(YgooStypesYlen),modnameF1717);
  T12 = CALL2(1,VARREF(YgooSmagYG),T13,YPint((P)0));
  tmpF1719 = T12;
  if (tmpF1719 != YPfalse) {
    T16 = CALL1(1,VARREF(YgooStypesYlen),varnameF1718);
  ...
  grF1720 = T19;
  T21 = CALL1(1,VARREF(Yx8rSastYenvironment_module_loader),grF1720);
  loaderF1721 = T21;
  T24 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLsymG),modnameF1717);
  T23 = CALL2(1,VARREF(Yx8rSastYprobe_module),loaderF1721,T24);
  modF1722 = T23;
  T27 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLsymG),varnameF1718);
  T28 = CALL1(1,VARREF(Yx8rSastYmodule_target_environment),modF1722);
  T26 = CALL2(1,VARREF(Yx8rSastYfind_binding),T27,T28);
  bindingF1723 = T26;
  CALL2(1,VARREF(Yx8rSastYinsert_globalX),bindingF1723,grF1720);
  T29 = CALL1(1,VARREF(Ynot),bindingF1723);
  if (T29 != YPfalse) {
    T30 = CALL3(1,VARREF(Yerror),LITREF(lit_377),varnameF1718,modnameF1717);
  } else {
  }
  T31 = CALL3(1,VARREF(Yx8rSastYobjectify_binding),name_,bindingF1723,r_);
  T25 = T31;
  T22 = T25;
  T20 = T22;
  T18 = T20;
...
loop:
  ...
  bindingsF1724 = T1;
  T4 = CALL2(1,VARREF(Yx8rSastYr_extendT),r_,bindingsF1724);
  new_rF1725 = T4;
  T6 = CALL3(1,VARREF(YgooScolsScolYmap2),VARREF(Yx8rSsyntaxYsexpr_make_anonymous_method),sigs_,bodies_);
  function_formsF1726 = T6;
  T9 = CALL3(1,VARREF(YgooSruntimeYrcurry),VARREF(Yx8rSastYobjectify),new_rF1725,YPfalse);
  T8 = CALL2(1,VARREF(YgooSmacrosYmap),T9,function_formsF1726);
  functionsF1727 = T8;
  T10 = FUNFAB(fun_305,1,r_);
  CALL3(1,VARREF(YgooScolsScolYdo2),T10,functionsF1727,bindingsF1724);
  T12 = CALL4(1,VARREF(YgooSmacrosYnapp),VARREF(YgooSmathYfabs),YPfalse,VARREF(Yx8rSastYLfunctionsG),functionsF1727);
  T13 = CALL3(1,VARREF(Yx8rSastYobjectify_sequential),body_,new_rF1725,YPtrue);
  T11 = CALLN(1,VARREF(Ynew),7,VARREF(Yx8rSastYLlocalsG),VARREF(Yx8rSastYlocals_bindings),bindingsF1724,VARREF(Yx8rSastYlocals_functions),T12,VARREF(Yx8rSastYlocals_body),T13);
  T7 = T11;
  T5 = T7;
  T3 = T5;
  T0 = T3;
...
loop:
  ...
  bindingF1728 = T1;
  T3 = CALL2(1,VARREF(YgooSmacrosYEE),bindingF1728,YPfalse);
  if (T3 != YPfalse) {
    T5 = FUNFAB(fun_313,1,name_);
    T4 = with_exit(T5);
    T2 = T4;
  } else {
    T6 = CALL3(1,VARREF(Yx8rSastYexport_bindingX),FREEREF(1),name_,bindingF1728);
    T2 = T6;
  }
  T0 = T2;
UNLINK_STACK();
...
loop:
  ...
  moduleF1730 = T3;
  T6 = CALL1(1,VARREF(Yx8rSastYmodule_target_environment),moduleF1730);
  T5 = CALL2(1,VARREF(YgooSmacrosYEE),envF1729,T6);
  T4 = CALL1(1,VARREF(Ynot),T5);
  if (T4 != YPfalse) {
    T7 = CALL1(1,VARREF(Yerror),LITREF(lit_396));
  } else {
  }
  T8 = FUNFAB(fun_314,2,envF1729,moduleF1730);
...
loop:
  ...
  existingF1731 = T1;
  T5 = CALL2(1,VARREF(YgooSmacrosYEE),existingF1731,YPfalse);
  tmpF1732 = T5;
  if (tmpF1732 != YPfalse) {
    T6 = tmpF1732;
  } else {
    T7 = CALL2(1,VARREF(YgooSmacrosYEE),existingF1731,b_);
    T6 = T7;
  }
  T4 = T6;
...
loop:
  ...
  T3 = CALL1(1,VARREF(Yx8rSastYfind_environment_module),r_);
  moduleF1734 = T3;
  T5 = CALL1(1,VARREF(Yx8rSastYenvironment_module_loader),envF1733);
  loaderF1735 = T5;
  T7 = CALL2(1,VARREF(Yx8rSastYprobe_module),loaderF1735,name_);
  used_moduleF1736 = T7;
  T8 = CALL1(1,VARREF(Yx8rSastYenvironment_uses_modules),envF1733);
  CALL2(1,VARREF(YgooScolsSseqxYpushX),T8,used_moduleF1736);
  T9 = FUNFAB(fun_317,2,envF1733,moduleF1734);
  T10 = CALL1(1,VARREF(Yx8rSastYmodule_exports),used_moduleF1736);
...
loop:
  T1 = CALL1(1,VARREF(Yx8rSastYfind_static_global_environment),r_);
  envF1737 = T1;
  T3 = CALL1(1,VARREF(Yx8rSastYenvironment_module_loader),envF1737);
  loaderF1738 = T3;
  T5 = CALL2(1,VARREF(Yx8rSastYprobe_module),loaderF1738,name_);
  used_moduleF1739 = T5;
  T6 = CALL1(1,VARREF(Yx8rSastYenvironment_uses_modules),envF1737);
  CALL2(1,VARREF(YgooScolsSseqxYpushX),T6,used_moduleF1739);
  T7 = FUNFAB(fun_319,1,envF1737);
  T8 = CALL1(1,VARREF(Yx8rSastYmodule_exports),used_moduleF1739);
...
loop:
  ...
  patF1740 = T1;
  T3 = CALL1(1,VARREF(Yx8rSsyntaxYsexpr_bind_pattern_variables),patF1740);
  varsF1741 = T3;
  ...
  T40 = CALL1(1,VARREF(Ylst),elseF1744);
  ...
  T48 = CALL1(1,VARREF(Ylst),varF1745);
  T49 = CALL1(1,VARREF(Ylst),valueF1742);
  ...
  T55 = fun_329;
  T54 = CALL2(1,VARREF(YgooSmacrosYmap),T55,varsF1741);
  T53 = CALL1(1,VARREF(Ylst),T54);
  T56 = CALL1(1,VARREF(Ylst),epatF1747);
  T57 = CALL1(1,VARREF(Ylst),thenF1743);
...
loop:
  ...
  rF1748 = T1;
  T3 = CALL1(1,VARREF(Yx8rSastYenvironment_bindings),rF1748);
...
loop:
  ...
  loopF1749 = T1;
  FUNINIT(loopF1749, 3,name_,r_,loopF1749);
  T3 = CALL1(1,VARREF(Yx8rSastYenvironment_bindings),r_);
  T2 = CALL1(0,loopF1749,T3);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  x_1443F1751 = T1;
  FUNINIT(x_1443F1751, 1,return_);
  x_1442F1752 = FREEREF(0);
  nameF1753 = YPfalse;
  nameF1753 = BOXFAB(nameF1753);
  paramsF1754 = YPfalse;
  paramsF1754 = BOXFAB(paramsF1754);
  bodyF1755 = YPfalse;
  bodyF1755 = BOXFAB(bodyF1755);
  T9 = CALL2(1,VARREF(YisaQ),x_1442F1752,VARREF(YLlstG));
  if (T9 != YPfalse) {
    T11 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1442F1752,LITREF(lit_435),x_1443F1751);
    x_1442F1756 = T11;
    T13 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1442F1756,x_1443F1751);
    BOXVAL(nameF1753) = T13;
    T14 = CALL1(1,VARREF(Ytail),x_1442F1756);
    x_1442F1757 = T14;
    T16 = CALL2(1,VARREF(YgooSmacrosYmatch_sublist),x_1442F1757,x_1443F1751);
    x_1442F1758 = T16;
    BOXVAL(paramsF1754) = x_1442F1758;
    x_1442F1759 = Ynil;
    T18 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1442F1759,x_1443F1751);
    T17 = T18;
    T19 = CALL1(1,VARREF(Ytail),x_1442F1757);
    x_1442F1760 = T19;
    BOXVAL(bodyF1755) = x_1442F1760;
    x_1442F1761 = Ynil;
    T21 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1442F1761,x_1443F1751);
    T20 = T21;
    T15 = T20;
    T12 = T15;
    T10 = T12;
  } else {
    T22 = CALL2(1,x_1443F1751,LITREF(lit_7),x_1442F1752);
  }
  T25 = BOXVAL(nameF1753);
  T24 = CALL2(1,VARREF(YgooSmacrosYcat_sym),LITREF(lit_436),T25);
  special_nameF1762 = T24;
  T28 = BOXVAL(nameF1753);
  ...
  T34 = CALL1(1,VARREF(Ylst),special_nameF1762);
  ...
  T45 = CALL1(1,VARREF(Ylst),sexpr_nameF1763);
...
loop:
  ...
  tup30F1764 = T1;
  T3 = CALL2(1,VARREF(YgooSmacrosYelt),tup30F1764,YPint((P)0));
  typeF1765 = T3;
  T5 = CALL2(1,VARREF(YgooSmacrosYelt),tup30F1764,YPint((P)1));
  infoF1766 = T5;
  T7 = CALL2(1,VARREF(YgooSmacrosYelt),tup30F1764,YPint((P)2));
  testF1767 = T7;
  T9 = CALL2(1,VARREF(YgooSmacrosYelt),tup30F1764,YPint((P)3));
  handlerF1768 = T9;
  T11 = CALL2(1,VARREF(YgooSmacrosYelt),tup30F1764,YPint((P)4));
  bodyF1769 = T11;
  T12 = CALLN(1,VARREF(Yx8rSastYobjectify_monitor),7,typeF1765,infoF1766,testF1767,handlerF1768,bodyF1769,r_,tailQ_);
  T10 = T12;
  T8 = T10;
  T6 = T8;
  T4 = T6;
...
loop:
  ...
  T7 = CALL1(1,VARREF(Yx8rSsyntaxYsexpr_isa_init_props),prop_initsF1770);
  T6 = CALL1(1,VARREF(Yx8rSastYpairize),T7);
  T9 = CALL1(1,VARREF(Yx8rSsyntaxYsexpr_isa_init_values),prop_initsF1770);
...
loop:
  ...
  T8 = CALL1(1,VARREF(Ylst),nameF1771);
  ...
  T2 = CALL3(1,VARREF(Yx8rSastYobjectify_definition),nameF1771,T3,r_);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  ownerF1774 = T5;
  T7 = CALL1(1,VARREF(Yx8rSsyntaxYsexpr_fab_setter_name),nameF1772);
  setter_nameF1775 = T7;
  T9 = CALL1(1,VARREF(Yx8rSsyntaxYsexpr_prop_type),x_);
  typeF1776 = T9;
  T13 = CALL2(1,VARREF(Yx8rSsyntaxYsexpr_fab_getter),nameF1772,ownerF1774);
  T14 = CALL3(1,VARREF(Yx8rSsyntaxYsexpr_fab_setter),nameF1772,ownerF1774,typeF1776);
  T18 = CALL1(1,VARREF(Yx8rSsyntaxYsexpr_prop_initQ),x_);
  if (T18 != YPfalse) {
    T23 = CALL1(1,VARREF(Ylst),varF1773);
  ...
  T16 = CALLN(1,VARREF(Ylst),5,ownerF1774,nameF1772,setter_nameF1775,typeF1776,T17);
...
loop:
  ...
  mF1777 = T1;
  T5 = CALL2(1,VARREF(YisaQ),mF1777,VARREF(Yx8rSastYLmodule_bindingG));
  tmpF1778 = T5;
  if (tmpF1778 != YPfalse) {
    T8 = CALL1(1,VARREF(Yx8rSastYbinding_kind),mF1777);
  ...
  T4 = T6;
  if (T4 != YPfalse) {
    T11 = CALL1(1,VARREF(Yx8rSastYbinding_handler),mF1777);
...
FUNCODEDEF(Yx8rSastYmerge_transactionsX) {
  P t1_,t2_;
  P t2_dependentsF1784;
  P t1_dependentsF1783;
  P t2_bindingsF1782;
  P t1_bindingsF1781;
  P T14,T13,T12,T11,T10,T9,T8,T7,T6,T5,T4,T3,T2,T1,T0;
  P a1,a2;
  ...
  if (T1 != YPfalse) {
    ...
    if (T3 != YPfalse) {
      ...
      if (YPtrue != YPfalse) {
        ...
        t1_dependentsF1783 = T10;
        T12 = CALL1(1,VARREF(Yx8rSastYtransaction_dependents),t2_);
        t2_dependentsF1784 = T12;
        T13 = FUNFAB(fun_392,1,t1_bindingsF1781);
        CALL2(1,VARREF(YgooScolsScolYdo_keyed),T13,t2_bindingsF1782);
        T14 = FUNFAB(fun_393,1,t1_dependentsF1783);
        CALL2(1,VARREF(YgooScolsScolYdo_keyed),T14,t2_dependentsF1784);
        T11 = t1_;
        T9 = T11;
        T7 = T9;
        T5 = T7;
...
LINK_STACK();
  ...
  ARG(thunk_, 1);
loop:
  successF1786 = YPfalse;
  successF1786 = BOXFAB(successF1786);
  savedF1787 = VARREF(Yx8rSastYTcurrent_subtransactionT);
  T4 = FUNFAB(fun_398,2,thunk_,successF1786);
  T5 = FUNFAB(fun_399,3,successF1786,module_,savedF1787);
  T3 = with_cleanup(T4,T5);
  T2 = T3;
  T0 = T2;
UNLINK_STACK();
...
loop:
  ...
  x_1447F1788 = T1;
  FUNINIT(x_1447F1788, 1,return_);
  x_1446F1789 = FREEREF(0);
  moduleF1790 = YPfalse;
  moduleF1790 = BOXFAB(moduleF1790);
  bodyF1791 = YPfalse;
  bodyF1791 = BOXFAB(bodyF1791);
  T7 = CALL2(1,VARREF(YisaQ),x_1446F1789,VARREF(YLlstG));
  if (T7 != YPfalse) {
    T9 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1446F1789,LITREF(lit_503),x_1447F1788);
    x_1446F1792 = T9;
    T11 = CALL2(1,VARREF(YgooSmacrosYmatch_sublist),x_1446F1792,x_1447F1788);
    x_1446F1793 = T11;
    T13 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1446F1793,x_1447F1788);
    BOXVAL(moduleF1790) = T13;
    T14 = CALL1(1,VARREF(Ytail),x_1446F1793);
    x_1446F1794 = T14;
    T15 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1446F1794,x_1447F1788);
    T12 = T15;
    T16 = CALL1(1,VARREF(Ytail),x_1446F1792);
    x_1446F1795 = T16;
    BOXVAL(bodyF1791) = x_1446F1795;
    x_1446F1796 = Ynil;
    T18 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1446F1796,x_1447F1788);
    T17 = T18;
    T10 = T17;
    T8 = T10;
  } else {
    T19 = CALL2(1,x_1447F1788,LITREF(lit_7),x_1446F1789);
  }
  T21 = CALL1(1,VARREF(Ylst),LITREF(lit_499));
  T23 = BOXVAL(moduleF1790);
  T22 = CALL1(1,VARREF(Ylst),T23);
  T26 = CALL1(1,VARREF(Ylst),LITREF(lit_441));
  T27 = CALL1(1,VARREF(Ylst),Ynil);
  T28 = BOXVAL(bodyF1791);
...
LINK_STACK();
loop:
  x_1449F1798 = FREEREF(0);
  T3 = CALL1(1,VARREF(Yx8rSastYmodule_loader_stack),x_1449F1798);
  T2 = CALL1(1,VARREF(YgooScolsSseqxYpopX),T3);
  tup31F1799 = T2;
  T5 = CALL2(1,VARREF(YgooSmacrosYelt),tup31F1799,YPint((P)0));
  x_1450F1800 = T5;
  T7 = CALL2(1,VARREF(YgooSmacrosYelt),tup31F1799,YPint((P)1));
  x_1451F1801 = T7;
  CALL2(1,VARREF(Yx8rSastYmodule_loader_stack_setter),x_1450F1800,x_1449F1798);
  T6 = x_1451F1801;
  T4 = T6;
  T1 = T4;
  T0 = T1;
...
loop:
  ...
  stackF1802 = T1;
  T3 = CALL1(1,VARREF(YgooStypesYlen),stackF1802);
  depthF1803 = T3;
  T5 = CALL2(1,VARREF(YgooScolsSstrYstring_repeat),LITREF(lit_537),depthF1803);
  indentF1804 = T5;
  T6 = CALL2(1,VARREF(YgooScolsScolYmemQ),stackF1802,name_);
  if (T6 != YPfalse) {
    T8 = CALL1(1,VARREF(Yhead),stackF1802);
    T7 = CALL3(1,VARREF(Yerror),LITREF(lit_538),T8,name_);
  } else {
  }
  CALL4(1,VARREF(YgooSruntimeYmsg),VARREF(YgooSioSportYout),LITREF(lit_539),indentF1804,name_);
  x_1448F1805 = loader_;
  T12 = CALL1(1,VARREF(Yx8rSastYmodule_loader_stack),x_1448F1805);
  T11 = CALL2(1,VARREF(YgooScolsSseqxYpushX),T12,name_);
  T10 = CALL2(1,VARREF(Yx8rSastYmodule_loader_stack_setter),T11,x_1448F1805);
  T14 = FUNFAB(fun_437,2,loader_,name_);
  T15 = FUNFAB(fun_438,1,loader_);
  T13 = with_cleanup(T14,T15);
  modF1806 = T13;
  CALL2(1,VARREF(Yx8rSastYregister_moduleX),loader_,modF1806);
  CALL3(1,VARREF(YgooSruntimeYmsg),VARREF(YgooSioSportYout),LITREF(lit_540),indentF1804);
  T9 = modF1806;
  T4 = T9;
  T2 = T4;
  T0 = T2;
...
loop:
  ...
  exportsF1807 = T1;
  T3 = CALL3(1,VARREF(YgooScolsScolYelt_or),exportsF1807,name_,YPfalse);
  existingF1808 = T3;
  T6 = CALL2(1,VARREF(YgooSmacrosYEE),existingF1808,YPfalse);
  tmpF1809 = T6;
  if (tmpF1809 != YPfalse) {
    T7 = tmpF1809;
  } else {
    T8 = CALL2(1,VARREF(YgooSmacrosYEE),existingF1808,binding_);
    T7 = T8;
  }
  T5 = T7;
  T4 = CALL1(1,VARREF(Ynot),T5);
  if (T4 != YPfalse) {
    T9 = CALLN(1,VARREF(Yerror),5,LITREF(lit_543),existingF1808,binding_,module_,name_);
  } else {
  }
  CALL3(1,VARREF(YgooScolsScolxYelt_setter),binding_,exportsF1807,name_);
  T2 = YPfalse;
  T0 = T2;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    T5 = CALL4(1,VARREF(YgooSruntimeYmsg),VARREF(YgooSioSportYout),LITREF(lit_546),T6,T7);
    T0 = T5;
  } else {
    T0 = YPfalse;
  }
...
loop:
  ...
  add_userF1812 = T3;
  FUNINIT(add_userF1812, 3,usersF1811,add_userF1812,loader_);
  CALL2(1,VARREF(YgooSmacrosYdo),add_userF1812,modnames_);
  collector_F1813 = Ynil;
  collector_F1813 = BOXFAB(collector_F1813);
  T6 = FUNFAB(fun_447,1,collector_F1813);
  CALL2(1,VARREF(YgooSmacrosYdo),T6,usersF1811);
  T8 = BOXVAL(collector_F1813);
...
loop:
  ...
  modF1814 = T1;
  T3 = CALL2(1,VARREF(Yx8rSastYremove_module_internalX),FREEREF(0),modF1814);
  T0 = T3;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  remove_namesF1815 = T1;
  T2 = FUNFAB(fun_450,1,loader_);
  CALL2(1,VARREF(YgooSmacrosYdo),T2,remove_namesF1815);
  T0 = YPfalse;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  namestrF1816 = T1;
  T4 = CALL2(1,VARREF(YgooScolsSstrYstring_split),namestrF1816,YPchr((P)47));
...
loop:
  ...
  bootmodF1817 = T1;
  T3 = CALL1(1,VARREF(Yx8rSastYmodule_target_environment),bootmodF1817);
  bootenvF1818 = T3;
  T5 = FUNFAB(fun_453,2,bootenvF1818,env_);
...
loop:
  ...
  loaderF1820 = T1;
  T4 = CALL3(1,VARREF(Yx8rSastYfab_static_global_environment),module_,loaderF1820,YPfalse);
  new_envF1821 = T4;
  T5 = FUNFAB(fun_456,2,excluded_,new_envF1821);
...
loop:
  ...
  typeF1822 = T1;
  T3 = CALL3(1,VARREF(Ynew),typeF1822,VARREF(Yx8rSastYmodule_name),name_);
  moduleF1823 = T3;
  T5 = CALL3(1,VARREF(Yx8rSastYfab_static_global_environment),moduleF1823,loader_,YPfalse);
  envF1824 = T5;
  keepmodQF1825 = YPfalse;
  keepmodQF1825 = BOXFAB(keepmodQF1825);
  T9 = CALL1(1,VARREF(Yx8rSastYmodule_name_to_relpath),name_);
  fileF1826 = T9;
  T12 = CALL1(1,VARREF(YgooSsystemYgoo_filename),fileF1826);
  T11 = CALL1(1,VARREF(YgooSsystemYadd_src_path),T12);
  src_fileF1827 = T11;
  CALL3(1,VARREF(Yx8rSastYset_module_environments),moduleF1823,envF1824,envF1824);
  CALL2(1,VARREF(Yx8rSastYinstall_initial_bindings),envF1824,loader_);
  x_1452F1828 = VARREF(Yx8rSastYTnow_rt_envT);
  T15 = FUNFAB(fun_460,4,envF1824,src_fileF1827,keepmodQF1825,moduleF1823);
  T16 = FUNFAB(fun_461,1,x_1452F1828);
...
loop:
  ...
  moduleF1829 = T1;
  CALL1(1,VARREF(Yx8rSastYensure_module_data),moduleF1829);
  T2 = CALL1(1,VARREF(Yx8rSastYmodule_target_environment),moduleF1829);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  T1 = CALL0(1,VARREF(Yx8rSastYruntime_module_loader));
  loaderF1830 = T1;
  T5 = CALL1(1,VARREF(Yx8rSastYmodule_loader_stack),loaderF1830);
...
loop:
  T1 = CALL0(1,VARREF(Yx8rSastYruntime_module_loader));
  loaderF1831 = T1;
  T3 = CALL1(1,VARREF(Yx8rSastYmodule_loader_module_type),loaderF1831);
  typeF1832 = T3;
  T6 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLsymG),modname_);
  T5 = CALL3(1,VARREF(Ynew),typeF1832,VARREF(Yx8rSastYmodule_name),T6);
  modF1833 = T5;
  T8 = CALL3(1,VARREF(Yx8rSastYfab_static_global_environment),modF1833,loaderF1831,YPtrue);
  envF1834 = T8;
  CALL2(1,VARREF(Yx8rSastYmodule_data_processedQ_setter),YPfalse,modF1833);
  CALL3(1,VARREF(Yx8rSastYset_module_environments),modF1833,envF1834,envF1834);
  CALL2(1,VARREF(Yx8rSastYmodule_runtime_data_setter),data_,modF1833);
  CALL2(1,VARREF(Yx8rSastYregister_moduleX),loaderF1831,modF1833);
  T7 = modF1833;
  T4 = T7;
  T2 = T4;
  T0 = T2;
...
loop:
  ...
  T3 = CALL2(1,VARREF(Yx8rSastYfind_binding),T4,home_envF1835);
  bindingF1836 = T3;
  T5 = CALL1(1,VARREF(Ynot),bindingF1836);
  if (T5 != YPfalse) {
  ...
  T9 = CALL2(1,VARREF(Yx8rSastYinsert_globalX),bindingF1836,T10);
  T2 = T9;
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
...
loop:
  ...
  T4 = CALL2(1,VARREF(Yx8rSastYinsert_globalX),bindingF1837,T5);
  T0 = T4;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  bindingF1838 = T1;
  T5 = CALL1(1,VARREF(Yx8rSastYmodule_target_environment),mod_);
  T4 = CALL2(1,VARREF(Yx8rSastYinsert_globalX),bindingF1838,T5);
  T0 = T4;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  bindingF1839 = T1;
  if (bindingF1839 != YPfalse) {
    T6 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLsymG),as_name_);
    T5 = CALL3(1,VARREF(Yx8rSastYexport_bindingX),mod_,T6,bindingF1839);
    T4 = T5;
  } else {
    T8 = CALL1(1,VARREF(Yx8rSastYmodule_name),mod_);
...
loop:
  ...
  T3 = CALL2(1,VARREF(Yx8rSastYbinding_handler_setter),T4,cloneF1840);
  T0 = T3;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  bootmodF1841 = T1;
  T4 = CALL1(1,VARREF(Yx8rSastYmodule_target_environment),bootmodF1841);
  bootenvF1842 = T4;
  CALL1(1,VARREF(Yx8rSastYinstall_magic_bindings),bootenvF1842);
  CALL0(1,VARREF(Yx8rSastYreload_macros));
  CALL1(1,VARREF(Yx8rSastYinstall_interpreter_hacks),bootenvF1842);
  T3 = YPfalse;
  T0 = T3;
UNLINK_STACK();
  QRET(T0);
...
loop:
  T1 = CALL1(1,VARREF(Yx8rSastYmodule_loader_module_type),loader_);
  typeF1843 = T1;
  T3 = CALL3(1,VARREF(Ynew),typeF1843,VARREF(Yx8rSastYmodule_name),name_);
  moduleF1844 = T3;
  T5 = CALL1(1,VARREF(Yx8rSastYfab_syntax_environment),moduleF1844);
  syntax_envF1845 = T5;
  T7 = CALL3(1,VARREF(Yx8rSastYfab_static_global_environment),moduleF1844,loader_,YPfalse);
  target_envF1846 = T7;
  CALL3(1,VARREF(Yx8rSastYset_module_environments),moduleF1844,syntax_envF1845,target_envF1846);
  T8 = CALL2(1,VARREF(YgooSmacrosYEE),name_,VARREF(Yx8rSastYDgoo_boot_module_name));
  if (T8 != YPfalse) {
    T9 = CALL1(1,VARREF(Yx8rSastYinit_g2c_boot_environment),target_envF1846);
  } else {
    T10 = CALL2(1,VARREF(Yx8rSastYinit_g2c_regular_environment),target_envF1846,loader_);
  }
  T6 = moduleF1844;
  T4 = T6;
  T2 = T4;
...
loop:
  ...
  loopF1847 = T1;
  FUNINIT(loopF1847, 2,f_,loopF1847);
  T2 = CALL1(0,loopF1847,env_);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  loopF1848 = T1;
  FUNINIT(loopF1848, 2,f_,loopF1848);
  T2 = CALL1(0,loopF1848,env_);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
