...
loop:
  ...
  varF2363 = T1;
  T3 = CALL2(1,VARREF(YisaQ),varF2363,VARREF(YLlstG));
  if (T3 != YPfalse) {
    T4 = CALL1(1,VARREF(Yhead),varF2363);
    T2 = T4;
  } else {
    T2 = varF2363;
  }
...
loop:
  T1 = CALL1(1,VARREF(YgooSmacrosY2nd),defn_);
  varF2364 = T1;
  T3 = CALL2(1,VARREF(YisaQ),varF2364,VARREF(YLlstG));
  if (T3 != YPfalse) {
    T4 = CALL1(1,VARREF(Ytail),varF2364);
    T2 = T4;
  } else {
    T2 = Ynil;
  }
...
loop:
  ...
  values_spec_indexF2365 = T1;
  if (values_spec_indexF2365 != YPfalse) {
    T3 = CALL3(1,VARREF(YgooScolsSseqYsub),signature_,YPint((P)0),values_spec_indexF2365);
    T2 = T3;
  } else {
    T2 = signature_;
  }
...
loop:
  T1 = CALL2(1,VARREF(YgooScolsSseqYpos),signature_,LITREF(lit_60));
  values_spec_indexF2366 = T1;
  tmpF2367 = values_spec_indexF2366;
  if (tmpF2367 != YPfalse) {
    T6 = CALL2(1,VARREF(YgooSmathYA),values_spec_indexF2366,YPint((P)1));
    T5 = CALL2(1,VARREF(YgooSmacrosYelt),signature_,T6);
    valueF2368 = T5;
    T8 = CALL2(1,VARREF(YevalSsyntaxYsexpr_tagged_listQ),valueF2368,LITREF(lit_66));
    if (T8 != YPfalse) {
      T10 = CALL1(1,VARREF(Ylst),LITREF(lit_67));
      T12 = CALL1(1,VARREF(Ytail),valueF2368);
...
LINK_STACK();
  ...
  NARGS(args_, 1);
loop:
  T1 = CALL2(1,VARREF(Ysyntax_error),LITREF(lit_128),FREEREF(0));
...
loop:
  ...
  x_1419F2369 = T1;
  FUNINIT(x_1419F2369, 2,FREEREF(0),return_);
  x_1418F2370 = FREEREF(0);
  optionsF2371 = YPfalse;
  optionsF2371 = BOXFAB(optionsF2371);
  handlerF2372 = YPfalse;
  handlerF2372 = BOXFAB(handlerF2372);
  bodyF2373 = YPfalse;
  bodyF2373 = BOXFAB(bodyF2373);
  T9 = CALL2(1,VARREF(YisaQ),x_1418F2370,VARREF(YLlstG));
  if (T9 != YPfalse) {
    T11 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1418F2370,LITREF(lit_120),x_1419F2369);
    x_1418F2374 = T11;
    T13 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1418F2374,x_1419F2369);
    BOXVAL(optionsF2371) = T13;
    T14 = CALL1(1,VARREF(Ytail),x_1418F2374);
    x_1418F2375 = T14;
    T16 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1418F2375,x_1419F2369);
    BOXVAL(handlerF2372) = T16;
    T17 = CALL1(1,VARREF(Ytail),x_1418F2375);
    x_1418F2376 = T17;
    BOXVAL(bodyF2373) = x_1418F2376;
    x_1418F2377 = Ynil;
    T19 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1418F2377,x_1419F2369);
    T18 = T19;
    T15 = T18;
    T12 = T15;
    T10 = T12;
  } else {
    T20 = CALL2(1,x_1419F2369,LITREF(lit_129),x_1418F2370);
  }
  T24 = BOXVAL(optionsF2371);
  T23 = CALL2(1,VARREF(YisaQ),T24,VARREF(YLsymG));
  if (T23 != YPfalse) {
    T28 = CALL1(1,VARREF(Ylst),LITREF(lit_130));
    T30 = BOXVAL(optionsF2371);
    ...
    T31 = BOXVAL(optionsF2371);
    T22 = T31;
  }
  optionsF2378 = T22;
  T33 = CALL1(1,VARREF(YevalSsyntaxYsexpr_monitor_type),optionsF2378);
  T34 = CALL1(1,VARREF(YevalSsyntaxYsexpr_monitor_info),optionsF2378);
  T35 = CALL1(1,VARREF(YevalSsyntaxYsexpr_monitor_test),optionsF2378);
  T36 = BOXVAL(handlerF2372);
  T38 = BOXVAL(bodyF2373);
...
LINK_STACK();
  ...
  NARGS(args_, 1);
loop:
  T1 = CALL2(1,VARREF(Ysyntax_error),LITREF(lit_139),FREEREF(0));
  T0 = CALL1(1,FREEREF(1),T1);
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  x_1421F2379 = T1;
  FUNINIT(x_1421F2379, 2,FREEREF(0),return_);
  x_1420F2380 = FREEREF(0);
  typeF2381 = YPfalse;
  typeF2381 = BOXFAB(typeF2381);
  T5 = CALL2(1,VARREF(YisaQ),x_1420F2380,VARREF(YLlstG));
  if (T5 != YPfalse) {
    T7 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1420F2380,x_1421F2379);
    BOXVAL(typeF2381) = T7;
    T8 = CALL1(1,VARREF(Ytail),x_1420F2380);
    x_1420F2382 = T8;
    T9 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1420F2382,x_1421F2379);
    T6 = T9;
  } else {
    T10 = CALL2(1,x_1421F2379,LITREF(lit_129),x_1420F2380);
  }
  T11 = BOXVAL(typeF2381);
  T3 = T11;
  T2 = T3;
  T0 = T2;
UNLINK_STACK();
...
LINK_STACK();
  ARG(options_, 0);
loop:
  T1 = CALL3(1,VARREF(YevalSsyntaxYfind_option),options_,LITREF(lit_130),LITREF(lit_135));
  type_listF2383 = T1;
  T3 = FUNFAB(fun_59,1,type_listF2383);
  T2 = with_exit(T3);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
...
LINK_STACK();
  ...
  NARGS(args_, 1);
loop:
  T1 = CALL2(1,VARREF(Ysyntax_error),LITREF(lit_148),FREEREF(0));
  T0 = CALL1(1,FREEREF(1),T1);
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  x_1423F2384 = T1;
  FUNINIT(x_1423F2384, 2,FREEREF(0),return_);
  x_1422F2385 = FREEREF(0);
  info_exprF2386 = YPfalse;
  info_exprF2386 = BOXFAB(info_exprF2386);
  T5 = CALL2(1,VARREF(YisaQ),x_1422F2385,VARREF(YLlstG));
  if (T5 != YPfalse) {
    T7 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1422F2385,x_1423F2384);
    BOXVAL(info_exprF2386) = T7;
    T8 = CALL1(1,VARREF(Ytail),x_1422F2385);
    x_1422F2387 = T8;
    T9 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1422F2387,x_1423F2384);
    T6 = T9;
  } else {
    T10 = CALL2(1,x_1423F2384,LITREF(lit_129),x_1422F2385);
  }
  T11 = BOXVAL(info_exprF2386);
  T3 = T11;
  T2 = T3;
  T0 = T2;
UNLINK_STACK();
...
loop:
  ...
  x_1425F2388 = T1;
  FUNINIT(x_1425F2388, 2,FREEREF(0),return_);
  x_1424F2389 = FREEREF(0);
  messageF2390 = YPfalse;
  messageF2390 = BOXFAB(messageF2390);
  argumentsF2391 = YPfalse;
  argumentsF2391 = BOXFAB(argumentsF2391);
  T7 = CALL2(1,VARREF(YisaQ),x_1424F2389,VARREF(YLlstG));
  if (T7 != YPfalse) {
    T9 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1424F2389,x_1425F2388);
    BOXVAL(messageF2390) = T9;
    T10 = CALL1(1,VARREF(Ytail),x_1424F2389);
    x_1424F2392 = T10;
    BOXVAL(argumentsF2391) = x_1424F2392;
    x_1424F2393 = Ynil;
    T12 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1424F2393,x_1425F2388);
    T11 = T12;
    T8 = T11;
  } else {
    T13 = CALL2(1,x_1425F2388,LITREF(lit_129),x_1424F2389);
  }
  T15 = CALL1(1,VARREF(Ylst),LITREF(lit_153));
  T16 = CALL1(1,VARREF(Ylst),LITREF(lit_154));
  T17 = CALL1(1,VARREF(Ylst),LITREF(lit_155));
  T19 = BOXVAL(messageF2390);
  T18 = CALL1(1,VARREF(Ylst),T19);
  T20 = CALL1(1,VARREF(Ylst),LITREF(lit_156));
  T23 = CALL1(1,VARREF(Ylst),LITREF(lit_157));
  T24 = BOXVAL(argumentsF2391);
...
LINK_STACK();
  ARG(options_, 0);
loop:
  T1 = CALL3(1,VARREF(YevalSsyntaxYfind_option),options_,LITREF(lit_142),YPfalse);
  infoF2394 = T1;
  T3 = CALL3(1,VARREF(YevalSsyntaxYfind_option),options_,LITREF(lit_143),YPfalse);
  descriptionF2395 = T3;
  tmpF2396 = infoF2394;
  if (tmpF2396 != YPfalse) {
    T6 = descriptionF2395;
  ...
  T5 = T6;
  if (T5 != YPfalse) {
    T7 = CALL2(1,VARREF(Ysyntax_error),LITREF(lit_144),options_);
    T4 = T7;
  } else {
    if (infoF2394 != YPfalse) {
      T10 = FUNFAB(fun_62,1,infoF2394);
      T9 = with_exit(T10);
      T8 = T9;
    } else {
      if (descriptionF2395 != YPfalse) {
        T13 = FUNFAB(fun_64,1,descriptionF2395);
        T12 = with_exit(T13);
        T11 = T12;
      } else {
        if (YPtrue != YPfalse) {
...
LINK_STACK();
  ARG(options_, 0);
loop:
  T1 = CALL3(1,VARREF(YevalSsyntaxYfind_option),options_,LITREF(lit_161),LITREF(lit_162));
  test_bodyF2397 = T1;
  T2 = CALL2(1,VARREF(YevalSsyntaxYsexpr_make_anonymous_method),Ynil,test_bodyF2397);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    nameF2399 = T4;
    T7 = CALL2(1,VARREF(YisaQ),nameF2399,VARREF(YLlstG));
    tmpF2400 = T7;
    if (tmpF2400 != YPfalse) {
      T11 = CALL1(1,VARREF(Ytail),nameF2399);
      T10 = CALL1(1,VARREF(Yhead),T11);
      T9 = CALL2(1,VARREF(YgooSmacrosYEE),T10,LITREF(lit_223));
      T8 = T9;
    } else {
      T8 = YPfalse;
    }
    T6 = T8;
    if (T6 != YPfalse) {
      T15 = CALL1(1,VARREF(Yhead),nameF2399);
      T14 = CALL2(1,VARREF(Ylst),T15,LITREF(lit_224));
      T13 = CALL2(1,VARREF(YgooSmacrosYpair),T14,rtnames_);
      T18 = CALL2(1,VARREF(Ylst),LITREF(lit_226),FREEREF(0));
      T17 = CALL4(1,VARREF(Ylst),LITREF(lit_225),FREEREF(0),index_,T18);
      ...
      T22 = CALL2(1,VARREF(YgooSmacrosYpair),nameF2399,rtnames_);
      T24 = CALL3(1,VARREF(Ylst),LITREF(lit_227),FREEREF(0),index_);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    valueF2402 = T8;
    T11 = CALL2(1,VARREF(YisaQ),nameF2401,VARREF(YLlstG));
    tmpF2403 = T11;
    if (tmpF2403 != YPfalse) {
      T14 = CALL1(1,VARREF(Yhead),nameF2401);
    ...
    T10 = T12;
    if (T10 != YPfalse) {
      T16 = CALL1(1,VARREF(YevalSsyntaxYsexpr_unique_name),LITREF(lit_220));
      tupnameF2404 = T16;
      T19 = FUNSHELL(1,fun_inner_93,2);
      innerF2405 = T19;
      FUNINIT(innerF2405, 2,tupnameF2404,innerF2405);
      T21 = CALL1(1,VARREF(Ylst),tupnameF2404);
      T22 = CALL1(1,VARREF(Ylst),valueF2402);
      T23 = CALL1(1,VARREF(Ytail),nameF2401);
      T20 = CALL4(0,innerF2405,T21,T22,YPint((P)0),T23);
      T18 = T20;
      tup27F2406 = T18;
      T25 = CALL2(1,VARREF(YgooSmacrosYelt),tup27F2406,YPint((P)0));
      rtnamesF2407 = T25;
      T27 = CALL2(1,VARREF(YgooSmacrosYelt),tup27F2406,YPint((P)1));
      rtvaluesF2408 = T27;
      T29 = CALL2(1,VARREF(YgooSmacrosYcat),rtnamesF2407,rnames_);
      T30 = CALL2(1,VARREF(YgooSmacrosYcat),rtvaluesF2408,rvalues_);
      ...
      T34 = CALL2(1,VARREF(YgooSmacrosYpair),nameF2401,rnames_);
      T35 = CALL2(1,VARREF(YgooSmacrosYpair),valueF2402,rvalues_);
...
loop:
  ...
  loopF2409 = T1;
  FUNINIT(loopF2409, 1,loopF2409);
  T2 = CALL4(0,loopF2409,Ynil,Ynil,names_,vals_);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  bodyF2412 = T5;
  T7 = CALL2(1,VARREF(YevalSsyntaxYsexpr_let_namesAvalues),onamesF2410,ovaluesF2411);
  tup28F2413 = T7;
  T9 = CALL2(1,VARREF(YgooSmacrosYelt),tup28F2413,YPint((P)0));
  namesF2414 = T9;
  T11 = CALL2(1,VARREF(YgooSmacrosYelt),tup28F2413,YPint((P)1));
  valuesF2415 = T11;
  T13 = FUNSHELL(1,fun_col_96,2);
  colF2416 = T13;
  FUNINIT(colF2416, 2,bodyF2412,colF2416);
  T14 = CALL2(0,colF2416,namesF2414,valuesF2415);
  T12 = T14;
  T10 = T12;
  T8 = T10;
  T6 = T8;
...
loop:
  ...
  sigF2417 = T1;
  T4 = fun_107;
  T5 = CALL1(1,VARREF(YevalSsyntaxYsexpr_signature_parameters),sigF2417);
  T3 = CALL2(1,VARREF(YgooSmacrosYmap),T4,T5);
  T7 = CALL1(1,VARREF(YevalSsyntaxYsexpr_signature_value),sigF2417);
  if (T7 != YPfalse) {
    T6 = Ynil;
  } else {
  ...
  T10 = CALL1(1,VARREF(YevalSsyntaxYsexpr_signature_value),sigF2417);
  T9 = CALL1(1,VARREF(Ylst),T10);
...
loop:
  ...
  initsF2421 = T7;
  T11 = CALL2(1,VARREF(Ylst),nameF2418,sigF2419);
  T10 = CALL2(1,VARREF(YgooSmacrosYcat),T11,bodyF2420);
  T9 = CALL1(1,VARREF(Ylst),T10);
  T13 = CALL1(1,VARREF(Ylst),nameF2418);
  T12 = CALL2(1,VARREF(YgooSmacrosYcat),T13,initsF2421);
...
loop:
  ...
  paramF2422 = T1;
  T4 = CALL2(1,VARREF(YisaQ),paramF2422,VARREF(YLlstG));
  if (T4 != YPfalse) {
    T5 = CALL1(1,VARREF(YgooSmacrosY2nd),paramF2422);
    T3 = T5;
  } else {
    T3 = paramF2422;
  }
...
loop:
  ...
  T1 = CALL1(1,VARREF(YgooSmacrosY1st),T2);
  paramF2423 = T1;
  T4 = CALL2(1,VARREF(YisaQ),paramF2423,VARREF(YLlstG));
  if (T4 != YPfalse) {
    T5 = CALL1(1,VARREF(YgooSmacrosY1st),paramF2423);
    T3 = T5;
  } else {
    T3 = LITREF(lit_286);
  }
...
LINK_STACK();
  ...
  ARG(type_, 1);
loop:
  T2 = CALL2(1,VARREF(Ylst),LITREF(lit_286),type_);
  T1 = CALL1(1,VARREF(Ylst),T2);
  T4 = CALL3(1,VARREF(Ylst),LITREF(lit_295),LITREF(lit_286),name_);
...
loop:
  ...
  T3 = CALL2(1,VARREF(Ylst),LITREF(lit_298),prop_type_);
  T4 = CALL2(1,VARREF(Ylst),LITREF(lit_286),type_);
  T2 = CALL2(1,VARREF(Ylst),T3,T4);
  T6 = CALL4(1,VARREF(Ylst),LITREF(lit_299),LITREF(lit_298),LITREF(lit_286),name_);
...
loop:
  ...
  T1 = CALL2(1,VARREF(YgooSmacrosYcat),T2,LITREF(lit_302));
  T0 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLsymG),T1);
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  T0 = CALL2(1,VARREF(YevalSsyntaxYeval),T1,LITREF(lit_320));
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  raw_resultF2424 = T1;
  T3 = CALL1(1,VARREF(YevalSsyntaxYbq_remove_tokens),raw_resultF2424);
  resF2425 = T3;
  T2 = resF2425;
  T0 = T2;
UNLINK_STACK();
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    if (T7 != YPfalse) {
      ...
      if (T8 != YPfalse) {
        T12 = CALL2(1,VARREF(Ysyntax_error),LITREF(lit_340),p_);
      } else {
      }
    ...
    if (T19 != YPfalse) {
      T21 = CALL2(1,VARREF(Ysyntax_error),LITREF(lit_341),p_);
    } else {
    }
...
loop:
  ...
  loopF2427 = T1;
  FUNINIT(loopF2427, 2,return_,loopF2427);
  T2 = CALL2(0,loopF2427,FREEREF(0),Ynil);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
    ...
    if (T4 != YPfalse) {
      ...
      if (T10 != YPfalse) {
        ...
        if (T14 != YPfalse) {
          ...
          T15 = CALL2(1,VARREF(Ysyntax_error),LITREF(lit_337),T16);
          T13 = T15;
        } else {
          if (YPtrue != YPfalse) {
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    T11 = CALL2(1,VARREF(YgooSmathYE),aF2428,T12);
    tmpF2430 = T11;
    if (tmpF2430 != YPfalse) {
      T15 = CALL1(1,VARREF(Ytail),x_);
      T14 = CALL2(1,VARREF(YgooSmathYE),dF2429,T15);
      T13 = T14;
    } else {
      T13 = YPfalse;
    }
    ...
    if (T10 != YPfalse) {
      ...
      T16 = CALL2(1,VARREF(YgooSmacrosYpair),aF2428,dF2429);
      T9 = T16;
    }
    T6 = T9;
    T3 = T6;
            ...
            if (T11 != YPfalse) {
              ...
              if (T13 != YPfalse) {
                ...
                if (T19 != YPfalse) {
                  ...
                  T33 = CALL2(1,VARREF(YgooSmacrosYpair),LITREF(lit_351),T34);
                  T18 = T33;
                } else {
                  if (YPtrue != YPfalse) {
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    xF2435 = T7;
    T9 = CALL1(1,VARREF(YevalSsyntaxYsexpr_pattern_variableQ),xF2435);
    if (T9 != YPfalse) {
      T11 = CALL1(1,VARREF(YevalSsyntaxYsexpr_pattern_variable_name),xF2435);
...
loop:
  ...
  colF2436 = T2;
  FUNINIT(colF2436, 1,colF2436);
  T3 = CALL1(0,colF2436,pat_);
  T1 = T3;
...
loop:
  ...
  T6 = CALL1(1,VARREF(Ylst),LITREF(lit_372));
  ...
  T11 = CALL1(1,VARREF(Ylst),LITREF(lit_371));
  T5 = CALL4(1,VARREF(YgooSmacrosYcat),T6,T7,T11,Ynil);
  T1 = CALL4(1,VARREF(YevalSsyntaxYsexpr_make_syntax_if),T2,LITREF(lit_371),T3,T5);
  mifF2437 = T1;
  T14 = CALL1(1,VARREF(Ylst),LITREF(lit_371));
  T15 = CALL1(1,VARREF(Ylst),mifF2437);
...
P YevalSsyntaxY___main_0___() {
  ...
  P T240,T241,T242,T243,T244,T245,T246,T247,T248,T249;
DEFCREGS();
loop:
  ...
  fun_sexpr_tagged_listQ_2 = YPmet(FUNCODEREF(fun_sexpr_tagged_listQ_2),LITREF(lit_4),T10,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_quotedQ_3 = YPmet(FUNCODEREF(fun_sexpr_quotedQ_3),LITREF(lit_7),T15,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_make_quote_4 = YPmet(FUNCODEREF(fun_sexpr_make_quote_4),LITREF(lit_9),T20,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_text_of_quotation_5 = YPmet(FUNCODEREF(fun_sexpr_text_of_quotation_5),LITREF(lit_11),T25,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_assignmentQ_6 = YPmet(FUNCODEREF(fun_sexpr_assignmentQ_6),LITREF(lit_14),T30,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_assignment_variable_7 = YPmet(FUNCODEREF(fun_sexpr_assignment_variable_7),LITREF(lit_16),T35,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_assignment_value_8 = YPmet(FUNCODEREF(fun_sexpr_assignment_value_8),LITREF(lit_18),T40,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_variable_name_9 = YPmet(FUNCODEREF(fun_sexpr_variable_name_9),LITREF(lit_20),T45,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_variable_name_10 = YPmet(FUNCODEREF(fun_sexpr_variable_name_10),LITREF(lit_20),T50,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_variable_type_11 = YPmet(FUNCODEREF(fun_sexpr_variable_type_11),LITREF(lit_23),T55,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_variable_type_12 = YPmet(FUNCODEREF(fun_sexpr_variable_type_12),LITREF(lit_23),T60,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_definitionQ_13 = YPmet(FUNCODEREF(fun_sexpr_definitionQ_13),LITREF(lit_28),T65,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_definition_variable_14 = YPmet(FUNCODEREF(fun_sexpr_definition_variable_14),LITREF(lit_31),T70,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_definition_value_15 = YPmet(FUNCODEREF(fun_sexpr_definition_value_15),LITREF(lit_33),T75,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_syntax_definitionQ_16 = YPmet(FUNCODEREF(fun_sexpr_syntax_definitionQ_16),LITREF(lit_36),T80,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_syntax_definition_variable_17 = YPmet(FUNCODEREF(fun_sexpr_syntax_definition_variable_17),LITREF(lit_39),T85,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_syntax_definition_value_18 = YPmet(FUNCODEREF(fun_sexpr_syntax_definition_value_18),LITREF(lit_41),T90,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_function_definitionQ_19 = YPmet(FUNCODEREF(fun_sexpr_function_definitionQ_19),LITREF(lit_44),T95,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_method_definitionQ_20 = YPmet(FUNCODEREF(fun_sexpr_method_definitionQ_20),LITREF(lit_47),T100,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_generic_definitionQ_21 = YPmet(FUNCODEREF(fun_sexpr_generic_definitionQ_21),LITREF(lit_50),T105,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_function_definition_variable_22 = YPmet(FUNCODEREF(fun_sexpr_function_definition_variable_22),LITREF(lit_52),T110,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_function_definition_adjectives_23 = YPmet(FUNCODEREF(fun_sexpr_function_definition_adjectives_23),LITREF(lit_54),T115,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_forward_primitiveQ_24 = YPmet(FUNCODEREF(fun_sexpr_forward_primitiveQ_24),LITREF(lit_56),T120,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_signature_parameters_25 = YPmet(FUNCODEREF(fun_sexpr_signature_parameters_25),LITREF(lit_58),T125,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_value_type_26 = YPmet(FUNCODEREF(fun_sexpr_value_type_26),LITREF(lit_61),T130,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_value_type_27 = YPmet(FUNCODEREF(fun_sexpr_value_type_27),LITREF(lit_61),T135,ENVNUL,PNUL,YPfalse);
  ...
  fun_sexpr_signature_value_28 = YPmet(FUNCODEREF(fun_sexpr_signature_value_28),LITREF(lit_64),T140,ENVNUL,PNUL,YPfalse);
  ...
  lit_68 = YPPsym((P)"as-signature");
  lit_69 = YPPlist(1,YPPsym((P)"sig"));
  T145 = YPsig(LITREF(lit_69),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  YevalSsyntaxYas_signature = YPmet(FUNCODEREF(YevalSsyntaxYas_signature),LITREF(lit_68),T145,ENVNUL,PNUL,YPfalse);
  T146 = YevalSsyntaxYas_signature;
  VARSET(YevalSsyntaxYas_signature,T146);
  lit_70 = YPPsym((P)"sexpr-function-signature");
  lit_71 = YPPlist(1,YPPsym((P)"defn"));
  T147 = YPsig(LITREF(lit_71),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_function_signature_30 = YPmet(FUNCODEREF(fun_sexpr_function_signature_30),LITREF(lit_70),T147,ENVNUL,PNUL,YPfalse);
  ...
  lit_72 = YPPsym((P)"sexpr-function-parameters");
  lit_73 = YPPlist(1,YPPsym((P)"defn"));
  T152 = YPsig(LITREF(lit_73),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_function_parameters_31 = YPmet(FUNCODEREF(fun_sexpr_function_parameters_31),LITREF(lit_72),T152,ENVNUL,PNUL,YPfalse);
  ...
  lit_74 = YPPsym((P)"sexpr-function-value");
  lit_75 = YPPlist(1,YPPsym((P)"defn"));
  T157 = YPsig(LITREF(lit_75),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_function_value_32 = YPmet(FUNCODEREF(fun_sexpr_function_value_32),LITREF(lit_74),T157,ENVNUL,PNUL,YPfalse);
  ...
  lit_76 = YPPsym((P)"sexpr-function-body");
  lit_77 = YPPlist(1,YPPsym((P)"defn"));
  T162 = YPsig(LITREF(lit_77),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_function_body_33 = YPmet(FUNCODEREF(fun_sexpr_function_body_33),LITREF(lit_76),T162,ENVNUL,PNUL,YPfalse);
  ...
  lit_78 = YPPsym((P)"fun");
  VARSET(YevalSsyntaxYDsexpr_method_tag,LITREF(lit_78));
  lit_79 = YPPsym((P)"sexpr-function-definition-value");
  lit_80 = YPPlist(1,YPPsym((P)"defn"));
  T167 = YPsig(LITREF(lit_80),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_function_definition_value_34 = YPmet(FUNCODEREF(fun_sexpr_function_definition_value_34),LITREF(lit_79),T167,ENVNUL,PNUL,YPfalse);
  ...
  lit_81 = YPPsym((P)"sexpr-method?");
  lit_82 = YPPlist(1,YPPsym((P)"exp"));
  T172 = YPsig(LITREF(lit_82),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_methodQ_35 = YPmet(FUNCODEREF(fun_sexpr_methodQ_35),LITREF(lit_81),T172,ENVNUL,PNUL,YPfalse);
  ...
  lit_83 = YPPsym((P)"sexpr-method-signature");
  lit_84 = YPPlist(1,YPPsym((P)"method-exp"));
  T177 = YPsig(LITREF(lit_84),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_method_signature_36 = YPmet(FUNCODEREF(fun_sexpr_method_signature_36),LITREF(lit_83),T177,ENVNUL,PNUL,YPfalse);
  ...
  lit_85 = YPPsym((P)"sexpr-method-parameters");
  lit_86 = YPPlist(1,YPPsym((P)"method-exp"));
  T182 = YPsig(LITREF(lit_86),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_method_parameters_37 = YPmet(FUNCODEREF(fun_sexpr_method_parameters_37),LITREF(lit_85),T182,ENVNUL,PNUL,YPfalse);
  ...
  lit_87 = YPPsym((P)"sexpr-method-value");
  lit_88 = YPPlist(1,YPPsym((P)"method-exp"));
  T187 = YPsig(LITREF(lit_88),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_method_value_38 = YPmet(FUNCODEREF(fun_sexpr_method_value_38),LITREF(lit_87),T187,ENVNUL,PNUL,YPfalse);
  ...
  lit_89 = YPPsym((P)"sexpr-method-body");
  lit_90 = YPPlist(1,YPPsym((P)"method-exp"));
  T192 = YPsig(LITREF(lit_90),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_method_body_39 = YPmet(FUNCODEREF(fun_sexpr_method_body_39),LITREF(lit_89),T192,ENVNUL,PNUL,YPfalse);
  ...
  lit_91 = YPPsym((P)"sexpr-make-anonymous-method");
  lit_92 = YPPlist(2,YPPsym((P)"parameters"),YPPsym((P)"body"));
  T197 = YPsig(LITREF(lit_92),YPPlist(2,VARREF(YLlstG),VARREF(YLlstG)),YPfalse,YPint((P)2),VARREF(YLlstG),Ynil);
  fun_sexpr_make_anonymous_method_40 = YPmet(FUNCODEREF(fun_sexpr_make_anonymous_method_40),LITREF(lit_91),T197,ENVNUL,PNUL,YPfalse);
  ...
  lit_93 = YPPsym((P)"sexpr-make-method");
  lit_94 = YPPlist(3,YPPsym((P)"name"),YPPsym((P)"parameters"),YPPsym((P)"body"));
  T202 = YPsig(LITREF(lit_94),YPPlist(3,VARREF(YLanyG),VARREF(YLlstG),VARREF(YLlstG)),YPfalse,YPint((P)3),VARREF(YLlstG),Ynil);
  fun_sexpr_make_method_41 = YPmet(FUNCODEREF(fun_sexpr_make_method_41),LITREF(lit_93),T202,ENVNUL,PNUL,YPfalse);
  ...
  lit_95 = YPPsym((P)"if");
  VARSET(YevalSsyntaxYDsexpr_if_tag,LITREF(lit_95));
  lit_96 = YPPsym((P)"sexpr-if?");
  lit_97 = YPPlist(1,YPPsym((P)"exp"));
  T207 = YPsig(LITREF(lit_97),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_ifQ_42 = YPmet(FUNCODEREF(fun_sexpr_ifQ_42),LITREF(lit_96),T207,ENVNUL,PNUL,YPfalse);
  ...
  lit_98 = YPPsym((P)"sexpr-if-test");
  lit_99 = YPPlist(1,YPPsym((P)"exp"));
  T212 = YPsig(LITREF(lit_99),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_if_test_43 = YPmet(FUNCODEREF(fun_sexpr_if_test_43),LITREF(lit_98),T212,ENVNUL,PNUL,YPfalse);
  ...
  lit_100 = YPPsym((P)"sexpr-if-then");
  lit_101 = YPPlist(1,YPPsym((P)"exp"));
  T217 = YPsig(LITREF(lit_101),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_if_then_44 = YPmet(FUNCODEREF(fun_sexpr_if_then_44),LITREF(lit_100),T217,ENVNUL,PNUL,YPfalse);
  ...
  lit_102 = YPPsym((P)"sexpr-if-else");
  lit_103 = YPPlist(1,YPPsym((P)"exp"));
  T222 = YPsig(LITREF(lit_103),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_if_else_45 = YPmet(FUNCODEREF(fun_sexpr_if_else_45),LITREF(lit_102),T222,ENVNUL,PNUL,YPfalse);
  ...
  lit_104 = YPPsym((P)"sexpr-make-if");
  lit_105 = YPPlist(3,YPPsym((P)"test"),YPPsym((P)"then"),YPPsym((P)"else"));
  T227 = YPsig(LITREF(lit_105),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLlstG),Ynil);
  fun_sexpr_make_if_46 = YPmet(FUNCODEREF(fun_sexpr_make_if_46),LITREF(lit_104),T227,ENVNUL,PNUL,YPfalse);
  ...
  lit_106 = YPPsym((P)"esc");
  VARSET(YevalSsyntaxYDsexpr_bind_exit_tag,LITREF(lit_106));
  lit_107 = YPPsym((P)"sexpr-block?");
  lit_108 = YPPlist(1,YPPsym((P)"exp"));
  T232 = YPsig(LITREF(lit_108),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_blockQ_47 = YPmet(FUNCODEREF(fun_sexpr_blockQ_47),LITREF(lit_107),T232,ENVNUL,PNUL,YPfalse);
  ...
  lit_109 = YPPsym((P)"sexpr-block-name");
  lit_110 = YPPlist(1,YPPsym((P)"exp"));
  T237 = YPsig(LITREF(lit_110),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_block_name_48 = YPmet(FUNCODEREF(fun_sexpr_block_name_48),LITREF(lit_109),T237,ENVNUL,PNUL,YPfalse);
  T240 = BOUNDP(YevalSsyntaxYsexpr_block_name);
  if (T240 != YPfalse) {
    T239 = VARREF(YevalSsyntaxYsexpr_block_name);
  } else {
    T239 = YPfalse;
  }
  T241 = fun_sexpr_block_name_48;
  T238 = XCALL2(1,VARREF(YPdefine_method),T239,T241);
  VARSET(YevalSsyntaxYsexpr_block_name,T238);
  lit_111 = YPPsym((P)"sexpr-block-body");
  lit_112 = YPPlist(1,YPPsym((P)"exp"));
  T244 = YPsig(LITREF(lit_112),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  T243 = fun_sexpr_block_body_49 = YPmet(FUNCODEREF(fun_sexpr_block_body_49),LITREF(lit_111),T244,ENVNUL,PNUL,YPfalse);
  T248 = BOUNDP(YevalSsyntaxYsexpr_block_body);
  if (T248 != YPfalse) {
    T247 = VARREF(YevalSsyntaxYsexpr_block_body);
  } else {
    T247 = YPfalse;
  }
  T249 = fun_sexpr_block_body_49;
  T246 = XCALL2(1,VARREF(YPdefine_method),T247,T249);
  T245 = VARSET(YevalSsyntaxYsexpr_block_body,T246);
  T242 = T245;
  return T242;
}
...
loop:
  ...
  VARSET(YevalSsyntaxYDsexpr_unwind_protect_tag,LITREF(lit_113));
  lit_114 = YPPsym((P)"sexpr-unwind-protect?");
  lit_115 = YPPlist(1,YPPsym((P)"exp"));
  T0 = YPsig(LITREF(lit_115),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_unwind_protectQ_50 = YPmet(FUNCODEREF(fun_sexpr_unwind_protectQ_50),LITREF(lit_114),T0,ENVNUL,PNUL,YPfalse);
  T3 = BOUNDP(YevalSsyntaxYsexpr_unwind_protectQ);
  if (T3 != YPfalse) {
    T2 = VARREF(YevalSsyntaxYsexpr_unwind_protectQ);
  } else {
    T2 = YPfalse;
  }
  T4 = fun_sexpr_unwind_protectQ_50;
  T1 = XCALL2(1,VARREF(YPdefine_method),T2,T4);
  VARSET(YevalSsyntaxYsexpr_unwind_protectQ,T1);
  lit_116 = YPPsym((P)"sexpr-unwind-protect-protected-form");
  lit_117 = YPPlist(1,YPPsym((P)"exp"));
  T5 = YPsig(LITREF(lit_117),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_unwind_protect_protected_form_51 = YPmet(FUNCODEREF(fun_sexpr_unwind_protect_protected_form_51),LITREF(lit_116),T5,ENVNUL,PNUL,YPfalse);
  T8 = BOUNDP(YevalSsyntaxYsexpr_unwind_protect_protected_form);
  if (T8 != YPfalse) {
    T7 = VARREF(YevalSsyntaxYsexpr_unwind_protect_protected_form);
  } else {
    T7 = YPfalse;
  }
  T9 = fun_sexpr_unwind_protect_protected_form_51;
  T6 = XCALL2(1,VARREF(YPdefine_method),T7,T9);
  VARSET(YevalSsyntaxYsexpr_unwind_protect_protected_form,T6);
  lit_118 = YPPsym((P)"sexpr-unwind-protect-cleanup-forms");
  lit_119 = YPPlist(1,YPPsym((P)"exp"));
  T10 = YPsig(LITREF(lit_119),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_unwind_protect_cleanup_forms_52 = YPmet(FUNCODEREF(fun_sexpr_unwind_protect_cleanup_forms_52),LITREF(lit_118),T10,ENVNUL,PNUL,YPfalse);
  T13 = BOUNDP(YevalSsyntaxYsexpr_unwind_protect_cleanup_forms);
  if (T13 != YPfalse) {
    T12 = VARREF(YevalSsyntaxYsexpr_unwind_protect_cleanup_forms);
  } else {
    T12 = YPfalse;
  }
  T14 = fun_sexpr_unwind_protect_cleanup_forms_52;
  T11 = XCALL2(1,VARREF(YPdefine_method),T12,T14);
  VARSET(YevalSsyntaxYsexpr_unwind_protect_cleanup_forms,T11);
  lit_120 = YPPsym((P)"try");
  VARSET(YevalSsyntaxYDsexpr_monitor_tag,LITREF(lit_120));
  lit_121 = YPPsym((P)"sexpr-monitor?");
  lit_122 = YPPlist(1,YPPsym((P)"exp"));
  T15 = YPsig(LITREF(lit_122),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_monitorQ_53 = YPmet(FUNCODEREF(fun_sexpr_monitorQ_53),LITREF(lit_121),T15,ENVNUL,PNUL,YPfalse);
  T18 = BOUNDP(YevalSsyntaxYsexpr_monitorQ);
  if (T18 != YPfalse) {
    T17 = VARREF(YevalSsyntaxYsexpr_monitorQ);
  } else {
    T17 = YPfalse;
  }
  T19 = fun_sexpr_monitorQ_53;
  T16 = XCALL2(1,VARREF(YPdefine_method),T17,T19);
  VARSET(YevalSsyntaxYsexpr_monitorQ,T16);
  lit_123 = YPPsym((P)"sexpr-monitor-expand");
  lit_124 = YPPlist(1,YPPsym((P)"exp"));
  lit_125 = YPPlist(1,YPPsym((P)"return"));
  lit_126 = YPPsym((P)"x-1419");
  lit_127 = YPPlist(2,YPPsym((P)"msg"),YPPsym((P)"args"));
  lit_128 = YPsb((P)"Malformed TRY expression: ~=");
  lit_129 = YPsb((P)"Match Pattern Failure");
  lit_130 = YPPsym((P)"type");
  T22 = YPsig(LITREF(lit_127),YPPlist(1,VARREF(YLstrG)),YPtrue,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_x_1419_54 = YPmet(FUNCODEREF(fun_x_1419_54),LITREF(lit_126),T22,ENVNUL,PNUL,YPfalse);
  T21 = YPsig(LITREF(lit_125),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_55 = YPmet(FUNCODEREF(fun_55),YPfalse,T21,ENVNUL,PNUL,YPfalse);
  T20 = YPsig(LITREF(lit_124),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_monitor_expand_56 = YPmet(FUNCODEREF(fun_sexpr_monitor_expand_56),LITREF(lit_123),T20,ENVNUL,PNUL,YPfalse);
  T25 = BOUNDP(YevalSsyntaxYsexpr_monitor_expand);
  if (T25 != YPfalse) {
    T24 = VARREF(YevalSsyntaxYsexpr_monitor_expand);
  } else {
    T24 = YPfalse;
  }
  T26 = fun_sexpr_monitor_expand_56;
  T23 = XCALL2(1,VARREF(YPdefine_method),T24,T26);
  VARSET(YevalSsyntaxYsexpr_monitor_expand,T23);
  lit_131 = YPPsym((P)"find-option");
  lit_132 = YPPlist(3,YPPsym((P)"options"),YPPsym((P)"option"),YPPsym((P)"default"));
  T27 = YPsig(LITREF(lit_132),YPPlist(3,VARREF(YLlstG),VARREF(YLsymG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  YevalSsyntaxYfind_option = YPmet(FUNCODEREF(YevalSsyntaxYfind_option),LITREF(lit_131),T27,ENVNUL,PNUL,YPfalse);
  T28 = YevalSsyntaxYfind_option;
  VARSET(YevalSsyntaxYfind_option,T28);
  lit_133 = YPPsym((P)"sexpr-monitor-type");
  lit_134 = YPPlist(1,YPPsym((P)"options"));
  lit_135 = YPPlist(1,YPPsym((P)"<condition>"));
  lit_136 = YPPlist(1,YPPsym((P)"return"));
  lit_137 = YPPsym((P)"x-1421");
  lit_138 = YPPlist(2,YPPsym((P)"msg"),YPPsym((P)"args"));
  lit_139 = YPsb((P)"Malformed TRY condition type: %=");
  T31 = YPsig(LITREF(lit_138),YPPlist(1,VARREF(YLstrG)),YPtrue,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_x_1421_58 = YPmet(FUNCODEREF(fun_x_1421_58),LITREF(lit_137),T31,ENVNUL,PNUL,YPfalse);
  T30 = YPsig(LITREF(lit_136),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_59 = YPmet(FUNCODEREF(fun_59),YPfalse,T30,ENVNUL,PNUL,YPfalse);
  T29 = YPsig(LITREF(lit_134),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_monitor_type_60 = YPmet(FUNCODEREF(fun_sexpr_monitor_type_60),LITREF(lit_133),T29,ENVNUL,PNUL,YPfalse);
  T34 = BOUNDP(YevalSsyntaxYsexpr_monitor_type);
  if (T34 != YPfalse) {
    T33 = VARREF(YevalSsyntaxYsexpr_monitor_type);
  } else {
    T33 = YPfalse;
  }
  T35 = fun_sexpr_monitor_type_60;
  T32 = XCALL2(1,VARREF(YPdefine_method),T33,T35);
  VARSET(YevalSsyntaxYsexpr_monitor_type,T32);
  lit_140 = YPPsym((P)"sexpr-monitor-info");
  lit_141 = YPPlist(1,YPPsym((P)"options"));
  lit_142 = YPPsym((P)"info");
  lit_143 = YPPsym((P)"description");
  lit_144 = YPsb((P)"TRY may only have one of INFO or DESCRIPTION: %=");
  lit_145 = YPPlist(1,YPPsym((P)"return"));
  lit_146 = YPPsym((P)"x-1423");
  lit_147 = YPPlist(2,YPPsym((P)"msg"),YPPsym((P)"args"));
  lit_148 = YPsb((P)"Malformed TRY info expression: %=");
  lit_149 = YPPlist(1,YPPsym((P)"return"));
  lit_150 = YPPsym((P)"x-1425");
  lit_151 = YPPlist(2,YPPsym((P)"msg"),YPPsym((P)"args"));
  lit_152 = YPsb((P)"Malformed TRY description: %=");
  lit_153 = YPPsym((P)"new");
  lit_154 = YPPsym((P)"<simple-handler-info>");
  lit_155 = YPPsym((P)"handler-info-message");
  lit_156 = YPPsym((P)"handler-info-arguments");
  lit_157 = YPPsym((P)"lst");
  lit_158 = YPPsym((P)"$default-handler-info");
  T40 = YPsig(LITREF(lit_147),YPPlist(1,VARREF(YLstrG)),YPtrue,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_x_1423_61 = YPmet(FUNCODEREF(fun_x_1423_61),LITREF(lit_146),T40,ENVNUL,PNUL,YPfalse);
  T39 = YPsig(LITREF(lit_145),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_62 = YPmet(FUNCODEREF(fun_62),YPfalse,T39,ENVNUL,PNUL,YPfalse);
  T38 = YPsig(LITREF(lit_151),YPPlist(1,VARREF(YLstrG)),YPtrue,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_x_1425_63 = YPmet(FUNCODEREF(fun_x_1425_63),LITREF(lit_150),T38,ENVNUL,PNUL,YPfalse);
  T37 = YPsig(LITREF(lit_149),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_64 = YPmet(FUNCODEREF(fun_64),YPfalse,T37,ENVNUL,PNUL,YPfalse);
  T36 = YPsig(LITREF(lit_141),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_monitor_info_65 = YPmet(FUNCODEREF(fun_sexpr_monitor_info_65),LITREF(lit_140),T36,ENVNUL,PNUL,YPfalse);
  T43 = BOUNDP(YevalSsyntaxYsexpr_monitor_info);
  if (T43 != YPfalse) {
    T42 = VARREF(YevalSsyntaxYsexpr_monitor_info);
  } else {
    T42 = YPfalse;
  }
  T44 = fun_sexpr_monitor_info_65;
  T41 = XCALL2(1,VARREF(YPdefine_method),T42,T44);
  VARSET(YevalSsyntaxYsexpr_monitor_info,T41);
  lit_159 = YPPsym((P)"sexpr-monitor-test");
  lit_160 = YPPlist(1,YPPsym((P)"options"));
  lit_161 = YPPsym((P)"test");
  lit_162 = YPPlist(1,YPtrue);
  T45 = YPsig(LITREF(lit_160),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_monitor_test_66 = YPmet(FUNCODEREF(fun_sexpr_monitor_test_66),LITREF(lit_159),T45,ENVNUL,PNUL,YPfalse);
  T48 = BOUNDP(YevalSsyntaxYsexpr_monitor_test);
  if (T48 != YPfalse) {
    T47 = VARREF(YevalSsyntaxYsexpr_monitor_test);
  } else {
    T47 = YPfalse;
  }
  T49 = fun_sexpr_monitor_test_66;
  T46 = XCALL2(1,VARREF(YPdefine_method),T47,T49);
  VARSET(YevalSsyntaxYsexpr_monitor_test,T46);
  lit_163 = YPPsym((P)"sexpr-monitor-body");
  lit_164 = YPPlist(1,YPPsym((P)"body"));
  T50 = YPsig(LITREF(lit_164),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_monitor_body_67 = YPmet(FUNCODEREF(fun_sexpr_monitor_body_67),LITREF(lit_163),T50,ENVNUL,PNUL,YPfalse);
  T53 = BOUNDP(YevalSsyntaxYsexpr_monitor_body);
  if (T53 != YPfalse) {
    T52 = VARREF(YevalSsyntaxYsexpr_monitor_body);
  } else {
    T52 = YPfalse;
  }
  T54 = fun_sexpr_monitor_body_67;
  T51 = XCALL2(1,VARREF(YPdefine_method),T52,T54);
  VARSET(YevalSsyntaxYsexpr_monitor_body,T51);
  lit_165 = YPPsym((P)"seq");
  VARSET(YevalSsyntaxYDsexpr_begin_tag,LITREF(lit_165));
  lit_166 = YPPsym((P)"sexpr-begin?");
  lit_167 = YPPlist(1,YPPsym((P)"exp"));
  T55 = YPsig(LITREF(lit_167),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_beginQ_68 = YPmet(FUNCODEREF(fun_sexpr_beginQ_68),LITREF(lit_166),T55,ENVNUL,PNUL,YPfalse);
  T58 = BOUNDP(YevalSsyntaxYsexpr_beginQ);
  if (T58 != YPfalse) {
    T57 = VARREF(YevalSsyntaxYsexpr_beginQ);
  } else {
    T57 = YPfalse;
  }
  T59 = fun_sexpr_beginQ_68;
  T56 = XCALL2(1,VARREF(YPdefine_method),T57,T59);
  VARSET(YevalSsyntaxYsexpr_beginQ,T56);
  lit_168 = YPPsym((P)"sexpr-begin-actions");
  lit_169 = YPPlist(1,YPPsym((P)"begin-exp"));
  T60 = YPsig(LITREF(lit_169),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_begin_actions_69 = YPmet(FUNCODEREF(fun_sexpr_begin_actions_69),LITREF(lit_168),T60,ENVNUL,PNUL,YPfalse);
  T63 = BOUNDP(YevalSsyntaxYsexpr_begin_actions);
  if (T63 != YPfalse) {
    T62 = VARREF(YevalSsyntaxYsexpr_begin_actions);
  } else {
    T62 = YPfalse;
  }
  T64 = fun_sexpr_begin_actions_69;
  T61 = XCALL2(1,VARREF(YPdefine_method),T62,T64);
  VARSET(YevalSsyntaxYsexpr_begin_actions,T61);
  lit_170 = YPPsym((P)"sexpr-last-exp?");
  lit_171 = YPPlist(1,YPPsym((P)"seq"));
  T65 = YPsig(LITREF(lit_171),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_last_expQ_70 = YPmet(FUNCODEREF(fun_sexpr_last_expQ_70),LITREF(lit_170),T65,ENVNUL,PNUL,YPfalse);
  T68 = BOUNDP(YevalSsyntaxYsexpr_last_expQ);
  if (T68 != YPfalse) {
    T67 = VARREF(YevalSsyntaxYsexpr_last_expQ);
  } else {
    T67 = YPfalse;
  }
  T69 = fun_sexpr_last_expQ_70;
  T66 = XCALL2(1,VARREF(YPdefine_method),T67,T69);
  VARSET(YevalSsyntaxYsexpr_last_expQ,T66);
  lit_172 = YPPsym((P)"sexpr-first-exp");
  lit_173 = YPPlist(1,YPPsym((P)"seq"));
  T70 = YPsig(LITREF(lit_173),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_first_exp_71 = YPmet(FUNCODEREF(fun_sexpr_first_exp_71),LITREF(lit_172),T70,ENVNUL,PNUL,YPfalse);
  T73 = BOUNDP(YevalSsyntaxYsexpr_first_exp);
  if (T73 != YPfalse) {
    T72 = VARREF(YevalSsyntaxYsexpr_first_exp);
  } else {
    T72 = YPfalse;
  }
  T74 = fun_sexpr_first_exp_71;
  T71 = XCALL2(1,VARREF(YPdefine_method),T72,T74);
  VARSET(YevalSsyntaxYsexpr_first_exp,T71);
  lit_174 = YPPsym((P)"sexpr-rest-exps");
  lit_175 = YPPlist(1,YPPsym((P)"seq"));
  T75 = YPsig(LITREF(lit_175),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_rest_exps_72 = YPmet(FUNCODEREF(fun_sexpr_rest_exps_72),LITREF(lit_174),T75,ENVNUL,PNUL,YPfalse);
  T78 = BOUNDP(YevalSsyntaxYsexpr_rest_exps);
  if (T78 != YPfalse) {
    T77 = VARREF(YevalSsyntaxYsexpr_rest_exps);
  } else {
    T77 = YPfalse;
  }
  T79 = fun_sexpr_rest_exps_72;
  T76 = XCALL2(1,VARREF(YPdefine_method),T77,T79);
  VARSET(YevalSsyntaxYsexpr_rest_exps,T76);
  lit_176 = YPPsym((P)"sexpr-sequence->begin");
  lit_177 = YPPlist(1,YPPsym((P)"seq"));
  T80 = YPsig(LITREF(lit_177),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_sequence_Gbegin_73 = YPmet(FUNCODEREF(fun_sexpr_sequence_Gbegin_73),LITREF(lit_176),T80,ENVNUL,PNUL,YPfalse);
  T83 = BOUNDP(YevalSsyntaxYsexpr_sequence_Gbegin);
  if (T83 != YPfalse) {
    T82 = VARREF(YevalSsyntaxYsexpr_sequence_Gbegin);
  } else {
    T82 = YPfalse;
  }
  T84 = fun_sexpr_sequence_Gbegin_73;
  T81 = XCALL2(1,VARREF(YPdefine_method),T82,T84);
  VARSET(YevalSsyntaxYsexpr_sequence_Gbegin,T81);
  lit_178 = YPPsym((P)"sexpr-make-begin");
  lit_179 = YPPlist(1,YPPsym((P)"exp"));
  T85 = YPsig(LITREF(lit_179),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_make_begin_74 = YPmet(FUNCODEREF(fun_sexpr_make_begin_74),LITREF(lit_178),T85,ENVNUL,PNUL,YPfalse);
  T88 = BOUNDP(YevalSsyntaxYsexpr_make_begin);
  if (T88 != YPfalse) {
    T87 = VARREF(YevalSsyntaxYsexpr_make_begin);
  } else {
    T87 = YPfalse;
  }
  T89 = fun_sexpr_make_begin_74;
  T86 = XCALL2(1,VARREF(YPdefine_method),T87,T89);
  VARSET(YevalSsyntaxYsexpr_make_begin,T86);
  lit_180 = YPPsym((P)"sexpr-application?");
  lit_181 = YPPlist(1,YPPsym((P)"exp"));
  T90 = YPsig(LITREF(lit_181),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_applicationQ_75 = YPmet(FUNCODEREF(fun_sexpr_applicationQ_75),LITREF(lit_180),T90,ENVNUL,PNUL,YPfalse);
  T93 = BOUNDP(YevalSsyntaxYsexpr_applicationQ);
  if (T93 != YPfalse) {
    T92 = VARREF(YevalSsyntaxYsexpr_applicationQ);
  } else {
    T92 = YPfalse;
  }
  T94 = fun_sexpr_applicationQ_75;
  T91 = XCALL2(1,VARREF(YPdefine_method),T92,T94);
  VARSET(YevalSsyntaxYsexpr_applicationQ,T91);
  lit_182 = YPPsym((P)"sexpr-operator");
  lit_183 = YPPlist(1,YPPsym((P)"app"));
  T95 = YPsig(LITREF(lit_183),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_operator_76 = YPmet(FUNCODEREF(fun_sexpr_operator_76),LITREF(lit_182),T95,ENVNUL,PNUL,YPfalse);
  T98 = BOUNDP(YevalSsyntaxYsexpr_operator);
  if (T98 != YPfalse) {
    T97 = VARREF(YevalSsyntaxYsexpr_operator);
  } else {
    T97 = YPfalse;
  }
  T99 = fun_sexpr_operator_76;
  T96 = XCALL2(1,VARREF(YPdefine_method),T97,T99);
  VARSET(YevalSsyntaxYsexpr_operator,T96);
  lit_184 = YPPsym((P)"sexpr-operands");
  lit_185 = YPPlist(1,YPPsym((P)"app"));
  T100 = YPsig(LITREF(lit_185),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_operands_77 = YPmet(FUNCODEREF(fun_sexpr_operands_77),LITREF(lit_184),T100,ENVNUL,PNUL,YPfalse);
  T103 = BOUNDP(YevalSsyntaxYsexpr_operands);
  if (T103 != YPfalse) {
    T102 = VARREF(YevalSsyntaxYsexpr_operands);
  } else {
    T102 = YPfalse;
  }
  T104 = fun_sexpr_operands_77;
  T101 = XCALL2(1,VARREF(YPdefine_method),T102,T104);
  VARSET(YevalSsyntaxYsexpr_operands,T101);
  lit_186 = YPPsym((P)"sexpr-no-operands?");
  lit_187 = YPPlist(1,YPPsym((P)"args"));
  T105 = YPsig(LITREF(lit_187),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_no_operandsQ_78 = YPmet(FUNCODEREF(fun_sexpr_no_operandsQ_78),LITREF(lit_186),T105,ENVNUL,PNUL,YPfalse);
  T108 = BOUNDP(YevalSsyntaxYsexpr_no_operandsQ);
  if (T108 != YPfalse) {
    T107 = VARREF(YevalSsyntaxYsexpr_no_operandsQ);
  } else {
    T107 = YPfalse;
  }
  T109 = fun_sexpr_no_operandsQ_78;
  T106 = XCALL2(1,VARREF(YPdefine_method),T107,T109);
  VARSET(YevalSsyntaxYsexpr_no_operandsQ,T106);
  lit_188 = YPPsym((P)"sexpr-first-operand");
  lit_189 = YPPlist(1,YPPsym((P)"args"));
  T110 = YPsig(LITREF(lit_189),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_first_operand_79 = YPmet(FUNCODEREF(fun_sexpr_first_operand_79),LITREF(lit_188),T110,ENVNUL,PNUL,YPfalse);
  T113 = BOUNDP(YevalSsyntaxYsexpr_first_operand);
  if (T113 != YPfalse) {
    T112 = VARREF(YevalSsyntaxYsexpr_first_operand);
  } else {
    T112 = YPfalse;
  }
  T114 = fun_sexpr_first_operand_79;
  T111 = XCALL2(1,VARREF(YPdefine_method),T112,T114);
  VARSET(YevalSsyntaxYsexpr_first_operand,T111);
  lit_190 = YPPsym((P)"sexpr-rest-operands");
  lit_191 = YPPlist(1,YPPsym((P)"args"));
  T115 = YPsig(LITREF(lit_191),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_rest_operands_80 = YPmet(FUNCODEREF(fun_sexpr_rest_operands_80),LITREF(lit_190),T115,ENVNUL,PNUL,YPfalse);
  T118 = BOUNDP(YevalSsyntaxYsexpr_rest_operands);
  if (T118 != YPfalse) {
    T117 = VARREF(YevalSsyntaxYsexpr_rest_operands);
  } else {
    T117 = YPfalse;
  }
  T119 = fun_sexpr_rest_operands_80;
  T116 = XCALL2(1,VARREF(YPdefine_method),T117,T119);
  VARSET(YevalSsyntaxYsexpr_rest_operands,T116);
  lit_192 = YPPsym((P)"sexpr-make-application");
  lit_193 = YPPlist(2,YPPsym((P)"f"),YPPsym((P)"operands"));
  T120 = YPsig(LITREF(lit_193),YPPlist(2,VARREF(YLanyG),VARREF(YLlstG)),YPfalse,YPint((P)2),VARREF(YLlstG),Ynil);
  fun_sexpr_make_application_81 = YPmet(FUNCODEREF(fun_sexpr_make_application_81),LITREF(lit_192),T120,ENVNUL,PNUL,YPfalse);
  T123 = BOUNDP(YevalSsyntaxYsexpr_make_application);
  if (T123 != YPfalse) {
    T122 = VARREF(YevalSsyntaxYsexpr_make_application);
  } else {
    T122 = YPfalse;
  }
  T124 = fun_sexpr_make_application_81;
  T121 = XCALL2(1,VARREF(YPdefine_method),T122,T124);
  VARSET(YevalSsyntaxYsexpr_make_application,T121);
  VARSET(YevalSsyntaxYTunique_name_counterT,YPint((P)0));
  lit_194 = YPPsym((P)"sexpr-new-unique-name-counter!");
  lit_195 = Ynil;
  T125 = YPsig(LITREF(lit_195),Ynil,YPfalse,YPint((P)0),VARREF(YLintG),Ynil);
  fun_sexpr_new_unique_name_counterX_82 = YPmet(FUNCODEREF(fun_sexpr_new_unique_name_counterX_82),LITREF(lit_194),T125,ENVNUL,PNUL,YPfalse);
  T128 = BOUNDP(YevalSsyntaxYsexpr_new_unique_name_counterX);
  if (T128 != YPfalse) {
    T127 = VARREF(YevalSsyntaxYsexpr_new_unique_name_counterX);
  } else {
    T127 = YPfalse;
  }
  T129 = fun_sexpr_new_unique_name_counterX_82;
  T126 = XCALL2(1,VARREF(YPdefine_method),T127,T129);
  VARSET(YevalSsyntaxYsexpr_new_unique_name_counterX,T126);
  VARSET(YevalSsyntaxYLnameG,VARREF(YLanyG));
  lit_196 = YPPsym((P)"sexpr-unique-name");
  lit_197 = YPPlist(1,YPPsym((P)"prefix"));
  T130 = YPsig(LITREF(lit_197),YPPlist(1,VARREF(YevalSsyntaxYLnameG)),YPfalse,YPint((P)1),VARREF(YLsymG),Ynil);
  fun_sexpr_unique_name_83 = YPmet(FUNCODEREF(fun_sexpr_unique_name_83),LITREF(lit_196),T130,ENVNUL,PNUL,YPfalse);
  T133 = BOUNDP(YevalSsyntaxYsexpr_unique_name);
  if (T133 != YPfalse) {
    T132 = VARREF(YevalSsyntaxYsexpr_unique_name);
  } else {
    T132 = YPfalse;
  }
  T134 = fun_sexpr_unique_name_83;
  T131 = XCALL2(1,VARREF(YPdefine_method),T132,T134);
  VARSET(YevalSsyntaxYsexpr_unique_name,T131);
  lit_198 = YPPsym((P)"def");
  VARSET(YevalSsyntaxYDsexpr_def_tag,LITREF(lit_198));
  lit_199 = YPPsym((P)"sexpr-def?");
  lit_200 = YPPlist(1,YPPsym((P)"exp"));
  T135 = YPsig(LITREF(lit_200),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_defQ_84 = YPmet(FUNCODEREF(fun_sexpr_defQ_84),LITREF(lit_199),T135,ENVNUL,PNUL,YPfalse);
  T138 = BOUNDP(YevalSsyntaxYsexpr_defQ);
  if (T138 != YPfalse) {
    T137 = VARREF(YevalSsyntaxYsexpr_defQ);
  } else {
    T137 = YPfalse;
  }
  T139 = fun_sexpr_defQ_84;
  T136 = XCALL2(1,VARREF(YPdefine_method),T137,T139);
  VARSET(YevalSsyntaxYsexpr_defQ,T136);
  lit_201 = YPPsym((P)"sexpr-def-variable");
  lit_202 = YPPlist(1,YPPsym((P)"exp"));
  T140 = YPsig(LITREF(lit_202),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_def_variable_85 = YPmet(FUNCODEREF(fun_sexpr_def_variable_85),LITREF(lit_201),T140,ENVNUL,PNUL,YPfalse);
  T143 = BOUNDP(YevalSsyntaxYsexpr_def_variable);
  if (T143 != YPfalse) {
    T142 = VARREF(YevalSsyntaxYsexpr_def_variable);
  } else {
    T142 = YPfalse;
  }
  T144 = fun_sexpr_def_variable_85;
  T141 = XCALL2(1,VARREF(YPdefine_method),T142,T144);
  VARSET(YevalSsyntaxYsexpr_def_variable,T141);
  lit_203 = YPPsym((P)"sexpr-def-value");
  lit_204 = YPPlist(1,YPPsym((P)"exp"));
  T145 = YPsig(LITREF(lit_204),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_def_value_86 = YPmet(FUNCODEREF(fun_sexpr_def_value_86),LITREF(lit_203),T145,ENVNUL,PNUL,YPfalse);
  T148 = BOUNDP(YevalSsyntaxYsexpr_def_value);
  if (T148 != YPfalse) {
    T147 = VARREF(YevalSsyntaxYsexpr_def_value);
  } else {
    T147 = YPfalse;
  }
  T149 = fun_sexpr_def_value_86;
  T146 = XCALL2(1,VARREF(YPdefine_method),T147,T149);
  VARSET(YevalSsyntaxYsexpr_def_value,T146);
  lit_205 = YPPsym((P)"let");
  VARSET(YevalSsyntaxYDsexpr_let_tag,LITREF(lit_205));
  lit_206 = YPPsym((P)"sexpr-let?");
  lit_207 = YPPlist(1,YPPsym((P)"exp"));
  T150 = YPsig(LITREF(lit_207),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_letQ_87 = YPmet(FUNCODEREF(fun_sexpr_letQ_87),LITREF(lit_206),T150,ENVNUL,PNUL,YPfalse);
  T153 = BOUNDP(YevalSsyntaxYsexpr_letQ);
  if (T153 != YPfalse) {
    T152 = VARREF(YevalSsyntaxYsexpr_letQ);
  } else {
    T152 = YPfalse;
  }
  T154 = fun_sexpr_letQ_87;
  T151 = XCALL2(1,VARREF(YPdefine_method),T152,T154);
  VARSET(YevalSsyntaxYsexpr_letQ,T151);
  lit_208 = YPPsym((P)"sexpr-let-bound-variables");
  lit_209 = YPPlist(1,YPPsym((P)"let-exp"));
  lit_210 = YPPlist(1,YPPsym((P)"x"));
  T156 = YPsig(LITREF(lit_210),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_88 = YPmet(FUNCODEREF(fun_88),YPfalse,T156,ENVNUL,PNUL,YPfalse);
  T155 = YPsig(LITREF(lit_209),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_let_bound_variables_89 = YPmet(FUNCODEREF(fun_sexpr_let_bound_variables_89),LITREF(lit_208),T155,ENVNUL,PNUL,YPfalse);
  T159 = BOUNDP(YevalSsyntaxYsexpr_let_bound_variables);
  if (T159 != YPfalse) {
    T158 = VARREF(YevalSsyntaxYsexpr_let_bound_variables);
  } else {
    T158 = YPfalse;
  }
  T160 = fun_sexpr_let_bound_variables_89;
  T157 = XCALL2(1,VARREF(YPdefine_method),T158,T160);
  VARSET(YevalSsyntaxYsexpr_let_bound_variables,T157);
  lit_211 = YPPsym((P)"sexpr-let-values");
  lit_212 = YPPlist(1,YPPsym((P)"let-exp"));
  lit_213 = YPPlist(1,YPPsym((P)"x"));
  T162 = YPsig(LITREF(lit_213),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_90 = YPmet(FUNCODEREF(fun_90),YPfalse,T162,ENVNUL,PNUL,YPfalse);
  T161 = YPsig(LITREF(lit_212),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_let_values_91 = YPmet(FUNCODEREF(fun_sexpr_let_values_91),LITREF(lit_211),T161,ENVNUL,PNUL,YPfalse);
  T165 = BOUNDP(YevalSsyntaxYsexpr_let_values);
  if (T165 != YPfalse) {
    T164 = VARREF(YevalSsyntaxYsexpr_let_values);
  } else {
    T164 = YPfalse;
  }
  T166 = fun_sexpr_let_values_91;
  T163 = XCALL2(1,VARREF(YPdefine_method),T164,T166);
  VARSET(YevalSsyntaxYsexpr_let_values,T163);
  lit_214 = YPPsym((P)"sexpr-let-body");
  lit_215 = YPPlist(1,YPPsym((P)"let-exp"));
  T167 = YPsig(LITREF(lit_215),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_let_body_92 = YPmet(FUNCODEREF(fun_sexpr_let_body_92),LITREF(lit_214),T167,ENVNUL,PNUL,YPfalse);
  T170 = BOUNDP(YevalSsyntaxYsexpr_let_body);
  if (T170 != YPfalse) {
    T169 = VARREF(YevalSsyntaxYsexpr_let_body);
  } else {
    T169 = YPfalse;
  }
  T171 = fun_sexpr_let_body_92;
  T168 = XCALL2(1,VARREF(YPdefine_method),T169,T171);
  VARSET(YevalSsyntaxYsexpr_let_body,T168);
  lit_216 = YPPsym((P)"sexpr-let-names+values");
  lit_217 = YPPlist(2,YPPsym((P)"names"),YPPsym((P)"vals"));
  lit_218 = YPPsym((P)"loop");
  lit_219 = YPPlist(4,YPPsym((P)"rnames"),YPPsym((P)"rvalues"),YPPsym((P)"names"),YPPsym((P)"vals"));
  lit_220 = YPsb((P)"tup");
  lit_221 = YPPsym((P)"inner");
  lit_222 = YPPlist(4,YPPsym((P)"rtnames"),YPPsym((P)"rtvalues"),YPPsym((P)"index"),YPPsym((P)"tnames"));
  lit_223 = YPPsym((P)"...");
  lit_224 = YPPsym((P)"<lst>");
  lit_225 = YPPsym((P)"sub");
  lit_226 = YPPsym((P)"len");
  lit_227 = YPPsym((P)"elt");
  T175 = YPsig(LITREF(lit_222),YPPlist(4,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)4),VARREF(YLanyG),Ynil);
  fun_inner_93 = YPmet(FUNCODEREF(fun_inner_93),LITREF(lit_221),T175,ENVNUL,PNUL,YPfalse);
  T174 = YPsig(LITREF(lit_219),YPPlist(4,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)4),VARREF(YLanyG),Ynil);
  fun_loop_94 = YPmet(FUNCODEREF(fun_loop_94),LITREF(lit_218),T174,ENVNUL,PNUL,YPfalse);
  T173 = XCALL2(1,VARREF(YtT),VARREF(YLlstG),VARREF(YLlstG));
  T172 = YPsig(LITREF(lit_217),YPPlist(2,VARREF(YLlstG),VARREF(YLlstG)),YPfalse,YPint((P)2),T173,Ynil);
  fun_sexpr_let_namesAvalues_95 = YPmet(FUNCODEREF(fun_sexpr_let_namesAvalues_95),LITREF(lit_216),T172,ENVNUL,PNUL,YPfalse);
  T178 = BOUNDP(YevalSsyntaxYsexpr_let_namesAvalues);
  if (T178 != YPfalse) {
    T177 = VARREF(YevalSsyntaxYsexpr_let_namesAvalues);
  } else {
    T177 = YPfalse;
  }
  T179 = fun_sexpr_let_namesAvalues_95;
  T176 = XCALL2(1,VARREF(YPdefine_method),T177,T179);
  VARSET(YevalSsyntaxYsexpr_let_namesAvalues,T176);
  ...
  T181 = YPsig(LITREF(lit_231),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_col_96 = YPmet(FUNCODEREF(fun_col_96),LITREF(lit_230),T181,ENVNUL,PNUL,YPfalse);
  T180 = YPsig(LITREF(lit_229),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_let_Gcombination_97 = YPmet(FUNCODEREF(fun_sexpr_let_Gcombination_97),LITREF(lit_228),T180,ENVNUL,PNUL,YPfalse);
  T184 = BOUNDP(YevalSsyntaxYsexpr_let_Gcombination);
  if (T184 != YPfalse) {
    T183 = VARREF(YevalSsyntaxYsexpr_let_Gcombination);
  } else {
    T183 = YPfalse;
  }
  T185 = fun_sexpr_let_Gcombination_97;
  T182 = XCALL2(1,VARREF(YPdefine_method),T183,T185);
  VARSET(YevalSsyntaxYsexpr_let_Gcombination,T182);
  ...
  T186 = YPsig(LITREF(lit_234),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_locQ_98 = YPmet(FUNCODEREF(fun_sexpr_locQ_98),LITREF(lit_233),T186,ENVNUL,PNUL,YPfalse);
  T189 = BOUNDP(YevalSsyntaxYsexpr_locQ);
  if (T189 != YPfalse) {
    T188 = VARREF(YevalSsyntaxYsexpr_locQ);
  } else {
    T188 = YPfalse;
  }
  T190 = fun_sexpr_locQ_98;
  T187 = XCALL2(1,VARREF(YPdefine_method),T188,T190);
  VARSET(YevalSsyntaxYsexpr_locQ,T187);
  lit_235 = YPPsym((P)"sexpr-loc-bound-names");
  lit_236 = YPPlist(1,YPPsym((P)"loc-exp"));
  T191 = YPsig(LITREF(lit_236),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_loc_bound_names_99 = YPmet(FUNCODEREF(fun_sexpr_loc_bound_names_99),LITREF(lit_235),T191,ENVNUL,PNUL,YPfalse);
  T194 = BOUNDP(YevalSsyntaxYsexpr_loc_bound_names);
  if (T194 != YPfalse) {
    T193 = VARREF(YevalSsyntaxYsexpr_loc_bound_names);
  } else {
    T193 = YPfalse;
  }
  T195 = fun_sexpr_loc_bound_names_99;
  T192 = XCALL2(1,VARREF(YPdefine_method),T193,T195);
  VARSET(YevalSsyntaxYsexpr_loc_bound_names,T192);
  lit_237 = YPPsym((P)"sexpr-loc-bound-signatures");
  lit_238 = YPPlist(1,YPPsym((P)"loc-exp"));
  lit_239 = YPPlist(1,YPPsym((P)"x"));
  T197 = YPsig(LITREF(lit_239),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_100 = YPmet(FUNCODEREF(fun_100),YPfalse,T197,ENVNUL,PNUL,YPfalse);
  T196 = YPsig(LITREF(lit_238),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_loc_bound_signatures_101 = YPmet(FUNCODEREF(fun_sexpr_loc_bound_signatures_101),LITREF(lit_237),T196,ENVNUL,PNUL,YPfalse);
  T200 = BOUNDP(YevalSsyntaxYsexpr_loc_bound_signatures);
  if (T200 != YPfalse) {
    T199 = VARREF(YevalSsyntaxYsexpr_loc_bound_signatures);
  } else {
    T199 = YPfalse;
  }
  T201 = fun_sexpr_loc_bound_signatures_101;
  T198 = XCALL2(1,VARREF(YPdefine_method),T199,T201);
  VARSET(YevalSsyntaxYsexpr_loc_bound_signatures,T198);
  lit_240 = YPPsym((P)"sexpr-loc-bound-bodies");
  lit_241 = YPPlist(1,YPPsym((P)"loc-exp"));
  T202 = YPsig(LITREF(lit_241),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_loc_bound_bodies_102 = YPmet(FUNCODEREF(fun_sexpr_loc_bound_bodies_102),LITREF(lit_240),T202,ENVNUL,PNUL,YPfalse);
  T205 = BOUNDP(YevalSsyntaxYsexpr_loc_bound_bodies);
  if (T205 != YPfalse) {
    T204 = VARREF(YevalSsyntaxYsexpr_loc_bound_bodies);
  } else {
    T204 = YPfalse;
  }
  T206 = fun_sexpr_loc_bound_bodies_102;
  T203 = XCALL2(1,VARREF(YPdefine_method),T204,T206);
  VARSET(YevalSsyntaxYsexpr_loc_bound_bodies,T203);
  lit_242 = YPPsym((P)"sexpr-loc-raw-body");
  lit_243 = YPPlist(1,YPPsym((P)"loc-exp"));
  T207 = YPsig(LITREF(lit_243),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_loc_raw_body_103 = YPmet(FUNCODEREF(fun_sexpr_loc_raw_body_103),LITREF(lit_242),T207,ENVNUL,PNUL,YPfalse);
  T210 = BOUNDP(YevalSsyntaxYsexpr_loc_raw_body);
  if (T210 != YPfalse) {
    T209 = VARREF(YevalSsyntaxYsexpr_loc_raw_body);
  } else {
    T209 = YPfalse;
  }
  T211 = fun_sexpr_loc_raw_body_103;
  T208 = XCALL2(1,VARREF(YPdefine_method),T209,T211);
  VARSET(YevalSsyntaxYsexpr_loc_raw_body,T208);
  lit_244 = YPPsym((P)"sexpr-loc-body");
  lit_245 = YPPlist(1,YPPsym((P)"loc-exp"));
  T212 = YPsig(LITREF(lit_245),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_loc_body_104 = YPmet(FUNCODEREF(fun_sexpr_loc_body_104),LITREF(lit_244),T212,ENVNUL,PNUL,YPfalse);
  T215 = BOUNDP(YevalSsyntaxYsexpr_loc_body);
  if (T215 != YPfalse) {
    T214 = VARREF(YevalSsyntaxYsexpr_loc_body);
  } else {
    T214 = YPfalse;
  }
  T216 = fun_sexpr_loc_body_104;
  T213 = XCALL2(1,VARREF(YPdefine_method),T214,T216);
  VARSET(YevalSsyntaxYsexpr_loc_body,T213);
  ...
  T217 = YPsig(LITREF(lit_248),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_iterateQ_105 = YPmet(FUNCODEREF(fun_sexpr_iterateQ_105),LITREF(lit_247),T217,ENVNUL,PNUL,YPfalse);
  T220 = BOUNDP(YevalSsyntaxYsexpr_iterateQ);
  if (T220 != YPfalse) {
    T219 = VARREF(YevalSsyntaxYsexpr_iterateQ);
  } else {
    T219 = YPfalse;
  }
  T221 = fun_sexpr_iterateQ_105;
  T218 = XCALL2(1,VARREF(YPdefine_method),T219,T221);
  VARSET(YevalSsyntaxYsexpr_iterateQ,T218);
  lit_249 = YPPsym((P)"sexpr-iterate-name");
  lit_250 = YPPlist(1,YPPsym((P)"rep-exp"));
  T222 = YPsig(LITREF(lit_250),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLsymG),Ynil);
  fun_sexpr_iterate_name_106 = YPmet(FUNCODEREF(fun_sexpr_iterate_name_106),LITREF(lit_249),T222,ENVNUL,PNUL,YPfalse);
  T225 = BOUNDP(YevalSsyntaxYsexpr_iterate_name);
  if (T225 != YPfalse) {
    T224 = VARREF(YevalSsyntaxYsexpr_iterate_name);
  } else {
    T224 = YPfalse;
  }
  T226 = fun_sexpr_iterate_name_106;
  T223 = XCALL2(1,VARREF(YPdefine_method),T224,T226);
  VARSET(YevalSsyntaxYsexpr_iterate_name,T223);
  ...
  T228 = YPsig(LITREF(lit_253),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_107 = YPmet(FUNCODEREF(fun_107),YPfalse,T228,ENVNUL,PNUL,YPfalse);
  T227 = YPsig(LITREF(lit_252),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_iterate_signature_108 = YPmet(FUNCODEREF(fun_sexpr_iterate_signature_108),LITREF(lit_251),T227,ENVNUL,PNUL,YPfalse);
  T231 = BOUNDP(YevalSsyntaxYsexpr_iterate_signature);
  if (T231 != YPfalse) {
    T230 = VARREF(YevalSsyntaxYsexpr_iterate_signature);
  } else {
    T230 = YPfalse;
  }
  T232 = fun_sexpr_iterate_signature_108;
  T229 = XCALL2(1,VARREF(YPdefine_method),T230,T232);
  VARSET(YevalSsyntaxYsexpr_iterate_signature,T229);
  lit_254 = YPPsym((P)"sexpr-iterate-inits");
  lit_255 = YPPlist(1,YPPsym((P)"rep-exp"));
  lit_256 = YPPlist(1,YPPsym((P)"x"));
  T234 = YPsig(LITREF(lit_256),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_109 = YPmet(FUNCODEREF(fun_109),YPfalse,T234,ENVNUL,PNUL,YPfalse);
  T233 = YPsig(LITREF(lit_255),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_iterate_inits_110 = YPmet(FUNCODEREF(fun_sexpr_iterate_inits_110),LITREF(lit_254),T233,ENVNUL,PNUL,YPfalse);
  T237 = BOUNDP(YevalSsyntaxYsexpr_iterate_inits);
  if (T237 != YPfalse) {
    T236 = VARREF(YevalSsyntaxYsexpr_iterate_inits);
  } else {
    T236 = YPfalse;
  }
  T238 = fun_sexpr_iterate_inits_110;
  T235 = XCALL2(1,VARREF(YPdefine_method),T236,T238);
  VARSET(YevalSsyntaxYsexpr_iterate_inits,T235);
  lit_257 = YPPsym((P)"sexpr-iterate-body");
  lit_258 = YPPlist(1,YPPsym((P)"rep-exp"));
  T239 = YPsig(LITREF(lit_258),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_iterate_body_111 = YPmet(FUNCODEREF(fun_sexpr_iterate_body_111),LITREF(lit_257),T239,ENVNUL,PNUL,YPfalse);
  T242 = BOUNDP(YevalSsyntaxYsexpr_iterate_body);
  if (T242 != YPfalse) {
    T241 = VARREF(YevalSsyntaxYsexpr_iterate_body);
  } else {
    T241 = YPfalse;
  }
  T243 = fun_sexpr_iterate_body_111;
  T240 = XCALL2(1,VARREF(YPdefine_method),T241,T243);
  VARSET(YevalSsyntaxYsexpr_iterate_body,T240);
  lit_259 = YPPsym((P)"sexpr-iterate->loc");
  lit_260 = YPPlist(1,YPPsym((P)"rep-exp"));
  T244 = YPsig(LITREF(lit_260),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_iterate_Gloc_112 = YPmet(FUNCODEREF(fun_sexpr_iterate_Gloc_112),LITREF(lit_259),T244,ENVNUL,PNUL,YPfalse);
  T247 = BOUNDP(YevalSsyntaxYsexpr_iterate_Gloc);
  if (T247 != YPfalse) {
    T246 = VARREF(YevalSsyntaxYsexpr_iterate_Gloc);
  } else {
    T246 = YPfalse;
  }
  T248 = fun_sexpr_iterate_Gloc_112;
  T245 = XCALL2(1,VARREF(YPdefine_method),T246,T248);
  VARSET(YevalSsyntaxYsexpr_iterate_Gloc,T245);
  ...
  T249 = YPsig(LITREF(lit_263),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_isaQ_113 = YPmet(FUNCODEREF(fun_sexpr_isaQ_113),LITREF(lit_262),T249,ENVNUL,PNUL,YPfalse);
  T252 = BOUNDP(YevalSsyntaxYsexpr_isaQ);
  if (T252 != YPfalse) {
    T251 = VARREF(YevalSsyntaxYsexpr_isaQ);
  } else {
    T251 = YPfalse;
  }
  T253 = fun_sexpr_isaQ_113;
  T250 = XCALL2(1,VARREF(YPdefine_method),T251,T253);
  VARSET(YevalSsyntaxYsexpr_isaQ,T250);
  lit_264 = YPPsym((P)"sexpr-isa-parent");
  lit_265 = YPPlist(1,YPPsym((P)"exp"));
  T254 = YPsig(LITREF(lit_265),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_isa_parent_114 = YPmet(FUNCODEREF(fun_sexpr_isa_parent_114),LITREF(lit_264),T254,ENVNUL,PNUL,YPfalse);
  T257 = BOUNDP(YevalSsyntaxYsexpr_isa_parent);
  if (T257 != YPfalse) {
    T256 = VARREF(YevalSsyntaxYsexpr_isa_parent);
  } else {
    T256 = YPfalse;
  }
  T258 = fun_sexpr_isa_parent_114;
  T255 = XCALL2(1,VARREF(YPdefine_method),T256,T258);
  VARSET(YevalSsyntaxYsexpr_isa_parent,T255);
  lit_266 = YPPsym((P)"sexpr-isa-prop-inits");
  lit_267 = YPPlist(1,YPPsym((P)"exp"));
  T259 = YPsig(LITREF(lit_267),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_isa_prop_inits_115 = YPmet(FUNCODEREF(fun_sexpr_isa_prop_inits_115),LITREF(lit_266),T259,ENVNUL,PNUL,YPfalse);
  T262 = BOUNDP(YevalSsyntaxYsexpr_isa_prop_inits);
  if (T262 != YPfalse) {
    T261 = VARREF(YevalSsyntaxYsexpr_isa_prop_inits);
  } else {
    T261 = YPfalse;
  }
  T263 = fun_sexpr_isa_prop_inits_115;
  T260 = XCALL2(1,VARREF(YPdefine_method),T261,T263);
  VARSET(YevalSsyntaxYsexpr_isa_prop_inits,T260);
  lit_268 = YPPsym((P)"sexpr-isa-init-props");
  lit_269 = YPPlist(1,YPPsym((P)"exp"));
  T264 = YPsig(LITREF(lit_269),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_isa_init_props_116 = YPmet(FUNCODEREF(fun_sexpr_isa_init_props_116),LITREF(lit_268),T264,ENVNUL,PNUL,YPfalse);
  T267 = BOUNDP(YevalSsyntaxYsexpr_isa_init_props);
  if (T267 != YPfalse) {
    T266 = VARREF(YevalSsyntaxYsexpr_isa_init_props);
  } else {
    T266 = YPfalse;
  }
  T268 = fun_sexpr_isa_init_props_116;
  T265 = XCALL2(1,VARREF(YPdefine_method),T266,T268);
  VARSET(YevalSsyntaxYsexpr_isa_init_props,T265);
  lit_270 = YPPsym((P)"sexpr-isa-init-values");
  lit_271 = YPPlist(1,YPPsym((P)"exp"));
  T271 = YPsig(LITREF(lit_271),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  T270 = fun_sexpr_isa_init_values_117 = YPmet(FUNCODEREF(fun_sexpr_isa_init_values_117),LITREF(lit_270),T271,ENVNUL,PNUL,YPfalse);
  T275 = BOUNDP(YevalSsyntaxYsexpr_isa_init_values);
  if (T275 != YPfalse) {
    T274 = VARREF(YevalSsyntaxYsexpr_isa_init_values);
  } else {
    T274 = YPfalse;
  }
  T276 = fun_sexpr_isa_init_values_117;
  T273 = XCALL2(1,VARREF(YPdefine_method),T274,T276);
  T272 = VARSET(YevalSsyntaxYsexpr_isa_init_values,T273);
  T269 = T272;
  return T269;
}
...
loop:
  ...
  T0 = YPsig(LITREF(lit_274),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_define_classQ_118 = YPmet(FUNCODEREF(fun_sexpr_define_classQ_118),LITREF(lit_273),T0,ENVNUL,PNUL,YPfalse);
  T3 = BOUNDP(YevalSsyntaxYsexpr_define_classQ);
  if (T3 != YPfalse) {
    T2 = VARREF(YevalSsyntaxYsexpr_define_classQ);
  } else {
    T2 = YPfalse;
  }
  T4 = fun_sexpr_define_classQ_118;
  T1 = XCALL2(1,VARREF(YPdefine_method),T2,T4);
  VARSET(YevalSsyntaxYsexpr_define_classQ,T1);
  lit_275 = YPPsym((P)"sexpr-define-class-parents");
  lit_276 = YPPlist(1,YPPsym((P)"exp"));
  T5 = YPsig(LITREF(lit_276),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_define_class_parents_119 = YPmet(FUNCODEREF(fun_sexpr_define_class_parents_119),LITREF(lit_275),T5,ENVNUL,PNUL,YPfalse);
  T8 = BOUNDP(YevalSsyntaxYsexpr_define_class_parents);
  if (T8 != YPfalse) {
    T7 = VARREF(YevalSsyntaxYsexpr_define_class_parents);
  } else {
    T7 = YPfalse;
  }
  T9 = fun_sexpr_define_class_parents_119;
  T6 = XCALL2(1,VARREF(YPdefine_method),T7,T9);
  VARSET(YevalSsyntaxYsexpr_define_class_parents,T6);
  lit_277 = YPPsym((P)"dp");
  VARSET(YevalSsyntaxYDsexpr_prop_tag,LITREF(lit_277));
  lit_278 = YPPsym((P)"sexpr-prop?");
  lit_279 = YPPlist(1,YPPsym((P)"exp"));
  T10 = YPsig(LITREF(lit_279),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_propQ_120 = YPmet(FUNCODEREF(fun_sexpr_propQ_120),LITREF(lit_278),T10,ENVNUL,PNUL,YPfalse);
  T13 = BOUNDP(YevalSsyntaxYsexpr_propQ);
  if (T13 != YPfalse) {
    T12 = VARREF(YevalSsyntaxYsexpr_propQ);
  } else {
    T12 = YPfalse;
  }
  T14 = fun_sexpr_propQ_120;
  T11 = XCALL2(1,VARREF(YPdefine_method),T12,T14);
  VARSET(YevalSsyntaxYsexpr_propQ,T11);
  lit_280 = YPPsym((P)"sexpr-prop-name");
  lit_281 = YPPlist(1,YPPsym((P)"exp"));
  T15 = YPsig(LITREF(lit_281),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLsymG),Ynil);
  fun_sexpr_prop_name_121 = YPmet(FUNCODEREF(fun_sexpr_prop_name_121),LITREF(lit_280),T15,ENVNUL,PNUL,YPfalse);
  T18 = BOUNDP(YevalSsyntaxYsexpr_prop_name);
  if (T18 != YPfalse) {
    T17 = VARREF(YevalSsyntaxYsexpr_prop_name);
  } else {
    T17 = YPfalse;
  }
  T19 = fun_sexpr_prop_name_121;
  T16 = XCALL2(1,VARREF(YPdefine_method),T17,T19);
  VARSET(YevalSsyntaxYsexpr_prop_name,T16);
  lit_282 = YPPsym((P)"sexpr-prop-owner");
  lit_283 = YPPlist(1,YPPsym((P)"exp"));
  T20 = YPsig(LITREF(lit_283),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_prop_owner_122 = YPmet(FUNCODEREF(fun_sexpr_prop_owner_122),LITREF(lit_282),T20,ENVNUL,PNUL,YPfalse);
  T23 = BOUNDP(YevalSsyntaxYsexpr_prop_owner);
  if (T23 != YPfalse) {
    T22 = VARREF(YevalSsyntaxYsexpr_prop_owner);
  } else {
    T22 = YPfalse;
  }
  T24 = fun_sexpr_prop_owner_122;
  T21 = XCALL2(1,VARREF(YPdefine_method),T22,T24);
  VARSET(YevalSsyntaxYsexpr_prop_owner,T21);
  lit_284 = YPPsym((P)"sexpr-prop-init-var");
  lit_285 = YPPlist(1,YPPsym((P)"exp"));
  lit_286 = YPPsym((P)"_x");
  T25 = YPsig(LITREF(lit_285),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_prop_init_var_123 = YPmet(FUNCODEREF(fun_sexpr_prop_init_var_123),LITREF(lit_284),T25,ENVNUL,PNUL,YPfalse);
  T28 = BOUNDP(YevalSsyntaxYsexpr_prop_init_var);
  if (T28 != YPfalse) {
    T27 = VARREF(YevalSsyntaxYsexpr_prop_init_var);
  } else {
    T27 = YPfalse;
  }
  T29 = fun_sexpr_prop_init_var_123;
  T26 = XCALL2(1,VARREF(YPdefine_method),T27,T29);
  VARSET(YevalSsyntaxYsexpr_prop_init_var,T26);
  lit_287 = YPPsym((P)"sexpr-prop-type");
  lit_288 = YPPlist(1,YPPsym((P)"exp"));
  T30 = YPsig(LITREF(lit_288),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_prop_type_124 = YPmet(FUNCODEREF(fun_sexpr_prop_type_124),LITREF(lit_287),T30,ENVNUL,PNUL,YPfalse);
  T33 = BOUNDP(YevalSsyntaxYsexpr_prop_type);
  if (T33 != YPfalse) {
    T32 = VARREF(YevalSsyntaxYsexpr_prop_type);
  } else {
    T32 = YPfalse;
  }
  T34 = fun_sexpr_prop_type_124;
  T31 = XCALL2(1,VARREF(YPdefine_method),T32,T34);
  VARSET(YevalSsyntaxYsexpr_prop_type,T31);
  lit_289 = YPPsym((P)"sexpr-prop-init?");
  lit_290 = YPPlist(1,YPPsym((P)"exp"));
  T35 = YPsig(LITREF(lit_290),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_prop_initQ_125 = YPmet(FUNCODEREF(fun_sexpr_prop_initQ_125),LITREF(lit_289),T35,ENVNUL,PNUL,YPfalse);
  T38 = BOUNDP(YevalSsyntaxYsexpr_prop_initQ);
  if (T38 != YPfalse) {
    T37 = VARREF(YevalSsyntaxYsexpr_prop_initQ);
  } else {
    T37 = YPfalse;
  }
  T39 = fun_sexpr_prop_initQ_125;
  T36 = XCALL2(1,VARREF(YPdefine_method),T37,T39);
  VARSET(YevalSsyntaxYsexpr_prop_initQ,T36);
  lit_291 = YPPsym((P)"sexpr-prop-init");
  lit_292 = YPPlist(1,YPPsym((P)"exp"));
  T40 = YPsig(LITREF(lit_292),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_prop_init_126 = YPmet(FUNCODEREF(fun_sexpr_prop_init_126),LITREF(lit_291),T40,ENVNUL,PNUL,YPfalse);
  T43 = BOUNDP(YevalSsyntaxYsexpr_prop_init);
  if (T43 != YPfalse) {
    T42 = VARREF(YevalSsyntaxYsexpr_prop_init);
  } else {
    T42 = YPfalse;
  }
  T44 = fun_sexpr_prop_init_126;
  T41 = XCALL2(1,VARREF(YPdefine_method),T42,T44);
  VARSET(YevalSsyntaxYsexpr_prop_init,T41);
  lit_293 = YPPsym((P)"sexpr-fab-getter");
  lit_294 = YPPlist(2,YPPsym((P)"name"),YPPsym((P)"type"));
  lit_295 = YPPsym((P)"prop-value");
  T45 = YPsig(LITREF(lit_294),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLlstG),Ynil);
  fun_sexpr_fab_getter_127 = YPmet(FUNCODEREF(fun_sexpr_fab_getter_127),LITREF(lit_293),T45,ENVNUL,PNUL,YPfalse);
  T48 = BOUNDP(YevalSsyntaxYsexpr_fab_getter);
  if (T48 != YPfalse) {
    T47 = VARREF(YevalSsyntaxYsexpr_fab_getter);
  } else {
    T47 = YPfalse;
  }
  T49 = fun_sexpr_fab_getter_127;
  T46 = XCALL2(1,VARREF(YPdefine_method),T47,T49);
  VARSET(YevalSsyntaxYsexpr_fab_getter,T46);
  lit_296 = YPPsym((P)"sexpr-fab-setter");
  lit_297 = YPPlist(3,YPPsym((P)"name"),YPPsym((P)"type"),YPPsym((P)"prop-type"));
  lit_298 = YPPsym((P)"_z");
  lit_299 = YPPsym((P)"prop-value-setter");
  T50 = YPsig(LITREF(lit_297),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLlstG),Ynil);
  fun_sexpr_fab_setter_128 = YPmet(FUNCODEREF(fun_sexpr_fab_setter_128),LITREF(lit_296),T50,ENVNUL,PNUL,YPfalse);
  T53 = BOUNDP(YevalSsyntaxYsexpr_fab_setter);
  if (T53 != YPfalse) {
    T52 = VARREF(YevalSsyntaxYsexpr_fab_setter);
  } else {
    T52 = YPfalse;
  }
  T54 = fun_sexpr_fab_setter_128;
  T51 = XCALL2(1,VARREF(YPdefine_method),T52,T54);
  VARSET(YevalSsyntaxYsexpr_fab_setter,T51);
  lit_300 = YPPsym((P)"sexpr-fab-setter-name");
  lit_301 = YPPlist(1,YPPsym((P)"name"));
  lit_302 = YPsb((P)"-setter");
  T55 = YPsig(LITREF(lit_301),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLsymG),Ynil);
  fun_sexpr_fab_setter_name_129 = YPmet(FUNCODEREF(fun_sexpr_fab_setter_name_129),LITREF(lit_300),T55,ENVNUL,PNUL,YPfalse);
  T58 = BOUNDP(YevalSsyntaxYsexpr_fab_setter_name);
  if (T58 != YPfalse) {
    T57 = VARREF(YevalSsyntaxYsexpr_fab_setter_name);
  } else {
    T57 = YPfalse;
  }
  T59 = fun_sexpr_fab_setter_name_129;
  T56 = XCALL2(1,VARREF(YPdefine_method),T57,T59);
  VARSET(YevalSsyntaxYsexpr_fab_setter_name,T56);
  lit_303 = YPPsym((P)"sexpr-macro?");
  lit_304 = YPPlist(1,YPPsym((P)"exp"));
  T60 = YPsig(LITREF(lit_304),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_macroQ_130 = YPmet(FUNCODEREF(fun_sexpr_macroQ_130),LITREF(lit_303),T60,ENVNUL,PNUL,YPfalse);
  T63 = BOUNDP(YevalSsyntaxYsexpr_macroQ);
  if (T63 != YPfalse) {
    T62 = VARREF(YevalSsyntaxYsexpr_macroQ);
  } else {
    T62 = YPfalse;
  }
  T64 = fun_sexpr_macroQ_130;
  T61 = XCALL2(1,VARREF(YPdefine_method),T62,T64);
  VARSET(YevalSsyntaxYsexpr_macroQ,T61);
  lit_305 = YPPsym((P)"macro-expand");
  VARSET(YevalSsyntaxYDsexpr_macro_expand_tag,LITREF(lit_305));
  lit_306 = YPPsym((P)"sexpr-macro-expand?");
  lit_307 = YPPlist(1,YPPsym((P)"exp"));
  T65 = YPsig(LITREF(lit_307),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_macro_expandQ_131 = YPmet(FUNCODEREF(fun_sexpr_macro_expandQ_131),LITREF(lit_306),T65,ENVNUL,PNUL,YPfalse);
  T68 = BOUNDP(YevalSsyntaxYsexpr_macro_expandQ);
  if (T68 != YPfalse) {
    T67 = VARREF(YevalSsyntaxYsexpr_macro_expandQ);
  } else {
    T67 = YPfalse;
  }
  T69 = fun_sexpr_macro_expandQ_131;
  T66 = XCALL2(1,VARREF(YPdefine_method),T67,T69);
  VARSET(YevalSsyntaxYsexpr_macro_expandQ,T66);
  lit_308 = YPPsym((P)"mif");
  VARSET(YevalSsyntaxYDsexpr_syntax_if_tag,LITREF(lit_308));
  lit_309 = YPPsym((P)"sexpr-make-syntax-if");
  lit_310 = YPPlist(4,YPPsym((P)"pat"),YPPsym((P)"exp"),YPPsym((P)"then"),YPPsym((P)"else"));
  T70 = YPsig(LITREF(lit_310),YPPlist(4,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)4),VARREF(YLlstG),Ynil);
  fun_sexpr_make_syntax_if_132 = YPmet(FUNCODEREF(fun_sexpr_make_syntax_if_132),LITREF(lit_309),T70,ENVNUL,PNUL,YPfalse);
  T73 = BOUNDP(YevalSsyntaxYsexpr_make_syntax_if);
  if (T73 != YPfalse) {
    T72 = VARREF(YevalSsyntaxYsexpr_make_syntax_if);
  } else {
    T72 = YPfalse;
  }
  T74 = fun_sexpr_make_syntax_if_132;
  T71 = XCALL2(1,VARREF(YPdefine_method),T72,T74);
  VARSET(YevalSsyntaxYsexpr_make_syntax_if,T71);
  lit_311 = YPPsym((P)"comma-atsign");
  VARSET(YevalSsyntaxYTcomma_atsignT,LITREF(lit_311));
  lit_312 = YPPsym((P)"bq-list");
  VARSET(YevalSsyntaxYTbq_listT,LITREF(lit_312));
  lit_313 = YPPsym((P)"bq-list*");
  VARSET(YevalSsyntaxYTbq_listTT,LITREF(lit_313));
  lit_314 = YPPsym((P)"bq-append");
  VARSET(YevalSsyntaxYTbq_appendT,LITREF(lit_314));
  lit_315 = YPPsym((P)"bq-nconc");
  VARSET(YevalSsyntaxYTbq_nconcT,LITREF(lit_315));
  lit_316 = YPPsym((P)"bq-clobberable");
  VARSET(YevalSsyntaxYTbq_clobberableT,LITREF(lit_316));
  lit_317 = YPPsym((P)"bq-quote");
  VARSET(YevalSsyntaxYTbq_quoteT,LITREF(lit_317));
  lit_318 = YPPsym((P)"sexpr-expand-backquote");
  lit_319 = YPPlist(1,YPPsym((P)"x"));
  lit_320 = YPPsym((P)"goo");
  T75 = YPsig(LITREF(lit_319),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  YevalSsyntaxYsexpr_expand_backquote = YPmet(FUNCODEREF(YevalSsyntaxYsexpr_expand_backquote),LITREF(lit_318),T75,ENVNUL,PNUL,YPfalse);
  T76 = YevalSsyntaxYsexpr_expand_backquote;
  VARSET(YevalSsyntaxYsexpr_expand_backquote,T76);
  lit_321 = YPPsym((P)"sexpr-build-backquote-expander");
  lit_322 = YPPlist(1,YPPsym((P)"x"));
  T77 = YPsig(LITREF(lit_322),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_build_backquote_expander_134 = YPmet(FUNCODEREF(fun_sexpr_build_backquote_expander_134),LITREF(lit_321),T77,ENVNUL,PNUL,YPfalse);
  T80 = BOUNDP(YevalSsyntaxYsexpr_build_backquote_expander);
  if (T80 != YPfalse) {
    T79 = VARREF(YevalSsyntaxYsexpr_build_backquote_expander);
  } else {
    T79 = YPfalse;
  }
  T81 = fun_sexpr_build_backquote_expander_134;
  T78 = XCALL2(1,VARREF(YPdefine_method),T79,T81);
  VARSET(YevalSsyntaxYsexpr_build_backquote_expander,T78);
  lit_323 = YPPsym((P)"sexpr-unquote?");
  lit_324 = YPPlist(1,YPPsym((P)"x"));
  lit_325 = YPPsym((P)"unquote");
  T82 = YPsig(LITREF(lit_324),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_unquoteQ_135 = YPmet(FUNCODEREF(fun_sexpr_unquoteQ_135),LITREF(lit_323),T82,ENVNUL,PNUL,YPfalse);
  T85 = BOUNDP(YevalSsyntaxYsexpr_unquoteQ);
  if (T85 != YPfalse) {
    T84 = VARREF(YevalSsyntaxYsexpr_unquoteQ);
  } else {
    T84 = YPfalse;
  }
  T86 = fun_sexpr_unquoteQ_135;
  T83 = XCALL2(1,VARREF(YPdefine_method),T84,T86);
  VARSET(YevalSsyntaxYsexpr_unquoteQ,T83);
  lit_326 = YPPsym((P)"sexpr-unquote-splicing?");
  lit_327 = YPPlist(1,YPPsym((P)"x"));
  lit_328 = YPPsym((P)"unquote-splicing");
  T87 = YPsig(LITREF(lit_327),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_unquote_splicingQ_136 = YPmet(FUNCODEREF(fun_sexpr_unquote_splicingQ_136),LITREF(lit_326),T87,ENVNUL,PNUL,YPfalse);
  T90 = BOUNDP(YevalSsyntaxYsexpr_unquote_splicingQ);
  if (T90 != YPfalse) {
    T89 = VARREF(YevalSsyntaxYsexpr_unquote_splicingQ);
  } else {
    T89 = YPfalse;
  }
  T91 = fun_sexpr_unquote_splicingQ_136;
  T88 = XCALL2(1,VARREF(YPdefine_method),T89,T91);
  VARSET(YevalSsyntaxYsexpr_unquote_splicingQ,T88);
  lit_329 = YPPsym((P)"sexpr-backquote?");
  lit_330 = YPPlist(1,YPPsym((P)"x"));
  T92 = YPsig(LITREF(lit_330),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_backquoteQ_137 = YPmet(FUNCODEREF(fun_sexpr_backquoteQ_137),LITREF(lit_329),T92,ENVNUL,PNUL,YPfalse);
  T95 = BOUNDP(YevalSsyntaxYsexpr_backquoteQ);
  if (T95 != YPfalse) {
    T94 = VARREF(YevalSsyntaxYsexpr_backquoteQ);
  } else {
    T94 = YPfalse;
  }
  T96 = fun_sexpr_backquoteQ_137;
  T93 = XCALL2(1,VARREF(YPdefine_method),T94,T96);
  VARSET(YevalSsyntaxYsexpr_backquoteQ,T93);
  lit_331 = YPPsym((P)"sexpr-atom?");
  lit_332 = YPPlist(1,YPPsym((P)"x"));
  T97 = YPsig(LITREF(lit_332),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_atomQ_138 = YPmet(FUNCODEREF(fun_sexpr_atomQ_138),LITREF(lit_331),T97,ENVNUL,PNUL,YPfalse);
  T100 = BOUNDP(YevalSsyntaxYsexpr_atomQ);
  if (T100 != YPfalse) {
    T99 = VARREF(YevalSsyntaxYsexpr_atomQ);
  } else {
    T99 = YPfalse;
  }
  T101 = fun_sexpr_atomQ_138;
  T98 = XCALL2(1,VARREF(YPdefine_method),T99,T101);
  VARSET(YevalSsyntaxYsexpr_atomQ,T98);
  lit_333 = YPPsym((P)"nreconc");
  lit_334 = YPPlist(2,YPPsym((P)"x"),YPPsym((P)"y"));
  T102 = YPsig(LITREF(lit_334),YPPlist(2,VARREF(YLlstG),VARREF(YLlstG)),YPfalse,YPint((P)2),VARREF(YLlstG),Ynil);
  fun_nreconc_139 = YPmet(FUNCODEREF(fun_nreconc_139),LITREF(lit_333),T102,ENVNUL,PNUL,YPfalse);
  T105 = BOUNDP(YevalSsyntaxYnreconc);
  if (T105 != YPfalse) {
    T104 = VARREF(YevalSsyntaxYnreconc);
  } else {
    T104 = YPfalse;
  }
  T106 = fun_nreconc_139;
  T103 = XCALL2(1,VARREF(YPdefine_method),T104,T106);
  VARSET(YevalSsyntaxYnreconc,T103);
  lit_335 = YPPsym((P)"bq-process");
  lit_336 = YPPlist(1,YPPsym((P)"x"));
  lit_337 = YPsb((P)"UNQUOTE-SPLICING %= AFTER BQ");
  lit_338 = YPPlist(1,YPPsym((P)"return"));
  lit_339 = YPPlist(2,YPPsym((P)"p"),YPPsym((P)"q"));
  lit_340 = YPsb((P)"Malformed ,%=");
  lit_341 = YPsb((P)"Dotted ,@%=");
  T109 = YPsig(LITREF(lit_339),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_loop_140 = YPmet(FUNCODEREF(fun_loop_140),LITREF(lit_218),T109,ENVNUL,PNUL,YPfalse);
  T108 = YPsig(LITREF(lit_338),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_141 = YPmet(FUNCODEREF(fun_141),YPfalse,T108,ENVNUL,PNUL,YPfalse);
  T107 = YPsig(LITREF(lit_336),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_bq_process_142 = YPmet(FUNCODEREF(fun_bq_process_142),LITREF(lit_335),T107,ENVNUL,PNUL,YPfalse);
  T112 = BOUNDP(YevalSsyntaxYbq_process);
  if (T112 != YPfalse) {
    T111 = VARREF(YevalSsyntaxYbq_process);
  } else {
    T111 = YPfalse;
  }
  T113 = fun_bq_process_142;
  T110 = XCALL2(1,VARREF(YPdefine_method),T111,T113);
  VARSET(YevalSsyntaxYbq_process,T110);
  lit_342 = YPPsym((P)"bracket");
  lit_343 = YPPlist(1,YPPsym((P)"x"));
  T114 = YPsig(LITREF(lit_343),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_bracket_143 = YPmet(FUNCODEREF(fun_bracket_143),LITREF(lit_342),T114,ENVNUL,PNUL,YPfalse);
  T117 = BOUNDP(YevalSsyntaxYbracket);
  if (T117 != YPfalse) {
    T116 = VARREF(YevalSsyntaxYbracket);
  } else {
    T116 = YPfalse;
  }
  T118 = fun_bracket_143;
  T115 = XCALL2(1,VARREF(YPdefine_method),T116,T118);
  VARSET(YevalSsyntaxYbracket,T115);
  lit_344 = YPPsym((P)"map-tree");
  lit_345 = YPPlist(2,YPPsym((P)"fn"),YPPsym((P)"x"));
  T119 = YPsig(LITREF(lit_345),YPPlist(2,VARREF(YLfunG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_map_tree_144 = YPmet(FUNCODEREF(fun_map_tree_144),LITREF(lit_344),T119,ENVNUL,PNUL,YPfalse);
  T122 = BOUNDP(YevalSsyntaxYmap_tree);
  if (T122 != YPfalse) {
    T121 = VARREF(YevalSsyntaxYmap_tree);
  } else {
    T121 = YPfalse;
  }
  T123 = fun_map_tree_144;
  T120 = XCALL2(1,VARREF(YPdefine_method),T121,T123);
  VARSET(YevalSsyntaxYmap_tree,T120);
  lit_346 = YPPsym((P)"bq-remove-tokens");
  lit_347 = YPPlist(1,YPPsym((P)"x"));
  lit_348 = YPPsym((P)"cat");
  lit_349 = YPPsym((P)"cat!");
  lit_350 = YPPsym((P)"list*");
  lit_351 = YPPsym((P)"pair");
  T124 = YPsig(LITREF(lit_347),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_bq_remove_tokens_145 = YPmet(FUNCODEREF(fun_bq_remove_tokens_145),LITREF(lit_346),T124,ENVNUL,PNUL,YPfalse);
  T127 = BOUNDP(YevalSsyntaxYbq_remove_tokens);
  if (T127 != YPfalse) {
    T126 = VARREF(YevalSsyntaxYbq_remove_tokens);
  } else {
    T126 = YPfalse;
  }
  T128 = fun_bq_remove_tokens_145;
  T125 = XCALL2(1,VARREF(YPdefine_method),T126,T128);
  VARSET(YevalSsyntaxYbq_remove_tokens,T125);
  lit_352 = YPPsym((P)"sexpr-syntax-if?");
  lit_353 = YPPlist(1,YPPsym((P)"exp"));
  T129 = YPsig(LITREF(lit_353),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_syntax_ifQ_146 = YPmet(FUNCODEREF(fun_sexpr_syntax_ifQ_146),LITREF(lit_352),T129,ENVNUL,PNUL,YPfalse);
  T132 = BOUNDP(YevalSsyntaxYsexpr_syntax_ifQ);
  if (T132 != YPfalse) {
    T131 = VARREF(YevalSsyntaxYsexpr_syntax_ifQ);
  } else {
    T131 = YPfalse;
  }
  T133 = fun_sexpr_syntax_ifQ_146;
  T130 = XCALL2(1,VARREF(YPdefine_method),T131,T133);
  VARSET(YevalSsyntaxYsexpr_syntax_ifQ,T130);
  lit_354 = YPPsym((P)"sexpr-syntax-if-value");
  lit_355 = YPPlist(1,YPPsym((P)"exp"));
  T134 = YPsig(LITREF(lit_355),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_syntax_if_value_147 = YPmet(FUNCODEREF(fun_sexpr_syntax_if_value_147),LITREF(lit_354),T134,ENVNUL,PNUL,YPfalse);
  T137 = BOUNDP(YevalSsyntaxYsexpr_syntax_if_value);
  if (T137 != YPfalse) {
    T136 = VARREF(YevalSsyntaxYsexpr_syntax_if_value);
  } else {
    T136 = YPfalse;
  }
  T138 = fun_sexpr_syntax_if_value_147;
  T135 = XCALL2(1,VARREF(YPdefine_method),T136,T138);
  VARSET(YevalSsyntaxYsexpr_syntax_if_value,T135);
  lit_356 = YPPsym((P)"sexpr-syntax-if-pattern");
  lit_357 = YPPlist(1,YPPsym((P)"exp"));
  T139 = YPsig(LITREF(lit_357),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_syntax_if_pattern_148 = YPmet(FUNCODEREF(fun_sexpr_syntax_if_pattern_148),LITREF(lit_356),T139,ENVNUL,PNUL,YPfalse);
  T142 = BOUNDP(YevalSsyntaxYsexpr_syntax_if_pattern);
  if (T142 != YPfalse) {
    T141 = VARREF(YevalSsyntaxYsexpr_syntax_if_pattern);
  } else {
    T141 = YPfalse;
  }
  T143 = fun_sexpr_syntax_if_pattern_148;
  T140 = XCALL2(1,VARREF(YPdefine_method),T141,T143);
  VARSET(YevalSsyntaxYsexpr_syntax_if_pattern,T140);
  lit_358 = YPPsym((P)"sexpr-syntax-if-then");
  lit_359 = YPPlist(1,YPPsym((P)"exp"));
  T144 = YPsig(LITREF(lit_359),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_syntax_if_then_149 = YPmet(FUNCODEREF(fun_sexpr_syntax_if_then_149),LITREF(lit_358),T144,ENVNUL,PNUL,YPfalse);
  T147 = BOUNDP(YevalSsyntaxYsexpr_syntax_if_then);
  if (T147 != YPfalse) {
    T146 = VARREF(YevalSsyntaxYsexpr_syntax_if_then);
  } else {
    T146 = YPfalse;
  }
  T148 = fun_sexpr_syntax_if_then_149;
  T145 = XCALL2(1,VARREF(YPdefine_method),T146,T148);
  VARSET(YevalSsyntaxYsexpr_syntax_if_then,T145);
  lit_360 = YPPsym((P)"sexpr-syntax-if-else");
  lit_361 = YPPlist(1,YPPsym((P)"exp"));
  T149 = YPsig(LITREF(lit_361),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_syntax_if_else_150 = YPmet(FUNCODEREF(fun_sexpr_syntax_if_else_150),LITREF(lit_360),T149,ENVNUL,PNUL,YPfalse);
  T152 = BOUNDP(YevalSsyntaxYsexpr_syntax_if_else);
  if (T152 != YPfalse) {
    T151 = VARREF(YevalSsyntaxYsexpr_syntax_if_else);
  } else {
    T151 = YPfalse;
  }
  T153 = fun_sexpr_syntax_if_else_150;
  T150 = XCALL2(1,VARREF(YPdefine_method),T151,T153);
  VARSET(YevalSsyntaxYsexpr_syntax_if_else,T150);
  lit_362 = YPPsym((P)"sexpr-pattern-variable?");
  lit_363 = YPPlist(1,YPPsym((P)"pat"));
  T154 = YPsig(LITREF(lit_363),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_sexpr_pattern_variableQ_151 = YPmet(FUNCODEREF(fun_sexpr_pattern_variableQ_151),LITREF(lit_362),T154,ENVNUL,PNUL,YPfalse);
  T157 = BOUNDP(YevalSsyntaxYsexpr_pattern_variableQ);
  if (T157 != YPfalse) {
    T156 = VARREF(YevalSsyntaxYsexpr_pattern_variableQ);
  } else {
    T156 = YPfalse;
  }
  T158 = fun_sexpr_pattern_variableQ_151;
  T155 = XCALL2(1,VARREF(YPdefine_method),T156,T158);
  VARSET(YevalSsyntaxYsexpr_pattern_variableQ,T155);
  lit_364 = YPPsym((P)"sexpr-pattern-variable-name");
  lit_365 = YPPlist(1,YPPsym((P)"pat"));
  T159 = YPsig(LITREF(lit_365),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_sexpr_pattern_variable_name_152 = YPmet(FUNCODEREF(fun_sexpr_pattern_variable_name_152),LITREF(lit_364),T159,ENVNUL,PNUL,YPfalse);
  T162 = BOUNDP(YevalSsyntaxYsexpr_pattern_variable_name);
  if (T162 != YPfalse) {
    T161 = VARREF(YevalSsyntaxYsexpr_pattern_variable_name);
  } else {
    T161 = YPfalse;
  }
  T163 = fun_sexpr_pattern_variable_name_152;
  T160 = XCALL2(1,VARREF(YPdefine_method),T161,T163);
  VARSET(YevalSsyntaxYsexpr_pattern_variable_name,T160);
  lit_366 = YPPsym((P)"sexpr-bind-pattern-variables");
  lit_367 = YPPlist(1,YPPsym((P)"pat"));
  lit_368 = YPPlist(1,YPPsym((P)"pat"));
  T165 = YPsig(LITREF(lit_368),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_col_153 = YPmet(FUNCODEREF(fun_col_153),LITREF(lit_230),T165,ENVNUL,PNUL,YPfalse);
  T164 = YPsig(LITREF(lit_367),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  fun_sexpr_bind_pattern_variables_154 = YPmet(FUNCODEREF(fun_sexpr_bind_pattern_variables_154),LITREF(lit_366),T164,ENVNUL,PNUL,YPfalse);
  T168 = BOUNDP(YevalSsyntaxYsexpr_bind_pattern_variables);
  if (T168 != YPfalse) {
    T167 = VARREF(YevalSsyntaxYsexpr_bind_pattern_variables);
  } else {
    T167 = YPfalse;
  }
  T169 = fun_sexpr_bind_pattern_variables_154;
  T166 = XCALL2(1,VARREF(YPdefine_method),T167,T169);
  VARSET(YevalSsyntaxYsexpr_bind_pattern_variables,T166);
  lit_369 = YPPsym((P)"sexpr-make-macro-function");
  lit_370 = YPPlist(2,YPPsym((P)"name"),YPPsym((P)"exp"));
  lit_371 = YPPsym((P)"exp");
  lit_372 = YPPsym((P)"macro-error");
  T170 = YPsig(LITREF(lit_370),YPPlist(2,VARREF(YLanyG),VARREF(YLlstG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_sexpr_make_macro_function_155 = YPmet(FUNCODEREF(fun_sexpr_make_macro_function_155),LITREF(lit_369),T170,ENVNUL,PNUL,YPfalse);
  T173 = BOUNDP(YevalSsyntaxYsexpr_make_macro_function);
  if (T173 != YPfalse) {
    T172 = VARREF(YevalSsyntaxYsexpr_make_macro_function);
  } else {
    T172 = YPfalse;
  }
  T174 = fun_sexpr_make_macro_function_155;
  T171 = XCALL2(1,VARREF(YPdefine_method),T172,T174);
  VARSET(YevalSsyntaxYsexpr_make_macro_function,T171);
  tmpF2439 = YPfalse;
  if (tmpF2439 != YPfalse) {
    T175 = VARREF(YevalSsyntaxYeval);
  } else {
    T175 = YPfalse;
  }
  T176 = YPfalse;
