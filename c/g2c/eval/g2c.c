...
/* MODULE ENVIRONMENT: compiler/p2c */
...
DEF(YcompilerSp2cYDescape_separator,"compiler/p2c","$escape-separator");
EXT(YPisa,"runtime/boot","%isa");
DEF(YcompilerSp2cYfloat_to_c_string,"compiler/p2c","float-to-c-string");
...
DEF(YcompilerSp2cYmodule_src_file_setter,"compiler/p2c","module-src-file-setter");
EXT(YgooSmathYatan,"goo/math","atan");
DEF(YcompilerSp2cYTtrace_registersQT,"compiler/p2c","*trace-registers?*");
...
DEF(YcompilerSp2cYcompute_ast,"compiler/p2c","compute-ast");
EXT(YcompilerSastYmonitor_handler,"compiler/ast","monitor-handler");
EXT(YgooSmathYrem,"goo/math","rem");
DEF(YcompilerSp2cYmangle_local_name,"compiler/p2c","mangle-local-name");
...
DEF(YcompilerSp2cYgenerate_function_binding,"compiler/p2c","generate-function-binding");
...
DEF(YcompilerSp2cYmangle_integer,"compiler/p2c","mangle-integer");
...
DEF(YcompilerSp2cYg2c_top,"compiler/p2c","g2c-top");
...
DEF(YcompilerSp2cYDmethod_mangled_marker,"compiler/p2c","$method-mangled-marker");
EXT(YcompilerSastYmonitor_test,"compiler/ast","monitor-test");
EXT(YgooSmathYlowerQ,"goo/math","lower?");
DEF(YcompilerSp2cYbinding_Gc,"compiler/p2c","binding->c");
EXT(YcompilerStopYg2c_eval,"compiler/top","g2c-eval");
EXT(YgooSmathYabs,"goo/math","abs");
EXT(Yhead,"runtime/boot","head");
DEF(YcompilerSp2cYgenerate_trailer,"compiler/p2c","generate-trailer");
...
DEF(YcompilerSp2cYTdynamic_linkingQT,"compiler/p2c","*dynamic-linking?*");
...
DEF(YcompilerSp2cYDnumber_characters,"compiler/p2c","$number-characters");
EXT(YcompilerSastYfunction_signature_setter,"compiler/ast","function-signature-setter");
DEF(YcompilerSp2cYgenerate_function_specs,"compiler/p2c","generate-function-specs");
...
DEF(YcompilerSp2cYgenerate_functions,"compiler/p2c","generate-functions");
...
DEF(YcompilerSp2cYmodule_up_to_dateQ,"compiler/p2c","module-up-to-date?");
...
DEF(YcompilerSp2cYso_load,"compiler/p2c","so-load");
...
DEF(YcompilerSp2cYDhygiene_char,"compiler/p2c","$hygiene-char");
...
DEF(YcompilerSp2cYDmodule_marker,"compiler/p2c","$module-marker");
DEF(YcompilerSp2cYmangle_boot_name,"compiler/p2c","mangle-boot-name");
EXT(YgooSportYout,"goo/port","out");
EXT(YPPmacro,"runtime/boot","%%macro");
DEF(YcompilerSp2cYDmin_character_code,"compiler/p2c","$min-character-code");
...
DEF(YcompilerSp2cYmangle_raw_name,"compiler/p2c","mangle-raw-name");
EXT(YgooSmathYas_log,"goo/math","as-log");
EXT(YPsymbols,"runtime/boot","%symbols");
DEF(YcompilerSp2cYmangle_name_into,"compiler/p2c","mangle-name-into");
...
DEF(YcompilerSp2cYLg2c_moduleG,"compiler/p2c","<g2c-module>");
...
DEF(YcompilerSp2cYgen_fab_list,"compiler/p2c","gen-fab-list");
...
DEF(YcompilerSp2cYmodule_loader_app_modname_setter,"compiler/p2c","module-loader-app-modname-setter");
EXT(YruntimeSruntimeYlist_handlers,"runtime/runtime","list-handlers");
EXT(YgooSsystemYadd_src_path,"goo/system","add-src-path");
DEF(YcompilerSp2cYgenerate_function_body_reference,"compiler/p2c","generate-function-body-reference");
...
DEF(YcompilerSp2cYgenerate_function_bodies,"compiler/p2c","generate-function-bodies");
EXT(Ysig_specs,"runtime/boot","sig-specs");
EXT(Ytype_error,"runtime/boot","type-error");
EXT(YOlst,"runtime/boot","@lst");
DEF(YcompilerSp2cYTdefinitionsT,"compiler/p2c","*definitions*");
...
DEF(YcompilerSp2cYDnumber_call_templates,"compiler/p2c","$number-call-templates");
...
DEF(YcompilerSp2cYDname_mangler_table,"compiler/p2c","$name-mangler-table");
...
DEF(YcompilerSp2cYmodule_mtime_setter,"compiler/p2c","module-mtime-setter");
...
DEF(YcompilerSp2cYcompute_program,"compiler/p2c","compute-program");
EXT(Yfab_class,"runtime/boot","fab-class");
DEF(YcompilerSp2cYmodule_init_decl,"compiler/p2c","module-init-decl");
...
DEF(YcompilerSp2cYgenerate_module_init,"compiler/p2c","generate-module-init");
...
DEF(YcompilerSp2cYgenerate_closure_structure,"compiler/p2c","generate-closure-structure");
...
DEF(YcompilerSp2cYmangle_global_name,"compiler/p2c","mangle-global-name");
...
DEF(YcompilerSp2cYDescape_marker,"compiler/p2c","$escape-marker");
EXT(YgooSmathYfabs,"goo/math","fabs");
DEF(YcompilerSp2cYDmax_character_code,"compiler/p2c","$max-character-code");
...
DEF(YcompilerSp2cYgen_ref,"compiler/p2c","gen-ref");
...
DEF(YcompilerSp2cYgenerate_quotations,"compiler/p2c","generate-quotations");
...
DEF(YcompilerSp2cYmodule_loader_app_modname,"compiler/p2c","module-loader-app-modname");
DEF(YcompilerSp2cYto_c,"compiler/p2c","to-c");
EXT(YcompilerSastYalternative_consequent,"compiler/ast","alternative-consequent");
EXT(YgooSmathYDpi,"goo/math","$pi");
DEF(YcompilerSp2cYDlocal_marker,"compiler/p2c","$local-marker");
...
DEF(YcompilerSp2cYg2c_clean,"compiler/p2c","g2c-clean");
...
DEF(YcompilerSp2cYTmangle_bufferT,"compiler/p2c","*mangle-buffer*");
...
DEF(YcompilerSp2cYDhygiene_marker,"compiler/p2c","$hygiene-marker");
...
DEF(YcompilerSp2cYgenerate_global_environment,"compiler/p2c","generate-global-environment");
DEF(YcompilerSp2cYmangle_string_literal,"compiler/p2c","mangle-string-literal");
EXT(YgooSsystemYfile_mtime,"goo/system","file-mtime");
DEF(YcompilerSp2cYTg2c_appT,"compiler/p2c","*g2c-app*");
...
DEF(YcompilerSp2cYDiep_suffix,"compiler/p2c","$iep-suffix");
EXT(YLanyG,"runtime/boot","<any>");
EXT(Yprop_type,"runtime/boot","prop-type");
DEF(YcompilerSp2cYgenerate_shadow_args,"compiler/p2c","generate-shadow-args");
DEF(YcompilerSp2cYdeclare_imported_module_infos,"compiler/p2c","declare-imported-module-infos");
...
DEF(YcompilerSp2cYDmangles_data,"compiler/p2c","$mangles-data");
...
DEF(YcompilerSp2cYgenerate_header,"compiler/p2c","generate-header");
...
DEF(YcompilerSp2cYcompile_load,"compiler/p2c","compile-load");
EXT(YgooSsystemYcomponents_basename,"goo/system","components-basename");
EXT(YcompilerSastYLfix_letG,"compiler/ast","<fix-let>");
DEF(YcompilerSp2cYgenerate_makefile,"compiler/p2c","generate-makefile");
...
DEF(YcompilerSp2cYg2c_ast,"compiler/p2c","g2c-ast");
...
DEF(YcompilerSp2cYg2c_exp,"compiler/p2c","g2c-exp");
DEF(YcompilerSp2cYgenerate_quotation,"compiler/p2c","generate-quotation");
EXT(YcompilerSastYbinding_kind,"compiler/ast","binding-kind");
EXT(YLsigG,"runtime/boot","<sig>");
EXT(YgooSmacrosYelt,"goo/macros","elt");
DEF(YcompilerSp2cYg2c_build_app,"compiler/p2c","g2c-build-app");
EXT(YgooSmathYGG,"goo/math",">>");
DEF(YcompilerSp2cYg2c_test,"compiler/p2c","g2c-test");
...
DEF(YcompilerSp2cYDlocal_suffix,"compiler/p2c","$local-suffix");
DEF(YcompilerSp2cYmodule_info_name,"compiler/p2c","module-info-name");
EXT(YcompilerStopYload,"compiler/top","load");
EXT(YgooSportYLstr_in_portG,"goo/port","<str-in-port>");
DEF(YcompilerSp2cYg2c_def_app,"compiler/p2c","g2c-def-app");
EXT(YgooScollectionsStableYtab_gc_state,"goo/collections/table","tab-gc-state");
DEF(YcompilerSp2cYfuninit_to_c,"compiler/p2c","funinit-to-c");
EXT(YgooScollectionsScollectionYinto,"goo/collections/collection","into");
EXT(YgooSmathYneg,"goo/math","neg");
EXT(YgooSmathYE,"goo/math","=");
DEF(YcompilerSp2cYgenerate_quotation_forwards,"compiler/p2c","generate-quotation-forwards");
...
DEF(YcompilerSp2cYmodule_loader_appname,"compiler/p2c","module-loader-appname");
...
DEF(YcompilerSp2cYmodule_init_name,"compiler/p2c","module-init-name");
...
DEF(YcompilerSp2cYTtmp_file_counterT,"compiler/p2c","*tmp-file-counter*");
DEF(YcompilerSp2cYgenerate_c_module,"compiler/p2c","generate-c-module");
...
DEF(YcompilerSp2cYgenerate_global_binding,"compiler/p2c","generate-global-binding");
...
DEF(YcompilerSp2cYgenerate_local_temporaries,"compiler/p2c","generate-local-temporaries");
EXT(YgooSsystemYgoo_filename,"goo/system","goo-filename");
DEF(YcompilerSp2cYgenerate_main,"compiler/p2c","generate-main");
EXT(YgooSmathYC,"goo/math","^");
DEF(YcompilerSp2cYgenerate_function_forward,"compiler/p2c","generate-function-forward");
...
DEF(YcompilerSp2cYgenerate_function_forwards,"compiler/p2c","generate-function-forwards");
...
DEF(YcompilerSp2cYout_list_builder,"compiler/p2c","out-list-builder");
...
DEF(YcompilerSp2cYDmethod_mangled_marker_string,"compiler/p2c","$method-mangled-marker-string");
EXT(YcompilerSastYprogram_type,"compiler/ast","program-type");
DEF(YcompilerSp2cYTregisters_per_lineT,"compiler/p2c","*registers-per-line*");
...
DEF(YcompilerSp2cYgenerate_self_recursive_call,"compiler/p2c","generate-self-recursive-call");
...
DEF(YcompilerSp2cYgen_result,"compiler/p2c","gen-result");
...
DEF(YcompilerSp2cYmodule_loader_appname_setter,"compiler/p2c","module-loader-appname-setter");
...
DEF(YcompilerSp2cYLg2c_module_loaderG,"compiler/p2c","<g2c-module-loader>");
EXT(YgooSmathYto_upper,"goo/math","to-upper");
EXT(YgooStypeYtA,"goo/type","t+");
EXT(YgooSmathYNEE,"goo/math","~==");
EXT(YcompilerSastYsignature_arity,"compiler/ast","signature-arity");
DEF(YcompilerSp2cYmangle_module_binding,"compiler/p2c","mangle-module-binding");
...
DEF(YcompilerSp2cYprimitive_inlinableQ,"compiler/p2c","primitive-inlinable?");
...
DEF(YcompilerSp2cYdispatcherQ,"compiler/p2c","dispatcher?");
...
DEF(YcompilerSp2cYmangler_reset,"compiler/p2c","mangler-reset");
EXT(YcompilerSastYLsequentialG,"compiler/ast","<sequential>");
DEF(YcompilerSp2cYfunshell_to_c,"compiler/p2c","funshell-to-c");
...
DEF(YcompilerSp2cYreference_Gc,"compiler/p2c","reference->c");
EXT(Yprop_getter,"runtime/boot","prop-getter");
DEF(YcompilerSp2cYgenerate_c_application,"compiler/p2c","generate-c-application");
EXT(YcompilerSastYbinding_dynamic_extentQ,"compiler/ast","binding-dynamic-extent?");
DEF(YcompilerSp2cYpurge_outdated_modules,"compiler/p2c","purge-outdated-modules");
...
DEF(YcompilerSp2cYpp,"compiler/p2c","pp");
...
DEF(YcompilerSp2cYgenerate_module_info,"compiler/p2c","generate-module-info");
...
DEF(YcompilerSp2cYfalse_name,"compiler/p2c","false-name");
EXT(YgooSsystemYadd_tmp_path,"goo/system","add-tmp-path");
DEF(YcompilerSp2cYgenerate_function_code,"compiler/p2c","generate-function-code");
DEF(YcompilerSp2cYgenerate_return,"compiler/p2c","generate-return");
...
DEF(YcompilerSp2cYgenerate_registers,"compiler/p2c","generate-registers");
...
DEF(YcompilerSp2cYchar_buffer_as_string,"compiler/p2c","char-buffer-as-string");
EXT(YLgenG,"runtime/boot","<gen>");
EXT(YgooSmathYsin,"goo/math","sin");
DEF(YcompilerSp2cYgen_depth,"compiler/p2c","gen-depth");
...
DEF(YcompilerSp2cYmodule_src_file,"compiler/p2c","module-src-file");
...
DEF(YcompilerSp2cYmangle_local_marked_name,"compiler/p2c","mangle-local-marked-name");
EXT(YisaQ,"runtime/boot","isa?");
EXT(Yobject_props,"runtime/boot","object-props");
DEF(YcompilerSp2cYmodule_mtime,"compiler/p2c","module-mtime");
...
DEF(YcompilerSp2cYDc_escapes,"compiler/p2c","$c-escapes");
DEF(YcompilerSp2cYDmodule_separator,"compiler/p2c","$module-separator");
...
DEF(YcompilerSp2cYDiep_marker,"compiler/p2c","$iep-marker");
...
FUNFOR(YcompilerSp2cYmodule_up_to_dateQ);
LOCFOR(fun_15);
LOCFOR(fun_16);
FUNFOR(YcompilerSp2cYpurge_outdated_modules);
FUNFOR(YcompilerSp2cYg2c_def_app);
FUNFOR(YcompilerSp2cYg2c_build_app);
FUNFOR(YcompilerSp2cYg2c_test);
LOCFOR(fun_21);
LOCFOR(fun_22);
LOCFOR(fun_23);
LOCFOR(fun_24);
...
FUNFOR(YcompilerSp2cYchar_buffer_as_string);
LOCFOR(fun_loop_53);
...
FUNFOR(YcompilerSp2cYmangler_reset);
LOCFOR(fun_x_1490_63);
FUNFOR(YcompilerSp2cYmangle_name_into);
...
LOCFOR(fun_202);
FUNFOR(YcompilerSp2cYdeclare_imported_module_infos);
LOCFOR(fun_x_1604_204);
LOCFOR(fun_205);
LOCFOR(fun_206);
LOCFOR(fun_x_1606_207);
FUNFOR(YcompilerSp2cYgenerate_module_info);
...
extern P YcompilerSp2cY___main_0___ ();
extern P YcompilerSp2cY___main_1___ ();
extern P YcompilerSp2cY___main_2___ ();
...
LINK_STACK();
  ARG(Ux_, 0);
loop:
  T0 = CALL2(1,VARREF(Yprop_value),Ux_,VARREF(YcompilerSp2cYmodule_loader_appname));
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ...
  ARG(Ux_, 1);
loop:
  T0 = CALL3(1,VARREF(Yprop_value_setter),Uz_,Ux_,VARREF(YcompilerSp2cYmodule_loader_appname));
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ARG(Ux_, 0);
loop:
  T0 = CALL2(1,VARREF(Yprop_value),Ux_,VARREF(YcompilerSp2cYmodule_loader_app_modname));
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ...
  ARG(Ux_, 1);
loop:
  T0 = CALL3(1,VARREF(Yprop_value_setter),Uz_,Ux_,VARREF(YcompilerSp2cYmodule_loader_app_modname));
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ARG(Ux_, 0);
loop:
  T0 = CALL2(1,VARREF(Yprop_value),Ux_,VARREF(YcompilerSp2cYmodule_src_file));
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ...
  ARG(Ux_, 1);
loop:
  T0 = CALL3(1,VARREF(Yprop_value_setter),Uz_,Ux_,VARREF(YcompilerSp2cYmodule_src_file));
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ARG(Ux_, 0);
loop:
  T0 = CALL2(1,VARREF(Yprop_value),Ux_,VARREF(YcompilerSp2cYmodule_mtime));
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ...
  ARG(Ux_, 1);
loop:
  T0 = CALL3(1,VARREF(Yprop_value_setter),Uz_,Ux_,VARREF(YcompilerSp2cYmodule_mtime));
UNLINK_STACK();
  RET(T0);
}
...
loop:
UNLINK_STACK();
  RET(VARREF(YcompilerSp2cYLg2c_moduleG));
}
...
loop:
  ...
  VARSET(YcompilerSp2cYTdefinitionsT,T0);
  T2 = BOXVAL(FREEREF(1));
  T1 = CALLN(1,VARREF(YcompilerSp2cYgenerate_c_module),4,T2,FREEREF(2),FREEREF(0),FREEREF(3));
UNLINK_STACK();
  RET(T1);
}
...
LINK_STACK();
loop:
  T0 = VARSET(YcompilerSp2cYTdefinitionsT,FREEREF(0));
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
loop:
  T0 = CALL2(1,VARREF(YgooSportYopen),VARREF(YgooSportYLfile_out_portG),FREEREF(1));
  BOXVAL(FREEREF(0)) = T0;
  check_type(VARREF(YcompilerSp2cYTdefinitionsT),VARREF(YLanyG));
  x_1476F2039 = VARREF(YcompilerSp2cYTdefinitionsT);
...
loop:
  ...
  src_fileF2045 = T8;
  T12 = CALL1(1,VARREF(YcompilerSp2cYmodule_loader_appname),loader_);
  ...
  out_fileF2046 = T11;
  CALL2(1,VARREF(YcompilerSp2cYmodule_src_file_setter),src_fileF2045,modF2041);
  T14 = CALL1(1,VARREF(YgooSsystemYfile_mtime),src_fileF2045);
  CALL2(1,VARREF(YcompilerSp2cYmodule_mtime_setter),T14,modF2041);
  T16 = CALL2(1,VARREF(YcompilerSp2cYcompute_ast),src_fileF2045,envF2043);
  check_type(T16,VARREF(YLanyG));
  astF2047 = T16;
  T18 = CALL2(1,VARREF(YcompilerSp2cYcompute_program),astF2047,envF2043);
...
FUNCODEDEF(YcompilerSp2cYmodule_up_to_dateQ) {
  P mod_;
  P T3,T2,T1,T0;
  P a1;
LINK_STACK();
  ARG(mod_, 0);
loop:
  T1 = CALL1(1,VARREF(YcompilerSp2cYmodule_mtime),mod_);
  T3 = CALL1(1,VARREF(YcompilerSp2cYmodule_src_file),mod_);
...
LINK_STACK();
  ARG(mod_, 0);
loop:
  T2 = CALL1(1,VARREF(YcompilerSp2cYmodule_up_to_dateQ),mod_);
...
LINK_STACK();
  ARG(name_, 0);
loop:
  T0 = CALL3(1,VARREF(YruntimeSruntimeYformat),VARREF(YgooSportYout),LITREF(lit_19),name_);
UNLINK_STACK();
  RET(T0);
}

FUNCODEDEF(YcompilerSp2cYpurge_outdated_modules) {
  P loader_;
  P changedF2050;
  P T6,T5,T4,T3,T2,T1,T0;
  P a1;
...
FUNCODEDEF(YcompilerSp2cYg2c_def_app) {
  P appname_,modname_;
  P T0;
  P a1,a2;
LINK_STACK();
  ...
  ARG(modname_, 1);
loop:
  T0 = CALLN(1,VARREF(Ynew),5,VARREF(YcompilerSp2cYLg2c_module_loaderG),VARREF(YcompilerSp2cYmodule_loader_appname),appname_,VARREF(YcompilerSp2cYmodule_loader_app_modname),modname_);
UNLINK_STACK();
  RET(T0);
}

FUNCODEDEF(YcompilerSp2cYg2c_build_app) {
  P loader_;
  P modF2051;
  P T2,T1,T0;
  P a1;
LINK_STACK();
  ARG(loader_, 0);
loop:
  CALL1(1,VARREF(YcompilerSp2cYpurge_outdated_modules),loader_);
  T2 = CALL1(1,VARREF(YcompilerSp2cYmodule_loader_app_modname),loader_);
  T1 = CALL2(1,VARREF(YcompilerSastYprobe_module),loader_,T2);
  check_type(T1,VARREF(YLanyG));
  modF2051 = T1;
  CALL2(1,VARREF(YgooSportYputs),VARREF(YgooSportYout),LITREF(lit_24));
  CALL2(1,VARREF(YcompilerSastYdo_module_loader_modules),VARREF(YcompilerSastYreport_undefined_global_bindings),loader_);
  CALL2(1,VARREF(YcompilerSp2cYgenerate_c_application),loader_,modF2051);
  CALL1(1,VARREF(YcompilerSp2cYgenerate_makefile),loader_);
  T0 = YPfalse;
UNLINK_STACK();
  RET(T0);
}

FUNCODEDEF(YcompilerSp2cYg2c_test) {
  P x_;
  P T3,T2,T1,T0;
  P a1;
LINK_STACK();
...
loop:
  ...
  T1 = CALL2(1,VARREF(YcompilerSp2cYg2c_def_app),T2,LITREF(lit_28));
  T0 = VARSET(YcompilerSp2cYTg2c_appT,T1);
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
loop:
  VARSET(YcompilerSp2cYTdynamic_linkingQT,YPtrue);
  check_type(VARREF(YcompilerSp2cYTdefinitionsT),VARREF(YLanyG));
  x_1478F2052 = VARREF(YcompilerSp2cYTdefinitionsT);
...
LINK_STACK();
loop:
  T0 = VARSET(YcompilerSp2cYTdynamic_linkingQT,FREEREF(0));
UNLINK_STACK();
  RET(T0);
}
...
loop:
  T0 = CALL2(1,VARREF(YgooSportYopen),VARREF(YgooSportYLfile_out_portG),FREEREF(1));
  BOXVAL(FREEREF(0)) = T0;
  check_type(VARREF(YcompilerSp2cYTdynamic_linkingQT),VARREF(YLanyG));
  x_1477F2053 = VARREF(YcompilerSp2cYTdynamic_linkingQT);
...
loop:
  ...
  T6 = CALL2(1,VARREF(YgooSmathYA),VARREF(YcompilerSp2cYTtmp_file_counterT),YPint((P)1));
  T5 = VARSET(YcompilerSp2cYTtmp_file_counterT,T6);
  ...
  out_fileF2058 = T10;
  T12 = CALL2(1,VARREF(YcompilerSp2cYcompute_program),ast_,env_);
...
loop:
  ...
  T0 = CALL2(1,VARREF(YcompilerSp2cYg2c_ast),T1,env_);
UNLINK_STACK();
  RET(T0);
}
...
loop:
  T0 = (P)YPsu(name_);
  (P)YcompilerSp2cYPcompile(T0);
  T2 = (P)YPsu(name_);
  T1 = (P)YcompilerSp2cYPload(T2);
UNLINK_STACK();
  RET(T1);
}
...
LINK_STACK();
  ...
  ARG(env_, 1);
loop:
  T1 = CALL2(1,VARREF(YcompilerSp2cYg2c_exp),exp_,env_);
  check_type(T1,VARREF(YLanyG));
  nameF2061 = T1;
  T2 = CALL1(1,VARREF(YcompilerSp2cYcompile_load),nameF2061);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ...
  ARG(env_, 1);
loop:
  T1 = CALL2(1,VARREF(YcompilerSp2cYg2c_ast),ast_,env_);
  check_type(T1,VARREF(YLanyG));
  nameF2062 = T1;
  T2 = CALL1(1,VARREF(YcompilerSp2cYcompile_load),nameF2062);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
loop:
  T0 = CALL1(1,VARREF(YcompilerSp2cYg2c_build_app),VARREF(YcompilerSp2cYTg2c_appT));
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
loop:
  T0 = CALL2(1,VARREF(YcompilerSp2cYg2c_def_app),LITREF(lit_41),LITREF(lit_28));
  VARSET(YcompilerSp2cYTg2c_appT,T0);
UNLINK_STACK();
  RET(YPfalse);
}
...
LINK_STACK();
  ...
  ARG(mod_, 3);
loop:
  CALL2(1,VARREF(YcompilerSp2cYgenerate_header),code_out_,e_);
  CALL2(1,VARREF(YcompilerSp2cYgenerate_global_environment),code_out_,mod_);
  T0 = CALL1(1,VARREF(YcompilerSast_linearizeYprogram_quotations),prg_);
  CALL2(1,VARREF(YcompilerSp2cYgenerate_quotation_forwards),code_out_,T0);
  T1 = CALL1(1,VARREF(YcompilerSast_linearizeYprogram_definitions),prg_);
  CALL2(1,VARREF(YcompilerSp2cYgenerate_function_forwards),code_out_,T1);
  T2 = CALL1(1,VARREF(YcompilerSast_linearizeYprogram_definitions),prg_);
  CALL2(1,VARREF(YcompilerSp2cYgenerate_function_bodies),code_out_,T2);
  T3 = CALL1(1,VARREF(Ynot),VARREF(YcompilerSp2cYTdynamic_linkingQT));
  if (T3 != YPfalse) {
    T4 = CALL2(1,VARREF(YcompilerSp2cYgenerate_module_info),code_out_,mod_);
  } else {
  }
  T5 = CALL1(1,VARREF(YcompilerSast_linearizeYprogram_form),prg_);
  CALL3(1,VARREF(YcompilerSp2cYgenerate_module_init),code_out_,mod_,T5);
  CALL1(1,VARREF(YcompilerSp2cYgenerate_trailer),code_out_);
UNLINK_STACK();
  RET(prg_);
}
...
loop:
  ...
  BOXVAL(FREEREF(0)) = T0;
  T1 = BOXVAL(FREEREF(0));
  CALL2(1,VARREF(YcompilerSp2cYgenerate_header),T1,YPfalse);
  T2 = BOXVAL(FREEREF(0));
  CALL2(1,VARREF(YcompilerSp2cYgenerate_main),T2,FREEREF(2));
  T4 = BOXVAL(FREEREF(0));
  T3 = CALL1(1,VARREF(YcompilerSp2cYgenerate_trailer),T4);
UNLINK_STACK();
  RET(T3);
}
...
LINK_STACK();
  ...
  ARG(mod_, 1);
loop:
  T1 = CALL1(1,VARREF(YcompilerSp2cYmodule_loader_appname),loader_);
  check_type(T1,VARREF(YLanyG));
  appnameF2070 = T1;
...
loop:
  ...
  check_type(T5,VARREF(YLanyG));
  exe_nameF2077 = T5;
  check_type(VARREF(YgooSsystemYTpath_separatorT),VARREF(YLanyG));
...
loop:
  ...
  if (VARREF(YcompilerSp2cYTdynamic_linkingQT) != YPfalse) {
...
loop:
  ...
  T1 = CALL1(1,VARREF(Ynot),T2);
  T0 = CALL3(1,VARREF(YcompilerSp2cYgenerate_global_binding),FREEREF(0),T1,binding_);
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  if (T3 != YPfalse) {
    ...
    T11 = CALL1(1,VARREF(YcompilerSp2cYmangle_module_binding),gb_);
    T13 = CALL1(1,VARREF(YcompilerSastYbinding_module_name),gb_);
    T12 = CALL1(1,VARREF(YcompilerSp2cYmangle_string_literal),T13);
    T14 = CALL1(1,VARREF(YcompilerSp2cYmangle_string_literal),nameF2083);
...
FUNCODEDEF(YcompilerSp2cYchar_buffer_as_string) {
  P buffer_;
  P x_1480F2087;
  P stringF2086;
  P buffer_sizeF2085;
...
LINK_STACK();
  ARG(buffer_, 0);
loop:
  T1 = CALL1(1,VARREF(YgooStypeYlen),buffer_);
...
loop:
  ...
  if (T1 != YPfalse) {
    T2 = CALL1(1,VARREF(YcompilerSp2cYchar_buffer_as_string),VARREF(YcompilerSp2cYTmangle_bufferT));
    T0 = T2;
  } else {
    T4 = CALL2(1,VARREF(YgooSmacrosYelt),FREEREF(1),i_);
    check_type(T4,VARREF(YLanyG));
    cF2088 = T4;
    T7 = CALL2(1,VARREF(YgooStypeYas),VARREF(YLintG),cF2088);
    T6 = CALL2(1,VARREF(YgooSmacrosYelt),VARREF(YcompilerSp2cYDc_escapes),T7);
    check_type(T6,VARREF(YLanyG));
    encF2089 = T6;
    T8 = CALL2(1,VARREF(YgooSmathYE),encF2089,YPfalse);
    if (T8 != YPfalse) {
      T9 = CALL2(1,VARREF(YgooScollectionsScollectionYaddX),VARREF(YcompilerSp2cYTmangle_bufferT),cF2088);
    } else {
      T10 = CALL2(1,VARREF(YgooScollectionsSsequenceYcatX),VARREF(YcompilerSp2cYTmangle_bufferT),encF2089);
    }
...
LINK_STACK();
  ARG(str_, 0);
loop:
  CALL2(1,VARREF(YgooScollectionsSbufferYlen_setter),YPint((P)0),VARREF(YcompilerSp2cYTmangle_bufferT));
  T1 = CALL1(1,VARREF(YgooStypeYlen),str_);
  check_type(T1,VARREF(YLanyG));
  lenF2090 = T1;
  T3 = FUNSHELL(1,fun_loop_53,3);
  loopF2091 = T3;
  FUNINIT(loopF2091, 3,lenF2090,str_,loopF2091);
  T4 = CALL1(1,loopF2091,YPint((P)0));
  T2 = T4;
  T0 = T2;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  T0 = CALL1(1,VARREF(YcompilerSp2cYmangle_string_literal),T1);
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  remainderF2094 = T5;
  T7 = CALL2(1,VARREF(YgooSmacrosYelt),VARREF(YcompilerSp2cYDnumber_characters),remainderF2094);
  ...
  if (T9 != YPfalse) {
    ...
    resultF2097 = T13;
    T16 = CALL1(1,VARREF(YgooStypeYlen),resultF2097);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    check_type(T4,VARREF(YLanyG));
    iF2099 = T4;
    T6 = CALL1(1,VARREF(YcompilerSp2cYmangle_integer),iF2099);
    T5 = CALL3(1,VARREF(YgooSmacrosYcat),VARREF(YcompilerSp2cYDescape_separator),T6,VARREF(YcompilerSp2cYDescape_separator));
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    T6 = CALL2(1,VARREF(YgooStypeYas),VARREF(YLintG),T7);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    check_type(T4,VARREF(YLanyG));
    iF2101 = T4;
    T5 = CALL2(1,VARREF(YgooStypeYas),VARREF(YLchrG),iF2101);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    check_type(T4,VARREF(YLanyG));
    iF2102 = T4;
    T5 = CALL2(1,VARREF(YgooStypeYas),VARREF(YLchrG),iF2102);
...
FUNCODEDEF(YcompilerSp2cYmangler_reset) {
  P buffer_;
  P T0;
  P a1;
LINK_STACK();
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    T6 = CALL2(1,VARREF(YgooStypeYas),VARREF(YLintG),T7);
    T5 = CALL2(1,VARREF(YgooSmacrosYelt),VARREF(YcompilerSp2cYDname_mangler_table),T6);
...
FUNCODEDEF(YcompilerSp2cYmangle_name_into) {
  P buf_,name_;
  P x_1490F2104;
  P T3,T2,T1,T0;
  P a1,a2;
...
LINK_STACK();
  ARG(name_, 0);
loop:
  CALL1(1,VARREF(YcompilerSp2cYmangler_reset),VARREF(YcompilerSp2cYTmangle_bufferT));
  CALL2(1,VARREF(YcompilerSp2cYmangle_name_into),VARREF(YcompilerSp2cYTmangle_bufferT),name_);
  T0 = CALL1(1,VARREF(YcompilerSp2cYchar_buffer_as_string),VARREF(YcompilerSp2cYTmangle_bufferT));
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  T0 = CALL1(1,VARREF(YcompilerSp2cYmangle_raw_name),T1);
UNLINK_STACK();
  RET(T0);
}
...
loop:
  CALL1(1,VARREF(YcompilerSp2cYmangler_reset),VARREF(YcompilerSp2cYTmangle_bufferT));
  CALL2(1,VARREF(YcompilerSp2cYmangle_name_into),VARREF(YcompilerSp2cYTmangle_bufferT),name_);
  CALL2(1,VARREF(YgooScollectionsScollectionYaddX),VARREF(YcompilerSp2cYTmangle_bufferT),VARREF(YcompilerSp2cYDlocal_marker));
  T0 = CALL1(1,VARREF(YcompilerSp2cYchar_buffer_as_string),VARREF(YcompilerSp2cYTmangle_bufferT));
UNLINK_STACK();
  RET(T0);
}
...
loop:
  T1 = CALL2(1,VARREF(YgooStypeYas),VARREF(YLstrG),name_);
  T0 = CALL1(1,VARREF(YcompilerSp2cYmangle_local_name),T1);
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  if (T0 != YPfalse) {
    CALL2(1,VARREF(YgooScollectionsScollectionYaddX),VARREF(YcompilerSp2cYTmangle_bufferT),VARREF(YcompilerSp2cYDmodule_marker));
    T3 = CALL2(1,VARREF(YgooStypeYas),VARREF(YLstrG),modname_);
    T2 = CALL2(1,VARREF(YcompilerSp2cYmangle_name_into),VARREF(YcompilerSp2cYTmangle_bufferT),T3);
  } else {
  }
  CALL2(1,VARREF(YgooScollectionsScollectionYaddX),VARREF(YcompilerSp2cYTmangle_bufferT),VARREF(YcompilerSp2cYDmodule_marker));
  CALL2(1,VARREF(YcompilerSp2cYmangle_name_into),VARREF(YcompilerSp2cYTmangle_bufferT),name_);
  T4 = CALL1(1,VARREF(YcompilerSp2cYchar_buffer_as_string),VARREF(YcompilerSp2cYTmangle_bufferT));
UNLINK_STACK();
  RET(T4);
}
...
loop:
  T1 = CALL2(1,VARREF(YgooStypeYas),VARREF(YLstrG),name_);
  T0 = CALL2(1,VARREF(YcompilerSp2cYmangle_global_name),modname_,T1);
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ARG(name_, 0);
loop:
  T0 = CALL2(1,VARREF(YcompilerSp2cYmangle_global_name),VARREF(YcompilerSastYDgoo_boot_module_name),name_);
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  T0 = CALL2(1,VARREF(YcompilerSp2cYmangle_global_name),T1,T2);
UNLINK_STACK();
  RET(T0);
}
...
loop:
  CALL1(1,VARREF(YcompilerSp2cYmangler_reset),VARREF(YcompilerSp2cYTmangle_bufferT));
  CALL2(1,VARREF(YcompilerSp2cYmangle_name_into),VARREF(YcompilerSp2cYTmangle_bufferT),name_);
  CALL2(1,VARREF(YgooScollectionsScollectionYaddX),VARREF(YcompilerSp2cYTmangle_bufferT),VARREF(YcompilerSp2cYDhygiene_char));
  T0 = CALL1(1,VARREF(YcompilerSp2cYmangle_integer),marker_);
  CALL2(1,VARREF(YgooScollectionsSsequenceYcatX),VARREF(YcompilerSp2cYTmangle_bufferT),T0);
  T1 = CALL1(1,VARREF(YcompilerSp2cYchar_buffer_as_string),VARREF(YcompilerSp2cYTmangle_bufferT));
UNLINK_STACK();
  RET(T1);
}
...
loop:
  T1 = CALL2(1,VARREF(YgooStypeYas),VARREF(YLstrG),name_);
  T0 = CALL2(1,VARREF(YcompilerSp2cYmangle_local_marked_name),T1,marker_);
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    check_type(firstQ_,VARREF(YLanyG));
    tmpF2127 = firstQ_;
    if (tmpF2127 != YPfalse) {
      T8 = tmpF2127;
    } else {
...
loop:
  ...
  T38 = CALL3(1,loopF2138,Ynil,T39,YPtrue);
  T36 = T38;
...
loop:
  ...
  check_type(T1,VARREF(YLanyG));
  regF2139 = T1;
  check_type(regF2139,VARREF(YLanyG));
  tmpF2140 = regF2139;
  if (tmpF2140 != YPfalse) {
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    check_type(T4,VARREF(YLanyG));
    iF2142 = T4;
    CALL2(1,VARREF(YgooSportYputs),FREEREF(0),LITREF(lit_170));
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    check_type(T4,VARREF(YLanyG));
    qbF2183 = T4;
    CALL2(1,VARREF(YcompilerSp2cYgen_depth),YPint((P)1),FREEREF(0));
    ...
    CALL2(1,VARREF(YcompilerSp2cYgenerate_quotation),FREEREF(0),T6);
    CALL2(1,VARREF(YgooSportYputs),FREEREF(0),LITREF(lit_175));
...
LINK_STACK();
loop:
  T0 = CALL1(1,VARREF(YcompilerSp2cYmangle_boot_name),LITREF(lit_193));
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  T1 = CALL1(1,VARREF(YcompilerSp2cYmangle_boot_name),T2);
  T0 = CALL2(1,VARREF(YgooSportYputs),code_out_,T1);
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ...
  ARG(qb_, 1);
loop:
  T1 = CALL1(1,VARREF(YcompilerSp2cYmangle_boot_name),LITREF(lit_198));
  T0 = CALL2(1,VARREF(YgooSportYputs),code_out_,T1);
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ARG(x_, 0);
loop:
  T0 = CALL2(1,VARREF(YcompilerSp2cYgenerate_quotation),FREEREF(0),x_);
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  T0 = CALL3(1,VARREF(YcompilerSp2cYout_list_builder),T1,code_out_,qb_);
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ...
  ARG(x_, 1);
loop:
  T1 = CALL1(1,VARREF(YcompilerSp2cYmangle_boot_name),LITREF(lit_200));
...
LINK_STACK();
  ...
  ARG(x_, 1);
loop:
  T1 = CALL1(1,VARREF(YcompilerSp2cYmangle_boot_name),LITREF(lit_202));
  T2 = CALL2(1,VARREF(YgooStypeYas),VARREF(YLintG),x_);
...
LINK_STACK();
  ...
  ARG(x_, 1);
loop:
  T1 = CALL1(1,VARREF(YcompilerSp2cYmangle_boot_name),LITREF(lit_207));
  T2 = CALL1(1,VARREF(YcompilerSp2cYfloat_to_c_string),x_);
...
LINK_STACK();
  ...
  ARG(x_, 1);
loop:
  T1 = CALL1(1,VARREF(YcompilerSp2cYmangle_boot_name),LITREF(lit_209));
  T2 = CALL1(1,VARREF(YcompilerSp2cYmangle_string_literal),x_);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    check_type(T4,VARREF(YLanyG));
    eF2189 = T4;
    CALL2(1,VARREF(YgooSportYputs),FREEREF(0),LITREF(lit_214));
    CALL2(1,VARREF(YcompilerSp2cYgenerate_quotation),FREEREF(0),eF2189);
...
LINK_STACK();
  ...
  ARG(x_, 1);
loop:
  T0 = CALL1(1,VARREF(YcompilerSp2cYmangle_boot_name),LITREF(lit_211));
  ...
  T3 = CALL1(1,x_1524F2190,T4);
  T5 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_215));
UNLINK_STACK();
  RET(T5);
}
...
LINK_STACK();
  ...
  ARG(x_, 1);
loop:
  T1 = CALL1(1,VARREF(YcompilerSp2cYmangle_boot_name),LITREF(lit_217));
  T2 = CALL1(1,VARREF(YcompilerSp2cYmangle_string_literal),x_);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    T6 = CALL1(1,VARREF(YcompilerSp2cYmangle_module_binding),binding_);
    T5 = CALL2(1,VARREF(YgooSportYputs),code_out_,T6);
    T0 = T5;
  }
UNLINK_STACK();
  RET(T0);
...
loop:
  T2 = CALL1(1,VARREF(YcompilerSastYbinding_name),binding_);
  T1 = CALL1(1,VARREF(YcompilerSp2cYmangle_local_name),T2);
  T0 = CALL2(1,VARREF(YgooSportYputs),code_out_,T1);
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  T1 = CALL2(1,VARREF(YcompilerSp2cYmangle_local_marked_name),T2,T3);
  T0 = CALL2(1,VARREF(YgooSportYputs),code_out_,T1);
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ...
  ARG(code_out_, 1);
loop:
  T0 = CALL2(1,VARREF(YcompilerSp2cYbinding_Gc),v_,code_out_);
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  CALL2(1,VARREF(YgooSportYputs),code_out_,T0);
  check_type(code_out_,VARREF(YLanyG));
  x_1525F2191 = code_out_;
  CALL2(1,VARREF(YgooSportYput),x_1525F2191,YPchr((P)40));
  CALL2(1,VARREF(YcompilerSp2cYbinding_Gc),v_,code_out_);
  T4 = CALL2(1,VARREF(YgooSportYput),x_1525F2191,YPchr((P)41));
  T3 = T4;
UNLINK_STACK();
  RET(T3);
}
...
loop:
  ...
  CALL2(1,VARREF(YcompilerSp2cYgenerate_quotations),code_out_,T0);
  T1 = CALL1(1,VARREF(YcompilerSast_linearizeYform_definitions),e_);
  CALLN(1,VARREF(YcompilerSp2cYgenerate_functions),4,T1,f_,d_,code_out_);
  T2 = CALL1(1,VARREF(YcompilerSast_linearizeYform_program),e_);
  CALLN(1,VARREF(YcompilerSp2cYto_c),4,T2,f_,d_,code_out_);
  T4 = CALL1(1,VARREF(YcompilerSastYprogram_register),e_);
  if (T4 != YPfalse) {
    CALL2(1,VARREF(YcompilerSp2cYgen_depth),d_,code_out_);
    CALL3(1,VARREF(YcompilerSp2cYgen_result),e_,d_,code_out_);
    T5 = CALL1(1,VARREF(YcompilerSast_linearizeYform_program),e_);
    CALL2(1,VARREF(YcompilerSp2cYgen_ref),T5,code_out_);
    T6 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
    T3 = T6;
  } else {
    T3 = YPfalse;
  }
...
loop:
  ...
  T0 = CALL2(1,VARREF(YcompilerSp2cYreference_Gc),T1,code_out_);
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ...
  ARG(code_out_, 1);
loop:
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_228));
  check_type(code_out_,VARREF(YLanyG));
  x_1526F2192 = code_out_;
  CALL2(1,VARREF(YgooSportYput),x_1526F2192,YPchr((P)40));
  ...
  T2 = CALL2(1,VARREF(YgooSportYput),x_1526F2192,YPchr((P)41));
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  if (regF2193 != YPfalse) {
    ...
    T4 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_231));
    T2 = T4;
  }
  T0 = T2;
UNLINK_STACK();
...
loop:
  T1 = CALL1(1,VARREF(YcompilerSastYconstant_value),e_);
  T0 = CALL2(1,VARREF(YcompilerSp2cYgenerate_quotation),code_out_,T1);
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  T0 = CALL2(1,VARREF(YcompilerSp2cYgen_ref),T1,code_out_);
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  CALLN(1,VARREF(YcompilerSp2cYto_c),4,T0,f_,d_,code_out_);
  CALL2(1,VARREF(YcompilerSp2cYgen_depth),d_,code_out_);
  CALL3(1,VARREF(YcompilerSp2cYgen_result),e_,d_,code_out_);
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_233));
  T1 = CALL1(1,VARREF(YcompilerSastYassignment_binding),e_);
  CALL2(1,VARREF(YcompilerSp2cYbinding_Gc),T1,code_out_);
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_234));
  T2 = CALL1(1,VARREF(YcompilerSastYassignment_form),e_);
  CALL2(1,VARREF(YcompilerSp2cYgen_ref),T2,code_out_);
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_235));
  T3 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
UNLINK_STACK();
  RET(T3);
}
...
loop:
  ...
  if (T1 != YPfalse) {
    CALL2(1,VARREF(YcompilerSp2cYgen_depth),d_,code_out_);
    CALL3(1,VARREF(YcompilerSp2cYgen_result),e_,d_,code_out_);
    CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_236));
    check_type(code_out_,VARREF(YLanyG));
    x_1527F2194 = code_out_;
    CALL2(1,VARREF(YgooSportYput),x_1527F2194,YPchr((P)40));
    T3 = CALL1(1,VARREF(YcompilerSastYboundQ_reference),e_);
    T2 = CALL1(1,VARREF(YcompilerSastYreference_binding),T3);
    CALL2(1,VARREF(YcompilerSp2cYbinding_Gc),T2,code_out_);
    T4 = CALL2(1,VARREF(YgooSportYput),x_1527F2194,YPchr((P)41));
    T5 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
    T0 = T5;
  } else {
    T0 = YPfalse;
  }
...
loop:
  ...
  if (T2 != YPfalse) {
    CALL2(1,VARREF(YcompilerSp2cYgen_depth),d_,code_out_);
    CALL3(1,VARREF(YcompilerSp2cYgen_result),e_,d_,code_out_);
    CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_237));
    check_type(code_out_,VARREF(YLanyG));
    x_1528F2195 = code_out_;
    CALL2(1,VARREF(YgooSportYput),x_1528F2195,YPchr((P)40));
    T3 = CALL1(1,VARREF(YcompilerSast_linearizeYbox_reference),e_);
    CALL2(1,VARREF(YcompilerSp2cYgen_ref),T3,code_out_);
    T4 = CALL2(1,VARREF(YgooSportYput),x_1528F2195,YPchr((P)41));
    T5 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
    T1 = T5;
  } else {
    T1 = YPfalse;
...
loop:
  ...
  CALL2(1,VARREF(YcompilerSp2cYgen_depth),d_,code_out_);
  CALL3(1,VARREF(YcompilerSp2cYgen_result),e_,d_,code_out_);
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_238));
  check_type(code_out_,VARREF(YLanyG));
  x_1529F2196 = code_out_;
  CALL2(1,VARREF(YgooSportYput),x_1529F2196,YPchr((P)40));
  T1 = CALL1(1,VARREF(YcompilerSast_linearizeYbox_reference),e_);
  CALL2(1,VARREF(YcompilerSp2cYgen_ref),T1,code_out_);
  T2 = CALL2(1,VARREF(YgooSportYput),x_1529F2196,YPchr((P)41));
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_239));
  T3 = CALL1(1,VARREF(YcompilerSast_linearizeYbox_form),e_);
  CALL2(1,VARREF(YcompilerSp2cYgen_ref),T3,code_out_);
  T4 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
UNLINK_STACK();
  RET(T4);
}
...
loop:
  ...
  check_type(T1,VARREF(YLanyG));
  bindingF2197 = T1;
  CALL2(1,VARREF(YcompilerSp2cYbinding_Gc),bindingF2197,code_out_);
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_240));
  check_type(code_out_,VARREF(YLanyG));
  x_1530F2198 = code_out_;
  CALL2(1,VARREF(YgooSportYput),x_1530F2198,YPchr((P)40));
  CALL2(1,VARREF(YcompilerSp2cYbinding_Gc),bindingF2197,code_out_);
  T4 = CALL2(1,VARREF(YgooSportYput),x_1530F2198,YPchr((P)41));
  T5 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
  T0 = T5;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  CALLN(1,VARREF(YcompilerSp2cYto_c),4,T0,f_,d_,code_out_);
  CALL2(1,VARREF(YcompilerSp2cYgen_depth),d_,code_out_);
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_241));
  T1 = CALL1(1,VARREF(YcompilerSastYalternative_condition),e_);
  CALL2(1,VARREF(YcompilerSp2cYgen_ref),T1,code_out_);
  T2 = CALL0(1,VARREF(YcompilerSp2cYfalse_name));
  ...
  CALLN(1,VARREF(YcompilerSp2cYto_c),4,T3,f_,T4,code_out_);
  T5 = CALL1(1,VARREF(YcompilerSastYprogram_register),e_);
  if (T5 != YPfalse) {
    T6 = CALL2(1,VARREF(YgooSmathYA),d_,YPint((P)1));
    CALL2(1,VARREF(YcompilerSp2cYgen_depth),T6,code_out_);
    T7 = CALL2(1,VARREF(YgooSmathYA),d_,YPint((P)1));
    CALL3(1,VARREF(YcompilerSp2cYgen_result),e_,T7,code_out_);
    T8 = CALL1(1,VARREF(YcompilerSastYalternative_consequent),e_);
    CALL2(1,VARREF(YcompilerSp2cYgen_ref),T8,code_out_);
    T9 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
  } else {
  }
  CALL2(1,VARREF(YcompilerSp2cYgen_depth),d_,code_out_);
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_243));
  T10 = CALL1(1,VARREF(YcompilerSastYalternative_alternant),e_);
  T11 = CALL2(1,VARREF(YgooSmathYA),d_,YPint((P)1));
  CALLN(1,VARREF(YcompilerSp2cYto_c),4,T10,f_,T11,code_out_);
  T12 = CALL1(1,VARREF(YcompilerSastYprogram_register),e_);
  if (T12 != YPfalse) {
    T13 = CALL2(1,VARREF(YgooSmathYA),d_,YPint((P)1));
    CALL2(1,VARREF(YcompilerSp2cYgen_depth),T13,code_out_);
    T14 = CALL2(1,VARREF(YgooSmathYA),d_,YPint((P)1));
    CALL3(1,VARREF(YcompilerSp2cYgen_result),e_,T14,code_out_);
    T15 = CALL1(1,VARREF(YcompilerSastYalternative_alternant),e_);
    CALL2(1,VARREF(YcompilerSp2cYgen_ref),T15,code_out_);
    T16 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
  } else {
  }
  CALL2(1,VARREF(YcompilerSp2cYgen_depth),d_,code_out_);
  T17 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_244));
UNLINK_STACK();
  RET(T17);
}
...
LINK_STACK();
  ARG(x_, 0);
loop:
  T0 = CALLN(1,VARREF(YcompilerSp2cYto_c),4,x_,FREEREF(0),FREEREF(1),FREEREF(2));
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    check_type(T4,VARREF(YLanyG));
    argF2199 = T4;
    CALLN(1,VARREF(YcompilerSp2cYto_c),4,argF2199,FREEREF(0),FREEREF(1),FREEREF(2));
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    check_type(T9,VARREF(YLanyG));
    argF2202 = T9;
    CALL2(1,VARREF(YcompilerSp2cYgen_depth),FREEREF(0),FREEREF(1));
    CALL3(1,VARREF(YruntimeSruntimeYformat),FREEREF(1),LITREF(lit_251),iF2201);
    CALL2(1,VARREF(YcompilerSp2cYgen_ref),argF2202,FREEREF(1));
    CALL2(1,VARREF(YgooSportYputs),FREEREF(1),LITREF(lit_175));
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    bindingF2205 = T9;
    CALL2(1,VARREF(YcompilerSp2cYgen_depth),FREEREF(0),FREEREF(1));
    CALL2(1,VARREF(YcompilerSp2cYbinding_Gc),bindingF2205,FREEREF(1));
...
loop:
  ...
  T11 = CALL2(1,x_1538F2208,T12,T14);
  CALL2(1,VARREF(YcompilerSp2cYgen_depth),d_,code_out_);
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_256));
  T16 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
UNLINK_STACK();
  RET(T16);
}
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    check_type(T4,VARREF(YLanyG));
    argF2209 = T4;
    CALLN(1,VARREF(YcompilerSp2cYto_c),4,argF2209,FREEREF(0),FREEREF(1),FREEREF(2));
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    check_type(T4,VARREF(YLanyG));
    argF2210 = T4;
    CALL2(1,VARREF(YgooSportYput),FREEREF(0),YPchr((P)44));
    CALL2(1,VARREF(YcompilerSp2cYgen_ref),argF2210,FREEREF(0));
...
loop:
  ...
  T3 = T5;
  if (T3 != YPfalse) {
    T17 = CALLN(1,VARREF(YcompilerSp2cYgenerate_self_recursive_call),4,e_,f_,d_,code_out_);
    T2 = T17;
  } else {
    T20 = CALL1(1,VARREF(YcompilerSastYapplication_arguments),e_);
    T19 = CALL1(1,VARREF(YgooStypeYlen),T20);
    check_type(T19,VARREF(YLanyG));
    nF2216 = T19;
    T21 = CALL1(1,VARREF(YcompilerSastYapplication_function),e_);
    CALLN(1,VARREF(YcompilerSp2cYto_c),4,T21,f_,d_,code_out_);
    ...
    T23 = CALL1(1,x_1540F2217,T24);
    CALL2(1,VARREF(YcompilerSp2cYgen_depth),d_,code_out_);
    CALL3(1,VARREF(YcompilerSp2cYgen_result),e_,d_,code_out_);
    T27 = CALL2(1,VARREF(YgooSmagnitudeYG),nF2216,VARREF(YcompilerSp2cYDnumber_call_templates));
    if (T27 != YPfalse) {
      T26 = LITREF(lit_260);
    } else {
      T26 = nF2216;
    ...
    CALL2(1,VARREF(YgooSportYput),x_1541F2218,YPchr((P)40));
    ...
    CALL2(1,VARREF(YgooSportYputs),code_out_,T28);
    T30 = CALL1(1,VARREF(YcompilerSastYapplication_function),e_);
    CALL2(1,VARREF(YcompilerSp2cYgen_ref),T30,code_out_);
    T31 = CALL2(1,VARREF(YgooSmagnitudeYG),nF2216,VARREF(YcompilerSp2cYDnumber_call_templates));
    if (T31 != YPfalse) {
    ...
    T34 = CALL1(1,x_1543F2219,T35);
    T37 = CALL2(1,VARREF(YgooSportYput),x_1541F2218,YPchr((P)41));
    T38 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
    T18 = T38;
    T2 = T18;
  }
  T0 = T2;
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    if (T10 != YPfalse) {
      T11 = CALL2(1,VARREF(YgooSportYput),FREEREF(0),YPchr((P)44));
    } else {
    }
    CALL2(1,VARREF(YcompilerSp2cYgen_ref),xF2222,FREEREF(1));
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    check_type(T14,VARREF(YLanyG));
    bindingF2229 = T14;
    CALLN(1,VARREF(YcompilerSp2cYto_c),4,initF2227,YPfalse,FREEREF(0),FREEREF(1));
    T16 = CALL1(1,VARREF(YcompilerSast_linearizeYunconstrained_typeQ),typeF2228);
    T15 = CALL1(1,VARREF(Ynot),T16);
    if (T15 != YPfalse) {
      CALLN(1,VARREF(YcompilerSp2cYto_c),4,typeF2228,YPfalse,FREEREF(0),FREEREF(1));
      CALL2(1,VARREF(YcompilerSp2cYgen_depth),FREEREF(0),FREEREF(1));
      CALL2(1,VARREF(YgooSportYputs),FREEREF(1),LITREF(lit_273));
      check_type(FREEREF(1),VARREF(YLanyG));
      x_1552F2230 = FREEREF(1);
      CALL2(1,VARREF(YgooSportYput),x_1552F2230,YPchr((P)40));
      CALL2(1,VARREF(YcompilerSp2cYgen_ref),initF2227,FREEREF(1));
      CALL2(1,VARREF(YgooSportYput),x_1552F2230,YPchr((P)44));
      CALL2(1,VARREF(YcompilerSp2cYgen_ref),typeF2228,FREEREF(1));
      T17 = CALL2(1,VARREF(YgooSportYput),x_1552F2230,YPchr((P)41));
      T18 = CALL2(1,VARREF(YgooSportYputs),FREEREF(1),LITREF(lit_175));
    } else {
    }
    CALL2(1,VARREF(YcompilerSp2cYgen_depth),FREEREF(0),FREEREF(1));
    CALL2(1,VARREF(YcompilerSp2cYbinding_Gc),bindingF2229,FREEREF(1));
    CALL2(1,VARREF(YgooSportYputs),FREEREF(1),LITREF(lit_274));
    CALL2(1,VARREF(YcompilerSp2cYgen_ref),initF2227,FREEREF(1));
    CALL2(1,VARREF(YgooSportYputs),FREEREF(1),LITREF(lit_175));
...
loop:
  ...
  T6 = CALL1(1,VARREF(YgooScollectionsScollectionYenum),T7);
  T1 = CALL3(1,x_1551F2231,T2,T4,T6);
  T8 = CALL1(1,VARREF(YcompilerSastYfix_let_body),e_);
  CALLN(1,VARREF(YcompilerSp2cYto_c),4,T8,f_,d_,code_out_);
  T10 = CALL1(1,VARREF(YcompilerSastYprogram_register),e_);
  if (T10 != YPfalse) {
    CALL2(1,VARREF(YcompilerSp2cYgen_depth),d_,code_out_);
    CALL3(1,VARREF(YcompilerSp2cYgen_result),e_,d_,code_out_);
    T11 = CALL1(1,VARREF(YcompilerSastYfix_let_body),e_);
    CALL2(1,VARREF(YcompilerSp2cYgen_ref),T11,code_out_);
    T12 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
    T9 = T12;
  } else {
    T9 = YPfalse;
  }
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    check_type(T9,VARREF(YLanyG));
    bindingF2234 = T9;
    CALLN(1,VARREF(YcompilerSp2cYfunshell_to_c),5,bindingF2234,initF2233,YPfalse,FREEREF(0),FREEREF(1));
    CALL2(1,VARREF(YcompilerSp2cYgen_depth),FREEREF(0),FREEREF(1));
    CALL2(1,VARREF(YcompilerSp2cYbinding_Gc),bindingF2234,FREEREF(1));
    CALL2(1,VARREF(YgooSportYputs),FREEREF(1),LITREF(lit_278));
    CALL2(1,VARREF(YcompilerSp2cYgen_ref),initF2233,FREEREF(1));
    CALL2(1,VARREF(YgooSportYputs),FREEREF(1),LITREF(lit_175));
...
loop:
  ...
  T4 = CALL1(1,VARREF(YgooScollectionsScollectionYenum),T5);
  T1 = CALL2(1,x_1555F2235,T2,T4);
  T6 = CALLN(1,VARREF(YruntimeSruntimeYrcurry),4,VARREF(YcompilerSp2cYfuninit_to_c),f_,d_,code_out_);
  ...
  CALLN(1,VARREF(YcompilerSp2cYto_c),4,T9,f_,d_,code_out_);
  T11 = CALL1(1,VARREF(YcompilerSastYprogram_register),e_);
  if (T11 != YPfalse) {
    CALL2(1,VARREF(YcompilerSp2cYgen_depth),d_,code_out_);
    CALL3(1,VARREF(YcompilerSp2cYgen_result),e_,d_,code_out_);
    T12 = CALL1(1,VARREF(YcompilerSastYlocals_body),e_);
    CALL2(1,VARREF(YcompilerSp2cYgen_ref),T12,code_out_);
    T13 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
    T10 = T13;
  } else {
    T10 = YPfalse;
  }
...
loop:
  ...
  CALL2(1,VARREF(YcompilerSp2cYgen_depth),d_,code_out_);
  CALL3(1,VARREF(YcompilerSp2cYgen_result),e_,d_,code_out_);
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_279));
  check_type(code_out_,VARREF(YLanyG));
  x_1556F2236 = code_out_;
  CALL2(1,VARREF(YgooSportYput),x_1556F2236,YPchr((P)40));
  T1 = CALL1(1,VARREF(YcompilerSastYbind_exit_main_fun),e_);
  CALL2(1,VARREF(YcompilerSp2cYgen_ref),T1,code_out_);
  T2 = CALL2(1,VARREF(YgooSportYput),x_1556F2236,YPchr((P)41));
  T3 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
UNLINK_STACK();
  RET(T3);
}
...
loop:
  ...
  CALLN(1,VARREF(YcompilerSp2cYto_c),4,T1,f_,d_,code_out_);
  CALL2(1,VARREF(YcompilerSp2cYgen_depth),d_,code_out_);
  CALL3(1,VARREF(YcompilerSp2cYgen_result),e_,d_,code_out_);
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_280));
  check_type(code_out_,VARREF(YLanyG));
  x_1557F2237 = code_out_;
  CALL2(1,VARREF(YgooSportYput),x_1557F2237,YPchr((P)40));
  T2 = CALL1(1,VARREF(YcompilerSastYunwind_protect_protected_thunk),e_);
  CALL2(1,VARREF(YcompilerSp2cYgen_ref),T2,code_out_);
  CALL2(1,VARREF(YgooSportYput),x_1557F2237,YPchr((P)44));
  T3 = CALL1(1,VARREF(YcompilerSastYunwind_protect_cleanup_thunk),e_);
  CALL2(1,VARREF(YcompilerSp2cYgen_ref),T3,code_out_);
  T4 = CALL2(1,VARREF(YgooSportYput),x_1557F2237,YPchr((P)41));
  T5 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
UNLINK_STACK();
  RET(T5);
}
...
loop:
  ...
  CALLN(1,VARREF(YcompilerSp2cYto_c),4,T3,f_,d_,code_out_);
  T4 = CALL1(1,VARREF(YcompilerSastYmonitor_main_thunk),e_);
  CALLN(1,VARREF(YcompilerSp2cYto_c),4,T4,f_,d_,code_out_);
  CALL2(1,VARREF(YcompilerSp2cYgen_depth),d_,code_out_);
  CALL3(1,VARREF(YcompilerSp2cYgen_result),e_,d_,code_out_);
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_281));
  check_type(code_out_,VARREF(YLanyG));
  x_1558F2238 = code_out_;
  CALL2(1,VARREF(YgooSportYput),x_1558F2238,YPchr((P)40));
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_282));
  CALL2(1,VARREF(YgooSportYput),x_1558F2238,YPchr((P)44));
  T5 = CALL1(1,VARREF(YcompilerSp2cYmangle_boot_name),LITREF(lit_283));
  CALL2(1,VARREF(YgooSportYputs),code_out_,T5);
  CALL2(1,VARREF(YgooSportYput),x_1558F2238,YPchr((P)44));
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_284));
  CALL2(1,VARREF(YgooSportYput),x_1558F2238,YPchr((P)44));
  T6 = CALL1(1,VARREF(YcompilerSastYmonitor_type),e_);
  CALL2(1,VARREF(YcompilerSp2cYgen_ref),T6,code_out_);
  CALL2(1,VARREF(YgooSportYput),x_1558F2238,YPchr((P)44));
  T7 = CALL1(1,VARREF(YcompilerSastYmonitor_info),e_);
  CALL2(1,VARREF(YcompilerSp2cYgen_ref),T7,code_out_);
  CALL2(1,VARREF(YgooSportYput),x_1558F2238,YPchr((P)44));
  T8 = CALL1(1,VARREF(YcompilerSastYmonitor_test),e_);
  CALL2(1,VARREF(YcompilerSp2cYgen_ref),T8,code_out_);
  CALL2(1,VARREF(YgooSportYput),x_1558F2238,YPchr((P)44));
  T9 = CALL1(1,VARREF(YcompilerSastYmonitor_handler),e_);
  CALL2(1,VARREF(YcompilerSp2cYgen_ref),T9,code_out_);
  CALL2(1,VARREF(YgooSportYput),x_1558F2238,YPchr((P)44));
  T10 = CALL1(1,VARREF(YcompilerSastYmonitor_main_thunk),e_);
  CALL2(1,VARREF(YcompilerSp2cYgen_ref),T10,code_out_);
  T11 = CALL2(1,VARREF(YgooSportYput),x_1558F2238,YPchr((P)41));
  T12 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
UNLINK_STACK();
  RET(T12);
}
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    check_type(T4,VARREF(YLanyG));
    argF2239 = T4;
    CALLN(1,VARREF(YcompilerSp2cYto_c),4,argF2239,FREEREF(0),FREEREF(1),FREEREF(2));
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    CALL2(1,VARREF(YcompilerSp2cYgen_ref),argF2242,FREEREF(1));
...
loop:
  ...
  T3 = T5;
  if (T3 != YPfalse) {
    T11 = CALLN(1,VARREF(YcompilerSp2cYgenerate_self_recursive_call),4,e_,f_,d_,code_out_);
    T2 = T11;
  } else {
    ...
    T20 = CALL2(1,x_1565F2249,T21,T23);
    T18 = T20;
    T25 = CALL2(1,VARREF(YgooSportYput),x_1561F2247,YPchr((P)41));
    T26 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
    T2 = T26;
  }
  T0 = T2;
UNLINK_STACK();
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    xF2250 = T4;
    CALL2(1,VARREF(YgooSportYput),FREEREF(0),YPchr((P)44));
    CALL2(1,VARREF(YcompilerSp2cYgen_ref),xF2250,FREEREF(0));
...
loop:
  ...
  T1 = CALL1(1,VARREF(YgooStypeYlen),T2);
  check_type(T1,VARREF(YLanyG));
  nF2251 = T1;
  T5 = CALL1(1,VARREF(YcompilerSast_linearizeYclosure_creation_index),e_);
  T4 = CALL2(1,VARREF(YgooSmacrosYelt),VARREF(YcompilerSp2cYTdefinitionsT),T5);
  check_type(T4,VARREF(YLanyG));
  fF2252 = T4;
  ...
  if (T7 != YPfalse) {
    ...
    if (T9 != YPfalse) {
      CALL2(1,VARREF(YcompilerSp2cYgen_depth),d_,code_out_);
      CALL3(1,VARREF(YcompilerSp2cYgen_result),e_,d_,code_out_);
      CALL2(1,VARREF(YcompilerSp2cYgenerate_function_binding),code_out_,fF2252);
      T10 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
      T8 = T10;
    } else {
      T8 = YPfalse;
    }
    ...
    CALL2(1,VARREF(YcompilerSp2cYgen_depth),d_,code_out_);
    CALL3(1,VARREF(YcompilerSp2cYgen_result),e_,d_,code_out_);
    CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_291));
    check_type(code_out_,VARREF(YLanyG));
    x_1566F2253 = code_out_;
    CALL2(1,VARREF(YgooSportYput),x_1566F2253,YPchr((P)40));
    CALL2(1,VARREF(YcompilerSp2cYgenerate_function_binding),code_out_,fF2252);
    ...
    T14 = CALL1(1,x_1568F2254,T15);
    T17 = CALL2(1,VARREF(YgooSportYput),x_1566F2253,YPchr((P)41));
    T18 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
    T6 = T18;
  }
  T3 = T6;
  T0 = T3;
...
loop:
  ...
  if (T6 != YPfalse) {
    T7 = CALL2(1,VARREF(YcompilerSp2cYgenerate_function_binding),code_out_,fF2256);
  } else {
    CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_297));
    check_type(code_out_,VARREF(YLanyG));
    x_1569F2257 = code_out_;
    CALL2(1,VARREF(YgooSportYput),x_1569F2257,YPchr((P)40));
    ...
    CALL2(1,VARREF(YgooSportYput),x_1569F2257,YPchr((P)44));
    CALL2(1,VARREF(YcompilerSp2cYgenerate_function_binding),code_out_,fF2256);
    CALL2(1,VARREF(YgooSportYput),x_1569F2257,YPchr((P)44));
    CALL3(1,VARREF(YruntimeSruntimeYformat),code_out_,LITREF(lit_299),nF2255);
    T11 = CALL2(1,VARREF(YgooSportYput),x_1569F2257,YPchr((P)41));
    T8 = T11;
  }
  T12 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
  T3 = T12;
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    xF2258 = T4;
    CALL2(1,VARREF(YgooSportYput),FREEREF(0),YPchr((P)44));
    CALL2(1,VARREF(YcompilerSp2cYgen_ref),xF2258,FREEREF(0));
...
loop:
  ...
  if (T4 != YPfalse) {
    ...
    CALL2(1,VARREF(YcompilerSp2cYgen_depth),d_,code_out_);
    CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_301));
    check_type(code_out_,VARREF(YLanyG));
    x_1570F2260 = code_out_;
    CALL2(1,VARREF(YgooSportYput),x_1570F2260,YPchr((P)40));
    CALL2(1,VARREF(YcompilerSp2cYbinding_Gc),b_,code_out_);
    ...
    T9 = CALL1(1,x_1572F2261,T10);
    T12 = CALL2(1,VARREF(YgooSportYput),x_1570F2260,YPchr((P)41));
    T13 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
    T3 = T13;
  } else {
    T3 = YPfalse;
...
loop:
  T0 = CALL1(1,VARREF(YcompilerSastYassignment_form),e_);
  CALLN(1,VARREF(YcompilerSp2cYto_c),4,T0,YPfalse,d_,code_out_);
  CALL2(1,VARREF(YcompilerSp2cYgen_depth),d_,code_out_);
  CALL3(1,VARREF(YcompilerSp2cYgen_result),e_,d_,code_out_);
  T1 = CALL1(1,VARREF(YcompilerSp2cYmangle_boot_name),LITREF(lit_305));
  CALL2(1,VARREF(YgooSportYputs),code_out_,T1);
  check_type(code_out_,VARREF(YLanyG));
  x_1573F2262 = code_out_;
  CALL2(1,VARREF(YgooSportYput),x_1573F2262,YPchr((P)40));
  T3 = CALL1(1,VARREF(YcompilerSastYassignment_binding),e_);
  T2 = CALL1(1,VARREF(YcompilerSastYbinding_module_name),T3);
  CALL2(1,VARREF(YcompilerSp2cYgenerate_quotation),code_out_,T2);
  CALL2(1,VARREF(YgooSportYput),x_1573F2262,YPchr((P)44));
  T5 = CALL1(1,VARREF(YcompilerSastYassignment_binding),e_);
  T4 = CALL1(1,VARREF(YcompilerSastYbinding_name),T5);
  CALL2(1,VARREF(YcompilerSp2cYgenerate_quotation),code_out_,T4);
  CALL2(1,VARREF(YgooSportYput),x_1573F2262,YPchr((P)44));
  T6 = CALL1(1,VARREF(YcompilerSastYassignment_form),e_);
  CALL2(1,VARREF(YcompilerSp2cYgen_ref),T6,code_out_);
  T7 = CALL2(1,VARREF(YgooSportYput),x_1573F2262,YPchr((P)41));
  T8 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
UNLINK_STACK();
  RET(T8);
}
...
loop:
  ...
  if (T1 != YPfalse) {
    T3 = CALL1(1,VARREF(YcompilerSp2cYmangle_boot_name),LITREF(lit_308));
    T2 = CALL2(1,VARREF(YgooSportYputs),code_out_,T3);
    T0 = T2;
  } else {
    T4 = CALL1(1,VARREF(YcompilerSp2cYmangle_boot_name),LITREF(lit_309));
    CALL2(1,VARREF(YgooSportYputs),code_out_,T4);
    check_type(code_out_,VARREF(YLanyG));
    x_1574F2264 = code_out_;
    CALL2(1,VARREF(YgooSportYput),x_1574F2264,YPchr((P)40));
    T6 = CALL1(1,VARREF(YgooStypeYlen),elts_);
    ...
    T8 = CALL1(1,x_1576F2265,T9);
    T10 = CALL2(1,VARREF(YgooSportYput),x_1574F2264,YPchr((P)41));
    T5 = T10;
    T0 = T5;
  }
UNLINK_STACK();
...
LINK_STACK();
  ARG(x_, 0);
loop:
  T0 = CALL2(1,VARREF(YcompilerSp2cYgen_ref),x_,FREEREF(0));
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  T0 = CALL3(1,VARREF(YcompilerSp2cYout_list_builder),T1,code_out_,refs_);
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  if (T4 != YPfalse) {
    T8 = CALL1(1,VARREF(YgooStypeYlen),typesF2266);
  ...
  check_type(T3,VARREF(YLanyG));
  specsF2267 = T3;
  T9 = CALL2(1,VARREF(YcompilerSp2cYgen_fab_list),code_out_,specsF2267);
  T2 = T9;
  T0 = T2;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  CALL2(1,VARREF(YcompilerSp2cYgen_depth),d_,code_out_);
  CALL3(1,VARREF(YcompilerSp2cYgen_result),e_,d_,code_out_);
  T3 = CALL1(1,VARREF(YcompilerSp2cYmangle_boot_name),LITREF(lit_317));
  CALL2(1,VARREF(YgooSportYputs),code_out_,T3);
  check_type(code_out_,VARREF(YLanyG));
  x_1577F2268 = code_out_;
  CALL2(1,VARREF(YgooSportYput),x_1577F2268,YPchr((P)40));
  T4 = CALL1(1,VARREF(YcompilerSastYsignature_names),e_);
  CALL2(1,VARREF(YcompilerSp2cYgen_fab_list),code_out_,T4);
  CALL2(1,VARREF(YgooSportYput),x_1577F2268,YPchr((P)44));
  CALL2(1,VARREF(YcompilerSp2cYgenerate_function_specs),code_out_,e_);
  CALL2(1,VARREF(YgooSportYput),x_1577F2268,YPchr((P)44));
  ...
  CALL2(1,VARREF(YcompilerSp2cYgen_ref),T7,code_out_);
  CALL2(1,VARREF(YgooSportYput),x_1577F2268,YPchr((P)44));
  T8 = CALL1(1,VARREF(YcompilerSp2cYmangle_boot_name),LITREF(lit_318));
  CALL2(1,VARREF(YgooSportYputs),code_out_,T8);
  T9 = CALL2(1,VARREF(YgooSportYput),x_1577F2268,YPchr((P)41));
  T10 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
UNLINK_STACK();
  RET(T10);
}
...
loop:
  ...
  CALL2(1,VARREF(YcompilerSp2cYgen_depth),d_,code_out_);
  CALL3(1,VARREF(YcompilerSp2cYgen_result),e_,d_,code_out_);
  T1 = CALL1(1,VARREF(YcompilerSp2cYmangle_boot_name),LITREF(lit_319));
  CALL2(1,VARREF(YgooSportYputs),code_out_,T1);
  check_type(code_out_,VARREF(YLanyG));
  x_1578F2269 = code_out_;
  CALL2(1,VARREF(YgooSportYput),x_1578F2269,YPchr((P)40));
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_320));
  CALL2(1,VARREF(YgooSportYput),x_1578F2269,YPchr((P)44));
  ...
  CALL2(1,VARREF(YcompilerSp2cYgen_ref),T3,code_out_);
  CALL2(1,VARREF(YgooSportYput),x_1578F2269,YPchr((P)44));
  T4 = CALL1(1,VARREF(YcompilerSp2cYmangle_boot_name),LITREF(lit_321));
  CALL2(1,VARREF(YgooSportYputs),code_out_,T4);
  CALL2(1,VARREF(YgooSportYput),x_1578F2269,YPchr((P)44));
  T5 = CALL1(1,VARREF(YcompilerSp2cYmangle_boot_name),LITREF(lit_322));
  CALL2(1,VARREF(YgooSportYputs),code_out_,T5);
  CALL2(1,VARREF(YgooSportYput),x_1578F2269,YPchr((P)44));
  T6 = CALL1(1,VARREF(YcompilerSp2cYmangle_boot_name),LITREF(lit_323));
  CALL2(1,VARREF(YgooSportYputs),code_out_,T6);
  CALL2(1,VARREF(YgooSportYput),x_1578F2269,YPchr((P)44));
  T7 = CALL1(1,VARREF(YcompilerSp2cYmangle_boot_name),LITREF(lit_324));
  CALL2(1,VARREF(YgooSportYputs),code_out_,T7);
  T8 = CALL2(1,VARREF(YgooSportYput),x_1578F2269,YPchr((P)41));
  T9 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
UNLINK_STACK();
  RET(T9);
}
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    check_type(T4,VARREF(YLanyG));
    defF2270 = T4;
    CALL2(1,VARREF(YcompilerSp2cYgenerate_function_forward),FREEREF(0),defF2270);
...
LINK_STACK();
  ...
  ARG(definitions_, 1);
loop:
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_327));
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    CALL2(1,VARREF(YgooSportYputs),FREEREF(1),LITREF(lit_338));
...
loop:
  ...
  T1 = CALL1(1,VARREF(YcompilerSp2cYmangle_module_binding),T2);
  ...
  T8 = CALL1(1,VARREF(YgooScollectionsScollectionYenum),T9);
  T5 = CALL2(1,x_1584F2276,T6,T8);
  T3 = T5;
  T12 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_339));
UNLINK_STACK();
  RET(T12);
}
...
loop:
  ...
  T3 = T5;
  if (T3 != YPfalse) {
    T9 = CALL1(1,VARREF(YcompilerSp2cYmangle_module_binding),nameF2277);
    T8 = CALL2(1,VARREF(YgooSportYputs),code_out_,T9);
    T2 = T8;
  } else {
    ...
    if (T11 != YPfalse) {
      ...
      check_type(T15,VARREF(YLanyG));
      nameF2279 = T15;
      T19 = CALL1(1,VARREF(YcompilerSp2cYmangle_raw_name),nameF2279);
...
loop:
  ...
  CALL2(1,VARREF(YgooSportYputs),code_out_,T3);
  CALL2(1,VARREF(YcompilerSp2cYgenerate_function_binding),code_out_,defn_);
  T4 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_346));
  T0 = T4;
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ARG(def_, 0);
loop:
  T0 = CALL2(1,VARREF(YcompilerSp2cYgenerate_function_code),FREEREF(0),def_);
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ...
  ARG(definitions_, 1);
loop:
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_348));
...
loop:
  ...
  T1 = CALL1(1,VARREF(Ynot),T2);
  if (T1 != YPfalse) {
    T3 = CALLN(1,VARREF(YcompilerSp2cYgenerate_closure_structure),4,def_,FREEREF(0),FREEREF(1),FREEREF(2));
    T0 = T3;
  } else {
    T0 = YPfalse;
  }
...
loop:
  ...
  CALLN(1,VARREF(YcompilerSp2cYto_c),4,T0,f_,d_,code_out_);
  CALL2(1,VARREF(YcompilerSp2cYgen_depth),d_,code_out_);
  CALL3(1,VARREF(YcompilerSp2cYgen_result),definition_,d_,code_out_);
  CALL2(1,VARREF(YcompilerSp2cYgenerate_function_binding),code_out_,definition_);
  T1 = CALL1(1,VARREF(YcompilerSp2cYmangle_boot_name),LITREF(lit_354));
  CALL3(1,VARREF(YruntimeSruntimeYformat),code_out_,LITREF(lit_353),T1);
  check_type(code_out_,VARREF(YLanyG));
  x_1585F2281 = code_out_;
  CALL2(1,VARREF(YgooSportYput),x_1585F2281,YPchr((P)40));
  CALL2(1,VARREF(YcompilerSp2cYgenerate_function_body_reference),code_out_,definition_);
  CALL2(1,VARREF(YgooSportYput),x_1585F2281,YPchr((P)44));
  ...
  CALL2(1,VARREF(YcompilerSp2cYgen_ref),T3,code_out_);
  CALL2(1,VARREF(YgooSportYput),x_1585F2281,YPchr((P)44));
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_355));
  CALL2(1,VARREF(YgooSportYput),x_1585F2281,YPchr((P)44));
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_356));
  CALL2(1,VARREF(YgooSportYput),x_1585F2281,YPchr((P)44));
  T4 = CALL1(1,VARREF(YcompilerSastYfunction_source),definition_);
  CALL2(1,VARREF(YcompilerSp2cYgen_ref),T4,code_out_);
  T5 = CALL2(1,VARREF(YgooSportYput),x_1585F2281,YPchr((P)41));
  T6 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
UNLINK_STACK();
  RET(T6);
}
...
LINK_STACK();
  ...
  ARG(definition_, 1);
loop:
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_358));
  CALL2(1,VARREF(YcompilerSp2cYgenerate_function_binding),code_out_,definition_);
  T0 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_359));
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    if (T15 != YPfalse) {
      T16 = CALL2(1,VARREF(YgooSportYput),FREEREF(0),YPchr((P)44));
    } else {
    }
...
loop:
  ...
  T1 = CALL1(1,VARREF(Ynot),T2);
  if (T1 != YPfalse) {
    CALL2(1,VARREF(YcompilerSp2cYgen_depth),YPint((P)1),code_out_);
    CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_362));
    check_type(code_out_,VARREF(YLanyG));
    ...
    T5 = CALL3(1,x_1590F2288,T6,T8,T10);
    T3 = T5;
    T11 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
    T0 = T11;
  } else {
    T0 = YPfalse;
  }
...
loop:
  CALL2(1,VARREF(YcompilerSp2cYgen_depth),d_,code_out_);
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_369));
  T0 = CALL1(1,VARREF(YcompilerSastYfunction_body),defn_);
  CALL2(1,VARREF(YcompilerSp2cYgen_ref),T0,code_out_);
  T1 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
UNLINK_STACK();
  RET(T1);
}
...
loop:
  ...
  if (T0 != YPfalse) {
    T2 = CALL2(1,VARREF(YgooSportYput),code_out_,YPchr((P)81));
  } else {
  }
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_370));
  check_type(code_out_,VARREF(YLanyG));
  x_1591F2289 = code_out_;
  CALL2(1,VARREF(YgooSportYput),x_1591F2289,YPchr((P)40));
  T3 = CALL1(1,VARREF(YcompilerSastYfunction_body),defn_);
  CALL2(1,VARREF(YcompilerSp2cYgen_ref),T3,code_out_);
  T4 = CALL2(1,VARREF(YgooSportYput),x_1591F2289,YPchr((P)41));
  T5 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
UNLINK_STACK();
  RET(T5);
}
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    CALL2(1,VARREF(YgooSportYputs),FREEREF(1),LITREF(lit_381));
    CALL2(1,VARREF(YcompilerSp2cYbinding_Gc),bindingF2293,FREEREF(1));
...
loop:
  ...
  T2 = CALL1(1,VARREF(YcompilerSp2cYprimitive_inlinableQ),e_);
  if (T2 != YPfalse) {
    T1 = LITREF(lit_377);
  } else {
    T1 = LITREF(lit_376);
  ...
  CALL2(1,VARREF(YcompilerSp2cYbinding_Gc),T3,code_out_);
  check_type(code_out_,VARREF(YLanyG));
  x_1592F2294 = code_out_;
  CALL2(1,VARREF(YgooSportYput),x_1592F2294,YPchr((P)40));
  check_type(code_out_,VARREF(YLanyG));
  ...
  T6 = CALL2(1,x_1596F2296,T7,T9);
  T4 = T6;
  T11 = CALL2(1,VARREF(YgooSportYput),x_1592F2294,YPchr((P)41));
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_382));
  T12 = CALL1(1,VARREF(YcompilerSastYfunction_temporaries),e_);
  CALL2(1,VARREF(YcompilerSp2cYgenerate_local_temporaries),T12,code_out_);
  T13 = CALL1(1,VARREF(YcompilerSastYfunction_registers),e_);
  CALL2(1,VARREF(YcompilerSp2cYgenerate_registers),T13,code_out_);
  T14 = CALL1(1,VARREF(YcompilerSastYfunction_bindings),e_);
  CALL2(1,VARREF(YcompilerSp2cYgenerate_shadow_args),T14,code_out_);
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_383));
  T15 = CALL1(1,VARREF(YcompilerSastYfunction_body),e_);
  CALLN(1,VARREF(YcompilerSp2cYto_c),4,T15,e_,YPint((P)1),code_out_);
  CALL3(1,VARREF(YcompilerSp2cYgenerate_return),e_,YPint((P)1),code_out_);
  T16 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_384));
UNLINK_STACK();
  RET(T16);
}
...
loop:
  ...
  if (tmpF2298 != YPfalse) {
    ...
    T6 = CALL2(1,VARREF(YgooStypeYas),VARREF(YLstrG),T7);
    check_type(T6,VARREF(YLanyG));
    nameF2299 = T6;
    ...
    if (tmpF2300 != YPfalse) {
      ...
      T14 = CALL1(1,VARREF(YgooStypeYlen),nameF2299);
      T15 = CALL1(1,VARREF(YgooStypeYlen),LITREF(lit_388));
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    CALL2(1,VARREF(YcompilerSp2cYbinding_Gc),bF2303,FREEREF(1));
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    if (T2 != YPfalse) {
      T3 = CALL2(1,VARREF(YgooSportYputs),FREEREF(0),LITREF(lit_396));
    } else {
      T4 = CALL2(1,VARREF(YgooSportYputs),FREEREF(0),LITREF(lit_397));
    }
    CALL2(1,VARREF(YcompilerSp2cYbinding_Gc),b_,FREEREF(0));
    T5 = BOXVAL(FREEREF(1));
...
loop:
  ...
  check_type(T3,VARREF(YLanyG));
  bindingsF2305 = T3;
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_389));
  CALL2(1,VARREF(YcompilerSp2cYgenerate_function_binding),code_out_,definition_);
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_390));
  T5 = CALL1(1,VARREF(YgooSmacrosYemptyQ),bindingsF2305);
  T4 = CALL1(1,VARREF(Ynot),T5);
  if (T4 != YPfalse) {
    CALL2(1,VARREF(YcompilerSp2cYgen_depth),YPint((P)1),code_out_);
    CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_391));
    check_type(code_out_,VARREF(YLanyG));
    ...
    T8 = CALL2(1,x_1600F2307,T9,T11);
    T6 = T8;
    T13 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_175));
  } else {
  }
  T14 = CALL1(1,VARREF(YcompilerSastYfunction_temporaries),definition_);
  CALL2(1,VARREF(YcompilerSp2cYgenerate_local_temporaries),T14,code_out_);
  T15 = CALL1(1,VARREF(YcompilerSastYfunction_registers),definition_);
  CALL2(1,VARREF(YcompilerSp2cYgenerate_registers),T15,code_out_);
  T16 = CALL1(1,VARREF(YcompilerSastYfunction_bindings),definition_);
  CALL2(1,VARREF(YcompilerSp2cYgenerate_shadow_args),T16,code_out_);
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_395));
  T17 = FUNFAB(fun_193,2,code_out_,offsetF2304);
  CALL2(1,VARREF(YgooSmacrosYdo),T17,bindingsF2305);
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_399));
  T18 = CALL1(1,VARREF(YcompilerSastYfunction_body),definition_);
  CALLN(1,VARREF(YcompilerSp2cYto_c),4,T18,definition_,YPint((P)1),code_out_);
  T20 = CALL1(1,VARREF(YcompilerSp2cYdispatcherQ),definition_);
  T19 = CALL1(1,VARREF(Ynot),T20);
  if (T19 != YPfalse) {
    T21 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_400));
  } else {
  }
  CALL3(1,VARREF(YcompilerSp2cYgenerate_return),definition_,YPint((P)1),code_out_);
  T22 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_401));
  T2 = T22;
  T0 = T2;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    tempF2308 = T4;
    CALL2(1,VARREF(YcompilerSp2cYgen_depth),YPint((P)1),FREEREF(0));
    CALL2(1,VARREF(YgooSportYputs),FREEREF(0),LITREF(lit_406));
    CALL2(1,VARREF(YcompilerSp2cYbinding_Gc),tempF2308,FREEREF(0));
    CALL2(1,VARREF(YgooSportYputs),FREEREF(0),LITREF(lit_175));
...
LINK_STACK();
  ...
  ARG(i_, 1);
loop:
  T2 = CALL2(1,VARREF(YgooSmathYE),i_,VARREF(YcompilerSp2cYTregisters_per_lineT));
  ...
  T1 = T3;
  if (T1 != YPfalse) {
    CALL2(1,VARREF(YgooSportYputs),FREEREF(0),LITREF(lit_412));
    T5 = CALL1(1,FREEREF(1),regs_);
    T0 = T5;
  } else {
    T7 = CALL2(1,VARREF(YgooSmathYE),i_,YPint((P)0));
    T6 = CALL1(1,VARREF(Ynot),T7);
    if (T6 != YPfalse) {
      T8 = CALL2(1,VARREF(YgooSportYput),FREEREF(0),YPchr((P)44));
    } else {
    }
    T9 = CALL1(1,VARREF(Yhead),regs_);
    CALL2(1,VARREF(YcompilerSp2cYgen_ref),T9,FREEREF(0));
...
loop:
  ...
  if (T1 != YPfalse) {
    CALL2(1,VARREF(YcompilerSp2cYgen_depth),YPint((P)1),FREEREF(0));
    CALL2(1,VARREF(YgooSportYputs),FREEREF(0),LITREF(lit_410));
    T4 = FUNSHELL(1,fun_next_reg_197,3);
    next_regF2311 = T4;
    FUNINIT(next_regF2311, 3,FREEREF(0),FREEREF(1),next_regF2311);
    T5 = CALL2(1,next_regF2311,regs_,YPint((P)0));
    T3 = T5;
    T0 = T3;
  } else {
    T0 = YPfalse;
...
loop:
  ...
  T2 = CALL1(1,next_lineF2312,regs_);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ARG(name_, 0);
loop:
  T1 = CALL1(1,VARREF(YcompilerSp2cYmangle_raw_name),name_);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    T4 = CALL1(1,VARREF(YcompilerSp2cYmodule_info_name),modname_);
...
loop:
  ...
  if (T3 != YPfalse) {
    T5 = CALL1(1,FREEREF(1),home_modF2313);
    T2 = T5;
  } else {
    T2 = YPfalse;
  }
...
FUNCODEDEF(YcompilerSp2cYdeclare_imported_module_infos) {
  P code_out_,mod_;
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    check_type(T4,VARREF(YLanyG));
    nF2317 = T4;
    T5 = CALL1(1,VARREF(YcompilerSp2cYmodule_info_name),nF2317);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    T4 = CALL1(1,VARREF(YcompilerSp2cYmangle_string_literal),T5);
    T7 = CALL1(1,VARREF(YcompilerSastYbinding_module_name),binding_);
    T6 = CALL1(1,VARREF(YcompilerSp2cYmodule_info_name),T7);
    T8 = CALL1(1,VARREF(YcompilerSp2cYmangle_string_literal),local_name_);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    if (T3 != YPfalse) {
      ...
      T6 = CALL1(1,VARREF(YcompilerSp2cYmangle_string_literal),T7);
      T8 = CALL1(1,VARREF(YcompilerSp2cYmangle_module_binding),binding_);
      ...
      T10 = CALL1(1,VARREF(YcompilerSp2cYmangle_string_literal),T11);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    T11 = CALL1(1,VARREF(YcompilerSp2cYmangle_string_literal),T12);
    T13 = CALL1(1,VARREF(YcompilerSp2cYmangle_string_literal),exported_asF2319);
...
FUNCODEDEF(YcompilerSp2cYgenerate_module_info) {
  P code_out_,mod_;
  P x_1606F2327;
  P x_1604F2326;
  P uses_namesF2325;
...
loop:
  ...
  check_type(T1,VARREF(YLanyG));
  nameF2321 = T1;
  T3 = CALL1(1,VARREF(YcompilerSp2cYmodule_info_name),nameF2321);
  check_type(T3,VARREF(YLanyG));
  info_nameF2322 = T3;
  ...
  check_type(T9,VARREF(YLanyG));
  uses_namesF2325 = T9;
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_419));
  CALL2(1,VARREF(YcompilerSp2cYdeclare_imported_module_infos),code_out_,mod_);
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_420));
  ...
  T11 = CALL1(1,x_1604F2326,T12);
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_424));
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_425));
  ...
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_428));
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_429));
  ...
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_432));
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_433));
  ...
  T18 = CALL1(1,x_1606F2327,T19);
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_437));
  ...
  T21 = CALL1(1,VARREF(YcompilerSp2cYmangle_string_literal),nameF2321);
  CALL3(1,VARREF(YruntimeSruntimeYformat),code_out_,LITREF(lit_440),T21);
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_441));
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_442));
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_443));
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_444));
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_445));
  T22 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_446));
  T8 = T22;
  T6 = T8;
  T4 = T6;
  T2 = T4;
...
LINK_STACK();
  ARG(name_, 0);
loop:
  T1 = CALL1(1,VARREF(YcompilerSp2cYmodule_init_name),name_);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    check_type(T4,VARREF(YLanyG));
    nF2328 = T4;
    T5 = CALL1(1,VARREF(YcompilerSp2cYmodule_init_decl),nF2328);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    check_type(T4,VARREF(YLanyG));
    nF2329 = T4;
    T5 = CALL1(1,VARREF(YcompilerSp2cYmodule_init_name),nF2329);
...
loop:
  ...
  check_type(T1,VARREF(YLanyG));
  nameF2330 = T1;
  T4 = CALL1(1,VARREF(YcompilerSp2cYmodule_init_decl),nameF2330);
  check_type(T4,VARREF(YLanyG));
  init_declF2331 = T4;
  ...
  check_type(T10,VARREF(YLanyG));
  uses_namesF2334 = T10;
  T11 = CALL1(1,VARREF(Ynot),VARREF(YcompilerSp2cYTdynamic_linkingQT));
  if (T11 != YPfalse) {
    CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_455));
    ...
    T14 = CALL1(1,x_1608F2335,T15);
    T12 = T14;
  } else {
  }
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_459));
  ...
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_462));
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_463));
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_464));
  T16 = CALL1(1,VARREF(Ynot),VARREF(YcompilerSp2cYTdynamic_linkingQT));
  if (T16 != YPfalse) {
    ...
    T18 = CALL1(1,x_1610F2336,T19);
    T20 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_468));
  } else {
  }
  CALLN(1,VARREF(YcompilerSp2cYto_c),4,form_,YPfalse,YPint((P)1),code_out_);
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_469));
  T21 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_470));
  T9 = T21;
  T7 = T9;
  T5 = T7;
  T3 = T5;
...
loop:
  ...
  check_type(T1,VARREF(YLanyG));
  nameF2337 = T1;
  T3 = CALL1(1,VARREF(YcompilerSp2cYmodule_info_name),nameF2337);
  check_type(T3,VARREF(YLanyG));
  info_nameF2338 = T3;
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_472));
  CALL3(1,VARREF(YruntimeSruntimeYformat),code_out_,LITREF(lit_473),info_nameF2338);
  T4 = CALL1(1,VARREF(YcompilerSp2cYmodule_init_decl),nameF2337);
  ...
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_476));
  T5 = CALL1(1,VARREF(YcompilerSp2cYmangle_boot_name),LITREF(lit_478));
  CALL3(1,VARREF(YruntimeSruntimeYformat),code_out_,LITREF(lit_477),T5);
  T6 = CALL1(1,VARREF(YcompilerSp2cYmodule_init_name),nameF2337);
  CALL3(1,VARREF(YruntimeSruntimeYformat),code_out_,LITREF(lit_479),T6);
  CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_480));
  T7 = CALL2(1,VARREF(YgooSportYputs),code_out_,LITREF(lit_481));
  T2 = T7;
  T0 = T2;
UNLINK_STACK();
  RET(T0);
...
P YcompilerSp2cY___main_0___() {
  ...
  P T14,T13,T12,T11,T10,T9,T8,T7,T6,T5,T4,T3,T2,T1,T0;
loop:
  VARSET(YcompilerSp2cYTdefinitionsT,YPfalse);
  VARSET(YcompilerSp2cYTdynamic_linkingQT,YPfalse);
  ...
  VARSET(YcompilerSp2cYLg2c_module_loaderG,T0);
  lit_1 = YPPsym((P)"module-loader-appname");
  lit_2 = YPPsym((P)"_x");
  T2 = YPsig(YPPlist(1,LITREF(lit_2)),YPPlist(1,VARREF(YcompilerSp2cYLg2c_module_loaderG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_loader_appname_0 = YPmet(FUNCODEREF(fun_module_loader_appname_0),LITREF(lit_1),T2,ENVNUL,PNUL,YPfalse);
  T5 = BOUNDP(YcompilerSp2cYmodule_loader_appname);
  if (T5 != YPfalse) {
    T4 = VARREF(YcompilerSp2cYmodule_loader_appname);
  } else {
    T4 = YPfalse;
  }
  T6 = fun_module_loader_appname_0;
  T3 = CALL2(1,VARREF(YPdefine_method),T4,T6);
  VARSET(YcompilerSp2cYmodule_loader_appname,T3);
  lit_3 = YPPsym((P)"module-loader-appname-setter");
  lit_4 = YPPsym((P)"_z");
  T7 = YPsig(YPPlist(2,LITREF(lit_4),LITREF(lit_2)),YPPlist(2,VARREF(YLstrG),VARREF(YcompilerSp2cYLg2c_module_loaderG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  ...
  T10 = BOUNDP(YcompilerSp2cYmodule_loader_appname_setter);
  if (T10 != YPfalse) {
    T9 = VARREF(YcompilerSp2cYmodule_loader_appname_setter);
  } else {
    T9 = YPfalse;
  }
  T11 = fun_module_loader_appname_setter_1;
  T8 = CALL2(1,VARREF(YPdefine_method),T9,T11);
  VARSET(YcompilerSp2cYmodule_loader_appname_setter,T8);
  CALLN(1,VARREF(YPprop),5,VARREF(YcompilerSp2cYLg2c_module_loaderG),VARREF(YcompilerSp2cYmodule_loader_appname),VARREF(YcompilerSp2cYmodule_loader_appname_setter),VARREF(YLstrG),VARREF(YPprop_unbound_error));
  lit_5 = YPPsym((P)"module-loader-app-modname");
  T12 = YPsig(YPPlist(1,LITREF(lit_2)),YPPlist(1,VARREF(YcompilerSp2cYLg2c_module_loaderG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_loader_app_modname_2 = YPmet(FUNCODEREF(fun_module_loader_app_modname_2),LITREF(lit_5),T12,ENVNUL,PNUL,YPfalse);
  T15 = BOUNDP(YcompilerSp2cYmodule_loader_app_modname);
  if (T15 != YPfalse) {
    T14 = VARREF(YcompilerSp2cYmodule_loader_app_modname);
  } else {
    T14 = YPfalse;
  }
  T16 = fun_module_loader_app_modname_2;
  T13 = CALL2(1,VARREF(YPdefine_method),T14,T16);
  VARSET(YcompilerSp2cYmodule_loader_app_modname,T13);
  lit_6 = YPPsym((P)"module-loader-app-modname-setter");
  T17 = YPsig(YPPlist(2,LITREF(lit_4),LITREF(lit_2)),YPPlist(2,VARREF(YLsymG),VARREF(YcompilerSp2cYLg2c_module_loaderG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  ...
  T20 = BOUNDP(YcompilerSp2cYmodule_loader_app_modname_setter);
  if (T20 != YPfalse) {
    T19 = VARREF(YcompilerSp2cYmodule_loader_app_modname_setter);
  } else {
    T19 = YPfalse;
  }
  T21 = fun_module_loader_app_modname_setter_3;
  T18 = CALL2(1,VARREF(YPdefine_method),T19,T21);
  VARSET(YcompilerSp2cYmodule_loader_app_modname_setter,T18);
  CALLN(1,VARREF(YPprop),5,VARREF(YcompilerSp2cYLg2c_module_loaderG),VARREF(YcompilerSp2cYmodule_loader_app_modname),VARREF(YcompilerSp2cYmodule_loader_app_modname_setter),VARREF(YLsymG),VARREF(YPprop_unbound_error));
  lit_7 = YPPsym((P)"<g2c-module>");
  T23 = (P)YPpair(VARREF(YcompilerSastYLmoduleG),Ynil);
  T22 = CALL2(1,VARREF(Yfab_class),LITREF(lit_7),T23);
  VARSET(YcompilerSp2cYLg2c_moduleG,T22);
  lit_8 = YPPsym((P)"module-src-file");
  T24 = YPsig(YPPlist(1,LITREF(lit_2)),YPPlist(1,VARREF(YcompilerSp2cYLg2c_moduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_src_file_4 = YPmet(FUNCODEREF(fun_module_src_file_4),LITREF(lit_8),T24,ENVNUL,PNUL,YPfalse);
  T27 = BOUNDP(YcompilerSp2cYmodule_src_file);
  if (T27 != YPfalse) {
    T26 = VARREF(YcompilerSp2cYmodule_src_file);
  } else {
    T26 = YPfalse;
  }
  T28 = fun_module_src_file_4;
  T25 = CALL2(1,VARREF(YPdefine_method),T26,T28);
  VARSET(YcompilerSp2cYmodule_src_file,T25);
  lit_9 = YPPsym((P)"module-src-file-setter");
  T29 = YPsig(YPPlist(2,LITREF(lit_4),LITREF(lit_2)),YPPlist(2,VARREF(YLstrG),VARREF(YcompilerSp2cYLg2c_moduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_src_file_setter_5 = YPmet(FUNCODEREF(fun_module_src_file_setter_5),LITREF(lit_9),T29,ENVNUL,PNUL,YPfalse);
  T32 = BOUNDP(YcompilerSp2cYmodule_src_file_setter);
  if (T32 != YPfalse) {
    T31 = VARREF(YcompilerSp2cYmodule_src_file_setter);
  } else {
    T31 = YPfalse;
  }
  T33 = fun_module_src_file_setter_5;
  T30 = CALL2(1,VARREF(YPdefine_method),T31,T33);
  VARSET(YcompilerSp2cYmodule_src_file_setter,T30);
  CALLN(1,VARREF(YPprop),5,VARREF(YcompilerSp2cYLg2c_moduleG),VARREF(YcompilerSp2cYmodule_src_file),VARREF(YcompilerSp2cYmodule_src_file_setter),VARREF(YLstrG),VARREF(YPprop_unbound_error));
  lit_10 = YPPsym((P)"module-mtime");
  T34 = YPsig(YPPlist(1,LITREF(lit_2)),YPPlist(1,VARREF(YcompilerSp2cYLg2c_moduleG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_module_mtime_6 = YPmet(FUNCODEREF(fun_module_mtime_6),LITREF(lit_10),T34,ENVNUL,PNUL,YPfalse);
  T37 = BOUNDP(YcompilerSp2cYmodule_mtime);
  if (T37 != YPfalse) {
    T36 = VARREF(YcompilerSp2cYmodule_mtime);
  } else {
    T36 = YPfalse;
  }
  T38 = fun_module_mtime_6;
  T35 = CALL2(1,VARREF(YPdefine_method),T36,T38);
  VARSET(YcompilerSp2cYmodule_mtime,T35);
  lit_11 = YPPsym((P)"module-mtime-setter");
  T39 = YPsig(YPPlist(2,LITREF(lit_4),LITREF(lit_2)),YPPlist(2,VARREF(YLfloG),VARREF(YcompilerSp2cYLg2c_moduleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_module_mtime_setter_7 = YPmet(FUNCODEREF(fun_module_mtime_setter_7),LITREF(lit_11),T39,ENVNUL,PNUL,YPfalse);
  T42 = BOUNDP(YcompilerSp2cYmodule_mtime_setter);
  if (T42 != YPfalse) {
    T41 = VARREF(YcompilerSp2cYmodule_mtime_setter);
  } else {
    T41 = YPfalse;
  }
  T43 = fun_module_mtime_setter_7;
  T40 = CALL2(1,VARREF(YPdefine_method),T41,T43);
  VARSET(YcompilerSp2cYmodule_mtime_setter,T40);
  CALLN(1,VARREF(YPprop),5,VARREF(YcompilerSp2cYLg2c_moduleG),VARREF(YcompilerSp2cYmodule_mtime),VARREF(YcompilerSp2cYmodule_mtime_setter),VARREF(YLfloG),VARREF(YPprop_unbound_error));
  lit_12 = YPPsym((P)"module-loader-module-type");
  lit_13 = YPPsym((P)"loader");
  T44 = YPsig(YPPlist(1,LITREF(lit_13)),YPPlist(1,VARREF(YcompilerSp2cYLg2c_module_loaderG)),YPfalse,YPint((P)1),VARREF(YLtypeG),Ynil);
  ...
  T49 = YPsig(YPPlist(2,LITREF(lit_13),LITREF(lit_15)),YPPlist(2,VARREF(YcompilerSp2cYLg2c_module_loaderG),VARREF(YLsymG)),YPfalse,YPint((P)2),VARREF(YcompilerSastYLmoduleG),Ynil);
  ...
  lit_17 = YPPsym((P)"mod");
  T58 = YPsig(YPPlist(1,LITREF(lit_17)),YPPlist(1,VARREF(YcompilerSp2cYLg2c_moduleG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  YcompilerSp2cYmodule_up_to_dateQ = YPmet(FUNCODEREF(YcompilerSp2cYmodule_up_to_dateQ),LITREF(lit_16),T58,ENVNUL,PNUL,YPfalse);
  T59 = YcompilerSp2cYmodule_up_to_dateQ;
  VARSET(YcompilerSp2cYmodule_up_to_dateQ,T59);
  ...
  YcompilerSp2cYpurge_outdated_modules = YPmet(FUNCODEREF(YcompilerSp2cYpurge_outdated_modules),LITREF(lit_18),T60,ENVNUL,PNUL,YPfalse);
  T63 = YcompilerSp2cYpurge_outdated_modules;
  VARSET(YcompilerSp2cYpurge_outdated_modules,T63);
  lit_20 = YPPsym((P)"g2c-def-app");
  lit_21 = YPPsym((P)"appname");
  lit_22 = YPPsym((P)"modname");
  T64 = YPsig(YPPlist(2,LITREF(lit_21),LITREF(lit_22)),YPPlist(2,VARREF(YLstrG),VARREF(YLsymG)),YPfalse,YPint((P)2),VARREF(YcompilerSp2cYLg2c_module_loaderG),Ynil);
  YcompilerSp2cYg2c_def_app = YPmet(FUNCODEREF(YcompilerSp2cYg2c_def_app),LITREF(lit_20),T64,ENVNUL,PNUL,YPfalse);
  T65 = YcompilerSp2cYg2c_def_app;
  VARSET(YcompilerSp2cYg2c_def_app,T65);
  lit_23 = YPPsym((P)"g2c-build-app");
  lit_24 = YPsb((P)"Searching for undefined global bindings.\n");
  T66 = YPsig(YPPlist(1,LITREF(lit_13)),YPPlist(1,VARREF(YcompilerSp2cYLg2c_module_loaderG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YcompilerSp2cYg2c_build_app = YPmet(FUNCODEREF(YcompilerSp2cYg2c_build_app),LITREF(lit_23),T66,ENVNUL,PNUL,YPfalse);
  T67 = YcompilerSp2cYg2c_build_app;
  VARSET(YcompilerSp2cYg2c_build_app,T67);
  lit_25 = YPPsym((P)"g2c-test");
  lit_26 = YPPsym((P)"x");
  lit_27 = YPsb((P)"g2c-");
  lit_28 = YPPsym((P)"main");
  T68 = YPsig(YPPlist(1,LITREF(lit_26)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YcompilerSp2cYg2c_test = YPmet(FUNCODEREF(YcompilerSp2cYg2c_test),LITREF(lit_25),T68,ENVNUL,PNUL,YPfalse);
  T69 = YcompilerSp2cYg2c_test;
  VARSET(YcompilerSp2cYg2c_test,T69);
  VARSET(YcompilerSp2cYTtmp_file_counterT,YPint((P)-1));
  ...
  T79 = BOUNDP(YcompilerSp2cYg2c_ast);
  if (T79 != YPfalse) {
    T78 = VARREF(YcompilerSp2cYg2c_ast);
  } else {
    T78 = YPfalse;
  }
  T80 = fun_g2c_ast_27;
  T77 = CALL2(1,VARREF(YPdefine_method),T78,T80);
  VARSET(YcompilerSp2cYg2c_ast,T77);
  ...
  T84 = BOUNDP(YcompilerSp2cYg2c_exp);
  if (T84 != YPfalse) {
    T83 = VARREF(YcompilerSp2cYg2c_exp);
  } else {
    T83 = YPfalse;
  }
  T85 = fun_g2c_exp_28;
  T82 = CALL2(1,VARREF(YPdefine_method),T83,T85);
  VARSET(YcompilerSp2cYg2c_exp,T82);
  ...
  T89 = BOUNDP(YcompilerSp2cYcompile_load);
  if (T89 != YPfalse) {
    T88 = VARREF(YcompilerSp2cYcompile_load);
  } else {
    T88 = YPfalse;
  }
  T90 = fun_compile_load_29;
  T87 = CALL2(1,VARREF(YPdefine_method),T88,T90);
  VARSET(YcompilerSp2cYcompile_load,T87);
  ...
  T94 = BOUNDP(YcompilerSp2cYso_load);
  if (T94 != YPfalse) {
    T93 = VARREF(YcompilerSp2cYso_load);
  } else {
    T93 = YPfalse;
  }
  T95 = fun_so_load_30;
  T92 = CALL2(1,VARREF(YPdefine_method),T93,T95);
  VARSET(YcompilerSp2cYso_load,T92);
  ...
  lit_38 = YPsb((P)"g2c");
  T106 = CALL2(1,VARREF(YcompilerSp2cYg2c_def_app),LITREF(lit_38),LITREF(lit_28));
  VARSET(YcompilerSp2cYTg2c_appT,T106);
  ...
  T110 = BOUNDP(YcompilerSp2cYg2c_top);
  if (T110 != YPfalse) {
    T109 = VARREF(YcompilerSp2cYg2c_top);
  } else {
    T109 = YPfalse;
  }
  T111 = fun_g2c_top_33;
  T108 = CALL2(1,VARREF(YPdefine_method),T109,T111);
  VARSET(YcompilerSp2cYg2c_top,T108);
  ...
  T115 = BOUNDP(YcompilerSp2cYg2c_clean);
  if (T115 != YPfalse) {
    T114 = VARREF(YcompilerSp2cYg2c_clean);
  } else {
    T114 = YPfalse;
  }
  T116 = fun_g2c_clean_34;
  T113 = CALL2(1,VARREF(YPdefine_method),T114,T116);
  VARSET(YcompilerSp2cYg2c_clean,T113);
  ...
  T120 = BOUNDP(YcompilerSp2cYcompute_ast);
  if (T120 != YPfalse) {
    T119 = VARREF(YcompilerSp2cYcompute_ast);
  } else {
    T119 = YPfalse;
  }
  T121 = fun_compute_ast_35;
  T118 = CALL2(1,VARREF(YPdefine_method),T119,T121);
  VARSET(YcompilerSp2cYcompute_ast,T118);
  ...
  T125 = BOUNDP(YcompilerSp2cYcompute_program);
  if (T125 != YPfalse) {
    T124 = VARREF(YcompilerSp2cYcompute_program);
  } else {
    T124 = YPfalse;
  }
  T126 = fun_compute_program_36;
  T123 = CALL2(1,VARREF(YPdefine_method),T124,T126);
  VARSET(YcompilerSp2cYcompute_program,T123);
  ...
  T130 = BOUNDP(YcompilerSp2cYgenerate_c_module);
  if (T130 != YPfalse) {
    T129 = VARREF(YcompilerSp2cYgenerate_c_module);
  } else {
    T129 = YPfalse;
  }
  T131 = fun_generate_c_module_37;
  T128 = CALL2(1,VARREF(YPdefine_method),T129,T131);
  VARSET(YcompilerSp2cYgenerate_c_module,T128);
  ...
  T137 = BOUNDP(YcompilerSp2cYgenerate_c_application);
  if (T137 != YPfalse) {
    T136 = VARREF(YcompilerSp2cYgenerate_c_application);
  } else {
    T136 = YPfalse;
  }
  T138 = fun_generate_c_application_40;
  T135 = CALL2(1,VARREF(YPdefine_method),T136,T138);
  VARSET(YcompilerSp2cYgenerate_c_application,T135);
  ...
  T145 = BOUNDP(YcompilerSp2cYgenerate_makefile);
  if (T145 != YPfalse) {
    T144 = VARREF(YcompilerSp2cYgenerate_makefile);
  } else {
    T144 = YPfalse;
  }
  T146 = fun_generate_makefile_44;
  T143 = CALL2(1,VARREF(YPdefine_method),T144,T146);
  VARSET(YcompilerSp2cYgenerate_makefile,T143);
  lit_65 = YPPsym((P)"pp");
  ...
  T150 = BOUNDP(YcompilerSp2cYpp);
  if (T150 != YPfalse) {
    T149 = VARREF(YcompilerSp2cYpp);
  } else {
    T149 = YPfalse;
  }
  T151 = fun_pp_45;
  T148 = CALL2(1,VARREF(YPdefine_method),T149,T151);
  VARSET(YcompilerSp2cYpp,T148);
  lit_66 = YPPsym((P)"generate-header");
  lit_67 = YPsb((P)"/* GOO 2 C $REVISION: 0.111 $ \n");
  lit_68 = YPsb((P)"  */\n\n#include \"prt.h\"\n");
  lit_69 = YPsb((P)"#include \"dlprt.h\"\n");
  ...
  T155 = BOUNDP(YcompilerSp2cYgenerate_header);
  if (T155 != YPfalse) {
    T154 = VARREF(YcompilerSp2cYgenerate_header);
  } else {
    T154 = YPfalse;
  }
  T156 = fun_generate_header_46;
  T153 = CALL2(1,VARREF(YPdefine_method),T154,T156);
  VARSET(YcompilerSp2cYgenerate_header,T153);
  ...
  T160 = BOUNDP(YcompilerSp2cYgenerate_trailer);
  if (T160 != YPfalse) {
    T159 = VARREF(YcompilerSp2cYgenerate_trailer);
  } else {
    T159 = YPfalse;
  }
  T161 = fun_generate_trailer_47;
  T158 = CALL2(1,VARREF(YPdefine_method),T159,T161);
  VARSET(YcompilerSp2cYgenerate_trailer,T158);
  ...
  T166 = BOUNDP(YcompilerSp2cYgenerate_global_environment);
  if (T166 != YPfalse) {
    T165 = VARREF(YcompilerSp2cYgenerate_global_environment);
  } else {
    T165 = YPfalse;
  }
  T167 = fun_generate_global_environment_49;
  T164 = CALL2(1,VARREF(YPdefine_method),T165,T167);
  VARSET(YcompilerSp2cYgenerate_global_environment,T164);
  ...
  T171 = BOUNDP(YcompilerSp2cYgenerate_global_binding);
  if (T171 != YPfalse) {
    T170 = VARREF(YcompilerSp2cYgenerate_global_binding);
  } else {
    T170 = YPfalse;
  }
  T172 = fun_generate_global_binding_50;
  T169 = CALL2(1,VARREF(YPdefine_method),T170,T172);
  VARSET(YcompilerSp2cYgenerate_global_binding,T169);
  lit_83 = YPsb((P)"Y");
  VARSET(YcompilerSp2cYDmodule_separator,LITREF(lit_83));
  lit_84 = YPsb((P)"_");
  VARSET(YcompilerSp2cYDlocal_suffix,LITREF(lit_84));
  lit_85 = YPsb((P)"F");
  VARSET(YcompilerSp2cYDhygiene_marker,LITREF(lit_85));
  lit_86 = YPsb((P)"Z");
  VARSET(YcompilerSp2cYDescape_separator,LITREF(lit_86));
  lit_87 = YPsb((P)"I");
  VARSET(YcompilerSp2cYDiep_suffix,LITREF(lit_87));
  lit_88 = YPsb((P)"M");
  T174 = VARSET(YcompilerSp2cYDmethod_mangled_marker_string,LITREF(lit_88));
  T173 = T174;
  return T173;
}

P YcompilerSp2cY___main_1___() {
  P x_1488F2344;
  P x_1486F2343;
  P x_1484F2342;
  P x_1482F2341;
  ...
  P T1,T0;
loop:
  T0 = CALL2(1,VARREF(YgooSmacrosYelt),VARREF(YcompilerSp2cYDmodule_separator),YPint((P)0));
  VARSET(YcompilerSp2cYDmodule_marker,T0);
  T1 = CALL2(1,VARREF(YgooSmacrosYelt),VARREF(YcompilerSp2cYDlocal_suffix),YPint((P)0));
  VARSET(YcompilerSp2cYDlocal_marker,T1);
  T2 = CALL2(1,VARREF(YgooSmacrosYelt),VARREF(YcompilerSp2cYDhygiene_marker),YPint((P)0));
  VARSET(YcompilerSp2cYDhygiene_char,T2);
  T3 = CALL2(1,VARREF(YgooSmacrosYelt),VARREF(YcompilerSp2cYDescape_separator),YPint((P)0));
  VARSET(YcompilerSp2cYDescape_marker,T3);
  T4 = CALL2(1,VARREF(YgooSmacrosYelt),VARREF(YcompilerSp2cYDiep_suffix),YPint((P)0));
  VARSET(YcompilerSp2cYDiep_marker,T4);
  T5 = CALL2(1,VARREF(YgooSmacrosYelt),VARREF(YcompilerSp2cYDmethod_mangled_marker_string),YPint((P)0));
  VARSET(YcompilerSp2cYDmethod_mangled_marker,T5);
  VARSET(YcompilerSp2cYDmin_character_code,YPint((P)0));
  VARSET(YcompilerSp2cYDmax_character_code,YPint((P)255));
  T6 = CALL1(1,VARREF(Ynew),VARREF(YgooScollectionsSbufferYLbufG));
  VARSET(YcompilerSp2cYTmangle_bufferT,T6);
  ...
  VARSET(YcompilerSp2cYDmangles_data,T7);
  ...
  YcompilerSp2cYchar_buffer_as_string = YPmet(FUNCODEREF(YcompilerSp2cYchar_buffer_as_string),LITREF(lit_106),T8,ENVNUL,PNUL,YPfalse);
  T10 = YcompilerSp2cYchar_buffer_as_string;
  VARSET(YcompilerSp2cYchar_buffer_as_string,T10);
  lit_110 = YPsb((P)"\\t");
  lit_111 = YPsb((P)"\\f");
  lit_112 = YPsb((P)"\\r");
  lit_113 = YPsb((P)"\\n");
  ...
  T24 = BOUNDP(YcompilerSp2cYmangle_string_literal);
  if (T24 != YPfalse) {
    T23 = VARREF(YcompilerSp2cYmangle_string_literal);
  } else {
    T23 = YPfalse;
  }
  T25 = fun_mangle_string_literal_54;
  T22 = CALL2(1,VARREF(YPdefine_method),T23,T25);
  VARSET(YcompilerSp2cYmangle_string_literal,T22);
  ...
  T29 = BOUNDP(YcompilerSp2cYmangle_string_literal);
  if (T29 != YPfalse) {
    T28 = VARREF(YcompilerSp2cYmangle_string_literal);
  } else {
    T28 = YPfalse;
  }
  T30 = fun_mangle_string_literal_55;
  T27 = CALL2(1,VARREF(YPdefine_method),T28,T30);
  VARSET(YcompilerSp2cYmangle_string_literal,T27);
  lit_121 = YPsb((P)"0123456789");
  VARSET(YcompilerSp2cYDnumber_characters,LITREF(lit_121));
  ...
  T35 = BOUNDP(YcompilerSp2cYmangle_integer);
  if (T35 != YPfalse) {
    T34 = VARREF(YcompilerSp2cYmangle_integer);
  } else {
    T34 = YPfalse;
  }
  T36 = fun_mangle_integer_57;
  T33 = CALL2(1,VARREF(YPdefine_method),T34,T36);
  VARSET(YcompilerSp2cYmangle_integer,T33);
  ...
  T43 = CALL2(1,VARREF(YgooSmathYA),VARREF(YcompilerSp2cYDmax_character_code),YPint((P)1));
  ...
  T47 = CALL3(1,VARREF(YgooScollectionsSrangeYrange),VARREF(YcompilerSp2cYDmin_character_code),VARREF(YgooSmagnitudeYLE),VARREF(YcompilerSp2cYDmax_character_code));
  T46 = CALL1(1,VARREF(YgooScollectionsScollectionYenum),T47);
  T45 = CALL1(1,x_1482F2341,T46);
  T48 = FUNSHELL(1,fun_x_1484_59,2);
  x_1484F2342 = T48;
  FUNINIT(x_1484F2342, 2,tableF2340,x_1484F2342);
  T50 = CALL1(1,VARREF(YgooScollectionsScollectionYenum),VARREF(YcompilerSp2cYDmangles_data));
  T49 = CALL1(1,x_1484F2342,T50);
  T51 = FUNSHELL(1,fun_x_1486_60,2);
  x_1486F2343 = T51;
  FUNINIT(x_1486F2343, 2,tableF2340,x_1486F2343);
  T55 = CALL2(1,VARREF(YgooStypeYas),VARREF(YLintG),YPchr((P)97));
  T56 = CALL2(1,VARREF(YgooStypeYas),VARREF(YLintG),YPchr((P)122));
  ...
  T52 = CALL1(1,x_1486F2343,T53);
  T57 = FUNSHELL(1,fun_x_1488_61,2);
  x_1488F2344 = T57;
  FUNINIT(x_1488F2344, 2,tableF2340,x_1488F2344);
  T61 = CALL2(1,VARREF(YgooStypeYas),VARREF(YLintG),YPchr((P)48));
  T62 = CALL2(1,VARREF(YgooStypeYas),VARREF(YLintG),YPchr((P)57));
  ...
  T58 = CALL1(1,x_1488F2344,T59);
  T41 = tableF2340;
  VARSET(YcompilerSp2cYDname_mangler_table,T41);
  ...
  YcompilerSp2cYmangler_reset = YPmet(FUNCODEREF(YcompilerSp2cYmangler_reset),LITREF(lit_134),T63,ENVNUL,PNUL,YPfalse);
  T64 = YcompilerSp2cYmangler_reset;
  VARSET(YcompilerSp2cYmangler_reset,T64);
  ...
  YcompilerSp2cYmangle_name_into = YPmet(FUNCODEREF(YcompilerSp2cYmangle_name_into),LITREF(lit_135),T65,ENVNUL,PNUL,YPfalse);
  T67 = YcompilerSp2cYmangle_name_into;
  VARSET(YcompilerSp2cYmangle_name_into,T67);
  ...
  T71 = BOUNDP(YcompilerSp2cYmangle_raw_name);
  if (T71 != YPfalse) {
    T70 = VARREF(YcompilerSp2cYmangle_raw_name);
  } else {
    T70 = YPfalse;
  }
  T72 = fun_mangle_raw_name_65;
  T69 = CALL2(1,VARREF(YPdefine_method),T70,T72);
  VARSET(YcompilerSp2cYmangle_raw_name,T69);
  ...
  T76 = BOUNDP(YcompilerSp2cYmangle_raw_name);
  if (T76 != YPfalse) {
    T75 = VARREF(YcompilerSp2cYmangle_raw_name);
  } else {
    T75 = YPfalse;
  }
  T77 = fun_mangle_raw_name_66;
  T74 = CALL2(1,VARREF(YPdefine_method),T75,T77);
  VARSET(YcompilerSp2cYmangle_raw_name,T74);
  ...
  T81 = BOUNDP(YcompilerSp2cYmangle_local_name);
  if (T81 != YPfalse) {
    T80 = VARREF(YcompilerSp2cYmangle_local_name);
  } else {
    T80 = YPfalse;
  }
  T82 = fun_mangle_local_name_67;
  T79 = CALL2(1,VARREF(YPdefine_method),T80,T82);
  VARSET(YcompilerSp2cYmangle_local_name,T79);
  ...
  T86 = BOUNDP(YcompilerSp2cYmangle_local_name);
  if (T86 != YPfalse) {
    T85 = VARREF(YcompilerSp2cYmangle_local_name);
  } else {
    T85 = YPfalse;
  }
  T87 = fun_mangle_local_name_68;
  T84 = CALL2(1,VARREF(YPdefine_method),T85,T87);
  VARSET(YcompilerSp2cYmangle_local_name,T84);
  ...
  T91 = BOUNDP(YcompilerSp2cYmangle_global_name);
  if (T91 != YPfalse) {
    T90 = VARREF(YcompilerSp2cYmangle_global_name);
  } else {
    T90 = YPfalse;
  }
  T92 = fun_mangle_global_name_69;
  T89 = CALL2(1,VARREF(YPdefine_method),T90,T92);
  VARSET(YcompilerSp2cYmangle_global_name,T89);
  ...
  T96 = BOUNDP(YcompilerSp2cYmangle_global_name);
  if (T96 != YPfalse) {
    T95 = VARREF(YcompilerSp2cYmangle_global_name);
  } else {
    T95 = YPfalse;
  }
  T97 = fun_mangle_global_name_70;
  T94 = CALL2(1,VARREF(YPdefine_method),T95,T97);
  VARSET(YcompilerSp2cYmangle_global_name,T94);
  ...
  T101 = BOUNDP(YcompilerSp2cYmangle_boot_name);
  if (T101 != YPfalse) {
    T100 = VARREF(YcompilerSp2cYmangle_boot_name);
  } else {
    T100 = YPfalse;
  }
  T102 = fun_mangle_boot_name_71;
  T99 = CALL2(1,VARREF(YPdefine_method),T100,T102);
  VARSET(YcompilerSp2cYmangle_boot_name,T99);
  ...
  T106 = BOUNDP(YcompilerSp2cYmangle_module_binding);
  if (T106 != YPfalse) {
    T105 = VARREF(YcompilerSp2cYmangle_module_binding);
  } else {
    T105 = YPfalse;
  }
  T107 = fun_mangle_module_binding_72;
  T104 = CALL2(1,VARREF(YPdefine_method),T105,T107);
  VARSET(YcompilerSp2cYmangle_module_binding,T104);
  ...
  T111 = BOUNDP(YcompilerSp2cYmangle_local_marked_name);
  if (T111 != YPfalse) {
    T110 = VARREF(YcompilerSp2cYmangle_local_marked_name);
  } else {
    T110 = YPfalse;
  }
  T112 = fun_mangle_local_marked_name_73;
  T109 = CALL2(1,VARREF(YPdefine_method),T110,T112);
  VARSET(YcompilerSp2cYmangle_local_marked_name,T109);
  ...
  T116 = BOUNDP(YcompilerSp2cYmangle_local_marked_name);
  if (T116 != YPfalse) {
    T115 = VARREF(YcompilerSp2cYmangle_local_marked_name);
  } else {
    T115 = YPfalse;
  }
  T117 = fun_mangle_local_marked_name_74;
  T114 = CALL2(1,VARREF(YPdefine_method),T115,T117);
  VARSET(YcompilerSp2cYmangle_local_marked_name,T114);
  ...
  T121 = fun_77;
  YPmacro(YPPsym((P)"compiler/p2c"),YPPsym((P)"for-commas"),T121);
  ...
  T125 = fun_80;
  YPmacro(YPPsym((P)"compiler/p2c"),YPPsym((P)"between-parentheses"),T125);
  ...
  T130 = fun_84;
  YPmacro(YPPsym((P)"compiler/p2c"),YPPsym((P)"between-parentheses-comma-separated"),T130);
  ...
  T134 = BOUNDP(YcompilerSp2cYgen_result);
  if (T134 != YPfalse) {
    T133 = VARREF(YcompilerSp2cYgen_result);
  } else {
    T133 = YPfalse;
  }
  T135 = fun_gen_result_85;
  T132 = CALL2(1,VARREF(YPdefine_method),T133,T135);
  VARSET(YcompilerSp2cYgen_result,T132);
  ...
  T140 = BOUNDP(YcompilerSp2cYgen_depth);
  if (T140 != YPfalse) {
    T139 = VARREF(YcompilerSp2cYgen_depth);
  } else {
    T139 = YPfalse;
  }
  T141 = fun_gen_depth_87;
  T138 = CALL2(1,VARREF(YPdefine_method),T139,T141);
  VARSET(YcompilerSp2cYgen_depth,T138);
  ...
  T145 = fun_90;
  YPmacro(YPPsym((P)"compiler/p2c"),YPPsym((P)"with-statement"),T145);
  ...
  T149 = fun_93;
  YPmacro(YPPsym((P)"compiler/p2c"),YPPsym((P)"with-expression"),T149);
  ...
  T153 = fun_96;
  YPmacro(YPPsym((P)"compiler/p2c"),YPPsym((P)"with-used-expression"),T153);
  ...
  T158 = BOUNDP(YcompilerSp2cYgenerate_quotation_forwards);
  if (T158 != YPfalse) {
    T157 = VARREF(YcompilerSp2cYgenerate_quotation_forwards);
  } else {
    T157 = YPfalse;
  }
  T159 = fun_generate_quotation_forwards_98;
  T156 = CALL2(1,VARREF(YPdefine_method),T157,T159);
  VARSET(YcompilerSp2cYgenerate_quotation_forwards,T156);
  ...
  T164 = BOUNDP(YcompilerSp2cYgenerate_quotations);
  if (T164 != YPfalse) {
    T163 = VARREF(YcompilerSp2cYgenerate_quotations);
  } else {
    T163 = YPfalse;
  }
  T165 = fun_generate_quotations_100;
  T162 = CALL2(1,VARREF(YPdefine_method),T163,T165);
  VARSET(YcompilerSp2cYgenerate_quotations,T162);
  ...
  T169 = BOUNDP(YcompilerSp2cYfalse_name);
  if (T169 != YPfalse) {
    T168 = VARREF(YcompilerSp2cYfalse_name);
  } else {
    T168 = YPfalse;
  }
  T170 = fun_false_name_101;
  T167 = CALL2(1,VARREF(YPdefine_method),T168,T170);
  VARSET(YcompilerSp2cYfalse_name,T167);
  ...
  T174 = BOUNDP(YcompilerSp2cYgenerate_quotation);
  if (T174 != YPfalse) {
    T173 = VARREF(YcompilerSp2cYgenerate_quotation);
  } else {
    T173 = YPfalse;
  }
  T175 = fun_generate_quotation_102;
  T172 = CALL2(1,VARREF(YPdefine_method),T173,T175);
  VARSET(YcompilerSp2cYgenerate_quotation,T172);
  lit_198 = YPsb((P)"nil");
  T177 = CALL1(1,VARREF(YgooStypeYtE),Ynil);
  ...
  T180 = BOUNDP(YcompilerSp2cYgenerate_quotation);
  if (T180 != YPfalse) {
    T179 = VARREF(YcompilerSp2cYgenerate_quotation);
  } else {
    T179 = YPfalse;
  }
  T181 = fun_generate_quotation_103;
  T178 = CALL2(1,VARREF(YPdefine_method),T179,T181);
  VARSET(YcompilerSp2cYgenerate_quotation,T178);
  ...
  T186 = BOUNDP(YcompilerSp2cYgenerate_quotation);
  if (T186 != YPfalse) {
    T185 = VARREF(YcompilerSp2cYgenerate_quotation);
  } else {
    T185 = YPfalse;
  }
  T187 = fun_generate_quotation_105;
  T184 = CALL2(1,VARREF(YPdefine_method),T185,T187);
  VARSET(YcompilerSp2cYgenerate_quotation,T184);
  ...
  T191 = BOUNDP(YcompilerSp2cYgenerate_quotation);
  if (T191 != YPfalse) {
    T190 = VARREF(YcompilerSp2cYgenerate_quotation);
  } else {
    T190 = YPfalse;
  }
  T192 = fun_generate_quotation_106;
  T189 = CALL2(1,VARREF(YPdefine_method),T190,T192);
  VARSET(YcompilerSp2cYgenerate_quotation,T189);
  ...
  T196 = BOUNDP(YcompilerSp2cYgenerate_quotation);
  if (T196 != YPfalse) {
    T195 = VARREF(YcompilerSp2cYgenerate_quotation);
  } else {
    T195 = YPfalse;
  }
  T197 = fun_generate_quotation_107;
  T194 = CALL2(1,VARREF(YPdefine_method),T195,T197);
  VARSET(YcompilerSp2cYgenerate_quotation,T194);
  ...
  T203 = BOUNDP(YcompilerSp2cYfloat_to_c_string);
  if (T203 != YPfalse) {
    T202 = VARREF(YcompilerSp2cYfloat_to_c_string);
  } else {
    T202 = YPfalse;
  }
  T204 = fun_float_to_c_string_110;
  T201 = CALL2(1,VARREF(YPdefine_method),T202,T204);
  VARSET(YcompilerSp2cYfloat_to_c_string,T201);
  ...
  T208 = BOUNDP(YcompilerSp2cYgenerate_quotation);
  if (T208 != YPfalse) {
    T207 = VARREF(YcompilerSp2cYgenerate_quotation);
  } else {
    T207 = YPfalse;
  }
  T209 = fun_generate_quotation_111;
  T206 = CALL2(1,VARREF(YPdefine_method),T207,T209);
  VARSET(YcompilerSp2cYgenerate_quotation,T206);
  ...
  T213 = BOUNDP(YcompilerSp2cYgenerate_quotation);
  if (T213 != YPfalse) {
    T212 = VARREF(YcompilerSp2cYgenerate_quotation);
  } else {
    T212 = YPfalse;
  }
  T214 = fun_generate_quotation_112;
  T211 = CALL2(1,VARREF(YPdefine_method),T212,T214);
  VARSET(YcompilerSp2cYgenerate_quotation,T211);
  ...
  T219 = BOUNDP(YcompilerSp2cYgenerate_quotation);
  if (T219 != YPfalse) {
    T218 = VARREF(YcompilerSp2cYgenerate_quotation);
  } else {
    T218 = YPfalse;
  }
  T220 = fun_generate_quotation_114;
  T217 = CALL2(1,VARREF(YPdefine_method),T218,T220);
  VARSET(YcompilerSp2cYgenerate_quotation,T217);
  ...
  T224 = BOUNDP(YcompilerSp2cYgenerate_quotation);
  if (T224 != YPfalse) {
    T223 = VARREF(YcompilerSp2cYgenerate_quotation);
  } else {
    T223 = YPfalse;
  }
  T225 = fun_generate_quotation_115;
  T222 = CALL2(1,VARREF(YPdefine_method),T223,T225);
  VARSET(YcompilerSp2cYgenerate_quotation,T222);
  ...
  VARSET(YcompilerSp2cYbinding_Gc,T226);
  ...
  T231 = BOUNDP(YcompilerSp2cYbinding_Gc);
  if (T231 != YPfalse) {
    T230 = VARREF(YcompilerSp2cYbinding_Gc);
  } else {
    T230 = YPfalse;
  }
  T232 = fun_binding_Gc_116;
  T229 = CALL2(1,VARREF(YPdefine_method),T230,T232);
  VARSET(YcompilerSp2cYbinding_Gc,T229);
  ...
  T236 = BOUNDP(YcompilerSp2cYbinding_Gc);
  if (T236 != YPfalse) {
    T235 = VARREF(YcompilerSp2cYbinding_Gc);
  } else {
    T235 = YPfalse;
  }
  T237 = fun_binding_Gc_117;
  T234 = CALL2(1,VARREF(YPdefine_method),T235,T237);
  VARSET(YcompilerSp2cYbinding_Gc,T234);
  ...
  T241 = BOUNDP(YcompilerSp2cYbinding_Gc);
  if (T241 != YPfalse) {
    T240 = VARREF(YcompilerSp2cYbinding_Gc);
  } else {
    T240 = YPfalse;
  }
  T242 = fun_binding_Gc_118;
  T239 = CALL2(1,VARREF(YPdefine_method),T240,T242);
  VARSET(YcompilerSp2cYbinding_Gc,T239);
  ...
  VARSET(YcompilerSp2cYreference_Gc,T243);
  ...
  T248 = BOUNDP(YcompilerSp2cYreference_Gc);
  if (T248 != YPfalse) {
    T247 = VARREF(YcompilerSp2cYreference_Gc);
  } else {
    T247 = YPfalse;
  }
  T249 = fun_reference_Gc_119;
  T246 = CALL2(1,VARREF(YPdefine_method),T247,T249);
  VARSET(YcompilerSp2cYreference_Gc,T246);
  ...
  T253 = BOUNDP(YcompilerSp2cYreference_Gc);
  if (T253 != YPfalse) {
    T252 = VARREF(YcompilerSp2cYreference_Gc);
  } else {
    T252 = YPfalse;
  }
  T254 = fun_reference_Gc_120;
  T251 = CALL2(1,VARREF(YPdefine_method),T252,T254);
  VARSET(YcompilerSp2cYreference_Gc,T251);
  ...
  VARSET(YcompilerSp2cYto_c,T255);
  ...
  T260 = BOUNDP(YcompilerSp2cYto_c);
  if (T260 != YPfalse) {
    T259 = VARREF(YcompilerSp2cYto_c);
  } else {
    T259 = YPfalse;
  }
  T261 = fun_to_c_121;
  T258 = CALL2(1,VARREF(YPdefine_method),T259,T261);
  VARSET(YcompilerSp2cYto_c,T258);
  ...
  T265 = BOUNDP(YcompilerSp2cYto_c);
  if (T265 != YPfalse) {
    T264 = VARREF(YcompilerSp2cYto_c);
  } else {
    T264 = YPfalse;
  }
  T266 = fun_to_c_122;
  T263 = CALL2(1,VARREF(YPdefine_method),T264,T266);
  VARSET(YcompilerSp2cYto_c,T263);
  ...
  T270 = BOUNDP(YcompilerSp2cYgen_ref);
  if (T270 != YPfalse) {
    T269 = VARREF(YcompilerSp2cYgen_ref);
  } else {
    T269 = YPfalse;
  }
  T271 = fun_gen_ref_123;
  T268 = CALL2(1,VARREF(YPdefine_method),T269,T271);
  VARSET(YcompilerSp2cYgen_ref,T268);
  ...
  T275 = BOUNDP(YcompilerSp2cYgen_ref);
  if (T275 != YPfalse) {
    T274 = VARREF(YcompilerSp2cYgen_ref);
  } else {
    T274 = YPfalse;
  }
  T276 = fun_gen_ref_124;
  T273 = CALL2(1,VARREF(YPdefine_method),T274,T276);
  VARSET(YcompilerSp2cYgen_ref,T273);
  lit_230 = YPsb((P)"T%d");
  lit_231 = YPsb((P)"T_1");
  ...
  T280 = BOUNDP(YcompilerSp2cYgen_ref);
  if (T280 != YPfalse) {
    T279 = VARREF(YcompilerSp2cYgen_ref);
  } else {
    T279 = YPfalse;
  }
  T281 = fun_gen_ref_125;
  T278 = CALL2(1,VARREF(YPdefine_method),T279,T281);
  VARSET(YcompilerSp2cYgen_ref,T278);
  lit_232 = YPsb((P)"(P)%s");
  ...
  T288 = BOUNDP(YcompilerSp2cYgen_ref);
  if (T288 != YPfalse) {
    T287 = VARREF(YcompilerSp2cYgen_ref);
  } else {
    T287 = YPfalse;
  }
  T289 = fun_gen_ref_126;
  T286 = CALL2(1,VARREF(YPdefine_method),T287,T289);
  T285 = VARSET(YcompilerSp2cYgen_ref,T286);
  T282 = T285;
  return T282;
}

P YcompilerSp2cY___main_2___() {
...
loop:
  ...
  T3 = BOUNDP(YcompilerSp2cYgen_ref);
  if (T3 != YPfalse) {
    T2 = VARREF(YcompilerSp2cYgen_ref);
  } else {
    T2 = YPfalse;
  }
  T4 = fun_gen_ref_127;
  T1 = CALL2(1,VARREF(YPdefine_method),T2,T4);
  VARSET(YcompilerSp2cYgen_ref,T1);
  ...
  T8 = BOUNDP(YcompilerSp2cYgen_ref);
  if (T8 != YPfalse) {
    T7 = VARREF(YcompilerSp2cYgen_ref);
  } else {
    T7 = YPfalse;
  }
  T9 = fun_gen_ref_128;
  T6 = CALL2(1,VARREF(YPdefine_method),T7,T9);
  VARSET(YcompilerSp2cYgen_ref,T6);
  ...
  T13 = BOUNDP(YcompilerSp2cYto_c);
  if (T13 != YPfalse) {
    T12 = VARREF(YcompilerSp2cYto_c);
  } else {
    T12 = YPfalse;
  }
  T14 = fun_to_c_129;
  T11 = CALL2(1,VARREF(YPdefine_method),T12,T14);
  VARSET(YcompilerSp2cYto_c,T11);
  ...
  T18 = BOUNDP(YcompilerSp2cYto_c);
  if (T18 != YPfalse) {
    T17 = VARREF(YcompilerSp2cYto_c);
  } else {
    T17 = YPfalse;
  }
  T19 = fun_to_c_130;
  T16 = CALL2(1,VARREF(YPdefine_method),T17,T19);
  VARSET(YcompilerSp2cYto_c,T16);
  ...
  T23 = BOUNDP(YcompilerSp2cYto_c);
  if (T23 != YPfalse) {
    T22 = VARREF(YcompilerSp2cYto_c);
  } else {
    T22 = YPfalse;
  }
  T24 = fun_to_c_131;
  T21 = CALL2(1,VARREF(YPdefine_method),T22,T24);
  VARSET(YcompilerSp2cYto_c,T21);
  ...
  T28 = BOUNDP(YcompilerSp2cYto_c);
  if (T28 != YPfalse) {
    T27 = VARREF(YcompilerSp2cYto_c);
  } else {
    T27 = YPfalse;
  }
  T29 = fun_to_c_132;
  T26 = CALL2(1,VARREF(YPdefine_method),T27,T29);
  VARSET(YcompilerSp2cYto_c,T26);
  ...
  T33 = BOUNDP(YcompilerSp2cYto_c);
  if (T33 != YPfalse) {
    T32 = VARREF(YcompilerSp2cYto_c);
  } else {
    T32 = YPfalse;
  }
  T34 = fun_to_c_133;
  T31 = CALL2(1,VARREF(YPdefine_method),T32,T34);
  VARSET(YcompilerSp2cYto_c,T31);
  lit_241 = YPsb((P)"if (");
  lit_242 = YPsb((P)" != %s) {\n");
  lit_243 = YPsb((P)"} else {\n");
  lit_244 = YPsb((P)"}\n");
  ...
  T38 = BOUNDP(YcompilerSp2cYto_c);
  if (T38 != YPfalse) {
    T37 = VARREF(YcompilerSp2cYto_c);
  } else {
    T37 = YPfalse;
  }
  T39 = fun_to_c_134;
  T36 = CALL2(1,VARREF(YPdefine_method),T37,T39);
  VARSET(YcompilerSp2cYto_c,T36);
  ...
  T44 = BOUNDP(YcompilerSp2cYto_c);
  if (T44 != YPfalse) {
    T43 = VARREF(YcompilerSp2cYto_c);
  } else {
    T43 = YPfalse;
  }
  T45 = fun_to_c_136;
  T42 = CALL2(1,VARREF(YPdefine_method),T43,T45);
  VARSET(YcompilerSp2cYto_c,T42);
  ...
  T52 = BOUNDP(YcompilerSp2cYgenerate_self_recursive_call);
  if (T52 != YPfalse) {
    T51 = VARREF(YcompilerSp2cYgenerate_self_recursive_call);
  } else {
    T51 = YPfalse;
  }
  T53 = fun_generate_self_recursive_call_140;
  T50 = CALL2(1,VARREF(YPdefine_method),T51,T53);
  VARSET(YcompilerSp2cYgenerate_self_recursive_call,T50);
  VARSET(YcompilerSp2cYDnumber_call_templates,YPint((P)3));
  ...
  T59 = BOUNDP(YcompilerSp2cYto_c);
  if (T59 != YPfalse) {
    T58 = VARREF(YcompilerSp2cYto_c);
  } else {
    T58 = YPfalse;
  }
  T60 = fun_to_c_143;
  T57 = CALL2(1,VARREF(YPdefine_method),T58,T60);
  VARSET(YcompilerSp2cYto_c,T57);
  ...
  T65 = BOUNDP(YcompilerSp2cYto_c);
  if (T65 != YPfalse) {
    T64 = VARREF(YcompilerSp2cYto_c);
  } else {
    T64 = YPfalse;
  }
  T66 = fun_to_c_145;
  T63 = CALL2(1,VARREF(YPdefine_method),T64,T66);
  VARSET(YcompilerSp2cYto_c,T63);
  ...
  T71 = BOUNDP(YcompilerSp2cYto_c);
  if (T71 != YPfalse) {
    T70 = VARREF(YcompilerSp2cYto_c);
  } else {
    T70 = YPfalse;
  }
  T72 = fun_to_c_147;
  T69 = CALL2(1,VARREF(YPdefine_method),T70,T72);
  VARSET(YcompilerSp2cYto_c,T69);
  ...
  T77 = BOUNDP(YcompilerSp2cYto_c);
  if (T77 != YPfalse) {
    T76 = VARREF(YcompilerSp2cYto_c);
  } else {
    T76 = YPfalse;
  }
  T78 = fun_to_c_149;
  T75 = CALL2(1,VARREF(YPdefine_method),T76,T78);
  VARSET(YcompilerSp2cYto_c,T75);
  ...
  T82 = BOUNDP(YcompilerSp2cYto_c);
  if (T82 != YPfalse) {
    T81 = VARREF(YcompilerSp2cYto_c);
  } else {
    T81 = YPfalse;
  }
  T83 = fun_to_c_150;
  T80 = CALL2(1,VARREF(YPdefine_method),T81,T83);
  VARSET(YcompilerSp2cYto_c,T80);
  ...
  T87 = BOUNDP(YcompilerSp2cYto_c);
  if (T87 != YPfalse) {
    T86 = VARREF(YcompilerSp2cYto_c);
  } else {
    T86 = YPfalse;
  }
  T88 = fun_to_c_151;
  T85 = CALL2(1,VARREF(YPdefine_method),T86,T88);
  VARSET(YcompilerSp2cYto_c,T85);
  ...
  T92 = BOUNDP(YcompilerSp2cYto_c);
  if (T92 != YPfalse) {
    T91 = VARREF(YcompilerSp2cYto_c);
  } else {
    T91 = YPfalse;
  }
  T93 = fun_to_c_152;
  T90 = CALL2(1,VARREF(YPdefine_method),T91,T93);
  VARSET(YcompilerSp2cYto_c,T90);
  ...
  T99 = BOUNDP(YcompilerSp2cYto_c);
  if (T99 != YPfalse) {
    T98 = VARREF(YcompilerSp2cYto_c);
  } else {
    T98 = YPfalse;
  }
  T100 = fun_to_c_155;
  T97 = CALL2(1,VARREF(YPdefine_method),T98,T100);
  VARSET(YcompilerSp2cYto_c,T97);
  ...
  T106 = BOUNDP(YcompilerSp2cYto_c);
  if (T106 != YPfalse) {
    T105 = VARREF(YcompilerSp2cYto_c);
  } else {
    T105 = YPfalse;
  }
  T107 = fun_to_c_158;
  T104 = CALL2(1,VARREF(YPdefine_method),T105,T107);
  VARSET(YcompilerSp2cYto_c,T104);
  ...
  T111 = BOUNDP(YcompilerSp2cYfunshell_to_c);
  if (T111 != YPfalse) {
    T110 = VARREF(YcompilerSp2cYfunshell_to_c);
  } else {
    T110 = YPfalse;
  }
  T112 = fun_funshell_to_c_159;
  T109 = CALL2(1,VARREF(YPdefine_method),T110,T112);
  VARSET(YcompilerSp2cYfunshell_to_c,T109);
  ...
  T118 = BOUNDP(YcompilerSp2cYfuninit_to_c);
  if (T118 != YPfalse) {
    T117 = VARREF(YcompilerSp2cYfuninit_to_c);
  } else {
    T117 = YPfalse;
  }
  T119 = fun_funinit_to_c_162;
  T116 = CALL2(1,VARREF(YPdefine_method),T117,T119);
  VARSET(YcompilerSp2cYfuninit_to_c,T116);
  ...
  T123 = BOUNDP(YcompilerSp2cYto_c);
  if (T123 != YPfalse) {
    T122 = VARREF(YcompilerSp2cYto_c);
  } else {
    T122 = YPfalse;
  }
  T124 = fun_to_c_163;
  T121 = CALL2(1,VARREF(YPdefine_method),T122,T124);
  VARSET(YcompilerSp2cYto_c,T121);
  ...
  T129 = BOUNDP(YcompilerSp2cYout_list_builder);
  if (T129 != YPfalse) {
    T128 = VARREF(YcompilerSp2cYout_list_builder);
  } else {
    T128 = YPfalse;
  }
  T130 = fun_out_list_builder_165;
  T127 = CALL2(1,VARREF(YPdefine_method),T128,T130);
  VARSET(YcompilerSp2cYout_list_builder,T127);
  ...
  T135 = BOUNDP(YcompilerSp2cYgen_fab_list);
  if (T135 != YPfalse) {
    T134 = VARREF(YcompilerSp2cYgen_fab_list);
  } else {
    T134 = YPfalse;
  }
  T136 = fun_gen_fab_list_167;
  T133 = CALL2(1,VARREF(YPdefine_method),T134,T136);
  VARSET(YcompilerSp2cYgen_fab_list,T133);
  ...
  T140 = BOUNDP(YcompilerSp2cYgenerate_function_specs);
  if (T140 != YPfalse) {
    T139 = VARREF(YcompilerSp2cYgenerate_function_specs);
  } else {
    T139 = YPfalse;
  }
  T141 = fun_generate_function_specs_168;
  T138 = CALL2(1,VARREF(YPdefine_method),T139,T141);
  VARSET(YcompilerSp2cYgenerate_function_specs,T138);
  lit_317 = YPsb((P)"%sig");
  lit_318 = YPsb((P)"nil");
  ...
  T146 = BOUNDP(YcompilerSp2cYto_c);
  if (T146 != YPfalse) {
    T145 = VARREF(YcompilerSp2cYto_c);
  } else {
    T145 = YPfalse;
  }
  T147 = fun_to_c_170;
  T144 = CALL2(1,VARREF(YPdefine_method),T145,T147);
  VARSET(YcompilerSp2cYto_c,T144);
  lit_319 = YPsb((P)"%gen");
  ...
  T151 = BOUNDP(YcompilerSp2cYto_c);
  if (T151 != YPfalse) {
    T150 = VARREF(YcompilerSp2cYto_c);
  } else {
    T150 = YPfalse;
  }
  T152 = fun_to_c_171;
  T149 = CALL2(1,VARREF(YPdefine_method),T150,T152);
  VARSET(YcompilerSp2cYto_c,T149);
  ...
  T157 = BOUNDP(YcompilerSp2cYgenerate_function_forwards);
  if (T157 != YPfalse) {
    T156 = VARREF(YcompilerSp2cYgenerate_function_forwards);
  } else {
    T156 = YPfalse;
  }
  T158 = fun_generate_function_forwards_173;
  T155 = CALL2(1,VARREF(YPdefine_method),T156,T158);
  VARSET(YcompilerSp2cYgenerate_function_forwards,T155);
  ...
  T163 = BOUNDP(YcompilerSp2cYgenerate_function_forward);
  if (T163 != YPfalse) {
    T162 = VARREF(YcompilerSp2cYgenerate_function_forward);
  } else {
    T162 = YPfalse;
  }
  T164 = fun_generate_function_forward_175;
  T161 = CALL2(1,VARREF(YPdefine_method),T162,T164);
  VARSET(YcompilerSp2cYgenerate_function_forward,T161);
  ...
  T168 = BOUNDP(YcompilerSp2cYgenerate_function_binding);
  if (T168 != YPfalse) {
    T167 = VARREF(YcompilerSp2cYgenerate_function_binding);
  } else {
    T167 = YPfalse;
  }
  T169 = fun_generate_function_binding_176;
  T166 = CALL2(1,VARREF(YPdefine_method),T167,T169);
  VARSET(YcompilerSp2cYgenerate_function_binding,T166);
  ...
  T173 = BOUNDP(YcompilerSp2cYgenerate_function_forward);
  if (T173 != YPfalse) {
    T172 = VARREF(YcompilerSp2cYgenerate_function_forward);
  } else {
    T172 = YPfalse;
  }
  T174 = fun_generate_function_forward_177;
  T171 = CALL2(1,VARREF(YPdefine_method),T172,T174);
  VARSET(YcompilerSp2cYgenerate_function_forward,T171);
  ...
  T179 = BOUNDP(YcompilerSp2cYgenerate_function_bodies);
  if (T179 != YPfalse) {
    T178 = VARREF(YcompilerSp2cYgenerate_function_bodies);
  } else {
    T178 = YPfalse;
  }
  T180 = fun_generate_function_bodies_179;
  T177 = CALL2(1,VARREF(YPdefine_method),T178,T180);
  VARSET(YcompilerSp2cYgenerate_function_bodies,T177);
  ...
  T185 = BOUNDP(YcompilerSp2cYgenerate_functions);
  if (T185 != YPfalse) {
    T184 = VARREF(YcompilerSp2cYgenerate_functions);
  } else {
    T184 = YPfalse;
  }
  T186 = fun_generate_functions_181;
  T183 = CALL2(1,VARREF(YPdefine_method),T184,T186);
  VARSET(YcompilerSp2cYgenerate_functions,T183);
  ...
  T190 = BOUNDP(YcompilerSp2cYgenerate_closure_structure);
  if (T190 != YPfalse) {
    T189 = VARREF(YcompilerSp2cYgenerate_closure_structure);
  } else {
    T189 = YPfalse;
  }
  T191 = fun_generate_closure_structure_182;
  T188 = CALL2(1,VARREF(YPdefine_method),T189,T191);
  VARSET(YcompilerSp2cYgenerate_closure_structure,T188);
  ...
  T195 = BOUNDP(YcompilerSp2cYgenerate_function_body_reference);
  if (T195 != YPfalse) {
    T194 = VARREF(YcompilerSp2cYgenerate_function_body_reference);
  } else {
    T194 = YPfalse;
  }
  T196 = fun_generate_function_body_reference_183;
  T193 = CALL2(1,VARREF(YPdefine_method),T194,T196);
  VARSET(YcompilerSp2cYgenerate_function_body_reference,T193);
  ...
  T201 = BOUNDP(YcompilerSp2cYgenerate_shadow_args);
  if (T201 != YPfalse) {
    T200 = VARREF(YcompilerSp2cYgenerate_shadow_args);
  } else {
    T200 = YPfalse;
  }
  T202 = fun_generate_shadow_args_185;
  T199 = CALL2(1,VARREF(YPdefine_method),T200,T202);
  VARSET(YcompilerSp2cYgenerate_shadow_args,T199);
  ...
  T206 = BOUNDP(YcompilerSp2cYgenerate_return);
  if (T206 != YPfalse) {
    T205 = VARREF(YcompilerSp2cYgenerate_return);
  } else {
    T205 = YPfalse;
  }
  T207 = fun_generate_return_186;
  T204 = CALL2(1,VARREF(YPdefine_method),T205,T207);
  VARSET(YcompilerSp2cYgenerate_return,T204);
  lit_370 = YPsb((P)"RET");
  ...
  T211 = BOUNDP(YcompilerSp2cYgenerate_return);
  if (T211 != YPfalse) {
    T210 = VARREF(YcompilerSp2cYgenerate_return);
  } else {
    T210 = YPfalse;
  }
  T212 = fun_generate_return_187;
  T209 = CALL2(1,VARREF(YPdefine_method),T210,T212);
  VARSET(YcompilerSp2cYgenerate_return,T209);
  ...
  T216 = BOUNDP(YcompilerSp2cYprimitive_inlinableQ);
  if (T216 != YPfalse) {
    T215 = VARREF(YcompilerSp2cYprimitive_inlinableQ);
  } else {
    T215 = YPfalse;
  }
  T217 = fun_primitive_inlinableQ_188;
  T214 = CALL2(1,VARREF(YPdefine_method),T215,T217);
  VARSET(YcompilerSp2cYprimitive_inlinableQ,T214);
  ...
  T222 = BOUNDP(YcompilerSp2cYgenerate_function_code);
  if (T222 != YPfalse) {
    T221 = VARREF(YcompilerSp2cYgenerate_function_code);
  } else {
    T221 = YPfalse;
  }
  T223 = fun_generate_function_code_190;
  T220 = CALL2(1,VARREF(YPdefine_method),T221,T223);
  VARSET(YcompilerSp2cYgenerate_function_code,T220);
  ...
  T227 = BOUNDP(YcompilerSp2cYdispatcherQ);
  if (T227 != YPfalse) {
    T226 = VARREF(YcompilerSp2cYdispatcherQ);
  } else {
    T226 = YPfalse;
  }
  T228 = fun_dispatcherQ_191;
  T225 = CALL2(1,VARREF(YPdefine_method),T226,T228);
  VARSET(YcompilerSp2cYdispatcherQ,T225);
  lit_389 = YPsb((P)"\nFUNCODEDEF(");
  lit_390 = YPsb((P)") {\n");
  lit_391 = YPsb((P)"P ");
  ...
  T234 = BOUNDP(YcompilerSp2cYgenerate_function_code);
  if (T234 != YPfalse) {
    T233 = VARREF(YcompilerSp2cYgenerate_function_code);
  } else {
    T233 = YPfalse;
  }
  T235 = fun_generate_function_code_194;
  T232 = CALL2(1,VARREF(YPdefine_method),T233,T235);
  VARSET(YcompilerSp2cYgenerate_function_code,T232);
  ...
  T240 = BOUNDP(YcompilerSp2cYgenerate_local_temporaries);
  if (T240 != YPfalse) {
    T239 = VARREF(YcompilerSp2cYgenerate_local_temporaries);
  } else {
    T239 = YPfalse;
  }
  T241 = fun_generate_local_temporaries_196;
  T238 = CALL2(1,VARREF(YPdefine_method),T239,T241);
  VARSET(YcompilerSp2cYgenerate_local_temporaries,T238);
  VARSET(YcompilerSp2cYTtrace_registersQT,YPfalse);
  VARSET(YcompilerSp2cYTregisters_per_lineT,YPint((P)16));
  ...
  T247 = BOUNDP(YcompilerSp2cYgenerate_registers);
  if (T247 != YPfalse) {
    T246 = VARREF(YcompilerSp2cYgenerate_registers);
  } else {
    T246 = YPfalse;
  }
  T248 = fun_generate_registers_199;
  T245 = CALL2(1,VARREF(YPdefine_method),T246,T248);
  VARSET(YcompilerSp2cYgenerate_registers,T245);
  ...
  T252 = BOUNDP(YcompilerSp2cYmodule_info_name);
  if (T252 != YPfalse) {
    T251 = VARREF(YcompilerSp2cYmodule_info_name);
  } else {
    T251 = YPfalse;
  }
  T253 = fun_module_info_name_200;
  T250 = CALL2(1,VARREF(YPdefine_method),T251,T253);
  VARSET(YcompilerSp2cYmodule_info_name,T250);
  ...
  YcompilerSp2cYdeclare_imported_module_infos = YPmet(FUNCODEREF(YcompilerSp2cYdeclare_imported_module_infos),LITREF(lit_415),T254,ENVNUL,PNUL,YPfalse);
  T257 = YcompilerSp2cYdeclare_imported_module_infos;
  VARSET(YcompilerSp2cYdeclare_imported_module_infos,T257);
  ...
  YcompilerSp2cYgenerate_module_info = YPmet(FUNCODEREF(YcompilerSp2cYgenerate_module_info),LITREF(lit_418),T258,ENVNUL,PNUL,YPfalse);
  T263 = YcompilerSp2cYgenerate_module_info;
  VARSET(YcompilerSp2cYgenerate_module_info,T263);
  ...
  T267 = BOUNDP(YcompilerSp2cYmodule_init_name);
  if (T267 != YPfalse) {
    T266 = VARREF(YcompilerSp2cYmodule_init_name);
  } else {
    T266 = YPfalse;
  }
  T268 = fun_module_init_name_209;
  T265 = CALL2(1,VARREF(YPdefine_method),T266,T268);
  VARSET(YcompilerSp2cYmodule_init_name,T265);
  ...
  T272 = BOUNDP(YcompilerSp2cYmodule_init_decl);
  if (T272 != YPfalse) {
    T271 = VARREF(YcompilerSp2cYmodule_init_decl);
  } else {
    T271 = YPfalse;
  }
  T273 = fun_module_init_decl_210;
  T270 = CALL2(1,VARREF(YPdefine_method),T271,T273);
  VARSET(YcompilerSp2cYmodule_init_decl,T270);
  ...
  T279 = BOUNDP(YcompilerSp2cYgenerate_module_init);
  if (T279 != YPfalse) {
    T278 = VARREF(YcompilerSp2cYgenerate_module_init);
  } else {
    T278 = YPfalse;
  }
  T280 = fun_generate_module_init_213;
  T277 = CALL2(1,VARREF(YPdefine_method),T278,T280);
  VARSET(YcompilerSp2cYgenerate_module_init,T277);
  ...
  T284 = BOUNDP(YcompilerSp2cYgenerate_main);
  if (T284 != YPfalse) {
    T283 = VARREF(YcompilerSp2cYgenerate_main);
  } else {
    T283 = YPfalse;
  }
  T285 = fun_generate_main_214;
  T282 = CALL2(1,VARREF(YPdefine_method),T283,T285);
  VARSET(YcompilerSp2cYgenerate_main,T282);
  T286 = YPfalse;
  return T286;
}
...
static BINDING_INFO binding_infos[] = {
  {"$escape-separator", &YcompilerSp2cYDescape_separator},
  {"float-to-c-string", &YcompilerSp2cYfloat_to_c_string},
  {"module-src-file-setter", &YcompilerSp2cYmodule_src_file_setter},
  {"*trace-registers?*", &YcompilerSp2cYTtrace_registersQT},
  {"compute-ast", &YcompilerSp2cYcompute_ast},
  {"mangle-local-name", &YcompilerSp2cYmangle_local_name},
  {"generate-function-binding", &YcompilerSp2cYgenerate_function_binding},
  {"mangle-integer", &YcompilerSp2cYmangle_integer},
  {"---main-1---", NULL},
  {"g2c-top", &YcompilerSp2cYg2c_top},
  {"$method-mangled-marker", &YcompilerSp2cYDmethod_mangled_marker},
  {"binding->c", &YcompilerSp2cYbinding_Gc},
  {"generate-trailer", &YcompilerSp2cYgenerate_trailer},
  {"*dynamic-linking?*", &YcompilerSp2cYTdynamic_linkingQT},
  {"$number-characters", &YcompilerSp2cYDnumber_characters},
  {"generate-function-specs", &YcompilerSp2cYgenerate_function_specs},
  {"generate-functions", &YcompilerSp2cYgenerate_functions},
  {"module-up-to-date?", &YcompilerSp2cYmodule_up_to_dateQ},
  {"so-load", &YcompilerSp2cYso_load},
  {"for-commas", NULL},
  {"%load", NULL},
  {"$hygiene-char", &YcompilerSp2cYDhygiene_char},
  {"$module-marker", &YcompilerSp2cYDmodule_marker},
  {"mangle-boot-name", &YcompilerSp2cYmangle_boot_name},
  {"$min-character-code", &YcompilerSp2cYDmin_character_code},
  {"mangle-raw-name", &YcompilerSp2cYmangle_raw_name},
  {"mangle-name-into", &YcompilerSp2cYmangle_name_into},
  {"<g2c-module>", &YcompilerSp2cYLg2c_moduleG},
  {"gen-fab-list", &YcompilerSp2cYgen_fab_list},
  {"module-loader-app-modname-setter", &YcompilerSp2cYmodule_loader_app_modname_setter},
  {"generate-function-body-reference", &YcompilerSp2cYgenerate_function_body_reference},
  {"generate-function-bodies", &YcompilerSp2cYgenerate_function_bodies},
  {"*definitions*", &YcompilerSp2cYTdefinitionsT},
  {"%compile", NULL},
  {"$number-call-templates", &YcompilerSp2cYDnumber_call_templates},
  {"$name-mangler-table", &YcompilerSp2cYDname_mangler_table},
  {"module-mtime-setter", &YcompilerSp2cYmodule_mtime_setter},
  {"compute-program", &YcompilerSp2cYcompute_program},
  {"module-init-decl", &YcompilerSp2cYmodule_init_decl},
  {"generate-module-init", &YcompilerSp2cYgenerate_module_init},
  {"generate-closure-structure", &YcompilerSp2cYgenerate_closure_structure},
  {"mangle-global-name", &YcompilerSp2cYmangle_global_name},
  {"$escape-marker", &YcompilerSp2cYDescape_marker},
  {"$max-character-code", &YcompilerSp2cYDmax_character_code},
  {"gen-ref", &YcompilerSp2cYgen_ref},
  {"generate-quotations", &YcompilerSp2cYgenerate_quotations},
  {"module-loader-app-modname", &YcompilerSp2cYmodule_loader_app_modname},
  {"to-c", &YcompilerSp2cYto_c},
  {"$local-marker", &YcompilerSp2cYDlocal_marker},
  {"g2c-clean", &YcompilerSp2cYg2c_clean},
  {"*mangle-buffer*", &YcompilerSp2cYTmangle_bufferT},
  {"$hygiene-marker", &YcompilerSp2cYDhygiene_marker},
  {"generate-global-environment", &YcompilerSp2cYgenerate_global_environment},
  {"mangle-string-literal", &YcompilerSp2cYmangle_string_literal},
  {"*g2c-app*", &YcompilerSp2cYTg2c_appT},
  {"$iep-suffix", &YcompilerSp2cYDiep_suffix},
  {"generate-shadow-args", &YcompilerSp2cYgenerate_shadow_args},
  {"declare-imported-module-infos", &YcompilerSp2cYdeclare_imported_module_infos},
  {"$mangles-data", &YcompilerSp2cYDmangles_data},
  {"generate-header", &YcompilerSp2cYgenerate_header},
  {"between-parentheses-comma-separated", NULL},
  {"compile-load", &YcompilerSp2cYcompile_load},
  {"generate-makefile", &YcompilerSp2cYgenerate_makefile},
  {"g2c-ast", &YcompilerSp2cYg2c_ast},
  {"g2c-exp", &YcompilerSp2cYg2c_exp},
  {"generate-quotation", &YcompilerSp2cYgenerate_quotation},
  {"g2c-build-app", &YcompilerSp2cYg2c_build_app},
  {"g2c-test", &YcompilerSp2cYg2c_test},
  {"$local-suffix", &YcompilerSp2cYDlocal_suffix},
  {"module-info-name", &YcompilerSp2cYmodule_info_name},
  {"g2c-def-app", &YcompilerSp2cYg2c_def_app},
  {"funinit-to-c", &YcompilerSp2cYfuninit_to_c},
  {"generate-quotation-forwards", &YcompilerSp2cYgenerate_quotation_forwards},
  {"module-loader-appname", &YcompilerSp2cYmodule_loader_appname},
  {"module-init-name", &YcompilerSp2cYmodule_init_name},
  {"between-parentheses", NULL},
  {"*tmp-file-counter*", &YcompilerSp2cYTtmp_file_counterT},
  {"generate-c-module", &YcompilerSp2cYgenerate_c_module},
  {"generate-global-binding", &YcompilerSp2cYgenerate_global_binding},
  {"with-expression", NULL},
  {"generate-local-temporaries", &YcompilerSp2cYgenerate_local_temporaries},
  {"generate-main", &YcompilerSp2cYgenerate_main},
  {"generate-function-forward", &YcompilerSp2cYgenerate_function_forward},
  {"generate-function-forwards", &YcompilerSp2cYgenerate_function_forwards},
  {"out-list-builder", &YcompilerSp2cYout_list_builder},
  {"---main-2---", NULL},
  {"$method-mangled-marker-string", &YcompilerSp2cYDmethod_mangled_marker_string},
  {"*registers-per-line*", &YcompilerSp2cYTregisters_per_lineT},
  {"generate-self-recursive-call", &YcompilerSp2cYgenerate_self_recursive_call},
  {"---main-0---", NULL},
  {"gen-result", &YcompilerSp2cYgen_result},
  {"module-loader-appname-setter", &YcompilerSp2cYmodule_loader_appname_setter},
  {"<g2c-module-loader>", &YcompilerSp2cYLg2c_module_loaderG},
  {"mangle-module-binding", &YcompilerSp2cYmangle_module_binding},
  {"primitive-inlinable?", &YcompilerSp2cYprimitive_inlinableQ},
  {"with-used-expression", NULL},
  {"dispatcher?", &YcompilerSp2cYdispatcherQ},
  {"mangler-reset", &YcompilerSp2cYmangler_reset},
  {"funshell-to-c", &YcompilerSp2cYfunshell_to_c},
  {"reference->c", &YcompilerSp2cYreference_Gc},
  {"generate-c-application", &YcompilerSp2cYgenerate_c_application},
  {"purge-outdated-modules", &YcompilerSp2cYpurge_outdated_modules},
  {"pp", &YcompilerSp2cYpp},
  {"generate-module-info", &YcompilerSp2cYgenerate_module_info},
  {"false-name", &YcompilerSp2cYfalse_name},
  {"with-statement", NULL},
  {"generate-function-code", &YcompilerSp2cYgenerate_function_code},
  {"generate-return", &YcompilerSp2cYgenerate_return},
  {"generate-registers", &YcompilerSp2cYgenerate_registers},
  {"char-buffer-as-string", &YcompilerSp2cYchar_buffer_as_string},
  {"gen-depth", &YcompilerSp2cYgen_depth},
  {"module-src-file", &YcompilerSp2cYmodule_src_file},
  {"mangle-local-marked-name", &YcompilerSp2cYmangle_local_marked_name},
  {"module-mtime", &YcompilerSp2cYmodule_mtime},
  {"$c-escapes", &YcompilerSp2cYDc_escapes},
  {"$module-separator", &YcompilerSp2cYDmodule_separator},
  {"$iep-marker", &YcompilerSp2cYDiep_marker},
  {NULL, NULL}
};
...
extern MODULE_INFO module_info_compilerSp2c;
MODULE_INFO module_info_compilerSp2c = {
  "compiler/p2c",
  NULL,
  use_infos,
  import_infos,
...
extern void load_module_compilerSp2c (void);

void load_module_compilerSp2c (void) {
