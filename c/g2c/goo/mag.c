...
DEFCREGS();
  ...
  fun_G_0 = YPfab_met(FUNCODEREF(fun_G_0),T12,LITREF(lit_2),LITREF(lit_12),sloc(18),YPsb((P)"(fun ((x <mag>) (y <mag>) => <log>) (< y x))"));
  ...
  fun_LE_1 = YPfab_met(FUNCODEREF(fun_LE_1),T16,LITREF(lit_4),LITREF(lit_13),sloc(21),YPsb((P)"(fun ((x <mag>) (y <mag>) => <log>) (not (< y x)))"));
  ...
  fun_GE_2 = YPfab_met(FUNCODEREF(fun_GE_2),T20,LITREF(lit_6),LITREF(lit_14),sloc(24),YPsb((P)"(fun ((x <mag>) (y <mag>) => <log>) (not (< x y)))"));
  ...
  fun_min_3 = YPfab_met(FUNCODEREF(fun_min_3),T24,LITREF(lit_8),LITREF(lit_15),sloc(27),YPsb((P)"(fun ((x <mag>) (y <mag>) => <mag>) (if (< x y) x y))"));
  ...
  T29 = fun_max_4 = YPfab_met(FUNCODEREF(fun_max_4),T30,LITREF(lit_10),LITREF(lit_16),sloc(30),YPsb((P)"(fun ((x <mag>) (y <mag>) => <mag>) (if (> x y) x y))"));
