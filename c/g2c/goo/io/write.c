...
loop:
  ...
  recurF1406 = T1;
  FUNINIT(recurF1406, 2,port_,recurF1406);
  T2 = CALL2(0,recurF1406,x_,YPint((P)-1));
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  portF1408 = YPfalse;
  portF1408 = BOXFAB(portF1408);
  T3 = FUNFAB(fun_6,2,portF1408,x_);
  T4 = FUNFAB(fun_7,1,portF1408);
...
loop:
  ...
  recurF1409 = T1;
  FUNINIT(recurF1409, 2,port_,recurF1409);
  T2 = CALL2(0,recurF1409,x_,YPint((P)-1));
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  if (probeF1410 != YPfalse) {
    T3 = CALL2(1,VARREF(YgooSioSwriteYwrite),port_,probeF1410);
    T2 = T3;
  } else {
...
loop:
  ...
  tmpF1412 = assocF1411;
  if (tmpF1412 != YPfalse) {
    T4 = CALL1(1,VARREF(YgooScolsSseqY1st),assocF1411);
    T3 = T4;
  } else {
    T3 = YPfalse;
  }
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    cF1413 = T4;
    T6 = CALL2(1,VARREF(YgooSmathYE),cF1413,YPchr((P)92));
    tmpF1414 = T6;
    if (tmpF1414 != YPfalse) {
      T7 = tmpF1414;
    } else {
      T8 = CALL2(1,VARREF(YgooSmathYE),cF1413,YPchr((P)34));
      T7 = T8;
    }
    T5 = T7;
    if (T5 != YPfalse) {
    ...
    CALL2(1,VARREF(YgooSioSportYput),FREEREF(1),cF1413);
...
loop:
  ...
  loopF1416 = T3;
  FUNINIT(loopF1416, 4,lenF1415,port_,x_,loopF1416);
  T4 = CALL1(0,loopF1416,YPint((P)0));
  T2 = T4;
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    loopF1417 = T6;
    FUNINIT(loopF1417, 4,port_,recur_,d_,loopF1417);
    T8 = CALL1(1,VARREF(Ytail),x_);
    T7 = CALL2(0,loopF1417,T8,YPint((P)1));
...
loop:
  ...
  zF1421 = T6;
  T7 = CALL2(1,VARREF(YgooSmagYG),zF1421,YPint((P)0));
  if (T7 != YPfalse) {
    T8 = CALL2(1,VARREF(YgooSmacrosYelt),x_,YPint((P)0));
    CALL2(1,recur_,T8,d_);
    T10 = FUNSHELL(1,fun_loop_30,6);
    loopF1422 = T10;
    FUNINIT(loopF1422, 6,port_,zF1421,recur_,x_,d_,loopF1422);
    T11 = CALL1(0,loopF1422,YPint((P)1));
    T9 = T11;
  } else {
  }
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    tup34F1425 = T9;
    T13 = CALL2(1,VARREF(YgooSmacrosYelt),tup34F1425,YPint((P)0));
    keyF1426 = T13;
    T15 = CALL2(1,VARREF(YgooSmacrosYelt),tup34F1425,YPint((P)1));
    valF1427 = T15;
    T16 = CALL2(1,VARREF(YgooSmagYGE),iF1424,VARREF(YgooSioSwriteYTmax_print_lengthT));
    if (T16 != YPfalse) {
    ...
    CALL2(1,VARREF(YgooSioSportYput),FREEREF(0),YPchr((P)32));
    CALL2(1,FREEREF(2),keyF1426,FREEREF(3));
    CALL2(1,VARREF(YgooSioSportYputs),FREEREF(0),LITREF(lit_48));
    CALL2(1,FREEREF(2),valF1427,FREEREF(3));
...
loop:
  ...
  x_1392F1428 = T1;
  FUNINIT(x_1392F1428, 5,FREEREF(0),blow_,FREEREF(1),FREEREF(2),x_1392F1428);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    iF1433 = T14;
    T15 = CALL1(1,VARREF(Ynot),firstQF1431);
    if (T15 != YPfalse) {
    ...
    if (T17 != YPfalse) {
      T18 = CALL2(1,VARREF(YgooSioSwriteYwrite_type),FREEREF(0),specF1432);
    } else {
      T20 = CALL2(1,VARREF(YgooSmacrosYelt),FREEREF(1),iF1433);
      T19 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLstrG),T20);
      CALL3(1,VARREF(YgooSruntimeYformat),FREEREF(0),LITREF(lit_56),T19);
      CALL2(1,VARREF(YgooSioSwriteYwrite_type),FREEREF(0),specF1432);
...
loop:
  ...
  x_1396F1436 = T4;
  FUNINIT(x_1396F1436, 3,port_,namesF1435,x_1396F1436);
  ...
  T5 = CALL3(0,x_1396F1436,T6,T8,T10);
  T13 = CALL1(1,VARREF(Yfun_val),x_);
  valueF1437 = T13;
  T16 = CALL1(1,VARREF(Ynot),valueF1437);
  tmpF1438 = T16;
  if (tmpF1438 != YPfalse) {
    T17 = tmpF1438;
  } else {
    T18 = CALL2(1,VARREF(YgooSmacrosYEE),valueF1437,VARREF(YLanyG));
    T17 = T18;
  }
  T15 = T17;
  ...
  if (T14 != YPfalse) {
    ...
    T19 = CALL2(1,VARREF(YgooSioSwriteYwrite_type),port_,valueF1437);
  } else {
  }
...
loop:
  ...
  if (tmpF1440 != YPfalse) {
    ...
    T4 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLstrG),nameF1439);
...
loop:
  ...
  recurF1441 = T1;
  FUNINIT(recurF1441, 2,port_,recurF1441);
  T2 = CALL2(0,recurF1441,x_,YPint((P)0));
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    propF1444 = T9;
    T10 = CALL2(1,VARREF(YgooSmagYGE),iF1443,VARREF(YgooSioSwriteYTmax_print_lengthT));
    if (T10 != YPfalse) {
      CALL2(1,VARREF(YgooSioSportYputs),FREEREF(0),LITREF(lit_80));
      T11 = CALL1(1,FREEREF(1),YPfalse);
    } else {
    }
    T13 = CALL1(1,VARREF(Yprop_getter),propF1444);
    getterF1445 = T13;
    CALL2(1,VARREF(YgooSioSportYput),FREEREF(0),YPchr((P)32));
    T14 = CALL1(1,VARREF(Yfun_name),getterF1445);
    CALL2(1,VARREF(YgooSioSwriteYdisplay),FREEREF(0),T14);
    CALL2(1,VARREF(YgooSioSportYputs),FREEREF(0),LITREF(lit_81));
    T15 = CALL1(1,getterF1445,FREEREF(3));
...
loop:
  ...
  x_1400F1446 = T1;
  FUNINIT(x_1400F1446, 6,FREEREF(0),FREEREF(1),FREEREF(2),FREEREF(3),FREEREF(4),x_1400F1446);
  T4 = CALL1(1,VARREF(YgooScolsSrangeYfrom),YPint((P)0));
  T3 = CALL1(1,VARREF(YgooScolsScolYenum),T4);
  T6 = CALL1(1,VARREF(Yobject_props),FREEREF(3));
  T5 = CALL1(1,VARREF(YgooScolsScolYenum),T6);
  T2 = CALL2(0,x_1400F1446,T3,T5);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
LINK_STACK();
  ARG(blow_, 0);
loop:
  x_1397F1447 = VARREF(YTreport_prop_unbound_errorsQT);
  T2 = FUNFAB(fun_53,5,FREEREF(0),blow_,FREEREF(1),FREEREF(2),FREEREF(3));
  T3 = FUNFAB(fun_54,1,x_1397F1447);
...
loop:
  T1 = BOXVAL(FREEREF(0));
  current_indexF1448 = T1;
  T3 = BOXVAL(FREEREF(0));
  T2 = CALL2(1,VARREF(YgooSmathYA),T3,YPint((P)1));
  BOXVAL(FREEREF(0)) = T2;
  T5 = CALL2(1,VARREF(YgooSmagYL),current_indexF1448,FREEREF(1));
  T4 = CALL1(1,VARREF(Ynot),T5);
  if (T4 != YPfalse) {
    T6 = CALL3(1,VARREF(Yerror),LITREF(lit_90),FREEREF(2),FREEREF(3));
  } else {
  }
  T8 = CALL2(1,VARREF(YgooSmacrosYelt),FREEREF(3),current_indexF1448);
  argumentF1449 = T8;
  ...
  if (tmpF1450 != YPfalse) {
    ...
    T13 = CALL2(1,VARREF(YisaQ),argumentF1449,class_);
    T12 = T13;
  }
  T10 = T12;
  T9 = CALL1(1,VARREF(Ynot),T10);
  if (T9 != YPfalse) {
    T14 = CALLN(1,VARREF(Yerror),4,LITREF(lit_91),char_,class_,argumentF1449);
  } else {
  }
  T7 = argumentF1449;
  T0 = T7;
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    x_1401F1451 = T2;
    x_1402F1452 = VARREF(YgooSmacrosYEE);
    T5 = CALL2(1,x_1402F1452,x_1401F1451,YPchr((P)68));
    if (T5 != YPfalse) {
      ...
      T10 = CALL2(1,x_1402F1452,x_1401F1451,YPchr((P)66));
      if (T10 != YPfalse) {
        ...
        T15 = CALL2(1,x_1402F1452,x_1401F1451,YPchr((P)79));
        if (T15 != YPfalse) {
          ...
          T20 = CALL2(1,x_1402F1452,x_1401F1451,YPchr((P)88));
          if (T20 != YPfalse) {
...
FUNCODEDEF(fun_format_61) {
  ...
  P argF1456;
  P num_argumentsF1455;
  P argument_indexF1454;
  P found_percentQF1453;
  P T13,T12,T11,T10,T9,T8,T7,T6,T5,T4,T3,T2,T1,T0;
  P a1,a2,a3;
LINK_STACK();
  ARG(port_, 0);
  ...
  NARGS(arguments_, 2);
loop:
  found_percentQF1453 = YPfalse;
  found_percentQF1453 = BOXFAB(found_percentQF1453);
  check_type(YPint((P)0),VARREF(YLintG));
  argument_indexF1454 = YPint((P)0);
  argument_indexF1454 = BOXFAB(argument_indexF1454);
  T5 = CALL1(1,VARREF(YgooStypesYlen),arguments_);
  num_argumentsF1455 = T5;
  T6 = FUNSHELL(1,fun_arg_59,4);
  argF1456 = T6;
  FUNINIT(argF1456, 4,argument_indexF1454,num_argumentsF1455,message_,arguments_);
  T8 = FUNFAB(fun_60,4,found_percentQF1453,port_,argF1456,message_);
  T7 = CALL2(1,VARREF(YgooSmacrosYdo),T8,message_);
  T12 = BOXVAL(found_percentQF1453);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    T5 = CALL2(1,VARREF(YgooSpackerYpacker_add),UF1457,T6);
...
loop:
  CALL0(0,FREEREF(0));
  T1 = BOXVAL(FREEREF(1));
  current_indexF1458 = T1;
  T3 = BOXVAL(FREEREF(1));
  T2 = CALL2(1,VARREF(YgooSmathYA),T3,YPint((P)1));
  BOXVAL(FREEREF(1)) = T2;
  T5 = CALL2(1,VARREF(YgooSmagYL),current_indexF1458,FREEREF(2));
  T4 = CALL1(1,VARREF(Ynot),T5);
  if (T4 != YPfalse) {
    T6 = CALL3(1,VARREF(Yerror),LITREF(lit_100),FREEREF(3),FREEREF(4));
  } else {
  }
  T7 = CALL2(1,VARREF(YgooSmacrosYelt),FREEREF(4),current_indexF1458);
  T0 = T7;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  if (T1 != YPfalse) {
    T2 = CALL1(1,VARREF(YgooSmathYto_upper),c_);
    x_1405F1459 = T2;
    x_1406F1460 = VARREF(YgooSmacrosYEE);
    T5 = CALL2(1,x_1406F1460,x_1405F1459,YPchr((P)68));
    if (T5 != YPfalse) {
      T7 = BOXVAL(FREEREF(1));
      UF1461 = T7;
      ...
      T9 = CALL2(1,VARREF(YgooSpackerYpacker_add),UF1461,T10);
      T8 = BOXVAL(FREEREF(1)) = T9;
      T6 = T8;
      T4 = T6;
    } else {
      T19 = CALL2(1,x_1406F1460,x_1405F1459,YPchr((P)66));
      if (T19 != YPfalse) {
        ...
        T23 = CALL2(1,VARREF(YgooSpackerYpacker_add),UF1462,T24);
        T22 = BOXVAL(FREEREF(1)) = T23;
        T20 = T22;
        T18 = T20;
      } else {
        T34 = CALL2(1,x_1406F1460,x_1405F1459,YPchr((P)79));
        if (T34 != YPfalse) {
          ...
          T38 = CALL2(1,VARREF(YgooSpackerYpacker_add),UF1463,T39);
          T37 = BOXVAL(FREEREF(1)) = T38;
          T35 = T37;
          T33 = T35;
        } else {
          T49 = CALL2(1,x_1406F1460,x_1405F1459,YPchr((P)88));
          if (T49 != YPfalse) {
            ...
            T53 = CALL2(1,VARREF(YgooSpackerYpacker_add),UF1464,T54);
            T52 = BOXVAL(FREEREF(1)) = T53;
            T50 = T52;
            T48 = T50;
          } else {
            T64 = CALL2(1,x_1406F1460,x_1405F1459,YPchr((P)67));
            if (T64 != YPfalse) {
              ...
              T68 = CALL2(1,VARREF(YgooSpackerYpacker_add),UF1465,T69);
              T67 = BOXVAL(FREEREF(1)) = T68;
              T65 = T67;
              T63 = T65;
            } else {
              T75 = CALL2(1,x_1406F1460,x_1405F1459,YPchr((P)83));
              if (T75 != YPfalse) {
                ...
                T79 = CALL2(1,VARREF(YgooSpackerYpacker_add),UF1466,T80);
                T78 = BOXVAL(FREEREF(1)) = T79;
                T76 = T78;
                T74 = T76;
              } else {
                T86 = CALL2(1,x_1406F1460,x_1405F1459,YPchr((P)61));
                if (T86 != YPfalse) {
                  ...
                  T90 = CALL2(1,VARREF(YgooSpackerYpacker_add),UF1467,T91);
                  T89 = BOXVAL(FREEREF(1)) = T90;
                  T87 = T89;
                  T85 = T87;
                } else {
                  T97 = CALL2(1,x_1406F1460,x_1405F1459,YPchr((P)37));
                  if (T97 != YPfalse) {
...
FUNCODEDEF(fun_pe_format_66) {
  ...
  P exprsF1476;
  P argF1475;
  P maybe_pack_charsF1474;
  P packer_F1473;
  P portF1472;
  P charsF1471;
  P num_argsF1470;
  P arg_indexF1469;
  P found_percentQF1468;
...
LINK_STACK();
  ...
  ARG(args_, 2);
loop:
  found_percentQF1468 = YPfalse;
  found_percentQF1468 = BOXFAB(found_percentQF1468);
  check_type(YPint((P)0),VARREF(YLintG));
  arg_indexF1469 = YPint((P)0);
  arg_indexF1469 = BOXFAB(arg_indexF1469);
  T5 = CALL1(1,VARREF(YgooStypesYlen),args_);
  num_argsF1470 = T5;
  T7 = CALL2(1,VARREF(YgooScolsScolYfab),VARREF(YgooScolsSbufYLbufG),YPint((P)0));
  charsF1471 = T7;
  T9 = CALL0(1,VARREF(YgooSmacrosYgensym));
  portF1472 = T9;
  T12 = CALL1(1,VARREF(YgooSpackerYpacker_fab),VARREF(YLlstG));
  packer_F1473 = T12;
  packer_F1473 = BOXFAB(packer_F1473);
  T14 = FUNSHELL(1,fun_maybe_pack_chars_63,3);
  maybe_pack_charsF1474 = T14;
  T15 = FUNSHELL(1,fun_arg_64,5);
  argF1475 = T15;
  FUNINIT(maybe_pack_charsF1474, 3,charsF1471,packer_F1473,portF1472);
  FUNINIT(argF1475, 5,maybe_pack_charsF1474,arg_indexF1469,num_argsF1470,message_,args_);
  T16 = FUNFAB(fun_65,6,found_percentQF1468,packer_F1473,portF1472,argF1475,charsF1471,message_);
  CALL2(1,VARREF(YgooSmacrosYdo),T16,message_);
  T17 = CALL0(0,maybe_pack_charsF1474);
  T19 = BOXVAL(packer_F1473);
  T18 = CALL1(1,VARREF(YgooSpackerYpacker_res),T19);
  T11 = T18;
  exprsF1476 = T11;
  T22 = BOXVAL(found_percentQF1468);
  ...
  T30 = CALL1(1,VARREF(Ylst),portF1472);
  ...
  T24 = CALLN(1,VARREF(YgooSmacrosYcat),4,T25,T26,exprsF1476,Ynil);
  T10 = T24;
  T8 = T10;
  T6 = T8;
  T4 = T6;
...
loop:
  ...
  x_1410F1477 = T1;
  FUNINIT(x_1410F1477, 1,return_);
  x_1409F1478 = FREEREF(0);
  portF1479 = YPfalse;
  portF1479 = BOXFAB(portF1479);
  messageF1480 = YPfalse;
  messageF1480 = BOXFAB(messageF1480);
  argsF1481 = YPfalse;
  argsF1481 = BOXFAB(argsF1481);
  T9 = CALL2(1,VARREF(YisaQ),x_1409F1478,VARREF(YLlstG));
  if (T9 != YPfalse) {
    T11 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1409F1478,LITREF(lit_109),x_1410F1477);
    x_1409F1482 = T11;
    T13 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1409F1482,x_1410F1477);
    BOXVAL(portF1479) = T13;
    T14 = CALL1(1,VARREF(Ytail),x_1409F1482);
    x_1409F1483 = T14;
    T16 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1409F1483,x_1410F1477);
    BOXVAL(messageF1480) = T16;
    T17 = CALL1(1,VARREF(Ytail),x_1409F1483);
    x_1409F1484 = T17;
    BOXVAL(argsF1481) = x_1409F1484;
    x_1409F1485 = Ynil;
    T19 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1409F1485,x_1410F1477);
    T18 = T19;
    T15 = T18;
    T12 = T15;
    T10 = T12;
  } else {
    T20 = CALL2(1,x_1410F1477,LITREF(lit_110),x_1409F1478);
  }
  T22 = BOXVAL(portF1479);
  T23 = BOXVAL(messageF1480);
  T24 = BOXVAL(argsF1481);
  T21 = CALL3(1,VARREF(YgooSioSwriteYpe_format),T22,T23,T24);
  T7 = T21;
  T5 = T7;
  T3 = T5;
  T2 = T3;
...
loop:
  portF1487 = YPfalse;
  portF1487 = BOXFAB(portF1487);
  T3 = FUNFAB(fun_70,3,portF1487,message_,arguments_);
  T4 = FUNFAB(fun_71,1,portF1487);
  T2 = with_cleanup(T3,T4);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  loopF1489 = T3;
  FUNINIT(loopF1489, 4,limF1488,port_,args_,loopF1489);
  T4 = CALL1(0,loopF1489,YPint((P)0));
  T2 = T4;
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
