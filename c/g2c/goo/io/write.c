...
LOCFOR(fun_recurring_write_type_49);
LOCFOR(fun_recurring_write_type_50);
LOCFOR(fun_recur_51);
LOCFOR(fun_write_type_52);
LOCFOR(fun_recurring_write_53);
LOCFOR(fun_x_1388_54);
LOCFOR(fun_55);
LOCFOR(fun_56);
LOCFOR(fun_57);
LOCFOR(fun_recurring_write_58);
LOCFOR(fun_recurring_write_59);
LOCFOR(fun_recurring_write_60);
LOCFOR(fun_arg_61);
LOCFOR(fun_62);
LOCFOR(fun_msg_63);
LOCFOR(fun_pe_msg_64);
LOCFOR(fun_maybe_pack_chars_65);
LOCFOR(fun_arg_66);
LOCFOR(fun_67);
LOCFOR(fun_pe_msg_68);
LOCFOR(fun_x_1398_69);
LOCFOR(fun_70);
LOCFOR(fun_71);
LOCFOR(fun_72);
LOCFOR(fun_73);
...
loop:
  ...
  recurF1381 = T1;
  FUNINIT(recurF1381, 2,port_,recurF1381);
  T2 = CALL2(0,recurF1381,x_,YPint((P)-1));
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  portF1383 = YPfalse;
  portF1383 = BOXFAB(portF1383);
  T3 = FUNFAB(fun_6,2,portF1383,x_);
  T4 = FUNFAB(fun_7,1,portF1383);
...
loop:
  ...
  recurF1384 = T1;
  FUNINIT(recurF1384, 2,port_,recurF1384);
  T2 = CALL2(0,recurF1384,x_,YPint((P)-1));
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  if (probeF1385 != YPfalse) {
    T3 = CALL2(1,VARREF(YgooSioSwriteYwrite),port_,probeF1385);
    T2 = T3;
  } else {
...
loop:
  ...
  tmpF1387 = assocF1386;
  if (tmpF1387 != YPfalse) {
    T4 = CALL1(1,VARREF(YgooScolsSseqY1st),assocF1386);
    T3 = T4;
  } else {
    T3 = YPfalse;
  }
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    cF1388 = T4;
    T6 = CALL2(1,VARREF(YgooSmathYE),cF1388,YPchr((P)92));
    tmpF1389 = T6;
    if (tmpF1389 != YPfalse) {
      T7 = tmpF1389;
    } else {
      T8 = CALL2(1,VARREF(YgooSmathYE),cF1388,YPchr((P)34));
      T7 = T8;
    }
    T5 = T7;
    if (T5 != YPfalse) {
    ...
    CALL2(1,VARREF(YgooSioSportYput),FREEREF(1),cF1388);
...
loop:
  ...
  loopF1391 = T3;
  FUNINIT(loopF1391, 4,lenF1390,port_,x_,loopF1391);
  T4 = CALL1(0,loopF1391,YPint((P)0));
  T2 = T4;
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    loopF1392 = T6;
    FUNINIT(loopF1392, 4,port_,d_,recur_,loopF1392);
    T8 = CALL1(1,VARREF(Ytail),x_);
    T7 = CALL2(0,loopF1392,T8,YPint((P)1));
...
loop:
  ...
  zF1396 = T6;
  T7 = CALL2(1,VARREF(YgooSmagYG),zF1396,YPint((P)0));
  if (T7 != YPfalse) {
    T8 = CALL2(1,VARREF(YgooSmacrosYelt),x_,YPint((P)0));
    CALL2(1,recur_,T8,d_);
    T10 = FUNSHELL(1,fun_loop_30,6);
    loopF1397 = T10;
    FUNINIT(loopF1397, 6,port_,zF1396,x_,d_,recur_,loopF1397);
    T11 = CALL1(0,loopF1397,YPint((P)1));
    T9 = T11;
  } else {
  }
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    iF1399 = T7;
    T10 = CALL1(1,VARREF(YgooScolsScolYnow_key),x_1378_);
    T11 = CALL1(1,VARREF(YgooScolsScolYnow),x_1378_);
    T9 = CALL2(1,VARREF(Ytup),T10,T11);
    tup26F1400 = T9;
    T13 = CALL2(1,VARREF(YgooSmacrosYelt),tup26F1400,YPint((P)0));
    keyF1401 = T13;
    T15 = CALL2(1,VARREF(YgooSmacrosYelt),tup26F1400,YPint((P)1));
    valF1402 = T15;
    T16 = CALL2(1,VARREF(YgooSmagYGE),iF1399,VARREF(YgooSioSwriteYTmax_print_lengthT));
    if (T16 != YPfalse) {
    ...
    CALL2(1,VARREF(YgooSioSportYput),FREEREF(0),YPchr((P)32));
    CALL2(1,FREEREF(3),keyF1401,FREEREF(2));
    CALL2(1,VARREF(YgooSioSportYputs),FREEREF(0),LITREF(lit_48));
    CALL2(1,FREEREF(3),valF1402,FREEREF(2));
    T19 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1379_);
    T20 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1378_);
    a1 = T19;
    a2 = T20;
    x_1379_ = a1;
    x_1378_ = a2;
...
LINK_STACK();
  ARG(blow_, 0);
loop:
  T1 = FUNSHELL(1,fun_x_1380_32,5);
  x_1380F1403 = T1;
  FUNINIT(x_1380F1403, 5,FREEREF(0),blow_,FREEREF(1),FREEREF(2),x_1380F1403);
...
FUNCODEDEF(fun_x_1384_37) {
  P x_1383_,x_1382_,x_1381_;
  P iF1408;
  P specF1407;
  P firstQF1406;
  P tmpF1405;
...
LINK_STACK();
  ...
  ARG(x_1381_, 2);
loop:
  T3 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_1383_);
  tmpF1404 = T3;
  if (tmpF1404 != YPfalse) {
    T4 = tmpF1404;
  } else {
    T6 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_1382_);
    tmpF1405 = T6;
    if (tmpF1405 != YPfalse) {
      T7 = tmpF1405;
    } else {
      T8 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_1381_);
      T7 = T8;
    }
    T5 = T7;
    T4 = T5;
  ...
  T1 = CALL1(1,VARREF(Ynot),T2);
  if (T1 != YPfalse) {
    T10 = CALL1(1,VARREF(YgooScolsScolYnow),x_1383_);
    firstQF1406 = T10;
    T12 = CALL1(1,VARREF(YgooScolsScolYnow),x_1382_);
    specF1407 = T12;
    T14 = CALL1(1,VARREF(YgooScolsScolYnow),x_1381_);
    iF1408 = T14;
    T15 = CALL1(1,VARREF(Ynot),firstQF1406);
    if (T15 != YPfalse) {
    ...
    if (T17 != YPfalse) {
      T18 = CALL2(1,VARREF(YgooSioSwriteYwrite_type),FREEREF(0),specF1407);
    } else {
      T20 = CALL2(1,VARREF(YgooSmacrosYelt),FREEREF(1),iF1408);
      T19 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLstrG),T20);
      CALL3(1,VARREF(YgooSruntimeYmsg),FREEREF(0),LITREF(lit_56),T19);
      CALL2(1,VARREF(YgooSioSwriteYwrite_type),FREEREF(0),specF1407);
      T21 = CALL2(1,VARREF(YgooSioSportYput),FREEREF(0),YPchr((P)41));
    }
    T23 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1383_);
    T24 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1382_);
    T25 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1381_);
    a1 = T23;
    a2 = T24;
    a3 = T25;
    x_1383_ = a1;
...
loop:
  ...
  namesF1410 = T3;
  T4 = FUNSHELL(1,fun_x_1384_37,3);
  x_1384F1411 = T4;
  FUNINIT(x_1384F1411, 3,port_,namesF1410,x_1384F1411);
  T8 = fun_38;
  T9 = fun_39;
  ...
  T5 = CALL3(0,x_1384F1411,T6,T10,T12);
  T15 = CALL1(1,VARREF(Yfun_val),x_);
  valueF1412 = T15;
  T18 = CALL1(1,VARREF(Ynot),valueF1412);
  tmpF1413 = T18;
  if (tmpF1413 != YPfalse) {
    T19 = tmpF1413;
  } else {
    T20 = CALL2(1,VARREF(YgooSmacrosYEE),valueF1412,VARREF(YLanyG));
    T19 = T20;
  }
  T17 = T19;
  ...
  if (T16 != YPfalse) {
    ...
    T21 = CALL2(1,VARREF(YgooSioSwriteYwrite_type),port_,valueF1412);
  } else {
  }
...
loop:
  ...
  if (tmpF1415 != YPfalse) {
    ...
    T4 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLstrG),nameF1414);
...
FUNCODEDEF(fun_recurring_write_type_49) {
  P port_,x_,d_,recur_;
  P T2,T1,T0;
  P a1,a2,a3,a4;
LINK_STACK();
...
FUNCODEDEF(fun_recurring_write_type_50) {
  P port_,x_,d_,recur_;
  P T0;
  P a1,a2,a3,a4;
LINK_STACK();
...
LINK_STACK();
  ...
  ARG(x_, 1);
loop:
  T1 = FUNSHELL(0,fun_recur_51,2);
  recurF1416 = T1;
  FUNINIT(recurF1416, 2,port_,recurF1416);
  T2 = CALL2(0,recurF1416,x_,YPint((P)0));
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
LINK_STACK();
  ...
  ARG(x_1386_, 1);
loop:
  T3 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_1387_);
  tmpF1417 = T3;
  if (tmpF1417 != YPfalse) {
    T4 = tmpF1417;
  } else {
    T5 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_1386_);
    T4 = T5;
  }
  T2 = T4;
  T1 = CALL1(1,VARREF(Ynot),T2);
  if (T1 != YPfalse) {
    T7 = CALL1(1,VARREF(YgooScolsScolYnow),x_1387_);
    iF1418 = T7;
    T9 = CALL1(1,VARREF(YgooScolsScolYnow),x_1386_);
    propF1419 = T9;
    T10 = CALL2(1,VARREF(YgooSmagYGE),iF1418,VARREF(YgooSioSwriteYTmax_print_lengthT));
    if (T10 != YPfalse) {
      CALL2(1,VARREF(YgooSioSportYputs),FREEREF(0),LITREF(lit_80));
      T11 = CALL1(1,FREEREF(1),YPfalse);
    } else {
    }
    T13 = CALL1(1,VARREF(Yprop_getter),propF1419);
    getterF1420 = T13;
    CALL2(1,VARREF(YgooSioSportYput),FREEREF(0),YPchr((P)32));
    T14 = CALL1(1,VARREF(Yfun_name),getterF1420);
    CALL2(1,VARREF(YgooSioSwriteYdisplay),FREEREF(0),T14);
    CALL2(1,VARREF(YgooSioSportYputs),FREEREF(0),LITREF(lit_81));
    T15 = CALL1(1,getterF1420,FREEREF(2));
    CALL2(1,FREEREF(4),T15,FREEREF(3));
    T17 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1387_);
    T18 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1386_);
    a1 = T17;
    a2 = T18;
    x_1387_ = a1;
    x_1386_ = a2;
...
loop:
  ...
  T1 = FUNSHELL(1,fun_x_1388_54,6);
  x_1388F1421 = T1;
  FUNINIT(x_1388F1421, 6,FREEREF(0),FREEREF(1),FREEREF(2),FREEREF(3),FREEREF(4),x_1388F1421);
  T4 = CALL1(1,VARREF(YgooScolsSrangeYfrom),YPint((P)0));
  T3 = CALL1(1,VARREF(YgooScolsScolYenum),T4);
  T6 = CALL1(1,VARREF(Yobject_props),FREEREF(2));
  T5 = CALL1(1,VARREF(YgooScolsScolYenum),T6);
  T2 = CALL2(0,x_1388F1421,T3,T5);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
LINK_STACK();
  ARG(blow_, 0);
loop:
  x_1385F1422 = VARREF(YTreport_prop_unbound_errorsQT);
  T2 = FUNFAB(fun_55,5,FREEREF(0),blow_,FREEREF(1),FREEREF(2),FREEREF(3));
  T3 = FUNFAB(fun_56,1,x_1385F1422);
...
loop:
  ...
  T0 = CALL1(1,VARREF(Yclass_name),T1);
  CALL2(1,VARREF(YgooSioSwriteYdisplay),port_,T0);
  T2 = FUNFAB(fun_57,4,port_,x_,d_,recur_);
  with_exit(T2);
...
FUNCODEDEF(fun_recurring_write_59) {
  P port_,x_,d_,recur_;
  P T0;
  P a1,a2,a3,a4;
LINK_STACK();
...
FUNCODEDEF(fun_arg_61) {
  P char_,class_;
  P tmpF1425;
  P argumentF1424;
  P current_indexF1423;
...
loop:
  T1 = BOXVAL(FREEREF(0));
  current_indexF1423 = T1;
  T3 = BOXVAL(FREEREF(0));
  T2 = CALL2(1,VARREF(YgooSmathYA),T3,YPint((P)1));
  BOXVAL(FREEREF(0)) = T2;
  T5 = CALL2(1,VARREF(YgooSmagYL),current_indexF1423,FREEREF(1));
  T4 = CALL1(1,VARREF(Ynot),T5);
  if (T4 != YPfalse) {
    T6 = CALL3(1,VARREF(Yerror),LITREF(lit_90),FREEREF(2),FREEREF(3));
  } else {
  }
  T8 = CALL2(1,VARREF(YgooSmacrosYelt),FREEREF(3),current_indexF1423);
  argumentF1424 = T8;
  ...
  if (tmpF1425 != YPfalse) {
    ...
    T13 = CALL2(1,VARREF(YisaQ),argumentF1424,class_);
    T12 = T13;
  }
  T10 = T12;
  T9 = CALL1(1,VARREF(Ynot),T10);
  if (T9 != YPfalse) {
    T14 = CALL4(1,VARREF(Yerror),LITREF(lit_91),char_,class_,argumentF1424);
  } else {
  }
  T7 = argumentF1424;
  T0 = T7;
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    x_1389F1426 = T2;
    x_1390F1427 = VARREF(YgooSmacrosYEE);
    T5 = CALL2(1,x_1390F1427,x_1389F1426,YPchr((P)68));
    if (T5 != YPfalse) {
      ...
      T10 = CALL2(1,x_1390F1427,x_1389F1426,YPchr((P)66));
      if (T10 != YPfalse) {
        ...
        T15 = CALL2(1,x_1390F1427,x_1389F1426,YPchr((P)79));
        if (T15 != YPfalse) {
          ...
          T20 = CALL2(1,x_1390F1427,x_1389F1426,YPchr((P)88));
          if (T20 != YPfalse) {
...
FUNCODEDEF(fun_msg_63) {
  P port_,message_,arguments_;
  P argF1431;
  P num_argumentsF1430;
  P argument_indexF1429;
  P found_percentQF1428;
  P T13,T12,T11,T10,T9,T8,T7,T6,T5,T4,T3,T2,T1,T0;
  P a1,a2,a3;
LINK_STACK();
  ARG(port_, 0);
  ...
  NARGS(arguments_, 2);
loop:
  found_percentQF1428 = YPfalse;
  found_percentQF1428 = BOXFAB(found_percentQF1428);
  check_type(YPint((P)0),VARREF(YLintG));
  argument_indexF1429 = YPint((P)0);
  argument_indexF1429 = BOXFAB(argument_indexF1429);
  T5 = CALL1(1,VARREF(YgooStypesYlen),arguments_);
  num_argumentsF1430 = T5;
  T6 = FUNSHELL(1,fun_arg_61,4);
  argF1431 = T6;
  FUNINIT(argF1431, 4,argument_indexF1429,num_argumentsF1430,message_,arguments_);
  T8 = FUNFAB(fun_62,4,found_percentQF1428,port_,argF1431,message_);
  T7 = CALL2(1,VARREF(YgooSmacrosYdo),T8,message_);
  T12 = BOXVAL(found_percentQF1428);
...
FUNCODEDEF(fun_maybe_pack_chars_65) {
  P UF1432;
  P T11,T10,T9,T8,T7,T6,T5,T4,T3,T2,T1,T0;
LINK_STACK();
loop:
  ...
  if (T1 != YPfalse) {
    ...
    T5 = CALL2(1,VARREF(YgooSpackerYpacker_add),UF1432,T6);
...
loop:
  CALL0(0,FREEREF(0));
  T1 = BOXVAL(FREEREF(1));
  current_indexF1433 = T1;
  T3 = BOXVAL(FREEREF(1));
  T2 = CALL2(1,VARREF(YgooSmathYA),T3,YPint((P)1));
  BOXVAL(FREEREF(1)) = T2;
  T5 = CALL2(1,VARREF(YgooSmagYL),current_indexF1433,FREEREF(2));
  T4 = CALL1(1,VARREF(Ynot),T5);
  if (T4 != YPfalse) {
    T6 = CALL3(1,VARREF(Yerror),LITREF(lit_100),FREEREF(3),FREEREF(4));
  } else {
  }
  T7 = CALL2(1,VARREF(YgooSmacrosYelt),FREEREF(4),current_indexF1433);
  T0 = T7;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  if (T1 != YPfalse) {
    T2 = CALL1(1,VARREF(YgooSmathYto_upper),c_);
    x_1393F1434 = T2;
    x_1394F1435 = VARREF(YgooSmacrosYEE);
    T5 = CALL2(1,x_1394F1435,x_1393F1434,YPchr((P)68));
    if (T5 != YPfalse) {
      T7 = BOXVAL(FREEREF(1));
      UF1436 = T7;
      ...
      T9 = CALL2(1,VARREF(YgooSpackerYpacker_add),UF1436,T10);
      T8 = BOXVAL(FREEREF(1)) = T9;
      T6 = T8;
      T4 = T6;
    } else {
      T19 = CALL2(1,x_1394F1435,x_1393F1434,YPchr((P)66));
      if (T19 != YPfalse) {
        ...
        T23 = CALL2(1,VARREF(YgooSpackerYpacker_add),UF1437,T24);
        T22 = BOXVAL(FREEREF(1)) = T23;
        T20 = T22;
        T18 = T20;
      } else {
        T34 = CALL2(1,x_1394F1435,x_1393F1434,YPchr((P)79));
        if (T34 != YPfalse) {
          ...
          T38 = CALL2(1,VARREF(YgooSpackerYpacker_add),UF1438,T39);
          T37 = BOXVAL(FREEREF(1)) = T38;
          T35 = T37;
          T33 = T35;
        } else {
          T49 = CALL2(1,x_1394F1435,x_1393F1434,YPchr((P)88));
          if (T49 != YPfalse) {
            ...
            T53 = CALL2(1,VARREF(YgooSpackerYpacker_add),UF1439,T54);
            T52 = BOXVAL(FREEREF(1)) = T53;
            T50 = T52;
            T48 = T50;
          } else {
            T64 = CALL2(1,x_1394F1435,x_1393F1434,YPchr((P)67));
            if (T64 != YPfalse) {
              ...
              T68 = CALL2(1,VARREF(YgooSpackerYpacker_add),UF1440,T69);
              T67 = BOXVAL(FREEREF(1)) = T68;
              T65 = T67;
              T63 = T65;
            } else {
              T75 = CALL2(1,x_1394F1435,x_1393F1434,YPchr((P)83));
              if (T75 != YPfalse) {
                ...
                T79 = CALL2(1,VARREF(YgooSpackerYpacker_add),UF1441,T80);
                T78 = BOXVAL(FREEREF(1)) = T79;
                T76 = T78;
                T74 = T76;
              } else {
                T86 = CALL2(1,x_1394F1435,x_1393F1434,YPchr((P)61));
                if (T86 != YPfalse) {
                  ...
                  T90 = CALL2(1,VARREF(YgooSpackerYpacker_add),UF1442,T91);
                  T89 = BOXVAL(FREEREF(1)) = T90;
                  T87 = T89;
                  T85 = T87;
                } else {
                  T97 = CALL2(1,x_1394F1435,x_1393F1434,YPchr((P)37));
                  if (T97 != YPfalse) {
...
FUNCODEDEF(fun_pe_msg_68) {
  P port_expr_,message_,args_;
  P exprsF1451;
  P argF1450;
  P maybe_pack_charsF1449;
  P packer_F1448;
  P portF1447;
  P charsF1446;
  P num_argsF1445;
  P arg_indexF1444;
  P found_percentQF1443;
...
LINK_STACK();
  ...
  ARG(args_, 2);
loop:
  found_percentQF1443 = YPfalse;
  found_percentQF1443 = BOXFAB(found_percentQF1443);
  check_type(YPint((P)0),VARREF(YLintG));
  arg_indexF1444 = YPint((P)0);
  arg_indexF1444 = BOXFAB(arg_indexF1444);
  ...
  packer_F1448 = T12;
  packer_F1448 = BOXFAB(packer_F1448);
  T14 = FUNSHELL(1,fun_maybe_pack_chars_65,3);
  maybe_pack_charsF1449 = T14;
  T15 = FUNSHELL(1,fun_arg_66,5);
  argF1450 = T15;
  FUNINIT(maybe_pack_charsF1449, 3,charsF1446,packer_F1448,portF1447);
  FUNINIT(argF1450, 5,maybe_pack_charsF1449,arg_indexF1444,num_argsF1445,message_,args_);
  T16 = FUNFAB(fun_67,6,found_percentQF1443,packer_F1448,portF1447,argF1450,charsF1446,message_);
  CALL2(1,VARREF(YgooSmacrosYdo),T16,message_);
  T17 = CALL0(0,maybe_pack_charsF1449);
  T19 = BOXVAL(packer_F1448);
  T18 = CALL1(1,VARREF(YgooSpackerYpacker_res),T19);
  T11 = T18;
  exprsF1451 = T11;
  T22 = BOXVAL(found_percentQF1443);
  ...
  T30 = CALL1(1,VARREF(Ylst),portF1447);
  ...
  T24 = CALL4(1,VARREF(YgooSmacrosYcat),T25,T26,exprsF1451,Ynil);
  T10 = T24;
  T8 = T10;
  T6 = T8;
  T4 = T6;
...
LINK_STACK();
  ARG(return_, 0);
loop:
  T1 = FUNSHELL(0,fun_x_1398_69,1);
  x_1398F1452 = T1;
  FUNINIT(x_1398F1452, 1,return_);
  x_1397F1453 = FREEREF(0);
  portF1454 = YPfalse;
  portF1454 = BOXFAB(portF1454);
  messageF1455 = YPfalse;
  messageF1455 = BOXFAB(messageF1455);
  argsF1456 = YPfalse;
  argsF1456 = BOXFAB(argsF1456);
  T9 = CALL2(1,VARREF(YisaQ),x_1397F1453,VARREF(YLlstG));
  if (T9 != YPfalse) {
    T11 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1397F1453,LITREF(lit_109),x_1398F1452);
    x_1397F1457 = T11;
    T13 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1397F1457,x_1398F1452);
    BOXVAL(portF1454) = T13;
    T14 = CALL1(1,VARREF(Ytail),x_1397F1457);
    x_1397F1458 = T14;
    T16 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1397F1458,x_1398F1452);
    BOXVAL(messageF1455) = T16;
    T17 = CALL1(1,VARREF(Ytail),x_1397F1458);
    x_1397F1459 = T17;
    BOXVAL(argsF1456) = x_1397F1459;
    x_1397F1460 = Ynil;
    T19 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1397F1460,x_1398F1452);
    T18 = T19;
    T15 = T18;
    T12 = T15;
    T10 = T12;
  } else {
    T20 = CALL2(1,x_1398F1452,LITREF(lit_110),x_1397F1453);
  }
  T22 = BOXVAL(portF1454);
  T23 = BOXVAL(messageF1455);
  T24 = BOXVAL(argsF1456);
...
loop:
  ...
  BOXVAL(FREEREF(0)) = T0;
  T1 = BOXVAL(FREEREF(0));
  CALLN(1,VARREF(YgooSmacrosYnapp),5,VARREF(YgooSruntimeYmsg),YPfalse,T1,FREEREF(1),FREEREF(2));
  T3 = BOXVAL(FREEREF(0));
...
loop:
  portF1462 = YPfalse;
  portF1462 = BOXFAB(portF1462);
  T3 = FUNFAB(fun_72,3,portF1462,message_,arguments_);
  T4 = FUNFAB(fun_73,1,portF1462);
  T2 = with_cleanup(T3,T4);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  loopF1464 = T3;
  FUNINIT(loopF1464, 4,limF1463,port_,args_,loopF1464);
  T4 = CALL1(0,loopF1464,YPint((P)0));
  T2 = T4;
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
...
loop:
  ...
  lit_44 = YPPsym((P)"x-1380");
  lit_45 = YPPsym((P)"x-1379");
  lit_46 = YPPsym((P)"x-1378");
  lit_47 = YPsb((P)" ...");
  lit_48 = YPsb((P)": ");
  ...
  fun_x_1380_32 = YPmet(FUNCODEREF(fun_x_1380_32),LITREF(lit_44),T134,ENVNUL,PNUL,YPfalse);
  ...
  lit_53 = YPPsym((P)"x-1383");
  lit_54 = YPPsym((P)"x-1382");
  lit_55 = YPPsym((P)"x-1381");
  lit_56 = YPsb((P)"(%s ");
  lit_57 = YPsb((P)" => ");
  ...
  fun_x_1384_37 = YPmet(FUNCODEREF(fun_x_1384_37),LITREF(lit_52),T152,ENVNUL,PNUL,YPfalse);
  ...
  T193 = YPsig(YPPlist(4,LITREF(lit_3),LITREF(lit_4),LITREF(lit_5),LITREF(lit_6)),YPPlist(4,VARREF(YgooSioSportYLout_portG),VARREF(YLclassG),VARREF(YLintG),VARREF(YLfunG)),YPfalse,YPint((P)4),VARREF(YLanyG),Ynil);
  fun_recurring_write_type_49 = YPmet(FUNCODEREF(fun_recurring_write_type_49),LITREF(lit_72),T193,ENVNUL,PNUL,YPfalse);
  T196 = BOUNDP(YgooSioSwriteYrecurring_write_type);
  if (T196 != YPfalse) {
    T195 = VARREF(YgooSioSwriteYrecurring_write_type);
  } else {
    T195 = YPfalse;
  }
  T197 = fun_recurring_write_type_49;
  T194 = CALL2(1,VARREF(YPdefine_method),T195,T197);
  VARSET(YgooSioSwriteYrecurring_write_type,T194);
  T198 = YPsig(YPPlist(4,LITREF(lit_3),LITREF(lit_4),LITREF(lit_5),LITREF(lit_6)),YPPlist(4,VARREF(YgooSioSportYLout_portG),VARREF(YLanyG),VARREF(YLintG),VARREF(YLfunG)),YPfalse,YPint((P)4),VARREF(YLanyG),Ynil);
  fun_recurring_write_type_50 = YPmet(FUNCODEREF(fun_recurring_write_type_50),LITREF(lit_72),T198,ENVNUL,PNUL,YPfalse);
  T201 = BOUNDP(YgooSioSwriteYrecurring_write_type);
  if (T201 != YPfalse) {
    T200 = VARREF(YgooSioSwriteYrecurring_write_type);
  } else {
    T200 = YPfalse;
  }
  T202 = fun_recurring_write_type_50;
  T199 = CALL2(1,VARREF(YPdefine_method),T200,T202);
  VARSET(YgooSioSwriteYrecurring_write_type,T199);
  lit_73 = YPPsym((P)"write-type");
  T204 = YPsig(YPPlist(2,LITREF(lit_4),LITREF(lit_5)),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_recur_51 = YPmet(FUNCODEREF(fun_recur_51),LITREF(lit_6),T204,ENVNUL,PNUL,YPfalse);
  T203 = YPsig(YPPlist(2,LITREF(lit_3),LITREF(lit_4)),YPPlist(2,VARREF(YgooSioSportYLout_portG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_write_type_52 = YPmet(FUNCODEREF(fun_write_type_52),LITREF(lit_73),T203,ENVNUL,PNUL,YPfalse);
  T207 = BOUNDP(YgooSioSwriteYwrite_type);
  if (T207 != YPfalse) {
    T206 = VARREF(YgooSioSwriteYwrite_type);
  } else {
    T206 = YPfalse;
  }
  T208 = fun_write_type_52;
  T205 = CALL2(1,VARREF(YPdefine_method),T206,T208);
  VARSET(YgooSioSwriteYwrite_type,T205);
  lit_74 = YPsb((P)"#{Prop ");
  lit_75 = YPsb((P)"}");
  T209 = YPsig(YPPlist(4,LITREF(lit_3),LITREF(lit_4),LITREF(lit_5),LITREF(lit_6)),YPPlist(4,VARREF(YgooSioSportYLout_portG),VARREF(YLpropG),VARREF(YLintG),VARREF(YLfunG)),YPfalse,YPint((P)4),VARREF(YLanyG),Ynil);
  fun_recurring_write_53 = YPmet(FUNCODEREF(fun_recurring_write_53),LITREF(lit_14),T209,ENVNUL,PNUL,YPfalse);
  ...
  lit_76 = YPsb((P)"#{");
  lit_77 = YPPsym((P)"x-1388");
  lit_78 = YPPsym((P)"x-1387");
  lit_79 = YPPsym((P)"x-1386");
  lit_80 = YPsb((P)" ...");
  lit_81 = YPsb((P)": ");
  lit_82 = YPsb((P)"}");
  T218 = YPsig(YPPlist(2,LITREF(lit_78),LITREF(lit_79)),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_x_1388_54 = YPmet(FUNCODEREF(fun_x_1388_54),LITREF(lit_77),T218,ENVNUL,PNUL,YPfalse);
  T217 = YPsig(Ynil,Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  fun_55 = YPmet(FUNCODEREF(fun_55),YPfalse,T217,ENVNUL,PNUL,YPfalse);
  T216 = YPsig(Ynil,Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  fun_56 = YPmet(FUNCODEREF(fun_56),YPfalse,T216,ENVNUL,PNUL,YPfalse);
  T215 = YPsig(YPPlist(1,LITREF(lit_43)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_57 = YPmet(FUNCODEREF(fun_57),YPfalse,T215,ENVNUL,PNUL,YPfalse);
  T214 = YPsig(YPPlist(4,LITREF(lit_3),LITREF(lit_4),LITREF(lit_5),LITREF(lit_6)),YPPlist(4,VARREF(YgooSioSportYLout_portG),VARREF(YLanyG),VARREF(YLintG),VARREF(YLfunG)),YPfalse,YPint((P)4),VARREF(YLanyG),Ynil);
  fun_recurring_write_58 = YPmet(FUNCODEREF(fun_recurring_write_58),LITREF(lit_14),T214,ENVNUL,PNUL,YPfalse);
  T221 = BOUNDP(YgooSioSwriteYrecurring_write);
  if (T221 != YPfalse) {
    T220 = VARREF(YgooSioSwriteYrecurring_write);
  } else {
    T220 = YPfalse;
  }
  T222 = fun_recurring_write_58;
  T219 = CALL2(1,VARREF(YPdefine_method),T220,T222);
  VARSET(YgooSioSwriteYrecurring_write,T219);
  lit_83 = YPsb((P)"#{End-of-file}");
  T225 = CALL0(1,VARREF(YgooSmathYeof_object));
  T224 = CALL1(1,VARREF(YgooStypesYtE),T225);
  T223 = YPsig(YPPlist(4,LITREF(lit_3),LITREF(lit_4),LITREF(lit_5),LITREF(lit_6)),YPPlist(4,VARREF(YgooSioSportYLout_portG),T224,VARREF(YLintG),VARREF(YLfunG)),YPfalse,YPint((P)4),VARREF(YLanyG),Ynil);
  fun_recurring_write_59 = YPmet(FUNCODEREF(fun_recurring_write_59),LITREF(lit_14),T223,ENVNUL,PNUL,YPfalse);
  T228 = BOUNDP(YgooSioSwriteYrecurring_write);
  if (T228 != YPfalse) {
    T227 = VARREF(YgooSioSwriteYrecurring_write);
  } else {
    T227 = YPfalse;
  }
  T229 = fun_recurring_write_59;
  T226 = CALL2(1,VARREF(YPdefine_method),T227,T229);
  VARSET(YgooSioSwriteYrecurring_write,T226);
  lit_84 = YPsb((P)"nul");
  T231 = CALL1(1,VARREF(YgooStypesYtE),VARREF(Ynul));
  T230 = YPsig(YPPlist(4,LITREF(lit_3),LITREF(lit_4),LITREF(lit_5),LITREF(lit_6)),YPPlist(4,VARREF(YgooSioSportYLout_portG),T231,VARREF(YLintG),VARREF(YLfunG)),YPfalse,YPint((P)4),VARREF(YLanyG),Ynil);
  fun_recurring_write_60 = YPmet(FUNCODEREF(fun_recurring_write_60),LITREF(lit_14),T230,ENVNUL,PNUL,YPfalse);
  ...
  lit_90 = YPsb((P)"Too few arguments for msg string %=: %=");
  lit_91 = YPsb((P)"Msg argument for directive '%%%c' not of class %s: %=");
  lit_92 = YPPsym((P)"c");
  lit_93 = YPsb((P)"Invalid msg directive '%s' in \"%s\"");
  lit_94 = YPsb((P)"Incomplete msg directive in \"%s\"");
  T238 = YPsig(YPPlist(2,LITREF(lit_26),LITREF(lit_89)),YPPlist(2,VARREF(YLchrG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_arg_61 = YPmet(FUNCODEREF(fun_arg_61),LITREF(lit_88),T238,ENVNUL,PNUL,YPfalse);
  T237 = YPsig(YPPlist(1,LITREF(lit_92)),YPPlist(1,VARREF(YLchrG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_62 = YPmet(FUNCODEREF(fun_62),YPfalse,T237,ENVNUL,PNUL,YPfalse);
  T236 = YPsig(YPPlist(3,LITREF(lit_3),LITREF(lit_86),LITREF(lit_87)),YPPlist(2,VARREF(YgooSioSportYLout_portG),VARREF(YLstrG)),YPtrue,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_msg_63 = YPmet(FUNCODEREF(fun_msg_63),LITREF(lit_85),T236,ENVNUL,PNUL,YPfalse);
  T241 = BOUNDP(YgooSruntimeYmsg);
  if (T241 != YPfalse) {
    T240 = VARREF(YgooSruntimeYmsg);
  } else {
    T240 = YPfalse;
  }
  T242 = fun_msg_63;
  T239 = CALL2(1,VARREF(YPdefine_method),T240,T242);
  VARSET(YgooSruntimeYmsg,T239);
  lit_95 = YPPsym((P)"pe-msg");
  lit_96 = YPPsym((P)"port-expr");
  lit_97 = YPPsym((P)"args");
  T243 = YPsig(YPPlist(3,LITREF(lit_96),LITREF(lit_86),LITREF(lit_97)),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLlstG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_pe_msg_64 = YPmet(FUNCODEREF(fun_pe_msg_64),LITREF(lit_95),T243,ENVNUL,PNUL,YPfalse);
  T246 = BOUNDP(YgooSioSwriteYpe_msg);
  if (T246 != YPfalse) {
    T245 = VARREF(YgooSioSwriteYpe_msg);
  } else {
    T245 = YPfalse;
  }
  T247 = fun_pe_msg_64;
  T244 = CALL2(1,VARREF(YPdefine_method),T245,T247);
  VARSET(YgooSioSwriteYpe_msg,T244);
  lit_98 = YPPsym((P)"maybe-pack-chars");
  lit_99 = YPPsym((P)"puts");
  lit_100 = YPsb((P)"Too few arguments for msg string %=: %=");
  lit_101 = YPPsym((P)"num-to-str");
  lit_102 = YPPsym((P)"put");
  lit_103 = YPsb((P)"Invalid msg directive '%s' in \"%s\"");
  lit_104 = YPsb((P)"Incomplete msg directive in \"%s\"");
  lit_105 = YPPsym((P)"let");
  T251 = YPsig(Ynil,Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  fun_maybe_pack_chars_65 = YPmet(FUNCODEREF(fun_maybe_pack_chars_65),LITREF(lit_98),T251,ENVNUL,PNUL,YPfalse);
  T250 = YPsig(YPPlist(1,LITREF(lit_26)),YPPlist(1,VARREF(YLchrG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_arg_66 = YPmet(FUNCODEREF(fun_arg_66),LITREF(lit_88),T250,ENVNUL,PNUL,YPfalse);
  T249 = YPsig(YPPlist(1,LITREF(lit_92)),YPPlist(1,VARREF(YLchrG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_67 = YPmet(FUNCODEREF(fun_67),YPfalse,T249,ENVNUL,PNUL,YPfalse);
  T248 = YPsig(YPPlist(3,LITREF(lit_96),LITREF(lit_86),LITREF(lit_97)),YPPlist(3,VARREF(YLanyG),VARREF(YLstrG),VARREF(YLlstG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_pe_msg_68 = YPmet(FUNCODEREF(fun_pe_msg_68),LITREF(lit_95),T248,ENVNUL,PNUL,YPfalse);
  T254 = BOUNDP(YgooSioSwriteYpe_msg);
  if (T254 != YPfalse) {
    T253 = VARREF(YgooSioSwriteYpe_msg);
  } else {
    T253 = YPfalse;
  }
  T255 = fun_pe_msg_68;
  T252 = CALL2(1,VARREF(YPdefine_method),T253,T255);
  VARSET(YgooSioSwriteYpe_msg,T252);
  lit_106 = YPPsym((P)"exp");
  lit_107 = YPPsym((P)"return");
  lit_108 = YPPsym((P)"x-1398");
  lit_109 = YPPsym((P)"msg*");
  lit_110 = YPsb((P)"Match Pattern Failure");
  T258 = YPsig(YPPlist(2,LITREF(lit_85),LITREF(lit_97)),YPPlist(1,VARREF(YLstrG)),YPtrue,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_x_1398_69 = YPmet(FUNCODEREF(fun_x_1398_69),LITREF(lit_108),T258,ENVNUL,PNUL,YPfalse);
  T257 = YPsig(YPPlist(1,LITREF(lit_107)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_70 = YPmet(FUNCODEREF(fun_70),YPfalse,T257,ENVNUL,PNUL,YPfalse);
  T256 = YPsig(YPPlist(1,LITREF(lit_106)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_71 = YPmet(FUNCODEREF(fun_71),YPfalse,T256,ENVNUL,PNUL,YPfalse);
  T259 = fun_71;
  YPmacro(YPPsym((P)"goo/io/write"),YPPsym((P)"msg*"),T259);
  lit_111 = YPPsym((P)"msg-to-str");
  T262 = YPsig(Ynil,Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  fun_72 = YPmet(FUNCODEREF(fun_72),YPfalse,T262,ENVNUL,PNUL,YPfalse);
  T261 = YPsig(Ynil,Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  fun_73 = YPmet(FUNCODEREF(fun_73),YPfalse,T261,ENVNUL,PNUL,YPfalse);
  T260 = YPsig(YPPlist(2,LITREF(lit_86),LITREF(lit_87)),YPPlist(1,VARREF(YLstrG)),YPtrue,YPint((P)1),VARREF(YLstrG),Ynil);
  YgooSruntimeYmsg_to_str = YPmet(FUNCODEREF(YgooSruntimeYmsg_to_str),LITREF(lit_111),T260,ENVNUL,PNUL,YPfalse);
  T263 = YgooSruntimeYmsg_to_str;
  VARSET(YgooSruntimeYmsg_to_str,T263);
  lit_112 = YPPsym((P)"say");
  T265 = YPsig(YPPlist(1,LITREF(lit_29)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_loop_75 = YPmet(FUNCODEREF(fun_loop_75),LITREF(lit_28),T265,ENVNUL,PNUL,YPfalse);
  T264 = YPsig(YPPlist(2,LITREF(lit_3),LITREF(lit_97)),YPPlist(1,VARREF(YgooSioSportYLout_portG)),YPtrue,YPint((P)1),VARREF(YLanyG),Ynil);
  YgooSioSwriteYsay = YPmet(FUNCODEREF(YgooSioSwriteYsay),LITREF(lit_112),T264,ENVNUL,PNUL,YPfalse);
  T266 = YgooSioSwriteYsay;
  VARSET(YgooSioSwriteYsay,T266);
  T267 = YPfalse;
  return T267;
}
