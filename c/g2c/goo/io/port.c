...
loop:
  ...
  loopF1219 = T1;
  FUNINIT(loopF1219, 2,loopF1219,port_);
  T3 = CALL1(1,VARREF(YgooSioSportYget),port_);
  T2 = CALL2(0,loopF1219,Ynil,T3);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  x_1321F1220 = T1;
  FUNINIT(x_1321F1220, 1,return_);
  x_1320F1221 = FREEREF(0);
  nameF1222 = YPfalse;
  nameF1222 = BOXFAB(nameF1222);
  portF1223 = YPfalse;
  portF1223 = BOXFAB(portF1223);
  bodyF1224 = YPfalse;
  bodyF1224 = BOXFAB(bodyF1224);
  T9 = CALL2(1,VARREF(YisaQ),x_1320F1221,VARREF(YLlstG));
  if (T9 != YPfalse) {
    T11 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1320F1221,LITREF(lit_47),x_1321F1220);
    x_1320F1225 = T11;
    T13 = CALL2(1,VARREF(YgooSmacrosYmatch_sublist),x_1320F1225,x_1321F1220);
    x_1320F1226 = T13;
    T15 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1320F1226,x_1321F1220);
    BOXVAL(nameF1222) = T15;
    T16 = CALL1(1,VARREF(Ytail),x_1320F1226);
    x_1320F1227 = T16;
    T18 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1320F1227,x_1321F1220);
    BOXVAL(portF1223) = T18;
    T19 = CALL1(1,VARREF(Ytail),x_1320F1227);
    x_1320F1228 = T19;
    T20 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1320F1228,x_1321F1220);
    T17 = T20;
    T14 = T17;
    T21 = CALL1(1,VARREF(Ytail),x_1320F1225);
    x_1320F1229 = T21;
    BOXVAL(bodyF1224) = x_1320F1229;
    x_1320F1230 = Ynil;
    T23 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1320F1230,x_1321F1220);
    T22 = T23;
    T12 = T22;
    T10 = T12;
  } else {
    T24 = CALL2(1,x_1321F1220,LITREF(lit_48),x_1320F1221);
  }
  T26 = CALL1(1,VARREF(Ylst),LITREF(lit_49));
  T32 = BOXVAL(nameF1222);
...
loop:
  ...
  T1 = (P)YPcb(T2);
  cF1231 = T1;
  T4 = CALL2(1,VARREF(YgooSmacrosYEE),cF1231,YPchr((P)10));
  if (T4 != YPfalse) {
    x_1322F1232 = port_;
    T8 = CALL1(1,VARREF(YgooSioSportYport_line),x_1322F1232);
    T7 = CALL2(1,VARREF(YgooSmathYA),T8,YPint((P)1));
    T6 = CALL2(1,VARREF(YgooSioSportYport_line_setter),T7,x_1322F1232);
    T5 = T6;
  } else {
  }
  T0 = cF1231;
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    resF1233 = T7;
    x_1323F1234 = port_;
    T12 = CALL1(1,VARREF(YgooSioSportYport_index),x_1323F1234);
    T11 = CALL2(1,VARREF(YgooSmathYA),T12,YPint((P)1));
    T10 = CALL2(1,VARREF(YgooSioSportYport_index_setter),T11,x_1323F1234);
    T6 = resF1233;
    T0 = T6;
  }
UNLINK_STACK();
...
loop:
  ...
  x_1327F1235 = T1;
  FUNINIT(x_1327F1235, 1,return_);
  x_1326F1236 = FREEREF(0);
  nameF1237 = YPfalse;
  nameF1237 = BOXFAB(nameF1237);
  bodyF1238 = YPfalse;
  bodyF1238 = BOXFAB(bodyF1238);
  T7 = CALL2(1,VARREF(YisaQ),x_1326F1236,VARREF(YLlstG));
  if (T7 != YPfalse) {
    T9 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1326F1236,LITREF(lit_56),x_1327F1235);
    x_1326F1239 = T9;
    T11 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1326F1239,x_1327F1235);
    BOXVAL(nameF1237) = T11;
    T12 = CALL1(1,VARREF(Ytail),x_1326F1239);
    x_1326F1240 = T12;
    BOXVAL(bodyF1238) = x_1326F1240;
    x_1326F1241 = Ynil;
    T14 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1326F1241,x_1327F1235);
    T13 = T14;
    T10 = T13;
    T8 = T10;
  } else {
    T15 = CALL2(1,x_1327F1235,LITREF(lit_48),x_1326F1236);
  }
  T17 = CALL1(1,VARREF(Ylst),LITREF(lit_49));
  T23 = BOXVAL(nameF1237);
  ...
  T29 = BOXVAL(bodyF1238);
  T32 = CALL1(1,VARREF(Ylst),LITREF(lit_32));
  T34 = BOXVAL(nameF1237);
