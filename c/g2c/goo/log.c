...
DEFCREGS();
  ...
  YgooSlogYas_log = YPfab_met(FUNCODEREF(YgooSlogYas_log),T6,LITREF(lit_6),LITREF(lit_7),sloc(19),YPsb((P)"(fun (x => <log>) (and x #t))"));
  T7 = YgooSlogYas_log;
  ...
  fun_EE_1 = YPfab_met(FUNCODEREF(fun_EE_1),T8,LITREF(lit_8),LITREF(lit_9),sloc(23),YPsb((P)"(fun (x y => <log>) (%bb (%eq? x y)))"));
  ...
  fun_E_2 = YPfab_met(FUNCODEREF(fun_E_2),T12,LITREF(lit_0),LITREF(lit_10),sloc(25),YPsb((P)"(fun (x y => <log>) (== x y))"));
  ...
  fun_NE_3 = YPfab_met(FUNCODEREF(fun_NE_3),T16,LITREF(lit_2),LITREF(lit_11),sloc(27),YPsb((P)"(fun (x y => <log>) (not (= x y)))"));
  ...
  fun_NEE_4 = YPfab_met(FUNCODEREF(fun_NEE_4),T20,LITREF(lit_4),LITREF(lit_12),sloc(30),YPsb((P)"(fun (x y => <log>) (not (== x y)))"));
  ...
  fun_to_str_5 = YPfab_met(FUNCODEREF(fun_to_str_5),T24,LITREF(lit_13),LITREF(lit_14),sloc(33),YPsb((P)"(fun ((x (t= #t)) => <str>) #t)"));
  ...
  T30 = fun_to_str_6 = YPfab_met(FUNCODEREF(fun_to_str_6),T31,LITREF(lit_13),LITREF(lit_16),sloc(35),YPsb((P)"(fun ((x (t= #f)) => <str>) #f)"));
