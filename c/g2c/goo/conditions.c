...
LINK_STACK();
  ...
  next_metsF3661 = T5;
  T3 = CALL1(1,VARREF(Yhead),next_metsF3661);
  T4 = CALL1(1,VARREF(Ytail),next_metsF3661);
  ...
  CALL2(1,VARREF(YgooSconditionsYcondition_message_setter),T0,condF3662);
  CALL2(1,VARREF(YgooSconditionsYmsg),out_,LITREF(lit_26));
  T1 = CALL1(1,VARREF(YgooSconditionsYread),in_);
  CALL2(1,VARREF(YgooSconditionsYcondition_arguments_setter),T1,condF3662);
UNLINK_STACK();
  RET(condF3662);
}
...
LINK_STACK();
  ...
  ARG(user_handler_, 3);
  ARG(main_fun_, 4);
  Uoriginal_handlersUF3663 = DYNREF(YgooSconditionsYTcurrent_handlersT);
  ...
  T5 = FUNFAB(fun_34,1,Uoriginal_handlersUF3663);
...
LINK_STACK();
  ...
  if (T1 != YPfalse) {
    ...
    remainingF3665 = T9;
    T4 = CALL2(1,VARREF(YgooSconditionsYhandler_matchesQ),handlerF3664,condition_);
    if (T4 != YPfalse) {
      T7 = CALL1(1,VARREF(YgooSconditionsYhandler_function),handlerF3664);
      T6 = FUNFAB(fun_36,2,condition_,remainingF3665);
      T5 = CALL2(1,T7,condition_,T6);
      T3 = T5;
    } else {
      T8 = CALL2(1,VARREF(YgooSconditionsYsignal_handler_list),condition_,remainingF3665);
      T3 = T8;
    }
    T0 = T3;
  }
...
LINK_STACK();
  ...
  next_metsF3666 = T7;
  T5 = CALL1(1,VARREF(Yhead),next_metsF3666);
  T6 = CALL1(1,VARREF(Ytail),next_metsF3666);
...
LINK_STACK();
  ...
  T7 = CALL3(1,VARREF(YgooSmacrosYOchecked_next_methods),T8,T9,c_);
  next_metsF3667 = T7;
  T5 = CALL1(1,VARREF(Yhead),next_metsF3667);
  T6 = CALL1(1,VARREF(Ytail),next_metsF3667);
  T4 = CALL4(1,VARREF(YgooSmacrosYnapp),T5,T6,c_,Ynil);
  T0 = CALL2(1,VARREF(YgooSmacrosYcat),T1,T4);
UNLINK_STACK();
  RET(T0);
...
LINK_STACK();
  ...
  next_metsF3668 = T4;
  T2 = CALL1(1,VARREF(Yhead),next_metsF3668);
  T3 = CALL1(1,VARREF(Ytail),next_metsF3668);
...
LINK_STACK();
  ...
  next_metsF3669 = T6;
  T4 = CALL1(1,VARREF(Yhead),next_metsF3669);
  T5 = CALL1(1,VARREF(Ytail),next_metsF3669);
...
LINK_STACK();
  ...
  LOOP_151: {
    P a151_0;
    T1 = CALL1(1,VARREF(YgooSmacrosYnulQ),handlersF3670);
    if (T1 != YPfalse) {
      T0 = YPfalse;
    } else {
      T9 = CALL1(1,VARREF(Yhead),handlersF3670);
      handlerF3671 = T9;
      T8 = CALL1(1,VARREF(Ytail),handlersF3670);
      remainingF3672 = T8;
      T4 = CALL1(1,VARREF(YgooSconditionsYhandler_condition_type),handlerF3671);
      T3 = CALL2(1,VARREF(YsubtypeQ),T4,type_);
      if (T3 != YPfalse) {
        T5 = CALL1(1,VARREF(YgooSconditionsYhandler_activeQ),handlerF3671);
        T2 = T5;
      } else {
        T2 = YPfalse;
      }
      if (T2 != YPfalse) {
        T6 = CALL1(0,f_,handlerF3671);
      } else {
      }
...
LINK_STACK();
  ...
  conditionF3675 = T14;
  T1 = CALL2(1,VARREF(YgooSconditionsYhandler_matchesQ),handler_,conditionF3675);
  T0 = CALL1(1,VARREF(Ynot),T1);
  if (T0 != YPfalse) {
    T2 = CALL3(1,VARREF(Yerror),LITREF(lit_233),handler_,conditionF3675);
  } else {
  }
  handlersF3676 = DYNREF(YgooSconditionsYTcurrent_handlersT);
  LOOP_152: {
    P a152_0;
    T4 = CALL1(1,VARREF(YgooSmacrosYnulQ),handlersF3676);
    if (T4 != YPfalse) {
      T5 = CALL2(1,VARREF(Yerror),LITREF(lit_234),handler_);
      T3 = T5;
    } else {
      T13 = CALL1(1,VARREF(Yhead),handlersF3676);
      currentF3677 = T13;
      T12 = CALL1(1,VARREF(Ytail),handlersF3676);
      remainingF3678 = T12;
      T7 = CALL2(1,VARREF(YgooSmacrosYEE),handler_,currentF3677);
      if (T7 != YPfalse) {
        T10 = CALL1(1,VARREF(YgooSconditionsYhandler_function),handler_);
        T9 = FUNFAB(fun_102,2,conditionF3675,remainingF3678);
        T8 = CALL2(1,T10,conditionF3675,T9);
        T6 = T8;
      } else {
        a152_0 = remainingF3678;
        handlersF3676 = a152_0;
        goto LOOP_152;
        T6 = T11;
      }
      T3 = T6;
...
LINK_STACK();
  ...
  nF3680 = T7;
  T3 = CALL2(1,VARREF(YgooSmagYL),nF3680,YPint((P)0));
  tmpF3681 = T3;
  if (tmpF3681 != YPfalse) {
    T0 = tmpF3681;
  } else {
    T2 = CALL1(1,VARREF(YgooStypesYlen),handlersF3679);
    T1 = CALL2(1,VARREF(YgooSmagYGE),nF3680,T2);
    T0 = T1;
  }
  if (T0 != YPfalse) {
    T4 = CALL2(1,VARREF(Yerror),LITREF(lit_238),nF3680);
  } else {
  }
  T6 = CALL2(1,VARREF(YgooSmacrosYelt),handlersF3679,nF3680);
