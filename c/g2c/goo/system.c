...
loop:
  ...
  fun_os_name_1 = YPmet(FUNCODEREF(fun_os_name_1),LITREF(lit_2),T2,ENVNUL,PNUL,YPfalse);
  ...
  fun_os_val_2 = YPmet(FUNCODEREF(fun_os_val_2),LITREF(lit_3),T7,ENVNUL,PNUL,YPfalse);
  ...
  fun_os_val_setter_3 = YPmet(FUNCODEREF(fun_os_val_setter_3),LITREF(lit_5),T12,ENVNUL,PNUL,YPfalse);
  ...
  fun_process_id_4 = YPmet(FUNCODEREF(fun_process_id_4),LITREF(lit_7),T17,ENVNUL,PNUL,YPfalse);
  ...
  fun_loop_5 = YPmet(FUNCODEREF(fun_loop_5),LITREF(lit_15),T30,ENVNUL,PNUL,YPfalse);
  T29 = YPsig(LITREF(lit_14),YPPlist(1,VARREF(YLstrG)),YPfalse,YPint((P)1),VARREF(YLstrG),Ynil);
  fun_base_path_6 = YPmet(FUNCODEREF(fun_base_path_6),LITREF(lit_13),T29,ENVNUL,PNUL,YPfalse);
  ...
  fun_fab_path_7 = YPmet(FUNCODEREF(fun_fab_path_7),LITREF(lit_18),T35,ENVNUL,PNUL,YPfalse);
  ...
  fun_add_src_path_8 = YPmet(FUNCODEREF(fun_add_src_path_8),LITREF(lit_29),T56,ENVNUL,PNUL,YPfalse);
  ...
  fun_add_goo_root_path_9 = YPmet(FUNCODEREF(fun_add_goo_root_path_9),LITREF(lit_32),T61,ENVNUL,PNUL,YPfalse);
  ...
  fun_add_goo_personal_root_path_10 = YPmet(FUNCODEREF(fun_add_goo_personal_root_path_10),LITREF(lit_34),T66,ENVNUL,PNUL,YPfalse);
  ...
  fun_add_tmp_path_11 = YPmet(FUNCODEREF(fun_add_tmp_path_11),LITREF(lit_36),T71,ENVNUL,PNUL,YPfalse);
  ...
  fun_add_build_path_12 = YPmet(FUNCODEREF(fun_add_build_path_12),LITREF(lit_39),T76,ENVNUL,PNUL,YPfalse);
  ...
  YgooSsystemYgoo_filenameQ = YPmet(FUNCODEREF(YgooSsystemYgoo_filenameQ),LITREF(lit_46),T81,ENVNUL,PNUL,YPfalse);
  ...
  YgooSsystemYgoo_filename = YPmet(FUNCODEREF(YgooSsystemYgoo_filename),LITREF(lit_48),T83,ENVNUL,PNUL,YPfalse);
  ...
  YgooSsystemYgooc_filenameQ = YPmet(FUNCODEREF(YgooSsystemYgooc_filenameQ),LITREF(lit_50),T85,ENVNUL,PNUL,YPfalse);
  ...
  YgooSsystemYgooc_filename = YPmet(FUNCODEREF(YgooSsystemYgooc_filename),LITREF(lit_52),T87,ENVNUL,PNUL,YPfalse);
  ...
  YgooSsystemYc_filename = YPmet(FUNCODEREF(YgooSsystemYc_filename),LITREF(lit_54),T89,ENVNUL,PNUL,YPfalse);
  ...
  YgooSsystemYobj_filename = YPmet(FUNCODEREF(YgooSsystemYobj_filename),LITREF(lit_56),T91,ENVNUL,PNUL,YPfalse);
  ...
  YgooSsystemYexe_filename = YPmet(FUNCODEREF(YgooSsystemYexe_filename),LITREF(lit_58),T93,ENVNUL,PNUL,YPfalse);
  ...
  fun_file_mtime_20 = YPmet(FUNCODEREF(fun_file_mtime_20),LITREF(lit_60),T95,ENVNUL,PNUL,YPfalse);
  ...
  YgooSsystemYfile_existsQ = YPmet(FUNCODEREF(YgooSsystemYfile_existsQ),LITREF(lit_62),T100,ENVNUL,PNUL,YPfalse);
  ...
  YgooSsystemYfile_type = YPmet(FUNCODEREF(YgooSsystemYfile_type),LITREF(lit_64),T102,ENVNUL,PNUL,YPfalse);
  ...
  YgooSsystemYcreate_directory = YPmet(FUNCODEREF(YgooSsystemYcreate_directory),LITREF(lit_66),T104,ENVNUL,PNUL,YPfalse);
  ...
  fun_loop_24 = YPmet(FUNCODEREF(fun_loop_24),LITREF(lit_15),T111,ENVNUL,PNUL,YPfalse);
  ...
  fun_file_copy_29 = YPmet(FUNCODEREF(fun_file_copy_29),LITREF(lit_68),T106,ENVNUL,PNUL,YPfalse);
  ...
  YgooSsystemYso_load = YPmet(FUNCODEREF(YgooSsystemYso_load),LITREF(lit_70),T116,ENVNUL,PNUL,YPfalse);
  ...
  YgooSsystemYpathname_error = YPmet(FUNCODEREF(YgooSsystemYpathname_error),LITREF(lit_73),T120,ENVNUL,PNUL,YPfalse);
  ...
  fun_32 = YPmet(FUNCODEREF(fun_32),YPfalse,T123,ENVNUL,PNUL,YPfalse);
  T122 = YPsig(LITREF(lit_76),YPPlist(1,VARREF(YLstrG)),YPfalse,YPint((P)1),VARREF(YLlstG),Ynil);
  YgooSsystemYpathname_to_components = YPmet(FUNCODEREF(YgooSsystemYpathname_to_components),LITREF(lit_75),T122,ENVNUL,PNUL,YPfalse);
  ...
  fun_34 = YPmet(FUNCODEREF(fun_34),YPfalse,T126,ENVNUL,PNUL,YPfalse);
  T125 = YPsig(LITREF(lit_85),YPPlist(1,VARREF(YLlstG)),YPfalse,YPint((P)1),VARREF(YLstrG),Ynil);
  YgooSsystemYcomponents_to_pathname = YPmet(FUNCODEREF(YgooSsystemYcomponents_to_pathname),LITREF(lit_84),T125,ENVNUL,PNUL,YPfalse);
  ...
  YgooSsystemYlabel_components = YPmet(FUNCODEREF(YgooSsystemYlabel_components),LITREF(lit_90),T128,ENVNUL,PNUL,YPfalse);
  ...
  YgooSsystemYhierarchical_components = YPmet(FUNCODEREF(YgooSsystemYhierarchical_components),LITREF(lit_92),T130,ENVNUL,PNUL,YPfalse);
  ...
  YgooSsystemYcomponents_last = YPmet(FUNCODEREF(YgooSsystemYcomponents_last),LITREF(lit_95),T132,ENVNUL,PNUL,YPfalse);
  ...
  YgooSsystemYcomponents_basename = YPmet(FUNCODEREF(YgooSsystemYcomponents_basename),LITREF(lit_98),T134,ENVNUL,PNUL,YPfalse);
  ...
  YgooSsystemYcomponents_parent_directory = YPmet(FUNCODEREF(YgooSsystemYcomponents_parent_directory),LITREF(lit_102),T136,ENVNUL,PNUL,YPfalse);
  ...
  YgooSsystemYparent_directory = YPmet(FUNCODEREF(YgooSsystemYparent_directory),LITREF(lit_106),T138,ENVNUL,PNUL,YPfalse);
  ...
  YgooSsystemYdirectory_error = YPmet(FUNCODEREF(YgooSsystemYdirectory_error),LITREF(lit_109),T143,ENVNUL,PNUL,YPfalse);
  ...
  fun_ensure_43 = YPmet(FUNCODEREF(fun_ensure_43),LITREF(lit_113),T146,ENVNUL,PNUL,YPfalse);
  T145 = YPsig(LITREF(lit_112),YPPlist(1,VARREF(YLstrG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  YgooSsystemYprobe_directory = YPmet(FUNCODEREF(YgooSsystemYprobe_directory),LITREF(lit_111),T145,ENVNUL,PNUL,YPfalse);
  ...
  T149 = YgooSsystemYfind_goo_file_at = YPmet(FUNCODEREF(YgooSsystemYfind_goo_file_at),LITREF(lit_118),T150,ENVNUL,PNUL,YPfalse);
...
loop:
  ...
  YgooSsystemYfind_goo_file_in_path = YPmet(FUNCODEREF(YgooSsystemYfind_goo_file_in_path),LITREF(lit_120),T0,ENVNUL,PNUL,YPfalse);
