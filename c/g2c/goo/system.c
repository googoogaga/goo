...
loop:
  ...
  resultF1544 = T1;
  T5 = CALL1(1,VARREF(YgooSmacrosYemptyQ),resultF1544);
  if (T5 != YPfalse) {
...
loop:
  ...
  lastF1545 = T1;
  T4 = CALL2(1,VARREF(YisaQ),lastF1545,VARREF(YLlstG));
  if (T4 != YPfalse) {
...
loop:
  ...
  hierF1547 = T3;
  T5 = CALL1(1,VARREF(YgooStypesYlen),hierF1547);
  countF1548 = T5;
  T7 = CALL1(1,VARREF(YgooSsystemYcomponents_last),hierF1547);
  lastF1549 = T7;
  T9 = CALL2(1,VARREF(YisaQ),lastF1549,VARREF(YLstrG));
  T8 = CALL1(1,VARREF(Ynot),T9);
  if (T8 != YPfalse) {
    T10 = CALL2(1,VARREF(Yerror),LITREF(lit_59),components_);
  } else {
  }
  T12 = CALL2(1,VARREF(YgooSmacrosYEE),countF1548,YPint((P)1));
  if (T12 != YPfalse) {
    T13 = CALL2(1,VARREF(YgooSmacrosYcat),labelF1546,LITREF(lit_60));
    T11 = T13;
  } else {
    T16 = CALL2(1,VARREF(YgooSmathY_),countF1548,YPint((P)1));
    T15 = CALL3(1,VARREF(YgooScolsSseqYsub),hierF1547,YPint((P)0),T16);
    T14 = CALL2(1,VARREF(YgooSmacrosYcat),labelF1546,T15);
    T11 = T14;
  }
  T6 = T11;
  T4 = T6;
...
loop:
  ...
  lastF1550 = T1;
  T3 = CALL2(1,VARREF(YisaQ),lastF1550,VARREF(YLstrG));
  if (T3 != YPfalse) {
    T4 = CALL1(1,VARREF(YgooSsystemYcomponents_basename),components_);
    T2 = T4;
  } else {
    T6 = CALL2(1,VARREF(YgooSmacrosYEE),lastF1550,LITREF(lit_43));
    if (T6 != YPfalse) {
...
loop:
  ...
  componentsF1551 = T1;
  T3 = CALL1(1,VARREF(YgooSsystemYcomponents_parent_directory),componentsF1551);
...
loop:
  ...
  nF1552 = T1;
  T4 = CALL1(1,VARREF(YgooSsystemYfile_existsQ),nF1552);
  if (T4 != YPfalse) {
    T8 = CALL1(1,VARREF(YgooSsystemYfile_type),nF1552);
    T7 = CALL2(1,VARREF(YgooSmacrosYEE),T8,LITREF(lit_68));
    T6 = CALL1(1,VARREF(Ynot),T7);
    if (T6 != YPfalse) {
      T9 = CALL2(1,VARREF(Yerror),LITREF(lit_69),nF1552);
      T5 = T9;
    } else {
      T5 = YPfalse;
    }
    ...
    if (T11 != YPfalse) {
      ...
      T14 = CALL1(1,VARREF(YgooSsystemYcreate_directory),nF1552);
      T10 = T14;
    } else {
      if (YPtrue != YPfalse) {
        T16 = CALL2(1,VARREF(Yerror),LITREF(lit_70),nF1552);
        T15 = T16;
      } else {
        T15 = YPfalse;
      }
...
loop:
  T1 = CALL1(1,VARREF(YgooSsystemYpathname_to_components),name_);
  componentsF1553 = T1;
  T3 = CALL1(1,VARREF(YgooSsystemYlabel_components),componentsF1553);
  labelF1554 = T3;
  T5 = CALL1(1,VARREF(YgooSsystemYhierarchical_components),componentsF1553);
  hierF1555 = T5;
  T6 = FUNSHELL(1,fun_ensure_27,2);
  ensureF1556 = T6;
  FUNINIT(ensureF1556, 2,labelF1554,ensureF1556);
  T7 = CALL1(0,ensureF1556,hierF1555);
  T4 = YPfalse;
  T2 = T4;
  T0 = T2;
UNLINK_STACK();
...
loop:
  ...
  env_rootF1557 = T34;
  T36 = CALL1(1,VARREF(YgooSmacrosYemptyQ),env_rootF1557);
  if (T36 != YPfalse) {
