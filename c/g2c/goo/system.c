...
loop:
  ...
  resultF1572 = T1;
  T5 = CALL1(1,VARREF(YgooSmacrosYemptyQ),resultF1572);
  if (T5 != YPfalse) {
...
loop:
  ...
  lastF1573 = T1;
  T4 = CALL2(1,VARREF(YisaQ),lastF1573,VARREF(YLlstG));
  if (T4 != YPfalse) {
...
loop:
  ...
  hierF1575 = T3;
  T5 = CALL1(1,VARREF(YgooStypesYlen),hierF1575);
  countF1576 = T5;
  T7 = CALL1(1,VARREF(YgooSsystemYcomponents_last),hierF1575);
  lastF1577 = T7;
  T9 = CALL2(1,VARREF(YisaQ),lastF1577,VARREF(YLstrG));
  T8 = CALL1(1,VARREF(Ynot),T9);
  if (T8 != YPfalse) {
    T10 = CALL2(1,VARREF(Yerror),LITREF(lit_59),components_);
  } else {
  }
  T12 = CALL2(1,VARREF(YgooSmacrosYEE),countF1576,YPint((P)1));
  if (T12 != YPfalse) {
    T13 = CALL2(1,VARREF(YgooSmacrosYcat),labelF1574,LITREF(lit_60));
    T11 = T13;
  } else {
    T16 = CALL2(1,VARREF(YgooSmathY_),countF1576,YPint((P)1));
    T15 = CALL3(1,VARREF(YgooScolsSseqYsub),hierF1575,YPint((P)0),T16);
    T14 = CALL2(1,VARREF(YgooSmacrosYcat),labelF1574,T15);
    T11 = T14;
  }
  T6 = T11;
  T4 = T6;
...
loop:
  ...
  lastF1578 = T1;
  T3 = CALL2(1,VARREF(YisaQ),lastF1578,VARREF(YLstrG));
  if (T3 != YPfalse) {
    T4 = CALL1(1,VARREF(YgooSsystemYcomponents_basename),components_);
    T2 = T4;
  } else {
    T6 = CALL2(1,VARREF(YgooSmacrosYEE),lastF1578,LITREF(lit_43));
    if (T6 != YPfalse) {
...
loop:
  ...
  componentsF1579 = T1;
  T3 = CALL1(1,VARREF(YgooSsystemYcomponents_parent_directory),componentsF1579);
...
loop:
  ...
  nF1580 = T1;
  T4 = CALL1(1,VARREF(YgooSsystemYfile_existsQ),nF1580);
  if (T4 != YPfalse) {
    T8 = CALL1(1,VARREF(YgooSsystemYfile_type),nF1580);
    T7 = CALL2(1,VARREF(YgooSmacrosYEE),T8,LITREF(lit_68));
    T6 = CALL1(1,VARREF(Ynot),T7);
    if (T6 != YPfalse) {
      T9 = CALL2(1,VARREF(Yerror),LITREF(lit_69),nF1580);
      T5 = T9;
    } else {
      T5 = YPfalse;
    }
    ...
    if (T11 != YPfalse) {
      ...
      T14 = CALL1(1,VARREF(YgooSsystemYcreate_directory),nF1580);
      T10 = T14;
    } else {
      if (YPtrue != YPfalse) {
        T16 = CALL2(1,VARREF(Yerror),LITREF(lit_70),nF1580);
        T15 = T16;
      } else {
        T15 = YPfalse;
      }
...
loop:
  T1 = CALL1(1,VARREF(YgooSsystemYpathname_to_components),name_);
  componentsF1581 = T1;
  T3 = CALL1(1,VARREF(YgooSsystemYlabel_components),componentsF1581);
  labelF1582 = T3;
  T5 = CALL1(1,VARREF(YgooSsystemYhierarchical_components),componentsF1581);
  hierF1583 = T5;
  T6 = FUNSHELL(1,fun_ensure_27,2);
  ensureF1584 = T6;
  FUNINIT(ensureF1584, 2,labelF1582,ensureF1584);
  T7 = CALL1(0,ensureF1584,hierF1583);
  T4 = YPfalse;
  T2 = T4;
  T0 = T2;
UNLINK_STACK();
...
loop:
  ...
  env_rootF1585 = T34;
  T36 = CALL1(1,VARREF(YgooSmacrosYemptyQ),env_rootF1585);
  if (T36 != YPfalse) {
