...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    expF2075 = T4;
    T6 = CALL2(1,VARREF(YgooSmacrosYEE),expF2075,pat_);
    if (T6 != YPfalse) {
      T7 = CALL1(1,VARREF(Ytail),x_);
      T5 = T7;
    } else {
      T8 = CALL3(1,fail_,LITREF(lit_9),expF2075,pat_);
      T5 = T8;
    }
    T3 = T5;
    T0 = T3;
...
loop:
  ...
  xF2076 = T1;
  T3 = CALL2(1,VARREF(YisaQ),xF2076,VARREF(YLlstG));
  if (T3 != YPfalse) {
    T2 = xF2076;
  } else {
    T4 = CALL2(1,fail_,LITREF(lit_12),xF2076);
    T2 = T4;
  }
  T0 = T2;
UNLINK_STACK();
...
loop:
  ...
  savedcurriedF2077 = T1;
  T2 = FUNFAB(fun_15,2,f_,savedcurriedF2077);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  T1 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLtupG),curried_);
  savedcurriedF2078 = T1;
  T2 = FUNFAB(fun_17,2,f_,savedcurriedF2078);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    symF2080 = T4;
    T5 = CALL1(1,VARREF(Ysym_name),symF2080);
    CALL3(1,VARREF(YgooScolsScolxYelt_setter),symF2080,VARREF(YgooSruntimeYsymbols),T5);
...
loop:
  ...
  bootF2081 = T1;
  FUNINIT(bootF2081, 1,bootF2081);
  T2 = CALL1(0,bootF2081,VARREF(YPsymbols));
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  YgooSmacrosYmatch_unquote = YPmet(FUNCODEREF(YgooSmacrosYmatch_unquote),LITREF(lit_3),T2,ENVNUL,PNUL,YPfalse);
  ...
  fun_cat_sym_5 = YPmet(FUNCODEREF(fun_cat_sym_5),LITREF(lit_13),T8,ENVNUL,PNUL,YPfalse);
  ...
  fun_gensym_6 = YPmet(FUNCODEREF(fun_gensym_6),LITREF(lit_17),T14,ENVNUL,PNUL,YPfalse);
  ...
  fun_fab_setter_name_7 = YPmet(FUNCODEREF(fun_fab_setter_name_7),LITREF(lit_20),T19,ENVNUL,PNUL,YPfalse);
  ...
  fun_var_name_8 = YPmet(FUNCODEREF(fun_var_name_8),LITREF(lit_23),T24,ENVNUL,PNUL,YPfalse);
  ...
  fun_var_name_9 = YPmet(FUNCODEREF(fun_var_name_9),LITREF(lit_23),T29,ENVNUL,PNUL,YPfalse);
  ...
  fun_var_type_10 = YPmet(FUNCODEREF(fun_var_type_10),LITREF(lit_26),T34,ENVNUL,PNUL,YPfalse);
  ...
  fun_var_type_11 = YPmet(FUNCODEREF(fun_var_type_11),LITREF(lit_26),T39,ENVNUL,PNUL,YPfalse);
  ...
  fun_identity_12 = YPmet(FUNCODEREF(fun_identity_12),LITREF(lit_30),T44,ENVNUL,PNUL,YPfalse);
  ...
  fun_compose_14 = YPmet(FUNCODEREF(fun_compose_14),LITREF(lit_32),T49,ENVNUL,PNUL,YPfalse);
  ...
  fun_rcurry_16 = YPmet(FUNCODEREF(fun_rcurry_16),LITREF(lit_35),T55,ENVNUL,PNUL,YPfalse);
  ...
  fun_curry_18 = YPmet(FUNCODEREF(fun_curry_18),LITREF(lit_38),T61,ENVNUL,PNUL,YPfalse);
  ...
  fun_always_20 = YPmet(FUNCODEREF(fun_always_20),LITREF(lit_41),T67,ENVNUL,PNUL,YPfalse);
  ...
  fun_zipped_22 = YPmet(FUNCODEREF(fun_zipped_22),LITREF(lit_44),T73,ENVNUL,PNUL,YPfalse);
  ...
  YgooSruntimeYloc_val = YPmet(FUNCODEREF(YgooSruntimeYloc_val),LITREF(lit_47),T79,ENVNUL,PNUL,YPfalse);
  ...
  YgooSruntimeYloc_val_setter = YPmet(FUNCODEREF(YgooSruntimeYloc_val_setter),LITREF(lit_49),T81,ENVNUL,PNUL,YPfalse);
  ...
  YgooSruntimeYapp_filename = YPmet(FUNCODEREF(YgooSruntimeYapp_filename),LITREF(lit_51),T83,ENVNUL,PNUL,YPfalse);
  ...
  YgooSruntimeYapp_args = YPmet(FUNCODEREF(YgooSruntimeYapp_args),LITREF(lit_52),T85,ENVNUL,PNUL,YPfalse);
  ...
  YgooSruntimeYbooted_fab_sym = YPmet(FUNCODEREF(YgooSruntimeYbooted_fab_sym),LITREF(lit_53),T88,ENVNUL,PNUL,YPfalse);
  ...
  fun_boot_28 = YPmet(FUNCODEREF(fun_boot_28),LITREF(lit_56),T91,ENVNUL,PNUL,YPfalse);
  T90 = YPsig(LITREF(lit_18),Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  YgooSruntimeYboot_symbols = YPmet(FUNCODEREF(YgooSruntimeYboot_symbols),LITREF(lit_55),T90,ENVNUL,PNUL,YPfalse);
