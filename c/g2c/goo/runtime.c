...
LINK_STACK();
  ...
  if (T1 != YPfalse) {
    ...
    expF2355 = T4;
    T6 = CALL2(1,VARREF(YgooSmacrosYEE),expF2355,pat_);
    if (T6 != YPfalse) {
      T7 = CALL1(1,VARREF(Ytail),x_);
      T5 = T7;
    } else {
      T8 = CALL3(1,fail_,LITREF(lit_9),expF2355,pat_);
      T5 = T8;
    }
    T3 = T5;
    T0 = T3;
...
LINK_STACK();
  ...
  xF2356 = T1;
  T3 = CALL2(1,VARREF(YisaQ),xF2356,VARREF(YLlstG));
  if (T3 != YPfalse) {
    T2 = xF2356;
  } else {
    T4 = CALL2(1,fail_,LITREF(lit_12),xF2356);
    T2 = T4;
  }
  T0 = T2;
UNLINK_STACK();
...
LINK_STACK();
  ...
  savedcurriedF2357 = T1;
  T2 = FUNFAB(fun_15,2,f_,savedcurriedF2357);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ...
  NARGS(curried_, 1);
  T1 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLtupG),curried_);
  savedcurriedF2358 = T1;
  T2 = FUNFAB(fun_17,2,f_,savedcurriedF2358);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  symsF2360 = VARREF(YPsymbols);
  for (;;) {
    P a143_0;
  loop143:
    T5 = CALL1(1,VARREF(YgooSmacrosYemptyQ),symsF2360);
    T4 = CALL1(1,VARREF(Ynot),T5);
    if (T4 != YPfalse) {
      T7 = CALL1(1,VARREF(Yhead),symsF2360);
      symF2361 = T7;
      T8 = CALL1(1,VARREF(Ysym_name),symF2361);
      CALL3(1,VARREF(YgooScolsScolxYelt_setter),symF2361,VARREF(YgooSruntimeYsymbols),T8);
      T10 = CALL1(1,VARREF(Ytail),symsF2360);
      a143_0 = T10;
      symsF2360 = a143_0;
      goto loop143;
      T6 = T9;
