...
LINK_STACK();
  symsF8621 = VARREF(YPsymbols);
  LOOP_398: {
    P a398_0;
    T2 = CALL1(1,VARREF(YgooSmacrosYemptyQ),symsF8621);
    T1 = CALL1(1,VARREF(Ynot),T2);
    if (T1 != YPfalse) {
      T6 = CALL1(1,VARREF(Yhead),symsF8621);
      symF8622 = T6;
      T3 = CALL1(1,VARREF(Ysym_name),symF8622);
      CALL3(1,VARREF(YgooScolsScolxYelt_setter),symF8622,VARREF(YgooSsymYsymbols),T3);
      T5 = CALL1(1,VARREF(Ytail),symsF8621);
      a398_0 = T5;
      symsF8621 = a398_0;
      goto LOOP_398;
      T0 = T4;
...
DEFCREGS();
  ...
  YgooSsymYbooted_fab_sym = YPmet(FUNCODEREF(YgooSsymYbooted_fab_sym),LITREF(lit_0),T1,ENVNUL,PNUL,sloc(22));
  T2 = YgooSsymYbooted_fab_sym;
  VARSET(YgooSsymYbooted_fab_sym,T2);
  lit_2 = YPPsym((P)"boot-symbols");
  lit_3 = Ynil;
  T3 = YPsig(LITREF(lit_3),Ynil,YPfalse,YPint((P)0),VARREF(YLanyG),Ynil);
  YgooSsymYboot_symbols = YPmet(FUNCODEREF(YgooSsymYboot_symbols),LITREF(lit_2),T3,ENVNUL,PNUL,sloc(26));
  T4 = YgooSsymYboot_symbols;
  VARSET(YgooSsymYboot_symbols,T4);
  XCALL0(1,VARREF(YgooSsymYboot_symbols));
  T6 = VARSET(Yfab_sym,VARREF(YgooSsymYbooted_fab_sym));
  T5 = T6;
  return T5;
}
