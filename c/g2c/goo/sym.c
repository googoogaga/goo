...
LINK_STACK();
  symsF3714 = VARREF(YPsymbols);
  LOOP_148: {
    P a148_0;
    T2 = CALL1(1,VARREF(YgooSmacrosYnulQ),symsF3714);
    T1 = CALL1(1,VARREF(Ynot),T2);
    if (T1 != YPfalse) {
      T6 = CALL1(1,VARREF(Yhead),symsF3714);
      symF3715 = T6;
      T3 = CALL1(1,VARREF(Ysym_name),symF3715);
      CALL3(1,VARREF(YgooScolsScolxYelt_setter),symF3715,VARREF(YgooSsymYsymbols),T3);
      T5 = CALL1(1,VARREF(Ytail),symsF3714);
      a148_0 = T5;
      symsF3714 = a148_0;
      goto LOOP_148;
      T0 = T4;
