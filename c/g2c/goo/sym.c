...
LINK_STACK();
  symsF3614 = VARREF(YPsymbols);
  LOOP_149: {
    P a149_0;
    T2 = CALL1(1,VARREF(YgooSmacrosYnulQ),symsF3614);
    T1 = CALL1(1,VARREF(Ynot),T2);
    if (T1 != YPfalse) {
      T6 = CALL1(1,VARREF(Yhead),symsF3614);
      symF3615 = T6;
      T3 = CALL1(1,VARREF(Ysym_name),symF3615);
      CALL3(1,VARREF(YgooScolsScolxYelt_setter),symF3615,VARREF(YgooSsymYsymbols),T3);
      T5 = CALL1(1,VARREF(Ytail),symsF3614);
      a149_0 = T5;
      symsF3614 = a149_0;
      goto LOOP_149;
      T0 = T4;
