...
LINK_STACK();
  ...
  xF2933 = i_;
  xF2934 = xF2933;
  T2 = (P)YPiGG(xF2934,(P)2);
  xF2935 = T2;
  xF2936 = xF2935;
  tF2937 = (P)2;
  T1 = (P)YPiLL(xF2936,(P)2);
  T0 = (P)YPiv(T1,tF2937);
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ...
  xF2938 = c_;
  xF2939 = xF2938;
  T2 = (P)YPiGG(xF2939,(P)2);
  xF2940 = T2;
  xF2941 = xF2940;
  tF2942 = (P)1;
  T1 = (P)YPiLL(xF2941,(P)2);
  T0 = (P)YPiv(T1,tF2942);
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ...
  xF2943 = x_;
  xF2944 = xF2943;
  T2 = (P)YPiGG(xF2944,(P)2);
  xF2945 = y_;
  xF2946 = xF2945;
  T3 = (P)YPiGG(xF2946,(P)2);
  T1 = (P)YPcL(T2,T3);
  T0 = (P)YPbb(T1);
UNLINK_STACK();
  RET(T0);
...
LINK_STACK();
  ...
  xF2947 = x_;
  xF2948 = xF2947;
  T2 = (P)YPiGG(xF2948,(P)2);
  xF2949 = y_;
  xF2950 = xF2949;
  T3 = (P)YPiGG(xF2950,(P)2);
  T1 = (P)YPcE(T2,T3);
  T0 = (P)YPbb(T1);
UNLINK_STACK();
  RET(T0);
...
LINK_STACK();
  ...
  T1 = CALL2(1,VARREF(YgooSmagYGE),codeF2951,T2);
  if (T1 != YPfalse) {
    T4 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLfixnumG),YPchr((P)122));
    T3 = CALL2(1,VARREF(YgooSmagYLE),codeF2951,T4);
    T0 = T3;
  } else {
    T0 = YPfalse;
  }
...
LINK_STACK();
  ...
  T1 = CALL2(1,VARREF(YgooSmagYGE),codeF2952,T2);
  if (T1 != YPfalse) {
    T4 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLfixnumG),YPchr((P)90));
    T3 = CALL2(1,VARREF(YgooSmagYLE),codeF2952,T4);
    T0 = T3;
  } else {
    T0 = YPfalse;
  }
