...
LINK_STACK();
  ...
  if (T1 != YPfalse) {
    ...
    T2 = CALL2(1,VARREF(YgooSmacrosYpair),varF3838,T3);
...
LINK_STACK();
  ...
  x_1448F3841 = T52;
  FUNINIT(x_1448F3841, 2,FREEREF(0),return_);
  x_1447F3842 = FREEREF(0);
  fF3843 = YPfalse;
  argsF3844 = YPfalse;
  T2 = CALL2(1,VARREF(YisaQ),x_1447F3842,VARREF(YLlstG));
  if (T2 != YPfalse) {
    T9 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1447F3842,LITREF(lit_4),x_1448F3841);
    x_1447F3845 = T9;
    T7 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1447F3845,x_1448F3841);
    fF3843 = T7;
    T8 = CALL1(1,VARREF(Ytail),x_1447F3845);
    x_1447F3846 = T8;
    argsF3844 = x_1447F3846;
    x_1447F3847 = Ynil;
    T5 = CALL2(1,VARREF(YgooSmacrosYmatch_sublist),x_1447F3847,x_1448F3841);
    x_1447F3848 = T5;
    T4 = CALL2(1,VARREF(YgooSmacrosYmatch_nul_list),x_1447F3848,x_1448F3841);
    T6 = CALL1(1,VARREF(Ytail),x_1447F3847);
    x_1447F3849 = T6;
    T3 = CALL2(1,VARREF(YgooSmacrosYmatch_nul_list),x_1447F3849,x_1448F3841);
  } else {
    T10 = CALL2(1,x_1448F3841,LITREF(lit_5),x_1447F3842);
  }
  T49 = fun_splice_2;
  spliceF3850 = T49;
  ...
  walk_opF3852 = T51;
  FUNINIT(rest_opQF3851, 1,rest_opQF3851);
  FUNINIT(walk_opF3852, 2,walk_opF3852,spliceF3850);
  T13 = argsF3844;
  ...
  if (T12 != YPfalse) {
    ...
    T43 = CALL2(1,walk_opF3852,varsF3853,T44);
    exprF3854 = T43;
    T39 = CALL1(1,VARREF(Ytail),varsF3853);
    T38 = CALL1(1,VARREF(YgooSmacrosYrevX),T39);
    T42 = argsF3844;
    T41 = CALL1(0,rest_opQF3851,T42);
    if (T41 != YPfalse) {
      T40 = LITREF(lit_27);
    } else {
      T40 = Ynil;
    ...
    T35 = CALL1(1,VARREF(Ylst),argsF3855);
    T36 = CALL1(1,VARREF(Ylst),exprF3854);
...
LINK_STACK();
  ...
  if (T1 != YPfalse) {
    ...
    expF3856 = T7;
    T4 = CALL2(1,VARREF(YgooSmacrosYEE),expF3856,pat_);
    if (T4 != YPfalse) {
      T5 = CALL1(1,VARREF(Ytail),x_);
      T3 = T5;
    } else {
      T6 = CALL3(1,fail_,LITREF(lit_37),expF3856,pat_);
      T3 = T6;
    }
    T0 = T3;
  }
...
LINK_STACK();
  ...
  T3 = CALL1(1,VARREF(Yhead),x_);
  xF3857 = T3;
  T1 = CALL2(1,VARREF(YisaQ),xF3857,VARREF(YLlstG));
  if (T1 != YPfalse) {
    T0 = xF3857;
  } else {
    T2 = CALL2(1,fail_,LITREF(lit_40),xF3857);
    T0 = T2;
  }
UNLINK_STACK();
  QRET(T0);
