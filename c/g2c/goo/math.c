...
loop:
  ...
  T3 = CALL2(1,VARREF(YprotoSmagnitudesYGE),codeF844,T4);
  if (T3 != YPfalse) {
    T6 = CALL2(1,VARREF(YprotoStypesYas),VARREF(YLintG),YPchr((P)122));
    T5 = CALL2(1,VARREF(YprotoSmagnitudesYLE),codeF844,T6);
    T2 = T5;
  } else {
    T2 = YPfalse;
  }
...
loop:
  ...
  T3 = CALL2(1,VARREF(YprotoSmagnitudesYGE),codeF845,T4);
  if (T3 != YPfalse) {
    T6 = CALL2(1,VARREF(YprotoStypesYas),VARREF(YLintG),YPchr((P)90));
    T5 = CALL2(1,VARREF(YprotoSmagnitudesYLE),codeF845,T6);
    T2 = T5;
  } else {
    T2 = YPfalse;
  }
...
loop:
  ...
  typeF850 = T1;
  T3 = CALL2(1,VARREF(YprotoStypesYas),typeF850,x_);
  T4 = CALL2(1,VARREF(YprotoStypesYas),typeF850,y_);
  T2 = CALL2(1,f_,T3,T4);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    fF851 = T4;
    T8 = CALL2(1,VARREF(YprotoSmathYT),x_,fF851);
    T7 = CALL1(1,VARREF(YprotoSmathYround),T8);
    T6 = CALL2(1,VARREF(YprotoSmathYS),T7,fF851);
    T5 = CALL1(1,x_,T6);
    T3 = T5;
    T0 = T3;
  }
...
loop:
  ...
  tup19F852 = T1;
  T3 = CALL2(1,VARREF(YmacrosYelt),tup19F852,YPint((P)0));
  check_type(T3,VARREF(YLintG));
  integerF853 = T3;
  T5 = CALL2(1,VARREF(YmacrosYelt),tup19F852,YPint((P)1));
  check_type(T5,VARREF(YLnumG));
  remainderF854 = T5;
  T9 = CALL1(1,VARREF(YprotoSmathYzeroQ),remainderF854);
  ...
  T7 = T10;
  if (T7 != YPfalse) {
    T16 = CALL2(1,VARREF(YprotoSmathY_),integerF853,YPint((P)1));
    T17 = CALL2(1,VARREF(YprotoSmathYA),remainderF854,divisor_);
    T15 = CALL2(1,VARREF(Ytup),T16,T17);
    T6 = T15;
  } else {
    T18 = CALL2(1,VARREF(Ytup),integerF853,remainderF854);
    T6 = T18;
  }
  T4 = T6;
  T2 = T4;
...
loop:
  T1 = CALL2(1,VARREF(YprotoSmathYtruncS),real_,divisor_);
  tup20F856 = T1;
  T3 = CALL2(1,VARREF(YmacrosYelt),tup20F856,YPint((P)0));
  check_type(T3,VARREF(YLintG));
  integerF857 = T3;
  T5 = CALL2(1,VARREF(YmacrosYelt),tup20F856,YPint((P)1));
  check_type(T5,VARREF(YLnumG));
  remainderF858 = T5;
  T9 = CALL1(1,VARREF(YprotoSmathYzeroQ),remainderF858);
  T8 = CALL1(1,VARREF(Ynot),T9);
  tmpF859 = T8;
  if (tmpF859 != YPfalse) {
    T12 = CALL1(1,VARREF(YprotoSmathYnegQ),divisor_);
  ...
  T7 = T10;
  if (T7 != YPfalse) {
    T16 = CALL2(1,VARREF(YprotoSmathYA),integerF857,YPint((P)1));
    T17 = CALL2(1,VARREF(YprotoSmathY_),remainderF858,divisor_);
    T15 = CALL2(1,VARREF(Ytup),T16,T17);
    T6 = T15;
  } else {
    T18 = CALL2(1,VARREF(Ytup),integerF857,remainderF858);
    T6 = T18;
  }
  T4 = T6;
  T2 = T4;
...
loop:
  T1 = CALL2(1,VARREF(YprotoSmathYtruncS),real_,divisor_);
  tup21F860 = T1;
  T3 = CALL2(1,VARREF(YmacrosYelt),tup21F860,YPint((P)0));
  check_type(T3,VARREF(YLintG));
  integerF861 = T3;
  T5 = CALL2(1,VARREF(YmacrosYelt),tup21F860,YPint((P)1));
  check_type(T5,VARREF(YLnumG));
  remainderF862 = T5;
  ...
  thresholdF863 = T7;
  T11 = CALL2(1,VARREF(YprotoSmagnitudesYG),remainderF862,thresholdF863);
  tmpF864 = T11;
  if (tmpF864 != YPfalse) {
    T12 = tmpF864;
  } else {
    T14 = CALL2(1,VARREF(YprotoSmathYE),remainderF862,thresholdF863);
    tmpF865 = T14;
    if (tmpF865 != YPfalse) {
      T16 = CALL1(1,VARREF(YprotoSmathYoddQ),integerF861);
      T15 = T16;
    } else {
      T15 = YPfalse;
    }
  ...
  if (T10 != YPfalse) {
    ...
    if (T18 != YPfalse) {
      T20 = CALL2(1,VARREF(YprotoSmathY_),integerF861,YPint((P)1));
      T21 = CALL2(1,VARREF(YprotoSmathYA),remainderF862,divisor_);
      T19 = CALL2(1,VARREF(Ytup),T20,T21);
      T17 = T19;
    } else {
      T23 = CALL2(1,VARREF(YprotoSmathYA),integerF861,YPint((P)1));
      T24 = CALL2(1,VARREF(YprotoSmathY_),remainderF862,divisor_);
      T22 = CALL2(1,VARREF(Ytup),T23,T24);
      T17 = T22;
    }
    T9 = T17;
  } else {
    T27 = CALL1(1,VARREF(YprotoSmathYneg),thresholdF863);
    minus_thresholdF866 = T27;
    T29 = CALL2(1,VARREF(YprotoSmagnitudesYL),remainderF862,minus_thresholdF866);
    tmpF867 = T29;
    if (tmpF867 != YPfalse) {
      T30 = tmpF867;
    } else {
      T32 = CALL2(1,VARREF(YprotoSmathYE),remainderF862,minus_thresholdF866);
      tmpF868 = T32;
      if (tmpF868 != YPfalse) {
        T34 = CALL1(1,VARREF(YprotoSmathYoddQ),integerF861);
        T33 = T34;
      } else {
        T33 = YPfalse;
      }
    ...
    if (T26 != YPfalse) {
      ...
      if (T36 != YPfalse) {
        T38 = CALL2(1,VARREF(YprotoSmathYA),integerF861,YPint((P)1));
        T39 = CALL2(1,VARREF(YprotoSmathY_),remainderF862,divisor_);
        T37 = CALL2(1,VARREF(Ytup),T38,T39);
        T35 = T37;
      } else {
        T41 = CALL2(1,VARREF(YprotoSmathY_),integerF861,YPint((P)1));
        T42 = CALL2(1,VARREF(YprotoSmathYA),remainderF862,divisor_);
        T40 = CALL2(1,VARREF(Ytup),T41,T42);
        T35 = T40;
      }
      T25 = T35;
    } else {
      T43 = CALL2(1,VARREF(Ytup),integerF861,remainderF862);
      T25 = T43;
    }
    T9 = T25;
  }
...
loop:
  ...
  tup22F869 = T1;
  T3 = CALL2(1,VARREF(YmacrosYelt),tup22F869,YPint((P)0));
  UF870 = T3;
  T5 = CALL2(1,VARREF(YmacrosYelt),tup22F869,YPint((P)1));
  check_type(T5,VARREF(YLnumG));
  remainderF871 = T5;
  T4 = remainderF871;
  T2 = T4;
...
loop:
  T1 = CALL2(1,VARREF(YprotoSmathYtruncS),real_,divisor_);
  tup23F872 = T1;
  T3 = CALL2(1,VARREF(YmacrosYelt),tup23F872,YPint((P)0));
  UF873 = T3;
  T5 = CALL2(1,VARREF(YmacrosYelt),tup23F872,YPint((P)1));
  check_type(T5,VARREF(YLnumG));
  remainderF874 = T5;
  T4 = remainderF874;
  T2 = T4;
...
loop:
  ...
  T1 = (P)YPib(T2);
  resultF875 = T1;
  T7 = CALL2(1,VARREF(YprotoSmathYT),resultF875,y_);
  T6 = CALL2(1,VARREF(YprotoSmathY_),x_,T7);
  T5 = CALL2(1,VARREF(Ytup),resultF875,T6);
  T0 = T5;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  T1 = (P)YPib(T2);
  resF876 = T1;
  T6 = CALL2(1,VARREF(YprotoSmagnitudesYL),resF876,YPint((P)0));
  if (T6 != YPfalse) {
    T8 = CALL2(1,VARREF(YprotoSmagnitudesYG),y_,YPint((P)0));
    if (T8 != YPfalse) {
      T9 = CALL2(1,VARREF(YprotoSmathYA),resF876,y_);
      T7 = T9;
    } else {
      T10 = CALL2(1,VARREF(YprotoSmathY_),resF876,y_);
      T7 = T10;
    }
    T5 = T7;
  } else {
    ...
    if (T6 != YPfalse) {
      ...
      if (T9 != YPfalse) {
        ...
        if (YPtrue != YPfalse) {
          ...
          T20 = CALL3(1,loopF877,T21,T24,T25);
          T18 = T20;
          T17 = T18;
        } else {
          T17 = YPfalse;
...
loop:
  ...
  searchF878 = T1;
  FUNINIT(searchF878, 2,x_,searchF878);
  T2 = CALL1(1,searchF878,YPint((P)1));
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  dividedF879 = T1;
  T5 = (P)YPfu(dividedF879);
  T4 = (P)YPft(T5);
  T3 = (P)YPib(T4);
  resultF880 = T3;
  T9 = CALL2(1,VARREF(YprotoStypesYas),VARREF(YLfloG),resultF880);
  T8 = CALL2(1,VARREF(YprotoSmathY_),dividedF879,T9);
  T7 = CALL2(1,VARREF(YprotoSmathYT),y_,T8);
  T6 = CALL2(1,VARREF(Ytup),resultF880,T7);
  T2 = T6;
  T0 = T2;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  T7 = T9;
  if (T7 != YPfalse) {
    T11 = CALL1(1,VARREF(YprotoSmathYneg),resF881);
    T6 = T11;
  } else {
    T6 = resF881;
  }
...
loop:
  ...
  x_1278F883 = T1;
  FUNINIT(x_1278F883, 1,return_);
  x_1277F884 = FREEREF(0);
  nameF885 = YPfalse;
  nameF885 = BOXFAB(nameF885);
  paramF886 = YPfalse;
  paramF886 = BOXFAB(paramF886);
  prefixF887 = YPfalse;
  prefixF887 = BOXFAB(prefixF887);
  T9 = CALL2(1,VARREF(YisaQ),x_1277F884,VARREF(YLlstG));
  if (T9 != YPfalse) {
    T11 = CALL3(1,VARREF(YmacrosYmatch_atom),x_1277F884,LITREF(lit_91),x_1278F883);
    x_1277F888 = T11;
    T13 = CALL2(1,VARREF(YmacrosYmatch_unquote),x_1277F888,x_1278F883);
    BOXVAL(nameF885) = T13;
    T14 = CALL1(1,VARREF(Ytail),x_1277F888);
    x_1277F889 = T14;
    T16 = CALL2(1,VARREF(YmacrosYmatch_sublist),x_1277F889,x_1278F883);
    x_1277F890 = T16;
    T18 = CALL2(1,VARREF(YmacrosYmatch_unquote),x_1277F890,x_1278F883);
    BOXVAL(paramF886) = T18;
    T19 = CALL1(1,VARREF(Ytail),x_1277F890);
    x_1277F891 = T19;
    T20 = CALL2(1,VARREF(YmacrosYmatch_empty_list),x_1277F891,x_1278F883);
    T17 = T20;
    T21 = CALL1(1,VARREF(Ytail),x_1277F889);
    x_1277F892 = T21;
    BOXVAL(prefixF887) = x_1277F892;
    x_1277F893 = Ynil;
    T23 = CALL2(1,VARREF(YmacrosYmatch_empty_list),x_1277F893,x_1278F883);
    T22 = T23;
    T15 = T22;
    T12 = T15;
    T10 = T12;
  } else {
    T24 = CALL2(1,x_1278F883,LITREF(lit_92),x_1277F884);
  }
  T27 = BOXVAL(nameF885);
