...
loop:
  xF1385 = i_;
  xF1386 = xF1385;
  T3 = (P)YPiGG(xF1386,(P)2);
  T2 = T3;
  T1 = T2;
  xF1387 = T1;
  xF1388 = xF1387;
  tF1389 = (P)2;
  T6 = (P)YPiLL(xF1388,(P)2);
  T5 = (P)YPiv(T6,tF1389);
  T4 = T5;
  T0 = T4;
UNLINK_STACK();
...
loop:
  xF1390 = c_;
  xF1391 = xF1390;
  T3 = (P)YPiGG(xF1391,(P)2);
  T2 = T3;
  T1 = T2;
  xF1392 = T1;
  xF1393 = xF1392;
  tF1394 = (P)1;
  T6 = (P)YPiLL(xF1393,(P)2);
  T5 = (P)YPiv(T6,tF1394);
  T4 = T5;
  T0 = T4;
UNLINK_STACK();
...
loop:
  xF1395 = x_;
  xF1396 = xF1395;
  T4 = (P)YPiGG(xF1396,(P)2);
  T3 = T4;
  T2 = T3;
  xF1397 = y_;
  xF1398 = xF1397;
  T7 = (P)YPiGG(xF1398,(P)2);
  T6 = T7;
  T5 = T6;
  T1 = (P)YPcL(T2,T5);
  T0 = (P)YPbb(T1);
...
loop:
  xF1399 = x_;
  xF1400 = xF1399;
  T4 = (P)YPiGG(xF1400,(P)2);
  T3 = T4;
  T2 = T3;
  xF1401 = y_;
  xF1402 = xF1401;
  T7 = (P)YPiGG(xF1402,(P)2);
  T6 = T7;
  T5 = T6;
  T1 = (P)YPcE(T2,T5);
  T0 = (P)YPbb(T1);
...
loop:
  ...
  T3 = CALL2(1,VARREF(YgooSmagYGE),codeF1403,T4);
  if (T3 != YPfalse) {
    T6 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLfixnumG),YPchr((P)122));
    T5 = CALL2(1,VARREF(YgooSmagYLE),codeF1403,T6);
    T2 = T5;
  } else {
    T2 = YPfalse;
  }
...
loop:
  ...
  T3 = CALL2(1,VARREF(YgooSmagYGE),codeF1404,T4);
  if (T3 != YPfalse) {
    T6 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLfixnumG),YPchr((P)90));
    T5 = CALL2(1,VARREF(YgooSmagYLE),codeF1404,T6);
    T2 = T5;
  } else {
    T2 = YPfalse;
  }
...
loop:
  ...
  typeF1414 = T1;
  T3 = CALL2(1,VARREF(YgooStypesYas),typeF1414,x_);
  T4 = CALL2(1,VARREF(YgooStypesYas),typeF1414,y_);
  T2 = CALL2(1,f_,T3,T4);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    fF1415 = T4;
    T8 = CALL2(1,VARREF(YgooSmathYT),x_,fF1415);
    T7 = CALL1(1,VARREF(YgooSmathYround),T8);
    T6 = CALL2(1,VARREF(YgooSmathYS),T7,fF1415);
    T5 = CALL1(1,x_,T6);
    T3 = T5;
    T0 = T3;
  }
...
loop:
  ...
  tup19F1416 = T1;
  T3 = CALL2(1,VARREF(YgooSmacrosYelt),tup19F1416,YPint((P)0));
  check_type(T3,VARREF(YLintG));
  integerF1417 = T3;
  T5 = CALL2(1,VARREF(YgooSmacrosYelt),tup19F1416,YPint((P)1));
  check_type(T5,VARREF(YLnumG));
  remainderF1418 = T5;
  T9 = CALL1(1,VARREF(YgooSmathYzeroQ),remainderF1418);
  ...
  T7 = T10;
  if (T7 != YPfalse) {
    T16 = CALL2(1,VARREF(YgooSmathY_),integerF1417,YPint((P)1));
    T17 = CALL2(1,VARREF(YgooSmathYA),remainderF1418,divisor_);
    T15 = CALL2(1,VARREF(Ytup),T16,T17);
    T6 = T15;
  } else {
    T18 = CALL2(1,VARREF(Ytup),integerF1417,remainderF1418);
    T6 = T18;
  }
  T4 = T6;
  T2 = T4;
...
loop:
  T1 = CALL2(1,VARREF(YgooSmathYtruncS),real_,divisor_);
  tup20F1420 = T1;
  T3 = CALL2(1,VARREF(YgooSmacrosYelt),tup20F1420,YPint((P)0));
  check_type(T3,VARREF(YLintG));
  integerF1421 = T3;
  T5 = CALL2(1,VARREF(YgooSmacrosYelt),tup20F1420,YPint((P)1));
  check_type(T5,VARREF(YLnumG));
  remainderF1422 = T5;
  T9 = CALL1(1,VARREF(YgooSmathYzeroQ),remainderF1422);
  T8 = CALL1(1,VARREF(Ynot),T9);
  tmpF1423 = T8;
  if (tmpF1423 != YPfalse) {
    T12 = CALL1(1,VARREF(YgooSmathYnegQ),divisor_);
  ...
  T7 = T10;
  if (T7 != YPfalse) {
    T16 = CALL2(1,VARREF(YgooSmathYA),integerF1421,YPint((P)1));
    T17 = CALL2(1,VARREF(YgooSmathY_),remainderF1422,divisor_);
    T15 = CALL2(1,VARREF(Ytup),T16,T17);
    T6 = T15;
  } else {
    T18 = CALL2(1,VARREF(Ytup),integerF1421,remainderF1422);
    T6 = T18;
  }
  T4 = T6;
  T2 = T4;
...
loop:
  T1 = CALL2(1,VARREF(YgooSmathYtruncS),real_,divisor_);
  tup21F1424 = T1;
  T3 = CALL2(1,VARREF(YgooSmacrosYelt),tup21F1424,YPint((P)0));
  check_type(T3,VARREF(YLintG));
  integerF1425 = T3;
  T5 = CALL2(1,VARREF(YgooSmacrosYelt),tup21F1424,YPint((P)1));
  check_type(T5,VARREF(YLnumG));
  remainderF1426 = T5;
  ...
  thresholdF1427 = T7;
  T11 = CALL2(1,VARREF(YgooSmagYG),remainderF1426,thresholdF1427);
  tmpF1428 = T11;
  if (tmpF1428 != YPfalse) {
    T12 = tmpF1428;
  } else {
    T14 = CALL2(1,VARREF(YgooSmathYE),remainderF1426,thresholdF1427);
    tmpF1429 = T14;
    if (tmpF1429 != YPfalse) {
      T16 = CALL1(1,VARREF(YgooSmathYoddQ),integerF1425);
      T15 = T16;
    } else {
      T15 = YPfalse;
    }
  ...
  if (T10 != YPfalse) {
    ...
    if (T18 != YPfalse) {
      T20 = CALL2(1,VARREF(YgooSmathY_),integerF1425,YPint((P)1));
      T21 = CALL2(1,VARREF(YgooSmathYA),remainderF1426,divisor_);
      T19 = CALL2(1,VARREF(Ytup),T20,T21);
      T17 = T19;
    } else {
      T23 = CALL2(1,VARREF(YgooSmathYA),integerF1425,YPint((P)1));
      T24 = CALL2(1,VARREF(YgooSmathY_),remainderF1426,divisor_);
      T22 = CALL2(1,VARREF(Ytup),T23,T24);
      T17 = T22;
    }
    T9 = T17;
  } else {
    T27 = CALL1(1,VARREF(YgooSmathYneg),thresholdF1427);
    minus_thresholdF1430 = T27;
    T29 = CALL2(1,VARREF(YgooSmagYL),remainderF1426,minus_thresholdF1430);
    tmpF1431 = T29;
    if (tmpF1431 != YPfalse) {
      T30 = tmpF1431;
    } else {
      T32 = CALL2(1,VARREF(YgooSmathYE),remainderF1426,minus_thresholdF1430);
      tmpF1432 = T32;
      if (tmpF1432 != YPfalse) {
        T34 = CALL1(1,VARREF(YgooSmathYoddQ),integerF1425);
        T33 = T34;
      } else {
        T33 = YPfalse;
      }
    ...
    if (T26 != YPfalse) {
      ...
      if (T36 != YPfalse) {
        T38 = CALL2(1,VARREF(YgooSmathYA),integerF1425,YPint((P)1));
        T39 = CALL2(1,VARREF(YgooSmathY_),remainderF1426,divisor_);
        T37 = CALL2(1,VARREF(Ytup),T38,T39);
        T35 = T37;
      } else {
        T41 = CALL2(1,VARREF(YgooSmathY_),integerF1425,YPint((P)1));
        T42 = CALL2(1,VARREF(YgooSmathYA),remainderF1426,divisor_);
        T40 = CALL2(1,VARREF(Ytup),T41,T42);
        T35 = T40;
      }
      T25 = T35;
    } else {
      T43 = CALL2(1,VARREF(Ytup),integerF1425,remainderF1426);
      T25 = T43;
    }
    T9 = T25;
  }
...
loop:
  ...
  tup22F1435 = T1;
  T3 = CALL2(1,VARREF(YgooSmacrosYelt),tup22F1435,YPint((P)0));
  UF1436 = T3;
  T5 = CALL2(1,VARREF(YgooSmacrosYelt),tup22F1435,YPint((P)1));
  check_type(T5,VARREF(YLnumG));
  remainderF1437 = T5;
  T4 = remainderF1437;
  T2 = T4;
...
loop:
  ...
  x_1292F1438 = T1;
  FUNINIT(x_1292F1438, 2,FREEREF(0),return_);
  x_1291F1439 = FREEREF(0);
  placeF1440 = YPfalse;
  placeF1440 = BOXFAB(placeF1440);
  maxF1441 = YPfalse;
  maxF1441 = BOXFAB(maxF1441);
  T7 = CALL2(1,VARREF(YisaQ),x_1291F1439,VARREF(YLlstG));
  if (T7 != YPfalse) {
    T9 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1291F1439,LITREF(lit_103),x_1292F1438);
    x_1291F1442 = T9;
    T11 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1291F1442,x_1292F1438);
    BOXVAL(placeF1440) = T11;
    T12 = CALL1(1,VARREF(Ytail),x_1291F1442);
    x_1291F1443 = T12;
    T14 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1291F1443,x_1292F1438);
    BOXVAL(maxF1441) = T14;
    T15 = CALL1(1,VARREF(Ytail),x_1291F1443);
    x_1291F1444 = T15;
    T16 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1291F1444,x_1292F1438);
    T13 = T16;
    T10 = T13;
    T8 = T10;
  } else {
    T17 = CALL2(1,x_1292F1438,LITREF(lit_104),x_1291F1439);
  }
  T19 = CALL1(1,VARREF(Ylst),LITREF(lit_105));
  T21 = BOXVAL(placeF1440);
  T20 = CALL1(1,VARREF(Ylst),T21);
  T24 = CALL1(1,VARREF(Ylst),LITREF(lit_95));
  T25 = CALL1(1,VARREF(Ylst),LITREF(lit_106));
...
LINK_STACK();
  ...
  NARGS(args_, 1);
loop:
  T1 = CALL2(1,VARREF(YgooSmacrosYmacro_error),LITREF(lit_111),FREEREF(0));
  T0 = CALL1(1,FREEREF(1),T1);
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  x_1296F1445 = T1;
  FUNINIT(x_1296F1445, 2,FREEREF(0),return_);
  x_1295F1446 = FREEREF(0);
  placeF1447 = YPfalse;
  placeF1447 = BOXFAB(placeF1447);
  maxF1448 = YPfalse;
  maxF1448 = BOXFAB(maxF1448);
  T7 = CALL2(1,VARREF(YisaQ),x_1295F1446,VARREF(YLlstG));
  if (T7 != YPfalse) {
    T9 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1295F1446,LITREF(lit_111),x_1296F1445);
    x_1295F1449 = T9;
    T11 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1295F1449,x_1296F1445);
    BOXVAL(placeF1447) = T11;
    T12 = CALL1(1,VARREF(Ytail),x_1295F1449);
    x_1295F1450 = T12;
    T14 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1295F1450,x_1296F1445);
    BOXVAL(maxF1448) = T14;
    T15 = CALL1(1,VARREF(Ytail),x_1295F1450);
    x_1295F1451 = T15;
    T16 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1295F1451,x_1296F1445);
    T13 = T16;
    T10 = T13;
    T8 = T10;
  } else {
    T17 = CALL2(1,x_1296F1445,LITREF(lit_104),x_1295F1446);
  }
  T19 = CALL1(1,VARREF(Ylst),LITREF(lit_105));
  T21 = BOXVAL(placeF1447);
  T20 = CALL1(1,VARREF(Ylst),T21);
  T24 = CALL1(1,VARREF(Ylst),LITREF(lit_97));
  T25 = CALL1(1,VARREF(Ylst),LITREF(lit_106));
  T26 = CALL1(1,VARREF(Ylst),YPint((P)1));
  T28 = BOXVAL(maxF1448);
  T27 = CALL1(1,VARREF(Ylst),T28);
...
loop:
  T1 = CALL2(1,VARREF(YgooSmathYtruncS),real_,divisor_);
  tup23F1452 = T1;
  T3 = CALL2(1,VARREF(YgooSmacrosYelt),tup23F1452,YPint((P)0));
  UF1453 = T3;
  T5 = CALL2(1,VARREF(YgooSmacrosYelt),tup23F1452,YPint((P)1));
  check_type(T5,VARREF(YLnumG));
  remainderF1454 = T5;
  T4 = remainderF1454;
  T2 = T4;
...
loop:
  xF1455 = x_;
  xF1456 = xF1455;
  T4 = (P)YPiGG(xF1456,(P)2);
  T3 = T4;
  T2 = T3;
  xF1457 = y_;
  xF1458 = xF1457;
  T7 = (P)YPiGG(xF1458,(P)2);
  T6 = T7;
  T5 = T6;
  T1 = (P)YPiE(T2,T5);
  T0 = (P)YPbb(T1);
...
loop:
  xF1459 = x_;
  xF1460 = xF1459;
  T4 = (P)YPiGG(xF1460,(P)2);
  T3 = T4;
  T2 = T3;
  xF1461 = y_;
  xF1462 = xF1461;
  T7 = (P)YPiGG(xF1462,(P)2);
  T6 = T7;
  T5 = T6;
  T1 = (P)YPiL(T2,T5);
  T0 = (P)YPbb(T1);
...
loop:
  xF1463 = x_;
  xF1464 = xF1463;
  T4 = (P)YPiGG(xF1464,(P)2);
  T3 = T4;
  T2 = T3;
  xF1465 = y_;
  xF1466 = xF1465;
  T7 = (P)YPiGG(xF1466,(P)2);
  T6 = T7;
  T5 = T6;
  T1 = (P)YPiA(T2,T5);
  xF1467 = T1;
  xF1468 = xF1467;
  tF1469 = (P)1;
  T10 = (P)YPiLL(xF1468,(P)2);
  T9 = (P)YPiv(T10,tF1469);
  T8 = T9;
  T0 = T8;
UNLINK_STACK();
  RET(T0);
...
loop:
  xF1470 = x_;
  xF1471 = xF1470;
  T4 = (P)YPiGG(xF1471,(P)2);
  T3 = T4;
  T2 = T3;
  xF1472 = y_;
  xF1473 = xF1472;
  T7 = (P)YPiGG(xF1473,(P)2);
  T6 = T7;
  T5 = T6;
  T1 = (P)YPi_(T2,T5);
  xF1474 = T1;
  xF1475 = xF1474;
  tF1476 = (P)1;
  T10 = (P)YPiLL(xF1475,(P)2);
  T9 = (P)YPiv(T10,tF1476);
  T8 = T9;
  T0 = T8;
UNLINK_STACK();
  RET(T0);
...
loop:
  xF1477 = x_;
  xF1478 = xF1477;
  T4 = (P)YPiGG(xF1478,(P)2);
  T3 = T4;
  T2 = T3;
  xF1479 = y_;
  xF1480 = xF1479;
  T7 = (P)YPiGG(xF1480,(P)2);
  T6 = T7;
  T5 = T6;
  T1 = (P)YPiT(T2,T5);
  xF1481 = T1;
  xF1482 = xF1481;
  tF1483 = (P)1;
  T10 = (P)YPiLL(xF1482,(P)2);
  T9 = (P)YPiv(T10,tF1483);
  T8 = T9;
  T0 = T8;
UNLINK_STACK();
  RET(T0);
...
LINK_STACK();
  ...
  ARG(y_, 1);
loop:
  T0 = CALL1(1,VARREF(Yarithmetic_error),LITREF(lit_137));
UNLINK_STACK();
  RET(T0);
}
...
loop:
  xF1484 = x_;
  xF1485 = xF1484;
  T5 = (P)YPiGG(xF1485,(P)2);
  T4 = T5;
  T3 = T4;
  xF1486 = y_;
  xF1487 = xF1486;
  T8 = (P)YPiGG(xF1487,(P)2);
  T7 = T8;
  T6 = T7;
  T2 = (P)YPitS(T3,T6);
  xF1488 = T2;
  xF1489 = xF1488;
  tF1490 = (P)1;
  T11 = (P)YPiLL(xF1489,(P)2);
  T10 = (P)YPiv(T11,tF1490);
  T9 = T10;
  T1 = T9;
  resultF1491 = T1;
  T14 = CALL2(1,VARREF(YgooSmathYT),resultF1491,y_);
  T13 = CALL2(1,VARREF(YgooSmathY_),x_,T14);
  T12 = CALL2(1,VARREF(Ytup),resultF1491,T13);
  T0 = T12;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  xF1492 = x_;
  xF1493 = xF1492;
  T5 = (P)YPiGG(xF1493,(P)2);
  T4 = T5;
  T3 = T4;
  xF1494 = y_;
  xF1495 = xF1494;
  T8 = (P)YPiGG(xF1495,(P)2);
  T7 = T8;
  T6 = T7;
  T2 = (P)YPim(T3,T6);
  xF1496 = T2;
  xF1497 = xF1496;
  tF1498 = (P)1;
  T11 = (P)YPiLL(xF1497,(P)2);
  T10 = (P)YPiv(T11,tF1498);
  T9 = T10;
  T1 = T9;
  resF1499 = T1;
  T13 = CALL2(1,VARREF(YgooSmagYL),resF1499,YPint((P)0));
  if (T13 != YPfalse) {
    T15 = CALL2(1,VARREF(YgooSmagYG),y_,YPint((P)0));
    if (T15 != YPfalse) {
      T16 = CALL2(1,VARREF(YgooSmathYA),resF1499,y_);
      T14 = T16;
    } else {
      T17 = CALL2(1,VARREF(YgooSmathY_),resF1499,y_);
      T14 = T17;
    }
    T12 = T14;
  } else {
    ...
    if (T6 != YPfalse) {
      ...
      if (T9 != YPfalse) {
        ...
        if (YPtrue != YPfalse) {
          ...
          T20 = CALL3(1,loopF1500,T21,T24,T25);
          T18 = T20;
          T17 = T18;
        } else {
          T17 = YPfalse;
...
loop:
  xF1501 = x_;
  xF1502 = xF1501;
  T4 = (P)YPiGG(xF1502,(P)2);
  T3 = T4;
  T2 = T3;
  xF1503 = y_;
  xF1504 = xF1503;
  T7 = (P)YPiGG(xF1504,(P)2);
  T6 = T7;
  T5 = T6;
  T1 = (P)YPiv(T2,T5);
  xF1505 = T1;
  xF1506 = xF1505;
  tF1507 = (P)1;
  T10 = (P)YPiLL(xF1506,(P)2);
  T9 = (P)YPiv(T10,tF1507);
  T8 = T9;
  T0 = T8;
UNLINK_STACK();
  RET(T0);
...
loop:
  xF1508 = x_;
  xF1509 = xF1508;
  T4 = (P)YPiGG(xF1509,(P)2);
  T3 = T4;
  T2 = T3;
  xF1510 = y_;
  xF1511 = xF1510;
  T7 = (P)YPiGG(xF1511,(P)2);
  T6 = T7;
  T5 = T6;
  T1 = (P)YPiC(T2,T5);
  xF1512 = T1;
  xF1513 = xF1512;
  tF1514 = (P)1;
  T10 = (P)YPiLL(xF1513,(P)2);
  T9 = (P)YPiv(T10,tF1514);
  T8 = T9;
  T0 = T8;
UNLINK_STACK();
  RET(T0);
...
loop:
  xF1515 = x_;
  xF1516 = xF1515;
  T4 = (P)YPiGG(xF1516,(P)2);
  T3 = T4;
  T2 = T3;
  xF1517 = y_;
  xF1518 = xF1517;
  T7 = (P)YPiGG(xF1518,(P)2);
  T6 = T7;
  T5 = T6;
  T1 = (P)YPiB(T2,T5);
  xF1519 = T1;
  xF1520 = xF1519;
  tF1521 = (P)1;
  T10 = (P)YPiLL(xF1520,(P)2);
  T9 = (P)YPiv(T10,tF1521);
  T8 = T9;
  T0 = T8;
UNLINK_STACK();
  RET(T0);
...
loop:
  xF1527 = o_;
  xF1528 = xF1527;
  T4 = (P)YPiGG(xF1528,(P)2);
  T3 = T4;
  T2 = T3;
  xF1529 = x_;
  xF1530 = xF1529;
  T7 = (P)YPiGG(xF1530,(P)2);
  T6 = T7;
  T5 = T6;
  T1 = (P)YPiQ(T2,T5);
  xF1531 = T1;
  xF1532 = xF1531;
  tF1533 = (P)1;
  T10 = (P)YPiLL(xF1532,(P)2);
  T9 = (P)YPiv(T10,tF1533);
  T8 = T9;
  T0 = T8;
UNLINK_STACK();
  RET(T0);
...
loop:
  xF1534 = x_;
  xF1535 = xF1534;
  T4 = (P)YPiGG(xF1535,(P)2);
  T3 = T4;
  T2 = T3;
  xF1536 = a_;
  xF1537 = xF1536;
  T7 = (P)YPiGG(xF1537,(P)2);
  T6 = T7;
  T5 = T6;
  T1 = (P)YPiGG(T2,T5);
  xF1538 = T1;
  xF1539 = xF1538;
  tF1540 = (P)1;
  T10 = (P)YPiLL(xF1539,(P)2);
  T9 = (P)YPiv(T10,tF1540);
  T8 = T9;
  T0 = T8;
UNLINK_STACK();
  RET(T0);
...
loop:
  xF1541 = x_;
  xF1542 = xF1541;
  T4 = (P)YPiGG(xF1542,(P)2);
  T3 = T4;
  T2 = T3;
  xF1543 = a_;
  xF1544 = xF1543;
  T7 = (P)YPiGG(xF1544,(P)2);
  T6 = T7;
  T5 = T6;
  T1 = (P)YPiGGG(T2,T5);
  xF1545 = T1;
  xF1546 = xF1545;
  tF1547 = (P)1;
  T10 = (P)YPiLL(xF1546,(P)2);
  T9 = (P)YPiv(T10,tF1547);
  T8 = T9;
  T0 = T8;
UNLINK_STACK();
  RET(T0);
...
loop:
  xF1548 = x_;
  xF1549 = xF1548;
  T4 = (P)YPiGG(xF1549,(P)2);
  T3 = T4;
  T2 = T3;
  xF1550 = a_;
  xF1551 = xF1550;
  T7 = (P)YPiGG(xF1551,(P)2);
  T6 = T7;
  T5 = T6;
  T1 = (P)YPiLL(T2,T5);
  xF1552 = T1;
  xF1553 = xF1552;
  tF1554 = (P)1;
  T10 = (P)YPiLL(xF1553,(P)2);
  T9 = (P)YPiv(T10,tF1554);
  T8 = T9;
  T0 = T8;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  searchF1555 = T1;
  FUNINIT(searchF1555, 2,x_,searchF1555);
  T2 = CALL1(1,searchF1555,YPint((P)1));
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  dividedF1561 = T1;
  T5 = (P)YPfu(dividedF1561);
  T4 = (P)YPft(T5);
  xF1562 = T4;
  xF1563 = xF1562;
  tF1564 = (P)1;
  T8 = (P)YPiLL(xF1563,(P)2);
  T7 = (P)YPiv(T8,tF1564);
  T6 = T7;
  T3 = T6;
  resultF1565 = T3;
  T12 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLfloG),resultF1565);
  T11 = CALL2(1,VARREF(YgooSmathY_),dividedF1561,T12);
  T10 = CALL2(1,VARREF(YgooSmathYT),y_,T11);
  T9 = CALL2(1,VARREF(Ytup),resultF1565,T10);
  T2 = T9;
  T0 = T2;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  T7 = T9;
  if (T7 != YPfalse) {
    T11 = CALL1(1,VARREF(YgooSmathYneg),resF1566);
    T6 = T11;
  } else {
    T6 = resF1566;
  }
...
LINK_STACK();
  ...
  NARGS(args_, 1);
loop:
  T1 = CALL2(1,VARREF(YgooSmacrosYmacro_error),LITREF(lit_190),FREEREF(0));
  T0 = CALL1(1,FREEREF(1),T1);
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  x_1300F1568 = T1;
  FUNINIT(x_1300F1568, 2,FREEREF(0),return_);
  x_1299F1569 = FREEREF(0);
  nameF1570 = YPfalse;
  nameF1570 = BOXFAB(nameF1570);
  paramF1571 = YPfalse;
  paramF1571 = BOXFAB(paramF1571);
  prefixF1572 = YPfalse;
  prefixF1572 = BOXFAB(prefixF1572);
  T9 = CALL2(1,VARREF(YisaQ),x_1299F1569,VARREF(YLlstG));
  if (T9 != YPfalse) {
    T11 = CALL3(1,VARREF(YgooSmacrosYmatch_atom),x_1299F1569,LITREF(lit_190),x_1300F1568);
    x_1299F1573 = T11;
    T13 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1299F1573,x_1300F1568);
    BOXVAL(nameF1570) = T13;
    T14 = CALL1(1,VARREF(Ytail),x_1299F1573);
    x_1299F1574 = T14;
    T16 = CALL2(1,VARREF(YgooSmacrosYmatch_sublist),x_1299F1574,x_1300F1568);
    x_1299F1575 = T16;
    T18 = CALL2(1,VARREF(YgooSmacrosYmatch_unquote),x_1299F1575,x_1300F1568);
    BOXVAL(paramF1571) = T18;
    T19 = CALL1(1,VARREF(Ytail),x_1299F1575);
    x_1299F1576 = T19;
    T20 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1299F1576,x_1300F1568);
    T17 = T20;
    T21 = CALL1(1,VARREF(Ytail),x_1299F1574);
    x_1299F1577 = T21;
    BOXVAL(prefixF1572) = x_1299F1577;
    x_1299F1578 = Ynil;
    T23 = CALL2(1,VARREF(YgooSmacrosYmatch_empty_list),x_1299F1578,x_1300F1568);
    T22 = T23;
    T15 = T22;
    T12 = T15;
    T10 = T12;
  } else {
    T24 = CALL2(1,x_1300F1568,LITREF(lit_104),x_1299F1569);
  }
  T27 = BOXVAL(nameF1570);
  T26 = CALL2(1,VARREF(YgooSmacrosYcat_sym),LITREF(lit_191),T27);
  PfpF1579 = T26;
  T29 = CALL1(1,VARREF(Ylst),LITREF(lit_192));
  T32 = CALL1(1,VARREF(Ylst),LITREF(lit_193));
  T34 = BOXVAL(nameF1570);
  T33 = CALL1(1,VARREF(Ylst),T34);
  T40 = BOXVAL(paramF1571);
  T39 = CALL1(1,VARREF(Ylst),T40);
  T41 = CALL1(1,VARREF(Ylst),LITREF(lit_194));
  T38 = CALL3(1,VARREF(YgooSmacrosYcat),T39,T41,Ynil);
  T37 = CALL1(1,VARREF(Ylst),T38);
  T42 = CALL1(1,VARREF(Ylst),LITREF(lit_195));
  T43 = CALL1(1,VARREF(Ylst),LITREF(lit_194));
  T36 = CALL4(1,VARREF(YgooSmacrosYcat),T37,T42,T43,Ynil);
  T35 = CALL1(1,VARREF(Ylst),T36);
  T31 = CALL4(1,VARREF(YgooSmacrosYcat),T32,T33,T35,Ynil);
  T30 = CALL1(1,VARREF(Ylst),T31);
  T46 = CALL1(1,VARREF(Ylst),LITREF(lit_196));
  T48 = BOXVAL(nameF1570);
  T47 = CALL1(1,VARREF(Ylst),T48);
  T54 = BOXVAL(paramF1571);
  T53 = CALL1(1,VARREF(Ylst),T54);
  T55 = CALL1(1,VARREF(Ylst),LITREF(lit_197));
  T52 = CALL3(1,VARREF(YgooSmacrosYcat),T53,T55,Ynil);
  T51 = CALL1(1,VARREF(Ylst),T52);
  T56 = CALL1(1,VARREF(Ylst),LITREF(lit_195));
  T57 = CALL1(1,VARREF(Ylst),LITREF(lit_198));
  T50 = CALL4(1,VARREF(YgooSmacrosYcat),T51,T56,T57,Ynil);
  T49 = CALL1(1,VARREF(Ylst),T50);
  T58 = BOXVAL(prefixF1572);
  T62 = BOXVAL(nameF1570);
  T61 = CALL1(1,VARREF(Ylst),T62);
  T65 = CALL1(1,VARREF(Ylst),LITREF(lit_11));
  T66 = CALL1(1,VARREF(Ylst),LITREF(lit_198));
  T68 = BOXVAL(paramF1571);
  ...
  T71 = CALL1(1,VARREF(Ylst),LITREF(lit_196));
  T73 = BOXVAL(nameF1570);
  T72 = CALL1(1,VARREF(Ylst),T73);
  T79 = BOXVAL(paramF1571);
  T78 = CALL1(1,VARREF(Ylst),T79);
  T80 = CALL1(1,VARREF(Ylst),LITREF(lit_198));
  T77 = CALL3(1,VARREF(YgooSmacrosYcat),T78,T80,Ynil);
  T76 = CALL1(1,VARREF(Ylst),T77);
  T81 = CALL1(1,VARREF(Ylst),LITREF(lit_195));
  T82 = CALL1(1,VARREF(Ylst),LITREF(lit_198));
  T75 = CALL4(1,VARREF(YgooSmacrosYcat),T76,T81,T82,Ynil);
  T74 = CALL1(1,VARREF(Ylst),T75);
  T83 = BOXVAL(prefixF1572);
  T86 = CALL1(1,VARREF(Ylst),LITREF(lit_199));
  T89 = CALL1(1,VARREF(Ylst),PfpF1579);
  T92 = CALL1(1,VARREF(Ylst),LITREF(lit_200));
  T94 = BOXVAL(paramF1571);
...
loop:
  ...
  if (T0 != YPfalse) {
    T1 = CALL1(1,VARREF(Yarithmetic_error),LITREF(lit_204));
  } else {
  }
...
loop:
  T0 = CALL1(1,VARREF(YgooSmathYnegQ),x_);
  if (T0 != YPfalse) {
    T1 = CALL1(1,VARREF(Yarithmetic_error),LITREF(lit_237));
  } else {
  }
  T3 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLfloG),x_);
...
loop:
  T0 = CALL1(1,VARREF(YgooSmathYnegQ),x_);
  if (T0 != YPfalse) {
    T1 = CALL1(1,VARREF(Yarithmetic_error),LITREF(lit_242));
  } else {
  }
  T3 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLfloG),x_);
...
loop:
  ...
  fun_as_4 = YPmet(FUNCODEREF(fun_as_4),LITREF(lit_11),T23,ENVNUL,PNUL,YPfalse);
  ...
  YgooSmathYas_log = YPmet(FUNCODEREF(YgooSmathYas_log),LITREF(lit_14),T28,ENVNUL,PNUL,YPfalse);
  ...
  fun_EE_6 = YPmet(FUNCODEREF(fun_EE_6),LITREF(lit_16),T30,ENVNUL,PNUL,YPfalse);
  ...
  fun_E_7 = YPmet(FUNCODEREF(fun_E_7),LITREF(lit_18),T35,ENVNUL,PNUL,YPfalse);
  ...
  fun_NE_8 = YPmet(FUNCODEREF(fun_NE_8),LITREF(lit_20),T40,ENVNUL,PNUL,YPfalse);
  ...
  fun_NEE_9 = YPmet(FUNCODEREF(fun_NEE_9),LITREF(lit_22),T45,ENVNUL,PNUL,YPfalse);
  ...
  fun_as_10 = YPmet(FUNCODEREF(fun_as_10),LITREF(lit_11),T50,ENVNUL,PNUL,YPfalse);
  ...
  fun_as_11 = YPmet(FUNCODEREF(fun_as_11),LITREF(lit_11),T56,ENVNUL,PNUL,YPfalse);
  ...
  fun_L_12 = YPmet(FUNCODEREF(fun_L_12),LITREF(lit_26),T62,ENVNUL,PNUL,YPfalse);
  ...
  fun_EE_13 = YPmet(FUNCODEREF(fun_EE_13),LITREF(lit_16),T67,ENVNUL,PNUL,YPfalse);
  ...
  fun_lowerQ_14 = YPmet(FUNCODEREF(fun_lowerQ_14),LITREF(lit_29),T72,ENVNUL,PNUL,YPfalse);
  ...
  fun_upperQ_15 = YPmet(FUNCODEREF(fun_upperQ_15),LITREF(lit_31),T77,ENVNUL,PNUL,YPfalse);
  ...
  fun_to_lower_16 = YPmet(FUNCODEREF(fun_to_lower_16),LITREF(lit_33),T82,ENVNUL,PNUL,YPfalse);
  ...
  fun_to_upper_17 = YPmet(FUNCODEREF(fun_to_upper_17),LITREF(lit_35),T87,ENVNUL,PNUL,YPfalse);
  ...
  fun_to_digit_18 = YPmet(FUNCODEREF(fun_to_digit_18),LITREF(lit_37),T92,ENVNUL,PNUL,YPfalse);
  ...
  fun_alphaQ_20 = YPmet(FUNCODEREF(fun_alphaQ_20),LITREF(lit_40),T102,ENVNUL,PNUL,YPfalse);
  ...
  fun_digitQ_21 = YPmet(FUNCODEREF(fun_digitQ_21),LITREF(lit_42),T107,ENVNUL,PNUL,YPfalse);
  ...
  fun_eof_objectQ_22 = YPmet(FUNCODEREF(fun_eof_objectQ_22),LITREF(lit_44),T112,ENVNUL,PNUL,YPfalse);
  ...
  fun_eof_objectQ_23 = YPmet(FUNCODEREF(fun_eof_objectQ_23),LITREF(lit_44),T117,ENVNUL,PNUL,YPfalse);
  ...
  fun_eof_object_24 = YPmet(FUNCODEREF(fun_eof_object_24),LITREF(lit_47),T122,ENVNUL,PNUL,YPfalse);
  ...
  fun_contagious_call_25 = YPmet(FUNCODEREF(fun_contagious_call_25),LITREF(lit_51),T132,ENVNUL,PNUL,YPfalse);
  ...
  fun_L_26 = YPmet(FUNCODEREF(fun_L_26),LITREF(lit_26),T137,ENVNUL,PNUL,YPfalse);
  ...
  fun_A_27 = YPmet(FUNCODEREF(fun_A_27),LITREF(lit_55),T142,ENVNUL,PNUL,YPfalse);
  ...
  fun_1A_28 = YPmet(FUNCODEREF(fun_1A_28),LITREF(lit_57),T147,ENVNUL,PNUL,YPfalse);
  ...
  fun___29 = YPmet(FUNCODEREF(fun___29),LITREF(lit_59),T152,ENVNUL,PNUL,YPfalse);
  ...
  fun_1__30 = YPmet(FUNCODEREF(fun_1__30),LITREF(lit_61),T157,ENVNUL,PNUL,YPfalse);
  ...
  fun_T_31 = YPmet(FUNCODEREF(fun_T_31),LITREF(lit_63),T162,ENVNUL,PNUL,YPfalse);
  ...
  fun_S_32 = YPmet(FUNCODEREF(fun_S_32),LITREF(lit_65),T167,ENVNUL,PNUL,YPfalse);
  ...
  fun_atan2_33 = YPmet(FUNCODEREF(fun_atan2_33),LITREF(lit_67),T172,ENVNUL,PNUL,YPfalse);
  ...
  fun_logn_34 = YPmet(FUNCODEREF(fun_logn_34),LITREF(lit_69),T177,ENVNUL,PNUL,YPfalse);
  ...
  fun_floor_35 = YPmet(FUNCODEREF(fun_floor_35),LITREF(lit_71),T182,ENVNUL,PNUL,YPfalse);
  ...
  fun_ceil_36 = YPmet(FUNCODEREF(fun_ceil_36),LITREF(lit_73),T187,ENVNUL,PNUL,YPfalse);
  ...
  fun_round_37 = YPmet(FUNCODEREF(fun_round_37),LITREF(lit_75),T192,ENVNUL,PNUL,YPfalse);
  ...
  fun_round_to_38 = YPmet(FUNCODEREF(fun_round_to_38),LITREF(lit_77),T197,ENVNUL,PNUL,YPfalse);
  ...
  fun_trunc_39 = YPmet(FUNCODEREF(fun_trunc_39),LITREF(lit_80),T202,ENVNUL,PNUL,YPfalse);
  ...
  fun_floorS_40 = YPmet(FUNCODEREF(fun_floorS_40),LITREF(lit_82),T207,ENVNUL,PNUL,YPfalse);
  ...
  fun_ceilS_41 = YPmet(FUNCODEREF(fun_ceilS_41),LITREF(lit_84),T213,ENVNUL,PNUL,YPfalse);
  ...
  fun_roundS_42 = YPmet(FUNCODEREF(fun_roundS_42),LITREF(lit_86),T219,ENVNUL,PNUL,YPfalse);
  ...
  fun_truncS_43 = YPmet(FUNCODEREF(fun_truncS_43),LITREF(lit_89),T225,ENVNUL,PNUL,YPfalse);
  ...
  fun_div_44 = YPmet(FUNCODEREF(fun_div_44),LITREF(lit_91),T231,ENVNUL,PNUL,YPfalse);
  ...
  fun_mod_45 = YPmet(FUNCODEREF(fun_mod_45),LITREF(lit_93),T236,ENVNUL,PNUL,YPfalse);
  ...
  fun_modA_46 = YPmet(FUNCODEREF(fun_modA_46),LITREF(lit_95),T241,ENVNUL,PNUL,YPfalse);
  ...
  fun_mod__47 = YPmet(FUNCODEREF(fun_mod__47),LITREF(lit_97),T246,ENVNUL,PNUL,YPfalse);
  ...
  lit_108 = YPPlist(1,YPPsym((P)"return"));
  lit_109 = YPPsym((P)"x-1296");
  lit_110 = YPPlist(2,YPPsym((P)"msg"),YPPsym((P)"args"));
  lit_111 = YPPsym((P)"moddecf");
  T257 = YPsig(LITREF(lit_110),YPPlist(1,VARREF(YLstrG)),YPtrue,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_x_1296_51 = YPmet(FUNCODEREF(fun_x_1296_51),LITREF(lit_109),T257,ENVNUL,PNUL,YPfalse);
  T256 = YPsig(LITREF(lit_108),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_52 = YPmet(FUNCODEREF(fun_52),YPfalse,T256,ENVNUL,PNUL,YPfalse);
  T255 = YPsig(LITREF(lit_107),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_53 = YPmet(FUNCODEREF(fun_53),YPfalse,T255,ENVNUL,PNUL,YPfalse);
  T258 = fun_53;
  YPmacro(YPPsym((P)"goo/math"),YPPsym((P)"moddecf"),T258);
  lit_112 = YPPsym((P)"rem");
  lit_113 = YPPlist(2,YPPsym((P)"real"),YPPsym((P)"divisor"));
  T259 = YPsig(LITREF(lit_113),YPPlist(2,VARREF(YLnumG),VARREF(YLnumG)),YPfalse,YPint((P)2),VARREF(YLnumG),Ynil);
  fun_rem_54 = YPmet(FUNCODEREF(fun_rem_54),LITREF(lit_112),T259,ENVNUL,PNUL,YPfalse);
  ...
  lit_114 = YPPsym((P)"pow");
  lit_115 = YPPlist(2,YPPsym((P)"base"),YPPsym((P)"n"));
  T264 = YPsig(LITREF(lit_115),YPPlist(2,VARREF(YLnumG),VARREF(YLnumG)),YPfalse,YPint((P)2),VARREF(YLnumG),Ynil);
  fun_pow_55 = YPmet(FUNCODEREF(fun_pow_55),LITREF(lit_114),T264,ENVNUL,PNUL,YPfalse);
  ...
  lit_116 = YPPsym((P)"pos?");
  lit_117 = YPPlist(1,YPPsym((P)"x"));
  T269 = YPsig(LITREF(lit_117),YPPlist(1,VARREF(YLnumG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_posQ_56 = YPmet(FUNCODEREF(fun_posQ_56),LITREF(lit_116),T269,ENVNUL,PNUL,YPfalse);
  ...
  lit_118 = YPPsym((P)"zero?");
  lit_119 = YPPlist(1,YPPsym((P)"x"));
  T274 = YPsig(LITREF(lit_119),YPPlist(1,VARREF(YLnumG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_zeroQ_57 = YPmet(FUNCODEREF(fun_zeroQ_57),LITREF(lit_118),T274,ENVNUL,PNUL,YPfalse);
  ...
  lit_120 = YPPsym((P)"neg?");
  lit_121 = YPPlist(1,YPPsym((P)"x"));
  T279 = YPsig(LITREF(lit_121),YPPlist(1,VARREF(YLnumG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_negQ_58 = YPmet(FUNCODEREF(fun_negQ_58),LITREF(lit_120),T279,ENVNUL,PNUL,YPfalse);
  ...
  lit_122 = YPPsym((P)"neg");
  lit_123 = YPPlist(1,YPPsym((P)"x"));
  T286 = YPsig(LITREF(lit_123),YPPlist(1,VARREF(YLnumG)),YPfalse,YPint((P)1),VARREF(YLnumG),Ynil);
  T285 = fun_neg_59 = YPmet(FUNCODEREF(fun_neg_59),LITREF(lit_122),T286,ENVNUL,PNUL,YPfalse);
...
DEFCREGS();
loop:
  lit_124 = YPPsym((P)"abs");
  lit_125 = YPPlist(1,YPPsym((P)"x"));
  T0 = YPsig(LITREF(lit_125),YPPlist(1,VARREF(YLnumG)),YPfalse,YPint((P)1),VARREF(YLnumG),Ynil);
  fun_abs_60 = YPmet(FUNCODEREF(fun_abs_60),LITREF(lit_124),T0,ENVNUL,PNUL,YPfalse);
  ...
  T5 = YPsig(LITREF(lit_126),YPPlist(1,VARREF(YLnumG)),YPfalse,YPint((P)1),VARREF(YLstrG),Ynil);
  ...
  T10 = YPsig(LITREF(lit_127),YPPlist(2,VARREF(YLintG),VARREF(YLintG)),YPfalse,YPint((P)2),T11,Ynil);
  fun_contagious_type_62 = YPmet(FUNCODEREF(fun_contagious_type_62),LITREF(lit_49),T10,ENVNUL,PNUL,YPfalse);
  ...
  T16 = YPsig(LITREF(lit_128),YPPlist(2,VARREF(YLfloG),VARREF(YLfloG)),YPfalse,YPint((P)2),T17,Ynil);
  fun_contagious_type_63 = YPmet(FUNCODEREF(fun_contagious_type_63),LITREF(lit_49),T16,ENVNUL,PNUL,YPfalse);
  ...
  T22 = YPsig(LITREF(lit_129),YPPlist(2,VARREF(YLintG),VARREF(YLfloG)),YPfalse,YPint((P)2),T23,Ynil);
  fun_contagious_type_64 = YPmet(FUNCODEREF(fun_contagious_type_64),LITREF(lit_49),T22,ENVNUL,PNUL,YPfalse);
  ...
  T28 = YPsig(LITREF(lit_130),YPPlist(2,VARREF(YLfloG),VARREF(YLintG)),YPfalse,YPint((P)2),T29,Ynil);
  fun_contagious_type_65 = YPmet(FUNCODEREF(fun_contagious_type_65),LITREF(lit_49),T28,ENVNUL,PNUL,YPfalse);
  ...
  T34 = YPsig(LITREF(lit_131),YPPlist(2,VARREF(YLfixnumG),VARREF(YLfixnumG)),YPfalse,YPint((P)2),VARREF(YLlogG),Ynil);
  fun_EE_66 = YPmet(FUNCODEREF(fun_EE_66),LITREF(lit_16),T34,ENVNUL,PNUL,YPfalse);
  ...
  T39 = YPsig(LITREF(lit_132),YPPlist(2,VARREF(YLfixnumG),VARREF(YLfixnumG)),YPfalse,YPint((P)2),VARREF(YLlogG),Ynil);
  fun_L_67 = YPmet(FUNCODEREF(fun_L_67),LITREF(lit_26),T39,ENVNUL,PNUL,YPfalse);
  ...
  T44 = YPsig(LITREF(lit_133),YPPlist(2,VARREF(YLfixnumG),VARREF(YLfixnumG)),YPfalse,YPint((P)2),VARREF(YLfixnumG),Ynil);
  fun_A_68 = YPmet(FUNCODEREF(fun_A_68),LITREF(lit_55),T44,ENVNUL,PNUL,YPfalse);
  ...
  T49 = YPsig(LITREF(lit_134),YPPlist(2,VARREF(YLfixnumG),VARREF(YLfixnumG)),YPfalse,YPint((P)2),VARREF(YLfixnumG),Ynil);
  fun___69 = YPmet(FUNCODEREF(fun___69),LITREF(lit_59),T49,ENVNUL,PNUL,YPfalse);
  ...
  T54 = YPsig(LITREF(lit_135),YPPlist(2,VARREF(YLfixnumG),VARREF(YLfixnumG)),YPfalse,YPint((P)2),VARREF(YLfixnumG),Ynil);
  fun_T_70 = YPmet(FUNCODEREF(fun_T_70),LITREF(lit_63),T54,ENVNUL,PNUL,YPfalse);
  ...
  lit_137 = YPsb((P)"No int divide, consider trunc/");
  T59 = YPsig(LITREF(lit_136),YPPlist(2,VARREF(YLintG),VARREF(YLintG)),YPfalse,YPint((P)2),VARREF(YLintG),Ynil);
  fun_S_71 = YPmet(FUNCODEREF(fun_S_71),LITREF(lit_65),T59,ENVNUL,PNUL,YPfalse);
  ...
  T64 = YPsig(LITREF(lit_138),YPPlist(1,VARREF(YLintG)),YPfalse,YPint((P)1),VARREF(YLintG),Ynil);
  fun_floor_72 = YPmet(FUNCODEREF(fun_floor_72),LITREF(lit_71),T64,ENVNUL,PNUL,YPfalse);
  ...
  T69 = YPsig(LITREF(lit_139),YPPlist(1,VARREF(YLintG)),YPfalse,YPint((P)1),VARREF(YLintG),Ynil);
  fun_ceil_73 = YPmet(FUNCODEREF(fun_ceil_73),LITREF(lit_73),T69,ENVNUL,PNUL,YPfalse);
  ...
  T74 = YPsig(LITREF(lit_140),YPPlist(1,VARREF(YLintG)),YPfalse,YPint((P)1),VARREF(YLintG),Ynil);
  fun_round_74 = YPmet(FUNCODEREF(fun_round_74),LITREF(lit_75),T74,ENVNUL,PNUL,YPfalse);
  ...
  T79 = YPsig(LITREF(lit_141),YPPlist(1,VARREF(YLintG)),YPfalse,YPint((P)1),VARREF(YLintG),Ynil);
  fun_trunc_75 = YPmet(FUNCODEREF(fun_trunc_75),LITREF(lit_80),T79,ENVNUL,PNUL,YPfalse);
  ...
  lit_142 = YPPlist(2,YPPsym((P)"x"),YPPsym((P)"y"));
  T85 = XCALL2(1,VARREF(YtT),VARREF(YLfixnumG),VARREF(YLfixnumG));
  T84 = YPsig(LITREF(lit_142),YPPlist(2,VARREF(YLfixnumG),VARREF(YLfixnumG)),YPfalse,YPint((P)2),T85,Ynil);
  fun_truncS_76 = YPmet(FUNCODEREF(fun_truncS_76),LITREF(lit_89),T84,ENVNUL,PNUL,YPfalse);
  ...
  T90 = YPsig(LITREF(lit_143),YPPlist(2,VARREF(YLfixnumG),VARREF(YLfixnumG)),YPfalse,YPint((P)2),VARREF(YLfixnumG),Ynil);
  fun_mod_77 = YPmet(FUNCODEREF(fun_mod_77),LITREF(lit_93),T90,ENVNUL,PNUL,YPfalse);
  ...
  lit_144 = YPPlist(2,YPPsym((P)"x"),YPPsym((P)"n"));
  lit_145 = YPPsym((P)"loop");
  lit_146 = YPPlist(3,YPPsym((P)"x"),YPPsym((P)"p"),YPPsym((P)"y"));
  T96 = YPsig(LITREF(lit_146),YPPlist(3,VARREF(YLintG),VARREF(YLintG),VARREF(YLintG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_loop_78 = YPmet(FUNCODEREF(fun_loop_78),LITREF(lit_145),T96,ENVNUL,PNUL,YPfalse);
  T95 = YPsig(LITREF(lit_144),YPPlist(2,VARREF(YLfixnumG),VARREF(YLfixnumG)),YPfalse,YPint((P)2),VARREF(YLnumG),Ynil);
  fun_pow_79 = YPmet(FUNCODEREF(fun_pow_79),LITREF(lit_114),T95,ENVNUL,PNUL,YPfalse);
  ...
  lit_147 = YPPsym((P)"|");
  lit_148 = YPPlist(2,YPPsym((P)"x"),YPPsym((P)"y"));
  T101 = YPsig(LITREF(lit_148),YPPlist(2,VARREF(YLfixnumG),VARREF(YLfixnumG)),YPfalse,YPint((P)2),VARREF(YLintG),Ynil);
  fun_K_80 = YPmet(FUNCODEREF(fun_K_80),LITREF(lit_147),T101,ENVNUL,PNUL,YPfalse);
  ...
  lit_149 = YPPsym((P)"^");
  lit_150 = YPPlist(2,YPPsym((P)"x"),YPPsym((P)"y"));
  T106 = YPsig(LITREF(lit_150),YPPlist(2,VARREF(YLfixnumG),VARREF(YLfixnumG)),YPfalse,YPint((P)2),VARREF(YLintG),Ynil);
  fun_C_81 = YPmet(FUNCODEREF(fun_C_81),LITREF(lit_149),T106,ENVNUL,PNUL,YPfalse);
  ...
  lit_151 = YPPsym((P)"&");
  lit_152 = YPPlist(2,YPPsym((P)"x"),YPPsym((P)"y"));
  T111 = YPsig(LITREF(lit_152),YPPlist(2,VARREF(YLfixnumG),VARREF(YLfixnumG)),YPfalse,YPint((P)2),VARREF(YLintG),Ynil);
  fun_B_82 = YPmet(FUNCODEREF(fun_B_82),LITREF(lit_151),T111,ENVNUL,PNUL,YPfalse);
  ...
  T116 = YPsig(LITREF(lit_154),YPPlist(1,VARREF(YLfixnumG)),YPfalse,YPint((P)1),VARREF(YLfixnumG),Ynil);
  fun_N_83 = YPmet(FUNCODEREF(fun_N_83),LITREF(lit_153),T116,ENVNUL,PNUL,YPfalse);
  ...
  lit_155 = YPPsym((P)"bit?");
  lit_156 = YPPlist(2,YPPsym((P)"o"),YPPsym((P)"x"));
  T121 = YPsig(LITREF(lit_156),YPPlist(2,VARREF(YLfixnumG),VARREF(YLfixnumG)),YPfalse,YPint((P)2),VARREF(YLfixnumG),Ynil);
  fun_bitQ_84 = YPmet(FUNCODEREF(fun_bitQ_84),LITREF(lit_155),T121,ENVNUL,PNUL,YPfalse);
  ...
  lit_157 = YPPsym((P)"even?");
  lit_158 = YPPlist(1,YPPsym((P)"x"));
  T126 = YPsig(LITREF(lit_158),YPPlist(1,VARREF(YLfixnumG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_evenQ_85 = YPmet(FUNCODEREF(fun_evenQ_85),LITREF(lit_157),T126,ENVNUL,PNUL,YPfalse);
  ...
  lit_159 = YPPsym((P)"odd?");
  lit_160 = YPPlist(1,YPPsym((P)"x"));
  T131 = YPsig(LITREF(lit_160),YPPlist(1,VARREF(YLfixnumG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_oddQ_86 = YPmet(FUNCODEREF(fun_oddQ_86),LITREF(lit_159),T131,ENVNUL,PNUL,YPfalse);
  ...
  lit_161 = YPPsym((P)">>");
  lit_162 = YPPlist(2,YPPsym((P)"x"),YPPsym((P)"a"));
  T136 = YPsig(LITREF(lit_162),YPPlist(2,VARREF(YLfixnumG),VARREF(YLfixnumG)),YPfalse,YPint((P)2),VARREF(YLfixnumG),Ynil);
  fun_GG_87 = YPmet(FUNCODEREF(fun_GG_87),LITREF(lit_161),T136,ENVNUL,PNUL,YPfalse);
  ...
  lit_163 = YPPsym((P)">>>");
  lit_164 = YPPlist(2,YPPsym((P)"x"),YPPsym((P)"a"));
  T141 = YPsig(LITREF(lit_164),YPPlist(2,VARREF(YLfixnumG),VARREF(YLfixnumG)),YPfalse,YPint((P)2),VARREF(YLfixnumG),Ynil);
  fun_GGG_88 = YPmet(FUNCODEREF(fun_GGG_88),LITREF(lit_163),T141,ENVNUL,PNUL,YPfalse);
  ...
  lit_165 = YPPsym((P)"<<");
  lit_166 = YPPlist(2,YPPsym((P)"x"),YPPsym((P)"a"));
  T146 = YPsig(LITREF(lit_166),YPPlist(2,VARREF(YLfixnumG),VARREF(YLfixnumG)),YPfalse,YPint((P)2),VARREF(YLfixnumG),Ynil);
  fun_LL_89 = YPmet(FUNCODEREF(fun_LL_89),LITREF(lit_165),T146,ENVNUL,PNUL,YPfalse);
  ...
  lit_167 = YPPsym((P)"power-of-two-ceil");
  lit_168 = YPPlist(1,YPPsym((P)"x"));
  lit_169 = YPPsym((P)"search");
  lit_170 = YPPlist(1,YPPsym((P)"po2"));
  T152 = YPsig(LITREF(lit_170),YPPlist(1,VARREF(YLintG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_search_90 = YPmet(FUNCODEREF(fun_search_90),LITREF(lit_169),T152,ENVNUL,PNUL,YPfalse);
  T151 = YPsig(LITREF(lit_168),YPPlist(1,VARREF(YLintG)),YPfalse,YPint((P)1),VARREF(YLintG),Ynil);
  fun_power_of_two_ceil_91 = YPmet(FUNCODEREF(fun_power_of_two_ceil_91),LITREF(lit_167),T151,ENVNUL,PNUL,YPfalse);
  ...
  lit_171 = YPPsym((P)"flo-bits");
  lit_172 = YPPlist(1,YPPsym((P)"x"));
  T157 = YPsig(LITREF(lit_172),YPPlist(1,VARREF(YLfloG)),YPfalse,YPint((P)1),VARREF(YLintG),Ynil);
  YgooSmathYflo_bits = YPmet(FUNCODEREF(YgooSmathYflo_bits),LITREF(lit_171),T157,ENVNUL,PNUL,YPfalse);
  T158 = YgooSmathYflo_bits;
  VARSET(YgooSmathYflo_bits,T158);
  lit_173 = YPPlist(2,YPPsym((P)"_"),YPPsym((P)"x"));
  T160 = XCALL1(1,VARREF(YgooStypesYtE),VARREF(YLfloG));
  T159 = YPsig(LITREF(lit_173),YPPlist(2,T160,VARREF(YLfixnumG)),YPfalse,YPint((P)2),VARREF(YLfloG),Ynil);
  fun_as_93 = YPmet(FUNCODEREF(fun_as_93),LITREF(lit_11),T159,ENVNUL,PNUL,YPfalse);
  ...
  T165 = YPsig(LITREF(lit_174),YPPlist(2,VARREF(YLfloG),VARREF(YLfloG)),YPfalse,YPint((P)2),VARREF(YLlogG),Ynil);
  fun_EE_94 = YPmet(FUNCODEREF(fun_EE_94),LITREF(lit_16),T165,ENVNUL,PNUL,YPfalse);
  ...
  T170 = YPsig(LITREF(lit_175),YPPlist(2,VARREF(YLfloG),VARREF(YLfloG)),YPfalse,YPint((P)2),VARREF(YLlogG),Ynil);
  fun_L_95 = YPmet(FUNCODEREF(fun_L_95),LITREF(lit_26),T170,ENVNUL,PNUL,YPfalse);
  ...
  T175 = YPsig(LITREF(lit_176),YPPlist(2,VARREF(YLfloG),VARREF(YLfloG)),YPfalse,YPint((P)2),VARREF(YLfloG),Ynil);
  fun_A_96 = YPmet(FUNCODEREF(fun_A_96),LITREF(lit_55),T175,ENVNUL,PNUL,YPfalse);
  ...
  T180 = YPsig(LITREF(lit_177),YPPlist(2,VARREF(YLfloG),VARREF(YLfloG)),YPfalse,YPint((P)2),VARREF(YLfloG),Ynil);
  fun___97 = YPmet(FUNCODEREF(fun___97),LITREF(lit_59),T180,ENVNUL,PNUL,YPfalse);
  ...
  T185 = YPsig(LITREF(lit_178),YPPlist(2,VARREF(YLfloG),VARREF(YLfloG)),YPfalse,YPint((P)2),VARREF(YLfloG),Ynil);
  fun_T_98 = YPmet(FUNCODEREF(fun_T_98),LITREF(lit_63),T185,ENVNUL,PNUL,YPfalse);
  ...
  T190 = YPsig(LITREF(lit_179),YPPlist(2,VARREF(YLfloG),VARREF(YLfloG)),YPfalse,YPint((P)2),VARREF(YLfloG),Ynil);
  fun_S_99 = YPmet(FUNCODEREF(fun_S_99),LITREF(lit_65),T190,ENVNUL,PNUL,YPfalse);
  ...
  T195 = YPsig(LITREF(lit_180),YPPlist(2,VARREF(YLfloG),VARREF(YLfloG)),YPfalse,YPint((P)2),T196,Ynil);
  fun_truncS_100 = YPmet(FUNCODEREF(fun_truncS_100),LITREF(lit_89),T195,ENVNUL,PNUL,YPfalse);
  ...
  lit_181 = YPPlist(2,YPPsym((P)"x"),YPPsym((P)"n"));
  T201 = YPsig(LITREF(lit_181),YPPlist(2,VARREF(YLfloG),VARREF(YLfloG)),YPfalse,YPint((P)2),VARREF(YLfloG),Ynil);
  fun_pow_101 = YPmet(FUNCODEREF(fun_pow_101),LITREF(lit_114),T201,ENVNUL,PNUL,YPfalse);
  ...
  lit_182 = YPflo(FLOINT(3.1415928));
  VARSET(YgooSmathYDpi,LITREF(lit_182));
  lit_183 = YPflo(FLOINT(2.7182816));
  VARSET(YgooSmathYDe,LITREF(lit_183));
  lit_184 = YPPsym((P)"isqrt");
  lit_185 = YPPlist(1,YPPsym((P)"x"));
  T206 = YPsig(LITREF(lit_185),YPPlist(1,VARREF(YLintG)),YPfalse,YPint((P)1),VARREF(YLintG),Ynil);
  fun_isqrt_102 = YPmet(FUNCODEREF(fun_isqrt_102),LITREF(lit_184),T206,ENVNUL,PNUL,YPfalse);
  ...
  lit_186 = YPPlist(1,YPPsym((P)"exp"));
  lit_187 = YPPlist(1,YPPsym((P)"return"));
  lit_188 = YPPsym((P)"x-1300");
  lit_189 = YPPlist(2,YPPsym((P)"msg"),YPPsym((P)"args"));
  lit_190 = YPPsym((P)"def-unary-trans");
  lit_191 = YPsb((P)"%f");
  lit_192 = YPPsym((P)"seq");
  lit_193 = YPPsym((P)"dg");
  lit_194 = YPPsym((P)"<num>");
  lit_195 = YPPsym((P)"=>");
  lit_196 = YPPsym((P)"dm");
  lit_197 = YPPsym((P)"<int>");
  lit_198 = YPPsym((P)"<flo>");
  lit_199 = YPPsym((P)"%fb");
  lit_200 = YPPsym((P)"%fu");
  T213 = YPsig(LITREF(lit_189),YPPlist(1,VARREF(YLstrG)),YPtrue,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_x_1300_103 = YPmet(FUNCODEREF(fun_x_1300_103),LITREF(lit_188),T213,ENVNUL,PNUL,YPfalse);
  T212 = YPsig(LITREF(lit_187),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_104 = YPmet(FUNCODEREF(fun_104),YPfalse,T212,ENVNUL,PNUL,YPfalse);
  T211 = YPsig(LITREF(lit_186),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_105 = YPmet(FUNCODEREF(fun_105),YPfalse,T211,ENVNUL,PNUL,YPfalse);
  T214 = fun_105;
  YPmacro(YPPsym((P)"goo/math"),YPPsym((P)"def-unary-trans"),T214);
  lit_201 = YPPsym((P)"sqrt");
  lit_202 = YPPlist(1,YPPsym((P)"x"));
  T216 = YPsig(LITREF(lit_202),YPPlist(1,VARREF(YLnumG)),YPfalse,YPint((P)1),VARREF(YLnumG),Ynil);
  T215 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_201),T216,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooSmathYsqrt,T215);
  lit_203 = YPPlist(1,YPPsym((P)"x"));
  lit_204 = YPsb((P)"SQRT would produce complex number");
  T217 = YPsig(LITREF(lit_203),YPPlist(1,VARREF(YLintG)),YPfalse,YPint((P)1),VARREF(YLfloG),Ynil);
  fun_sqrt_106 = YPmet(FUNCODEREF(fun_sqrt_106),LITREF(lit_201),T217,ENVNUL,PNUL,YPfalse);
  ...
  T222 = YPsig(LITREF(lit_205),YPPlist(1,VARREF(YLfloG)),YPfalse,YPint((P)1),VARREF(YLfloG),Ynil);
  fun_sqrt_107 = YPmet(FUNCODEREF(fun_sqrt_107),LITREF(lit_201),T222,ENVNUL,PNUL,YPfalse);
  ...
  lit_206 = YPPsym((P)"log");
  lit_207 = YPPlist(1,YPPsym((P)"x"));
  T228 = YPsig(LITREF(lit_207),YPPlist(1,VARREF(YLnumG)),YPfalse,YPint((P)1),VARREF(YLnumG),Ynil);
  T227 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_206),T228,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooSmathYlog,T227);
  lit_208 = YPPlist(1,YPPsym((P)"x"));
  T229 = YPsig(LITREF(lit_208),YPPlist(1,VARREF(YLintG)),YPfalse,YPint((P)1),VARREF(YLfloG),Ynil);
  fun_log_108 = YPmet(FUNCODEREF(fun_log_108),LITREF(lit_206),T229,ENVNUL,PNUL,YPfalse);
  ...
  T234 = YPsig(LITREF(lit_209),YPPlist(1,VARREF(YLfloG)),YPfalse,YPint((P)1),VARREF(YLfloG),Ynil);
  fun_log_109 = YPmet(FUNCODEREF(fun_log_109),LITREF(lit_206),T234,ENVNUL,PNUL,YPfalse);
  ...
  lit_210 = YPPsym((P)"sin");
  lit_211 = YPPlist(1,YPPsym((P)"x"));
  T240 = YPsig(LITREF(lit_211),YPPlist(1,VARREF(YLnumG)),YPfalse,YPint((P)1),VARREF(YLnumG),Ynil);
  T239 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_210),T240,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooSmathYsin,T239);
  lit_212 = YPPlist(1,YPPsym((P)"x"));
  T241 = YPsig(LITREF(lit_212),YPPlist(1,VARREF(YLintG)),YPfalse,YPint((P)1),VARREF(YLfloG),Ynil);
  fun_sin_110 = YPmet(FUNCODEREF(fun_sin_110),LITREF(lit_210),T241,ENVNUL,PNUL,YPfalse);
  ...
  T246 = YPsig(LITREF(lit_213),YPPlist(1,VARREF(YLfloG)),YPfalse,YPint((P)1),VARREF(YLfloG),Ynil);
  fun_sin_111 = YPmet(FUNCODEREF(fun_sin_111),LITREF(lit_210),T246,ENVNUL,PNUL,YPfalse);
  ...
  lit_214 = YPPsym((P)"cos");
  lit_215 = YPPlist(1,YPPsym((P)"x"));
  T252 = YPsig(LITREF(lit_215),YPPlist(1,VARREF(YLnumG)),YPfalse,YPint((P)1),VARREF(YLnumG),Ynil);
  T251 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_214),T252,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooSmathYcos,T251);
  lit_216 = YPPlist(1,YPPsym((P)"x"));
  T253 = YPsig(LITREF(lit_216),YPPlist(1,VARREF(YLintG)),YPfalse,YPint((P)1),VARREF(YLfloG),Ynil);
  fun_cos_112 = YPmet(FUNCODEREF(fun_cos_112),LITREF(lit_214),T253,ENVNUL,PNUL,YPfalse);
  ...
  T258 = YPsig(LITREF(lit_217),YPPlist(1,VARREF(YLfloG)),YPfalse,YPint((P)1),VARREF(YLfloG),Ynil);
  fun_cos_113 = YPmet(FUNCODEREF(fun_cos_113),LITREF(lit_214),T258,ENVNUL,PNUL,YPfalse);
  ...
  lit_218 = YPPsym((P)"tan");
  lit_219 = YPPlist(1,YPPsym((P)"x"));
  T264 = YPsig(LITREF(lit_219),YPPlist(1,VARREF(YLnumG)),YPfalse,YPint((P)1),VARREF(YLnumG),Ynil);
  T263 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_218),T264,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooSmathYtan,T263);
  lit_220 = YPPlist(1,YPPsym((P)"x"));
  T265 = YPsig(LITREF(lit_220),YPPlist(1,VARREF(YLintG)),YPfalse,YPint((P)1),VARREF(YLfloG),Ynil);
  fun_tan_114 = YPmet(FUNCODEREF(fun_tan_114),LITREF(lit_218),T265,ENVNUL,PNUL,YPfalse);
  ...
  T270 = YPsig(LITREF(lit_221),YPPlist(1,VARREF(YLfloG)),YPfalse,YPint((P)1),VARREF(YLfloG),Ynil);
  fun_tan_115 = YPmet(FUNCODEREF(fun_tan_115),LITREF(lit_218),T270,ENVNUL,PNUL,YPfalse);
  ...
  lit_222 = YPPsym((P)"sinh");
  lit_223 = YPPlist(1,YPPsym((P)"x"));
  T276 = YPsig(LITREF(lit_223),YPPlist(1,VARREF(YLnumG)),YPfalse,YPint((P)1),VARREF(YLnumG),Ynil);
  T275 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_222),T276,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooSmathYsinh,T275);
  lit_224 = YPPlist(1,YPPsym((P)"x"));
  T277 = YPsig(LITREF(lit_224),YPPlist(1,VARREF(YLintG)),YPfalse,YPint((P)1),VARREF(YLfloG),Ynil);
  fun_sinh_116 = YPmet(FUNCODEREF(fun_sinh_116),LITREF(lit_222),T277,ENVNUL,PNUL,YPfalse);
  ...
  T282 = YPsig(LITREF(lit_225),YPPlist(1,VARREF(YLfloG)),YPfalse,YPint((P)1),VARREF(YLfloG),Ynil);
  fun_sinh_117 = YPmet(FUNCODEREF(fun_sinh_117),LITREF(lit_222),T282,ENVNUL,PNUL,YPfalse);
  ...
  lit_226 = YPPsym((P)"cosh");
  lit_227 = YPPlist(1,YPPsym((P)"x"));
  T288 = YPsig(LITREF(lit_227),YPPlist(1,VARREF(YLnumG)),YPfalse,YPint((P)1),VARREF(YLnumG),Ynil);
  T287 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_226),T288,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooSmathYcosh,T287);
  lit_228 = YPPlist(1,YPPsym((P)"x"));
  T291 = YPsig(LITREF(lit_228),YPPlist(1,VARREF(YLintG)),YPfalse,YPint((P)1),VARREF(YLfloG),Ynil);
  T290 = fun_cosh_118 = YPmet(FUNCODEREF(fun_cosh_118),LITREF(lit_226),T291,ENVNUL,PNUL,YPfalse);
...
loop:
  ...
  T0 = YPsig(LITREF(lit_229),YPPlist(1,VARREF(YLfloG)),YPfalse,YPint((P)1),VARREF(YLfloG),Ynil);
  fun_cosh_119 = YPmet(FUNCODEREF(fun_cosh_119),LITREF(lit_226),T0,ENVNUL,PNUL,YPfalse);
  ...
  lit_230 = YPPsym((P)"tanh");
  lit_231 = YPPlist(1,YPPsym((P)"x"));
  T6 = YPsig(LITREF(lit_231),YPPlist(1,VARREF(YLnumG)),YPfalse,YPint((P)1),VARREF(YLnumG),Ynil);
  T5 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_230),T6,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooSmathYtanh,T5);
  lit_232 = YPPlist(1,YPPsym((P)"x"));
  T7 = YPsig(LITREF(lit_232),YPPlist(1,VARREF(YLintG)),YPfalse,YPint((P)1),VARREF(YLfloG),Ynil);
  fun_tanh_120 = YPmet(FUNCODEREF(fun_tanh_120),LITREF(lit_230),T7,ENVNUL,PNUL,YPfalse);
  ...
  T12 = YPsig(LITREF(lit_233),YPPlist(1,VARREF(YLfloG)),YPfalse,YPint((P)1),VARREF(YLfloG),Ynil);
  fun_tanh_121 = YPmet(FUNCODEREF(fun_tanh_121),LITREF(lit_230),T12,ENVNUL,PNUL,YPfalse);
  ...
  lit_234 = YPPsym((P)"asin");
  lit_235 = YPPlist(1,YPPsym((P)"x"));
  T18 = YPsig(LITREF(lit_235),YPPlist(1,VARREF(YLnumG)),YPfalse,YPint((P)1),VARREF(YLnumG),Ynil);
  T17 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_234),T18,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooSmathYasin,T17);
  lit_236 = YPPlist(1,YPPsym((P)"x"));
  lit_237 = YPsb((P)"SQRT would produce complex number");
  T19 = YPsig(LITREF(lit_236),YPPlist(1,VARREF(YLintG)),YPfalse,YPint((P)1),VARREF(YLfloG),Ynil);
  fun_asin_122 = YPmet(FUNCODEREF(fun_asin_122),LITREF(lit_234),T19,ENVNUL,PNUL,YPfalse);
  ...
  T24 = YPsig(LITREF(lit_238),YPPlist(1,VARREF(YLfloG)),YPfalse,YPint((P)1),VARREF(YLfloG),Ynil);
  fun_asin_123 = YPmet(FUNCODEREF(fun_asin_123),LITREF(lit_234),T24,ENVNUL,PNUL,YPfalse);
  ...
  lit_239 = YPPsym((P)"acos");
  lit_240 = YPPlist(1,YPPsym((P)"x"));
  T30 = YPsig(LITREF(lit_240),YPPlist(1,VARREF(YLnumG)),YPfalse,YPint((P)1),VARREF(YLnumG),Ynil);
  T29 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_239),T30,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooSmathYacos,T29);
  lit_241 = YPPlist(1,YPPsym((P)"x"));
  lit_242 = YPsb((P)"SQRT would produce complex number");
  T31 = YPsig(LITREF(lit_241),YPPlist(1,VARREF(YLintG)),YPfalse,YPint((P)1),VARREF(YLfloG),Ynil);
  fun_acos_124 = YPmet(FUNCODEREF(fun_acos_124),LITREF(lit_239),T31,ENVNUL,PNUL,YPfalse);
  ...
  T36 = YPsig(LITREF(lit_243),YPPlist(1,VARREF(YLfloG)),YPfalse,YPint((P)1),VARREF(YLfloG),Ynil);
  fun_acos_125 = YPmet(FUNCODEREF(fun_acos_125),LITREF(lit_239),T36,ENVNUL,PNUL,YPfalse);
  ...
  lit_244 = YPPsym((P)"atan");
  lit_245 = YPPlist(1,YPPsym((P)"x"));
  T42 = YPsig(LITREF(lit_245),YPPlist(1,VARREF(YLnumG)),YPfalse,YPint((P)1),VARREF(YLnumG),Ynil);
  T41 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_244),T42,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooSmathYatan,T41);
  lit_246 = YPPlist(1,YPPsym((P)"x"));
  T43 = YPsig(LITREF(lit_246),YPPlist(1,VARREF(YLintG)),YPfalse,YPint((P)1),VARREF(YLfloG),Ynil);
  fun_atan_126 = YPmet(FUNCODEREF(fun_atan_126),LITREF(lit_244),T43,ENVNUL,PNUL,YPfalse);
  ...
  T48 = YPsig(LITREF(lit_247),YPPlist(1,VARREF(YLfloG)),YPfalse,YPint((P)1),VARREF(YLfloG),Ynil);
  fun_atan_127 = YPmet(FUNCODEREF(fun_atan_127),LITREF(lit_244),T48,ENVNUL,PNUL,YPfalse);
  ...
  lit_248 = YPPlist(2,YPPsym((P)"y"),YPPsym((P)"x"));
  T54 = YPsig(LITREF(lit_248),YPPlist(2,VARREF(YLnumG),VARREF(YLnumG)),YPfalse,YPint((P)2),VARREF(YLnumG),Ynil);
  ...
  T55 = YPsig(LITREF(lit_249),YPPlist(2,VARREF(YLfloG),VARREF(YLfloG)),YPfalse,YPint((P)2),VARREF(YLfloG),Ynil);
  fun_atan2_128 = YPmet(FUNCODEREF(fun_atan2_128),LITREF(lit_67),T55,ENVNUL,PNUL,YPfalse);
  ...
  T60 = YPsig(LITREF(lit_250),YPPlist(2,VARREF(YLfloG),VARREF(YLfloG)),YPfalse,YPint((P)2),VARREF(YLfloG),Ynil);
  fun_atan2_129 = YPmet(FUNCODEREF(fun_atan2_129),LITREF(lit_67),T60,ENVNUL,PNUL,YPfalse);
  ...
  lit_251 = YPPlist(2,YPPsym((P)"x"),YPPsym((P)"b"));
  T66 = YPsig(LITREF(lit_251),YPPlist(2,VARREF(YLnumG),VARREF(YLnumG)),YPfalse,YPint((P)2),VARREF(YLnumG),Ynil);
  ...
  T67 = YPsig(LITREF(lit_252),YPPlist(2,VARREF(YLnumG),VARREF(YLnumG)),YPfalse,YPint((P)2),VARREF(YLnumG),Ynil);
  fun_logn_130 = YPmet(FUNCODEREF(fun_logn_130),LITREF(lit_69),T67,ENVNUL,PNUL,YPfalse);
