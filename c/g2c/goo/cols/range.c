...
LINK_STACK();
  ...
  cF3676 = T5;
  T4 = CALL1(1,VARREF(YgooScolsSrangeYrange_inQ),cF3676);
  T2 = CALL1(1,VARREF(YgooScolsSrangeYPval),e_);
  T3 = CALL1(1,VARREF(YgooScolsSrangeYrange_lim),cF3676);
  T1 = CALL2(1,T4,T2,T3);
...
LINK_STACK();
  ...
  T0 = CALL1(1,T2,T1);
  CALL2(1,VARREF(YgooScolsSrangeYPval_setter),T0,x_1434F3677);
  T5 = CALL1(1,VARREF(YgooScolsSrangeYPkey),e_);
  T4 = CALL2(1,VARREF(YgooSmathYA),T5,YPint((P)1));
  CALL2(1,VARREF(YgooScolsSrangeYPkey_setter),T4,x_1434F3677);
UNLINK_STACK();
  RET(x_1434F3677);
}
...
DEFCREGS();
  ...
  fun_range_from_0 = YPfab_met(FUNCODEREF(fun_range_from_0),T10,LITREF(lit_9),LITREF(lit_10),sloc(30),YPsb((P)"(fun ((_x <range>)) (prop-value _x range-from))"));
  ...
  fun_1 = YPfab_met(FUNCODEREF(fun_1),T14,YPfalse,LITREF(lit_11),sloc(30),YPsb((P)"(fun ((_x <any>)) 0)"));
  T15 = fun_1;
  ...
  fun_range_inQ_2 = YPfab_met(FUNCODEREF(fun_range_inQ_2),T16,LITREF(lit_12),LITREF(lit_13),sloc(31),YPsb((P)"(fun ((_x <range>)) (prop-value _x range-in?))"));
  ...
  fun_3 = YPfab_met(FUNCODEREF(fun_3),T20,YPfalse,LITREF(lit_14),sloc(31),YPsb((P)"(fun ((_x <any>)) <)"));
  T21 = fun_3;
  ...
  fun_range_lim_4 = YPfab_met(FUNCODEREF(fun_range_lim_4),T22,LITREF(lit_15),LITREF(lit_16),sloc(32),YPsb((P)"(fun ((_x <range>)) (prop-value _x range-lim))"));
  ...
  fun_5 = YPfab_met(FUNCODEREF(fun_5),T26,YPfalse,LITREF(lit_17),sloc(32),YPsb((P)"(fun ((_x <any>)) #f)"));
  ...
  fun_range_nxt_6 = YPfab_met(FUNCODEREF(fun_range_nxt_6),T29,LITREF(lit_18),LITREF(lit_19),sloc(33),YPsb((P)"(fun ((_x <range>)) (prop-value _x range-nxt))"));
  ...
  fun_7 = YPfab_met(FUNCODEREF(fun_7),T33,YPfalse,LITREF(lit_20),sloc(33),YPsb((P)"(fun ((_x <any>)) 1+)"));
  T34 = fun_7;
  ...
  fun_fab_8 = YPfab_met(FUNCODEREF(fun_fab_8),T35,LITREF(lit_21),LITREF(lit_22),sloc(35),YPsb((P)"(fun ((c (t= <range>)) (s <int>) => <range>) (range 0 < s 1+))"));
  ...
  fun_range_9 = YPfab_met(FUNCODEREF(fun_range_9),T40,LITREF(lit_1),LITREF(lit_23),sloc(38),YPsb((P)"(fun ((from <num>) (in? <fun>) (lim <num>) => <range>) (new <range> range-from from range-in? in? range-lim lim))"));
  ...
  fun_range_by_10 = YPfab_met(FUNCODEREF(fun_range_by_10),T44,LITREF(lit_3),LITREF(lit_24),sloc(41),YPsb((P)"(fun ((from <num>) (in? <fun>) (lim <num>) (nxt <fun>) => <range>) (new <range> range-from from range-in? in? range-lim lim range-nxt nxt))"));
  ...
  fun_from_11 = YPfab_met(FUNCODEREF(fun_from_11),T48,LITREF(lit_5),LITREF(lit_25),sloc(44),YPsb((P)"(fun ((from <num>) => <range>) (new <range> range-from from range-in? (always #t)))"));
  ...
  fun_below_12 = YPfab_met(FUNCODEREF(fun_below_12),T52,LITREF(lit_7),LITREF(lit_26),sloc(47),YPsb((P)"(fun ((lim <num>) => <range>) (new <range> range-lim lim))"));
  ...
  fun_col_res_type_13 = YPfab_met(FUNCODEREF(fun_col_res_type_13),T56,LITREF(lit_27),LITREF(lit_28),sloc(50),YPsb((P)"(fun ((x <range>) => <type>) <lst>)"));
  ...
  fun_Pdat_14 = YPfab_met(FUNCODEREF(fun_Pdat_14),T62,LITREF(lit_30),LITREF(lit_31),sloc(54),YPsb((P)"(fun ((_x <range-enum>)) (prop-value _x %dat))"));
  ...
  fun_Pval_15 = YPfab_met(FUNCODEREF(fun_Pval_15),T66,LITREF(lit_32),LITREF(lit_33),sloc(55),YPsb((P)"(fun ((_x <range-enum>)) (prop-value _x %val))"));
  ...
  fun_Pval_setter_16 = YPfab_met(FUNCODEREF(fun_Pval_setter_16),T70,LITREF(lit_34),LITREF(lit_35),sloc(55),YPsb((P)"(fun ((_z <num>) (_x <range-enum>)) (prop-value-setter _z _x %val))"));
  ...
  fun_Pkey_17 = YPfab_met(FUNCODEREF(fun_Pkey_17),T74,LITREF(lit_36),LITREF(lit_37),sloc(56),YPsb((P)"(fun ((_x <range-enum>)) (prop-value _x %key))"));
  ...
  T79 = fun_Pkey_setter_18 = YPfab_met(FUNCODEREF(fun_Pkey_setter_18),T80,LITREF(lit_38),LITREF(lit_39),sloc(56),YPsb((P)"(fun ((_z <int>) (_x <range-enum>)) (prop-value-setter _z _x %key))"));
...
DEFCREGS();
  ...
  fun_enum_19 = YPfab_met(FUNCODEREF(fun_enum_19),T0,LITREF(lit_40),LITREF(lit_41),sloc(58),YPsb((P)"(fun ((x <range>) => <range-enum>) (new <range-enum> %dat x %val (range-from x) %key 0))"));
  ...
  fun_finQ_20 = YPfab_met(FUNCODEREF(fun_finQ_20),T4,LITREF(lit_42),LITREF(lit_43),sloc(61),YPsb((P)"(fun ((e <range-enum>) => <log>) (def c (%dat e)) (not ((range-in? c) (%val e) (range-lim c))))"));
  ...
  fun_nxt_21 = YPfab_met(FUNCODEREF(fun_nxt_21),T8,LITREF(lit_44),LITREF(lit_45),sloc(65),YPsb((P)"(fun ((e <range-enum>) => <range-enum>) (renew e %val ((range-nxt (%dat e)) (%val e)) %key (+ (%key e) 1)))"));
  ...
  fun_now_22 = YPfab_met(FUNCODEREF(fun_now_22),T12,LITREF(lit_46),LITREF(lit_47),sloc(68),YPsb((P)"(fun ((e <range-enum>) => <num>) (%val e))"));
  ...
  T17 = fun_now_key_23 = YPfab_met(FUNCODEREF(fun_now_key_23),T18,LITREF(lit_48),LITREF(lit_49),sloc(71),YPsb((P)"(fun ((e <range-enum>) => <int>) (%key e))"));
