...
loop:
  ...
  cF2161 = T1;
  T6 = CALL1(1,VARREF(YgooScolsSrangeYrange_inQ),cF2161);
  T4 = CALL1(1,VARREF(YgooScolsSrangeYPval),e_);
  T5 = CALL1(1,VARREF(YgooScolsSrangeYrange_lim),cF2161);
  T3 = CALL2(1,T6,T4,T5);
...
loop:
  ...
  T1 = CALL1(1,T3,T2);
  CALL2(1,VARREF(YgooScolsSrangeYPval_setter),T1,x_1384F2162);
  T6 = CALL1(1,VARREF(YgooScolsSrangeYPkey),e_);
  T5 = CALL2(1,VARREF(YgooSmathYA),T6,YPint((P)1));
  CALL2(1,VARREF(YgooScolsSrangeYPkey_setter),T5,x_1384F2162);
  T0 = x_1384F2162;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  fun_range_from_0 = YPmet(FUNCODEREF(fun_range_from_0),LITREF(lit_9),T10,ENVNUL,PNUL,YPfalse);
  ...
  fun_range_from_setter_1 = YPmet(FUNCODEREF(fun_range_from_setter_1),LITREF(lit_11),T15,ENVNUL,PNUL,YPfalse);
  ...
  fun_range_inQ_3 = YPmet(FUNCODEREF(fun_range_inQ_3),LITREF(lit_14),T22,ENVNUL,PNUL,YPfalse);
  ...
  fun_range_inQ_setter_4 = YPmet(FUNCODEREF(fun_range_inQ_setter_4),LITREF(lit_16),T27,ENVNUL,PNUL,YPfalse);
  ...
  fun_range_lim_6 = YPmet(FUNCODEREF(fun_range_lim_6),LITREF(lit_19),T34,ENVNUL,PNUL,YPfalse);
  ...
  fun_range_lim_setter_7 = YPmet(FUNCODEREF(fun_range_lim_setter_7),LITREF(lit_21),T39,ENVNUL,PNUL,YPfalse);
  ...
  fun_range_nxt_9 = YPmet(FUNCODEREF(fun_range_nxt_9),LITREF(lit_24),T48,ENVNUL,PNUL,YPfalse);
  ...
  fun_range_nxt_setter_10 = YPmet(FUNCODEREF(fun_range_nxt_setter_10),LITREF(lit_26),T53,ENVNUL,PNUL,YPfalse);
  ...
  fun_fab_12 = YPmet(FUNCODEREF(fun_fab_12),LITREF(lit_29),T60,ENVNUL,PNUL,YPfalse);
  ...
  fun_range_by_14 = YPmet(FUNCODEREF(fun_range_by_14),LITREF(lit_3),T71,ENVNUL,PNUL,YPfalse);
  ...
  fun_from_15 = YPmet(FUNCODEREF(fun_from_15),LITREF(lit_5),T76,ENVNUL,PNUL,YPfalse);
  ...
  fun_col_res_type_17 = YPmet(FUNCODEREF(fun_col_res_type_17),LITREF(lit_35),T86,ENVNUL,PNUL,YPfalse);
  ...
  fun_Pdat_18 = YPmet(FUNCODEREF(fun_Pdat_18),LITREF(lit_38),T93,ENVNUL,PNUL,YPfalse);
  ...
  fun_Pdat_setter_19 = YPmet(FUNCODEREF(fun_Pdat_setter_19),LITREF(lit_40),T98,ENVNUL,PNUL,YPfalse);
  ...
  fun_Pval_20 = YPmet(FUNCODEREF(fun_Pval_20),LITREF(lit_42),T103,ENVNUL,PNUL,YPfalse);
  ...
  fun_Pval_setter_21 = YPmet(FUNCODEREF(fun_Pval_setter_21),LITREF(lit_44),T108,ENVNUL,PNUL,YPfalse);
  ...
  fun_Pkey_22 = YPmet(FUNCODEREF(fun_Pkey_22),LITREF(lit_46),T113,ENVNUL,PNUL,YPfalse);
  ...
  fun_Pkey_setter_23 = YPmet(FUNCODEREF(fun_Pkey_setter_23),LITREF(lit_48),T118,ENVNUL,PNUL,YPfalse);
  ...
  fun_enum_24 = YPmet(FUNCODEREF(fun_enum_24),LITREF(lit_50),T123,ENVNUL,PNUL,YPfalse);
  ...
  fun_finQ_25 = YPmet(FUNCODEREF(fun_finQ_25),LITREF(lit_52),T128,ENVNUL,PNUL,YPfalse);
  ...
  fun_nxt_26 = YPmet(FUNCODEREF(fun_nxt_26),LITREF(lit_54),T133,ENVNUL,PNUL,YPfalse);
  ...
  fun_now_27 = YPmet(FUNCODEREF(fun_now_27),LITREF(lit_56),T138,ENVNUL,PNUL,YPfalse);
  ...
  T144 = fun_now_key_28 = YPmet(FUNCODEREF(fun_now_key_28),LITREF(lit_58),T145,ENVNUL,PNUL,YPfalse);
