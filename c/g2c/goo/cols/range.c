...
LINK_STACK();
  ...
  cF2427 = T1;
  T6 = CALL1(1,VARREF(YgooScolsSrangeYrange_inQ),cF2427);
  T4 = CALL1(1,VARREF(YgooScolsSrangeYPval),e_);
  T5 = CALL1(1,VARREF(YgooScolsSrangeYrange_lim),cF2427);
  T3 = CALL2(1,T6,T4,T5);
...
LINK_STACK();
  ...
  T1 = CALL1(1,T3,T2);
  CALL2(1,VARREF(YgooScolsSrangeYPval_setter),T1,x_1388F2428);
  T6 = CALL1(1,VARREF(YgooScolsSrangeYPkey),e_);
  T5 = CALL2(1,VARREF(YgooSmathYA),T6,YPint((P)1));
  CALL2(1,VARREF(YgooScolsSrangeYPkey_setter),T5,x_1388F2428);
  T0 = x_1388F2428;
UNLINK_STACK();
  RET(T0);
}
