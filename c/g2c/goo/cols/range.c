...
LINK_STACK();
  ...
  cF2385 = T5;
  T4 = CALL1(1,VARREF(YgooScolsSrangeYrange_inQ),cF2385);
  T2 = CALL1(1,VARREF(YgooScolsSrangeYPval),e_);
  T3 = CALL1(1,VARREF(YgooScolsSrangeYrange_lim),cF2385);
  T1 = CALL2(1,T4,T2,T3);
...
LINK_STACK();
  ...
  T0 = CALL1(1,T2,T1);
  CALL2(1,VARREF(YgooScolsSrangeYPval_setter),T0,x_1388F2386);
  T5 = CALL1(1,VARREF(YgooScolsSrangeYPkey),e_);
  T4 = CALL2(1,VARREF(YgooSmathYA),T5,YPint((P)1));
  CALL2(1,VARREF(YgooScolsSrangeYPkey_setter),T4,x_1388F2386);
UNLINK_STACK();
  RET(x_1388F2386);
}
