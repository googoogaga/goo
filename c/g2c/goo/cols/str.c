...
loop:
  ...
  loopF1126 = T1;
  FUNINIT(loopF1126, 3,s_,FREEREF(0),loopF1126);
  T2 = CALL2(0,loopF1126,i_,YPint((P)0));
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    cF1128 = T4;
    if (cF1128 != YPfalse) {
      T7 = CALL1(1,VARREF(YgooScolsSstrYchar_Ginteger),cF1128);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    loopF1130 = T8;
    FUNINIT(loopF1130, 4,FREEREF(0),least_,vF1129,loopF1130);
    T9 = CALL1(0,loopF1130,YPint((P)0));
    T7 = T9;
    T2 = T7;
    T0 = T2;
  } else {
    ...
    cF1131 = T11;
    if (cF1131 != YPfalse) {
      T14 = CALL1(1,VARREF(YgooScolsSstrYchar_Ginteger),cF1131);
      nF1132 = T14;
      T16 = CALL2(1,VARREF(YgooSmathYA),i_,YPint((P)1));
      if (least_ != YPfalse) {
        T18 = CALL2(1,VARREF(YgooSmagYmin),least_,nF1132);
        T17 = T18;
      } else {
        T17 = nF1132;
      }
      if (greatest_ != YPfalse) {
        T20 = CALL2(1,VARREF(YgooSmagYmax),greatest_,nF1132);
        T19 = T20;
      } else {
        T19 = nF1132;
      }
...
loop:
  ...
  failXXF1135 = T1;
  FUNINIT(failXXF1135, 1,return_);
  T3 = BOXVAL(FREEREF(0));
  T2 = CALL2(1,VARREF(YgooSmagYGE),T3,FREEREF(1));
  if (T2 != YPfalse) {
    T4 = CALL0(0,failXXF1135);
  } else {
  }
  T7 = BOXVAL(FREEREF(0));
  T6 = CALL2(1,VARREF(YgooSmacrosYelt),FREEREF(2),T7);
  charF1136 = T6;
  charF1136 = BOXFAB(charF1136);
  T10 = BOXVAL(charF1136);
...
FUNCODEDEF(fun_str_to_num_25) {
  ...
  P tmpF1151;
  P tmpF1150;
  P looking_at_alphaQF1149;
  P match_digitXF1148;
  P matchF1147;
  P radixF1146;
  P seen_decimal_pointQF1145;
  P lengthF1144;
  P scaleF1143;
  P iF1142;
  P nF1141;
...
loop:
  sF1139 = YPint((P)1);
  sF1139 = BOXFAB(sF1139);
  dF1140 = YPint((P)0);
  dF1140 = BOXFAB(dF1140);
  nF1141 = YPint((P)0);
  nF1141 = BOXFAB(nF1141);
  iF1142 = YPint((P)0);
  iF1142 = BOXFAB(iF1142);
  scaleF1143 = YPint((P)1);
  scaleF1143 = BOXFAB(scaleF1143);
  T11 = CALL1(1,VARREF(YgooStypesYlen),string_);
  lengthF1144 = T11;
  seen_decimal_pointQF1145 = YPfalse;
  seen_decimal_pointQF1145 = BOXFAB(seen_decimal_pointQF1145);
  radixF1146 = YPint((P)10);
  T16 = FUNSHELL(1,fun_match_19,3);
  matchF1147 = T16;
  T17 = FUNSHELL(1,fun_match_digitX_22,7);
  match_digitXF1148 = T17;
  T18 = FUNSHELL(1,fun_looking_at_alphaQ_23,3);
  looking_at_alphaQF1149 = T18;
  FUNINIT(matchF1147, 3,iF1142,lengthF1144,string_);
  FUNINIT(match_digitXF1148, 7,iF1142,lengthF1144,string_,seen_decimal_pointQF1145,dF1140,scaleF1143,radixF1146);
  FUNINIT(looking_at_alphaQF1149, 3,iF1142,lengthF1144,string_);
  T21 = CALL1(0,matchF1147,YPchr((P)43));
  tmpF1150 = T21;
  if (tmpF1150 != YPfalse) {
    T22 = tmpF1150;
  } else {
    T25 = CALL1(0,matchF1147,YPchr((P)45));
    tmpF1151 = T25;
    if (tmpF1151 != YPfalse) {
      T27 = BOXVAL(sF1139) = YPint((P)-1);
      T26 = T27;
    } else {
      T26 = YPfalse;
    }
  ...
  if (tmpF1153 != YPfalse) {
    T33 = BOXVAL(dF1140);
    T32 = CALL1(0,match_digitXF1148,T33);
    tmpF1154 = T32;
    if (tmpF1154 != YPfalse) {
      T36 = BOXVAL(dF1140);
      T35 = BOXVAL(nF1141) = T36;
      T34 = T35;
    } else {
      T34 = YPfalse;
    }
    ...
    if (tmpF1155 != YPfalse) {
      ...
      loopF1156 = T40;
      FUNINIT(loopF1156, 5,dF1140,match_digitXF1148,nF1141,radixF1146,loopF1156);
      T41 = CALL0(0,loopF1156);
      T39 = T41;
      tmpF1157 = T39;
      if (tmpF1157 != YPfalse) {
        T45 = BOXVAL(iF1142);
        T44 = CALL2(1,VARREF(YgooSmathYE),T45,lengthF1144);
        tmpF1158 = T44;
        if (tmpF1158 != YPfalse) {
          T50 = BOXVAL(sF1139);
          ...
          fF1159 = T48;
          T57 = BOXVAL(seen_decimal_pointQF1145);
          if (T57 != YPfalse) {
            T56 = fF1159;
          } else {
            T58 = CALL1(1,VARREF(YgooSmathYtrunc),fF1159);
            T56 = T58;
          }
          T47 = T56;
          T46 = T47;
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    digitF1160 = T3;
    T6 = CALL2(1,VARREF(YgooSmacrosYpair),digitF1160,digit_list_);
...
loop:
  ...
  loopF1162 = T5;
  FUNINIT(loopF1162, 2,radix_,loopF1162);
  T7 = CALL2(1,VARREF(YgooSmathYT),num_,sF1161);
  T6 = CALL2(0,loopF1162,Ynil,T7);
  T4 = T6;
  digit_listF1163 = T4;
  T10 = CALL2(1,VARREF(YgooSmagYL),sF1161,YPint((P)0));
  if (T10 != YPfalse) {
    T11 = CALL2(1,VARREF(YgooSmacrosYpair),YPchr((P)45),digit_listF1163);
    T9 = T11;
  } else {
...
loop:
  ...
  iF1164 = T1;
  T4 = CALL2(1,VARREF(YgooSmathY_),p_,iF1164);
  T3 = CALL2(1,VARREF(YgooSmagYL),T4,VARREF(YgooScolsSstrYepsilon));
  if (T3 != YPfalse) {
    T5 = CALL2(1,VARREF(YgooScolsSstrYnum_to_str_base),iF1164,FREEREF(1));
    BOXVAL(FREEREF(0)) = T5;
    T2 = e_;
  } else {
...
loop:
  ...
  sF1165 = T1;
  T4 = CALL2(1,VARREF(YgooSmathYT),num_,sF1165);
  pF1166 = T4;
  stringF1167 = LITREF(lit_55);
  stringF1167 = BOXFAB(stringF1167);
  T9 = FUNSHELL(1,fun_loop_29,3);
  loopF1168 = T9;
  FUNINIT(loopF1168, 3,stringF1167,radix_,loopF1168);
  T10 = CALL2(0,loopF1168,pF1166,YPint((P)0));
  T8 = T10;
  eF1169 = T8;
  T13 = BOXVAL(stringF1167);
  T12 = CALL1(1,VARREF(YgooStypesYlen),T13);
  lengthF1170 = T12;
  T15 = CALL2(1,VARREF(YgooSmathYE),eF1169,YPint((P)0));
  if (T15 != YPfalse) {
    T17 = BOXVAL(stringF1167);
    T16 = CALL2(1,VARREF(YgooSmacrosYcat),T17,LITREF(lit_58));
    T14 = T16;
  } else {
    T19 = CALL2(1,VARREF(YgooSmathYE),eF1169,lengthF1170);
    if (T19 != YPfalse) {
      T21 = BOXVAL(stringF1167);
      T20 = CALL2(1,VARREF(YgooSmacrosYcat),LITREF(lit_59),T21);
      T18 = T20;
    } else {
      T23 = CALL2(1,VARREF(YgooSmagYL),eF1169,lengthF1170);
      if (T23 != YPfalse) {
        T26 = BOXVAL(stringF1167);
        T27 = CALL2(1,VARREF(YgooSmathY_),lengthF1170,eF1169);
        T25 = CALL3(1,VARREF(YgooScolsSseqYsub),T26,YPint((P)0),T27);
        T29 = BOXVAL(stringF1167);
        T30 = CALL2(1,VARREF(YgooSmathY_),lengthF1170,eF1169);
        T28 = CALL3(1,VARREF(YgooScolsSseqYsub),T29,T30,lengthF1170);
        T24 = CALL3(1,VARREF(YgooSmacrosYcat),T25,LITREF(lit_60),T28);
        T22 = T24;
      } else {
        T34 = CALL2(1,VARREF(YgooSmathY_),eF1169,lengthF1170);
        T33 = CALL2(1,VARREF(YgooSmathYA),T34,YPint((P)2));
        T32 = CALL3(1,VARREF(YgooScolsSseqYsub),LITREF(lit_61),YPint((P)0),T33);
        T35 = BOXVAL(stringF1167);
  ...
  BOXVAL(stringF1167) = T14;
  T37 = CALL2(1,VARREF(YgooSmagYL),sF1165,YPint((P)0));
  if (T37 != YPfalse) {
    T39 = BOXVAL(stringF1167);
    T38 = CALL2(1,VARREF(YgooSmacrosYcat),LITREF(lit_62),T39);
    T36 = T38;
  } else {
    T40 = BOXVAL(stringF1167);
    T36 = T40;
  }
  T11 = T36;
  T7 = T11;
...
loop:
  ...
  ascii_charsF1171 = T71;
  T74 = FUNFAB(fun_12,1,ascii_charsF1171);
  initF1172 = T74;
  CALL2(1,initF1172,YPint((P)9),LITREF(lit_28));
  CALL2(1,initF1172,YPint((P)10),LITREF(lit_29));
  CALL2(1,initF1172,YPint((P)12),LITREF(lit_30));
  CALL2(1,initF1172,YPint((P)13),LITREF(lit_31));
  CALL2(1,initF1172,YPint((P)32),LITREF(lit_32));
  CALL2(1,initF1172,YPint((P)64),LITREF(lit_33));
  CALL2(1,initF1172,YPint((P)96),LITREF(lit_34));
  T73 = ascii_charsF1171;
  T70 = T73;
  ...
  loopF1174 = T95;
  FUNINIT(loopF1174, 2,end259F1173,loopF1174);
  T96 = CALL3(0,loopF1174,YPint((P)0),YPfalse,YPfalse);
  T94 = T96;
  T92 = T94;
