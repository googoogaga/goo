...
loop:
  ...
  xF1711 = x_;
  iF1712 = i_;
  T2 = (P)YPopts_location(xF1711);
  xF1713 = iF1712;
  xF1714 = xF1713;
  T6 = (P)YPiGG(xF1714,(P)2);
  T5 = T6;
  T4 = T5;
  T3 = (P)YPi_((P)0,T4);
...
loop:
  xF1715 = x_;
  iF1716 = i_;
  T2 = (P)YPopts_location(xF1715);
  xF1717 = iF1716;
  xF1718 = xF1717;
  T6 = (P)YPiGG(xF1718,(P)2);
  T5 = T6;
  T4 = T5;
  T3 = (P)YPi_((P)0,T4);
  T1 = (P)YPloc_off(T2,T3);
...
loop:
  ...
  fun_to_str_3 = YPmet(FUNCODEREF(fun_to_str_3),LITREF(lit_6),T15,ENVNUL,PNUL,YPfalse);
