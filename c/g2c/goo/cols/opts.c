...
LINK_STACK();
  ...
  iF8201 = i_;
  xF8202 = xF8200;
  T1 = (P)YPprop_elt(xF8202,(P)0);
  xF8203 = iF8201;
  xF8204 = xF8203;
  T3 = (P)YPiGG(xF8204,(P)2);
  T2 = (P)YPi_((P)0,T3);
...
LINK_STACK();
  ...
  iF8206 = i_;
  xF8207 = xF8205;
  T1 = (P)YPprop_elt(xF8207,(P)0);
  xF8208 = iF8206;
  xF8209 = xF8208;
  T3 = (P)YPiGG(xF8209,(P)2);
  T2 = (P)YPi_((P)0,T3);
  T0 = (P)YPloc_off(T1,T2);
UNLINK_STACK();
  QRET(T0);
...
DEFCREGS();
  ...
  fun_col_res_type_0 = YPmet(FUNCODEREF(fun_col_res_type_0),LITREF(lit_0),T0,ENVNUL,PNUL,sloc(23));
  ...
  T4 = YPsig(LITREF(lit_3),YPPlist(1,VARREF(YLoptsG)),YPfalse,YPint((P)1),VARREF(YLintG),Ynil);
  fun_len_1 = YPmet(FUNCODEREF(fun_len_1),LITREF(lit_2),T4,ENVNUL,PNUL,sloc(26));
  ...
  T8 = YPsig(LITREF(lit_5),YPPlist(3,VARREF(YLoptsG),VARREF(YLintG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_elt_or_2 = YPmet(FUNCODEREF(fun_elt_or_2),LITREF(lit_4),T8,ENVNUL,PNUL,sloc(29));
  ...
  lit_8 = YPsb((P)"$$opts(");
  lit_9 = YPsb((P)")");
  T12 = YPsig(LITREF(lit_7),YPPlist(1,VARREF(YLoptsG)),YPfalse,YPint((P)1),VARREF(YLstrG),Ynil);
  fun_to_str_3 = YPmet(FUNCODEREF(fun_to_str_3),LITREF(lit_6),T12,ENVNUL,PNUL,sloc(33));
  T14 = VARREF_OR(YgooSmathYto_str,YPfalse);
  T15 = fun_to_str_3;
  T13 = XCALL2(1,VARREF(YgooSfunYPdefine_method),T14,T15);
  VARSET(YgooSmathYto_str,T13);
  lit_10 = YPPsym((P)"low-elt");
  lit_11 = YPPlist(2,YPPsym((P)"x"),YPPsym((P)"i"));
  T18 = YPsig(LITREF(lit_11),YPPlist(2,VARREF(YLoptsG),VARREF(YLintG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  T17 = fun_low_elt_4 = YPmet(FUNCODEREF(fun_low_elt_4),LITREF(lit_10),T18,ENVNUL,PNUL,sloc(38));
