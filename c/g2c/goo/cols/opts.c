...
LINK_STACK();
  ...
  ARG(x_, 1);
loop:
  T0 = CALL2(1,VARREF(YprotoStypesYas),VARREF(YLlstG),x_);
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  T0 = CALL3(1,VARREF(YmacrosYcat),LITREF(lit_8),T1,LITREF(lit_9));
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  T3 = BOUNDP(YprotoScollectionsScollectionYas_copy);
  if (T3 != YPfalse) {
    T2 = VARREF(YprotoScollectionsScollectionYas_copy);
  } else {
    T2 = YPfalse;
  }
  T4 = fun_as_copy_0;
  T1 = CALL2(1,VARREF(YPdefine_method),T2,T4);
  VARSET(YprotoScollectionsScollectionYas_copy,T1);
  lit_3 = YPPsym((P)"len");
  ...
  T8 = BOUNDP(YprotoStypesYlen);
  if (T8 != YPfalse) {
    T7 = VARREF(YprotoStypesYlen);
  } else {
    T7 = YPfalse;
  }
  T9 = fun_len_1;
  T6 = CALL2(1,VARREF(YPdefine_method),T7,T9);
  VARSET(YprotoStypesYlen,T6);
  ...
  T13 = BOUNDP(YprotoScollectionsScollectionYelt_or);
  if (T13 != YPfalse) {
    T12 = VARREF(YprotoScollectionsScollectionYelt_or);
  } else {
    T12 = YPfalse;
  }
  T14 = fun_elt_or_2;
  T11 = CALL2(1,VARREF(YPdefine_method),T12,T14);
  VARSET(YprotoScollectionsScollectionYelt_or,T11);
  ...
  T18 = BOUNDP(YprotoSmathYto_str);
  if (T18 != YPfalse) {
    T17 = VARREF(YprotoSmathYto_str);
  } else {
    T17 = YPfalse;
  }
  T19 = fun_to_str_3;
  T16 = CALL2(1,VARREF(YPdefine_method),T17,T19);
  VARSET(YprotoSmathYto_str,T16);
  ...
  T26 = BOUNDP(YprotoScollectionsScollectionYlow_elt);
  if (T26 != YPfalse) {
    T25 = VARREF(YprotoScollectionsScollectionYlow_elt);
  } else {
    T25 = YPfalse;
  }
  T27 = fun_low_elt_4;
  T24 = CALL2(1,VARREF(YPdefine_method),T25,T27);
  T23 = VARSET(YprotoScollectionsScollectionYlow_elt,T24);
  T20 = T23;
  return T20;
}
