...
/* MODULE ENVIRONMENT: proto/collections/opts */
...
LOCFOR(fun_elt_1);
LOCFOR(fun_to_str_2);
LOCFOR(fun_low_elt_3);
extern P YprotoScollectionsSoptsY___main_0___ ();
...
loop:
  ...
  T0 = CALL3(1,VARREF(YmacrosYcat),LITREF(lit_5),T1,LITREF(lit_6));
UNLINK_STACK();
  RET(T0);
}

FUNCODEDEF(fun_low_elt_3) {
  P x_,i_;
  P T0;
  P a1,a2;
LINK_STACK();
...
P YprotoScollectionsSoptsY___main_0___() {
  P T22,T21,T20,T19,T18,T17,T16,T15,T14,T13,T12,T11,T10,T9,T8,T7;
  P T6,T5,T4,T3,T2,T1,T0;
loop:
  lit_0 = YPPsym((P)"len");
  lit_1 = YPPsym((P)"x");
  T0 = YPsig(YPPlist(1,LITREF(lit_1)),YPPlist(1,VARREF(YLoptsG)),YPfalse,YPint((P)1),VARREF(YLintG),Ynil);
  fun_len_0 = YPmet(FUNCODEREF(fun_len_0),LITREF(lit_0),T0,ENVNUL,PNUL,YPfalse);
  T3 = BOUNDP(YprotoScollectionsScollectionYlen);
  if (T3 != YPfalse) {
    T2 = VARREF(YprotoScollectionsScollectionYlen);
  } else {
    T2 = YPfalse;
  }
  T4 = fun_len_0;
  T1 = CALL2(1,VARREF(YPdefine_method),T2,T4);
  VARSET(YprotoScollectionsScollectionYlen,T1);
  lit_2 = YPPsym((P)"elt");
  lit_3 = YPPsym((P)"i");
  T5 = YPsig(YPPlist(2,LITREF(lit_1),LITREF(lit_3)),YPPlist(2,VARREF(YLoptsG),VARREF(YLintG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_elt_1 = YPmet(FUNCODEREF(fun_elt_1),LITREF(lit_2),T5,ENVNUL,PNUL,YPfalse);
  T8 = BOUNDP(YmacrosYelt);
  if (T8 != YPfalse) {
    T7 = VARREF(YmacrosYelt);
  } else {
    T7 = YPfalse;
  }
  T9 = fun_elt_1;
  T6 = CALL2(1,VARREF(YPdefine_method),T7,T9);
  VARSET(YmacrosYelt,T6);
  lit_4 = YPPsym((P)"to-str");
  lit_5 = YPsb((P)"$$opts(");
  lit_6 = YPsb((P)")");
  T10 = YPsig(YPPlist(1,LITREF(lit_1)),YPPlist(1,VARREF(YLoptsG)),YPfalse,YPint((P)1),VARREF(YLstrG),Ynil);
  fun_to_str_2 = YPmet(FUNCODEREF(fun_to_str_2),LITREF(lit_4),T10,ENVNUL,PNUL,YPfalse);
  ...
  lit_7 = YPPsym((P)"low-elt");
  T17 = YPsig(YPPlist(2,LITREF(lit_1),LITREF(lit_3)),YPPlist(2,VARREF(YLoptsG),VARREF(YLintG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  T16 = fun_low_elt_3 = YPmet(FUNCODEREF(fun_low_elt_3),LITREF(lit_7),T17,ENVNUL,PNUL,YPfalse);
  T21 = BOUNDP(YprotoScollectionsScollectionYlow_elt);
  if (T21 != YPfalse) {
    T20 = VARREF(YprotoScollectionsScollectionYlow_elt);
  } else {
    T20 = YPfalse;
  }
  T22 = fun_low_elt_3;
  T19 = CALL2(1,VARREF(YPdefine_method),T20,T22);
  T18 = VARSET(YprotoScollectionsScollectionYlow_elt,T19);
  T15 = T18;
  return T15;
}
...
MODULE_INFO module_info_protoScollectionsSopts = {
  "proto/collections/opts",
  NULL,
  use_infos,
  import_infos,
  binding_infos,
...
void load_module_protoScollectionsSopts (void) {
