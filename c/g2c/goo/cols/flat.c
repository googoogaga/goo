...
EXT(YLtupG,"boot","<tup>");
DEF(YprotoScollectionsSflatYPdat,"proto/collections/flat","%dat");
...
DEF(YprotoScollectionsSflatYPkey_setter,"proto/collections/flat","%key-setter");
...
DEF(YprotoScollectionsSflatYLflat_enumG,"proto/collections/flat","<flat-enum>");
...
EXT(Ynew,"boot","new");
DEF(YprotoScollectionsSflatYPdat_setter,"proto/collections/flat","%dat-setter");
...
DEF(YprotoScollectionsSflatYPkey,"proto/collections/flat","%key");
...
LINK_STACK();
  ARG(Ux_, 0);
loop:
  T0 = CALL2(1,VARREF(Yprop_value),Ux_,VARREF(YprotoScollectionsSflatYPdat));
UNLINK_STACK();
  QRET(T0);
}
...
LINK_STACK();
  ...
  ARG(Ux_, 1);
loop:
  T0 = CALL3(1,VARREF(Yprop_value_setter),Uz_,Ux_,VARREF(YprotoScollectionsSflatYPdat));
UNLINK_STACK();
  QRET(T0);
}
...
LINK_STACK();
  ARG(Ux_, 0);
loop:
  T0 = CALL2(1,VARREF(Yprop_value),Ux_,VARREF(YprotoScollectionsSflatYPkey));
UNLINK_STACK();
  QRET(T0);
}
...
LINK_STACK();
  ...
  ARG(Ux_, 1);
loop:
  T0 = CALL3(1,VARREF(Yprop_value_setter),Uz_,Ux_,VARREF(YprotoScollectionsSflatYPkey));
UNLINK_STACK();
  QRET(T0);
}
...
LINK_STACK();
  ARG(x_, 0);
loop:
  T0 = CALL3(1,VARREF(Ynew),VARREF(YprotoScollectionsSflatYLflat_enumG),VARREF(YprotoScollectionsSflatYPdat),x_);
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ARG(e_, 0);
loop:
  T1 = CALL1(1,VARREF(YprotoScollectionsSflatYPkey),e_);
  T3 = CALL1(1,VARREF(YprotoScollectionsSflatYPdat),e_);
...
loop:
  x_2374F5367 = e_;
  T2 = CALL1(1,VARREF(YprotoScollectionsSflatYPkey),e_);
  T1 = CALL2(1,VARREF(YprotoSmathYA),T2,YPint((P)1));
  CALL2(1,VARREF(YprotoScollectionsSflatYPkey_setter),T1,x_2374F5367);
  T0 = x_2374F5367;
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ARG(e_, 0);
loop:
  T1 = CALL1(1,VARREF(YprotoScollectionsSflatYPdat),e_);
  T2 = CALL1(1,VARREF(YprotoScollectionsSflatYPkey),e_);
  T0 = CALL2(1,VARREF(YprotoScollectionsScollectionYlow_elt),T1,T2);
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  T1 = CALL1(1,VARREF(YprotoScollectionsSflatYPdat),e_);
  T2 = CALL1(1,VARREF(YprotoScollectionsSflatYPkey),e_);
  T0 = CALL3(1,VARREF(YprotoScollectionsScollectionYlow_elt_setter),v_,T1,T2);
UNLINK_STACK();
  QRET(T0);
}
...
LINK_STACK();
  ARG(e_, 0);
loop:
  T0 = CALL1(1,VARREF(YprotoScollectionsSflatYPkey),e_);
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  T1 = (P)YPpair(VARREF(YprotoScollectionsScollectionYLenumG),Ynil);
  T0 = CALL2(1,VARREF(Yfab_class),LITREF(lit_0),T1);
  VARSET(YprotoScollectionsSflatYLflat_enumG,T0);
  lit_1 = YPPsym((P)"%dat");
  lit_2 = YPPsym((P)"_x");
  T2 = YPsig(YPPlist(1,LITREF(lit_2)),YPPlist(1,VARREF(YprotoScollectionsSflatYLflat_enumG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_Pdat_0 = YPmet(FUNCODEREF(fun_Pdat_0),LITREF(lit_1),T2,ENVNUL,PNUL,YPfalse);
  T5 = BOUNDP(YprotoScollectionsSflatYPdat);
  if (T5 != YPfalse) {
    T4 = VARREF(YprotoScollectionsSflatYPdat);
  } else {
    T4 = YPfalse;
  }
  T6 = fun_Pdat_0;
  T3 = CALL2(1,VARREF(YPdefine_method),T4,T6);
  VARSET(YprotoScollectionsSflatYPdat,T3);
  lit_3 = YPPsym((P)"%dat-setter");
  lit_4 = YPPsym((P)"_z");
  T7 = YPsig(YPPlist(2,LITREF(lit_4),LITREF(lit_2)),YPPlist(2,VARREF(YLflatG),VARREF(YprotoScollectionsSflatYLflat_enumG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_Pdat_setter_1 = YPmet(FUNCODEREF(fun_Pdat_setter_1),LITREF(lit_3),T7,ENVNUL,PNUL,YPfalse);
  T10 = BOUNDP(YprotoScollectionsSflatYPdat_setter);
  if (T10 != YPfalse) {
    T9 = VARREF(YprotoScollectionsSflatYPdat_setter);
  } else {
    T9 = YPfalse;
  }
  T11 = fun_Pdat_setter_1;
  T8 = CALL2(1,VARREF(YPdefine_method),T9,T11);
  VARSET(YprotoScollectionsSflatYPdat_setter,T8);
  CALLN(1,VARREF(YPprop),5,VARREF(YprotoScollectionsSflatYLflat_enumG),VARREF(YprotoScollectionsSflatYPdat),VARREF(YprotoScollectionsSflatYPdat_setter),VARREF(YLflatG),VARREF(YPprop_unbound_error));
  lit_5 = YPPsym((P)"%key");
  T12 = YPsig(YPPlist(1,LITREF(lit_2)),YPPlist(1,VARREF(YprotoScollectionsSflatYLflat_enumG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_Pkey_2 = YPmet(FUNCODEREF(fun_Pkey_2),LITREF(lit_5),T12,ENVNUL,PNUL,YPfalse);
  T15 = BOUNDP(YprotoScollectionsSflatYPkey);
  if (T15 != YPfalse) {
    T14 = VARREF(YprotoScollectionsSflatYPkey);
  } else {
    T14 = YPfalse;
  }
  T16 = fun_Pkey_2;
  T13 = CALL2(1,VARREF(YPdefine_method),T14,T16);
  VARSET(YprotoScollectionsSflatYPkey,T13);
  lit_6 = YPPsym((P)"%key-setter");
  T17 = YPsig(YPPlist(2,LITREF(lit_4),LITREF(lit_2)),YPPlist(2,VARREF(YLintG),VARREF(YprotoScollectionsSflatYLflat_enumG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_Pkey_setter_3 = YPmet(FUNCODEREF(fun_Pkey_setter_3),LITREF(lit_6),T17,ENVNUL,PNUL,YPfalse);
  T20 = BOUNDP(YprotoScollectionsSflatYPkey_setter);
  if (T20 != YPfalse) {
    T19 = VARREF(YprotoScollectionsSflatYPkey_setter);
  } else {
    T19 = YPfalse;
  }
  T21 = fun_Pkey_setter_3;
  T18 = CALL2(1,VARREF(YPdefine_method),T19,T21);
  VARSET(YprotoScollectionsSflatYPkey_setter,T18);
  lit_7 = YPPsym((P)"x");
  ...
  T23 = fun_4;
  CALLN(1,VARREF(YPprop),5,VARREF(YprotoScollectionsSflatYLflat_enumG),VARREF(YprotoScollectionsSflatYPkey),VARREF(YprotoScollectionsSflatYPkey_setter),VARREF(YLintG),T23);
  lit_8 = YPPsym((P)"enum");
  T24 = YPsig(YPPlist(1,LITREF(lit_7)),YPPlist(1,VARREF(YLflatG)),YPfalse,YPint((P)1),VARREF(YprotoScollectionsSflatYLflat_enumG),Ynil);
  fun_enum_5 = YPmet(FUNCODEREF(fun_enum_5),LITREF(lit_8),T24,ENVNUL,PNUL,YPfalse);
  T27 = BOUNDP(YprotoScollectionsScollectionYenum);
  if (T27 != YPfalse) {
    T26 = VARREF(YprotoScollectionsScollectionYenum);
  } else {
    T26 = YPfalse;
  }
  T28 = fun_enum_5;
  T25 = CALL2(1,VARREF(YPdefine_method),T26,T28);
  VARSET(YprotoScollectionsScollectionYenum,T25);
  lit_9 = YPPsym((P)"fin?");
  lit_10 = YPPsym((P)"e");
  T29 = YPsig(YPPlist(1,LITREF(lit_10)),YPPlist(1,VARREF(YprotoScollectionsSflatYLflat_enumG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_finQ_6 = YPmet(FUNCODEREF(fun_finQ_6),LITREF(lit_9),T29,ENVNUL,PNUL,YPfalse);
  T32 = BOUNDP(YprotoScollectionsScollectionYfinQ);
  if (T32 != YPfalse) {
    T31 = VARREF(YprotoScollectionsScollectionYfinQ);
  } else {
    T31 = YPfalse;
  }
  T33 = fun_finQ_6;
  T30 = CALL2(1,VARREF(YPdefine_method),T31,T33);
  VARSET(YprotoScollectionsScollectionYfinQ,T30);
  lit_11 = YPPsym((P)"nxt");
  T34 = YPsig(YPPlist(1,LITREF(lit_10)),YPPlist(1,VARREF(YprotoScollectionsSflatYLflat_enumG)),YPfalse,YPint((P)1),VARREF(YprotoScollectionsSflatYLflat_enumG),Ynil);
  fun_nxt_7 = YPmet(FUNCODEREF(fun_nxt_7),LITREF(lit_11),T34,ENVNUL,PNUL,YPfalse);
  T37 = BOUNDP(YprotoScollectionsScollectionYnxt);
  if (T37 != YPfalse) {
    T36 = VARREF(YprotoScollectionsScollectionYnxt);
  } else {
    T36 = YPfalse;
  }
  T38 = fun_nxt_7;
  T35 = CALL2(1,VARREF(YPdefine_method),T36,T38);
  VARSET(YprotoScollectionsScollectionYnxt,T35);
  lit_12 = YPPsym((P)"now");
  T39 = YPsig(YPPlist(1,LITREF(lit_10)),YPPlist(1,VARREF(YprotoScollectionsSflatYLflat_enumG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_now_8 = YPmet(FUNCODEREF(fun_now_8),LITREF(lit_12),T39,ENVNUL,PNUL,YPfalse);
  T42 = BOUNDP(YprotoScollectionsScollectionYnow);
  if (T42 != YPfalse) {
    T41 = VARREF(YprotoScollectionsScollectionYnow);
  } else {
    T41 = YPfalse;
  }
  T43 = fun_now_8;
  T40 = CALL2(1,VARREF(YPdefine_method),T41,T43);
  VARSET(YprotoScollectionsScollectionYnow,T40);
  lit_13 = YPPsym((P)"now-setter");
  lit_14 = YPPsym((P)"v");
  T44 = YPsig(YPPlist(2,LITREF(lit_14),LITREF(lit_10)),YPPlist(2,VARREF(YLanyG),VARREF(YprotoScollectionsSflatYLflat_enumG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_now_setter_9 = YPmet(FUNCODEREF(fun_now_setter_9),LITREF(lit_13),T44,ENVNUL,PNUL,YPfalse);
  T47 = BOUNDP(YprotoScollectionsScollectionYnow_setter);
  if (T47 != YPfalse) {
    T46 = VARREF(YprotoScollectionsScollectionYnow_setter);
  } else {
    T46 = YPfalse;
  }
  T48 = fun_now_setter_9;
  T45 = CALL2(1,VARREF(YPdefine_method),T46,T48);
  VARSET(YprotoScollectionsScollectionYnow_setter,T45);
  lit_15 = YPPsym((P)"now-key");
  T51 = YPsig(YPPlist(1,LITREF(lit_10)),YPPlist(1,VARREF(YprotoScollectionsSflatYLflat_enumG)),YPfalse,YPint((P)1),VARREF(YLintG),Ynil);
  T50 = fun_now_key_10 = YPmet(FUNCODEREF(fun_now_key_10),LITREF(lit_15),T51,ENVNUL,PNUL,YPfalse);
  T55 = BOUNDP(YprotoScollectionsScollectionYnow_key);
  if (T55 != YPfalse) {
    T54 = VARREF(YprotoScollectionsScollectionYnow_key);
  } else {
    T54 = YPfalse;
  }
  T56 = fun_now_key_10;
  T53 = CALL2(1,VARREF(YPdefine_method),T54,T56);
  T52 = VARSET(YprotoScollectionsScollectionYnow_key,T53);
  T49 = T52;
  return T49;
}
...
static BINDING_INFO binding_infos[] = {
  {"%dat", &YprotoScollectionsSflatYPdat},
  {"%key-setter", &YprotoScollectionsSflatYPkey_setter},
  {"<flat-enum>", &YprotoScollectionsSflatYLflat_enumG},
  {"%dat-setter", &YprotoScollectionsSflatYPdat_setter},
  {"---main-0---", NULL},
  {"%key", &YprotoScollectionsSflatYPkey},
  {NULL, NULL}
};
