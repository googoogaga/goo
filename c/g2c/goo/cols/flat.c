...
loop:
  ...
  CALL2(1,VARREF(YgooScolsSflatYPkey_setter),T1,x_1301F1709);
  T0 = x_1301F1709;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  fun_Pkey_setter_3 = YPmet(FUNCODEREF(fun_Pkey_setter_3),LITREF(lit_7),T17,ENVNUL,PNUL,YPfalse);
  ...
  fun_enum_5 = YPmet(FUNCODEREF(fun_enum_5),LITREF(lit_10),T24,ENVNUL,PNUL,YPfalse);
  ...
  fun_finQ_6 = YPmet(FUNCODEREF(fun_finQ_6),LITREF(lit_12),T29,ENVNUL,PNUL,YPfalse);
  ...
  fun_nxt_7 = YPmet(FUNCODEREF(fun_nxt_7),LITREF(lit_14),T34,ENVNUL,PNUL,YPfalse);
  ...
  fun_now_8 = YPmet(FUNCODEREF(fun_now_8),LITREF(lit_16),T39,ENVNUL,PNUL,YPfalse);
  ...
  fun_now_setter_9 = YPmet(FUNCODEREF(fun_now_setter_9),LITREF(lit_18),T44,ENVNUL,PNUL,YPfalse);
  ...
  T50 = fun_now_key_10 = YPmet(FUNCODEREF(fun_now_key_10),LITREF(lit_20),T51,ENVNUL,PNUL,YPfalse);
