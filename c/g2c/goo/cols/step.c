...
loop:
  x_1385F2163 = e_;
  CALL2(1,VARREF(YgooScolsSstepYPfirstQ_setter),YPfalse,x_1385F2163);
  T0 = x_1385F2163;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  fun_step_first_0 = YPmet(FUNCODEREF(fun_step_first_0),LITREF(lit_6),T8,ENVNUL,PNUL,YPfalse);
  ...
  fun_step_first_setter_1 = YPmet(FUNCODEREF(fun_step_first_setter_1),LITREF(lit_8),T13,ENVNUL,PNUL,YPfalse);
  ...
  fun_step_then_2 = YPmet(FUNCODEREF(fun_step_then_2),LITREF(lit_10),T18,ENVNUL,PNUL,YPfalse);
  ...
  fun_Pdat_5 = YPmet(FUNCODEREF(fun_Pdat_5),LITREF(lit_16),T35,ENVNUL,PNUL,YPfalse);
  ...
  fun_Pdat_setter_6 = YPmet(FUNCODEREF(fun_Pdat_setter_6),LITREF(lit_18),T40,ENVNUL,PNUL,YPfalse);
  ...
  fun_PfirstQ_7 = YPmet(FUNCODEREF(fun_PfirstQ_7),LITREF(lit_20),T45,ENVNUL,PNUL,YPfalse);
  ...
  fun_PfirstQ_setter_8 = YPmet(FUNCODEREF(fun_PfirstQ_setter_8),LITREF(lit_22),T50,ENVNUL,PNUL,YPfalse);
  ...
  fun_enum_10 = YPmet(FUNCODEREF(fun_enum_10),LITREF(lit_25),T57,ENVNUL,PNUL,YPfalse);
  ...
  fun_finQ_11 = YPmet(FUNCODEREF(fun_finQ_11),LITREF(lit_27),T62,ENVNUL,PNUL,YPfalse);
  ...
  fun_nxt_12 = YPmet(FUNCODEREF(fun_nxt_12),LITREF(lit_29),T67,ENVNUL,PNUL,YPfalse);
  ...
  fun_now_13 = YPmet(FUNCODEREF(fun_now_13),LITREF(lit_31),T72,ENVNUL,PNUL,YPfalse);
  ...
  fun_each_fun_14 = YPmet(FUNCODEREF(fun_each_fun_14),LITREF(lit_33),T77,ENVNUL,PNUL,YPfalse);
  ...
  fun_each_fun_setter_15 = YPmet(FUNCODEREF(fun_each_fun_setter_15),LITREF(lit_35),T82,ENVNUL,PNUL,YPfalse);
  ...
  fun_Pdat_16 = YPmet(FUNCODEREF(fun_Pdat_16),LITREF(lit_16),T89,ENVNUL,PNUL,YPfalse);
  ...
  fun_Pdat_setter_17 = YPmet(FUNCODEREF(fun_Pdat_setter_17),LITREF(lit_18),T94,ENVNUL,PNUL,YPfalse);
  ...
  fun_enum_18 = YPmet(FUNCODEREF(fun_enum_18),LITREF(lit_25),T99,ENVNUL,PNUL,YPfalse);
  ...
  fun_finQ_19 = YPmet(FUNCODEREF(fun_finQ_19),LITREF(lit_27),T104,ENVNUL,PNUL,YPfalse);
  ...
  fun_nxt_20 = YPmet(FUNCODEREF(fun_nxt_20),LITREF(lit_29),T109,ENVNUL,PNUL,YPfalse);
  ...
  T115 = fun_now_21 = YPmet(FUNCODEREF(fun_now_21),LITREF(lit_31),T116,ENVNUL,PNUL,YPfalse);
