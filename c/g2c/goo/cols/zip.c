...
FUNCODEDEF(fun_Penums_setter_6) {
  P Uz_,Ux_;
  P T0;
LINK_STACK();
  ARG(Uz_, 0);
...
LINK_STACK();
  ...
  CALL2(1,VARREF(YgooScolsSzipYPenums_setter),T0,x_2283F8686);
UNLINK_STACK();
  RET(x_2283F8686);
}
...
LINK_STACK();
  ...
  LOOP_402: {
    P a402_0,a402_1;
    T4 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_2285F8687);
    tmpF8689 = T4;
    if (tmpF8689 != YPfalse) {
      T2 = tmpF8689;
    } else {
      T3 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_2284F8688);
      T2 = T3;
    }
    T1 = CALL1(1,VARREF(Ynot),T2);
    if (T1 != YPfalse) {
      T10 = CALL1(1,VARREF(YgooScolsScolYnow),x_2285F8687);
      eeF8690 = T10;
      T9 = CALL1(1,VARREF(YgooScolsScolYnow),x_2284F8688);
      veF8691 = T9;
      T5 = CALL1(1,VARREF(YgooScolsScolYnow),veF8691);
      CALL2(1,VARREF(YgooScolsScolYnow_setter),T5,eeF8690);
      T7 = CALL1(1,VARREF(YgooScolsScolYnxt),x_2285F8687);
      T8 = CALL1(1,VARREF(YgooScolsScolYnxt),x_2284F8688);
      a402_0 = T7;
      a402_1 = T8;
      x_2285F8687 = a402_0;
      x_2284F8688 = a402_1;
...
DEFCREGS();
  ...
  fun_zip_dat_0 = YPmet(FUNCODEREF(fun_zip_dat_0),LITREF(lit_5),T6,ENVNUL,PNUL,sloc(17));
  ...
  T10 = YPsig(LITREF(lit_7),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_1 = YPmet(FUNCODEREF(fun_1),YPfalse,T10,ENVNUL,PNUL,sloc(17));
  T11 = fun_1;
  ...
  T12 = YPsig(LITREF(lit_9),Ynil,YPtrue,YPint((P)0),VARREF(YgooScolsSzipYLzipG),Ynil);
  fun_zip_2 = YPmet(FUNCODEREF(fun_zip_2),LITREF(lit_1),T12,ENVNUL,PNUL,sloc(19));
  T14 = VARREF_OR(YgooScolsSzipYzip,YPfalse);
  T15 = fun_zip_2;
  T13 = XCALL2(1,VARREF(YgooSfunYPdefine_method),T14,T15);
  VARSET(YgooScolsSzipYzip,T13);
  lit_10 = YPPlist(1,YPPsym((P)"z"));
  T16 = YPsig(LITREF(lit_10),YPPlist(1,VARREF(YgooScolsSzipYLzipG)),YPfalse,YPint((P)1),VARREF(YLtupG),Ynil);
  fun_unzip_3 = YPmet(FUNCODEREF(fun_unzip_3),LITREF(lit_3),T16,ENVNUL,PNUL,sloc(22));
  ...
  T22 = YPsig(LITREF(lit_13),YPPlist(1,VARREF(YgooScolsSzipYLzip_stateG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_zip_states_4 = YPmet(FUNCODEREF(fun_zip_states_4),LITREF(lit_12),T22,ENVNUL,PNUL,sloc(27));
  ...
  T27 = (P)YPpair(VARREF(YgooScolsScolYLenumG),Ynil);
  ...
  T28 = YPsig(LITREF(lit_16),YPPlist(1,VARREF(YgooScolsSzipYLzip_enumG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_Penums_5 = YPmet(FUNCODEREF(fun_Penums_5),LITREF(lit_15),T28,ENVNUL,PNUL,sloc(31));
  ...
  T32 = YPsig(LITREF(lit_18),YPPlist(2,VARREF(YgooScolsSzipYLzipG),VARREF(YgooScolsSzipYLzip_enumG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_Penums_setter_6 = YPmet(FUNCODEREF(fun_Penums_setter_6),LITREF(lit_17),T32,ENVNUL,PNUL,sloc(31));
  ...
  T36 = YPsig(LITREF(lit_20),YPPlist(1,VARREF(YgooScolsSzipYLzipG)),YPfalse,YPint((P)1),VARREF(YgooScolsSzipYLzip_enumG),Ynil);
  ...
  T40 = YPsig(LITREF(lit_22),YPPlist(1,VARREF(YgooScolsSzipYLzip_enumG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_finQ_8 = YPmet(FUNCODEREF(fun_finQ_8),LITREF(lit_21),T40,ENVNUL,PNUL,sloc(36));
  ...
  T44 = YPsig(LITREF(lit_24),YPPlist(1,VARREF(YgooScolsSzipYLzip_enumG)),YPfalse,YPint((P)1),VARREF(YgooScolsSzipYLzip_enumG),Ynil);
  fun_nxt_9 = YPmet(FUNCODEREF(fun_nxt_9),LITREF(lit_23),T44,ENVNUL,PNUL,sloc(39));
  ...
  T48 = YPsig(LITREF(lit_26),YPPlist(1,VARREF(YgooScolsSzipYLzip_enumG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_now_10 = YPmet(FUNCODEREF(fun_now_10),LITREF(lit_25),T48,ENVNUL,PNUL,sloc(42));
  ...
  T52 = YPsig(LITREF(lit_28),YPPlist(2,VARREF(YgooScolsSzipYLzipG),VARREF(YgooScolsSzipYLzip_enumG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_now_setter_11 = YPmet(FUNCODEREF(fun_now_setter_11),LITREF(lit_27),T52,ENVNUL,PNUL,sloc(45));
  ...
  T58 = YPsig(LITREF(lit_30),YPPlist(1,VARREF(YgooScolsSzipYLzip_enumG)),YPfalse,YPint((P)1),VARREF(YgooScolsSzipYLzipG),Ynil);
  T57 = fun_now_key_12 = YPmet(FUNCODEREF(fun_now_key_12),LITREF(lit_29),T58,ENVNUL,PNUL,sloc(48));
