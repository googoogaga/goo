...
loop:
  ...
  CALL2(1,VARREF(YgooScolsSzipYPenums_setter),T1,x_1386F2164);
  T0 = x_1386F2164;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    veF2167 = T9;
    T10 = CALL1(1,VARREF(YgooScolsScolYnow),veF2167);
    CALL2(1,VARREF(YgooScolsScolYnow_setter),T10,eeF2166);
...
loop:
  ...
  fun_zip_states_5 = YPmet(FUNCODEREF(fun_zip_states_5),LITREF(lit_14),T30,ENVNUL,PNUL,YPfalse);
  ...
  fun_zip_states_setter_6 = YPmet(FUNCODEREF(fun_zip_states_setter_6),LITREF(lit_16),T35,ENVNUL,PNUL,YPfalse);
  ...
  fun_Penums_7 = YPmet(FUNCODEREF(fun_Penums_7),LITREF(lit_19),T42,ENVNUL,PNUL,YPfalse);
  ...
  fun_Penums_setter_8 = YPmet(FUNCODEREF(fun_Penums_setter_8),LITREF(lit_21),T47,ENVNUL,PNUL,YPfalse);
  ...
  fun_enum_9 = YPmet(FUNCODEREF(fun_enum_9),LITREF(lit_23),T52,ENVNUL,PNUL,YPfalse);
  ...
  fun_finQ_10 = YPmet(FUNCODEREF(fun_finQ_10),LITREF(lit_25),T57,ENVNUL,PNUL,YPfalse);
  ...
  fun_nxt_11 = YPmet(FUNCODEREF(fun_nxt_11),LITREF(lit_27),T62,ENVNUL,PNUL,YPfalse);
  ...
  fun_now_12 = YPmet(FUNCODEREF(fun_now_12),LITREF(lit_29),T67,ENVNUL,PNUL,YPfalse);
  ...
  fun_x_1389_13 = YPmet(FUNCODEREF(fun_x_1389_13),LITREF(lit_33),T73,ENVNUL,PNUL,YPfalse);
  ...
  fun_now_setter_14 = YPmet(FUNCODEREF(fun_now_setter_14),LITREF(lit_31),T72,ENVNUL,PNUL,YPfalse);
  ...
  T79 = fun_now_key_15 = YPmet(FUNCODEREF(fun_now_key_15),LITREF(lit_35),T80,ENVNUL,PNUL,YPfalse);
