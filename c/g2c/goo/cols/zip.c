...
loop:
  ...
  CALL2(1,VARREF(YgooScolsSzipYPenums_setter),T1,x_1330F1276);
  T0 = x_1330F1276;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    veF1279 = T9;
    T10 = CALL1(1,VARREF(YgooScolsScolYnow),veF1279);
    CALL2(1,VARREF(YgooScolsScolYnow_setter),T10,eeF1278);
