...
LINK_STACK();
  ...
  CALL2(1,VARREF(YgooScolsSzipYPenums_setter),T0,x_1390F2388);
UNLINK_STACK();
  RET(x_1390F2388);
}
...
LINK_STACK();
  ...
  for (;;) {
    P a147_0,a147_1;
  loop147:
    T4 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_1392F2389);
    tmpF2391 = T4;
    if (tmpF2391 != YPfalse) {
      T2 = tmpF2391;
    } else {
      T3 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_1391F2390);
      T2 = T3;
    }
    T1 = CALL1(1,VARREF(Ynot),T2);
    if (T1 != YPfalse) {
      T10 = CALL1(1,VARREF(YgooScolsScolYnow),x_1392F2389);
      eeF2392 = T10;
      T9 = CALL1(1,VARREF(YgooScolsScolYnow),x_1391F2390);
      veF2393 = T9;
      T5 = CALL1(1,VARREF(YgooScolsScolYnow),veF2393);
      CALL2(1,VARREF(YgooScolsScolYnow_setter),T5,eeF2392);
      T7 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1392F2389);
      T8 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1391F2390);
      a147_0 = T7;
      a147_1 = T8;
      x_1392F2389 = a147_0;
      x_1391F2390 = a147_1;
