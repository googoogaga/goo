...
LINK_STACK();
  ...
  CALL2(1,VARREF(YgooScolsSzipYPenums_setter),T0,x_1436F3679);
UNLINK_STACK();
  RET(x_1436F3679);
}
...
LINK_STACK();
  ...
  LOOP_152: {
    P a152_0,a152_1;
    T4 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_1438F3680);
    tmpF3682 = T4;
    if (tmpF3682 != YPfalse) {
      T2 = tmpF3682;
    } else {
      T3 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_1437F3681);
      T2 = T3;
    }
    T1 = CALL1(1,VARREF(Ynot),T2);
    if (T1 != YPfalse) {
      T10 = CALL1(1,VARREF(YgooScolsScolYnow),x_1438F3680);
      eeF3683 = T10;
      T9 = CALL1(1,VARREF(YgooScolsScolYnow),x_1437F3681);
      veF3684 = T9;
      T5 = CALL1(1,VARREF(YgooScolsScolYnow),veF3684);
      CALL2(1,VARREF(YgooScolsScolYnow_setter),T5,eeF3683);
      T7 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1438F3680);
      T8 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1437F3681);
      a152_0 = T7;
      a152_1 = T8;
      x_1438F3680 = a152_0;
      x_1437F3681 = a152_1;
...
DEFCREGS();
  ...
  fun_zip_dat_0 = YPfab_met(FUNCODEREF(fun_zip_dat_0),T6,LITREF(lit_5),LITREF(lit_6),sloc(17),YPsb((P)"(fun ((_x <zip>)) (prop-value _x zip-dat))"));
  ...
  fun_1 = YPfab_met(FUNCODEREF(fun_1),T10,YPfalse,LITREF(lit_7),sloc(17),YPsb((P)"(fun ((_x <any>)) #())"));
  T11 = fun_1;
  ...
  fun_zip_2 = YPfab_met(FUNCODEREF(fun_zip_2),T12,LITREF(lit_1),LITREF(lit_9),sloc(19),YPsb((P)"(fun ((e ...) => <zip>) (new <zip> zip-dat (as <tup> e)))"));
  ...
  fun_unzip_3 = YPfab_met(FUNCODEREF(fun_unzip_3),T16,LITREF(lit_3),LITREF(lit_10),sloc(22),YPsb((P)"(fun ((z <zip>) => <tup>) (zip-dat z))"));
  ...
  fun_zip_states_4 = YPfab_met(FUNCODEREF(fun_zip_states_4),T22,LITREF(lit_12),LITREF(lit_13),sloc(27),YPsb((P)"(fun ((_x <zip-state>)) (prop-value _x zip-states))"));
  ...
  fun_Penums_5 = YPfab_met(FUNCODEREF(fun_Penums_5),T28,LITREF(lit_15),LITREF(lit_16),sloc(31),YPsb((P)"(fun ((_x <zip-enum>)) (prop-value _x %enums))"));
  ...
  fun_Penums_setter_6 = YPfab_met(FUNCODEREF(fun_Penums_setter_6),T32,LITREF(lit_17),LITREF(lit_18),sloc(31),YPsb((P)"(fun ((_z <zip>) (_x <zip-enum>)) (prop-value-setter _z _x %enums))"));
  ...
  fun_enum_7 = YPfab_met(FUNCODEREF(fun_enum_7),T36,LITREF(lit_19),LITREF(lit_20),sloc(33),YPsb((P)"(fun ((x <zip>) => <zip-enum>) (new <zip-enum> %enums (map enum x)))"));
  ...
  fun_finQ_8 = YPfab_met(FUNCODEREF(fun_finQ_8),T40,LITREF(lit_21),LITREF(lit_22),sloc(36),YPsb((P)"(fun ((e <zip-enum>) => <log>) (any? nul? (%enums e)))"));
  ...
  fun_nxt_9 = YPfab_met(FUNCODEREF(fun_nxt_9),T44,LITREF(lit_23),LITREF(lit_24),sloc(39),YPsb((P)"(fun ((e <zip-enum>) => <zip-enum>) (renew e %enums (map nxt (%enums e))))"));
  ...
  fun_now_10 = YPfab_met(FUNCODEREF(fun_now_10),T48,LITREF(lit_25),LITREF(lit_26),sloc(42),YPsb((P)"(fun ((e <zip-enum>) => <any>) (map now (%enums e)))"));
  ...
  fun_now_setter_11 = YPfab_met(FUNCODEREF(fun_now_setter_11),T52,LITREF(lit_27),LITREF(lit_28),sloc(45),YPsb((P)"(fun ((v <zip>) (e <zip-enum>)) (for ((ve v) (ee (%enums e))) (set (now ee) (now ve))))"));
  ...
  T57 = fun_now_key_12 = YPfab_met(FUNCODEREF(fun_now_key_12),T58,LITREF(lit_29),LITREF(lit_30),sloc(48),YPsb((P)"(fun ((e <zip-enum>) => <zip>) (map now-key (%enums e)))"));
