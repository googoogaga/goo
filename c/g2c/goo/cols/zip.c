...
LINK_STACK();
  ...
  CALL2(1,VARREF(YgooScolsSzipYPenums_setter),T0,x_1436F3673);
UNLINK_STACK();
  RET(x_1436F3673);
}
...
LINK_STACK();
  ...
  LOOP_153: {
    P a153_0,a153_1;
    T4 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_1438F3674);
    tmpF3676 = T4;
    if (tmpF3676 != YPfalse) {
      T2 = tmpF3676;
    } else {
      T3 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_1437F3675);
      T2 = T3;
    }
    T1 = CALL1(1,VARREF(Ynot),T2);
    if (T1 != YPfalse) {
      T10 = CALL1(1,VARREF(YgooScolsScolYnow),x_1438F3674);
      eeF3677 = T10;
      T9 = CALL1(1,VARREF(YgooScolsScolYnow),x_1437F3675);
      veF3678 = T9;
      T5 = CALL1(1,VARREF(YgooScolsScolYnow),veF3678);
      CALL2(1,VARREF(YgooScolsScolYnow_setter),T5,eeF3677);
      T7 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1438F3674);
      T8 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1437F3675);
      a153_0 = T7;
      a153_1 = T8;
      x_1438F3674 = a153_0;
      x_1437F3675 = a153_1;
