...
LINK_STACK();
  ...
  CALL2(1,VARREF(YgooScolsSzipYPenums_setter),T0,x_1436F3777);
UNLINK_STACK();
  RET(x_1436F3777);
}
...
LINK_STACK();
  ...
  LOOP_152: {
    P a152_0,a152_1;
    T4 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_1438F3778);
    tmpF3780 = T4;
    if (tmpF3780 != YPfalse) {
      T2 = tmpF3780;
    } else {
      T3 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_1437F3779);
      T2 = T3;
    }
    T1 = CALL1(1,VARREF(Ynot),T2);
    if (T1 != YPfalse) {
      T10 = CALL1(1,VARREF(YgooScolsScolYnow),x_1438F3778);
      eeF3781 = T10;
      T9 = CALL1(1,VARREF(YgooScolsScolYnow),x_1437F3779);
      veF3782 = T9;
      T5 = CALL1(1,VARREF(YgooScolsScolYnow),veF3782);
      CALL2(1,VARREF(YgooScolsScolYnow_setter),T5,eeF3781);
      T7 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1438F3778);
      T8 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1437F3779);
      a152_0 = T7;
      a152_1 = T8;
      x_1438F3778 = a152_0;
      x_1437F3779 = a152_1;
