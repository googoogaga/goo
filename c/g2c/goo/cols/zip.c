...
loop:
  ...
  CALL2(1,VARREF(YgooScolsSzipYPenums_setter),T1,x_1373F1336);
  T0 = x_1373F1336;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    veF1339 = T9;
    T10 = CALL1(1,VARREF(YgooScolsScolYnow),veF1339);
    CALL2(1,VARREF(YgooScolsScolYnow_setter),T10,eeF1338);
