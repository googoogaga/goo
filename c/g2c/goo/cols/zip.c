...
loop:
  ...
  CALL2(1,VARREF(YgooScolsSzipYPenums_setter),T1,x_1326F1281);
  T0 = x_1326F1281;
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ...
  ARG(x_1327_, 1);
loop:
  T3 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_1328_);
  tmpF1282 = T3;
  if (tmpF1282 != YPfalse) {
    T4 = tmpF1282;
  } else {
    T5 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_1327_);
    T4 = T5;
  }
  T2 = T4;
  T1 = CALL1(1,VARREF(Ynot),T2);
  if (T1 != YPfalse) {
    T7 = CALL1(1,VARREF(YgooScolsScolYnow),x_1328_);
    eeF1283 = T7;
    T9 = CALL1(1,VARREF(YgooScolsScolYnow),x_1327_);
    veF1284 = T9;
    T10 = CALL1(1,VARREF(YgooScolsScolYnow),veF1284);
    CALL2(1,VARREF(YgooScolsScolYnow_setter),T10,eeF1283);
    T12 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1328_);
    T13 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1327_);
    a1 = T12;
    a2 = T13;
    x_1328_ = a1;
    x_1327_ = a2;
...
loop:
  ...
  lit_22 = YPPsym((P)"v");
  lit_23 = YPPsym((P)"x-1329");
  lit_24 = YPPsym((P)"x-1328");
  lit_25 = YPPsym((P)"x-1327");
  ...
  fun_x_1329_13 = YPmet(FUNCODEREF(fun_x_1329_13),LITREF(lit_23),T73,ENVNUL,PNUL,YPfalse);
