...
loop:
  ...
  T39 = fun_low_elt_setter_7 = YPmet(FUNCODEREF(fun_low_elt_setter_7),LITREF(lit_15),T40,ENVNUL,PNUL,YPfalse);
  T44 = BOUNDP(YgooScolsScolYlow_elt_setter);
  if (T44 != YPfalse) {
    T43 = VARREF(YgooScolsScolYlow_elt_setter);
  } else {
    T43 = YPfalse;
  }
  T45 = fun_low_elt_setter_7;
  T42 = CALL2(1,VARREF(YPdefine_method),T43,T45);
  T41 = VARSET(YgooScolsScolYlow_elt_setter,T42);
  T38 = T41;
  return T38;
}
