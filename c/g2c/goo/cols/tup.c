...
DEFCREGS();
  ...
  fun_len_0 = YPfab_met(FUNCODEREF(fun_len_0),T0,LITREF(lit_0),LITREF(lit_1),sloc(24),YPsb((P)"(fun ((x <tup>) => <int>) (%ib (%tlen x)))"));
  ...
  fun_elt_or_1 = YPfab_met(FUNCODEREF(fun_elt_or_1),T4,LITREF(lit_2),LITREF(lit_3),sloc(27),YPsb((P)"(fun ((x <tup>) (i <int>) default => <any>) (if (range-check? x i) (%telt x (%iu i)) default))"));
  ...
  fun_nul_2 = YPfab_met(FUNCODEREF(fun_nul_2),T8,LITREF(lit_4),LITREF(lit_5),sloc(36),YPsb((P)"(fun ((c (t= <tup>)) => <tup>) %tnul)"));
  ...
  fun_fab_3 = YPfab_met(FUNCODEREF(fun_fab_3),T13,LITREF(lit_6),LITREF(lit_7),sloc(39),YPsb((P)"(fun ((x (t= <tup>)) (s <int>) => <tup>) (%tup (%iu s) #f))"));
  ...
  fun_to_str_4 = YPfab_met(FUNCODEREF(fun_to_str_4),T18,LITREF(lit_8),LITREF(lit_9),sloc(45),YPsb((P)"(fun ((x <tup>) => <str>) (cat #( (vals-to-str x) )))"));
  ...
  fun_low_elt_5 = YPfab_met(FUNCODEREF(fun_low_elt_5),T22,LITREF(lit_12),LITREF(lit_13),sloc(49),YPsb((P)"(fun ((x <tup>) (i <int>) => <any>) (%telt x (%iu i)))"));
  ...
  T27 = fun_fab_elt_setter_6 = YPfab_met(FUNCODEREF(fun_fab_elt_setter_6),T28,LITREF(lit_14),LITREF(lit_15),sloc(52),YPsb((P)"(fun (z (x <tup>) (i <int>)) (set (%telt x (%iu i)) z))"));
