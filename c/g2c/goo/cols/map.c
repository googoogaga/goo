...
/* MODULE ENVIRONMENT: goo/collections/map */
...
DEF(YgooScollectionsSmapYLmapG,"goo/collections/map","<map>");
...
DEF(YgooScollectionsSmapYfab_map,"goo/collections/map","fab-map");
...
extern P YgooScollectionsSmapY___main_0___ ();
...
LINK_STACK();
  ...
  ARG(val_, 1);
loop:
  T0 = CALL3(1,VARREF(YgooScollectionsScollectionYelt_setter),val_,FREEREF(0),key_);
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ...
  NARGS(key_vals_, 1);
loop:
  T4 = CALL1(1,VARREF(YgooStypeYlen),key_vals_);
  ...
  xF1013 = T1;
  T5 = FUNFAB(fun_0,1,xF1013);
  CALL2(1,VARREF(YgooScollectionsSsequenceYdo_key_vals),T5,key_vals_);
  T0 = xF1013;
UNLINK_STACK();
  RET(T0);
}

P YgooScollectionsSmapY___main_0___() {
  P T15,T14,T13,T12,T11,T10,T9,T8,T7,T6,T5,T4,T3,T2,T1,T0;
loop:
  lit_0 = YPPsym((P)"<map>");
  T1 = (P)YPpair(VARREF(YLcolG),Ynil);
  T0 = CALL2(1,VARREF(Yfab_class),LITREF(lit_0),T1);
  VARSET(YgooScollectionsSmapYLmapG,T0);
  lit_1 = YPPsym((P)"fab-map");
  lit_2 = YPPsym((P)"p");
  lit_3 = YPPsym((P)"key-vals");
  T4 = CALL1(1,VARREF(YgooStypeYtL),VARREF(YgooScollectionsSmapYLmapG));
  T3 = YPsig(YPPlist(2,LITREF(lit_2),LITREF(lit_3)),YPPlist(1,T4),YPtrue,YPint((P)1),VARREF(YLanyG),Ynil);
  T2 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_1),T3,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooScollectionsSmapYfab_map,T2);
  lit_4 = YPPsym((P)"key");
  lit_5 = YPPsym((P)"val");
  ...
  T8 = CALL1(1,VARREF(YgooStypeYtL),VARREF(YgooScollectionsSmapYLmapG));
  ...
  T14 = BOUNDP(YgooScollectionsSmapYfab_map);
  if (T14 != YPfalse) {
    T13 = VARREF(YgooScollectionsSmapYfab_map);
  } else {
    T13 = YPfalse;
  }
  T15 = fun_fab_map_1;
  T12 = CALL2(1,VARREF(YPdefine_method),T13,T15);
  T11 = VARSET(YgooScollectionsSmapYfab_map,T12);
  T5 = T11;
  return T5;
}
...
static BINDING_INFO binding_infos[] = {
  {"<map>", &YgooScollectionsSmapYLmapG},
  {"---main-0---", NULL},
  {"fab-map", &YgooScollectionsSmapYfab_map},
  {NULL, NULL}
};
...
MODULE_INFO module_info_gooScollectionsSmap = {
  "goo/collections/map",
  NULL,
  use_infos,
  import_infos,
...
void load_module_gooScollectionsSmap (void) {
