...
loop:
  ...
  CALL2(1,VARREF(YgooScolsScycleYPkey_setter),T1,x_1390F2169);
  T0 = x_1390F2169;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  fun_Pkey_3 = YPmet(FUNCODEREF(fun_Pkey_3),LITREF(lit_9),T21,ENVNUL,PNUL,YPfalse);
  ...
  fun_Pkey_setter_4 = YPmet(FUNCODEREF(fun_Pkey_setter_4),LITREF(lit_11),T26,ENVNUL,PNUL,YPfalse);
  ...
  fun_Plen_6 = YPmet(FUNCODEREF(fun_Plen_6),LITREF(lit_14),T33,ENVNUL,PNUL,YPfalse);
  ...
  fun_Plen_setter_7 = YPmet(FUNCODEREF(fun_Plen_setter_7),LITREF(lit_16),T38,ENVNUL,PNUL,YPfalse);
  ...
  fun_Pdat_8 = YPmet(FUNCODEREF(fun_Pdat_8),LITREF(lit_18),T43,ENVNUL,PNUL,YPfalse);
  ...
  fun_Pdat_setter_9 = YPmet(FUNCODEREF(fun_Pdat_setter_9),LITREF(lit_20),T48,ENVNUL,PNUL,YPfalse);
  ...
  fun_enum_10 = YPmet(FUNCODEREF(fun_enum_10),LITREF(lit_22),T53,ENVNUL,PNUL,YPfalse);
  ...
  fun_finQ_11 = YPmet(FUNCODEREF(fun_finQ_11),LITREF(lit_24),T58,ENVNUL,PNUL,YPfalse);
  ...
  fun_nxt_12 = YPmet(FUNCODEREF(fun_nxt_12),LITREF(lit_26),T63,ENVNUL,PNUL,YPfalse);
  ...
  T69 = fun_now_13 = YPmet(FUNCODEREF(fun_now_13),LITREF(lit_28),T70,ENVNUL,PNUL,YPfalse);
