...
loop:
  ...
  CALL2(1,VARREF(YgooScolsScycleYPkey_setter),T1,x_1330F1286);
  T0 = x_1330F1286;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  lit_1 = YPPsym((P)"e");
  T1 = YPsig(YPPlist(1,LITREF(lit_1)),Ynil,YPtrue,YPint((P)0),VARREF(YgooScolsScycleYLcycleG),Ynil);
  T0 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_0),T1,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooScolsScycleYcycle,T0);
  lit_2 = YPPsym((P)"<cycle>");
  T3 = (P)YPpair(VARREF(YLseqG),Ynil);
  T2 = CALL2(1,VARREF(Yfab_class),LITREF(lit_2),T3);
  VARSET(YgooScolsScycleYLcycleG,T2);
  ...
  T14 = YPsig(YPPlist(1,LITREF(lit_1)),Ynil,YPtrue,YPint((P)0),VARREF(YgooScolsScycleYLcycleG),Ynil);
  ...
  lit_16 = YPPsym((P)"fin?");
  T58 = YPsig(YPPlist(1,LITREF(lit_1)),YPPlist(1,VARREF(YgooScolsScycleYLcycle_enumG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  ...
  lit_17 = YPPsym((P)"nxt");
  T63 = YPsig(YPPlist(1,LITREF(lit_1)),YPPlist(1,VARREF(YgooScolsScycleYLcycle_enumG)),YPfalse,YPint((P)1),VARREF(YgooScolsScycleYLcycle_enumG),Ynil);
  ...
  lit_18 = YPPsym((P)"now");
  T70 = YPsig(YPPlist(1,LITREF(lit_1)),YPPlist(1,VARREF(YgooScolsScycleYLcycle_enumG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
