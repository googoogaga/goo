...
LINK_STACK();
  ...
  CALL2(1,VARREF(YgooScolsScycleYPkey_setter),T0,x_1394F2394);
UNLINK_STACK();
  RET(x_1394F2394);
}
...
DEFCREGS();
  ...
  T8 = YPsig(LITREF(lit_6),YPPlist(2,VARREF(YLtupG),VARREF(YgooScolsScycleYLcycleG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_cycle_elts_setter_1 = YPmet(FUNCODEREF(fun_cycle_elts_setter_1),LITREF(lit_5),T8,ENVNUL,PNUL,sloc(15));
  T10 = VARREF_OR(YgooScolsScycleYcycle_elts_setter,YPfalse);
  T11 = fun_cycle_elts_setter_1;
  T9 = XCALL2(1,VARREF(YPdefine_method),T10,T11);
  VARSET(YgooScolsScycleYcycle_elts_setter,T9);
  ...
  T12 = YPsig(LITREF(lit_7),Ynil,YPtrue,YPint((P)0),VARREF(YgooScolsScycleYLcycleG),Ynil);
  fun_cycle_2 = YPmet(FUNCODEREF(fun_cycle_2),LITREF(lit_1),T12,ENVNUL,PNUL,sloc(17));
  T14 = VARREF_OR(YgooScolsScycleYcycle,YPfalse);
  T15 = fun_cycle_2;
  T13 = XCALL2(1,VARREF(YPdefine_method),T14,T15);
  VARSET(YgooScolsScycleYcycle,T13);
  lit_8 = YPPsym((P)"<cycle-enum>");
  T17 = (P)YPpair(VARREF(YgooScolsScolYLenumG),Ynil);
  T16 = XCALL2(1,VARREF(Yfab_class),LITREF(lit_8),T17);
  VARSET(YgooScolsScycleYLcycle_enumG,T16);
  lit_9 = YPPsym((P)"%key");
  lit_10 = YPPlist(1,YPPsym((P)"_x"));
  T18 = YPsig(LITREF(lit_10),YPPlist(1,VARREF(YgooScolsScycleYLcycle_enumG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_Pkey_3 = YPmet(FUNCODEREF(fun_Pkey_3),LITREF(lit_9),T18,ENVNUL,PNUL,sloc(21));
  T20 = VARREF_OR(YgooScolsScycleYPkey,YPfalse);
  T21 = fun_Pkey_3;
  T19 = XCALL2(1,VARREF(YPdefine_method),T20,T21);
  VARSET(YgooScolsScycleYPkey,T19);
  lit_11 = YPPsym((P)"%key-setter");
  lit_12 = YPPlist(2,YPPsym((P)"_z"),YPPsym((P)"_x"));
  T22 = YPsig(LITREF(lit_12),YPPlist(2,VARREF(YLintG),VARREF(YgooScolsScycleYLcycle_enumG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_Pkey_setter_4 = YPmet(FUNCODEREF(fun_Pkey_setter_4),LITREF(lit_11),T22,ENVNUL,PNUL,sloc(21));
  T24 = VARREF_OR(YgooScolsScycleYPkey_setter,YPfalse);
  T25 = fun_Pkey_setter_4;
  T23 = XCALL2(1,VARREF(YPdefine_method),T24,T25);
  VARSET(YgooScolsScycleYPkey_setter,T23);
  lit_13 = YPPlist(1,YPPsym((P)"_x"));
  T26 = YPsig(LITREF(lit_13),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_5 = YPmet(FUNCODEREF(fun_5),YPfalse,T26,ENVNUL,PNUL,sloc(21));
  T27 = fun_5;
  XCALL5(1,VARREF(YPprop),VARREF(YgooScolsScycleYLcycle_enumG),VARREF(YgooScolsScycleYPkey),VARREF(YgooScolsScycleYPkey_setter),VARREF(YLintG),T27);
  lit_14 = YPPsym((P)"%len");
  ...
  fun_Plen_6 = YPmet(FUNCODEREF(fun_Plen_6),LITREF(lit_14),T28,ENVNUL,PNUL,sloc(22));
  T30 = VARREF_OR(YgooScolsScycleYPlen,YPfalse);
  T31 = fun_Plen_6;
  T29 = XCALL2(1,VARREF(YPdefine_method),T30,T31);
  VARSET(YgooScolsScycleYPlen,T29);
  lit_16 = YPPsym((P)"%len-setter");
  lit_17 = YPPlist(2,YPPsym((P)"_z"),YPPsym((P)"_x"));
  T32 = YPsig(LITREF(lit_17),YPPlist(2,VARREF(YLintG),VARREF(YgooScolsScycleYLcycle_enumG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_Plen_setter_7 = YPmet(FUNCODEREF(fun_Plen_setter_7),LITREF(lit_16),T32,ENVNUL,PNUL,sloc(22));
  T34 = VARREF_OR(YgooScolsScycleYPlen_setter,YPfalse);
  T35 = fun_Plen_setter_7;
  T33 = XCALL2(1,VARREF(YPdefine_method),T34,T35);
  VARSET(YgooScolsScycleYPlen_setter,T33);
  ...
  T36 = YPsig(LITREF(lit_19),YPPlist(1,VARREF(YgooScolsScycleYLcycle_enumG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_Pdat_8 = YPmet(FUNCODEREF(fun_Pdat_8),LITREF(lit_18),T36,ENVNUL,PNUL,sloc(23));
  T38 = VARREF_OR(YgooScolsScycleYPdat,YPfalse);
  T39 = fun_Pdat_8;
  T37 = XCALL2(1,VARREF(YPdefine_method),T38,T39);
  VARSET(YgooScolsScycleYPdat,T37);
  lit_20 = YPPsym((P)"%dat-setter");
  lit_21 = YPPlist(2,YPPsym((P)"_z"),YPPsym((P)"_x"));
  T40 = YPsig(LITREF(lit_21),YPPlist(2,VARREF(YgooScolsScycleYLcycleG),VARREF(YgooScolsScycleYLcycle_enumG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_Pdat_setter_9 = YPmet(FUNCODEREF(fun_Pdat_setter_9),LITREF(lit_20),T40,ENVNUL,PNUL,sloc(23));
  T42 = VARREF_OR(YgooScolsScycleYPdat_setter,YPfalse);
  T43 = fun_Pdat_setter_9;
  T41 = XCALL2(1,VARREF(YPdefine_method),T42,T43);
  VARSET(YgooScolsScycleYPdat_setter,T41);
  ...
  T44 = YPsig(LITREF(lit_23),YPPlist(1,VARREF(YgooScolsScycleYLcycleG)),YPfalse,YPint((P)1),VARREF(YgooScolsScycleYLcycle_enumG),Ynil);
  fun_enum_10 = YPmet(FUNCODEREF(fun_enum_10),LITREF(lit_22),T44,ENVNUL,PNUL,sloc(24));
  ...
  T48 = YPsig(LITREF(lit_25),YPPlist(1,VARREF(YgooScolsScycleYLcycle_enumG)),YPfalse,YPint((P)1),VARREF(YLlogG),Ynil);
  fun_finQ_11 = YPmet(FUNCODEREF(fun_finQ_11),LITREF(lit_24),T48,ENVNUL,PNUL,sloc(26));
  ...
  T52 = YPsig(LITREF(lit_27),YPPlist(1,VARREF(YgooScolsScycleYLcycle_enumG)),YPfalse,YPint((P)1),VARREF(YgooScolsScycleYLcycle_enumG),Ynil);
  fun_nxt_12 = YPmet(FUNCODEREF(fun_nxt_12),LITREF(lit_26),T52,ENVNUL,PNUL,sloc(28));
  ...
  T58 = YPsig(LITREF(lit_29),YPPlist(1,VARREF(YgooScolsScycleYLcycle_enumG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  T57 = fun_now_13 = YPmet(FUNCODEREF(fun_now_13),LITREF(lit_28),T58,ENVNUL,PNUL,sloc(31));
  T61 = VARREF_OR(YgooScolsScolYnow,YPfalse);
  T62 = fun_now_13;
  T60 = XCALL2(1,VARREF(YPdefine_method),T61,T62);
  T59 = VARSET(YgooScolsScolYnow,T60);
  T56 = T59;
  return T56;
}
