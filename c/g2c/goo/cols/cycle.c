...
loop:
  ...
  CALL2(1,VARREF(YgooScolsScycleYPkey_setter),T1,x_1334F1295);
  T0 = x_1334F1295;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  CALLN(1,VARREF(YPprop),5,VARREF(YgooScolsScycleYLcycleG),VARREF(YgooScolsScycleYcycle_elts),VARREF(YgooScolsScycleYcycle_elts_setter),VARREF(YLtupG),VARREF(YPprop_unbound_error));
