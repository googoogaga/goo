...
loop:
  ...
  CALL2(1,VARREF(YgooScolsScycleYPkey_setter),T1,x_7578F23820);
  T0 = x_7578F23820;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  CALL5(1,VARREF(YPprop),VARREF(YgooScolsScycleYLcycleG),VARREF(YgooScolsScycleYcycle_elts),VARREF(YgooScolsScycleYcycle_elts_setter),VARREF(YLtupG),VARREF(YPprop_unbound_error));
  ...
  T32 = fun_5;
  CALL5(1,VARREF(YPprop),VARREF(YgooScolsScycleYLcycle_enumG),VARREF(YgooScolsScycleYPkey),VARREF(YgooScolsScycleYPkey_setter),VARREF(YLintG),T32);
  lit_10 = YPPsym((P)"%len");
  ...
  CALL5(1,VARREF(YPprop),VARREF(YgooScolsScycleYLcycle_enumG),VARREF(YgooScolsScycleYPlen),VARREF(YgooScolsScycleYPlen_setter),VARREF(YLintG),VARREF(YPprop_unbound_error));
  lit_12 = YPPsym((P)"%dat");
  ...
  CALL5(1,VARREF(YPprop),VARREF(YgooScolsScycleYLcycle_enumG),VARREF(YgooScolsScycleYPdat),VARREF(YgooScolsScycleYPdat_setter),VARREF(YgooScolsScycleYLcycleG),VARREF(YPprop_unbound_error));
