...
LOCFOR(fun_suffixQ_60);
LOCFOR(fun_prefixQ_61);
LOCFOR(fun_repeat_62);
LOCFOR(fun_split_63);
LOCFOR(fun_64);
LOCFOR(fun_join_65);
...
loop:
  ...
  conF23419 = T1;
  FUNINIT(conF23419, 3,c_,f_,conF23419);
  T3 = CALL1(1,VARREF(YgooScolsScolYenum),c_);
  T2 = CALL2(0,conF23419,Ynil,T3);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  conF23420 = T1;
  FUNINIT(conF23420, 3,c_,f_,conF23420);
  T3 = CALL1(1,VARREF(YgooScolsScolYenum),c_);
  T2 = CALL2(0,conF23420,Ynil,T3);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  T3 = CALL1(1,VARREF(YgooScolsScolYfinQ),ex_);
  tmpF23423 = T3;
  if (tmpF23423 != YPfalse) {
    T4 = tmpF23423;
  } else {
    T6 = CALL1(1,VARREF(YgooScolsScolYfinQ),ey_);
    tmpF23424 = T6;
    if (tmpF23424 != YPfalse) {
      T7 = tmpF23424;
    } else {
...
loop:
  ...
  lopF23425 = T1;
  FUNINIT(lopF23425, 2,f_,lopF23425);
  T3 = CALL1(1,VARREF(YgooScolsScolYenum),x_);
  T4 = CALL1(1,VARREF(YgooScolsScolYenum),y_);
  T5 = CALL1(1,VARREF(YgooScolsScolYenum),z_);
  T2 = CALL3(0,lopF23425,T3,T4,T5);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}
...
loop:
  ...
  conF23427 = T1;
  FUNINIT(conF23427, 3,x_,f_,conF23427);
  T3 = CALL1(1,VARREF(YgooScolsScolYenum),x_);
  T4 = CALL1(1,VARREF(YgooScolsScolYenum),y_);
  T2 = CALL3(0,conF23427,Ynil,T3,T4);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  fndF23430 = T1;
  FUNINIT(fndF23430, 2,test_,fndF23430);
  T3 = CALL1(1,VARREF(YgooScolsScolYenum),x_);
  T4 = CALL1(1,VARREF(YgooScolsScolYenum),y_);
  T2 = CALL2(0,fndF23430,T3,T4);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  tmpF23431 = T1;
  if (tmpF23431 != YPfalse) {
    T2 = tmpF23431;
  } else {
    T4 = CALL1(1,VARREF(YgooScolsScolYfinQ),ey_);
    tmpF23432 = T4;
    if (tmpF23432 != YPfalse) {
      T5 = tmpF23432;
    } else {
      T8 = CALL1(1,VARREF(YgooScolsScolYnow),ex_);
      T9 = CALL1(1,VARREF(YgooScolsScolYnow),ey_);
...
loop:
  ...
  fndF23434 = T1;
  FUNINIT(fndF23434, 2,test_,fndF23434);
  T3 = CALL1(1,VARREF(YgooScolsScolYenum),x_);
  T4 = CALL1(1,VARREF(YgooScolsScolYenum),y_);
  T2 = CALL2(0,fndF23434,T3,T4);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    innerF23438 = T7;
    FUNINIT(innerF23438, 5,FREEREF(0),FREEREF(1),innerF23438,xsi_,FREEREF(2));
    T8 = CALL2(0,innerF23438,xsi_,YPint((P)0));
    T6 = T8;
    T0 = T6;
  } else {
    T0 = YPfalse;
...
loop:
  ...
  outerF23439 = T1;
  FUNINIT(outerF23439, 3,x_,y_,outerF23439);
  T2 = CALL1(0,outerF23439,YPint((P)0));
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  conF23440 = T1;
  FUNINIT(conF23440, 2,x_,conF23440);
  T3 = CALL1(1,VARREF(YgooScolsScolYenum),x_);
  T2 = CALL2(0,conF23440,Ynil,T3);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    con_yF23441 = T3;
    FUNINIT(con_yF23441, 2,FREEREF(0),con_yF23441);
    T5 = CALL1(1,VARREF(YgooScolsScolYenum),FREEREF(1));
    T4 = CALL2(0,con_yF23441,seq_,T5);
    T2 = T4;
    T0 = T2;
  } else {
    T8 = CALL1(1,VARREF(YgooScolsScolYnow),ex_);
...
loop:
  ...
  con_xF23442 = T1;
  FUNINIT(con_xF23442, 3,x_,y_,con_xF23442);
  T3 = CALL1(1,VARREF(YgooScolsScolYenum),x_);
  T2 = CALL2(0,con_xF23442,Ynil,T3);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  con_xF23443 = T1;
  FUNINIT(con_xF23443, 4,x_,from_,below_,con_xF23443);
  T3 = CALL1(1,VARREF(YgooScolsScolYenum),x_);
  T2 = CALL3(1,con_xF23443,Ynil,YPint((P)0),T3);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    vF23444 = T4;
    T7 = CALL1(1,FREEREF(1),vF23444);
    if (T7 != YPfalse) {
      T8 = CALL2(1,VARREF(YgooScolsScolYadd),seq_,vF23444);
      T6 = T8;
    } else {
      T6 = seq_;
    }
...
loop:
  ...
  conF23445 = T1;
  FUNINIT(conF23445, 3,x_,test_,conF23445);
  T3 = CALL1(1,VARREF(YgooScolsScolYenum),x_);
  T2 = CALL2(0,conF23445,Ynil,T3);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  copyF23446 = T1;
  FUNINIT(copyF23446, 4,x_,before_,v_,copyF23446);
  T3 = CALL1(1,VARREF(YgooScolsScolYenum),x_);
  T2 = CALL3(0,copyF23446,Ynil,YPint((P)0),T3);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
  ...
  if (T1 != YPfalse) {
    ...
    if (T5 != YPfalse) {
      ...
      if (YPtrue != YPfalse) {
        ...
        keyF23447 = T9;
        T11 = CALL2(1,VARREF(YgooSmathYE),i_,keyF23447);
        if (T11 != YPfalse) {
          ...
          T19 = CALL2(1,VARREF(YisaQ),keyF23447,VARREF(YLintG));
          if (T19 != YPfalse) {
            ...
            if (YPtrue != YPfalse) {
              T24 = CALL2(1,VARREF(YgooScolsScolYrange_error),FREEREF(0),keyF23447);
              T23 = T24;
            } else {
              T23 = YPfalse;
            }
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    T8 = T11;
    valF23454 = T8;
    CALL2(1,FREEREF(0),keyF23451,valF23454);
...
loop:
  ...
  repF23455 = T1;
  FUNINIT(repF23455, 2,fn_,repF23455);
  T3 = CALL1(1,VARREF(YgooScolsScolYenum),key_vals_);
  T2 = CALL1(0,repF23455,T3);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
}

FUNCODEDEF(fun_suffixQ_60) {
  P s_,end_;
  P T0,T1,T2,T3,T4,T5;
  P a1,a2;
LINK_STACK();
...
loop:
  ...
  matchF23456 = T1;
  T3 = CALL2(1,VARREF(YgooSmacrosYEE),matchF23456,YPfalse);
  if (T3 != YPfalse) {
    T4 = CALL1(1,VARREF(Ylst),s_);
    T2 = T4;
  } else {
    T6 = CALL3(1,VARREF(YgooScolsSseqYsub),s_,YPint((P)0),matchF23456);
    T9 = CALL2(1,VARREF(YgooSmathYA),matchF23456,YPint((P)1));
...
loop:
  ...
  lit_6 = YPPsym((P)"pos");
  lit_7 = YPPsym((P)"v");
  T12 = CALL1(1,VARREF(YgooScolsSseqYOtQ),VARREF(YLintG));
  ...
  lit_9 = YPPsym((P)"y");
  T15 = CALL1(1,VARREF(YgooScolsSseqYOtQ),VARREF(YLintG));
  ...
  lit_24 = YPPsym((P)"pop");
  T35 = YPsig(YPPlist(1,LITREF(lit_23)),YPPlist(1,VARREF(YLseqG)),YPfalse,YPint((P)1),VARREF(YLtupG),Ynil);
  ...
  T37 = YPsig(YPPlist(3,LITREF(lit_1),LITREF(lit_26),LITREF(lit_27)),YPPlist(3,VARREF(YLseqG),VARREF(YLintG),VARREF(YLintG)),YPfalse,YPint((P)3),VARREF(YLseqG),Ynil);
  T36 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_25),T37,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooScolsSseqYsub,T36);
  lit_28 = YPPsym((P)"ins");
  lit_29 = YPPsym((P)"e");
  lit_30 = YPPsym((P)"before");
  T39 = YPsig(YPPlist(3,LITREF(lit_1),LITREF(lit_29),LITREF(lit_30)),YPPlist(3,VARREF(YLseqG),VARREF(YLanyG),VARREF(YLintG)),YPfalse,YPint((P)3),VARREF(YLseqG),Ynil);
  T38 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_28),T39,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooScolsSseqYins,T38);
  lit_31 = YPPsym((P)"pick");
  T41 = YPsig(YPPlist(2,LITREF(lit_16),LITREF(lit_1)),YPPlist(2,VARREF(YLfunG),VARREF(YLseqG)),YPfalse,YPint((P)2),VARREF(YLseqG),Ynil);
  T40 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_31),T41,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooScolsSseqYpick,T40);
  lit_32 = YPPsym((P)"reject");
  T43 = YPsig(YPPlist(2,LITREF(lit_16),LITREF(lit_1)),YPPlist(2,VARREF(YLfunG),VARREF(YLseqG)),YPfalse,YPint((P)2),VARREF(YLseqG),Ynil);
  T42 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_32),T43,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooScolsSseqYreject,T42);
  lit_33 = YPPsym((P)"del-vals");
  T45 = YPsig(YPPlist(2,LITREF(lit_1),LITREF(lit_7)),YPPlist(2,VARREF(YLseqG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLseqG),Ynil);
  T44 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_33),T45,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooScolsSseqYdel_vals,T44);
  lit_34 = YPPsym((P)"del-dups");
  T47 = YPsig(YPPlist(1,LITREF(lit_1)),YPPlist(1,VARREF(YLseqG)),YPfalse,YPint((P)1),VARREF(YLseqG),Ynil);
  T46 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_34),T47,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooScolsSseqYdel_dups,T46);
  lit_35 = YPPsym((P)"sort");
  T49 = YPsig(YPPlist(1,LITREF(lit_1)),YPPlist(1,VARREF(YLseqG)),YPfalse,YPint((P)1),VARREF(YLseqG),Ynil);
  T48 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_35),T49,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooScolsSseqYsort,T48);
  lit_36 = YPPsym((P)"sort-by");
  T51 = YPsig(YPPlist(2,LITREF(lit_1),LITREF(lit_16)),YPPlist(2,VARREF(YLseqG),VARREF(YLfunG)),YPfalse,YPint((P)2),VARREF(YLseqG),Ynil);
  T50 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_36),T51,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooScolsSseqYsort_by,T50);
  lit_37 = YPPsym((P)"suffix?");
  lit_38 = YPPsym((P)"s");
  lit_39 = YPPsym((P)"suffix");
  T53 = YPsig(YPPlist(2,LITREF(lit_38),LITREF(lit_39)),YPPlist(2,VARREF(YLseqG),VARREF(YLseqG)),YPfalse,YPint((P)2),VARREF(YLlogG),Ynil);
  T52 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_37),T53,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooScolsSseqYsuffixQ,T52);
  lit_40 = YPPsym((P)"prefix?");
  lit_41 = YPPsym((P)"prefix");
  T55 = YPsig(YPPlist(2,LITREF(lit_38),LITREF(lit_41)),YPPlist(2,VARREF(YLseqG),VARREF(YLseqG)),YPfalse,YPint((P)2),VARREF(YLlogG),Ynil);
  T54 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_40),T55,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooScolsSseqYprefixQ,T54);
  lit_42 = YPPsym((P)"repeat");
  lit_43 = YPPsym((P)"n");
  T57 = YPsig(YPPlist(2,LITREF(lit_38),LITREF(lit_43)),YPPlist(2,VARREF(YLseqG),VARREF(YLintG)),YPfalse,YPint((P)2),VARREF(YLseqG),Ynil);
  T56 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_42),T57,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooScolsSseqYrepeat,T56);
  T58 = YPfalse;
  return T58;
}
...
P YgooScolsSseqY___main_1___() {
  ...
  P T224,T225,T226,T227,T228,T229,T230,T231,T232,T233,T234,T235;
loop:
  ...
  T82 = CALL1(1,VARREF(YgooScolsSseqYOtQ),VARREF(YLintG));
  ...
  T89 = CALL1(1,VARREF(YgooScolsSseqYOtQ),VARREF(YLintG));
  ...
  T125 = YPsig(YPPlist(1,LITREF(lit_23)),YPPlist(1,VARREF(YLseqG)),YPfalse,YPint((P)1),VARREF(YLtupG),Ynil);
  fun_pop_36 = YPmet(FUNCODEREF(fun_pop_36),LITREF(lit_24),T125,ENVNUL,PNUL,YPfalse);
  T128 = BOUNDP(YgooScolsSseqYpop);
  if (T128 != YPfalse) {
    T127 = VARREF(YgooScolsSseqYpop);
  } else {
    T127 = YPfalse;
  }
  T129 = fun_pop_36;
  T126 = CALL2(1,VARREF(YPdefine_method),T127,T129);
  VARSET(YgooScolsSseqYpop,T126);
  T131 = YPsig(YPPlist(2,LITREF(lit_75),LITREF(lit_29)),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_con_37 = YPmet(FUNCODEREF(fun_con_37),LITREF(lit_55),T131,ENVNUL,PNUL,YPfalse);
  T130 = YPsig(YPPlist(2,LITREF(lit_16),LITREF(lit_1)),YPPlist(2,VARREF(YLfunG),VARREF(YLseqG)),YPfalse,YPint((P)2),VARREF(YLseqG),Ynil);
  fun_pick_38 = YPmet(FUNCODEREF(fun_pick_38),LITREF(lit_31),T130,ENVNUL,PNUL,YPfalse);
  T134 = BOUNDP(YgooScolsSseqYpick);
  if (T134 != YPfalse) {
    T133 = VARREF(YgooScolsSseqYpick);
  } else {
    T133 = YPfalse;
  }
  T135 = fun_pick_38;
  T132 = CALL2(1,VARREF(YPdefine_method),T133,T135);
  VARSET(YgooScolsSseqYpick,T132);
  ...
  T136 = YPsig(YPPlist(2,LITREF(lit_16),LITREF(lit_1)),YPPlist(2,VARREF(YLfunG),VARREF(YLseqG)),YPfalse,YPint((P)2),VARREF(YLseqG),Ynil);
  fun_reject_40 = YPmet(FUNCODEREF(fun_reject_40),LITREF(lit_32),T136,ENVNUL,PNUL,YPfalse);
  T140 = BOUNDP(YgooScolsSseqYreject);
  if (T140 != YPfalse) {
    T139 = VARREF(YgooScolsSseqYreject);
  } else {
    T139 = YPfalse;
  }
  T141 = fun_reject_40;
  T138 = CALL2(1,VARREF(YPdefine_method),T139,T141);
  VARSET(YgooScolsSseqYreject,T138);
  lit_79 = YPPsym((P)"del");
  lit_80 = YPPsym((P)"key");
  T142 = YPsig(YPPlist(2,LITREF(lit_1),LITREF(lit_80)),YPPlist(2,VARREF(YLseqG),VARREF(YLintG)),YPfalse,YPint((P)2),VARREF(YLseqG),Ynil);
  fun_del_41 = YPmet(FUNCODEREF(fun_del_41),LITREF(lit_79),T142,ENVNUL,PNUL,YPfalse);
  T145 = BOUNDP(YgooScolsScolYdel);
  if (T145 != YPfalse) {
    T144 = VARREF(YgooScolsScolYdel);
  } else {
    T144 = YPfalse;
  }
  T146 = fun_del_41;
  T143 = CALL2(1,VARREF(YPdefine_method),T144,T146);
  VARSET(YgooScolsScolYdel,T143);
  T148 = YPsig(YPPlist(1,LITREF(lit_29)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_42 = YPmet(FUNCODEREF(fun_42),YPfalse,T148,ENVNUL,PNUL,YPfalse);
  T147 = YPsig(YPPlist(2,LITREF(lit_38),LITREF(lit_1)),YPPlist(2,VARREF(YLseqG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLseqG),Ynil);
  fun_del_vals_43 = YPmet(FUNCODEREF(fun_del_vals_43),LITREF(lit_33),T147,ENVNUL,PNUL,YPfalse);
  T151 = BOUNDP(YgooScolsSseqYdel_vals);
  if (T151 != YPfalse) {
    T150 = VARREF(YgooScolsSseqYdel_vals);
  } else {
    T150 = YPfalse;
  }
  T152 = fun_del_vals_43;
  T149 = CALL2(1,VARREF(YPdefine_method),T150,T152);
  VARSET(YgooScolsSseqYdel_vals,T149);
  T154 = YPsig(YPPlist(2,LITREF(lit_38),LITREF(lit_29)),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_44 = YPmet(FUNCODEREF(fun_44),YPfalse,T154,ENVNUL,PNUL,YPfalse);
  T153 = YPsig(YPPlist(1,LITREF(lit_1)),YPPlist(1,VARREF(YLseqG)),YPfalse,YPint((P)1),VARREF(YLseqG),Ynil);
  fun_del_dups_45 = YPmet(FUNCODEREF(fun_del_dups_45),LITREF(lit_34),T153,ENVNUL,PNUL,YPfalse);
  T157 = BOUNDP(YgooScolsSseqYdel_dups);
  if (T157 != YPfalse) {
    T156 = VARREF(YgooScolsSseqYdel_dups);
  } else {
    T156 = YPfalse;
  }
  T158 = fun_del_dups_45;
  T155 = CALL2(1,VARREF(YPdefine_method),T156,T158);
  VARSET(YgooScolsSseqYdel_dups,T155);
  lit_81 = YPPsym((P)"copy");
  lit_82 = YPPsym((P)"r");
  T160 = YPsig(YPPlist(3,LITREF(lit_82),LITREF(lit_78),LITREF(lit_29)),YPPlist(3,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_copy_46 = YPmet(FUNCODEREF(fun_copy_46),LITREF(lit_81),T160,ENVNUL,PNUL,YPfalse);
  T159 = YPsig(YPPlist(3,LITREF(lit_1),LITREF(lit_7),LITREF(lit_30)),YPPlist(3,VARREF(YLseqG),VARREF(YLanyG),VARREF(YLintG)),YPfalse,YPint((P)3),VARREF(YLseqG),Ynil);
  fun_ins_47 = YPmet(FUNCODEREF(fun_ins_47),LITREF(lit_28),T159,ENVNUL,PNUL,YPfalse);
  T163 = BOUNDP(YgooScolsSseqYins);
  if (T163 != YPfalse) {
    T162 = VARREF(YgooScolsSseqYins);
  } else {
    T162 = YPfalse;
  }
  T164 = fun_ins_47;
  T161 = CALL2(1,VARREF(YPdefine_method),T162,T164);
  VARSET(YgooScolsSseqYins,T161);
  lit_83 = YPPsym((P)"elts");
  lit_84 = YPPsym((P)"keys");
  T166 = YPsig(YPPlist(4,LITREF(lit_82),LITREF(lit_29),LITREF(lit_78),LITREF(lit_84)),YPPlist(4,VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)4),VARREF(YLanyG),Ynil);
  fun_copy_48 = YPmet(FUNCODEREF(fun_copy_48),LITREF(lit_81),T166,ENVNUL,PNUL,YPfalse);
  T165 = YPsig(YPPlist(2,LITREF(lit_1),LITREF(lit_84)),YPPlist(2,VARREF(YLseqG),VARREF(YLseqG)),YPfalse,YPint((P)2),VARREF(YLseqG),Ynil);
  fun_elts_49 = YPmet(FUNCODEREF(fun_elts_49),LITREF(lit_83),T165,ENVNUL,PNUL,YPfalse);
  T169 = BOUNDP(YgooScolsScolYelts);
  if (T169 != YPfalse) {
    T168 = VARREF(YgooScolsScolYelts);
  } else {
    T168 = YPfalse;
  }
  T170 = fun_elts_49;
  T167 = CALL2(1,VARREF(YPdefine_method),T168,T170);
  VARSET(YgooScolsScolYelts,T167);
  T171 = YPsig(YPPlist(1,LITREF(lit_1)),YPPlist(1,VARREF(YLseqG)),YPfalse,YPint((P)1),VARREF(YLseqG),Ynil);
  fun_sort_50 = YPmet(FUNCODEREF(fun_sort_50),LITREF(lit_35),T171,ENVNUL,PNUL,YPfalse);
  T174 = BOUNDP(YgooScolsSseqYsort);
  if (T174 != YPfalse) {
    T173 = VARREF(YgooScolsSseqYsort);
  } else {
    T173 = YPfalse;
  }
  T175 = fun_sort_50;
  T172 = CALL2(1,VARREF(YPdefine_method),T173,T175);
  VARSET(YgooScolsSseqYsort,T172);
  T176 = YPsig(YPPlist(2,LITREF(lit_1),LITREF(lit_16)),YPPlist(2,VARREF(YLseqG),VARREF(YLfunG)),YPfalse,YPint((P)2),VARREF(YLseqG),Ynil);
  fun_sort_by_51 = YPmet(FUNCODEREF(fun_sort_by_51),LITREF(lit_36),T176,ENVNUL,PNUL,YPfalse);
  T179 = BOUNDP(YgooScolsSseqYsort_by);
  if (T179 != YPfalse) {
    T178 = VARREF(YgooScolsSseqYsort_by);
  } else {
    T178 = YPfalse;
  }
  T180 = fun_sort_by_51;
  T177 = CALL2(1,VARREF(YPdefine_method),T178,T180);
  VARSET(YgooScolsSseqYsort_by,T177);
  lit_85 = YPPsym((P)"d");
  T181 = YPsig(YPPlist(1,LITREF(lit_85)),YPPlist(1,VARREF(YLseqG)),YPfalse,YPint((P)1),VARREF(YLseqG),Ynil);
  fun_keys_52 = YPmet(FUNCODEREF(fun_keys_52),LITREF(lit_84),T181,ENVNUL,PNUL,YPfalse);
  ...
  T186 = YPsig(YPPlist(2,LITREF(lit_1),LITREF(lit_78)),YPPlist(2,VARREF(YLseqG),VARREF(YLintG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  YgooScolsSseqYrange_check = YPmet(FUNCODEREF(YgooScolsSseqYrange_check),LITREF(lit_86),T186,ENVNUL,PNUL,YPfalse);
  T187 = YgooScolsSseqYrange_check;
  VARSET(YgooScolsSseqYrange_check,T187);
  lit_87 = YPPsym((P)"range-check?");
  T188 = YPsig(YPPlist(2,LITREF(lit_1),LITREF(lit_78)),YPPlist(2,VARREF(YLseqG),VARREF(YLintG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  YgooScolsSseqYrange_checkQ = YPmet(FUNCODEREF(YgooScolsSseqYrange_checkQ),LITREF(lit_87),T188,ENVNUL,PNUL,YPfalse);
  T189 = YgooScolsSseqYrange_checkQ;
  VARSET(YgooScolsSseqYrange_checkQ,T189);
  lit_88 = YPPsym((P)"add-new");
  T190 = YPsig(YPPlist(2,LITREF(lit_54),LITREF(lit_1)),YPPlist(2,VARREF(YLseqG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLseqG),Ynil);
  fun_add_new_55 = YPmet(FUNCODEREF(fun_add_new_55),LITREF(lit_88),T190,ENVNUL,PNUL,YPfalse);
  T193 = BOUNDP(YgooScolsSseqYadd_new);
  if (T193 != YPfalse) {
    T192 = VARREF(YgooScolsSseqYadd_new);
  } else {
    T192 = YPfalse;
  }
  T194 = fun_add_new_55;
  T191 = CALL2(1,VARREF(YPdefine_method),T192,T194);
  VARSET(YgooScolsSseqYadd_new,T191);
  lit_89 = YPsb((P)"");
  lit_90 = YPsb((P)" ");
  T196 = YPsig(YPPlist(2,LITREF(lit_38),LITREF(lit_29)),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_56 = YPmet(FUNCODEREF(fun_56),YPfalse,T196,ENVNUL,PNUL,YPfalse);
  T195 = YPsig(YPPlist(1,LITREF(lit_38)),YPPlist(1,VARREF(YLseqG)),YPfalse,YPint((P)1),VARREF(YLstrG),Ynil);
  fun_vals_to_str_57 = YPmet(FUNCODEREF(fun_vals_to_str_57),LITREF(lit_48),T195,ENVNUL,PNUL,YPfalse);
  T199 = BOUNDP(YgooScolsSseqYvals_to_str);
  if (T199 != YPfalse) {
    T198 = VARREF(YgooScolsSseqYvals_to_str);
  } else {
    T198 = YPfalse;
  }
  T200 = fun_vals_to_str_57;
  T197 = CALL2(1,VARREF(YPdefine_method),T198,T200);
  VARSET(YgooScolsSseqYvals_to_str,T197);
  lit_91 = YPPsym((P)"rep");
  T202 = YPsig(YPPlist(1,LITREF(lit_29)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_rep_58 = YPmet(FUNCODEREF(fun_rep_58),LITREF(lit_91),T202,ENVNUL,PNUL,YPfalse);
  T201 = YPsig(YPPlist(2,LITREF(lit_50),LITREF(lit_51)),YPPlist(2,VARREF(YLfunG),VARREF(YLseqG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_do_key_vals_59 = YPmet(FUNCODEREF(fun_do_key_vals_59),LITREF(lit_49),T201,ENVNUL,PNUL,YPfalse);
  T205 = BOUNDP(YgooScolsSseqYdo_key_vals);
  if (T205 != YPfalse) {
    T204 = VARREF(YgooScolsSseqYdo_key_vals);
  } else {
    T204 = YPfalse;
  }
  T206 = fun_do_key_vals_59;
  T203 = CALL2(1,VARREF(YPdefine_method),T204,T206);
  VARSET(YgooScolsSseqYdo_key_vals,T203);
  lit_92 = YPPsym((P)"end");
  T207 = YPsig(YPPlist(2,LITREF(lit_38),LITREF(lit_92)),YPPlist(2,VARREF(YLseqG),VARREF(YLseqG)),YPfalse,YPint((P)2),VARREF(YLlogG),Ynil);
  fun_suffixQ_60 = YPmet(FUNCODEREF(fun_suffixQ_60),LITREF(lit_37),T207,ENVNUL,PNUL,YPfalse);
  T210 = BOUNDP(YgooScolsSseqYsuffixQ);
  if (T210 != YPfalse) {
    T209 = VARREF(YgooScolsSseqYsuffixQ);
  } else {
    T209 = YPfalse;
  }
  T211 = fun_suffixQ_60;
  T208 = CALL2(1,VARREF(YPdefine_method),T209,T211);
  VARSET(YgooScolsSseqYsuffixQ,T208);
  lit_93 = YPPsym((P)"begin");
  T212 = YPsig(YPPlist(2,LITREF(lit_38),LITREF(lit_93)),YPPlist(2,VARREF(YLseqG),VARREF(YLseqG)),YPfalse,YPint((P)2),VARREF(YLlogG),Ynil);
  fun_prefixQ_61 = YPmet(FUNCODEREF(fun_prefixQ_61),LITREF(lit_40),T212,ENVNUL,PNUL,YPfalse);
  T215 = BOUNDP(YgooScolsSseqYprefixQ);
  if (T215 != YPfalse) {
    T214 = VARREF(YgooScolsSseqYprefixQ);
  } else {
    T214 = YPfalse;
  }
  T216 = fun_prefixQ_61;
  T213 = CALL2(1,VARREF(YPdefine_method),T214,T216);
  VARSET(YgooScolsSseqYprefixQ,T213);
  T217 = YPsig(YPPlist(2,LITREF(lit_38),LITREF(lit_43)),YPPlist(2,VARREF(YLseqG),VARREF(YLintG)),YPfalse,YPint((P)2),VARREF(YLseqG),Ynil);
  fun_repeat_62 = YPmet(FUNCODEREF(fun_repeat_62),LITREF(lit_42),T217,ENVNUL,PNUL,YPfalse);
  T220 = BOUNDP(YgooScolsSseqYrepeat);
  if (T220 != YPfalse) {
    T219 = VARREF(YgooScolsSseqYrepeat);
  } else {
    T219 = YPfalse;
  }
  T221 = fun_repeat_62;
  T218 = CALL2(1,VARREF(YPdefine_method),T219,T221);
  VARSET(YgooScolsSseqYrepeat,T218);
  T222 = YPsig(YPPlist(2,LITREF(lit_38),LITREF(lit_45)),YPPlist(2,VARREF(YLseqG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLlstG),Ynil);
  fun_split_63 = YPmet(FUNCODEREF(fun_split_63),LITREF(lit_44),T222,ENVNUL,PNUL,YPfalse);
  T225 = BOUNDP(YgooScolsSseqYsplit);
  if (T225 != YPfalse) {
    T224 = VARREF(YgooScolsSseqYsplit);
  } else {
    T224 = YPfalse;
  }
  T226 = fun_split_63;
  T223 = CALL2(1,VARREF(YPdefine_method),T224,T226);
  VARSET(YgooScolsSseqYsplit,T223);
  T228 = YPsig(YPPlist(2,LITREF(lit_1),LITREF(lit_9)),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_64 = YPmet(FUNCODEREF(fun_64),YPfalse,T228,ENVNUL,PNUL,YPfalse);
  T227 = YPsig(YPPlist(2,LITREF(lit_47),LITREF(lit_45)),YPPlist(2,VARREF(YLseqG),VARREF(YLseqG)),YPfalse,YPint((P)2),VARREF(YLseqG),Ynil);
  fun_join_65 = YPmet(FUNCODEREF(fun_join_65),LITREF(lit_46),T227,ENVNUL,PNUL,YPfalse);
  T231 = BOUNDP(YgooScolsSseqYjoin);
  if (T231 != YPfalse) {
    T230 = VARREF(YgooScolsSseqYjoin);
  } else {
    T230 = YPfalse;
  }
  T232 = fun_join_65;
  T229 = CALL2(1,VARREF(YPdefine_method),T230,T232);
  VARSET(YgooScolsSseqYjoin,T229);
  tmpF23457 = YPfalse;
  if (tmpF23457 != YPfalse) {
    T233 = VARREF(YgooScolsSseqYbelow);
  } else {
    T233 = YPfalse;
  }
  tmpF23458 = YPfalse;
  if (tmpF23458 != YPfalse) {
    T234 = VARREF(YgooScolsSseqYsort_byX);
  } else {
    T234 = YPfalse;
  }
  T235 = YPfalse;
...
static BINDING_INFO binding_infos[] = {
  {"pop", &YgooScolsSseqYpop},
  {"reject", &YgooScolsSseqYreject},
  {"any2?", &YgooScolsSseqYany2Q},
  {"sort-by", &YgooScolsSseqYsort_by},
