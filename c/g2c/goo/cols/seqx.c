...
LINK_STACK();
  ...
  LOOP_91: {
    P a91_0,a91_1;
    T3 = CALL1(1,VARREF(YgooScolsScolYfinQ),esF3178);
    tmpF3179 = T3;
    if (tmpF3179 != YPfalse) {
      T1 = tmpF3179;
    } else {
      T2 = CALL1(1,VARREF(YgooScolsScolYfinQ),edF3177);
      T1 = T2;
    }
    if (T1 != YPfalse) {
      T0 = dst_;
    } else {
      T4 = CALL1(1,VARREF(YgooScolsScolYnow),esF3178);
      CALL2(1,VARREF(YgooScolsScolYnow_setter),T4,edF3177);
      T6 = CALL1(1,VARREF(YgooScolsScolYnxt),edF3177);
      T7 = CALL1(1,VARREF(YgooScolsScolYnxt),esF3178);
      a91_0 = T6;
      a91_1 = T7;
      edF3177 = a91_0;
      esF3178 = a91_1;
...
LINK_STACK();
  ...
  del_lenF3182 = T47;
  T1 = CALL2(1,VARREF(YgooSlogYE),del_lenF3182,src_lenF3181);
  if (T1 != YPfalse) {
    ...
    LOOP_92: {
      P a92_0,a92_1;
      T3 = CALL2(1,VARREF(YgooSlogYE),iF3184,from_);
      if (T3 != YPfalse) {
        dF3185 = dF3183;
        ...
        LOOP_93: {
          P a93_0,a93_1;
          T5 = CALL1(1,VARREF(YgooScolsScolYfinQ),sF3186);
          if (T5 != YPfalse) {
            T4 = dst_;
          } else {
            T6 = CALL1(1,VARREF(YgooScolsScolYnow),sF3186);
            CALL2(1,VARREF(YgooScolsScolYnow_setter),T6,dF3185);
            T8 = CALL1(1,VARREF(YgooScolsScolYnxt),dF3185);
            T9 = CALL1(1,VARREF(YgooScolsScolYnxt),sF3186);
            a93_0 = T8;
            a93_1 = T9;
            dF3185 = a93_0;
            sF3186 = a93_1;
        ...
        T12 = CALL1(1,VARREF(YgooScolsScolYnxt),dF3183);
        T13 = CALL2(1,VARREF(YgooSmathYA),iF3184,YPint((P)1));
        a92_0 = T12;
        a92_1 = T13;
        dF3183 = a92_0;
        iF3184 = a92_1;
    ...
    T46 = CALL2(1,VARREF(YgooSmathY_),dst_lenF3180,del_lenF3182);
    T45 = CALL2(1,VARREF(YgooSmathYA),T46,src_lenF3181);
    new_lenF3187 = T45;
    T44 = CALL1(1,VARREF(YgooSclassYclass_of),dst_);
    T43 = CALL2(1,VARREF(YgooScolsScolYfab),T44,new_lenF3187);
    ndstF3188 = T43;
    T41 = CALL1(1,VARREF(YgooScolsScolYenum),ndstF3188);
    ndF3189 = T41;
    ...
    LOOP_94: {
      P a94_0,a94_1,a94_2;
      T16 = CALL2(1,VARREF(YgooSlogYE),iF3191,from_);
      if (T16 != YPfalse) {
        ndF3192 = ndF3189;
        ...
        LOOP_95: {
          P a95_0,a95_1;
          T18 = CALL1(1,VARREF(YgooScolsScolYfinQ),sF3193);
          if (T18 != YPfalse) {
            dF3194 = dF3190;
            iF3195 = from_;
            LOOP_96: {
              P a96_0,a96_1;
              T20 = CALL2(1,VARREF(YgooSlogYE),iF3195,below_);
              if (T20 != YPfalse) {
                ndF3196 = ndF3192;
                dF3197 = dF3194;
                iF3198 = below_;
                LOOP_97: {
                  P a97_0,a97_1,a97_2;
                  T22 = CALL2(1,VARREF(YgooSlogYE),iF3198,dst_lenF3180);
                  if (T22 != YPfalse) {
                    T21 = ndstF3188;
                  } else {
                    T23 = CALL1(1,VARREF(YgooScolsScolYnow),dF3197);
                    CALL2(1,VARREF(YgooScolsScolYnow_setter),T23,ndF3196);
                    T25 = CALL1(1,VARREF(YgooScolsScolYnxt),ndF3196);
                    T26 = CALL1(1,VARREF(YgooScolsScolYnxt),dF3197);
                    T27 = CALL2(1,VARREF(YgooSmathYA),iF3198,YPint((P)1));
                    a97_0 = T25;
                    a97_1 = T26;
                    a97_2 = T27;
                    ndF3196 = a97_0;
                ...
                T29 = CALL1(1,VARREF(YgooScolsScolYnxt),dF3194);
                T30 = CALL2(1,VARREF(YgooSmathYA),iF3195,YPint((P)1));
                a96_0 = T29;
                a96_1 = T30;
                dF3194 = a96_0;
                iF3195 = a96_1;
            ...
            T31 = CALL1(1,VARREF(YgooScolsScolYnow),sF3193);
            CALL2(1,VARREF(YgooScolsScolYnow_setter),T31,ndF3192);
            T33 = CALL1(1,VARREF(YgooScolsScolYnxt),ndF3192);
            T34 = CALL1(1,VARREF(YgooScolsScolYnxt),sF3193);
            a95_0 = T33;
            a95_1 = T34;
            ndF3192 = a95_0;
            sF3193 = a95_1;
        ...
        T36 = CALL1(1,VARREF(YgooScolsScolYnow),dF3190);
        CALL2(1,VARREF(YgooScolsScolYnow_setter),T36,ndF3189);
        T38 = CALL1(1,VARREF(YgooScolsScolYnxt),ndF3189);
        T39 = CALL1(1,VARREF(YgooScolsScolYnxt),dF3190);
        T40 = CALL2(1,VARREF(YgooSmathYA),iF3191,YPint((P)1));
        a94_0 = T38;
        a94_1 = T39;
        a94_2 = T40;
        ndF3189 = a94_0;
...
LINK_STACK();
  ...
  LOOP_98: {
    P a98_0,a98_1;
    T3 = CALL1(1,VARREF(YgooScolsScolYfinQ),dF3199);
    tmpF3201 = T3;
    if (tmpF3201 != YPfalse) {
      T1 = tmpF3201;
    } else {
      T2 = CALL1(1,VARREF(YgooScolsScolYfinQ),sF3200);
      T1 = T2;
    }
    if (T1 != YPfalse) {
      T0 = dst_;
    } else {
      T4 = CALL1(1,VARREF(YgooScolsScolYnow),sF3200);
      CALL2(1,VARREF(YgooScolsScolYnow_setter),T4,dF3199);
      T6 = CALL1(1,VARREF(YgooScolsScolYnxt),dF3199);
      T7 = CALL1(1,VARREF(YgooScolsScolYnxt),sF3200);
      a98_0 = T6;
      a98_1 = T7;
      dF3199 = a98_0;
      sF3200 = a98_1;
