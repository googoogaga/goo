...
LINK_STACK();
  ...
  for (;;) {
    P a86_0,a86_1;
  loop86:
    T7 = CALL1(1,VARREF(YgooScolsScolYfinQ),esF1890);
    tmpF1891 = T7;
    if (tmpF1891 != YPfalse) {
      T8 = tmpF1891;
    } else {
      T9 = CALL1(1,VARREF(YgooScolsScolYfinQ),edF1889);
      T8 = T9;
    }
    T6 = T8;
    if (T6 != YPfalse) {
      ...
      T10 = CALL1(1,VARREF(YgooScolsScolYnow),esF1890);
      CALL2(1,VARREF(YgooScolsScolYnow_setter),T10,edF1889);
      T12 = CALL1(1,VARREF(YgooScolsScolYnxt),edF1889);
      T13 = CALL1(1,VARREF(YgooScolsScolYnxt),esF1890);
      a86_0 = T12;
      a86_1 = T13;
      edF1889 = a86_0;
      esF1890 = a86_1;
...
LINK_STACK();
  ...
  del_lenF1894 = T5;
  T7 = CALL2(1,VARREF(YgooSmathYE),del_lenF1894,src_lenF1893);
  if (T7 != YPfalse) {
    T9 = CALL1(1,VARREF(YgooScolsScolYenum),dst_);
    dF1895 = T9;
    iF1896 = YPint((P)0);
    for (;;) {
      P a87_0,a87_1;
    loop87:
      T12 = CALL2(1,VARREF(YgooSmathYE),iF1896,from_);
      if (T12 != YPfalse) {
        dF1897 = dF1895;
        T14 = CALL1(1,VARREF(YgooScolsScolYenum),src_);
        sF1898 = T14;
        for (;;) {
          P a88_0,a88_1;
        loop88:
          T17 = CALL1(1,VARREF(YgooScolsScolYfinQ),sF1898);
          if (T17 != YPfalse) {
            T16 = dst_;
          } else {
            T18 = CALL1(1,VARREF(YgooScolsScolYnow),sF1898);
            CALL2(1,VARREF(YgooScolsScolYnow_setter),T18,dF1897);
            T20 = CALL1(1,VARREF(YgooScolsScolYnxt),dF1897);
            T21 = CALL1(1,VARREF(YgooScolsScolYnxt),sF1898);
            a88_0 = T20;
            a88_1 = T21;
            dF1897 = a88_0;
            sF1898 = a88_1;
        ...
        T23 = CALL1(1,VARREF(YgooScolsScolYnxt),dF1895);
        T24 = CALL2(1,VARREF(YgooSmathYA),iF1896,YPint((P)1));
        a87_0 = T23;
        a87_1 = T24;
        dF1895 = a87_0;
        iF1896 = a87_1;
    ...
    T27 = CALL2(1,VARREF(YgooSmathY_),dst_lenF1892,del_lenF1894);
    T26 = CALL2(1,VARREF(YgooSmathYA),T27,src_lenF1893);
    new_lenF1899 = T26;
    T30 = CALL1(1,VARREF(Yclass_of),dst_);
    T29 = CALL2(1,VARREF(YgooScolsScolYfab),T30,new_lenF1899);
    ndstF1900 = T29;
    T32 = CALL1(1,VARREF(YgooScolsScolYenum),ndstF1900);
    ndF1901 = T32;
    T33 = CALL1(1,VARREF(YgooScolsScolYenum),dst_);
    dF1902 = T33;
    iF1903 = YPint((P)0);
    for (;;) {
      P a89_0,a89_1,a89_2;
    loop89:
      T36 = CALL2(1,VARREF(YgooSmathYE),iF1903,from_);
      if (T36 != YPfalse) {
        ndF1904 = ndF1901;
        T38 = CALL1(1,VARREF(YgooScolsScolYenum),src_);
        sF1905 = T38;
        for (;;) {
          P a90_0,a90_1;
        loop90:
          T41 = CALL1(1,VARREF(YgooScolsScolYfinQ),sF1905);
          if (T41 != YPfalse) {
            dF1906 = dF1902;
            iF1907 = from_;
            for (;;) {
              P a91_0,a91_1;
            loop91:
              T45 = CALL2(1,VARREF(YgooSmathYE),iF1907,below_);
              if (T45 != YPfalse) {
                ndF1908 = ndF1904;
                dF1909 = dF1906;
                iF1910 = below_;
                for (;;) {
                  P a92_0,a92_1,a92_2;
                loop92:
                  T49 = CALL2(1,VARREF(YgooSmathYE),iF1910,dst_lenF1892);
                  if (T49 != YPfalse) {
                    T48 = ndstF1900;
                  } else {
                    T50 = CALL1(1,VARREF(YgooScolsScolYnow),dF1909);
                    CALL2(1,VARREF(YgooScolsScolYnow_setter),T50,ndF1908);
                    T52 = CALL1(1,VARREF(YgooScolsScolYnxt),ndF1908);
                    T53 = CALL1(1,VARREF(YgooScolsScolYnxt),dF1909);
                    T54 = CALL2(1,VARREF(YgooSmathYA),iF1910,YPint((P)1));
                    a92_0 = T52;
                    a92_1 = T53;
                    a92_2 = T54;
                    ndF1908 = a92_0;
                ...
                T56 = CALL1(1,VARREF(YgooScolsScolYnxt),dF1906);
                T57 = CALL2(1,VARREF(YgooSmathYA),iF1907,YPint((P)1));
                a91_0 = T56;
                a91_1 = T57;
                dF1906 = a91_0;
                iF1907 = a91_1;
            ...
            T58 = CALL1(1,VARREF(YgooScolsScolYnow),sF1905);
            CALL2(1,VARREF(YgooScolsScolYnow_setter),T58,ndF1904);
            T60 = CALL1(1,VARREF(YgooScolsScolYnxt),ndF1904);
            T61 = CALL1(1,VARREF(YgooScolsScolYnxt),sF1905);
            a90_0 = T60;
            a90_1 = T61;
            ndF1904 = a90_0;
            sF1905 = a90_1;
        ...
        T62 = CALL1(1,VARREF(YgooScolsScolYnow),dF1902);
        CALL2(1,VARREF(YgooScolsScolYnow_setter),T62,ndF1901);
        T64 = CALL1(1,VARREF(YgooScolsScolYnxt),ndF1901);
        T65 = CALL1(1,VARREF(YgooScolsScolYnxt),dF1902);
        T66 = CALL2(1,VARREF(YgooSmathYA),iF1903,YPint((P)1));
        a89_0 = T64;
        a89_1 = T65;
        a89_2 = T66;
        ndF1901 = a89_0;
...
LINK_STACK();
  ...
  for (;;) {
    P a93_0,a93_1;
  loop93:
    T7 = CALL1(1,VARREF(YgooScolsScolYfinQ),dF1911);
    tmpF1913 = T7;
    if (tmpF1913 != YPfalse) {
      T8 = tmpF1913;
    } else {
      T9 = CALL1(1,VARREF(YgooScolsScolYfinQ),sF1912);
      T8 = T9;
    }
    T6 = T8;
    if (T6 != YPfalse) {
      ...
      T10 = CALL1(1,VARREF(YgooScolsScolYnow),sF1912);
      CALL2(1,VARREF(YgooScolsScolYnow_setter),T10,dF1911);
      T12 = CALL1(1,VARREF(YgooScolsScolYnxt),dF1911);
      T13 = CALL1(1,VARREF(YgooScolsScolYnxt),sF1912);
      a93_0 = T12;
      a93_1 = T13;
      dF1911 = a93_0;
      sF1912 = a93_1;
...
DEFCREGS();
  ...
  fun_into_7 = YPmet(FUNCODEREF(fun_into_7),LITREF(lit_31),T54,ENVNUL,PNUL,sloc(51));
  ...
  fun_sub_setter_8 = YPmet(FUNCODEREF(fun_sub_setter_8),LITREF(lit_8),T58,ENVNUL,PNUL,sloc(58));
  ...
  fun_subT_setter_9 = YPmet(FUNCODEREF(fun_subT_setter_9),LITREF(lit_10),T62,ENVNUL,PNUL,sloc(90));
  ...
  fun_sortX_10 = YPmet(FUNCODEREF(fun_sortX_10),LITREF(lit_18),T66,ENVNUL,PNUL,sloc(93));
  ...
  T71 = fun_alter_11 = YPmet(FUNCODEREF(fun_alter_11),LITREF(lit_22),T72,ENVNUL,PNUL,sloc(101));
