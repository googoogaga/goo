...
LINK_STACK();
  ...
  for (;;) {
    P a86_0,a86_1;
  loop86:
    T3 = CALL1(1,VARREF(YgooScolsScolYfinQ),esF1873);
    tmpF1874 = T3;
    if (tmpF1874 != YPfalse) {
      T1 = tmpF1874;
    } else {
      T2 = CALL1(1,VARREF(YgooScolsScolYfinQ),edF1872);
      T1 = T2;
    }
    if (T1 != YPfalse) {
      T0 = dst_;
    } else {
      T4 = CALL1(1,VARREF(YgooScolsScolYnow),esF1873);
      CALL2(1,VARREF(YgooScolsScolYnow_setter),T4,edF1872);
      T6 = CALL1(1,VARREF(YgooScolsScolYnxt),edF1872);
      T7 = CALL1(1,VARREF(YgooScolsScolYnxt),esF1873);
      a86_0 = T6;
      a86_1 = T7;
      edF1872 = a86_0;
      esF1873 = a86_1;
...
LINK_STACK();
  ...
  del_lenF1877 = T47;
  T1 = CALL2(1,VARREF(YgooSmathYE),del_lenF1877,src_lenF1876);
  if (T1 != YPfalse) {
    ...
    for (;;) {
      P a87_0,a87_1;
    loop87:
      T3 = CALL2(1,VARREF(YgooSmathYE),iF1879,from_);
      if (T3 != YPfalse) {
        dF1880 = dF1878;
        ...
        for (;;) {
          P a88_0,a88_1;
        loop88:
          T5 = CALL1(1,VARREF(YgooScolsScolYfinQ),sF1881);
          if (T5 != YPfalse) {
            T4 = dst_;
          } else {
            T6 = CALL1(1,VARREF(YgooScolsScolYnow),sF1881);
            CALL2(1,VARREF(YgooScolsScolYnow_setter),T6,dF1880);
            T8 = CALL1(1,VARREF(YgooScolsScolYnxt),dF1880);
            T9 = CALL1(1,VARREF(YgooScolsScolYnxt),sF1881);
            a88_0 = T8;
            a88_1 = T9;
            dF1880 = a88_0;
            sF1881 = a88_1;
        ...
        T12 = CALL1(1,VARREF(YgooScolsScolYnxt),dF1878);
        T13 = CALL2(1,VARREF(YgooSmathYA),iF1879,YPint((P)1));
        a87_0 = T12;
        a87_1 = T13;
        dF1878 = a87_0;
        iF1879 = a87_1;
    ...
    T46 = CALL2(1,VARREF(YgooSmathY_),dst_lenF1875,del_lenF1877);
    T45 = CALL2(1,VARREF(YgooSmathYA),T46,src_lenF1876);
    new_lenF1882 = T45;
    T44 = CALL1(1,VARREF(Yclass_of),dst_);
    T43 = CALL2(1,VARREF(YgooScolsScolYfab),T44,new_lenF1882);
    ndstF1883 = T43;
    T41 = CALL1(1,VARREF(YgooScolsScolYenum),ndstF1883);
    ndF1884 = T41;
    ...
    for (;;) {
      P a89_0,a89_1,a89_2;
    loop89:
      T16 = CALL2(1,VARREF(YgooSmathYE),iF1886,from_);
      if (T16 != YPfalse) {
        ndF1887 = ndF1884;
        ...
        for (;;) {
          P a90_0,a90_1;
        loop90:
          T18 = CALL1(1,VARREF(YgooScolsScolYfinQ),sF1888);
          if (T18 != YPfalse) {
            dF1889 = dF1885;
            iF1890 = from_;
            for (;;) {
              P a91_0,a91_1;
            loop91:
              T20 = CALL2(1,VARREF(YgooSmathYE),iF1890,below_);
              if (T20 != YPfalse) {
                ndF1891 = ndF1887;
                dF1892 = dF1889;
                iF1893 = below_;
                for (;;) {
                  P a92_0,a92_1,a92_2;
                loop92:
                  T22 = CALL2(1,VARREF(YgooSmathYE),iF1893,dst_lenF1875);
                  if (T22 != YPfalse) {
                    T21 = ndstF1883;
                  } else {
                    T23 = CALL1(1,VARREF(YgooScolsScolYnow),dF1892);
                    CALL2(1,VARREF(YgooScolsScolYnow_setter),T23,ndF1891);
                    T25 = CALL1(1,VARREF(YgooScolsScolYnxt),ndF1891);
                    T26 = CALL1(1,VARREF(YgooScolsScolYnxt),dF1892);
                    T27 = CALL2(1,VARREF(YgooSmathYA),iF1893,YPint((P)1));
                    a92_0 = T25;
                    a92_1 = T26;
                    a92_2 = T27;
                    ndF1891 = a92_0;
                ...
                T29 = CALL1(1,VARREF(YgooScolsScolYnxt),dF1889);
                T30 = CALL2(1,VARREF(YgooSmathYA),iF1890,YPint((P)1));
                a91_0 = T29;
                a91_1 = T30;
                dF1889 = a91_0;
                iF1890 = a91_1;
            ...
            T31 = CALL1(1,VARREF(YgooScolsScolYnow),sF1888);
            CALL2(1,VARREF(YgooScolsScolYnow_setter),T31,ndF1887);
            T33 = CALL1(1,VARREF(YgooScolsScolYnxt),ndF1887);
            T34 = CALL1(1,VARREF(YgooScolsScolYnxt),sF1888);
            a90_0 = T33;
            a90_1 = T34;
            ndF1887 = a90_0;
            sF1888 = a90_1;
        ...
        T36 = CALL1(1,VARREF(YgooScolsScolYnow),dF1885);
        CALL2(1,VARREF(YgooScolsScolYnow_setter),T36,ndF1884);
        T38 = CALL1(1,VARREF(YgooScolsScolYnxt),ndF1884);
        T39 = CALL1(1,VARREF(YgooScolsScolYnxt),dF1885);
        T40 = CALL2(1,VARREF(YgooSmathYA),iF1886,YPint((P)1));
        a89_0 = T38;
        a89_1 = T39;
        a89_2 = T40;
        ndF1884 = a89_0;
...
LINK_STACK();
  ...
  for (;;) {
    P a93_0,a93_1;
  loop93:
    T3 = CALL1(1,VARREF(YgooScolsScolYfinQ),dF1894);
    tmpF1896 = T3;
    if (tmpF1896 != YPfalse) {
      T1 = tmpF1896;
    } else {
      T2 = CALL1(1,VARREF(YgooScolsScolYfinQ),sF1895);
      T1 = T2;
    }
    if (T1 != YPfalse) {
      T0 = dst_;
    } else {
      T4 = CALL1(1,VARREF(YgooScolsScolYnow),sF1895);
      CALL2(1,VARREF(YgooScolsScolYnow_setter),T4,dF1894);
      T6 = CALL1(1,VARREF(YgooScolsScolYnxt),dF1894);
      T7 = CALL1(1,VARREF(YgooScolsScolYnxt),sF1895);
      a93_0 = T6;
      a93_1 = T7;
      dF1894 = a93_0;
      sF1895 = a93_1;
