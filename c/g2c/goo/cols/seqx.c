...
LINK_STACK();
  ...
  LOOP_91: {
    P a91_0,a91_1;
    T3 = CALL1(1,VARREF(YgooScolsScolYfinQ),esF3167);
    tmpF3168 = T3;
    if (tmpF3168 != YPfalse) {
      T1 = tmpF3168;
    } else {
      T2 = CALL1(1,VARREF(YgooScolsScolYfinQ),edF3166);
      T1 = T2;
    }
    if (T1 != YPfalse) {
      T0 = dst_;
    } else {
      T4 = CALL1(1,VARREF(YgooScolsScolYnow),esF3167);
      CALL2(1,VARREF(YgooScolsScolYnow_setter),T4,edF3166);
      T6 = CALL1(1,VARREF(YgooScolsScolYnxt),edF3166);
      T7 = CALL1(1,VARREF(YgooScolsScolYnxt),esF3167);
      a91_0 = T6;
      a91_1 = T7;
      edF3166 = a91_0;
      esF3167 = a91_1;
...
LINK_STACK();
  ...
  del_lenF3171 = T47;
  T1 = CALL2(1,VARREF(YgooSlogYE),del_lenF3171,src_lenF3170);
  if (T1 != YPfalse) {
    ...
    LOOP_92: {
      P a92_0,a92_1;
      T3 = CALL2(1,VARREF(YgooSlogYE),iF3173,from_);
      if (T3 != YPfalse) {
        dF3174 = dF3172;
        ...
        LOOP_93: {
          P a93_0,a93_1;
          T5 = CALL1(1,VARREF(YgooScolsScolYfinQ),sF3175);
          if (T5 != YPfalse) {
            T4 = dst_;
          } else {
            T6 = CALL1(1,VARREF(YgooScolsScolYnow),sF3175);
            CALL2(1,VARREF(YgooScolsScolYnow_setter),T6,dF3174);
            T8 = CALL1(1,VARREF(YgooScolsScolYnxt),dF3174);
            T9 = CALL1(1,VARREF(YgooScolsScolYnxt),sF3175);
            a93_0 = T8;
            a93_1 = T9;
            dF3174 = a93_0;
            sF3175 = a93_1;
        ...
        T12 = CALL1(1,VARREF(YgooScolsScolYnxt),dF3172);
        T13 = CALL2(1,VARREF(YgooSmathYA),iF3173,YPint((P)1));
        a92_0 = T12;
        a92_1 = T13;
        dF3172 = a92_0;
        iF3173 = a92_1;
    ...
    T46 = CALL2(1,VARREF(YgooSmathY_),dst_lenF3169,del_lenF3171);
    T45 = CALL2(1,VARREF(YgooSmathYA),T46,src_lenF3170);
    new_lenF3176 = T45;
    T44 = CALL1(1,VARREF(YgooSclassYclass_of),dst_);
    T43 = CALL2(1,VARREF(YgooScolsScolYfab),T44,new_lenF3176);
    ndstF3177 = T43;
    T41 = CALL1(1,VARREF(YgooScolsScolYenum),ndstF3177);
    ndF3178 = T41;
    ...
    LOOP_94: {
      P a94_0,a94_1,a94_2;
      T16 = CALL2(1,VARREF(YgooSlogYE),iF3180,from_);
      if (T16 != YPfalse) {
        ndF3181 = ndF3178;
        ...
        LOOP_95: {
          P a95_0,a95_1;
          T18 = CALL1(1,VARREF(YgooScolsScolYfinQ),sF3182);
          if (T18 != YPfalse) {
            dF3183 = dF3179;
            iF3184 = from_;
            LOOP_96: {
              P a96_0,a96_1;
              T20 = CALL2(1,VARREF(YgooSlogYE),iF3184,below_);
              if (T20 != YPfalse) {
                ndF3185 = ndF3181;
                dF3186 = dF3183;
                iF3187 = below_;
                LOOP_97: {
                  P a97_0,a97_1,a97_2;
                  T22 = CALL2(1,VARREF(YgooSlogYE),iF3187,dst_lenF3169);
                  if (T22 != YPfalse) {
                    T21 = ndstF3177;
                  } else {
                    T23 = CALL1(1,VARREF(YgooScolsScolYnow),dF3186);
                    CALL2(1,VARREF(YgooScolsScolYnow_setter),T23,ndF3185);
                    T25 = CALL1(1,VARREF(YgooScolsScolYnxt),ndF3185);
                    T26 = CALL1(1,VARREF(YgooScolsScolYnxt),dF3186);
                    T27 = CALL2(1,VARREF(YgooSmathYA),iF3187,YPint((P)1));
                    a97_0 = T25;
                    a97_1 = T26;
                    a97_2 = T27;
                    ndF3185 = a97_0;
                ...
                T29 = CALL1(1,VARREF(YgooScolsScolYnxt),dF3183);
                T30 = CALL2(1,VARREF(YgooSmathYA),iF3184,YPint((P)1));
                a96_0 = T29;
                a96_1 = T30;
                dF3183 = a96_0;
                iF3184 = a96_1;
            ...
            T31 = CALL1(1,VARREF(YgooScolsScolYnow),sF3182);
            CALL2(1,VARREF(YgooScolsScolYnow_setter),T31,ndF3181);
            T33 = CALL1(1,VARREF(YgooScolsScolYnxt),ndF3181);
            T34 = CALL1(1,VARREF(YgooScolsScolYnxt),sF3182);
            a95_0 = T33;
            a95_1 = T34;
            ndF3181 = a95_0;
            sF3182 = a95_1;
        ...
        T36 = CALL1(1,VARREF(YgooScolsScolYnow),dF3179);
        CALL2(1,VARREF(YgooScolsScolYnow_setter),T36,ndF3178);
        T38 = CALL1(1,VARREF(YgooScolsScolYnxt),ndF3178);
        T39 = CALL1(1,VARREF(YgooScolsScolYnxt),dF3179);
        T40 = CALL2(1,VARREF(YgooSmathYA),iF3180,YPint((P)1));
        a94_0 = T38;
        a94_1 = T39;
        a94_2 = T40;
        ndF3178 = a94_0;
...
LINK_STACK();
  ...
  LOOP_98: {
    P a98_0,a98_1;
    T3 = CALL1(1,VARREF(YgooScolsScolYfinQ),dF3188);
    tmpF3190 = T3;
    if (tmpF3190 != YPfalse) {
      T1 = tmpF3190;
    } else {
      T2 = CALL1(1,VARREF(YgooScolsScolYfinQ),sF3189);
      T1 = T2;
    }
    if (T1 != YPfalse) {
      T0 = dst_;
    } else {
      T4 = CALL1(1,VARREF(YgooScolsScolYnow),sF3189);
      CALL2(1,VARREF(YgooScolsScolYnow_setter),T4,dF3188);
      T6 = CALL1(1,VARREF(YgooScolsScolYnxt),dF3188);
      T7 = CALL1(1,VARREF(YgooScolsScolYnxt),sF3189);
      a98_0 = T6;
      a98_1 = T7;
      dF3188 = a98_0;
      sF3189 = a98_1;
...
DEFCREGS();
  ...
  fun_revX_0 = YPfab_met(FUNCODEREF(fun_revX_0),T25,LITREF(lit_0),LITREF(lit_24),sloc(49),YPsb((P)"(fun ((x <seq!>) => <seq!>) (rev x))"));
  ...
  fun_catX_1 = YPfab_met(FUNCODEREF(fun_catX_1),T29,LITREF(lit_2),LITREF(lit_25),sloc(50),YPsb((P)"(fun ((x <seq!>) (more ...) => <seq!>) (app cat more))"));
  ...
  fun_pushX_2 = YPfab_met(FUNCODEREF(fun_pushX_2),T33,LITREF(lit_4),LITREF(lit_26),sloc(51),YPsb((P)"(fun ((l <seq!>) (x <any>) => <seq!>) (push l x))"));
  ...
  fun_popX_3 = YPfab_met(FUNCODEREF(fun_popX_3),T37,LITREF(lit_6),LITREF(lit_27),sloc(52),YPsb((P)"(fun ((l <seq!>) => (tup (new-col <seq!>) (value <any>))) (pop l))"));
  ...
  fun_insX_4 = YPfab_met(FUNCODEREF(fun_insX_4),T42,LITREF(lit_12),LITREF(lit_28),sloc(53),YPsb((P)"(fun ((x <seq!>) (v <any>) (before <int>) => <seq!>) (ins x v before))"));
  ...
  fun_del_valsX_5 = YPfab_met(FUNCODEREF(fun_del_valsX_5),T46,LITREF(lit_14),LITREF(lit_29),sloc(54),YPsb((P)"(fun ((x <seq!>) (v <any>) => <seq!>) (del-vals x v))"));
  ...
  fun_del_dupsX_6 = YPfab_met(FUNCODEREF(fun_del_dupsX_6),T50,LITREF(lit_16),LITREF(lit_30),sloc(55),YPsb((P)"(fun ((x <seq!>) => <seq!>) (del-dups x))"));
  ...
  fun_into_7 = YPfab_met(FUNCODEREF(fun_into_7),T54,LITREF(lit_31),LITREF(lit_32),sloc(57),YPsb((P)"(fun ((dst <seq!>) (src <seq>) => <seq!>) (rep in ((ed (enum dst)) (es (enum src))) (if (or (fin? es) (fin? ed)) dst (seq (set (now ed) (now es)) (in (nxt ed) (nxt es))))))"));
  ...
  fun_sub_setter_8 = YPfab_met(FUNCODEREF(fun_sub_setter_8),T58,LITREF(lit_8),LITREF(lit_33),sloc(64),YPsb((P)"(fun ((src <seq!>) (dst <seq>) (from <int>) (below <int>) => <seq!>) (def (dst-len <int>) (len dst)) (def (src-len <int>) (len src)) (def (del-len <int>) (- below from)) (if (= del-len src-len) (rep find ((d (enum dst)) (i 0)) (if (= i from) (rep in ((d d) (s (enum src))) (if (fin? s) dst (seq (set (now d) (now s)) (in (nxt d) (nxt s))))) (find (nxt d) (+ i 1)))) (let ((new-len (+ (- dst-len del-len) src-len)) (ndst (fab (class-of dst) new-len))) (rep copy ((nd (enum ndst)) (d (enum dst)) (i 0)) (if (= i from) (rep insert ((nd nd) (s (enum src))) (if (fin? s) (rep skip ((d d) (i from)) (if (= i below) (rep onto ((nd nd) (d d) (i below)) (if (= i dst-len) ndst (seq (set (now nd) (now d)) (onto (nxt nd) (nxt d) (+ i 1))))) (skip (nxt d) (+ i 1)))) (seq (set (now nd) (now s)) (insert (nxt nd) (nxt s))))) (seq (set (now nd) (now d)) (copy (nxt nd) (nxt d) (+ i 1))))))))"));
  ...
  fun_subT_setter_9 = YPfab_met(FUNCODEREF(fun_subT_setter_9),T62,LITREF(lit_10),LITREF(lit_34),sloc(96),YPsb((P)"(fun ((src <seq!>) (dst <seq>) (from <int>) => <seq!>) (set (sub dst from (len dst)) src))"));
  ...
  fun_sortX_10 = YPfab_met(FUNCODEREF(fun_sortX_10),T66,LITREF(lit_18),LITREF(lit_35),sloc(99),YPsb((P)"(fun ((items <seq!>) => <seq!>) (sort-by! items <))"));
  ...
  T71 = fun_alter_11 = YPfab_met(FUNCODEREF(fun_alter_11),T72,LITREF(lit_22),LITREF(lit_36),sloc(107),YPsb((P)"(fun ((dst <seq!>) (src <seq>) (from <int>) (below <int>) => <seq!>) (rep in ((d (enum dst)) (s (enum src))) (if (or (fin? d) (fin? s)) dst (seq (set (now d) (now s)) (in (nxt d) (nxt s))))))"));
