...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    inF1699 = T3;
    FUNINIT(inF1699, 2,FREEREF(1),inF1699);
    T5 = CALL1(1,VARREF(YgooScolsScolYenum),FREEREF(2));
    T4 = CALL2(0,inF1699,d_,T5);
    T2 = T4;
    T0 = T2;
  } else {
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    ontoF1700 = T3;
    FUNINIT(ontoF1700, 3,FREEREF(1),FREEREF(2),ontoF1700);
    T4 = CALL3(0,ontoF1700,FREEREF(3),d_,FREEREF(0));
    T2 = T4;
    T0 = T2;
  } else {
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    skipF1701 = T3;
    FUNINIT(skipF1701, 5,FREEREF(0),FREEREF(1),FREEREF(2),nd_,skipF1701);
    T4 = CALL2(0,skipF1701,FREEREF(3),FREEREF(4));
    T2 = T4;
    T0 = T2;
  } else {
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    insertF1702 = T3;
    FUNINIT(insertF1702, 6,FREEREF(1),FREEREF(2),FREEREF(3),d_,FREEREF(0),insertF1702);
    T5 = CALL1(1,VARREF(YgooScolsScolYenum),FREEREF(4));
    T4 = CALL2(0,insertF1702,nd_,T5);
    T2 = T4;
    T0 = T2;
  } else {
...
loop:
  ...
  del_lenF1705 = T5;
  T7 = CALL2(1,VARREF(YgooSmathYE),del_lenF1705,src_lenF1704);
  if (T7 != YPfalse) {
    T9 = FUNSHELL(1,fun_find_10,4);
    findF1706 = T9;
    FUNINIT(findF1706, 4,from_,dst_,src_,findF1706);
    T11 = CALL1(1,VARREF(YgooScolsScolYenum),dst_);
    T10 = CALL2(0,findF1706,T11,YPint((P)0));
    T8 = T10;
    T6 = T8;
  } else {
    T14 = CALL2(1,VARREF(YgooSmathY_),dst_lenF1703,del_lenF1705);
    T13 = CALL2(1,VARREF(YgooSmathYA),T14,src_lenF1704);
    new_lenF1707 = T13;
    T17 = CALL1(1,VARREF(Yobject_class),dst_);
    T16 = CALL2(1,VARREF(YgooScolsScolYfab),T17,new_lenF1707);
    ndstF1708 = T16;
    T19 = FUNSHELL(1,fun_copy_14,6);
    copyF1709 = T19;
    FUNINIT(copyF1709, 6,from_,below_,dst_lenF1703,ndstF1708,src_,copyF1709);
    T21 = CALL1(1,VARREF(YgooScolsScolYenum),ndstF1708);
    T22 = CALL1(1,VARREF(YgooScolsScolYenum),dst_);
    T20 = CALL3(0,copyF1709,T21,T22,YPint((P)0));
    T18 = T20;
    T15 = T18;
    T12 = T15;
    T6 = T12;
...
loop:
  ...
  inF1711 = T1;
  FUNINIT(inF1711, 2,dst_,inF1711);
  T3 = CALL1(1,VARREF(YgooScolsScolYenum),dst_);
  T4 = CALL1(1,VARREF(YgooScolsScolYenum),src_);
  T2 = CALL2(0,inF1711,T3,T4);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  T85 = YPsig(YPPlist(2,LITREF(lit_27),LITREF(lit_29)),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  T84 = fun_in_17 = YPmet(FUNCODEREF(fun_in_17),LITREF(lit_23),T85,ENVNUL,PNUL,YPfalse);
  T83 = YPsig(YPPlist(4,LITREF(lit_8),LITREF(lit_9),LITREF(lit_10),LITREF(lit_11)),YPPlist(4,VARREF(YLseqXG),VARREF(YLseqG),VARREF(YLintG),VARREF(YLintG)),YPfalse,YPint((P)4),VARREF(YLseqXG),Ynil);
  T82 = fun_alter_18 = YPmet(FUNCODEREF(fun_alter_18),LITREF(lit_21),T83,ENVNUL,PNUL,YPfalse);
