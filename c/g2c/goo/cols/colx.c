...
loop:
  ...
  inF1651 = T1;
  FUNINIT(inF1651, 3,dst_,val_,inF1651);
  T3 = CALL1(1,VARREF(YgooScolsScolYenum),dst_);
  T2 = CALL1(0,inF1651,T3);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  inF1652 = T1;
  FUNINIT(inF1652, 2,dst_,inF1652);
  T3 = CALL1(1,VARREF(YgooScolsScolYenum),src_);
  T2 = CALL1(0,inF1652,T3);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  lit_6 = YPPsym((P)"del!");
  lit_7 = YPPlist(2,YPPsym((P)"c"),YPPsym((P)"x"));
  T7 = YPsig(LITREF(lit_7),YPPlist(2,VARREF(YLcolXG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLcolXG),Ynil);
  T6 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_6),T7,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooScolsScolxYdelX,T6);
  lit_8 = YPPsym((P)"zap!");
  lit_9 = YPPlist(1,YPPsym((P)"c"));
  T9 = YPsig(LITREF(lit_9),YPPlist(1,VARREF(YLcolXG)),YPfalse,YPint((P)1),VARREF(YLcolXG),Ynil);
  ...
  lit_11 = YPPlist(2,YPPsym((P)"new-len"),YPPsym((P)"c"));
  T11 = YPsig(LITREF(lit_11),YPPlist(2,VARREF(YLintG),VARREF(YLcolXG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  ...
  lit_13 = YPPlist(3,YPPsym((P)"new-len"),YPPsym((P)"c"),YPPsym((P)"default"));
  T13 = YPsig(LITREF(lit_13),YPPlist(3,VARREF(YLintG),VARREF(YLcolXG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_15 = YPPlist(2,YPPsym((P)"c"),YPPsym((P)"x"));
  T15 = YPsig(LITREF(lit_15),YPPlist(2,VARREF(YLcolXG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLcolXG),Ynil);
  T14 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_14),T15,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooScolsScolxYfillX,T14);
  lit_16 = YPPsym((P)"low-elt-setter");
  lit_17 = YPPlist(3,YPPsym((P)"v"),YPPsym((P)"x"),YPPsym((P)"k"));
  T17 = YPsig(LITREF(lit_17),YPPlist(3,VARREF(YLanyG),VARREF(YLcolG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  lit_18 = YPPsym((P)"fab-elt-setter");
  lit_19 = YPPlist(3,YPPsym((P)"value"),YPPsym((P)"c"),YPPsym((P)"key"));
  T18 = YPsig(LITREF(lit_19),YPPlist(3,VARREF(YLanyG),VARREF(YLcolXG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_fab_elt_setter_0 = YPmet(FUNCODEREF(fun_fab_elt_setter_0),LITREF(lit_18),T18,ENVNUL,PNUL,YPfalse);
  ...
  lit_20 = YPPlist(3,YPPsym((P)"value"),YPPsym((P)"c"),YPPsym((P)"key"));
  T23 = YPsig(LITREF(lit_20),YPPlist(3,VARREF(YLanyG),VARREF(YLcolXG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  fun_low_elt_setter_1 = YPmet(FUNCODEREF(fun_low_elt_setter_1),LITREF(lit_16),T23,ENVNUL,PNUL,YPfalse);
  ...
  lit_21 = YPPlist(2,YPPsym((P)"c"),YPPsym((P)"x"));
  T28 = YPsig(LITREF(lit_21),YPPlist(2,VARREF(YLcolXG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLcolXG),Ynil);
  fun_addX_2 = YPmet(FUNCODEREF(fun_addX_2),LITREF(lit_4),T28,ENVNUL,PNUL,YPfalse);
  ...
  lit_22 = YPPlist(2,YPPsym((P)"c"),YPPsym((P)"x"));
  T33 = YPsig(LITREF(lit_22),YPPlist(2,VARREF(YLcolXG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLcolXG),Ynil);
  fun_delX_3 = YPmet(FUNCODEREF(fun_delX_3),LITREF(lit_6),T33,ENVNUL,PNUL,YPfalse);
  ...
  T38 = YPsig(LITREF(lit_23),YPPlist(1,VARREF(YLcolXG)),YPfalse,YPint((P)1),VARREF(YLcolXG),Ynil);
  fun_zapX_4 = YPmet(FUNCODEREF(fun_zapX_4),LITREF(lit_8),T38,ENVNUL,PNUL,YPfalse);
  ...
  lit_24 = YPPlist(2,YPPsym((P)"dst"),YPPsym((P)"val"));
  lit_25 = YPPsym((P)"in");
  lit_26 = YPPlist(1,YPPsym((P)"ds"));
  T44 = YPsig(LITREF(lit_26),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_in_5 = YPmet(FUNCODEREF(fun_in_5),LITREF(lit_25),T44,ENVNUL,PNUL,YPfalse);
  T43 = YPsig(LITREF(lit_24),YPPlist(2,VARREF(YLcolXG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLcolXG),Ynil);
  ...
  lit_27 = YPPlist(2,YPPsym((P)"dst"),YPPsym((P)"src"));
  lit_28 = YPPlist(1,YPPsym((P)"ss"));
  T53 = YPsig(LITREF(lit_28),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  T52 = fun_in_7 = YPmet(FUNCODEREF(fun_in_7),LITREF(lit_25),T53,ENVNUL,PNUL,YPfalse);
  T51 = YPsig(LITREF(lit_27),YPPlist(2,VARREF(YLcolXG),VARREF(YLcolG)),YPfalse,YPint((P)2),VARREF(YLcolXG),Ynil);
  T50 = fun_into_8 = YPmet(FUNCODEREF(fun_into_8),LITREF(lit_2),T51,ENVNUL,PNUL,YPfalse);
