...
LINK_STACK();
  ...
  xF1823 = T1;
  T3 = CALL2(1,VARREF(YgooSmacrosYEE),xF1823,VARREF(YgooScolsScolxYDnot_found));
  if (T3 != YPfalse) {
    T5 = CALL0(1,f_);
...
LINK_STACK();
  ...
  for (;;) {
    P a66_0;
  loop66:
    T5 = CALL1(1,VARREF(YgooScolsScolYfinQ),dsF1824);
    if (T5 != YPfalse) {
      T4 = dst_;
    } else {
      CALL2(1,VARREF(YgooScolsScolYnow_setter),val_,dsF1824);
      T7 = CALL1(1,VARREF(YgooScolsScolYnxt),dsF1824);
      a66_0 = T7;
      dsF1824 = a66_0;
      goto loop66;
      T4 = T6;
...
LINK_STACK();
  ...
  for (;;) {
    P a67_0;
  loop67:
    T5 = CALL1(1,VARREF(YgooScolsScolYfinQ),ssF1825);
    if (T5 != YPfalse) {
      T4 = dst_;
    } else {
      T6 = CALL1(1,VARREF(YgooScolsScolYnow),ssF1825);
      T7 = CALL1(1,VARREF(YgooScolsScolYnow_key),ssF1825);
      CALL3(1,VARREF(YgooScolsScolxYelt_setter),T6,dst_,T7);
      T9 = CALL1(1,VARREF(YgooScolsScolYnxt),ssF1825);
      a67_0 = T9;
      ssF1825 = a67_0;
      goto loop67;
      T4 = T8;
