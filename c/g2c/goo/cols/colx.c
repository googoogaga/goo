...
LINK_STACK();
  ...
  xF3118 = T4;
  T1 = CALL2(1,VARREF(YgooSmacrosYEE),xF3118,VARREF(YgooScolsScolxYDnot_found));
  if (T1 != YPfalse) {
    T3 = CALL0(1,f_);
...
LINK_STACK();
  ...
  LOOP_71: {
    P a71_0;
    T1 = CALL1(1,VARREF(YgooScolsScolYfinQ),dsF3119);
    if (T1 != YPfalse) {
      T0 = dst_;
    } else {
      CALL2(1,VARREF(YgooScolsScolYnow_setter),val_,dsF3119);
      T3 = CALL1(1,VARREF(YgooScolsScolYnxt),dsF3119);
      a71_0 = T3;
      dsF3119 = a71_0;
      goto LOOP_71;
      T0 = T2;
...
LINK_STACK();
  ...
  LOOP_72: {
    P a72_0;
    T1 = CALL1(1,VARREF(YgooScolsScolYfinQ),ssF3120);
    if (T1 != YPfalse) {
      T0 = dst_;
    } else {
      T2 = CALL1(1,VARREF(YgooScolsScolYnow),ssF3120);
      T3 = CALL1(1,VARREF(YgooScolsScolYnow_key),ssF3120);
      CALL3(1,VARREF(YgooScolsScolxYelt_setter),T2,dst_,T3);
      T5 = CALL1(1,VARREF(YgooScolsScolYnxt),ssF3120);
      a72_0 = T5;
      ssF3120 = a72_0;
      goto LOOP_72;
      T0 = T4;
