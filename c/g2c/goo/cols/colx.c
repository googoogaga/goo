...
LINK_STACK();
  ...
  xF3205 = T4;
  T1 = CALL2(1,VARREF(YgooSmacrosYEE),xF3205,VARREF(YgooScolsScolxYDnot_found));
  if (T1 != YPfalse) {
    T3 = CALL0(1,f_);
...
LINK_STACK();
  ...
  LOOP_71: {
    P a71_0;
    T1 = CALL1(1,VARREF(YgooScolsScolYfinQ),dsF3206);
    if (T1 != YPfalse) {
      T0 = dst_;
    } else {
      CALL2(1,VARREF(YgooScolsScolYnow_setter),val_,dsF3206);
      T3 = CALL1(1,VARREF(YgooScolsScolYnxt),dsF3206);
      a71_0 = T3;
      dsF3206 = a71_0;
      goto LOOP_71;
      T0 = T2;
...
LINK_STACK();
  ...
  LOOP_72: {
    P a72_0;
    T1 = CALL1(1,VARREF(YgooScolsScolYfinQ),ssF3207);
    if (T1 != YPfalse) {
      T0 = dst_;
    } else {
      T2 = CALL1(1,VARREF(YgooScolsScolYnow),ssF3207);
      T3 = CALL1(1,VARREF(YgooScolsScolYnow_key),ssF3207);
      CALL3(1,VARREF(YgooScolsScolxYelt_setter),T2,dst_,T3);
      T5 = CALL1(1,VARREF(YgooScolsScolYnxt),ssF3207);
      a72_0 = T5;
      ssF3207 = a72_0;
      goto LOOP_72;
      T0 = T4;
