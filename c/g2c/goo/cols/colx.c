...
loop:
  ...
  inF962 = T1;
  FUNINIT(inF962, 3,dst_,val_,inF962);
  T3 = CALL1(1,VARREF(YgooScolsScolYenum),dst_);
  T2 = CALL1(0,inF962,T3);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ...
  ARG(src_, 1);
loop:
  T1 = FUNSHELL(1,fun_in_5,2);
  inF963 = T1;
  FUNINIT(inF963, 2,dst_,inF963);
  T3 = CALL1(1,VARREF(YgooScolsScolYenum),src_);
  T2 = CALL1(0,inF963,T3);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  lit_21 = YPPsym((P)"in");
  lit_22 = YPPsym((P)"ds");
  T34 = YPsig(YPPlist(1,LITREF(lit_22)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_in_3 = YPmet(FUNCODEREF(fun_in_3),LITREF(lit_21),T34,ENVNUL,PNUL,YPfalse);
  T33 = YPsig(YPPlist(2,LITREF(lit_19),LITREF(lit_20)),YPPlist(2,VARREF(YLcolXG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLcolXG),Ynil);
  fun_fillX_4 = YPmet(FUNCODEREF(fun_fillX_4),LITREF(lit_14),T33,ENVNUL,PNUL,YPfalse);
  T37 = BOUNDP(YgooScolsScolxYfillX);
  if (T37 != YPfalse) {
    T36 = VARREF(YgooScolsScolxYfillX);
  } else {
    T36 = YPfalse;
  }
  T38 = fun_fillX_4;
  T35 = CALL2(1,VARREF(YPdefine_method),T36,T38);
  VARSET(YgooScolsScolxYfillX,T35);
  lit_23 = YPPsym((P)"src");
  lit_24 = YPPsym((P)"ss");
  T43 = YPsig(YPPlist(1,LITREF(lit_24)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  T42 = fun_in_5 = YPmet(FUNCODEREF(fun_in_5),LITREF(lit_21),T43,ENVNUL,PNUL,YPfalse);
  T41 = YPsig(YPPlist(2,LITREF(lit_19),LITREF(lit_23)),YPPlist(2,VARREF(YLcolXG),VARREF(YLcolG)),YPfalse,YPint((P)2),VARREF(YLcolXG),Ynil);
  T40 = fun_into_6 = YPmet(FUNCODEREF(fun_into_6),LITREF(lit_4),T41,ENVNUL,PNUL,YPfalse);
  T47 = BOUNDP(YgooScolsScolYinto);
  if (T47 != YPfalse) {
    T46 = VARREF(YgooScolsScolYinto);
  } else {
    T46 = YPfalse;
  }
  T48 = fun_into_6;
  T45 = CALL2(1,VARREF(YPdefine_method),T46,T48);
  T44 = VARSET(YgooScolsScolYinto,T45);
  T39 = T44;
  return T39;
}
