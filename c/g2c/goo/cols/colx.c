...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    T3 = CALL1(1,VARREF(YgooScolsScolYnow),ss_);
    CALL3(1,VARREF(YgooScolsScolYelt_setter),T2,FREEREF(0),T3);
...
LINK_STACK();
  ...
  ARG(src_, 1);
loop:
  T1 = FUNSHELL(1,fun_in_1,2);
  inF996 = T1;
  FUNINIT(inF996, 2,dst_,inF996);
  T3 = CALL1(1,VARREF(YgooScolsScolYenum),src_);
  T2 = CALL1(0,inF996,T3);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ...
  ARG(val_, 1);
loop:
  T1 = FUNSHELL(1,fun_in_3,3);
  inF997 = T1;
  FUNINIT(inF997, 3,dst_,val_,inF997);
  T3 = CALL1(1,VARREF(YgooScolsScolYenum),dst_);
  T2 = CALL1(0,inF997,T3);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  lit_1 = YPPsym((P)"c");
  lit_2 = YPPsym((P)"x");
  T1 = YPsig(YPPlist(2,LITREF(lit_1),LITREF(lit_2)),YPPlist(2,VARREF(YLcolXG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLcolXG),Ynil);
  T0 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_0),T1,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooScolsScolxYaddX,T0);
  lit_3 = YPPsym((P)"del!");
  T3 = YPsig(YPPlist(2,LITREF(lit_1),LITREF(lit_2)),YPPlist(2,VARREF(YLcolXG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLcolXG),Ynil);
  T2 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_3),T3,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooScolsScolxYdelX,T2);
  lit_4 = YPPsym((P)"zap!");
  T5 = YPsig(YPPlist(1,LITREF(lit_1)),YPPlist(1,VARREF(YLcolXG)),YPfalse,YPint((P)1),VARREF(YLcolXG),Ynil);
  T4 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_4),T5,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooScolsScolxYzapX,T4);
  lit_5 = YPPsym((P)"len-setter");
  lit_6 = YPPsym((P)"new-len");
  T7 = YPsig(YPPlist(2,LITREF(lit_6),LITREF(lit_1)),YPPlist(2,VARREF(YLintG),VARREF(YLcolXG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  T6 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_5),T7,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooScolsScolxYlen_setter,T6);
  lit_7 = YPPsym((P)"len/fill-setter");
  lit_8 = YPPsym((P)"default");
  T9 = YPsig(YPPlist(3,LITREF(lit_6),LITREF(lit_1),LITREF(lit_8)),YPPlist(3,VARREF(YLintG),VARREF(YLcolXG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  T8 = YPgen((P)YPgen_code((P)YPdispatch),LITREF(lit_7),T9,Ynil,YPfalse,YPfalse,YPfalse);
  VARSET(YgooScolsScolxYlenSfill_setter,T8);
  T10 = YPsig(YPPlist(2,LITREF(lit_1),LITREF(lit_2)),YPPlist(2,VARREF(YLcolXG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLcolXG),Ynil);
  fun_addX_0 = YPmet(FUNCODEREF(fun_addX_0),LITREF(lit_0),T10,ENVNUL,PNUL,YPfalse);
  T13 = BOUNDP(YgooScolsScolxYaddX);
  if (T13 != YPfalse) {
    T12 = VARREF(YgooScolsScolxYaddX);
  } else {
    T12 = YPfalse;
  }
  T14 = fun_addX_0;
  T11 = CALL2(1,VARREF(YPdefine_method),T12,T14);
  VARSET(YgooScolsScolxYaddX,T11);
  lit_9 = YPPsym((P)"into");
  lit_10 = YPPsym((P)"dst");
  lit_11 = YPPsym((P)"src");
  lit_12 = YPPsym((P)"in");
  lit_13 = YPPsym((P)"ss");
  T16 = YPsig(YPPlist(1,LITREF(lit_13)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_in_1 = YPmet(FUNCODEREF(fun_in_1),LITREF(lit_12),T16,ENVNUL,PNUL,YPfalse);
  T15 = YPsig(YPPlist(2,LITREF(lit_10),LITREF(lit_11)),YPPlist(2,VARREF(YLcolG),VARREF(YLcolG)),YPfalse,YPint((P)2),VARREF(YLcolG),Ynil);
  fun_into_2 = YPmet(FUNCODEREF(fun_into_2),LITREF(lit_9),T15,ENVNUL,PNUL,YPfalse);
  T19 = BOUNDP(YgooScolsScolYinto);
  if (T19 != YPfalse) {
  ...
  VARSET(YgooScolsScolYinto,T17);
  lit_14 = YPPsym((P)"fill!");
  lit_15 = YPPsym((P)"val");
  lit_16 = YPPsym((P)"ds");
  T25 = YPsig(YPPlist(1,LITREF(lit_16)),YPPlist(1,VARREF(YLanyG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  T24 = fun_in_3 = YPmet(FUNCODEREF(fun_in_3),LITREF(lit_12),T25,ENVNUL,PNUL,YPfalse);
  T23 = YPsig(YPPlist(2,LITREF(lit_10),LITREF(lit_15)),YPPlist(2,VARREF(YLcolG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLcolG),Ynil);
  T22 = fun_fillX_4 = YPmet(FUNCODEREF(fun_fillX_4),LITREF(lit_14),T23,ENVNUL,PNUL,YPfalse);
  T29 = BOUNDP(YgooScolsScolYfillX);
  if (T29 != YPfalse) {
    T28 = VARREF(YgooScolsScolYfillX);
  } else {
    T28 = YPfalse;
  }
  T30 = fun_fillX_4;
  T27 = CALL2(1,VARREF(YPdefine_method),T28,T30);
  T26 = VARSET(YgooScolsScolYfillX,T27);
  T21 = T26;
  return T21;
}
