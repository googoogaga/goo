...
LINK_STACK();
  ...
  for (;;) {
    P a106_0;
  loop106:
    T4 = CALL2(1,VARREF(YgooSmagYL),iF1989,sF1988);
    if (T4 != YPfalse) {
      CALL3(1,VARREF(YgooScolsSrepYrep_elt_setter),val_,x_,iF1989);
      T6 = CALL2(1,VARREF(YgooSmathYA),iF1989,YPint((P)1));
      a106_0 = T6;
      iF1989 = a106_0;
      goto loop106;
      T3 = T5;
...
LINK_STACK();
  ...
  for (;;) {
    P a107_0;
  loop107:
    T6 = CALL2(1,VARREF(YgooSmagYL),iF1991,lF1990);
    if (T6 != YPfalse) {
      T7 = CALL2(1,VARREF(YgooScolsSrepYrep_elt),s_,iF1991);
      CALL3(1,VARREF(YgooScolsSrepYrep_elt_setter),T7,d_,iF1991);
      T9 = CALL2(1,VARREF(YgooSmathYA),iF1991,YPint((P)1));
      a107_0 = T9;
      iF1991 = a107_0;
      goto loop107;
      T5 = T8;
...
LINK_STACK();
  ...
  for (;;) {
    P a108_0,a108_1;
  loop108:
    T7 = CALL2(1,VARREF(YgooSmagYL),iF1993,lF1992);
    if (T7 != YPfalse) {
      T8 = CALL1(1,VARREF(YgooScolsScolYnow),eF1994);
      CALL3(1,VARREF(YgooScolsSrepYrep_elt_setter),T8,d_,iF1993);
      T10 = CALL2(1,VARREF(YgooSmathYA),iF1993,YPint((P)1));
      T11 = CALL1(1,VARREF(YgooScolsScolYnxt),eF1994);
      a108_0 = T10;
      a108_1 = T11;
      iF1993 = a108_0;
      eF1994 = a108_1;
