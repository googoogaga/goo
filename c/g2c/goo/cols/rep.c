...
loop:
  ...
  fillF1755 = T2;
  FUNINIT(fillF1755, 4,sF1754,val_,x_,fillF1755);
  T3 = CALL1(0,fillF1755,YPint((P)0));
  T0 = x_;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  intoF1757 = T4;
  FUNINIT(intoF1757, 4,lF1756,s_,d_,intoF1757);
  T5 = CALL1(0,intoF1757,YPint((P)0));
  T0 = d_;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  intoF1759 = T4;
  FUNINIT(intoF1759, 3,lF1758,d_,intoF1759);
  T6 = CALL1(1,VARREF(YgooScolsScolYenum),s_);
  T5 = CALL2(0,intoF1759,YPint((P)0),T6);
  T0 = d_;
UNLINK_STACK();
  RET(T0);
}
