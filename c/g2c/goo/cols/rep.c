...
loop:
  ...
  fillF6906 = T2;
  FUNINIT(fillF6906, 4,sF6905,val_,x_,fillF6906);
  T3 = CALL1(0,fillF6906,YPint((P)0));
  T0 = x_;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  intoF6908 = T2;
  FUNINIT(intoF6908, 4,lF6907,s_,d_,intoF6908);
  T3 = CALL1(0,intoF6908,YPint((P)0));
  T0 = d_;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  intoF6910 = T2;
  FUNINIT(intoF6910, 3,lF6909,d_,intoF6910);
  T4 = CALL1(1,VARREF(YgooScolsScolYenum),s_);
  T3 = CALL2(0,intoF6910,YPint((P)0),T4);
  T0 = d_;
UNLINK_STACK();
  RET(T0);
}
