...
loop:
  ...
  fillF1894 = T2;
  FUNINIT(fillF1894, 4,sF1893,val_,x_,fillF1894);
  T3 = CALL1(0,fillF1894,YPint((P)0));
  T0 = x_;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  intoF1896 = T4;
  FUNINIT(intoF1896, 4,lF1895,s_,d_,intoF1896);
  T5 = CALL1(0,intoF1896,YPint((P)0));
  T0 = d_;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  intoF1898 = T4;
  FUNINIT(intoF1898, 3,lF1897,d_,intoF1898);
  T6 = CALL1(1,VARREF(YgooScolsScolYenum),s_);
  T5 = CALL2(0,intoF1898,YPint((P)0),T6);
  T0 = d_;
UNLINK_STACK();
  RET(T0);
}
