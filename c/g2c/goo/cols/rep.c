...
LINK_STACK();
  ...
  LOOP_111: {
    P a111_0;
    T1 = CALL2(1,VARREF(YgooSmagYL),iF3268,sF3267);
    if (T1 != YPfalse) {
      CALL3(1,VARREF(YgooScolsSrepYrep_elt_setter),val_,x_,iF3268);
      T3 = CALL2(1,VARREF(YgooSmathYA),iF3268,YPint((P)1));
      a111_0 = T3;
      iF3268 = a111_0;
      goto LOOP_111;
      T0 = T2;
...
LINK_STACK();
  ...
  LOOP_112: {
    P a112_0;
    T1 = CALL2(1,VARREF(YgooSmagYL),iF3270,lF3269);
    if (T1 != YPfalse) {
      T2 = CALL2(1,VARREF(YgooScolsSrepYrep_elt),s_,iF3270);
      CALL3(1,VARREF(YgooScolsSrepYrep_elt_setter),T2,d_,iF3270);
      T4 = CALL2(1,VARREF(YgooSmathYA),iF3270,YPint((P)1));
      a112_0 = T4;
      iF3270 = a112_0;
      goto LOOP_112;
      T0 = T3;
...
LINK_STACK();
  ...
  LOOP_113: {
    P a113_0,a113_1;
    T1 = CALL2(1,VARREF(YgooSmagYL),iF3272,lF3271);
    if (T1 != YPfalse) {
      T2 = CALL1(1,VARREF(YgooScolsScolYnow),eF3273);
      CALL3(1,VARREF(YgooScolsSrepYrep_elt_setter),T2,d_,iF3272);
      T4 = CALL2(1,VARREF(YgooSmathYA),iF3272,YPint((P)1));
      T5 = CALL1(1,VARREF(YgooScolsScolYnxt),eF3273);
      a113_0 = T4;
      a113_1 = T5;
      iF3272 = a113_0;
      eF3273 = a113_1;
...
DEFCREGS();
  ...
  YgooScolsSrepYrep_nul = YPfab_met(FUNCODEREF(YgooScolsSrepYrep_nul),T2,LITREF(lit_2),LITREF(lit_3),sloc(32),YPsb((P)"(fun () %rnul)"));
  ...
  YgooScolsSrepYrep_len = YPfab_met(FUNCODEREF(YgooScolsSrepYrep_len),T4,LITREF(lit_4),LITREF(lit_5),sloc(34),YPsb((P)"(fun ((x <rep>) => <int>) (%ib (%rlen x)))"));
  ...
  YgooScolsSrepYrep_fillX = YPfab_met(FUNCODEREF(YgooScolsSrepYrep_fillX),T6,LITREF(lit_6),LITREF(lit_7),sloc(37),YPsb((P)"(fun ((x <rep>) val => <rep>) (def s (rep-len x)) (rep fill ((i 0)) (when (< i s) (set (rep-elt x i) val) (fill (+ i 1)))) x)"));
  ...
  fun_rep_intoX_3 = YPfab_met(FUNCODEREF(fun_rep_intoX_3),T8,LITREF(lit_0),LITREF(lit_8),sloc(45),YPsb((P)"(fun ((d <rep>) (s <rep>) => <rep>) (def l (min (rep-len d) (rep-len s))) (rep into ((i 0)) (when (< i l) (set (rep-elt d i) (rep-elt s i)) (into (+ i 1)))) d)"));
  ...
  fun_rep_intoX_4 = YPfab_met(FUNCODEREF(fun_rep_intoX_4),T12,LITREF(lit_0),LITREF(lit_9),sloc(53),YPsb((P)"(fun ((d <rep>) (s <col>) => <rep>) (def l (min (rep-len d) (len s))) (rep into ((i 0) (e (enum s))) (when (< i l) (set (rep-elt d i) (now e)) (into (+ i 1) (nxt e)))) d)"));
  ...
  YgooScolsSrepYrep_fab = YPfab_met(FUNCODEREF(YgooScolsSrepYrep_fab),T16,LITREF(lit_10),LITREF(lit_11),sloc(61),YPsb((P)"(fun ((s <int>) fill => <rep>) (%rep (%iu s) fill))"));
  ...
  YgooScolsSrepYrep_elt = YPfab_met(FUNCODEREF(YgooScolsSrepYrep_elt),T18,LITREF(lit_12),LITREF(lit_13),sloc(64),YPsb((P)"(fun ((x <rep>) (i <int>) => <any>) (%relt x (%iu i)))"));
  ...
  T21 = YgooScolsSrepYrep_elt_setter = YPfab_met(FUNCODEREF(YgooScolsSrepYrep_elt_setter),T22,LITREF(lit_14),LITREF(lit_15),sloc(67),YPsb((P)"(fun (z (x <rep>) (i <int>)) (set (%relt x (%iu i)) z))"));
