...
LINK_STACK();
  ...
  LOOP_361: {
    P a361_0;
    T1 = CALL2(1,VARREF(YgooSmagYL),iF8274,sF8273);
    if (T1 != YPfalse) {
      CALL3(1,VARREF(YgooScolsSrepYrep_elt_setter),val_,x_,iF8274);
      T3 = CALL2(1,VARREF(YgooSmathYA),iF8274,YPint((P)1));
      a361_0 = T3;
      iF8274 = a361_0;
      goto LOOP_361;
      T0 = T2;
...
LINK_STACK();
  ...
  LOOP_362: {
    P a362_0;
    T1 = CALL2(1,VARREF(YgooSmagYL),iF8276,lF8275);
    if (T1 != YPfalse) {
      T2 = CALL2(1,VARREF(YgooScolsSrepYrep_elt),s_,iF8276);
      CALL3(1,VARREF(YgooScolsSrepYrep_elt_setter),T2,d_,iF8276);
      T4 = CALL2(1,VARREF(YgooSmathYA),iF8276,YPint((P)1));
      a362_0 = T4;
      iF8276 = a362_0;
      goto LOOP_362;
      T0 = T3;
...
LINK_STACK();
  ...
  LOOP_363: {
    P a363_0,a363_1;
    T1 = CALL2(1,VARREF(YgooSmagYL),iF8278,lF8277);
    if (T1 != YPfalse) {
      T2 = CALL1(1,VARREF(YgooScolsScolYnow),eF8279);
      CALL3(1,VARREF(YgooScolsSrepYrep_elt_setter),T2,d_,iF8278);
      T4 = CALL2(1,VARREF(YgooSmathYA),iF8278,YPint((P)1));
      T5 = CALL1(1,VARREF(YgooScolsScolYnxt),eF8279);
      a363_0 = T4;
      a363_1 = T5;
      iF8278 = a363_0;
      eF8279 = a363_1;
...
DEFCREGS();
  ...
  YgooScolsSrepYrep_nul = YPmet(FUNCODEREF(YgooScolsSrepYrep_nul),LITREF(lit_2),T2,ENVNUL,PNUL,sloc(28));
  ...
  YgooScolsSrepYrep_len = YPmet(FUNCODEREF(YgooScolsSrepYrep_len),LITREF(lit_4),T4,ENVNUL,PNUL,sloc(30));
  ...
  YgooScolsSrepYrep_fillX = YPmet(FUNCODEREF(YgooScolsSrepYrep_fillX),LITREF(lit_6),T6,ENVNUL,PNUL,sloc(33));
  ...
  fun_rep_intoX_3 = YPmet(FUNCODEREF(fun_rep_intoX_3),LITREF(lit_0),T8,ENVNUL,PNUL,sloc(41));
  ...
  fun_rep_intoX_4 = YPmet(FUNCODEREF(fun_rep_intoX_4),LITREF(lit_0),T12,ENVNUL,PNUL,sloc(49));
  ...
  YgooScolsSrepYrep_fab = YPmet(FUNCODEREF(YgooScolsSrepYrep_fab),LITREF(lit_10),T16,ENVNUL,PNUL,sloc(57));
  ...
  YgooScolsSrepYrep_elt = YPmet(FUNCODEREF(YgooScolsSrepYrep_elt),LITREF(lit_12),T18,ENVNUL,PNUL,sloc(60));
  ...
  T21 = YgooScolsSrepYrep_elt_setter = YPmet(FUNCODEREF(YgooScolsSrepYrep_elt_setter),LITREF(lit_14),T22,ENVNUL,PNUL,sloc(63));
