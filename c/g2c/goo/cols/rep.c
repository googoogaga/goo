...
loop:
  ...
  fillF1876 = T2;
  FUNINIT(fillF1876, 4,sF1875,val_,x_,fillF1876);
  T3 = CALL1(0,fillF1876,YPint((P)0));
  T0 = x_;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  intoF1878 = T4;
  FUNINIT(intoF1878, 4,lF1877,s_,d_,intoF1878);
  T5 = CALL1(0,intoF1878,YPint((P)0));
  T0 = d_;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  intoF1880 = T4;
  FUNINIT(intoF1880, 3,lF1879,d_,intoF1880);
  T6 = CALL1(1,VARREF(YgooScolsScolYenum),s_);
  T5 = CALL2(0,intoF1880,YPint((P)0),T6);
  T0 = d_;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  T12 = VARREF_OR(YgooScolsSrepYrep_intoX,YPfalse);
  T13 = fun_rep_intoX_5;
  ...
  T15 = YPsig(LITREF(lit_14),YPPlist(2,VARREF(YLanyG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  fun_into_6 = YPmet(FUNCODEREF(fun_into_6),LITREF(lit_11),T15,ENVNUL,PNUL,sloc(49));
  T14 = YPsig(LITREF(lit_13),YPPlist(2,VARREF(YLrepG),VARREF(YLcolG)),YPfalse,YPint((P)2),VARREF(YLrepG),Ynil);
  fun_rep_intoX_7 = YPmet(FUNCODEREF(fun_rep_intoX_7),LITREF(lit_0),T14,ENVNUL,PNUL,sloc(47));
  T17 = VARREF_OR(YgooScolsSrepYrep_intoX,YPfalse);
  T18 = fun_rep_intoX_7;
  T16 = XCALL2(1,VARREF(YPdefine_method),T17,T18);
  VARSET(YgooScolsSrepYrep_intoX,T16);
  lit_15 = YPPsym((P)"rep-fab");
  lit_16 = YPPlist(2,YPPsym((P)"s"),YPPsym((P)"fill"));
  T19 = YPsig(LITREF(lit_16),YPPlist(2,VARREF(YLintG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YLrepG),Ynil);
  YgooScolsSrepYrep_fab = YPmet(FUNCODEREF(YgooScolsSrepYrep_fab),LITREF(lit_15),T19,ENVNUL,PNUL,sloc(55));
  T20 = YgooScolsSrepYrep_fab;
  VARSET(YgooScolsSrepYrep_fab,T20);
  lit_17 = YPPsym((P)"rep-elt");
  lit_18 = YPPlist(2,YPPsym((P)"x"),YPPsym((P)"i"));
  T21 = YPsig(LITREF(lit_18),YPPlist(2,VARREF(YLrepG),VARREF(YLintG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  YgooScolsSrepYrep_elt = YPmet(FUNCODEREF(YgooScolsSrepYrep_elt),LITREF(lit_17),T21,ENVNUL,PNUL,sloc(58));
  T22 = YgooScolsSrepYrep_elt;
  VARSET(YgooScolsSrepYrep_elt,T22);
  lit_19 = YPPsym((P)"rep-elt-setter");
  lit_20 = YPPlist(3,YPPsym((P)"z"),YPPsym((P)"x"),YPPsym((P)"i"));
  T25 = YPsig(LITREF(lit_20),YPPlist(3,VARREF(YLanyG),VARREF(YLrepG),VARREF(YLintG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  T24 = YgooScolsSrepYrep_elt_setter = YPmet(FUNCODEREF(YgooScolsSrepYrep_elt_setter),LITREF(lit_19),T25,ENVNUL,PNUL,sloc(61));
  T27 = YgooScolsSrepYrep_elt_setter;
  T26 = VARSET(YgooScolsSrepYrep_elt_setter,T27);
  T23 = T26;
  return T23;
}
