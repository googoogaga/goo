...
loop:
  ...
  fillF1014 = T2;
  FUNINIT(fillF1014, 4,sF1013,val_,x_,fillF1014);
  T3 = CALL1(0,fillF1014,YPint((P)0));
  T0 = x_;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  intoF1016 = T2;
  FUNINIT(intoF1016, 4,lF1015,s_,d_,intoF1016);
  T3 = CALL1(0,intoF1016,YPint((P)0));
  T0 = d_;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  intoF1018 = T2;
  FUNINIT(intoF1018, 3,lF1017,d_,intoF1018);
  T4 = CALL1(1,VARREF(YgooScolsScolYenum),s_);
  T3 = CALL2(0,intoF1018,YPint((P)0),T4);
  T0 = d_;
UNLINK_STACK();
  RET(T0);
}
