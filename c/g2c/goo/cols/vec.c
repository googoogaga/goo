...
LINK_STACK();
  ...
  datF3378 = T1;
  T0 = CALL5(1,VARREF(Ynew),VARREF(YgooScolsSvecYLvecG),VARREF(YgooScolsSvecYvec_len),s_,VARREF(YgooScolsSvecYvec_dat),datF3378);
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ...
  LOOP_114: {
    P a114_0;
    T2 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_1361F3379);
    T1 = CALL1(1,VARREF(Ynot),T2);
    if (T1 != YPfalse) {
      T12 = CALL1(1,VARREF(YgooScolsScolYnow),x_1361F3379);
      sF3380 = T12;
      T9 = CALL1(1,VARREF(YgooScolsScolYenum),sF3380);
      x_1363F3381 = T9;
      LOOP_115: {
        P a115_0;
        T5 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_1363F3381);
        T4 = CALL1(1,VARREF(Ynot),T5);
        if (T4 != YPfalse) {
          T8 = CALL1(1,VARREF(YgooScolsScolYnow),x_1363F3381);
          eF3382 = T8;
          CALL2(1,VARREF(YgooScolsScolxYaddX),x_,eF3382);
          T7 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1363F3381);
          a115_0 = T7;
          x_1363F3381 = a115_0;
          goto LOOP_115;
          T3 = T6;
      ...
      T11 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1361F3379);
      a114_0 = T11;
      x_1361F3379 = a114_0;
      goto LOOP_114;
      T0 = T10;
...
LINK_STACK();
  ...
  new_lenF3383 = T4;
  T0 = CALL2(1,VARREF(YgooSmagYL),new_lenF3383,YPint((P)0));
  if (T0 != YPfalse) {
    T1 = CALL2(1,VARREF(Yrange_error),c_,new_lenF3383);
  } else {
  }
  T3 = CALL2(1,VARREF(YgooScolsScolYlow_elt),c_,new_lenF3383);
  xF3384 = T3;
  CALL2(1,VARREF(YgooScolsScolxYlen_setter),new_lenF3383,c_);
  T2 = CALL2(1,VARREF(Ytup),c_,xF3384);
UNLINK_STACK();
  RET(T2);
}
...
LINK_STACK();
  ...
  datF3385 = T19;
  T2 = CALL1(1,VARREF(YgooScolsSrepYrep_len),datF3385);
  ...
  if (T1 != YPfalse) {
    ...
    new_dataF3386 = T4;
    CALL2(1,VARREF(YgooScolsSrepYrep_intoX),new_dataF3386,datF3385);
    CALL2(1,VARREF(YgooScolsSvecYvec_len_setter),new_len_,c_);
    T3 = CALL2(1,VARREF(YgooScolsSvecYvec_dat_setter),new_dataF3386,c_);
    T0 = T3;
  } else {
    ...
    if (T7 != YPfalse) {
      ...
      LOOP_116: {
        P a116_0;
        T12 = CALL2(1,VARREF(YgooSmagYL),iF3388,old_lenF3387);
        if (T12 != YPfalse) {
          T14 = CALL3(1,VARREF(YgooScolsSrepYrep_elt_setter),default_,datF3385,iF3388);
          if (T14 != YPfalse) {
            T16 = CALL2(1,VARREF(YgooSmathYA),iF3388,YPint((P)1));
            a116_0 = T16;
            iF3388 = a116_0;
            goto LOOP_116;
            T13 = T15;
...
LINK_STACK();
  ...
  sortedF3389 = T3;
  T1 = CALL2(1,VARREF(YgooSmacrosYEE),a_,sortedF3389);
  if (T1 != YPfalse) {
    T0 = sortedF3389;
  } else {
    T2 = CALL2(1,VARREF(YgooScolsScolYinto),a_,sortedF3389);
    T0 = T2;
  }
UNLINK_STACK();
  RET(T0);
...
LINK_STACK();
  ...
  if (T1 != YPfalse) {
    ...
    qF3390 = T4;
    CALL4(1,VARREF(YgooScolsSvecYquicksortX),a_,p_,qF3390,test_);
    T3 = CALL1(1,VARREF(YgooSmathY1A),qF3390);
  ...
  LOOP_117: {
    LOOP_118: {
      ...
      if (tmpF3394 != YPfalse) {
        ...
        T7 = CALL2(1,VARREF(YgooSlogYE),T8,xF3391);
        T6 = T7;
      }
    ...
    if (T24 != YPfalse) {
      ...
      T31 = jF3393;
      T30 = CALL3(1,VARREF(YgooScolsScolxYelt_setter),x_1365F3395,a_,T31);
      goto LOOP_117;
      T23 = T34;
    } else {
      T35 = jF3393;
