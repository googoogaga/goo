...
loop:
  ...
  sortedF1071 = T1;
  T6 = CALL2(1,VARREF(YgooSmacrosYEE),a_,sortedF1071);
  if (T6 != YPfalse) {
    T5 = sortedF1071;
  } else {
    T7 = CALL2(1,VARREF(YgooScolsScolYinto),a_,sortedF1071);
    T5 = T7;
  }
  T0 = T5;
UNLINK_STACK();
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    qF1072 = T3;
    CALL4(1,VARREF(YgooScolsSvecYquicksortX),a_,p_,qF1072,test_);
    T5 = CALL1(1,VARREF(YgooSmathY1A),qF1072);
...
loop:
  ...
  j_loopF1074 = T0;
  FUNINIT(j_loopF1074, 5,FREEREF(0),FREEREF(1),FREEREF(2),FREEREF(3),j_loopF1074);
  T1 = CALL0(0,j_loopF1074);
  T2 = FUNSHELL(1,fun_i_loop_29,5);
  i_loopF1075 = T2;
  FUNINIT(i_loopF1075, 5,FREEREF(4),FREEREF(1),FREEREF(2),FREEREF(3),i_loopF1075);
  T3 = CALL0(0,i_loopF1075);
  T6 = BOXVAL(FREEREF(4));
  T7 = BOXVAL(FREEREF(0));
  T5 = CALL2(1,VARREF(YgooSmagYL),T6,T7);
  if (T5 != YPfalse) {
    x_1306F1076 = FREEREF(1);
    T9 = BOXVAL(FREEREF(4));
    x_1305F1077 = T9;
    x_1308F1078 = FREEREF(1);
    T12 = BOXVAL(FREEREF(0));
    x_1307F1079 = T12;
    T14 = CALL2(1,VARREF(YgooSmacrosYelt),x_1306F1076,x_1305F1077);
    x_1309F1080 = T14;
    T15 = CALL2(1,VARREF(YgooSmacrosYelt),x_1308F1078,x_1307F1079);
    CALL3(1,VARREF(YgooScolsScolxYelt_setter),T15,x_1306F1076,x_1305F1077);
    T16 = CALL3(1,VARREF(YgooScolsScolxYelt_setter),x_1309F1080,x_1308F1078,x_1307F1079);
    T13 = T16;
    T11 = T13;
    T10 = T11;
    T8 = T10;
...
loop:
  ...
  iF1082 = T3;
  iF1082 = BOXFAB(iF1082);
  T6 = CALL1(1,VARREF(YgooSmathY1A),r_);
  jF1083 = T6;
  jF1083 = BOXFAB(jF1083);
  T9 = FUNSHELL(1,fun_loop_30,6);
  loopF1084 = T9;
  FUNINIT(loopF1084, 6,jF1083,a_,xF1081,test_,iF1082,loopF1084);
  T10 = CALL0(0,loopF1084);
  T8 = T10;
  T5 = T8;
  T2 = T5;
  T0 = T2;
