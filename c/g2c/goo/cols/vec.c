...
loop:
  ...
  datF1036 = T1;
  T3 = CALL5(1,VARREF(Ynew),VARREF(YgooScolsSvecYLvecG),VARREF(YgooScolsSvecYvec_len),s_,VARREF(YgooScolsSvecYvec_dat),datF1036);
  T0 = T3;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    eF1037 = T4;
    CALL2(1,VARREF(YgooScolsScolxYaddX),FREEREF(0),eF1037);
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    x_1300F1039 = T5;
    FUNINIT(x_1300F1039, 2,FREEREF(0),x_1300F1039);
    T7 = CALL1(1,VARREF(YgooScolsScolYenum),sF1038);
    T6 = CALL1(0,x_1300F1039,T7);
...
loop:
  ...
  x_1298F1040 = T0;
  FUNINIT(x_1298F1040, 2,x_,x_1298F1040);
  T2 = CALL1(1,VARREF(YgooScolsScolYenum),more_);
  T1 = CALL1(0,x_1298F1040,T2);
UNLINK_STACK();
  RET(x_);
}
...
loop:
  ...
  new_lenF1041 = T1;
  T4 = CALL2(1,VARREF(YgooScolsScolYlow_elt),c_,new_lenF1041);
  xF1042 = T4;
  CALL2(1,VARREF(YgooScolsScolxYlen_setter),new_lenF1041,c_);
  T5 = CALL2(1,VARREF(Ytup),c_,xF1042);
  T3 = T5;
  T0 = T3;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  datF1045 = T1;
  T4 = CALL1(1,VARREF(YgooScolsSrepYrep_len),datF1045);
  ...
  if (T3 != YPfalse) {
    ...
    new_dataF1046 = T6;
    CALL2(1,VARREF(YgooScolsSrepYrep_intoX),new_dataF1046,datF1045);
    CALL2(1,VARREF(YgooScolsSvecYvec_len_setter),new_len_,c_);
    T8 = CALL2(1,VARREF(YgooScolsSvecYvec_dat_setter),new_dataF1046,c_);
    T5 = T8;
    T2 = T5;
  } else {
    ...
    if (T10 != YPfalse) {
      ...
      fillF1048 = T15;
      FUNINIT(fillF1048, 4,old_lenF1047,default_,datF1045,fillF1048);
      T16 = CALL1(1,fillF1048,new_len_);
      T14 = T16;
      T12 = T14;
      T9 = T12;
    } else {
...
loop:
  ...
  lit_27 = YPPsym((P)"pop!");
  T73 = YPsig(YPPlist(1,LITREF(lit_10)),YPPlist(1,VARREF(YgooScolsSvecYLvecG)),YPfalse,YPint((P)1),VARREF(YLtupG),Ynil);
  ...
  lit_29 = YPsb((P)"#[");
  lit_30 = YPsb((P)"]");
  T78 = YPsig(YPPlist(1,LITREF(lit_20)),YPPlist(1,VARREF(YgooScolsSvecYLvecG)),YPfalse,YPint((P)1),VARREF(YLstrG),Ynil);
  ...
  lit_31 = YPPsym((P)"add!");
  T83 = YPsig(YPPlist(2,LITREF(lit_10),LITREF(lit_20)),YPPlist(2,VARREF(YgooScolsSvecYLvecG),VARREF(YLanyG)),YPfalse,YPint((P)2),VARREF(YgooScolsSvecYLvecG),Ynil);
  ...
  T89 = YPsig(YPPlist(1,LITREF(lit_12)),YPPlist(1,VARREF(YLintG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_fill_19 = YPmet(FUNCODEREF(fun_fill_19),LITREF(lit_34),T89,ENVNUL,PNUL,YPfalse);
  T88 = YPsig(YPPlist(3,LITREF(lit_33),LITREF(lit_10),LITREF(lit_13)),YPPlist(3,VARREF(YLintG),VARREF(YgooScolsSvecYLvecG),VARREF(YLanyG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
  ...
  T94 = YPsig(YPPlist(2,LITREF(lit_33),LITREF(lit_10)),YPPlist(2,VARREF(YLintG),VARREF(YgooScolsSvecYLvecG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  ...
  lit_36 = YPPsym((P)"zap!");
  T99 = YPsig(YPPlist(1,LITREF(lit_10)),YPPlist(1,VARREF(YgooScolsSvecYLvecG)),YPfalse,YPint((P)1),VARREF(YgooScolsSvecYLvecG),Ynil);
  ...
  T104 = YPsig(YPPlist(2,LITREF(lit_20),LITREF(lit_12)),YPPlist(2,VARREF(YgooScolsSvecYLvecG),VARREF(YLintG)),YPfalse,YPint((P)2),VARREF(YLanyG),Ynil);
  ...
  T111 = YPsig(YPPlist(3,LITREF(lit_15),LITREF(lit_20),LITREF(lit_12)),YPPlist(3,VARREF(YLanyG),VARREF(YgooScolsSvecYLvecG),VARREF(YLintG)),YPfalse,YPint((P)3),VARREF(YLanyG),Ynil);
