...
LINK_STACK();
  ...
  datF1983 = T1;
  T0 = CALL5(1,VARREF(Ynew),VARREF(YgooScolsSvecYLvecG),VARREF(YgooScolsSvecYvec_len),s_,VARREF(YgooScolsSvecYvec_dat),datF1983);
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ...
  for (;;) {
    P a109_0;
  loop109:
    T2 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_1309F1984);
    T1 = CALL1(1,VARREF(Ynot),T2);
    if (T1 != YPfalse) {
      T12 = CALL1(1,VARREF(YgooScolsScolYnow),x_1309F1984);
      sF1985 = T12;
      T9 = CALL1(1,VARREF(YgooScolsScolYenum),sF1985);
      x_1311F1986 = T9;
      for (;;) {
        P a110_0;
      loop110:
        T5 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_1311F1986);
        T4 = CALL1(1,VARREF(Ynot),T5);
        if (T4 != YPfalse) {
          T8 = CALL1(1,VARREF(YgooScolsScolYnow),x_1311F1986);
          eF1987 = T8;
          CALL2(1,VARREF(YgooScolsScolxYaddX),x_,eF1987);
          T7 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1311F1986);
          a110_0 = T7;
          x_1311F1986 = a110_0;
          goto loop110;
          T3 = T6;
      ...
      T11 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1309F1984);
      a109_0 = T11;
      x_1309F1984 = a109_0;
      goto loop109;
      T0 = T10;
...
LINK_STACK();
  ...
  new_lenF1988 = T4;
  T0 = CALL2(1,VARREF(YgooSmagYL),new_lenF1988,YPint((P)0));
  if (T0 != YPfalse) {
    T1 = CALL2(1,VARREF(Yrange_error),c_,new_lenF1988);
  } else {
  }
  T3 = CALL2(1,VARREF(YgooScolsScolYlow_elt),c_,new_lenF1988);
  xF1989 = T3;
  CALL2(1,VARREF(YgooScolsScolxYlen_setter),new_lenF1988,c_);
  T2 = CALL2(1,VARREF(Ytup),c_,xF1989);
UNLINK_STACK();
  RET(T2);
}
...
LINK_STACK();
  ...
  datF1990 = T19;
  T2 = CALL1(1,VARREF(YgooScolsSrepYrep_len),datF1990);
  ...
  if (T1 != YPfalse) {
    ...
    new_dataF1991 = T4;
    CALL2(1,VARREF(YgooScolsSrepYrep_intoX),new_dataF1991,datF1990);
    CALL2(1,VARREF(YgooScolsSvecYvec_len_setter),new_len_,c_);
    T3 = CALL2(1,VARREF(YgooScolsSvecYvec_dat_setter),new_dataF1991,c_);
    T0 = T3;
  } else {
    ...
    if (T7 != YPfalse) {
      ...
      for (;;) {
        P a111_0;
      loop111:
        T12 = CALL2(1,VARREF(YgooSmagYL),iF1993,old_lenF1992);
        if (T12 != YPfalse) {
          T14 = CALL3(1,VARREF(YgooScolsSrepYrep_elt_setter),default_,datF1990,iF1993);
          if (T14 != YPfalse) {
            T16 = CALL2(1,VARREF(YgooSmathYA),iF1993,YPint((P)1));
            a111_0 = T16;
            iF1993 = a111_0;
            goto loop111;
            T13 = T15;
...
LINK_STACK();
  ...
  sortedF1994 = T3;
  T1 = CALL2(1,VARREF(YgooSmacrosYEE),a_,sortedF1994);
  if (T1 != YPfalse) {
    T0 = sortedF1994;
  } else {
    T2 = CALL2(1,VARREF(YgooScolsScolYinto),a_,sortedF1994);
    T0 = T2;
  }
UNLINK_STACK();
  RET(T0);
...
LINK_STACK();
  ...
  if (T1 != YPfalse) {
    ...
    qF1995 = T4;
    CALL4(1,VARREF(YgooScolsSvecYquicksortX),a_,p_,qF1995,test_);
    T3 = CALL1(1,VARREF(YgooSmathY1A),qF1995);
...
LINK_STACK();
  ...
  iF1997 = T35;
  iF1997 = BOXFAB(iF1997);
  T34 = CALL1(1,VARREF(YgooSmathY1A),r_);
  jF1998 = T34;
  jF1998 = BOXFAB(jF1998);
  for (;;) {
  loop112:
    for (;;) {
    loop113:
      ...
      if (tmpF1999 != YPfalse) {
        ...
        T7 = CALL2(1,VARREF(YgooSmathYE),T8,xF1996);
        T6 = T7;
      }
    ...
    if (T24 != YPfalse) {
      ...
      T30 = BOXVAL(jF1998);
      x_1315F2003 = T30;
      T29 = CALL2(1,VARREF(YgooSmacrosYelt),x_1314F2000,x_1313F2001);
      x_1317F2004 = T29;
      T27 = CALL2(1,VARREF(YgooSmacrosYelt),x_1316F2002,x_1315F2003);
      CALL3(1,VARREF(YgooScolsScolxYelt_setter),T27,x_1314F2000,x_1313F2001);
      T28 = CALL3(1,VARREF(YgooScolsScolxYelt_setter),x_1317F2004,x_1316F2002,x_1315F2003);
      goto loop112;
      T23 = T32;
    } else {
      T33 = BOXVAL(jF1998);
...
DEFCREGS();
  ...
  fun_catX_11 = YPmet(FUNCODEREF(fun_catX_11),LITREF(lit_23),T47,ENVNUL,PNUL,sloc(51));
  ...
  fun_vec_12 = YPmet(FUNCODEREF(fun_vec_12),LITREF(lit_1),T51,ENVNUL,PNUL,sloc(57));
  ...
  fun_pushX_13 = YPmet(FUNCODEREF(fun_pushX_13),LITREF(lit_26),T55,ENVNUL,PNUL,sloc(60));
  ...
  fun_popX_14 = YPmet(FUNCODEREF(fun_popX_14),LITREF(lit_28),T59,ENVNUL,PNUL,sloc(63));
  ...
  fun_to_str_15 = YPmet(FUNCODEREF(fun_to_str_15),LITREF(lit_30),T64,ENVNUL,PNUL,sloc(71));
  ...
  fun_addX_16 = YPmet(FUNCODEREF(fun_addX_16),LITREF(lit_34),T68,ENVNUL,PNUL,sloc(74));
  ...
  fun_lenSfill_setter_17 = YPmet(FUNCODEREF(fun_lenSfill_setter_17),LITREF(lit_36),T72,ENVNUL,PNUL,sloc(78));
  ...
  fun_len_setter_18 = YPmet(FUNCODEREF(fun_len_setter_18),LITREF(lit_38),T76,ENVNUL,PNUL,sloc(95));
  ...
  fun_zapX_19 = YPmet(FUNCODEREF(fun_zapX_19),LITREF(lit_40),T80,ENVNUL,PNUL,sloc(98));
  ...
  fun_low_elt_20 = YPmet(FUNCODEREF(fun_low_elt_20),LITREF(lit_42),T84,ENVNUL,PNUL,sloc(100));
  ...
  fun_low_elt_setter_21 = YPmet(FUNCODEREF(fun_low_elt_setter_21),LITREF(lit_44),T88,ENVNUL,PNUL,sloc(103));
  ...
  fun_sort_by_22 = YPmet(FUNCODEREF(fun_sort_by_22),LITREF(lit_46),T92,ENVNUL,PNUL,sloc(108));
  ...
  fun_sort_byX_23 = YPmet(FUNCODEREF(fun_sort_byX_23),LITREF(lit_48),T96,ENVNUL,PNUL,sloc(111));
  ...
  fun_quicksortX_24 = YPmet(FUNCODEREF(fun_quicksortX_24),LITREF(lit_50),T100,ENVNUL,PNUL,sloc(117));
  ...
  T105 = fun_partitionX_25 = YPmet(FUNCODEREF(fun_partitionX_25),LITREF(lit_52),T106,ENVNUL,PNUL,sloc(124));
