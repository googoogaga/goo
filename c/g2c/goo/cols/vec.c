...
LINK_STACK();
  ...
  datF3292 = T1;
  T0 = CALL5(1,VARREF(Ynew),VARREF(YgooScolsSvecYLvecG),VARREF(YgooScolsSvecYvec_len),s_,VARREF(YgooScolsSvecYvec_dat),datF3292);
UNLINK_STACK();
  RET(T0);
}
...
LINK_STACK();
  ...
  LOOP_115: {
    P a115_0;
    T2 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_1361F3293);
    T1 = CALL1(1,VARREF(Ynot),T2);
    if (T1 != YPfalse) {
      T12 = CALL1(1,VARREF(YgooScolsScolYnow),x_1361F3293);
      sF3294 = T12;
      T9 = CALL1(1,VARREF(YgooScolsScolYenum),sF3294);
      x_1363F3295 = T9;
      LOOP_116: {
        P a116_0;
        T5 = CALL1(1,VARREF(YgooScolsScolYfinQ),x_1363F3295);
        T4 = CALL1(1,VARREF(Ynot),T5);
        if (T4 != YPfalse) {
          T8 = CALL1(1,VARREF(YgooScolsScolYnow),x_1363F3295);
          eF3296 = T8;
          CALL2(1,VARREF(YgooScolsScolxYaddX),x_,eF3296);
          T7 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1363F3295);
          a116_0 = T7;
          x_1363F3295 = a116_0;
          goto LOOP_116;
          T3 = T6;
      ...
      T11 = CALL1(1,VARREF(YgooScolsScolYnxt),x_1361F3293);
      a115_0 = T11;
      x_1361F3293 = a115_0;
      goto LOOP_115;
      T0 = T10;
...
LINK_STACK();
  ...
  new_lenF3297 = T4;
  T0 = CALL2(1,VARREF(YgooSmagYL),new_lenF3297,YPint((P)0));
  if (T0 != YPfalse) {
    T1 = CALL2(1,VARREF(Yrange_error),c_,new_lenF3297);
  } else {
  }
  T3 = CALL2(1,VARREF(YgooScolsScolYlow_elt),c_,new_lenF3297);
  xF3298 = T3;
  CALL2(1,VARREF(YgooScolsScolxYlen_setter),new_lenF3297,c_);
  T2 = CALL2(1,VARREF(Ytup),c_,xF3298);
UNLINK_STACK();
  RET(T2);
}
...
LINK_STACK();
  ...
  datF3299 = T19;
  T2 = CALL1(1,VARREF(YgooScolsSrepYrep_len),datF3299);
  ...
  if (T1 != YPfalse) {
    ...
    new_dataF3300 = T4;
    CALL2(1,VARREF(YgooScolsSrepYrep_intoX),new_dataF3300,datF3299);
    CALL2(1,VARREF(YgooScolsSvecYvec_len_setter),new_len_,c_);
    T3 = CALL2(1,VARREF(YgooScolsSvecYvec_dat_setter),new_dataF3300,c_);
    T0 = T3;
  } else {
    ...
    if (T7 != YPfalse) {
      ...
      LOOP_117: {
        P a117_0;
        T12 = CALL2(1,VARREF(YgooSmagYL),iF3302,old_lenF3301);
        if (T12 != YPfalse) {
          T14 = CALL3(1,VARREF(YgooScolsSrepYrep_elt_setter),default_,datF3299,iF3302);
          if (T14 != YPfalse) {
            T16 = CALL2(1,VARREF(YgooSmathYA),iF3302,YPint((P)1));
            a117_0 = T16;
            iF3302 = a117_0;
            goto LOOP_117;
            T13 = T15;
...
LINK_STACK();
  ...
  sortedF3303 = T3;
  T1 = CALL2(1,VARREF(YgooSmacrosYEE),a_,sortedF3303);
  if (T1 != YPfalse) {
    T0 = sortedF3303;
  } else {
    T2 = CALL2(1,VARREF(YgooScolsScolYinto),a_,sortedF3303);
    T0 = T2;
  }
UNLINK_STACK();
  RET(T0);
...
LINK_STACK();
  ...
  if (T1 != YPfalse) {
    ...
    qF3304 = T4;
    CALL4(1,VARREF(YgooScolsSvecYquicksortX),a_,p_,qF3304,test_);
    T3 = CALL1(1,VARREF(YgooSmathY1A),qF3304);
  ...
  LOOP_118: {
    LOOP_119: {
      ...
      if (tmpF3308 != YPfalse) {
        ...
        T7 = CALL2(1,VARREF(YgooSlogYE),T8,xF3305);
        T6 = T7;
      }
    ...
    if (T24 != YPfalse) {
      ...
      T31 = jF3307;
      T30 = CALL3(1,VARREF(YgooScolsScolxYelt_setter),x_1365F3309,a_,T31);
      goto LOOP_118;
      T23 = T34;
    } else {
      T35 = jF3307;
