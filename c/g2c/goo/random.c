...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    v1F3795 = T3;
    T5 = CALL1(1,VARREF(YgooSrandomYlcg_rand),v1F3795);
    v2F3796 = T5;
    T7 = CALL2(1,VARREF(YgooSmathYmod),v1F3795,YPint((P)32768));
    T9 = CALL2(1,VARREF(YgooSmathYmod),v2F3796,YPint((P)16384));
...
loop:
  ...
  rF3798 = T1;
  T3 = CALL1(1,VARREF(YgooSrandomYrecent),rF3798);
  aF3799 = T3;
  CALL3(1,VARREF(YgooScolsScolxYelt_setter),VARREF(YDmax_int),aF3799,YPint((P)0));
  T4 = FUNSHELL(1,fun_loop_8,2);
  loopF3800 = T4;
  FUNINIT(loopF3800, 2,aF3799,loopF3800);
  T7 = CALL1(1,VARREF(YgooSmathYabs),seed_);
  T6 = CALL2(1,VARREF(YgooSmathYmod),T7,YPint((P)32768));
  T5 = CALL2(0,loopF3800,YPint((P)1),T6);
  T8 = FUNSHELL(1,fun_x_1784_9,2);
  x_1784F3801 = T8;
  FUNINIT(x_1784F3801, 2,rF3798,x_1784F3801);
...
loop:
  ...
  aF3803 = T5;
  CALL2(1,VARREF(YgooSrandomYrecent_index_setter),riF3802,r_);
  T7 = FUNSHELL(1,fun_tap_12,2);
  tapF3804 = T7;
  FUNINIT(tapF3804, 2,aF3803,riF3802);
  T11 = CALL1(1,tapF3804,YPint((P)54));
  T12 = CALL1(1,tapF3804,YPint((P)8));
  T10 = CALL2(1,VARREF(YgooSmathYC),T11,T12);
  T14 = CALL1(1,tapF3804,YPint((P)6));
  T15 = CALL1(1,tapF3804,YPint((P)3));
  T13 = CALL2(1,VARREF(YgooSmathYC),T14,T15);
  T9 = CALL2(1,VARREF(YgooSmathYC),T10,T13);
  T8 = CALL3(1,VARREF(YgooScolsScolxYelt_setter),T9,aF3803,riF3802);
  T6 = T8;
  T4 = T6;
  T0 = T4;
UNLINK_STACK();
...
loop:
  ...
  valueF3805 = T1;
  T3 = CALL2(1,VARREF(YgooSmagYLE),valueF3805,FREEREF(1));
  if (T3 != YPfalse) {
    T2 = valueF3805;
  } else {
    goto loop;
...
loop:
  ...
  if (T1 != YPfalse) {
    ...
    mF3806 = VARREF(YDmax_int);
    T7 = CALL2(1,VARREF(YgooSmathY_),mF3806,range_);
    T6 = CALL2(1,VARREF(YgooSmathYA),T7,YPint((P)1));
    T5 = CALL2(1,VARREF(YgooSmathYmod),T6,range_);
    T4 = CALL2(1,VARREF(YgooSmathY_),mF3806,T5);
    limitF3807 = T4;
    T9 = FUNSHELL(1,fun_find_good_value_15,3);
    find_good_valueF3808 = T9;
    FUNINIT(find_good_valueF3808, 3,r_,limitF3807,find_good_valueF3808);
    T11 = CALL0(1,find_good_valueF3808);
...
LINK_STACK();
  ARG(r_, 0);
loop:
  maxF3809 = YPint((P)1000000);
  T4 = CALL2(1,VARREF(YgooSmathYA),maxF3809,YPint((P)1));
  T3 = CALL2(1,VARREF(YgooSrandomYrandom_using),T4,r_);
  T2 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLfloG),T3);
  T5 = CALL2(1,VARREF(YgooStypesYas),VARREF(YLfloG),maxF3809);
