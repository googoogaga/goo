...
loop:
  ...
  fun_recent_1 = YPmet(FUNCODEREF(fun_recent_1),LITREF(lit_3),T4,ENVNUL,PNUL,YPfalse);
  ...
  fun_recent_setter_2 = YPmet(FUNCODEREF(fun_recent_setter_2),LITREF(lit_5),T9,ENVNUL,PNUL,YPfalse);
  ...
  fun_recent_index_4 = YPmet(FUNCODEREF(fun_recent_index_4),LITREF(lit_8),T16,ENVNUL,PNUL,YPfalse);
  ...
  fun_recent_index_setter_5 = YPmet(FUNCODEREF(fun_recent_index_setter_5),LITREF(lit_10),T21,ENVNUL,PNUL,YPfalse);
  ...
  YgooSrandomYlcg_rand = YPmet(FUNCODEREF(YgooSrandomYlcg_rand),LITREF(lit_13),T28,ENVNUL,PNUL,YPfalse);
  ...
  fun_fab_random_11 = YPmet(FUNCODEREF(fun_fab_random_11),LITREF(lit_21),T37,ENVNUL,PNUL,YPfalse);
  ...
  fun_tap_12 = YPmet(FUNCODEREF(fun_tap_12),LITREF(lit_24),T43,ENVNUL,PNUL,YPfalse);
  T42 = YPsig(LITREF(lit_23),YPPlist(1,VARREF(YgooSrandomYLrandomG)),YPfalse,YPint((P)1),VARREF(YLintG),Ynil);
  YgooSrandomYrandom_29 = YPmet(FUNCODEREF(YgooSrandomYrandom_29),LITREF(lit_22),T42,ENVNUL,PNUL,YPfalse);
  ...
  fun_random_14 = YPmet(FUNCODEREF(fun_random_14),LITREF(lit_26),T46,ENVNUL,PNUL,YPfalse);
  ...
  fun_find_good_value_15 = YPmet(FUNCODEREF(fun_find_good_value_15),LITREF(lit_30),T52,ENVNUL,PNUL,YPfalse);
  T51 = YPsig(LITREF(lit_29),YPPlist(2,VARREF(YLintG),VARREF(YgooSrandomYLrandomG)),YPfalse,YPint((P)2),VARREF(YLintG),Ynil);
  fun_random_using_16 = YPmet(FUNCODEREF(fun_random_using_16),LITREF(lit_28),T51,ENVNUL,PNUL,YPfalse);
  ...
  fun_random_unit_17 = YPmet(FUNCODEREF(fun_random_unit_17),LITREF(lit_31),T57,ENVNUL,PNUL,YPfalse);
  ...
  fun_random_unit_using_18 = YPmet(FUNCODEREF(fun_random_unit_using_18),LITREF(lit_32),T62,ENVNUL,PNUL,YPfalse);
