...
DEFCREGS();
  ...
  YgooSlocYloc_val = YPfab_met(FUNCODEREF(YgooSlocYloc_val),T0,LITREF(lit_0),LITREF(lit_1),sloc(8),YPsb((P)"(fun ((x <loc>) => <any>) (%loc-val x))"));
  T1 = YgooSlocYloc_val;
  ...
  YgooSlocYloc_val_setter = YPfab_met(FUNCODEREF(YgooSlocYloc_val_setter),T2,LITREF(lit_2),LITREF(lit_3),sloc(11),YPsb((P)"(fun (z (x <loc>) => <any>) (set (%loc-val x) z))"));
