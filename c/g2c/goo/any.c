...
DEFCREGS();
  ...
  YgooSanyYaddress_of = YPfab_met(FUNCODEREF(YgooSanyYaddress_of),T4,LITREF(lit_4),LITREF(lit_5),sloc(16),YPsb((P)"(fun (x => <fixnum>) (%ib x))"));
  ...
  fun_to_str_1 = YPfab_met(FUNCODEREF(fun_to_str_1),T6,LITREF(lit_0),LITREF(lit_6),sloc(18),YPsb((P)"(fun ((x <any>) => <str>) (cat { obj( (to-str (class-name (class-of x))) ) }))"));
  ...
  T11 = fun_as_2 = YPfab_met(FUNCODEREF(fun_as_2),T12,LITREF(lit_2),LITREF(lit_9),sloc(21),YPsb((P)"(fun (type x => <any>) (if (isa? x type) x (as-error type x)))"));
