...
loop:
  ...
  T3 = CALLN(1,VARREF(Ynew),7,VARREF(YcolsSpipeYLpipeG),VARREF(YcolsSpipeYpipe_data),datF3514,VARREF(YcolsSpipeYpipe_lock),T4,VARREF(YcolsSpipeYpipe_available),T5);
  T0 = T3;
UNLINK_STACK();
  RET(T0);
}
...
loop:
  ...
  x_1769F3515 = T1;
  T3 = FUNFAB(fun_14,2,x_1769F3515,c_);
  T4 = FUNFAB(fun_15,1,x_1769F3515);
...
loop:
  ...
  odatF3516 = T1;
  T3 = CALL1(1,VARREF(YgooScolsSrepYrep_len),odatF3516);
  olenF3517 = T3;
  T9 = CALL1(1,VARREF(YgooScolsSrepYrep_len),odatF3516);
  ...
  loopF3519 = T10;
  FUNINIT(loopF3519, 5,c_,odatF3516,ndatF3518,olenF3517,loopF3519);
  T12 = CALL1(1,VARREF(YcolsSpipeYpipe_get_idx),c_);
  T11 = CALL2(0,loopF3519,T12,YPint((P)0));
  CALL2(1,VARREF(YcolsSpipeYpipe_data_setter),ndatF3518,c_);
...
loop:
  ...
  lenF3520 = T1;
  T3 = CALL2(1,VARREF(YgooSmathYA),lenF3520,YPint((P)1));
  ...
  T7 = CALL2(1,VARREF(YgooSmathYE),lenF3520,YPint((P)0));
  if (T7 != YPfalse) {
  ...
  x_1771F3521 = FREEREF(1);
  T14 = CALL1(1,VARREF(YcolsSpipeYpipe_put_idx),x_1771F3521);
  UF3522 = T14;
  T18 = CALL1(1,VARREF(YcolsSpipeYpipe_data),FREEREF(1));
  T17 = CALL1(1,VARREF(YgooScolsSrepYrep_len),T18);
  T16 = CALL3(1,VARREF(YgooSmathYmodA),UF3522,YPint((P)1),T17);
  T15 = CALL2(1,VARREF(YcolsSpipeYpipe_put_idx_setter),T16,x_1771F3521);
  T13 = T15;
  T0 = FREEREF(1);
UNLINK_STACK();
  QRET(T0);
...
loop:
  T1 = CALL1(1,VARREF(YcolsSpipeYpipe_lock),c_);
  x_1770F3523 = T1;
  T3 = FUNFAB(fun_19,3,x_1770F3523,c_,x_);
  T4 = FUNFAB(fun_20,1,x_1770F3523);
  T2 = with_cleanup(T3,T4);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  resF3524 = T6;
  x_1773F3525 = FREEREF(1);
  T10 = CALL1(1,VARREF(YcolsSpipeYpipe_get_idx),x_1773F3525);
  UF3526 = T10;
  T14 = CALL1(1,VARREF(YcolsSpipeYpipe_data),FREEREF(1));
  T13 = CALL1(1,VARREF(YgooScolsSrepYrep_len),T14);
  T12 = CALL3(1,VARREF(YgooSmathYmodA),UF3526,YPint((P)1),T13);
  T11 = CALL2(1,VARREF(YcolsSpipeYpipe_get_idx_setter),T12,x_1773F3525);
  T9 = T11;
  T5 = resF3524;
UNLINK_STACK();
  QRET(T5);
...
loop:
  T1 = CALL1(1,VARREF(YcolsSpipeYpipe_lock),c_);
  x_1772F3527 = T1;
  T3 = FUNFAB(fun_23,2,x_1772F3527,c_);
  T4 = FUNFAB(fun_24,1,x_1772F3527);
  T2 = with_cleanup(T3,T4);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
...
loop:
  T1 = CALL1(1,VARREF(YcolsSpipeYpipe_lock),c_);
  x_1774F3528 = T1;
  T3 = FUNFAB(fun_26,2,x_1774F3528,c_);
  T4 = FUNFAB(fun_27,1,x_1774F3528);
  T2 = with_cleanup(T3,T4);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  x_1775F3529 = T1;
  T3 = FUNFAB(fun_29,3,x_1775F3529,i_,x_);
  T4 = FUNFAB(fun_30,1,x_1775F3529);
  T2 = with_cleanup(T3,T4);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  fun_pipe_get_idx_setter_3 = YPmet(FUNCODEREF(fun_pipe_get_idx_setter_3),LITREF(lit_7),T18,ENVNUL,PNUL,YPfalse);
  ...
  fun_pipe_put_idx_5 = YPmet(FUNCODEREF(fun_pipe_put_idx_5),LITREF(lit_10),T25,ENVNUL,PNUL,YPfalse);
  ...
  fun_pipe_put_idx_setter_6 = YPmet(FUNCODEREF(fun_pipe_put_idx_setter_6),LITREF(lit_12),T30,ENVNUL,PNUL,YPfalse);
  ...
  fun_pipe_lock_8 = YPmet(FUNCODEREF(fun_pipe_lock_8),LITREF(lit_15),T37,ENVNUL,PNUL,YPfalse);
  ...
  fun_pipe_lock_setter_9 = YPmet(FUNCODEREF(fun_pipe_lock_setter_9),LITREF(lit_17),T42,ENVNUL,PNUL,YPfalse);
  ...
  fun_pipe_available_10 = YPmet(FUNCODEREF(fun_pipe_available_10),LITREF(lit_19),T47,ENVNUL,PNUL,YPfalse);
  ...
  fun_pipe_available_setter_11 = YPmet(FUNCODEREF(fun_pipe_available_setter_11),LITREF(lit_21),T52,ENVNUL,PNUL,YPfalse);
  ...
  fun_fab_12 = YPmet(FUNCODEREF(fun_fab_12),LITREF(lit_23),T57,ENVNUL,PNUL,YPfalse);
  ...
  YcolsSpipeYOlen = YPmet(FUNCODEREF(YcolsSpipeYOlen),LITREF(lit_25),T63,ENVNUL,PNUL,YPfalse);
  T64 = YcolsSpipeYOlen;
  ...
  fun_len_16 = YPmet(FUNCODEREF(fun_len_16),LITREF(lit_27),T65,ENVNUL,PNUL,YPfalse);
  ...
  fun_loop_17 = YPmet(FUNCODEREF(fun_loop_17),LITREF(lit_32),T73,ENVNUL,PNUL,YPfalse);
  T72 = YPsig(LITREF(lit_31),YPPlist(1,VARREF(YcolsSpipeYLpipeG)),YPfalse,YPint((P)1),VARREF(YLanyG),Ynil);
  fun_grow_pipeX_18 = YPmet(FUNCODEREF(fun_grow_pipeX_18),LITREF(lit_30),T72,ENVNUL,PNUL,YPfalse);
  ...
  fun_addX_21 = YPmet(FUNCODEREF(fun_addX_21),LITREF(lit_34),T78,ENVNUL,PNUL,YPfalse);
  ...
  fun_enqX_22 = YPmet(FUNCODEREF(fun_enqX_22),LITREF(lit_36),T85,ENVNUL,PNUL,YPfalse);
  ...
  fun_deqX_25 = YPmet(FUNCODEREF(fun_deqX_25),LITREF(lit_38),T90,ENVNUL,PNUL,YPfalse);
  ...
  fun_zapX_28 = YPmet(FUNCODEREF(fun_zapX_28),LITREF(lit_40),T97,ENVNUL,PNUL,YPfalse);
  ...
  YcolsSpipeYpipe_idx = YPmet(FUNCODEREF(YcolsSpipeYpipe_idx),LITREF(lit_42),T104,ENVNUL,PNUL,YPfalse);
  ...
  fun_low_elt_32 = YPmet(FUNCODEREF(fun_low_elt_32),LITREF(lit_44),T108,ENVNUL,PNUL,YPfalse);
  ...
  fun_low_elt_setter_33 = YPmet(FUNCODEREF(fun_low_elt_setter_33),LITREF(lit_46),T113,ENVNUL,PNUL,YPfalse);
  ...
  fun_elt_or_34 = YPmet(FUNCODEREF(fun_elt_or_34),LITREF(lit_48),T118,ENVNUL,PNUL,YPfalse);
