...
loop:
  ...
  x_1743F2628 = T1;
  T3 = FUNFAB(fun_14,2,x_1743F2628,c_);
  T4 = FUNFAB(fun_15,1,x_1743F2628);
...
loop:
  ...
  x_1745F2634 = FREEREF(1);
  T14 = CALL1(1,VARREF(YcolsSpipeYpipe_put_idx),x_1745F2634);
  UF2635 = T14;
  ...
  T15 = CALL2(1,VARREF(YcolsSpipeYpipe_put_idx_setter),T16,x_1745F2634);
  T13 = T15;
  T0 = FREEREF(1);
UNLINK_STACK();
  QRET(T0);
...
loop:
  T1 = CALL1(1,VARREF(YcolsSpipeYpipe_lock),c_);
  x_1744F2636 = T1;
  T3 = FUNFAB(fun_19,3,x_1744F2636,c_,x_);
  T4 = FUNFAB(fun_20,1,x_1744F2636);
  T2 = with_cleanup(T3,T4);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  T10 = CALL1(1,VARREF(YcolsSpipeYpipe_get_idx),x_1747F2638);
  UF2639 = T10;
  ...
  T11 = CALL2(1,VARREF(YcolsSpipeYpipe_get_idx_setter),T12,x_1747F2638);
  T9 = T11;
  T5 = resF2637;
UNLINK_STACK();
  QRET(T5);
...
loop:
  T1 = CALL1(1,VARREF(YcolsSpipeYpipe_lock),c_);
  x_1746F2640 = T1;
  T3 = FUNFAB(fun_23,2,x_1746F2640,c_);
  T4 = FUNFAB(fun_24,1,x_1746F2640);
  T2 = with_cleanup(T3,T4);
  T0 = T2;
UNLINK_STACK();
  QRET(T0);
...
loop:
  T1 = CALL1(1,VARREF(YcolsSpipeYpipe_lock),c_);
  x_1748F2641 = T1;
  T3 = FUNFAB(fun_26,2,x_1748F2641,c_);
  T4 = FUNFAB(fun_27,1,x_1748F2641);
  T2 = with_cleanup(T3,T4);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
...
loop:
  ...
  x_1749F2642 = T1;
  T3 = FUNFAB(fun_29,3,x_1749F2642,i_,x_);
  T4 = FUNFAB(fun_30,1,x_1749F2642);
  T2 = with_cleanup(T3,T4);
  T0 = T2;
UNLINK_STACK();
  RET(T0);
