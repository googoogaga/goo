...
\T\title{{\Huge \goo\ Reference Manual v42 }}
\T\author{{\huge Jonathan Bachrach} \\ {\Large MIT AI Lab}}
\W\title{{\huge \goo\ Reference Manual v42 }}
...
\generic{object-class}{x|<any> => <class>}
...
\generic{col-res-type}{x|<col> => <type>}
  \doc{appropriate instantiable type for creating collection results,
       where the default is \kode{(object-class x)}.}
...
\class{<ast-error>}{<compiler-error>}
