...
\goo\ is freely available from \kode{www.googaga.org} under GPL.
...
Unpack % either a linux or windows version of \goo\ into an
appropriate installation area.  There are five directories:
\kode{doc}, \kode{bin}, \kode{c}, \kode{src}, and \kode{emacs}.  Edit
the \kode{Make.inc} file in the top level directory, to configure the
...
installation location and type \kode{make simple-install}.
...
Please, please, please send bug reports to \kode{jrb@googaga.org}.  I
will fix your bugs asap.  The \goo\ website \kode{www.googaga.org}
